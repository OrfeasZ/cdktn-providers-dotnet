...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/azure/azapi/2.12.0/docs/resources/resource azapi_resource}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/azure/azapi/2.12.0/docs/resources/resource azapi_resource} Resource.</summary>
        ...
        [JsiiMethod(name: "resetIgnoreBodyChanges")]
        public virtual void ResetIgnoreBodyChanges()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "ignoreBodyChangesInput", typeJson: "{\"collection\":{\"elementtype\":{\"primitive\":\"string\"},\"kind\":\"array\"}}", isOptional: true)]
        public virtual string[]? IgnoreBodyChangesInput
        {
            get => GetInstanceProperty<string[]?>();
        }
        ...
        [JsiiProperty(name: "ignoreBodyChanges", typeJson: "{\"collection\":{\"elementtype\":{\"primitive\":\"string\"},\"kind\":\"array\"}}")]
        public virtual string[] IgnoreBodyChanges
        {
            get => GetInstanceProperty<string[]>()!;
            set => SetInstanceProperty(value);
        }
