...
namespace azapi.DataAzapiResource
{
    ...
    public interface IDataAzapiResourceConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        azapi.DataAzapiResource.IDataAzapiResourceRetry? Retry
        {
            get
            {
                return null;
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        azapi.DataAzapiResource.IDataAzapiResourceTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        internal sealed class _Proxy : DeputyBase, azapi.DataAzapiResource.IDataAzapiResourceConfig
        {
            ...
            {
                get => GetInstanceProperty<azapi.DataAzapiResource.IDataAzapiResourceRetry?>();
            }
            ...
            {
                get => GetInstanceProperty<azapi.DataAzapiResource.IDataAzapiResourceTimeouts?>();
            }
