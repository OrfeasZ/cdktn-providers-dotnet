...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/azure/azapi/2.10.0/docs/resources/data_plane_resource azapi_data_plane_resource}.</summary>
    [JsiiClass(nativeType: typeof(azapi.DataPlaneResource.DataPlaneResource), fullyQualifiedName: "azapi.dataPlaneResource.DataPlaneResource", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"remarks\":\"Must be unique amongst siblings in the same scope\",\"summary\":\"The scoped construct ID.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"azapi.dataPlaneResource.DataPlaneResourceConfig\"}}]")]
    public class DataPlaneResource : Io.Cdktn.TerraformResource
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/azure/azapi/2.10.0/docs/resources/data_plane_resource azapi_data_plane_resource} Resource.</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        /// <param name="id">The scoped construct ID.</param>
        public DataPlaneResource(Constructs.Construct scope, string id, azapi.DataPlaneResource.IDataPlaneResourceConfig config): base(_MakeDeputyProps(scope, id, config))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(Constructs.Construct scope, string id, azapi.DataPlaneResource.IDataPlaneResourceConfig config)
        {
        ...
        /// <summary>Generates CDKTN code for importing a DataPlaneResource resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        ...
        = GetStaticProperty<string>(typeof(azapi.DataPlaneResource.DataPlaneResource))!;
        ...
        public virtual azapi.DataPlaneResource.DataPlaneResourceRetryOutputReference Retry
        {
            get => GetInstanceProperty<azapi.DataPlaneResource.DataPlaneResourceRetryOutputReference>()!;
        }

        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"azapi.dataPlaneResource.DataPlaneResourceTimeoutsOutputReference\"}")]
        public virtual azapi.DataPlaneResource.DataPlaneResourceTimeoutsOutputReference Timeouts
        {
            get => GetInstanceProperty<azapi.DataPlaneResource.DataPlaneResourceTimeoutsOutputReference>()!;
        }
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "retryInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"azapi.dataPlaneResource.DataPlaneResourceRetry\"}]}}", isOptional: true)]
        ...
        /// <remarks>
        /// <para>Type union: either <see cref="Io.Cdktn.IResolvable" /> or <see cref="azapi.DataPlaneResource.IDataPlaneResourceTimeouts" /></para>
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "timeoutsInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"azapi.dataPlaneResource.DataPlaneResourceTimeouts\"}]}}", isOptional: true)]
