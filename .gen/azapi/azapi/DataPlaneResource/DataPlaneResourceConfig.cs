...
namespace azapi.DataPlaneResource
{
    ...
    public class DataPlaneResourceConfig : azapi.DataPlaneResource.IDataPlaneResourceConfig
    {
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case null:
                            break;
                        default:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: System.Collections.Generic.IDictionary<string, string[]>, {typeof(Io.Cdktn.IResolvable).FullName}; received {value.GetType().FullName}", nameof(value));
                    }
                }
