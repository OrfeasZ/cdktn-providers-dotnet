...
namespace random.Uuid7
{
    [JsiiInterface(nativeType: typeof(IUuid7Config), fullyQualifiedName: "random.uuid7.Uuid7Config")]
    public interface IUuid7Config : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IUuid7Config), fullyQualifiedName: "random.uuid7.Uuid7Config")]
        internal sealed class _Proxy : DeputyBase, random.Uuid7.IUuid7Config
        {
