...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/hashicorp/random/3.8.1/docs/resources/shuffle random_shuffle}.</summary>
    ...
    public class Shuffle : Io.Cdktn.TerraformResource
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/hashicorp/random/3.8.1/docs/resources/shuffle random_shuffle} Resource.</summary>
        ...
        /// <summary>Generates CDKTN code for importing a Shuffle resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
