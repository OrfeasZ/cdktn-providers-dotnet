...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesRedirDevsSourceDevSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesRedirDevsSourceDevSecLabel")]
    public interface IDomainDevicesRedirDevsSourceDevSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesRedirDevsSourceDevSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesRedirDevsSourceDevSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesRedirDevsSourceDevSecLabel
        {
