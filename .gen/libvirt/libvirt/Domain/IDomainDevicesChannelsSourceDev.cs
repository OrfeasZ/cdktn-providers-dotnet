...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesChannelsSourceDev), fullyQualifiedName: "libvirt.domain.DomainDevicesChannelsSourceDev")]
    public interface IDomainDevicesChannelsSourceDev
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesChannelsSourceDev), fullyQualifiedName: "libvirt.domain.DomainDevicesChannelsSourceDev")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesChannelsSourceDev
        {
