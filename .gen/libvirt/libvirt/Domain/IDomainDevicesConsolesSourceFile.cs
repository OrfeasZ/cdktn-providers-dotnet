...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesConsolesSourceFile), fullyQualifiedName: "libvirt.domain.DomainDevicesConsolesSourceFile")]
    public interface IDomainDevicesConsolesSourceFile
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "secLabel", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"libvirt.domain.DomainDevicesConsolesSourceFileSecLabel\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        object? SecLabel
        {
            get
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesConsolesSourceFile), fullyQualifiedName: "libvirt.domain.DomainDevicesConsolesSourceFile")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesConsolesSourceFile
        {
