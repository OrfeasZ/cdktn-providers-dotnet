...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainFeaturesCapabilitiesMkNod")]
    public class DomainFeaturesCapabilitiesMkNod : libvirt.Domain.IDomainFeaturesCapabilitiesMkNod
    {
