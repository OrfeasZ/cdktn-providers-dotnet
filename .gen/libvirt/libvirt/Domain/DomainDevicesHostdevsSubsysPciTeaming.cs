...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesHostdevsSubsysPciTeaming")]
    public class DomainDevicesHostdevsSubsysPciTeaming : libvirt.Domain.IDomainDevicesHostdevsSubsysPciTeaming
    {
