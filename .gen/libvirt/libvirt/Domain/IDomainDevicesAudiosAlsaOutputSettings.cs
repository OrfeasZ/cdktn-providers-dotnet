...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesAudiosAlsaOutputSettings), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosAlsaOutputSettings")]
    public interface IDomainDevicesAudiosAlsaOutputSettings
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesAudiosAlsaOutputSettings), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosAlsaOutputSettings")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesAudiosAlsaOutputSettings
        {
