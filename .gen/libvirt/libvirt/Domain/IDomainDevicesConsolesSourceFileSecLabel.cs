...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesConsolesSourceFileSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesConsolesSourceFileSecLabel")]
    public interface IDomainDevicesConsolesSourceFileSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesConsolesSourceFileSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesConsolesSourceFileSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesConsolesSourceFileSecLabel
        {
