...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesAudiosPipeWireOutputSettings")]
    public class DomainDevicesAudiosPipeWireOutputSettings : libvirt.Domain.IDomainDevicesAudiosPipeWireOutputSettings
    {
