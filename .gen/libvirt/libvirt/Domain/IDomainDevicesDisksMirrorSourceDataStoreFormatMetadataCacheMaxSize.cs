...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksMirrorSourceDataStoreFormatMetadataCacheMaxSize), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceDataStoreFormatMetadataCacheMaxSize")]
    public interface IDomainDevicesDisksMirrorSourceDataStoreFormatMetadataCacheMaxSize
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksMirrorSourceDataStoreFormatMetadataCacheMaxSize), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceDataStoreFormatMetadataCacheMaxSize")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksMirrorSourceDataStoreFormatMetadataCacheMaxSize
        {
