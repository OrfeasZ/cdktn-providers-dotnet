...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksSourceVhostUserTcpReconnect), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceVhostUserTcpReconnect")]
    public interface IDomainDevicesDisksSourceVhostUserTcpReconnect
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksSourceVhostUserTcpReconnect), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceVhostUserTcpReconnect")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksSourceVhostUserTcpReconnect
        {
