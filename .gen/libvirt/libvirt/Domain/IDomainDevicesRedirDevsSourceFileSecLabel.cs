...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesRedirDevsSourceFileSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesRedirDevsSourceFileSecLabel")]
    public interface IDomainDevicesRedirDevsSourceFileSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesRedirDevsSourceFileSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesRedirDevsSourceFileSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesRedirDevsSourceFileSecLabel
        {
