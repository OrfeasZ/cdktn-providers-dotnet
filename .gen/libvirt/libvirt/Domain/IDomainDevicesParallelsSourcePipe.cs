...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesParallelsSourcePipe), fullyQualifiedName: "libvirt.domain.DomainDevicesParallelsSourcePipe")]
    public interface IDomainDevicesParallelsSourcePipe
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "secLabel", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"libvirt.domain.DomainDevicesParallelsSourcePipeSecLabel\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesParallelsSourcePipe), fullyQualifiedName: "libvirt.domain.DomainDevicesParallelsSourcePipe")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesParallelsSourcePipe
        {
