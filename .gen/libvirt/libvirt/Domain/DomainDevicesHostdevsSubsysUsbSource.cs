...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesHostdevsSubsysUsbSource")]
    public class DomainDevicesHostdevsSubsysUsbSource : libvirt.Domain.IDomainDevicesHostdevsSubsysUsbSource
    {
