...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesSmartcardsPassthroughSpicePort")]
    public class DomainDevicesSmartcardsPassthroughSpicePort : libvirt.Domain.IDomainDevicesSmartcardsPassthroughSpicePort
    {
