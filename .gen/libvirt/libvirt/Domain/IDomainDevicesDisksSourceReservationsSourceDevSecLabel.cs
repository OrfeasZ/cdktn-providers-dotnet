...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksSourceReservationsSourceDevSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceReservationsSourceDevSecLabel")]
    public interface IDomainDevicesDisksSourceReservationsSourceDevSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksSourceReservationsSourceDevSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceReservationsSourceDevSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksSourceReservationsSourceDevSecLabel
        {
