...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesTpmsBackendExternalSourcePipeSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesTpmsBackendExternalSourcePipeSecLabel")]
    public interface IDomainDevicesTpmsBackendExternalSourcePipeSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesTpmsBackendExternalSourcePipeSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesTpmsBackendExternalSourcePipeSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesTpmsBackendExternalSourcePipeSecLabel
        {
