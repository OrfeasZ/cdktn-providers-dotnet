...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesCryptoAlias), fullyQualifiedName: "libvirt.domain.DomainDevicesCryptoAlias")]
    public interface IDomainDevicesCryptoAlias
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesCryptoAlias), fullyQualifiedName: "libvirt.domain.DomainDevicesCryptoAlias")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesCryptoAlias
        {
