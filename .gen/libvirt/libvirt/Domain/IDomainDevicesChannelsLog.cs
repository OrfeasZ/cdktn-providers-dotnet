...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesChannelsLog), fullyQualifiedName: "libvirt.domain.DomainDevicesChannelsLog")]
    public interface IDomainDevicesChannelsLog
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesChannelsLog), fullyQualifiedName: "libvirt.domain.DomainDevicesChannelsLog")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesChannelsLog
        {
