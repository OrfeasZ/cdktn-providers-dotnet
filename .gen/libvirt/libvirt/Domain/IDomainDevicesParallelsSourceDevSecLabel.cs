...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesParallelsSourceDevSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesParallelsSourceDevSecLabel")]
    public interface IDomainDevicesParallelsSourceDevSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesParallelsSourceDevSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesParallelsSourceDevSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesParallelsSourceDevSecLabel
        {
