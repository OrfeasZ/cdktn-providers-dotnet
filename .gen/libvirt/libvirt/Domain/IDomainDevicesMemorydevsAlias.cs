...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesMemorydevsAlias), fullyQualifiedName: "libvirt.domain.DomainDevicesMemorydevsAlias")]
    public interface IDomainDevicesMemorydevsAlias
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesMemorydevsAlias), fullyQualifiedName: "libvirt.domain.DomainDevicesMemorydevsAlias")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesMemorydevsAlias
        {
