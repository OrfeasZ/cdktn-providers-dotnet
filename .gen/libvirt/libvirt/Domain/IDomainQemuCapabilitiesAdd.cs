...
{
    [JsiiInterface(nativeType: typeof(IDomainQemuCapabilitiesAdd), fullyQualifiedName: "libvirt.domain.DomainQemuCapabilitiesAdd")]
    public interface IDomainQemuCapabilitiesAdd
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainQemuCapabilitiesAdd), fullyQualifiedName: "libvirt.domain.DomainQemuCapabilitiesAdd")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainQemuCapabilitiesAdd
        {
