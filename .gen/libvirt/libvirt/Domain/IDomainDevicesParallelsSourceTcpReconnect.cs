...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesParallelsSourceTcpReconnect), fullyQualifiedName: "libvirt.domain.DomainDevicesParallelsSourceTcpReconnect")]
    public interface IDomainDevicesParallelsSourceTcpReconnect
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesParallelsSourceTcpReconnect), fullyQualifiedName: "libvirt.domain.DomainDevicesParallelsSourceTcpReconnect")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesParallelsSourceTcpReconnect
        {
