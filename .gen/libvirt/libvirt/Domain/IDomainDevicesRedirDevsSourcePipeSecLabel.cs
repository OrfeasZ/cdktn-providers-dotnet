...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesRedirDevsSourcePipeSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesRedirDevsSourcePipeSecLabel")]
    public interface IDomainDevicesRedirDevsSourcePipeSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesRedirDevsSourcePipeSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesRedirDevsSourcePipeSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesRedirDevsSourcePipeSecLabel
        {
