...
{
    [JsiiInterface(nativeType: typeof(IDomainCpuNumaCellCachesSize), fullyQualifiedName: "libvirt.domain.DomainCpuNumaCellCachesSize")]
    public interface IDomainCpuNumaCellCachesSize
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainCpuNumaCellCachesSize), fullyQualifiedName: "libvirt.domain.DomainCpuNumaCellCachesSize")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainCpuNumaCellCachesSize
        {
