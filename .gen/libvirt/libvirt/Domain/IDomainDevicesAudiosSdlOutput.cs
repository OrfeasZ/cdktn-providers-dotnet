...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesAudiosSdlOutput), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosSdlOutput")]
    public interface IDomainDevicesAudiosSdlOutput
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        libvirt.Domain.IDomainDevicesAudiosSdlOutputSettings? Settings
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesAudiosSdlOutput), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosSdlOutput")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesAudiosSdlOutput
        {
            ...
            {
                get => GetInstanceProperty<libvirt.Domain.IDomainDevicesAudiosSdlOutputSettings?>();
            }
