...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksMirrorSourceDir")]
    public class DomainDevicesDisksMirrorSourceDir : libvirt.Domain.IDomainDevicesDisksMirrorSourceDir
    {
