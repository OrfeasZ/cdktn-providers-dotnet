...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesSmartcardsPassthroughPipeSecLabel")]
    public class DomainDevicesSmartcardsPassthroughPipeSecLabel : libvirt.Domain.IDomainDevicesSmartcardsPassthroughPipeSecLabel
    {
