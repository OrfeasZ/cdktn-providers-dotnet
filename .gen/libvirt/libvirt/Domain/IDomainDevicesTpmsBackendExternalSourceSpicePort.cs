...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesTpmsBackendExternalSourceSpicePort), fullyQualifiedName: "libvirt.domain.DomainDevicesTpmsBackendExternalSourceSpicePort")]
    public interface IDomainDevicesTpmsBackendExternalSourceSpicePort
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesTpmsBackendExternalSourceSpicePort), fullyQualifiedName: "libvirt.domain.DomainDevicesTpmsBackendExternalSourceSpicePort")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesTpmsBackendExternalSourceSpicePort
        {
