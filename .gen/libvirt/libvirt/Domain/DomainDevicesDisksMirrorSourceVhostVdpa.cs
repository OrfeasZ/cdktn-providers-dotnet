...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksMirrorSourceVhostVdpa")]
    public class DomainDevicesDisksMirrorSourceVhostVdpa : libvirt.Domain.IDomainDevicesDisksMirrorSourceVhostVdpa
    {
