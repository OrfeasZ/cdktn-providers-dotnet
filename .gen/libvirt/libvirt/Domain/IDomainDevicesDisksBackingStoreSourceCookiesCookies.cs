...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksBackingStoreSourceCookiesCookies), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackingStoreSourceCookiesCookies")]
    public interface IDomainDevicesDisksBackingStoreSourceCookiesCookies
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksBackingStoreSourceCookiesCookies), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackingStoreSourceCookiesCookies")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksBackingStoreSourceCookiesCookies
        {
