...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksBackingStoreSourceBlock")]
    public class DomainDevicesDisksBackingStoreSourceBlock : libvirt.Domain.IDomainDevicesDisksBackingStoreSourceBlock
    {
