...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesChannelsSourceTcp")]
    public class DomainDevicesChannelsSourceTcp : libvirt.Domain.IDomainDevicesChannelsSourceTcp
    {
