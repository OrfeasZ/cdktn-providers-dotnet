...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksMirrorSourceVhostUserDev")]
    public class DomainDevicesDisksMirrorSourceVhostUserDev : libvirt.Domain.IDomainDevicesDisksMirrorSourceVhostUserDev
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "secLabel", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"libvirt.domain.DomainDevicesDisksMirrorSourceVhostUserDevSecLabel\"},\"kind\":\"array\"}}]}}", isOptional: true)]
