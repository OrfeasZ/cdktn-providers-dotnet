...
{
    [JsiiInterface(nativeType: typeof(IDomainFeaturesCapabilitiesMacOverride), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesMacOverride")]
    public interface IDomainFeaturesCapabilitiesMacOverride
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainFeaturesCapabilitiesMacOverride), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesMacOverride")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainFeaturesCapabilitiesMacOverride
        {
