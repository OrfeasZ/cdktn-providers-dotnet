...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesInterfacesSourceVhostUserChardevUnixReconnect), fullyQualifiedName: "libvirt.domain.DomainDevicesInterfacesSourceVhostUserChardevUnixReconnect")]
    public interface IDomainDevicesInterfacesSourceVhostUserChardevUnixReconnect
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesInterfacesSourceVhostUserChardevUnixReconnect), fullyQualifiedName: "libvirt.domain.DomainDevicesInterfacesSourceVhostUserChardevUnixReconnect")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesInterfacesSourceVhostUserChardevUnixReconnect
        {
