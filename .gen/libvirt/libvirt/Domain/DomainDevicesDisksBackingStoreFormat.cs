...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksBackingStoreFormat")]
    public class DomainDevicesDisksBackingStoreFormat : libvirt.Domain.IDomainDevicesDisksBackingStoreFormat
    {
