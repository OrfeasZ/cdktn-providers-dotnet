...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksMirrorSourceFileSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceFileSecLabel")]
    public interface IDomainDevicesDisksMirrorSourceFileSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksMirrorSourceFileSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceFileSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksMirrorSourceFileSecLabel
        {
