...
{
    [JsiiInterface(nativeType: typeof(IDomainFeaturesCapabilitiesChown), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesChown")]
    public interface IDomainFeaturesCapabilitiesChown
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainFeaturesCapabilitiesChown), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesChown")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainFeaturesCapabilitiesChown
        {
