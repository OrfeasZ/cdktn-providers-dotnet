...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesTpmsBackendExternalSourceUnixSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesTpmsBackendExternalSourceUnixSecLabel")]
    public interface IDomainDevicesTpmsBackendExternalSourceUnixSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesTpmsBackendExternalSourceUnixSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesTpmsBackendExternalSourceUnixSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesTpmsBackendExternalSourceUnixSecLabel
        {
