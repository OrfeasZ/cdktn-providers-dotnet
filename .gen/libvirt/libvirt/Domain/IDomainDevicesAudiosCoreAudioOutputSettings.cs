...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesAudiosCoreAudioOutputSettings), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosCoreAudioOutputSettings")]
    public interface IDomainDevicesAudiosCoreAudioOutputSettings
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesAudiosCoreAudioOutputSettings), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosCoreAudioOutputSettings")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesAudiosCoreAudioOutputSettings
        {
