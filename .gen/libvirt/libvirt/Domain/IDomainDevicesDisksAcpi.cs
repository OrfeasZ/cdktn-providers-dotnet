...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksAcpi), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksAcpi")]
    public interface IDomainDevicesDisksAcpi
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksAcpi), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksAcpi")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksAcpi
        {
