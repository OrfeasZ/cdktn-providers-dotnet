...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksMirrorBackingStoreSourceVolume")]
    public class DomainDevicesDisksMirrorBackingStoreSourceVolume : libvirt.Domain.IDomainDevicesDisksMirrorBackingStoreSourceVolume
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "secLabel", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"libvirt.domain.DomainDevicesDisksMirrorBackingStoreSourceVolumeSecLabel\"},\"kind\":\"array\"}}]}}", isOptional: true)]
