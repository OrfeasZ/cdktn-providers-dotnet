...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesSmartcardsProtocol), fullyQualifiedName: "libvirt.domain.DomainDevicesSmartcardsProtocol")]
    public interface IDomainDevicesSmartcardsProtocol
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesSmartcardsProtocol), fullyQualifiedName: "libvirt.domain.DomainDevicesSmartcardsProtocol")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesSmartcardsProtocol
        {
