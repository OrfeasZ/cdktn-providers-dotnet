...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesAudiosOssOutput")]
    public class DomainDevicesAudiosOssOutput : libvirt.Domain.IDomainDevicesAudiosOssOutput
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "settings", typeJson: "{\"fqn\":\"libvirt.domain.DomainDevicesAudiosOssOutputSettings\"}", isOptional: true)]
        public libvirt.Domain.IDomainDevicesAudiosOssOutputSettings? Settings
        {
            get;
            set;
        }
