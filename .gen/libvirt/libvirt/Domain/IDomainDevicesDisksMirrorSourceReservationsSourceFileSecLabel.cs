...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksMirrorSourceReservationsSourceFileSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceReservationsSourceFileSecLabel")]
    public interface IDomainDevicesDisksMirrorSourceReservationsSourceFileSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksMirrorSourceReservationsSourceFileSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceReservationsSourceFileSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksMirrorSourceReservationsSourceFileSecLabel
        {
