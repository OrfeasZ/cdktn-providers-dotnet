...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesRngsBackendEgdSourceFileSecLabel")]
    public class DomainDevicesRngsBackendEgdSourceFileSecLabel : libvirt.Domain.IDomainDevicesRngsBackendEgdSourceFileSecLabel
    {
