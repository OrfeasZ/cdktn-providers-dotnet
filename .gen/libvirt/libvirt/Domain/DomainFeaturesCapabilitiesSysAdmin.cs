...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainFeaturesCapabilitiesSysAdmin")]
    public class DomainFeaturesCapabilitiesSysAdmin : libvirt.Domain.IDomainFeaturesCapabilitiesSysAdmin
    {
