...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksMirrorSourceVhostUserUnixSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceVhostUserUnixSecLabel")]
    public interface IDomainDevicesDisksMirrorSourceVhostUserUnixSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksMirrorSourceVhostUserUnixSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceVhostUserUnixSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksMirrorSourceVhostUserUnixSecLabel
        {
