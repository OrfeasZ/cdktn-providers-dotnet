...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesWatchdogsAcpi), fullyQualifiedName: "libvirt.domain.DomainDevicesWatchdogsAcpi")]
    public interface IDomainDevicesWatchdogsAcpi
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesWatchdogsAcpi), fullyQualifiedName: "libvirt.domain.DomainDevicesWatchdogsAcpi")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesWatchdogsAcpi
        {
