...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksSourceVhostUserUnixSecLabel")]
    public class DomainDevicesDisksSourceVhostUserUnixSecLabel : libvirt.Domain.IDomainDevicesDisksSourceVhostUserUnixSecLabel
    {
