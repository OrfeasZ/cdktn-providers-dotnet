...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainOsNvRamSourceNetworkSnapshot")]
    public class DomainOsNvRamSourceNetworkSnapshot : libvirt.Domain.IDomainOsNvRamSourceNetworkSnapshot
    {
