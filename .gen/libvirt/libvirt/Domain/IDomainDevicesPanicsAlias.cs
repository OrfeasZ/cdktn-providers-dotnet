...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesPanicsAlias), fullyQualifiedName: "libvirt.domain.DomainDevicesPanicsAlias")]
    public interface IDomainDevicesPanicsAlias
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesPanicsAlias), fullyQualifiedName: "libvirt.domain.DomainDevicesPanicsAlias")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesPanicsAlias
        {
