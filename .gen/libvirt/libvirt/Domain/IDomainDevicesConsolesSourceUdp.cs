...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesConsolesSourceUdp), fullyQualifiedName: "libvirt.domain.DomainDevicesConsolesSourceUdp")]
    public interface IDomainDevicesConsolesSourceUdp
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesConsolesSourceUdp), fullyQualifiedName: "libvirt.domain.DomainDevicesConsolesSourceUdp")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesConsolesSourceUdp
        {
