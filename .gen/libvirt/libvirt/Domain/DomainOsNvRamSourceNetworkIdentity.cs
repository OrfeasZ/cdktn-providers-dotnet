...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainOsNvRamSourceNetworkIdentity")]
    public class DomainOsNvRamSourceNetworkIdentity : libvirt.Domain.IDomainOsNvRamSourceNetworkIdentity
    {
