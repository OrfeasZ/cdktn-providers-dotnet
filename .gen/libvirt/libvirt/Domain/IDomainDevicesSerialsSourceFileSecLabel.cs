...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesSerialsSourceFileSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesSerialsSourceFileSecLabel")]
    public interface IDomainDevicesSerialsSourceFileSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesSerialsSourceFileSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesSerialsSourceFileSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesSerialsSourceFileSecLabel
        {
