...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesConsolesSourcePtySecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesConsolesSourcePtySecLabel")]
    public interface IDomainDevicesConsolesSourcePtySecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesConsolesSourcePtySecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesConsolesSourcePtySecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesConsolesSourcePtySecLabel
        {
