...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesRedirDevsSourceUdp), fullyQualifiedName: "libvirt.domain.DomainDevicesRedirDevsSourceUdp")]
    public interface IDomainDevicesRedirDevsSourceUdp
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesRedirDevsSourceUdp), fullyQualifiedName: "libvirt.domain.DomainDevicesRedirDevsSourceUdp")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesRedirDevsSourceUdp
        {
