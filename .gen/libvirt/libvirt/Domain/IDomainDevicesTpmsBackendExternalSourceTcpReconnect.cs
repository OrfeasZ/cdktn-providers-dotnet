...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesTpmsBackendExternalSourceTcpReconnect), fullyQualifiedName: "libvirt.domain.DomainDevicesTpmsBackendExternalSourceTcpReconnect")]
    public interface IDomainDevicesTpmsBackendExternalSourceTcpReconnect
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesTpmsBackendExternalSourceTcpReconnect), fullyQualifiedName: "libvirt.domain.DomainDevicesTpmsBackendExternalSourceTcpReconnect")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesTpmsBackendExternalSourceTcpReconnect
        {
