...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesSerialsSourceUnixReconnect), fullyQualifiedName: "libvirt.domain.DomainDevicesSerialsSourceUnixReconnect")]
    public interface IDomainDevicesSerialsSourceUnixReconnect
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesSerialsSourceUnixReconnect), fullyQualifiedName: "libvirt.domain.DomainDevicesSerialsSourceUnixReconnect")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesSerialsSourceUnixReconnect
        {
