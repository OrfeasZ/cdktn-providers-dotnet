...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksMirrorSourceEncryptionSecrets")]
    public class DomainDevicesDisksMirrorSourceEncryptionSecrets : libvirt.Domain.IDomainDevicesDisksMirrorSourceEncryptionSecrets
    {
