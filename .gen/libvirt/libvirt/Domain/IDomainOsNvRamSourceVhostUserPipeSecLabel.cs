...
{
    [JsiiInterface(nativeType: typeof(IDomainOsNvRamSourceVhostUserPipeSecLabel), fullyQualifiedName: "libvirt.domain.DomainOsNvRamSourceVhostUserPipeSecLabel")]
    public interface IDomainOsNvRamSourceVhostUserPipeSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainOsNvRamSourceVhostUserPipeSecLabel), fullyQualifiedName: "libvirt.domain.DomainOsNvRamSourceVhostUserPipeSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainOsNvRamSourceVhostUserPipeSecLabel
        {
