...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksMirrorSourceSsl")]
    public class DomainDevicesDisksMirrorSourceSsl : libvirt.Domain.IDomainDevicesDisksMirrorSourceSsl
    {
