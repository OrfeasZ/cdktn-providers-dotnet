...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesRedirDevsProtocol")]
    public class DomainDevicesRedirDevsProtocol : libvirt.Domain.IDomainDevicesRedirDevsProtocol
    {
