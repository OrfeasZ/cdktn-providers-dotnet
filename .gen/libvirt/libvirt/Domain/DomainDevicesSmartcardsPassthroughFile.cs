...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesSmartcardsPassthroughFile")]
    public class DomainDevicesSmartcardsPassthroughFile : libvirt.Domain.IDomainDevicesSmartcardsPassthroughFile
    {
