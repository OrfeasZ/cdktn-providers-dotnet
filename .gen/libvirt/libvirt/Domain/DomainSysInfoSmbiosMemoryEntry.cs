...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainSysInfoSmbiosMemoryEntry")]
    public class DomainSysInfoSmbiosMemoryEntry : libvirt.Domain.IDomainSysInfoSmbiosMemoryEntry
    {
