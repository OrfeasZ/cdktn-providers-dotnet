...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesParallelsSourceNmdm")]
    public class DomainDevicesParallelsSourceNmdm : libvirt.Domain.IDomainDevicesParallelsSourceNmdm
    {
