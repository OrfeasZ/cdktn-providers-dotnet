...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesSmartcardsPassthroughSpicePort), fullyQualifiedName: "libvirt.domain.DomainDevicesSmartcardsPassthroughSpicePort")]
    public interface IDomainDevicesSmartcardsPassthroughSpicePort
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesSmartcardsPassthroughSpicePort), fullyQualifiedName: "libvirt.domain.DomainDevicesSmartcardsPassthroughSpicePort")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesSmartcardsPassthroughSpicePort
        {
