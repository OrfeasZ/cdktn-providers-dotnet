...
{
    [JsiiInterface(nativeType: typeof(IDomainFeaturesCapabilitiesSysBoot), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesSysBoot")]
    public interface IDomainFeaturesCapabilitiesSysBoot
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainFeaturesCapabilitiesSysBoot), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesSysBoot")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainFeaturesCapabilitiesSysBoot
        {
