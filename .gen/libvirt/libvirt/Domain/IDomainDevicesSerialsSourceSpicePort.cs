...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesSerialsSourceSpicePort), fullyQualifiedName: "libvirt.domain.DomainDevicesSerialsSourceSpicePort")]
    public interface IDomainDevicesSerialsSourceSpicePort
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesSerialsSourceSpicePort), fullyQualifiedName: "libvirt.domain.DomainDevicesSerialsSourceSpicePort")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesSerialsSourceSpicePort
        {
