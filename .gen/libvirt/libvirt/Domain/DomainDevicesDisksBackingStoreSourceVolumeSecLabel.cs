...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksBackingStoreSourceVolumeSecLabel")]
    public class DomainDevicesDisksBackingStoreSourceVolumeSecLabel : libvirt.Domain.IDomainDevicesDisksBackingStoreSourceVolumeSecLabel
    {
