...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksMirrorSourceVhostUserDevSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceVhostUserDevSecLabel")]
    public interface IDomainDevicesDisksMirrorSourceVhostUserDevSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksMirrorSourceVhostUserDevSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceVhostUserDevSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksMirrorSourceVhostUserDevSecLabel
        {
