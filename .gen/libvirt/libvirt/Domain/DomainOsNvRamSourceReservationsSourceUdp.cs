...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainOsNvRamSourceReservationsSourceUdp")]
    public class DomainOsNvRamSourceReservationsSourceUdp : libvirt.Domain.IDomainOsNvRamSourceReservationsSourceUdp
    {
