...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksMirrorSourceVolumeSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceVolumeSecLabel")]
    public interface IDomainDevicesDisksMirrorSourceVolumeSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksMirrorSourceVolumeSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceVolumeSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksMirrorSourceVolumeSecLabel
        {
