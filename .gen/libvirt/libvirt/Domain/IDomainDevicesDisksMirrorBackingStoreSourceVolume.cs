...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksMirrorBackingStoreSourceVolume), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorBackingStoreSourceVolume")]
    public interface IDomainDevicesDisksMirrorBackingStoreSourceVolume
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksMirrorBackingStoreSourceVolume), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorBackingStoreSourceVolume")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksMirrorBackingStoreSourceVolume
        {
