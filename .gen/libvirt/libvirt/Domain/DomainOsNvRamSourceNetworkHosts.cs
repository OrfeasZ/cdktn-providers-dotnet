...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainOsNvRamSourceNetworkHosts")]
    public class DomainOsNvRamSourceNetworkHosts : libvirt.Domain.IDomainOsNvRamSourceNetworkHosts
    {
