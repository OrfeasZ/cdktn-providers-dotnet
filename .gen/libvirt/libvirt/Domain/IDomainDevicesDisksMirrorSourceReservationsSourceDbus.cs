...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksMirrorSourceReservationsSourceDbus), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceReservationsSourceDbus")]
    public interface IDomainDevicesDisksMirrorSourceReservationsSourceDbus
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksMirrorSourceReservationsSourceDbus), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceReservationsSourceDbus")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksMirrorSourceReservationsSourceDbus
        {
