...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksSourceVhostUserNmdm")]
    public class DomainDevicesDisksSourceVhostUserNmdm : libvirt.Domain.IDomainDevicesDisksSourceVhostUserNmdm
    {
