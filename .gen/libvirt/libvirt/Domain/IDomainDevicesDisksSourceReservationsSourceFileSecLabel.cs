...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksSourceReservationsSourceFileSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceReservationsSourceFileSecLabel")]
    public interface IDomainDevicesDisksSourceReservationsSourceFileSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksSourceReservationsSourceFileSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceReservationsSourceFileSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksSourceReservationsSourceFileSecLabel
        {
