...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksMirrorSourceReservationsSourceTcp), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceReservationsSourceTcp")]
    public interface IDomainDevicesDisksMirrorSourceReservationsSourceTcp
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        libvirt.Domain.IDomainDevicesDisksMirrorSourceReservationsSourceTcpReconnect? Reconnect
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksMirrorSourceReservationsSourceTcp), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceReservationsSourceTcp")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksMirrorSourceReservationsSourceTcp
        {
            ...
            {
                get => GetInstanceProperty<libvirt.Domain.IDomainDevicesDisksMirrorSourceReservationsSourceTcpReconnect?>();
            }
