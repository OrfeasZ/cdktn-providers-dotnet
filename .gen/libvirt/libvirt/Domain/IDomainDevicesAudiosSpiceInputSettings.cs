...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesAudiosSpiceInputSettings), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosSpiceInputSettings")]
    public interface IDomainDevicesAudiosSpiceInputSettings
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesAudiosSpiceInputSettings), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosSpiceInputSettings")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesAudiosSpiceInputSettings
        {
