...
{
    [JsiiInterface(nativeType: typeof(IDomainFeaturesPs2), fullyQualifiedName: "libvirt.domain.DomainFeaturesPs2")]
    public interface IDomainFeaturesPs2
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainFeaturesPs2), fullyQualifiedName: "libvirt.domain.DomainFeaturesPs2")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainFeaturesPs2
        {
