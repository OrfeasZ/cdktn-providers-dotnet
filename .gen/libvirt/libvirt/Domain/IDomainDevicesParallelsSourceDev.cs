...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesParallelsSourceDev), fullyQualifiedName: "libvirt.domain.DomainDevicesParallelsSourceDev")]
    public interface IDomainDevicesParallelsSourceDev
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "secLabel", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"libvirt.domain.DomainDevicesParallelsSourceDevSecLabel\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesParallelsSourceDev), fullyQualifiedName: "libvirt.domain.DomainDevicesParallelsSourceDev")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesParallelsSourceDev
        {
