...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesConsolesSourceDbus")]
    public class DomainDevicesConsolesSourceDbus : libvirt.Domain.IDomainDevicesConsolesSourceDbus
    {
