...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesAudiosSpiceOutput), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosSpiceOutput")]
    public interface IDomainDevicesAudiosSpiceOutput
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        libvirt.Domain.IDomainDevicesAudiosSpiceOutputSettings? Settings
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesAudiosSpiceOutput), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosSpiceOutput")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesAudiosSpiceOutput
        {
            ...
            {
                get => GetInstanceProperty<libvirt.Domain.IDomainDevicesAudiosSpiceOutputSettings?>();
            }
