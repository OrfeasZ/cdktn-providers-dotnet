...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainOsNvRamSourceVhostUserDbus")]
    public class DomainOsNvRamSourceVhostUserDbus : libvirt.Domain.IDomainOsNvRamSourceVhostUserDbus
    {
