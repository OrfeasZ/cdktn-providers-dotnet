...
{
    [JsiiInterface(nativeType: typeof(IDomainResource), fullyQualifiedName: "libvirt.domain.DomainResource")]
    public interface IDomainResource
    {
        ...
        libvirt.Domain.IDomainResourceFibreChannel? FibreChannel
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainResource), fullyQualifiedName: "libvirt.domain.DomainResource")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainResource
        {
            ...
            {
                get => GetInstanceProperty<libvirt.Domain.IDomainResourceFibreChannel?>();
            }
