...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesChannelsSourceUdp), fullyQualifiedName: "libvirt.domain.DomainDevicesChannelsSourceUdp")]
    public interface IDomainDevicesChannelsSourceUdp
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesChannelsSourceUdp), fullyQualifiedName: "libvirt.domain.DomainDevicesChannelsSourceUdp")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesChannelsSourceUdp
        {
