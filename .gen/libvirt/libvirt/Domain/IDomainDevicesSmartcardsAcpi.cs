...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesSmartcardsAcpi), fullyQualifiedName: "libvirt.domain.DomainDevicesSmartcardsAcpi")]
    public interface IDomainDevicesSmartcardsAcpi
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesSmartcardsAcpi), fullyQualifiedName: "libvirt.domain.DomainDevicesSmartcardsAcpi")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesSmartcardsAcpi
        {
