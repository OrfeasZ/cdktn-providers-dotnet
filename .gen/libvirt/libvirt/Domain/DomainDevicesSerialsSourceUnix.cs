...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesSerialsSourceUnix")]
    public class DomainDevicesSerialsSourceUnix : libvirt.Domain.IDomainDevicesSerialsSourceUnix
    {
