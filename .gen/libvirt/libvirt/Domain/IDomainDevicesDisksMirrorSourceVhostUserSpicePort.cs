...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksMirrorSourceVhostUserSpicePort), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceVhostUserSpicePort")]
    public interface IDomainDevicesDisksMirrorSourceVhostUserSpicePort
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksMirrorSourceVhostUserSpicePort), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceVhostUserSpicePort")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksMirrorSourceVhostUserSpicePort
        {
