...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesParallelsSourceDevSecLabel")]
    public class DomainDevicesParallelsSourceDevSecLabel : libvirt.Domain.IDomainDevicesParallelsSourceDevSecLabel
    {
