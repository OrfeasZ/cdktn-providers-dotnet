...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesRngsBackendEgdSourceUnix")]
    public class DomainDevicesRngsBackendEgdSourceUnix : libvirt.Domain.IDomainDevicesRngsBackendEgdSourceUnix
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "reconnect", typeJson: "{\"fqn\":\"libvirt.domain.DomainDevicesRngsBackendEgdSourceUnixReconnect\"}", isOptional: true)]
        public libvirt.Domain.IDomainDevicesRngsBackendEgdSourceUnixReconnect? Reconnect
        {
            get;
            set;
        }
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "secLabel", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"libvirt.domain.DomainDevicesRngsBackendEgdSourceUnixSecLabel\"},\"kind\":\"array\"}}]}}", isOptional: true)]
