...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesAudiosPulseAudioInput")]
    public class DomainDevicesAudiosPulseAudioInput : libvirt.Domain.IDomainDevicesAudiosPulseAudioInput
    {
