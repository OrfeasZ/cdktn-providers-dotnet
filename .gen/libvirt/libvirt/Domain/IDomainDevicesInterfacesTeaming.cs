...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesInterfacesTeaming), fullyQualifiedName: "libvirt.domain.DomainDevicesInterfacesTeaming")]
    public interface IDomainDevicesInterfacesTeaming
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesInterfacesTeaming), fullyQualifiedName: "libvirt.domain.DomainDevicesInterfacesTeaming")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesInterfacesTeaming
        {
