...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesInterfacesSourceEthernetIp), fullyQualifiedName: "libvirt.domain.DomainDevicesInterfacesSourceEthernetIp")]
    public interface IDomainDevicesInterfacesSourceEthernetIp
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesInterfacesSourceEthernetIp), fullyQualifiedName: "libvirt.domain.DomainDevicesInterfacesSourceEthernetIp")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesInterfacesSourceEthernetIp
        {
