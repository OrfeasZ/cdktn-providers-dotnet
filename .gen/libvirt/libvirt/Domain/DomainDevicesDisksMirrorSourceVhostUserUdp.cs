...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksMirrorSourceVhostUserUdp")]
    public class DomainDevicesDisksMirrorSourceVhostUserUdp : libvirt.Domain.IDomainDevicesDisksMirrorSourceVhostUserUdp
    {
