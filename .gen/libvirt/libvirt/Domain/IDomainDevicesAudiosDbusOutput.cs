...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesAudiosDbusOutput), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosDbusOutput")]
    public interface IDomainDevicesAudiosDbusOutput
    {
        ...
        [JsiiProperty(name: "settings", typeJson: "{\"fqn\":\"libvirt.domain.DomainDevicesAudiosDbusOutputSettings\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        libvirt.Domain.IDomainDevicesAudiosDbusOutputSettings? Settings
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesAudiosDbusOutput), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosDbusOutput")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesAudiosDbusOutput
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "settings", typeJson: "{\"fqn\":\"libvirt.domain.DomainDevicesAudiosDbusOutputSettings\"}", isOptional: true)]
            public libvirt.Domain.IDomainDevicesAudiosDbusOutputSettings? Settings
            {
                get => GetInstanceProperty<libvirt.Domain.IDomainDevicesAudiosDbusOutputSettings?>();
            }
