...
{
    [JsiiInterface(nativeType: typeof(IDomainFeaturesCapabilitiesSysModule), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesSysModule")]
    public interface IDomainFeaturesCapabilitiesSysModule
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainFeaturesCapabilitiesSysModule), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesSysModule")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainFeaturesCapabilitiesSysModule
        {
