...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesParallelsSourcePty), fullyQualifiedName: "libvirt.domain.DomainDevicesParallelsSourcePty")]
    public interface IDomainDevicesParallelsSourcePty
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesParallelsSourcePty), fullyQualifiedName: "libvirt.domain.DomainDevicesParallelsSourcePty")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesParallelsSourcePty
        {
