...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesSerialsSourcePipe")]
    public class DomainDevicesSerialsSourcePipe : libvirt.Domain.IDomainDevicesSerialsSourcePipe
    {
