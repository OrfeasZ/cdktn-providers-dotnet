...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksSourceDataStore")]
    public class DomainDevicesDisksSourceDataStore : libvirt.Domain.IDomainDevicesDisksSourceDataStore
    {
