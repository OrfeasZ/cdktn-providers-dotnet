...
{
    [JsiiInterface(nativeType: typeof(IDomainOsNvRamSourceReservationsSourceTcpReconnect), fullyQualifiedName: "libvirt.domain.DomainOsNvRamSourceReservationsSourceTcpReconnect")]
    public interface IDomainOsNvRamSourceReservationsSourceTcpReconnect
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainOsNvRamSourceReservationsSourceTcpReconnect), fullyQualifiedName: "libvirt.domain.DomainOsNvRamSourceReservationsSourceTcpReconnect")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainOsNvRamSourceReservationsSourceTcpReconnect
        {
