...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesConsolesAcpi), fullyQualifiedName: "libvirt.domain.DomainDevicesConsolesAcpi")]
    public interface IDomainDevicesConsolesAcpi
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesConsolesAcpi), fullyQualifiedName: "libvirt.domain.DomainDevicesConsolesAcpi")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesConsolesAcpi
        {
