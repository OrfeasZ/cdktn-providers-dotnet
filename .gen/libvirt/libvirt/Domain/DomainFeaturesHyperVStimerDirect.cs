...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainFeaturesHyperVStimerDirect")]
    public class DomainFeaturesHyperVStimerDirect : libvirt.Domain.IDomainFeaturesHyperVStimerDirect
    {
