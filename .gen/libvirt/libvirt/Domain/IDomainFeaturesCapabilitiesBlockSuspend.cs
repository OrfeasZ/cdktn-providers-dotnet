...
{
    [JsiiInterface(nativeType: typeof(IDomainFeaturesCapabilitiesBlockSuspend), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesBlockSuspend")]
    public interface IDomainFeaturesCapabilitiesBlockSuspend
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainFeaturesCapabilitiesBlockSuspend), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesBlockSuspend")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainFeaturesCapabilitiesBlockSuspend
        {
