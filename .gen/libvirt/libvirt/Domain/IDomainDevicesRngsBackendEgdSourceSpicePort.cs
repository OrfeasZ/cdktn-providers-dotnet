...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesRngsBackendEgdSourceSpicePort), fullyQualifiedName: "libvirt.domain.DomainDevicesRngsBackendEgdSourceSpicePort")]
    public interface IDomainDevicesRngsBackendEgdSourceSpicePort
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesRngsBackendEgdSourceSpicePort), fullyQualifiedName: "libvirt.domain.DomainDevicesRngsBackendEgdSourceSpicePort")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesRngsBackendEgdSourceSpicePort
        {
