...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesSerialsSourceUdp), fullyQualifiedName: "libvirt.domain.DomainDevicesSerialsSourceUdp")]
    public interface IDomainDevicesSerialsSourceUdp
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesSerialsSourceUdp), fullyQualifiedName: "libvirt.domain.DomainDevicesSerialsSourceUdp")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesSerialsSourceUdp
        {
