...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesSerialsSourceDbus")]
    public class DomainDevicesSerialsSourceDbus : libvirt.Domain.IDomainDevicesSerialsSourceDbus
    {
