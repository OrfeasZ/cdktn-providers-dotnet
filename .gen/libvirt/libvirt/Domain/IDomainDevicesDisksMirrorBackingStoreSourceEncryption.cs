...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksMirrorBackingStoreSourceEncryption), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorBackingStoreSourceEncryption")]
    public interface IDomainDevicesDisksMirrorBackingStoreSourceEncryption
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "secrets", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"libvirt.domain.DomainDevicesDisksMirrorBackingStoreSourceEncryptionSecrets\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        object? Secrets
        {
            get
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksMirrorBackingStoreSourceEncryption), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorBackingStoreSourceEncryption")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksMirrorBackingStoreSourceEncryption
        {
