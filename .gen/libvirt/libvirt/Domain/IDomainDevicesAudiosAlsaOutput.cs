...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesAudiosAlsaOutput), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosAlsaOutput")]
    public interface IDomainDevicesAudiosAlsaOutput
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        libvirt.Domain.IDomainDevicesAudiosAlsaOutputSettings? Settings
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesAudiosAlsaOutput), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosAlsaOutput")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesAudiosAlsaOutput
        {
            ...
            {
                get => GetInstanceProperty<libvirt.Domain.IDomainDevicesAudiosAlsaOutputSettings?>();
            }
