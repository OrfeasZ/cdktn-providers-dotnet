...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesSmartcardsPassthroughUdp), fullyQualifiedName: "libvirt.domain.DomainDevicesSmartcardsPassthroughUdp")]
    public interface IDomainDevicesSmartcardsPassthroughUdp
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesSmartcardsPassthroughUdp), fullyQualifiedName: "libvirt.domain.DomainDevicesSmartcardsPassthroughUdp")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesSmartcardsPassthroughUdp
        {
