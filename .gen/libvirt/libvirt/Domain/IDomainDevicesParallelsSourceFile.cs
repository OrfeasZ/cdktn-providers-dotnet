...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesParallelsSourceFile), fullyQualifiedName: "libvirt.domain.DomainDevicesParallelsSourceFile")]
    public interface IDomainDevicesParallelsSourceFile
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "secLabel", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"libvirt.domain.DomainDevicesParallelsSourceFileSecLabel\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        object? SecLabel
        {
            get
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesParallelsSourceFile), fullyQualifiedName: "libvirt.domain.DomainDevicesParallelsSourceFile")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesParallelsSourceFile
        {
