...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesRngsBackendEgdSourceDevSecLabel")]
    public class DomainDevicesRngsBackendEgdSourceDevSecLabel : libvirt.Domain.IDomainDevicesRngsBackendEgdSourceDevSecLabel
    {
