...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesGraphicsRdpListenersAddress")]
    public class DomainDevicesGraphicsRdpListenersAddress : libvirt.Domain.IDomainDevicesGraphicsRdpListenersAddress
    {
