...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesTpmsAlias), fullyQualifiedName: "libvirt.domain.DomainDevicesTpmsAlias")]
    public interface IDomainDevicesTpmsAlias
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesTpmsAlias), fullyQualifiedName: "libvirt.domain.DomainDevicesTpmsAlias")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesTpmsAlias
        {
