...
{
    [JsiiInterface(nativeType: typeof(IDomainFeaturesHyperVRuntime), fullyQualifiedName: "libvirt.domain.DomainFeaturesHyperVRuntime")]
    public interface IDomainFeaturesHyperVRuntime
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainFeaturesHyperVRuntime), fullyQualifiedName: "libvirt.domain.DomainFeaturesHyperVRuntime")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainFeaturesHyperVRuntime
        {
