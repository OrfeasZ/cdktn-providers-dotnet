...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksBackingStoreFormatMetadataCache")]
    public class DomainDevicesDisksBackingStoreFormatMetadataCache : libvirt.Domain.IDomainDevicesDisksBackingStoreFormatMetadataCache
    {
