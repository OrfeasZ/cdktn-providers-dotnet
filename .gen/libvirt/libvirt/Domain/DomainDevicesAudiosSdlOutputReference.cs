...
namespace libvirt.Domain
{
    ...
    public class DomainDevicesAudiosSdlOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        /// <remarks>
        /// <para>Type union: either <see cref="Io.Cdktn.IResolvable" /> or <see cref="libvirt.Domain.IDomainDevicesAudiosSdlInput" /></para>
        /// </remarks>
        [JsiiOptional]
        ...
        /// <remarks>
        /// <para>Type union: either <see cref="Io.Cdktn.IResolvable" /> or <see cref="libvirt.Domain.IDomainDevicesAudiosSdlOutput" /></para>
        /// </remarks>
        [JsiiOptional]
