...
{
    [JsiiInterface(nativeType: typeof(IDomainFeaturesNestedHv), fullyQualifiedName: "libvirt.domain.DomainFeaturesNestedHv")]
    public interface IDomainFeaturesNestedHv
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainFeaturesNestedHv), fullyQualifiedName: "libvirt.domain.DomainFeaturesNestedHv")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainFeaturesNestedHv
        {
