...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesRedirDevsSourceTcp), fullyQualifiedName: "libvirt.domain.DomainDevicesRedirDevsSourceTcp")]
    public interface IDomainDevicesRedirDevsSourceTcp
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        libvirt.Domain.IDomainDevicesRedirDevsSourceTcpReconnect? Reconnect
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesRedirDevsSourceTcp), fullyQualifiedName: "libvirt.domain.DomainDevicesRedirDevsSourceTcp")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesRedirDevsSourceTcp
        {
            ...
            {
                get => GetInstanceProperty<libvirt.Domain.IDomainDevicesRedirDevsSourceTcpReconnect?>();
            }
