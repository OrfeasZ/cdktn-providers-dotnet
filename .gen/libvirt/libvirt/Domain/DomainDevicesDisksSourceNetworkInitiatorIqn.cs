...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksSourceNetworkInitiatorIqn")]
    public class DomainDevicesDisksSourceNetworkInitiatorIqn : libvirt.Domain.IDomainDevicesDisksSourceNetworkInitiatorIqn
    {
