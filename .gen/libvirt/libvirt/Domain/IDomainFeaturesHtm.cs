...
{
    [JsiiInterface(nativeType: typeof(IDomainFeaturesHtm), fullyQualifiedName: "libvirt.domain.DomainFeaturesHtm")]
    public interface IDomainFeaturesHtm
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainFeaturesHtm), fullyQualifiedName: "libvirt.domain.DomainFeaturesHtm")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainFeaturesHtm
        {
