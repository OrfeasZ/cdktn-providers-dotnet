...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksMirrorSourceEncryptionSecrets), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceEncryptionSecrets")]
    public interface IDomainDevicesDisksMirrorSourceEncryptionSecrets
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksMirrorSourceEncryptionSecrets), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceEncryptionSecrets")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksMirrorSourceEncryptionSecrets
        {
