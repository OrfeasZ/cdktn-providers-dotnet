...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesRngsBackendEgdSource")]
    public class DomainDevicesRngsBackendEgdSource : libvirt.Domain.IDomainDevicesRngsBackendEgdSource
    {
