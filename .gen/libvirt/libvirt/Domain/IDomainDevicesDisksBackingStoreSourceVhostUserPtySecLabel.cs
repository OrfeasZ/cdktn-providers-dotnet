...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksBackingStoreSourceVhostUserPtySecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackingStoreSourceVhostUserPtySecLabel")]
    public interface IDomainDevicesDisksBackingStoreSourceVhostUserPtySecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksBackingStoreSourceVhostUserPtySecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackingStoreSourceVhostUserPtySecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksBackingStoreSourceVhostUserPtySecLabel
        {
