...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesAudiosCoreAudioInputSettings), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosCoreAudioInputSettings")]
    public interface IDomainDevicesAudiosCoreAudioInputSettings
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesAudiosCoreAudioInputSettings), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosCoreAudioInputSettings")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesAudiosCoreAudioInputSettings
        {
