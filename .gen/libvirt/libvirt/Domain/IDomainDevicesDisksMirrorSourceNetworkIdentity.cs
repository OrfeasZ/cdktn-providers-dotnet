...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksMirrorSourceNetworkIdentity), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceNetworkIdentity")]
    public interface IDomainDevicesDisksMirrorSourceNetworkIdentity
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksMirrorSourceNetworkIdentity), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceNetworkIdentity")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksMirrorSourceNetworkIdentity
        {
