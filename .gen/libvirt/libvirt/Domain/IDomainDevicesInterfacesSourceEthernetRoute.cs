...
namespace libvirt.Domain
{
    ...
    public interface IDomainDevicesInterfacesSourceEthernetRoute
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesInterfacesSourceEthernetRoute), fullyQualifiedName: "libvirt.domain.DomainDevicesInterfacesSourceEthernetRoute")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesInterfacesSourceEthernetRoute
        {
