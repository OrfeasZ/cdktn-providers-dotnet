...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksMirrorSourceVolumeSecLabel")]
    public class DomainDevicesDisksMirrorSourceVolumeSecLabel : libvirt.Domain.IDomainDevicesDisksMirrorSourceVolumeSecLabel
    {
