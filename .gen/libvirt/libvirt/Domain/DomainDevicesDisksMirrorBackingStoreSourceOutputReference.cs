...
namespace libvirt.Domain
{
    ...
    public class DomainDevicesDisksMirrorBackingStoreSourceOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        [JsiiMethod(name: "putCtl", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"libvirt.domain.DomainDevicesDisksMirrorBackingStoreSourceCtl\"}}]")]
        public virtual void PutCtl(libvirt.Domain.IDomainDevicesDisksMirrorBackingStoreSourceCtl @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(libvirt.Domain.IDomainDevicesDisksMirrorBackingStoreSourceCtl)}, new object[]{@value});
        }
        ...
        [JsiiProperty(name: "ctl", typeJson: "{\"fqn\":\"libvirt.domain.DomainDevicesDisksMirrorBackingStoreSourceCtlOutputReference\"}")]
        public virtual libvirt.Domain.DomainDevicesDisksMirrorBackingStoreSourceCtlOutputReference Ctl
        {
            get => GetInstanceProperty<libvirt.Domain.DomainDevicesDisksMirrorBackingStoreSourceCtlOutputReference>()!;
        }
        ...
        /// <remarks>
        /// <para>Type union: either <see cref="Io.Cdktn.IResolvable" /> or <see cref="libvirt.Domain.IDomainDevicesDisksMirrorBackingStoreSourceCtl" /></para>
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "ctlInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"libvirt.domain.DomainDevicesDisksMirrorBackingStoreSourceCtl\"}]}}", isOptional: true)]
