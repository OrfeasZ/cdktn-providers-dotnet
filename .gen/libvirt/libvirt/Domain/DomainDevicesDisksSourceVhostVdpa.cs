...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksSourceVhostVdpa")]
    public class DomainDevicesDisksSourceVhostVdpa : libvirt.Domain.IDomainDevicesDisksSourceVhostVdpa
    {
