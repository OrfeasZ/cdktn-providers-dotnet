...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesParallelsLog), fullyQualifiedName: "libvirt.domain.DomainDevicesParallelsLog")]
    public interface IDomainDevicesParallelsLog
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesParallelsLog), fullyQualifiedName: "libvirt.domain.DomainDevicesParallelsLog")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesParallelsLog
        {
