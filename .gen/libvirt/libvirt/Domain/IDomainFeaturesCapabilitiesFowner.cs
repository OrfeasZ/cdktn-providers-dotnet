...
{
    [JsiiInterface(nativeType: typeof(IDomainFeaturesCapabilitiesFowner), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesFowner")]
    public interface IDomainFeaturesCapabilitiesFowner
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainFeaturesCapabilitiesFowner), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesFowner")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainFeaturesCapabilitiesFowner
        {
