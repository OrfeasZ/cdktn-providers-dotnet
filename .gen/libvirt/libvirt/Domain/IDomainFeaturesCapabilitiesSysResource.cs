...
{
    [JsiiInterface(nativeType: typeof(IDomainFeaturesCapabilitiesSysResource), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesSysResource")]
    public interface IDomainFeaturesCapabilitiesSysResource
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainFeaturesCapabilitiesSysResource), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesSysResource")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainFeaturesCapabilitiesSysResource
        {
