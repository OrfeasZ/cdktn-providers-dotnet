...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesRedirDevsProtocol), fullyQualifiedName: "libvirt.domain.DomainDevicesRedirDevsProtocol")]
    public interface IDomainDevicesRedirDevsProtocol
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesRedirDevsProtocol), fullyQualifiedName: "libvirt.domain.DomainDevicesRedirDevsProtocol")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesRedirDevsProtocol
        {
