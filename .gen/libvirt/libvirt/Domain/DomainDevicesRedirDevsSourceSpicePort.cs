...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesRedirDevsSourceSpicePort")]
    public class DomainDevicesRedirDevsSourceSpicePort : libvirt.Domain.IDomainDevicesRedirDevsSourceSpicePort
    {
