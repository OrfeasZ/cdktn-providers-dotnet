...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesParallelsAlias), fullyQualifiedName: "libvirt.domain.DomainDevicesParallelsAlias")]
    public interface IDomainDevicesParallelsAlias
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesParallelsAlias), fullyQualifiedName: "libvirt.domain.DomainDevicesParallelsAlias")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesParallelsAlias
        {
