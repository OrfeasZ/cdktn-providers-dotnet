...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksMirrorFormat")]
    public class DomainDevicesDisksMirrorFormat : libvirt.Domain.IDomainDevicesDisksMirrorFormat
    {
