...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesSmartcardsPassthroughFileSecLabel")]
    public class DomainDevicesSmartcardsPassthroughFileSecLabel : libvirt.Domain.IDomainDevicesSmartcardsPassthroughFileSecLabel
    {
