...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesConsolesSourceUnixSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesConsolesSourceUnixSecLabel")]
    public interface IDomainDevicesConsolesSourceUnixSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesConsolesSourceUnixSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesConsolesSourceUnixSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesConsolesSourceUnixSecLabel
        {
