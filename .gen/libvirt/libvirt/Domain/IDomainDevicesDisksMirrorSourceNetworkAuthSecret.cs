...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksMirrorSourceNetworkAuthSecret), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceNetworkAuthSecret")]
    public interface IDomainDevicesDisksMirrorSourceNetworkAuthSecret
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksMirrorSourceNetworkAuthSecret), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceNetworkAuthSecret")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksMirrorSourceNetworkAuthSecret
        {
