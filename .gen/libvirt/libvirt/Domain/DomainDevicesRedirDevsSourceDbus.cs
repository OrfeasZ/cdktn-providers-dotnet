...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesRedirDevsSourceDbus")]
    public class DomainDevicesRedirDevsSourceDbus : libvirt.Domain.IDomainDevicesRedirDevsSourceDbus
    {
