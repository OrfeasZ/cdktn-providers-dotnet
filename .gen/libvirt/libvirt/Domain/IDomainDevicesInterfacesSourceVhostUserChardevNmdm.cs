...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesInterfacesSourceVhostUserChardevNmdm), fullyQualifiedName: "libvirt.domain.DomainDevicesInterfacesSourceVhostUserChardevNmdm")]
    public interface IDomainDevicesInterfacesSourceVhostUserChardevNmdm
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesInterfacesSourceVhostUserChardevNmdm), fullyQualifiedName: "libvirt.domain.DomainDevicesInterfacesSourceVhostUserChardevNmdm")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesInterfacesSourceVhostUserChardevNmdm
        {
