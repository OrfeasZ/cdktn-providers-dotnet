...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainFeaturesCapabilitiesIpcOwner")]
    public class DomainFeaturesCapabilitiesIpcOwner : libvirt.Domain.IDomainFeaturesCapabilitiesIpcOwner
    {
