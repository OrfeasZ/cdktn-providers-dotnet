...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainFeaturesCapabilitiesSysTime")]
    public class DomainFeaturesCapabilitiesSysTime : libvirt.Domain.IDomainFeaturesCapabilitiesSysTime
    {
