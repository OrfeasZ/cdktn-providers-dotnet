...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainOsNvRamSourceNetworkAuth")]
    public class DomainOsNvRamSourceNetworkAuth : libvirt.Domain.IDomainOsNvRamSourceNetworkAuth
    {
