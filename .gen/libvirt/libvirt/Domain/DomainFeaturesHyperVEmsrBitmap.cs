...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainFeaturesHyperVEmsrBitmap")]
    public class DomainFeaturesHyperVEmsrBitmap : libvirt.Domain.IDomainFeaturesHyperVEmsrBitmap
    {
