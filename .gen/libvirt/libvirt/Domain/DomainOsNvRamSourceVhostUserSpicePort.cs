...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainOsNvRamSourceVhostUserSpicePort")]
    public class DomainOsNvRamSourceVhostUserSpicePort : libvirt.Domain.IDomainOsNvRamSourceVhostUserSpicePort
    {
