...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksBackingStoreFormatMetadataCacheMaxSize), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackingStoreFormatMetadataCacheMaxSize")]
    public interface IDomainDevicesDisksBackingStoreFormatMetadataCacheMaxSize
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksBackingStoreFormatMetadataCacheMaxSize), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackingStoreFormatMetadataCacheMaxSize")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksBackingStoreFormatMetadataCacheMaxSize
        {
