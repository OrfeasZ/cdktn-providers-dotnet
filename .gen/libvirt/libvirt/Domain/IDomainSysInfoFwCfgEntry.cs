...
{
    [JsiiInterface(nativeType: typeof(IDomainSysInfoFwCfgEntry), fullyQualifiedName: "libvirt.domain.DomainSysInfoFwCfgEntry")]
    public interface IDomainSysInfoFwCfgEntry
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainSysInfoFwCfgEntry), fullyQualifiedName: "libvirt.domain.DomainSysInfoFwCfgEntry")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainSysInfoFwCfgEntry
        {
