...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesSerialsProtocol), fullyQualifiedName: "libvirt.domain.DomainDevicesSerialsProtocol")]
    public interface IDomainDevicesSerialsProtocol
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesSerialsProtocol), fullyQualifiedName: "libvirt.domain.DomainDevicesSerialsProtocol")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesSerialsProtocol
        {
