...
{
    [JsiiInterface(nativeType: typeof(IDomainSysInfoSmbiosBaseBoardEntry), fullyQualifiedName: "libvirt.domain.DomainSysInfoSmbiosBaseBoardEntry")]
    public interface IDomainSysInfoSmbiosBaseBoardEntry
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainSysInfoSmbiosBaseBoardEntry), fullyQualifiedName: "libvirt.domain.DomainSysInfoSmbiosBaseBoardEntry")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainSysInfoSmbiosBaseBoardEntry
        {
