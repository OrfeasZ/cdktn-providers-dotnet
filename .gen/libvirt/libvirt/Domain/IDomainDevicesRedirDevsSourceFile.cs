...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesRedirDevsSourceFile), fullyQualifiedName: "libvirt.domain.DomainDevicesRedirDevsSourceFile")]
    public interface IDomainDevicesRedirDevsSourceFile
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesRedirDevsSourceFile), fullyQualifiedName: "libvirt.domain.DomainDevicesRedirDevsSourceFile")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesRedirDevsSourceFile
        {
