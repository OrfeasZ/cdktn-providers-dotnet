...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksBackingStoreSourceVhostUserTcpReconnect), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackingStoreSourceVhostUserTcpReconnect")]
    public interface IDomainDevicesDisksBackingStoreSourceVhostUserTcpReconnect
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksBackingStoreSourceVhostUserTcpReconnect), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackingStoreSourceVhostUserTcpReconnect")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksBackingStoreSourceVhostUserTcpReconnect
        {
