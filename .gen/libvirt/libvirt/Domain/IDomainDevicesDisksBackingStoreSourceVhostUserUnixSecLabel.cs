...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksBackingStoreSourceVhostUserUnixSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackingStoreSourceVhostUserUnixSecLabel")]
    public interface IDomainDevicesDisksBackingStoreSourceVhostUserUnixSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksBackingStoreSourceVhostUserUnixSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackingStoreSourceVhostUserUnixSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksBackingStoreSourceVhostUserUnixSecLabel
        {
