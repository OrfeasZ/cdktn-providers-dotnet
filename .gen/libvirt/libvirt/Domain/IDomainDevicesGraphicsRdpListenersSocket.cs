...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesGraphicsRdpListenersSocket), fullyQualifiedName: "libvirt.domain.DomainDevicesGraphicsRdpListenersSocket")]
    public interface IDomainDevicesGraphicsRdpListenersSocket
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesGraphicsRdpListenersSocket), fullyQualifiedName: "libvirt.domain.DomainDevicesGraphicsRdpListenersSocket")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesGraphicsRdpListenersSocket
        {
