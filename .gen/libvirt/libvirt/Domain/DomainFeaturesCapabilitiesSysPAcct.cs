...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainFeaturesCapabilitiesSysPAcct")]
    public class DomainFeaturesCapabilitiesSysPAcct : libvirt.Domain.IDomainFeaturesCapabilitiesSysPAcct
    {
