...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksSourceVhostUserDevSecLabel")]
    public class DomainDevicesDisksSourceVhostUserDevSecLabel : libvirt.Domain.IDomainDevicesDisksSourceVhostUserDevSecLabel
    {
