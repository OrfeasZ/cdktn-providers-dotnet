...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainFeaturesCapabilitiesSetPCap")]
    public class DomainFeaturesCapabilitiesSetPCap : libvirt.Domain.IDomainFeaturesCapabilitiesSetPCap
    {
