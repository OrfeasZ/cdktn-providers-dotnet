...
{
    [JsiiInterface(nativeType: typeof(IDomainOsNvRamSourceReservationsSourceTcp), fullyQualifiedName: "libvirt.domain.DomainOsNvRamSourceReservationsSourceTcp")]
    public interface IDomainOsNvRamSourceReservationsSourceTcp
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "reconnect", typeJson: "{\"fqn\":\"libvirt.domain.DomainOsNvRamSourceReservationsSourceTcpReconnect\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        libvirt.Domain.IDomainOsNvRamSourceReservationsSourceTcpReconnect? Reconnect
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainOsNvRamSourceReservationsSourceTcp), fullyQualifiedName: "libvirt.domain.DomainOsNvRamSourceReservationsSourceTcp")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainOsNvRamSourceReservationsSourceTcp
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "reconnect", typeJson: "{\"fqn\":\"libvirt.domain.DomainOsNvRamSourceReservationsSourceTcpReconnect\"}", isOptional: true)]
            public libvirt.Domain.IDomainOsNvRamSourceReservationsSourceTcpReconnect? Reconnect
            {
                get => GetInstanceProperty<libvirt.Domain.IDomainOsNvRamSourceReservationsSourceTcpReconnect?>();
            }
