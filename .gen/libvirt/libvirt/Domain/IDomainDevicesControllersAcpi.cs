...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesControllersAcpi), fullyQualifiedName: "libvirt.domain.DomainDevicesControllersAcpi")]
    public interface IDomainDevicesControllersAcpi
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesControllersAcpi), fullyQualifiedName: "libvirt.domain.DomainDevicesControllersAcpi")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesControllersAcpi
        {
