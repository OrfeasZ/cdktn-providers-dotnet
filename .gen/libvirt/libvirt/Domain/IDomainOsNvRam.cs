...
{
    [JsiiInterface(nativeType: typeof(IDomainOsNvRam), fullyQualifiedName: "libvirt.domain.DomainOsNvRam")]
    public interface IDomainOsNvRam
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        libvirt.Domain.IDomainOsNvRamSource? Source
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainOsNvRam), fullyQualifiedName: "libvirt.domain.DomainOsNvRam")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainOsNvRam
        {
            ...
            {
                get => GetInstanceProperty<libvirt.Domain.IDomainOsNvRamSource?>();
            }
