...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesSmartcardsPassthroughTcp), fullyQualifiedName: "libvirt.domain.DomainDevicesSmartcardsPassthroughTcp")]
    public interface IDomainDevicesSmartcardsPassthroughTcp
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "reconnect", typeJson: "{\"fqn\":\"libvirt.domain.DomainDevicesSmartcardsPassthroughTcpReconnect\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        libvirt.Domain.IDomainDevicesSmartcardsPassthroughTcpReconnect? Reconnect
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesSmartcardsPassthroughTcp), fullyQualifiedName: "libvirt.domain.DomainDevicesSmartcardsPassthroughTcp")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesSmartcardsPassthroughTcp
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "reconnect", typeJson: "{\"fqn\":\"libvirt.domain.DomainDevicesSmartcardsPassthroughTcpReconnect\"}", isOptional: true)]
            public libvirt.Domain.IDomainDevicesSmartcardsPassthroughTcpReconnect? Reconnect
            {
                get => GetInstanceProperty<libvirt.Domain.IDomainDevicesSmartcardsPassthroughTcpReconnect?>();
            }
