...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksMirrorSourceNetworkHosts")]
    public class DomainDevicesDisksMirrorSourceNetworkHosts : libvirt.Domain.IDomainDevicesDisksMirrorSourceNetworkHosts
    {
