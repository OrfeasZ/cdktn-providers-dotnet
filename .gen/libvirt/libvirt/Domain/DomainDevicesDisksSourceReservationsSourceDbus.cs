...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksSourceReservationsSourceDbus")]
    public class DomainDevicesDisksSourceReservationsSourceDbus : libvirt.Domain.IDomainDevicesDisksSourceReservationsSourceDbus
    {
