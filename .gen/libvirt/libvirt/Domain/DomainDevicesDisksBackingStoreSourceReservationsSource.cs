...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksBackingStoreSourceReservationsSource")]
    public class DomainDevicesDisksBackingStoreSourceReservationsSource : libvirt.Domain.IDomainDevicesDisksBackingStoreSourceReservationsSource
    {
