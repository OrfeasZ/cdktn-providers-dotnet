...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesConsolesAlias), fullyQualifiedName: "libvirt.domain.DomainDevicesConsolesAlias")]
    public interface IDomainDevicesConsolesAlias
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesConsolesAlias), fullyQualifiedName: "libvirt.domain.DomainDevicesConsolesAlias")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesConsolesAlias
        {
