...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesChannelsSourceNmdm), fullyQualifiedName: "libvirt.domain.DomainDevicesChannelsSourceNmdm")]
    public interface IDomainDevicesChannelsSourceNmdm
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesChannelsSourceNmdm), fullyQualifiedName: "libvirt.domain.DomainDevicesChannelsSourceNmdm")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesChannelsSourceNmdm
        {
