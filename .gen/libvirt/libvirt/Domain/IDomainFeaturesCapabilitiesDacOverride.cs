...
{
    [JsiiInterface(nativeType: typeof(IDomainFeaturesCapabilitiesDacOverride), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesDacOverride")]
    public interface IDomainFeaturesCapabilitiesDacOverride
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainFeaturesCapabilitiesDacOverride), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesDacOverride")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainFeaturesCapabilitiesDacOverride
        {
