...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesConsolesSourceTcp")]
    public class DomainDevicesConsolesSourceTcp : libvirt.Domain.IDomainDevicesConsolesSourceTcp
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "reconnect", typeJson: "{\"fqn\":\"libvirt.domain.DomainDevicesConsolesSourceTcpReconnect\"}", isOptional: true)]
        public libvirt.Domain.IDomainDevicesConsolesSourceTcpReconnect? Reconnect
        {
            get;
            set;
        }
