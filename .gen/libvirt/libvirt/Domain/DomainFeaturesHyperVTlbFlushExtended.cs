...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainFeaturesHyperVTlbFlushExtended")]
    public class DomainFeaturesHyperVTlbFlushExtended : libvirt.Domain.IDomainFeaturesHyperVTlbFlushExtended
    {
