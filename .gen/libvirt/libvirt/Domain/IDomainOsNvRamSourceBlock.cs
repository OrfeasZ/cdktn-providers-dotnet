...
{
    [JsiiInterface(nativeType: typeof(IDomainOsNvRamSourceBlock), fullyQualifiedName: "libvirt.domain.DomainOsNvRamSourceBlock")]
    public interface IDomainOsNvRamSourceBlock
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "secLabel", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"libvirt.domain.DomainOsNvRamSourceBlockSecLabel\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        object? SecLabel
        {
            get
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainOsNvRamSourceBlock), fullyQualifiedName: "libvirt.domain.DomainOsNvRamSourceBlock")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainOsNvRamSourceBlock
        {
