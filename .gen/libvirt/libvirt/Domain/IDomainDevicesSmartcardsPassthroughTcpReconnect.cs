...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesSmartcardsPassthroughTcpReconnect), fullyQualifiedName: "libvirt.domain.DomainDevicesSmartcardsPassthroughTcpReconnect")]
    public interface IDomainDevicesSmartcardsPassthroughTcpReconnect
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesSmartcardsPassthroughTcpReconnect), fullyQualifiedName: "libvirt.domain.DomainDevicesSmartcardsPassthroughTcpReconnect")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesSmartcardsPassthroughTcpReconnect
        {
