...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainFeaturesCapabilitiesMacAdmin")]
    public class DomainFeaturesCapabilitiesMacAdmin : libvirt.Domain.IDomainFeaturesCapabilitiesMacAdmin
    {
