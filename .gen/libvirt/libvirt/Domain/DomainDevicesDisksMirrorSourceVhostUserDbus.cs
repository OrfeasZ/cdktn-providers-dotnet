...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksMirrorSourceVhostUserDbus")]
    public class DomainDevicesDisksMirrorSourceVhostUserDbus : libvirt.Domain.IDomainDevicesDisksMirrorSourceVhostUserDbus
    {
