...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksSourceVhostVdpa), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceVhostVdpa")]
    public interface IDomainDevicesDisksSourceVhostVdpa
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksSourceVhostVdpa), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceVhostVdpa")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksSourceVhostVdpa
        {
