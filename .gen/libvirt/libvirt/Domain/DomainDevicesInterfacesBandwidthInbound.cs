...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesInterfacesBandwidthInbound")]
    public class DomainDevicesInterfacesBandwidthInbound : libvirt.Domain.IDomainDevicesInterfacesBandwidthInbound
    {
