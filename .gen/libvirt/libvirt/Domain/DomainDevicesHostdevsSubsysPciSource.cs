...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesHostdevsSubsysPciSource")]
    public class DomainDevicesHostdevsSubsysPciSource : libvirt.Domain.IDomainDevicesHostdevsSubsysPciSource
    {
