...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksBackingStoreSourceVhostUserFileSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackingStoreSourceVhostUserFileSecLabel")]
    public interface IDomainDevicesDisksBackingStoreSourceVhostUserFileSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksBackingStoreSourceVhostUserFileSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackingStoreSourceVhostUserFileSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksBackingStoreSourceVhostUserFileSecLabel
        {
