...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainFeaturesCapabilitiesSetFCap")]
    public class DomainFeaturesCapabilitiesSetFCap : libvirt.Domain.IDomainFeaturesCapabilitiesSetFCap
    {
