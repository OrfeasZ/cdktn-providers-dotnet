...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesAudiosPulseAudioInputSettings")]
    public class DomainDevicesAudiosPulseAudioInputSettings : libvirt.Domain.IDomainDevicesAudiosPulseAudioInputSettings
    {
