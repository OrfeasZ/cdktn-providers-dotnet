...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesSerialsSourceTcpReconnect")]
    public class DomainDevicesSerialsSourceTcpReconnect : libvirt.Domain.IDomainDevicesSerialsSourceTcpReconnect
    {
