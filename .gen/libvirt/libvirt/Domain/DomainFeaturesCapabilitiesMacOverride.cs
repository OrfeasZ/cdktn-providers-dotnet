...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainFeaturesCapabilitiesMacOverride")]
    public class DomainFeaturesCapabilitiesMacOverride : libvirt.Domain.IDomainFeaturesCapabilitiesMacOverride
    {
