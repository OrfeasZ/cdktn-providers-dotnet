...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesRngsBackendEgdSourceTcpReconnect), fullyQualifiedName: "libvirt.domain.DomainDevicesRngsBackendEgdSourceTcpReconnect")]
    public interface IDomainDevicesRngsBackendEgdSourceTcpReconnect
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesRngsBackendEgdSourceTcpReconnect), fullyQualifiedName: "libvirt.domain.DomainDevicesRngsBackendEgdSourceTcpReconnect")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesRngsBackendEgdSourceTcpReconnect
        {
