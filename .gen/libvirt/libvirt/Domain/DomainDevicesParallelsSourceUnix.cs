...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesParallelsSourceUnix")]
    public class DomainDevicesParallelsSourceUnix : libvirt.Domain.IDomainDevicesParallelsSourceUnix
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "reconnect", typeJson: "{\"fqn\":\"libvirt.domain.DomainDevicesParallelsSourceUnixReconnect\"}", isOptional: true)]
        public libvirt.Domain.IDomainDevicesParallelsSourceUnixReconnect? Reconnect
        {
            get;
            set;
        }
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "secLabel", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"libvirt.domain.DomainDevicesParallelsSourceUnixSecLabel\"},\"kind\":\"array\"}}]}}", isOptional: true)]
