...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesPstoreAlias), fullyQualifiedName: "libvirt.domain.DomainDevicesPstoreAlias")]
    public interface IDomainDevicesPstoreAlias
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesPstoreAlias), fullyQualifiedName: "libvirt.domain.DomainDevicesPstoreAlias")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesPstoreAlias
        {
