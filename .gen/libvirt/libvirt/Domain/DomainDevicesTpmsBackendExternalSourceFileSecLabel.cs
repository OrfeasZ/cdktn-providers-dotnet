...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesTpmsBackendExternalSourceFileSecLabel")]
    public class DomainDevicesTpmsBackendExternalSourceFileSecLabel : libvirt.Domain.IDomainDevicesTpmsBackendExternalSourceFileSecLabel
    {
