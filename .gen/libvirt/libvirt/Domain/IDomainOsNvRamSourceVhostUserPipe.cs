...
{
    [JsiiInterface(nativeType: typeof(IDomainOsNvRamSourceVhostUserPipe), fullyQualifiedName: "libvirt.domain.DomainOsNvRamSourceVhostUserPipe")]
    public interface IDomainOsNvRamSourceVhostUserPipe
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainOsNvRamSourceVhostUserPipe), fullyQualifiedName: "libvirt.domain.DomainOsNvRamSourceVhostUserPipe")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainOsNvRamSourceVhostUserPipe
        {
