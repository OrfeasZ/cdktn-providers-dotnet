...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesTpmsAcpi), fullyQualifiedName: "libvirt.domain.DomainDevicesTpmsAcpi")]
    public interface IDomainDevicesTpmsAcpi
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesTpmsAcpi), fullyQualifiedName: "libvirt.domain.DomainDevicesTpmsAcpi")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesTpmsAcpi
        {
