...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesChannelsSourceUnix), fullyQualifiedName: "libvirt.domain.DomainDevicesChannelsSourceUnix")]
    public interface IDomainDevicesChannelsSourceUnix
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        libvirt.Domain.IDomainDevicesChannelsSourceUnixReconnect? Reconnect
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesChannelsSourceUnix), fullyQualifiedName: "libvirt.domain.DomainDevicesChannelsSourceUnix")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesChannelsSourceUnix
        {
            ...
            {
                get => GetInstanceProperty<libvirt.Domain.IDomainDevicesChannelsSourceUnixReconnect?>();
            }
