...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksSourceVhostUserUnixReconnect), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceVhostUserUnixReconnect")]
    public interface IDomainDevicesDisksSourceVhostUserUnixReconnect
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksSourceVhostUserUnixReconnect), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceVhostUserUnixReconnect")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksSourceVhostUserUnixReconnect
        {
