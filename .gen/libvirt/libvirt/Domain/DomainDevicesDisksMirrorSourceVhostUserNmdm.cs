...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksMirrorSourceVhostUserNmdm")]
    public class DomainDevicesDisksMirrorSourceVhostUserNmdm : libvirt.Domain.IDomainDevicesDisksMirrorSourceVhostUserNmdm
    {
