...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesAudiosAlsaInputSettings")]
    public class DomainDevicesAudiosAlsaInputSettings : libvirt.Domain.IDomainDevicesAudiosAlsaInputSettings
    {
