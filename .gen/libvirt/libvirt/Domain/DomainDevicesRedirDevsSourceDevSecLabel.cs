...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesRedirDevsSourceDevSecLabel")]
    public class DomainDevicesRedirDevsSourceDevSecLabel : libvirt.Domain.IDomainDevicesRedirDevsSourceDevSecLabel
    {
