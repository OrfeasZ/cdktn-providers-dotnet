...
{
    [JsiiInterface(nativeType: typeof(IDomainFeaturesHyperVRelaxed), fullyQualifiedName: "libvirt.domain.DomainFeaturesHyperVRelaxed")]
    public interface IDomainFeaturesHyperVRelaxed
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainFeaturesHyperVRelaxed), fullyQualifiedName: "libvirt.domain.DomainFeaturesHyperVRelaxed")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainFeaturesHyperVRelaxed
        {
