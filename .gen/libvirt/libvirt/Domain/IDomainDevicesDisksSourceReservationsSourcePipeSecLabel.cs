...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksSourceReservationsSourcePipeSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceReservationsSourcePipeSecLabel")]
    public interface IDomainDevicesDisksSourceReservationsSourcePipeSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksSourceReservationsSourcePipeSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceReservationsSourcePipeSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksSourceReservationsSourcePipeSecLabel
        {
