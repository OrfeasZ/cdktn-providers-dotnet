...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesConsolesSourceDevSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesConsolesSourceDevSecLabel")]
    public interface IDomainDevicesConsolesSourceDevSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesConsolesSourceDevSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesConsolesSourceDevSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesConsolesSourceDevSecLabel
        {
