...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksMirrorSourceReservations), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceReservations")]
    public interface IDomainDevicesDisksMirrorSourceReservations
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "source", typeJson: "{\"fqn\":\"libvirt.domain.DomainDevicesDisksMirrorSourceReservationsSource\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        libvirt.Domain.IDomainDevicesDisksMirrorSourceReservationsSource? Source
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksMirrorSourceReservations), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceReservations")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksMirrorSourceReservations
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "source", typeJson: "{\"fqn\":\"libvirt.domain.DomainDevicesDisksMirrorSourceReservationsSource\"}", isOptional: true)]
            public libvirt.Domain.IDomainDevicesDisksMirrorSourceReservationsSource? Source
            {
                get => GetInstanceProperty<libvirt.Domain.IDomainDevicesDisksMirrorSourceReservationsSource?>();
            }
        }
    }
}
