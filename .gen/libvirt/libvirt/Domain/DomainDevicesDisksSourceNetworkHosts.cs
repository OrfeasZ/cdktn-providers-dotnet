...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksSourceNetworkHosts")]
    public class DomainDevicesDisksSourceNetworkHosts : libvirt.Domain.IDomainDevicesDisksSourceNetworkHosts
    {
