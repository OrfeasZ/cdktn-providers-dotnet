...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesAudiosSpiceOutput")]
    public class DomainDevicesAudiosSpiceOutput : libvirt.Domain.IDomainDevicesAudiosSpiceOutput
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "settings", typeJson: "{\"fqn\":\"libvirt.domain.DomainDevicesAudiosSpiceOutputSettings\"}", isOptional: true)]
        public libvirt.Domain.IDomainDevicesAudiosSpiceOutputSettings? Settings
        {
            get;
            set;
        }
