...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainOsNvRamSourceEncryptionSecrets")]
    public class DomainOsNvRamSourceEncryptionSecrets : libvirt.Domain.IDomainOsNvRamSourceEncryptionSecrets
    {
