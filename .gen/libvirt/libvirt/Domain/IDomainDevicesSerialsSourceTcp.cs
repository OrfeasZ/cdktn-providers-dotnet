...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesSerialsSourceTcp), fullyQualifiedName: "libvirt.domain.DomainDevicesSerialsSourceTcp")]
    public interface IDomainDevicesSerialsSourceTcp
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        libvirt.Domain.IDomainDevicesSerialsSourceTcpReconnect? Reconnect
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesSerialsSourceTcp), fullyQualifiedName: "libvirt.domain.DomainDevicesSerialsSourceTcp")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesSerialsSourceTcp
        {
            ...
            {
                get => GetInstanceProperty<libvirt.Domain.IDomainDevicesSerialsSourceTcpReconnect?>();
            }
