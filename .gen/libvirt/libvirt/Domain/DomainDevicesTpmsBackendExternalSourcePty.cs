...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesTpmsBackendExternalSourcePty")]
    public class DomainDevicesTpmsBackendExternalSourcePty : libvirt.Domain.IDomainDevicesTpmsBackendExternalSourcePty
    {
