...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesParallelsSourcePipeSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesParallelsSourcePipeSecLabel")]
    public interface IDomainDevicesParallelsSourcePipeSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesParallelsSourcePipeSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesParallelsSourcePipeSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesParallelsSourcePipeSecLabel
        {
