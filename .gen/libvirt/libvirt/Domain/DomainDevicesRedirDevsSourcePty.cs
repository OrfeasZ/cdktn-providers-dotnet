...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesRedirDevsSourcePty")]
    public class DomainDevicesRedirDevsSourcePty : libvirt.Domain.IDomainDevicesRedirDevsSourcePty
    {
