...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesHostdevsBoot), fullyQualifiedName: "libvirt.domain.DomainDevicesHostdevsBoot")]
    public interface IDomainDevicesHostdevsBoot
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesHostdevsBoot), fullyQualifiedName: "libvirt.domain.DomainDevicesHostdevsBoot")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesHostdevsBoot
        {
