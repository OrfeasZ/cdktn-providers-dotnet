...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesSerialsSourceDevSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesSerialsSourceDevSecLabel")]
    public interface IDomainDevicesSerialsSourceDevSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesSerialsSourceDevSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesSerialsSourceDevSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesSerialsSourceDevSecLabel
        {
