...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksSourceVhostUserUnix")]
    public class DomainDevicesDisksSourceVhostUserUnix : libvirt.Domain.IDomainDevicesDisksSourceVhostUserUnix
    {
