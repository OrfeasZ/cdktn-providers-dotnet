...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesAudiosSdlInputSettings), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosSdlInputSettings")]
    public interface IDomainDevicesAudiosSdlInputSettings
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesAudiosSdlInputSettings), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosSdlInputSettings")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesAudiosSdlInputSettings
        {
