...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainFeaturesCapabilitiesSetGid")]
    public class DomainFeaturesCapabilitiesSetGid : libvirt.Domain.IDomainFeaturesCapabilitiesSetGid
    {
