...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesRngsBackendEgdSourceSpicePort")]
    public class DomainDevicesRngsBackendEgdSourceSpicePort : libvirt.Domain.IDomainDevicesRngsBackendEgdSourceSpicePort
    {
