...
{
    [JsiiInterface(nativeType: typeof(IDomainFeaturesCapabilitiesIpcLock), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesIpcLock")]
    public interface IDomainFeaturesCapabilitiesIpcLock
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainFeaturesCapabilitiesIpcLock), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesIpcLock")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainFeaturesCapabilitiesIpcLock
        {
