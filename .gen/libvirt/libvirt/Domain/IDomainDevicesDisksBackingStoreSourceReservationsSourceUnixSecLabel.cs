...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksBackingStoreSourceReservationsSourceUnixSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackingStoreSourceReservationsSourceUnixSecLabel")]
    public interface IDomainDevicesDisksBackingStoreSourceReservationsSourceUnixSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksBackingStoreSourceReservationsSourceUnixSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackingStoreSourceReservationsSourceUnixSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksBackingStoreSourceReservationsSourceUnixSecLabel
        {
