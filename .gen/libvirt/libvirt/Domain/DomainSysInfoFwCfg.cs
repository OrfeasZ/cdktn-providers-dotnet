...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainSysInfoFwCfg")]
    public class DomainSysInfoFwCfg : libvirt.Domain.IDomainSysInfoFwCfg
    {
        ...
        /// <para>Type union: either <see cref="Io.Cdktn.IResolvable" /> or (<see cref="libvirt.Domain.IDomainSysInfoFwCfgEntry" />)[]</para>
        /// </remarks>
        [JsiiOptional]
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        case Io.Cdktn.IResolvable cast_cd4240:
                            break;
                        case libvirt.Domain.IDomainSysInfoFwCfgEntry[] cast_cd4240:
                            break;
                        ...
                        case null:
                            break;
                        default:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(libvirt.Domain.IDomainSysInfoFwCfgEntry).FullName}[]; received {value.GetType().FullName}", nameof(value));
                    }
                }
                _entry = value;
            }
