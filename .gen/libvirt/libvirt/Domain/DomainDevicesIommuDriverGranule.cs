...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesIommuDriverGranule")]
    public class DomainDevicesIommuDriverGranule : libvirt.Domain.IDomainDevicesIommuDriverGranule
    {
