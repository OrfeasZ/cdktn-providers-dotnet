...
{
    [JsiiInterface(nativeType: typeof(IDomainFeaturesCapabilitiesNetAdmin), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesNetAdmin")]
    public interface IDomainFeaturesCapabilitiesNetAdmin
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainFeaturesCapabilitiesNetAdmin), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesNetAdmin")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainFeaturesCapabilitiesNetAdmin
        {
