...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksBackingStoreSourceNetworkAuth")]
    public class DomainDevicesDisksBackingStoreSourceNetworkAuth : libvirt.Domain.IDomainDevicesDisksBackingStoreSourceNetworkAuth
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "secret", typeJson: "{\"fqn\":\"libvirt.domain.DomainDevicesDisksBackingStoreSourceNetworkAuthSecret\"}", isOptional: true)]
        public libvirt.Domain.IDomainDevicesDisksBackingStoreSourceNetworkAuthSecret? Secret
        {
            get;
            set;
        }
