...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainOsNvRamSourceReservationsSourceDbus")]
    public class DomainOsNvRamSourceReservationsSourceDbus : libvirt.Domain.IDomainOsNvRamSourceReservationsSourceDbus
    {
