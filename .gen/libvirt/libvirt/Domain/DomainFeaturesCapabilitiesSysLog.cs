...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainFeaturesCapabilitiesSysLog")]
    public class DomainFeaturesCapabilitiesSysLog : libvirt.Domain.IDomainFeaturesCapabilitiesSysLog
    {
