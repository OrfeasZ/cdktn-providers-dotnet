...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesParallelsSourceTcpReconnect")]
    public class DomainDevicesParallelsSourceTcpReconnect : libvirt.Domain.IDomainDevicesParallelsSourceTcpReconnect
    {
