...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesParallelsSourcePtySecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesParallelsSourcePtySecLabel")]
    public interface IDomainDevicesParallelsSourcePtySecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesParallelsSourcePtySecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesParallelsSourcePtySecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesParallelsSourcePtySecLabel
        {
