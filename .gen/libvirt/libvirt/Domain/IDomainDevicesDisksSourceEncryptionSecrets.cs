...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksSourceEncryptionSecrets), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceEncryptionSecrets")]
    public interface IDomainDevicesDisksSourceEncryptionSecrets
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksSourceEncryptionSecrets), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceEncryptionSecrets")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksSourceEncryptionSecrets
        {
