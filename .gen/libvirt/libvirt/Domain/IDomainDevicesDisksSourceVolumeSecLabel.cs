...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksSourceVolumeSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceVolumeSecLabel")]
    public interface IDomainDevicesDisksSourceVolumeSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksSourceVolumeSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceVolumeSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksSourceVolumeSecLabel
        {
