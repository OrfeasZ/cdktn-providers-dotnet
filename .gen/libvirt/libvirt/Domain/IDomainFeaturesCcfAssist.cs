...
{
    [JsiiInterface(nativeType: typeof(IDomainFeaturesCcfAssist), fullyQualifiedName: "libvirt.domain.DomainFeaturesCcfAssist")]
    public interface IDomainFeaturesCcfAssist
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainFeaturesCcfAssist), fullyQualifiedName: "libvirt.domain.DomainFeaturesCcfAssist")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainFeaturesCcfAssist
        {
