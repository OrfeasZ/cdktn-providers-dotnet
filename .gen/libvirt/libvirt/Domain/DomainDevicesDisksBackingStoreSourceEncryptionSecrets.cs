...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksBackingStoreSourceEncryptionSecrets")]
    public class DomainDevicesDisksBackingStoreSourceEncryptionSecrets : libvirt.Domain.IDomainDevicesDisksBackingStoreSourceEncryptionSecrets
    {
