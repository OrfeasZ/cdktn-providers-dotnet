...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesInterfacesBandwidthOutbound")]
    public class DomainDevicesInterfacesBandwidthOutbound : libvirt.Domain.IDomainDevicesInterfacesBandwidthOutbound
    {
