...
{
    [JsiiInterface(nativeType: typeof(IDomainLxcNamespaceShareNet), fullyQualifiedName: "libvirt.domain.DomainLxcNamespaceShareNet")]
    public interface IDomainLxcNamespaceShareNet
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainLxcNamespaceShareNet), fullyQualifiedName: "libvirt.domain.DomainLxcNamespaceShareNet")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainLxcNamespaceShareNet
        {
