...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksMirrorSourceReservationsSourceNmdm), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceReservationsSourceNmdm")]
    public interface IDomainDevicesDisksMirrorSourceReservationsSourceNmdm
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksMirrorSourceReservationsSourceNmdm), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceReservationsSourceNmdm")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksMirrorSourceReservationsSourceNmdm
        {
