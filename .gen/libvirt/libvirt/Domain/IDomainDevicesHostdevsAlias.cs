...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesHostdevsAlias), fullyQualifiedName: "libvirt.domain.DomainDevicesHostdevsAlias")]
    public interface IDomainDevicesHostdevsAlias
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesHostdevsAlias), fullyQualifiedName: "libvirt.domain.DomainDevicesHostdevsAlias")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesHostdevsAlias
        {
