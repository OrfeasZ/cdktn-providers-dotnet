...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksMirrorSourceReservationsSourcePtySecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceReservationsSourcePtySecLabel")]
    public interface IDomainDevicesDisksMirrorSourceReservationsSourcePtySecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksMirrorSourceReservationsSourcePtySecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceReservationsSourcePtySecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksMirrorSourceReservationsSourcePtySecLabel
        {
