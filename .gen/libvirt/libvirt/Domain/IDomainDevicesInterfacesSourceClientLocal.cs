...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesInterfacesSourceClientLocal), fullyQualifiedName: "libvirt.domain.DomainDevicesInterfacesSourceClientLocal")]
    public interface IDomainDevicesInterfacesSourceClientLocal
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesInterfacesSourceClientLocal), fullyQualifiedName: "libvirt.domain.DomainDevicesInterfacesSourceClientLocal")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesInterfacesSourceClientLocal
        {
