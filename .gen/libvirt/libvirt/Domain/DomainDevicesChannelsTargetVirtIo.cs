...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesChannelsTargetVirtIo")]
    public class DomainDevicesChannelsTargetVirtIo : libvirt.Domain.IDomainDevicesChannelsTargetVirtIo
    {
