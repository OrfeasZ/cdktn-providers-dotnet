...
{
    [JsiiInterface(nativeType: typeof(IDomainFeaturesHyperVAvic), fullyQualifiedName: "libvirt.domain.DomainFeaturesHyperVAvic")]
    public interface IDomainFeaturesHyperVAvic
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainFeaturesHyperVAvic), fullyQualifiedName: "libvirt.domain.DomainFeaturesHyperVAvic")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainFeaturesHyperVAvic
        {
