...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesRedirDevsSourcePipeSecLabel")]
    public class DomainDevicesRedirDevsSourcePipeSecLabel : libvirt.Domain.IDomainDevicesRedirDevsSourcePipeSecLabel
    {
