...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainOsNvRamSourceFileSecLabel")]
    public class DomainOsNvRamSourceFileSecLabel : libvirt.Domain.IDomainOsNvRamSourceFileSecLabel
    {
