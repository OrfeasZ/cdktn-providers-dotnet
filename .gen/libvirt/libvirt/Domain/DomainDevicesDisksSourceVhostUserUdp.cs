...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksSourceVhostUserUdp")]
    public class DomainDevicesDisksSourceVhostUserUdp : libvirt.Domain.IDomainDevicesDisksSourceVhostUserUdp
    {
