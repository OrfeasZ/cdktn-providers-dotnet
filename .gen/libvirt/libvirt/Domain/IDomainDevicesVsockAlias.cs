...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesVsockAlias), fullyQualifiedName: "libvirt.domain.DomainDevicesVsockAlias")]
    public interface IDomainDevicesVsockAlias
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesVsockAlias), fullyQualifiedName: "libvirt.domain.DomainDevicesVsockAlias")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesVsockAlias
        {
