...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksBackingStoreSourceBlockSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackingStoreSourceBlockSecLabel")]
    public interface IDomainDevicesDisksBackingStoreSourceBlockSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksBackingStoreSourceBlockSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackingStoreSourceBlockSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksBackingStoreSourceBlockSecLabel
        {
