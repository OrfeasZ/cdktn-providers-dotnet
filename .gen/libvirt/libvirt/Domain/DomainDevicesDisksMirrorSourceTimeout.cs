...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksMirrorSourceTimeout")]
    public class DomainDevicesDisksMirrorSourceTimeout : libvirt.Domain.IDomainDevicesDisksMirrorSourceTimeout
    {
