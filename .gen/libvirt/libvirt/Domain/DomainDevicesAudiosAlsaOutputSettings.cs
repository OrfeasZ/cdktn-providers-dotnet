...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesAudiosAlsaOutputSettings")]
    public class DomainDevicesAudiosAlsaOutputSettings : libvirt.Domain.IDomainDevicesAudiosAlsaOutputSettings
    {
