...
{
    [JsiiInterface(nativeType: typeof(IDomainFeaturesKvmHidden), fullyQualifiedName: "libvirt.domain.DomainFeaturesKvmHidden")]
    public interface IDomainFeaturesKvmHidden
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainFeaturesKvmHidden), fullyQualifiedName: "libvirt.domain.DomainFeaturesKvmHidden")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainFeaturesKvmHidden
        {
