...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesInterfacesSourceVhostUserChardevPty), fullyQualifiedName: "libvirt.domain.DomainDevicesInterfacesSourceVhostUserChardevPty")]
    public interface IDomainDevicesInterfacesSourceVhostUserChardevPty
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesInterfacesSourceVhostUserChardevPty), fullyQualifiedName: "libvirt.domain.DomainDevicesInterfacesSourceVhostUserChardevPty")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesInterfacesSourceVhostUserChardevPty
        {
