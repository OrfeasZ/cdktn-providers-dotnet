...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesHostdevsSubsysScsiSourceIscsi")]
    public class DomainDevicesHostdevsSubsysScsiSourceIscsi : libvirt.Domain.IDomainDevicesHostdevsSubsysScsiSourceIscsi
    {
