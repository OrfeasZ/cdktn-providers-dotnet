...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesAudiosJackOutputSettings), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosJackOutputSettings")]
    public interface IDomainDevicesAudiosJackOutputSettings
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesAudiosJackOutputSettings), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosJackOutputSettings")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesAudiosJackOutputSettings
        {
