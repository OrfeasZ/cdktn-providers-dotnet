...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesRngsBackendEgdSourceTcp), fullyQualifiedName: "libvirt.domain.DomainDevicesRngsBackendEgdSourceTcp")]
    public interface IDomainDevicesRngsBackendEgdSourceTcp
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "reconnect", typeJson: "{\"fqn\":\"libvirt.domain.DomainDevicesRngsBackendEgdSourceTcpReconnect\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        libvirt.Domain.IDomainDevicesRngsBackendEgdSourceTcpReconnect? Reconnect
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesRngsBackendEgdSourceTcp), fullyQualifiedName: "libvirt.domain.DomainDevicesRngsBackendEgdSourceTcp")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesRngsBackendEgdSourceTcp
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "reconnect", typeJson: "{\"fqn\":\"libvirt.domain.DomainDevicesRngsBackendEgdSourceTcpReconnect\"}", isOptional: true)]
            public libvirt.Domain.IDomainDevicesRngsBackendEgdSourceTcpReconnect? Reconnect
            {
                get => GetInstanceProperty<libvirt.Domain.IDomainDevicesRngsBackendEgdSourceTcpReconnect?>();
            }
