...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesFilesystemsIdMapGid), fullyQualifiedName: "libvirt.domain.DomainDevicesFilesystemsIdMapGid")]
    public interface IDomainDevicesFilesystemsIdMapGid
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesFilesystemsIdMapGid), fullyQualifiedName: "libvirt.domain.DomainDevicesFilesystemsIdMapGid")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesFilesystemsIdMapGid
        {
