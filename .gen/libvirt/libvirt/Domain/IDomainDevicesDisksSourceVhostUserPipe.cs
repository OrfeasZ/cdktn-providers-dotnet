...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksSourceVhostUserPipe), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceVhostUserPipe")]
    public interface IDomainDevicesDisksSourceVhostUserPipe
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksSourceVhostUserPipe), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceVhostUserPipe")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksSourceVhostUserPipe
        {
