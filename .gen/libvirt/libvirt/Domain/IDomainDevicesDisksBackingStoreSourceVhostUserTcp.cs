...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksBackingStoreSourceVhostUserTcp), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackingStoreSourceVhostUserTcp")]
    public interface IDomainDevicesDisksBackingStoreSourceVhostUserTcp
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        libvirt.Domain.IDomainDevicesDisksBackingStoreSourceVhostUserTcpReconnect? Reconnect
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksBackingStoreSourceVhostUserTcp), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackingStoreSourceVhostUserTcp")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksBackingStoreSourceVhostUserTcp
        {
            ...
            {
                get => GetInstanceProperty<libvirt.Domain.IDomainDevicesDisksBackingStoreSourceVhostUserTcpReconnect?>();
            }
