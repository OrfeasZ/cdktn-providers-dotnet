...
{
    [JsiiInterface(nativeType: typeof(IDomainFeaturesCapabilitiesAuditControl), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesAuditControl")]
    public interface IDomainFeaturesCapabilitiesAuditControl
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainFeaturesCapabilitiesAuditControl), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesAuditControl")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainFeaturesCapabilitiesAuditControl
        {
