...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksSourceVhostUserFileSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceVhostUserFileSecLabel")]
    public interface IDomainDevicesDisksSourceVhostUserFileSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksSourceVhostUserFileSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceVhostUserFileSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksSourceVhostUserFileSecLabel
        {
