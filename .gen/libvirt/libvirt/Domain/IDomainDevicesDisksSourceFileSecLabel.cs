...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksSourceFileSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceFileSecLabel")]
    public interface IDomainDevicesDisksSourceFileSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksSourceFileSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceFileSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksSourceFileSecLabel
        {
