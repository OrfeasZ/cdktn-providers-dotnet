...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesSerialsSourceFileSecLabel")]
    public class DomainDevicesSerialsSourceFileSecLabel : libvirt.Domain.IDomainDevicesSerialsSourceFileSecLabel
    {
