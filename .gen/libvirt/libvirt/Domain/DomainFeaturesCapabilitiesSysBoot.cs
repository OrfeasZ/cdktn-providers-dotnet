...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainFeaturesCapabilitiesSysBoot")]
    public class DomainFeaturesCapabilitiesSysBoot : libvirt.Domain.IDomainFeaturesCapabilitiesSysBoot
    {
