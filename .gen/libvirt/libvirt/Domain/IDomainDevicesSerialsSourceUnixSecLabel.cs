...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesSerialsSourceUnixSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesSerialsSourceUnixSecLabel")]
    public interface IDomainDevicesSerialsSourceUnixSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesSerialsSourceUnixSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesSerialsSourceUnixSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesSerialsSourceUnixSecLabel
        {
