...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesSerialsSourceNmdm")]
    public class DomainDevicesSerialsSourceNmdm : libvirt.Domain.IDomainDevicesSerialsSourceNmdm
    {
