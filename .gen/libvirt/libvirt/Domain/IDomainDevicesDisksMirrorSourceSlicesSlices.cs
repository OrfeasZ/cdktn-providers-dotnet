...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksMirrorSourceSlicesSlices), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceSlicesSlices")]
    public interface IDomainDevicesDisksMirrorSourceSlicesSlices
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksMirrorSourceSlicesSlices), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceSlicesSlices")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksMirrorSourceSlicesSlices
        {
