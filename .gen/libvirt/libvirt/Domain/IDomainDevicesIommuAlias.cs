...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesIommuAlias), fullyQualifiedName: "libvirt.domain.DomainDevicesIommuAlias")]
    public interface IDomainDevicesIommuAlias
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesIommuAlias), fullyQualifiedName: "libvirt.domain.DomainDevicesIommuAlias")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesIommuAlias
        {
