...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksBackingStoreSourceDataStoreFormatMetadataCacheMaxSize), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackingStoreSourceDataStoreFormatMetadataCacheMaxSize")]
    public interface IDomainDevicesDisksBackingStoreSourceDataStoreFormatMetadataCacheMaxSize
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksBackingStoreSourceDataStoreFormatMetadataCacheMaxSize), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackingStoreSourceDataStoreFormatMetadataCacheMaxSize")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksBackingStoreSourceDataStoreFormatMetadataCacheMaxSize
        {
