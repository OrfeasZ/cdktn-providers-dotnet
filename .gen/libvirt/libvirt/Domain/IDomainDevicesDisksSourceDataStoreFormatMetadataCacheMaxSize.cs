...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksSourceDataStoreFormatMetadataCacheMaxSize), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceDataStoreFormatMetadataCacheMaxSize")]
    public interface IDomainDevicesDisksSourceDataStoreFormatMetadataCacheMaxSize
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksSourceDataStoreFormatMetadataCacheMaxSize), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceDataStoreFormatMetadataCacheMaxSize")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksSourceDataStoreFormatMetadataCacheMaxSize
        {
