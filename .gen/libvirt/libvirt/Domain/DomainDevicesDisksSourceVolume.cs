...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksSourceVolume")]
    public class DomainDevicesDisksSourceVolume : libvirt.Domain.IDomainDevicesDisksSourceVolume
    {
