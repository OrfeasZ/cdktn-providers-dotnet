...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesRngsBackendEgdSourceUnixSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesRngsBackendEgdSourceUnixSecLabel")]
    public interface IDomainDevicesRngsBackendEgdSourceUnixSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesRngsBackendEgdSourceUnixSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesRngsBackendEgdSourceUnixSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesRngsBackendEgdSourceUnixSecLabel
        {
