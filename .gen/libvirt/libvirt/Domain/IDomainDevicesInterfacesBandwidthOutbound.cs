...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesInterfacesBandwidthOutbound), fullyQualifiedName: "libvirt.domain.DomainDevicesInterfacesBandwidthOutbound")]
    public interface IDomainDevicesInterfacesBandwidthOutbound
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesInterfacesBandwidthOutbound), fullyQualifiedName: "libvirt.domain.DomainDevicesInterfacesBandwidthOutbound")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesInterfacesBandwidthOutbound
        {
