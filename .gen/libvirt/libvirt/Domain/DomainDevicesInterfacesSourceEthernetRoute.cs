...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesInterfacesSourceEthernetRoute")]
    public class DomainDevicesInterfacesSourceEthernetRoute : libvirt.Domain.IDomainDevicesInterfacesSourceEthernetRoute
    {
