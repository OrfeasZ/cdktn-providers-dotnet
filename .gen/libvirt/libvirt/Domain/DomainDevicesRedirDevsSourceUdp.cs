...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesRedirDevsSourceUdp")]
    public class DomainDevicesRedirDevsSourceUdp : libvirt.Domain.IDomainDevicesRedirDevsSourceUdp
    {
