...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksMirrorSourceVhostUserFile")]
    public class DomainDevicesDisksMirrorSourceVhostUserFile : libvirt.Domain.IDomainDevicesDisksMirrorSourceVhostUserFile
    {
