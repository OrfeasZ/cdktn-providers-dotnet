...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesParallelsSourceUdp")]
    public class DomainDevicesParallelsSourceUdp : libvirt.Domain.IDomainDevicesParallelsSourceUdp
    {
