...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainFeaturesCapabilitiesSysModule")]
    public class DomainFeaturesCapabilitiesSysModule : libvirt.Domain.IDomainFeaturesCapabilitiesSysModule
    {
