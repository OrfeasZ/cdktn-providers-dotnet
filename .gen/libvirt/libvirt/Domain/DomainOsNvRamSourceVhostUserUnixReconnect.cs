...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainOsNvRamSourceVhostUserUnixReconnect")]
    public class DomainOsNvRamSourceVhostUserUnixReconnect : libvirt.Domain.IDomainOsNvRamSourceVhostUserUnixReconnect
    {
