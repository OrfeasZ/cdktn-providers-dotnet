...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesIommUsDriver), fullyQualifiedName: "libvirt.domain.DomainDevicesIommUsDriver")]
    public interface IDomainDevicesIommUsDriver
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        libvirt.Domain.IDomainDevicesIommUsDriverGranule? Granule
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesIommUsDriver), fullyQualifiedName: "libvirt.domain.DomainDevicesIommUsDriver")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesIommUsDriver
        {
            ...
            {
                get => GetInstanceProperty<libvirt.Domain.IDomainDevicesIommUsDriverGranule?>();
            }
