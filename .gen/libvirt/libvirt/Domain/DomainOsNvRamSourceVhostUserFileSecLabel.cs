...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainOsNvRamSourceVhostUserFileSecLabel")]
    public class DomainOsNvRamSourceVhostUserFileSecLabel : libvirt.Domain.IDomainOsNvRamSourceVhostUserFileSecLabel
    {
