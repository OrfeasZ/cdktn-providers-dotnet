...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksBackingStoreSourceNetworkHosts), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackingStoreSourceNetworkHosts")]
    public interface IDomainDevicesDisksBackingStoreSourceNetworkHosts
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksBackingStoreSourceNetworkHosts), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackingStoreSourceNetworkHosts")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksBackingStoreSourceNetworkHosts
        {
