...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesFilesystemsIdMapUid")]
    public class DomainDevicesFilesystemsIdMapUid : libvirt.Domain.IDomainDevicesFilesystemsIdMapUid
    {
