...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesAudiosPulseAudioOutputSettings")]
    public class DomainDevicesAudiosPulseAudioOutputSettings : libvirt.Domain.IDomainDevicesAudiosPulseAudioOutputSettings
    {
