...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesRngsBackendEgdSourceFile), fullyQualifiedName: "libvirt.domain.DomainDevicesRngsBackendEgdSourceFile")]
    public interface IDomainDevicesRngsBackendEgdSourceFile
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "secLabel", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"libvirt.domain.DomainDevicesRngsBackendEgdSourceFileSecLabel\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        object? SecLabel
        {
            get
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesRngsBackendEgdSourceFile), fullyQualifiedName: "libvirt.domain.DomainDevicesRngsBackendEgdSourceFile")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesRngsBackendEgdSourceFile
        {
