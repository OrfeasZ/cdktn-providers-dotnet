...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesSmartcardsPassthroughPtySecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesSmartcardsPassthroughPtySecLabel")]
    public interface IDomainDevicesSmartcardsPassthroughPtySecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesSmartcardsPassthroughPtySecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesSmartcardsPassthroughPtySecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesSmartcardsPassthroughPtySecLabel
        {
