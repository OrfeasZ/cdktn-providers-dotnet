...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksSourceVhostUserPty), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceVhostUserPty")]
    public interface IDomainDevicesDisksSourceVhostUserPty
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksSourceVhostUserPty), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceVhostUserPty")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksSourceVhostUserPty
        {
