...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainFeaturesCapabilitiesSysTtyCnofig")]
    public class DomainFeaturesCapabilitiesSysTtyCnofig : libvirt.Domain.IDomainFeaturesCapabilitiesSysTtyCnofig
    {
