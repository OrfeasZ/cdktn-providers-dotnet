...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksSourceVhostUserNmdm), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceVhostUserNmdm")]
    public interface IDomainDevicesDisksSourceVhostUserNmdm
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksSourceVhostUserNmdm), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceVhostUserNmdm")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksSourceVhostUserNmdm
        {
