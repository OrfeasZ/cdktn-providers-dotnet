...
{
    [JsiiInterface(nativeType: typeof(IDomainFeaturesCapabilitiesFsetId), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesFsetId")]
    public interface IDomainFeaturesCapabilitiesFsetId
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainFeaturesCapabilitiesFsetId), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesFsetId")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainFeaturesCapabilitiesFsetId
        {
