...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesConsolesSourceTcpReconnect")]
    public class DomainDevicesConsolesSourceTcpReconnect : libvirt.Domain.IDomainDevicesConsolesSourceTcpReconnect
    {
