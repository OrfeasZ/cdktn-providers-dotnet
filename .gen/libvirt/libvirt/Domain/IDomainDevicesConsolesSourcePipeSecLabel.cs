...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesConsolesSourcePipeSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesConsolesSourcePipeSecLabel")]
    public interface IDomainDevicesConsolesSourcePipeSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesConsolesSourcePipeSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesConsolesSourcePipeSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesConsolesSourcePipeSecLabel
        {
