...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainOsNvRamSourceCookiesCookies")]
    public class DomainOsNvRamSourceCookiesCookies : libvirt.Domain.IDomainOsNvRamSourceCookiesCookies
    {
