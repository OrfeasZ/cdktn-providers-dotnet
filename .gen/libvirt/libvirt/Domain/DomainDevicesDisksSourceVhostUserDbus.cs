...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksSourceVhostUserDbus")]
    public class DomainDevicesDisksSourceVhostUserDbus : libvirt.Domain.IDomainDevicesDisksSourceVhostUserDbus
    {
