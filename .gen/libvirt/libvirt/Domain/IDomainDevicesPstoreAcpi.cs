...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesPstoreAcpi), fullyQualifiedName: "libvirt.domain.DomainDevicesPstoreAcpi")]
    public interface IDomainDevicesPstoreAcpi
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesPstoreAcpi), fullyQualifiedName: "libvirt.domain.DomainDevicesPstoreAcpi")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesPstoreAcpi
        {
