...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainFeaturesHyperVFrequencies")]
    public class DomainFeaturesHyperVFrequencies : libvirt.Domain.IDomainFeaturesHyperVFrequencies
    {
