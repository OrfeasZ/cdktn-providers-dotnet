...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesInputsAlias), fullyQualifiedName: "libvirt.domain.DomainDevicesInputsAlias")]
    public interface IDomainDevicesInputsAlias
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesInputsAlias), fullyQualifiedName: "libvirt.domain.DomainDevicesInputsAlias")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesInputsAlias
        {
