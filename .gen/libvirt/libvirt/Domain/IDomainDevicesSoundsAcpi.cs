...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesSoundsAcpi), fullyQualifiedName: "libvirt.domain.DomainDevicesSoundsAcpi")]
    public interface IDomainDevicesSoundsAcpi
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesSoundsAcpi), fullyQualifiedName: "libvirt.domain.DomainDevicesSoundsAcpi")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesSoundsAcpi
        {
