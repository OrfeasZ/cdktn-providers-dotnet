...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksMirrorBackingStoreSourceReservationsSourceUnix")]
    public class DomainDevicesDisksMirrorBackingStoreSourceReservationsSourceUnix : libvirt.Domain.IDomainDevicesDisksMirrorBackingStoreSourceReservationsSourceUnix
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "reconnect", typeJson: "{\"fqn\":\"libvirt.domain.DomainDevicesDisksMirrorBackingStoreSourceReservationsSourceUnixReconnect\"}", isOptional: true)]
        public libvirt.Domain.IDomainDevicesDisksMirrorBackingStoreSourceReservationsSourceUnixReconnect? Reconnect
        {
            get;
            set;
        }
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "secLabel", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"libvirt.domain.DomainDevicesDisksMirrorBackingStoreSourceReservationsSourceUnixSecLabel\"},\"kind\":\"array\"}}]}}", isOptional: true)]
