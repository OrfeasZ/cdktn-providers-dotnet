...
{
    [JsiiInterface(nativeType: typeof(IDomainOsNvRamSourceVhostUserDbus), fullyQualifiedName: "libvirt.domain.DomainOsNvRamSourceVhostUserDbus")]
    public interface IDomainOsNvRamSourceVhostUserDbus
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainOsNvRamSourceVhostUserDbus), fullyQualifiedName: "libvirt.domain.DomainOsNvRamSourceVhostUserDbus")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainOsNvRamSourceVhostUserDbus
        {
