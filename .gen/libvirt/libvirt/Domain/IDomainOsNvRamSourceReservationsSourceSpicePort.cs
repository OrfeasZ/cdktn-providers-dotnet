...
{
    [JsiiInterface(nativeType: typeof(IDomainOsNvRamSourceReservationsSourceSpicePort), fullyQualifiedName: "libvirt.domain.DomainOsNvRamSourceReservationsSourceSpicePort")]
    public interface IDomainOsNvRamSourceReservationsSourceSpicePort
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainOsNvRamSourceReservationsSourceSpicePort), fullyQualifiedName: "libvirt.domain.DomainOsNvRamSourceReservationsSourceSpicePort")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainOsNvRamSourceReservationsSourceSpicePort
        {
