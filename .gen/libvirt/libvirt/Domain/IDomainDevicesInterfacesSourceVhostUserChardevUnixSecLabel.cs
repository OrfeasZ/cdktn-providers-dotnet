...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesInterfacesSourceVhostUserChardevUnixSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesInterfacesSourceVhostUserChardevUnixSecLabel")]
    public interface IDomainDevicesInterfacesSourceVhostUserChardevUnixSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesInterfacesSourceVhostUserChardevUnixSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesInterfacesSourceVhostUserChardevUnixSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesInterfacesSourceVhostUserChardevUnixSecLabel
        {
