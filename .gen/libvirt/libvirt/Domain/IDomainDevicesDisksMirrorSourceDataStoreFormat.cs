...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksMirrorSourceDataStoreFormat), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceDataStoreFormat")]
    public interface IDomainDevicesDisksMirrorSourceDataStoreFormat
    {
        ...
        libvirt.Domain.IDomainDevicesDisksMirrorSourceDataStoreFormatMetadataCache? MetadataCache
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksMirrorSourceDataStoreFormat), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceDataStoreFormat")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksMirrorSourceDataStoreFormat
        {
            ...
            {
                get => GetInstanceProperty<libvirt.Domain.IDomainDevicesDisksMirrorSourceDataStoreFormatMetadataCache?>();
            }
        }
    }
}
