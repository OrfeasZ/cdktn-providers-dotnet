...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksSourceReservationsSourcePtySecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceReservationsSourcePtySecLabel")]
    public interface IDomainDevicesDisksSourceReservationsSourcePtySecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksSourceReservationsSourcePtySecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceReservationsSourcePtySecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksSourceReservationsSourcePtySecLabel
        {
