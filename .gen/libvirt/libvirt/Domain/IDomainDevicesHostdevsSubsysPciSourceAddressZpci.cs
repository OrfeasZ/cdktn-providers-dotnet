...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesHostdevsSubsysPciSourceAddressZpci), fullyQualifiedName: "libvirt.domain.DomainDevicesHostdevsSubsysPciSourceAddressZpci")]
    public interface IDomainDevicesHostdevsSubsysPciSourceAddressZpci
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesHostdevsSubsysPciSourceAddressZpci), fullyQualifiedName: "libvirt.domain.DomainDevicesHostdevsSubsysPciSourceAddressZpci")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesHostdevsSubsysPciSourceAddressZpci
        {
