...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainFeaturesCapabilitiesDacOverride")]
    public class DomainFeaturesCapabilitiesDacOverride : libvirt.Domain.IDomainFeaturesCapabilitiesDacOverride
    {
