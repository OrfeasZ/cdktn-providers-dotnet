...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksMirrorSourceVhostUserUnixReconnect), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceVhostUserUnixReconnect")]
    public interface IDomainDevicesDisksMirrorSourceVhostUserUnixReconnect
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksMirrorSourceVhostUserUnixReconnect), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceVhostUserUnixReconnect")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksMirrorSourceVhostUserUnixReconnect
        {
