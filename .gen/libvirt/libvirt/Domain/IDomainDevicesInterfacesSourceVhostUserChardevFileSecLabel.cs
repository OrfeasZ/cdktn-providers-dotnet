...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesInterfacesSourceVhostUserChardevFileSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesInterfacesSourceVhostUserChardevFileSecLabel")]
    public interface IDomainDevicesInterfacesSourceVhostUserChardevFileSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesInterfacesSourceVhostUserChardevFileSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesInterfacesSourceVhostUserChardevFileSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesInterfacesSourceVhostUserChardevFileSecLabel
        {
