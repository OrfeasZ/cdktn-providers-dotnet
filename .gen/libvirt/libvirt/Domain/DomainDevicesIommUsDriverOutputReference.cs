...
{
    [JsiiClass(nativeType: typeof(libvirt.Domain.DomainDevicesIommUsDriverOutputReference), fullyQualifiedName: "libvirt.domain.DomainDevicesIommUsDriverOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktn.IInterpolatingParent\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}}]")]
    public class DomainDevicesIommUsDriverOutputReference : Io.Cdktn.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        public DomainDevicesIommUsDriverOutputReference(Io.Cdktn.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
        ...
        protected DomainDevicesIommUsDriverOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected DomainDevicesIommUsDriverOutputReference(DeputyProps props): base(props)
        {
        }

        [JsiiMethod(name: "putGranule", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"libvirt.domain.DomainDevicesIommUsDriverGranule\"}}]")]
        public virtual void PutGranule(libvirt.Domain.IDomainDevicesIommUsDriverGranule @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(libvirt.Domain.IDomainDevicesIommUsDriverGranule)}, new object[]{@value});
        }
        ...
        [JsiiProperty(name: "granule", typeJson: "{\"fqn\":\"libvirt.domain.DomainDevicesIommUsDriverGranuleOutputReference\"}")]
        public virtual libvirt.Domain.DomainDevicesIommUsDriverGranuleOutputReference Granule
        {
            get => GetInstanceProperty<libvirt.Domain.DomainDevicesIommUsDriverGranuleOutputReference>()!;
        }
        ...
        /// <remarks>
        /// <para>Type union: either <see cref="Io.Cdktn.IResolvable" /> or <see cref="libvirt.Domain.IDomainDevicesIommUsDriverGranule" /></para>
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "granuleInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"libvirt.domain.DomainDevicesIommUsDriverGranule\"}]}}", isOptional: true)]
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"libvirt.domain.DomainDevicesIommUsDriver\"}]}}", isOptional: true)]
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        case Io.Cdktn.IResolvable cast_cd4240:
                            break;
                        case libvirt.Domain.IDomainDevicesIommUsDriver cast_cd4240:
                            break;
                        ...
                        case null:
                            break;
                        default:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(libvirt.Domain.IDomainDevicesIommUsDriver).FullName}; received {value.GetType().FullName}", nameof(value));
                    }
                }
