...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesMemorydevsAcpi), fullyQualifiedName: "libvirt.domain.DomainDevicesMemorydevsAcpi")]
    public interface IDomainDevicesMemorydevsAcpi
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesMemorydevsAcpi), fullyQualifiedName: "libvirt.domain.DomainDevicesMemorydevsAcpi")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesMemorydevsAcpi
        {
