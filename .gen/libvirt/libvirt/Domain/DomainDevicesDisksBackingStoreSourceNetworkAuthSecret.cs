...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksBackingStoreSourceNetworkAuthSecret")]
    public class DomainDevicesDisksBackingStoreSourceNetworkAuthSecret : libvirt.Domain.IDomainDevicesDisksBackingStoreSourceNetworkAuthSecret
    {
