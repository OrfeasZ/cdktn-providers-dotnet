...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksSourceReservationsSourceUnixReconnect), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceReservationsSourceUnixReconnect")]
    public interface IDomainDevicesDisksSourceReservationsSourceUnixReconnect
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksSourceReservationsSourceUnixReconnect), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceReservationsSourceUnixReconnect")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksSourceReservationsSourceUnixReconnect
        {
