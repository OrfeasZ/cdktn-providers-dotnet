...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesAudiosNoneInput), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosNoneInput")]
    public interface IDomainDevicesAudiosNoneInput
    {
        ...
        [JsiiProperty(name: "settings", typeJson: "{\"fqn\":\"libvirt.domain.DomainDevicesAudiosNoneInputSettings\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        libvirt.Domain.IDomainDevicesAudiosNoneInputSettings? Settings
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesAudiosNoneInput), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosNoneInput")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesAudiosNoneInput
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "settings", typeJson: "{\"fqn\":\"libvirt.domain.DomainDevicesAudiosNoneInputSettings\"}", isOptional: true)]
            public libvirt.Domain.IDomainDevicesAudiosNoneInputSettings? Settings
            {
                get => GetInstanceProperty<libvirt.Domain.IDomainDevicesAudiosNoneInputSettings?>();
            }
