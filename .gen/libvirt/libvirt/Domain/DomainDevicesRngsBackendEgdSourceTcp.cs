...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesRngsBackendEgdSourceTcp")]
    public class DomainDevicesRngsBackendEgdSourceTcp : libvirt.Domain.IDomainDevicesRngsBackendEgdSourceTcp
    {
