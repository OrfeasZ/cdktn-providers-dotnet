...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesConsolesSourceDbus), fullyQualifiedName: "libvirt.domain.DomainDevicesConsolesSourceDbus")]
    public interface IDomainDevicesConsolesSourceDbus
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesConsolesSourceDbus), fullyQualifiedName: "libvirt.domain.DomainDevicesConsolesSourceDbus")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesConsolesSourceDbus
        {
