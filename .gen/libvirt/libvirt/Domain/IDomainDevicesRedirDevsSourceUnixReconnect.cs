...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesRedirDevsSourceUnixReconnect), fullyQualifiedName: "libvirt.domain.DomainDevicesRedirDevsSourceUnixReconnect")]
    public interface IDomainDevicesRedirDevsSourceUnixReconnect
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesRedirDevsSourceUnixReconnect), fullyQualifiedName: "libvirt.domain.DomainDevicesRedirDevsSourceUnixReconnect")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesRedirDevsSourceUnixReconnect
        {
