...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesTpmsBackendEmulatorActivePcrBanks")]
    public class DomainDevicesTpmsBackendEmulatorActivePcrBanks : libvirt.Domain.IDomainDevicesTpmsBackendEmulatorActivePcrBanks
    {
        private object? _sha1;
