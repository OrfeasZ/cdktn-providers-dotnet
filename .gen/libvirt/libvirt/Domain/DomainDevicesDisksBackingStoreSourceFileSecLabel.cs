...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksBackingStoreSourceFileSecLabel")]
    public class DomainDevicesDisksBackingStoreSourceFileSecLabel : libvirt.Domain.IDomainDevicesDisksBackingStoreSourceFileSecLabel
    {
