...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesRedirDevsSourcePipe), fullyQualifiedName: "libvirt.domain.DomainDevicesRedirDevsSourcePipe")]
    public interface IDomainDevicesRedirDevsSourcePipe
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "secLabel", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"libvirt.domain.DomainDevicesRedirDevsSourcePipeSecLabel\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesRedirDevsSourcePipe), fullyQualifiedName: "libvirt.domain.DomainDevicesRedirDevsSourcePipe")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesRedirDevsSourcePipe
        {
