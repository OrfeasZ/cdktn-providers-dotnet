...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesChannelsSourcePtySecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesChannelsSourcePtySecLabel")]
    public interface IDomainDevicesChannelsSourcePtySecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesChannelsSourcePtySecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesChannelsSourcePtySecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesChannelsSourcePtySecLabel
        {
