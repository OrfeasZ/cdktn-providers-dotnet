...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksSourceReservationsSourceQemuVdAgent")]
    public class DomainDevicesDisksSourceReservationsSourceQemuVdAgent : libvirt.Domain.IDomainDevicesDisksSourceReservationsSourceQemuVdAgent
    {
