...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesParallelsSourceTcp")]
    public class DomainDevicesParallelsSourceTcp : libvirt.Domain.IDomainDevicesParallelsSourceTcp
    {
