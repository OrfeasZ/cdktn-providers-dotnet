...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainFeaturesCapabilitiesSysChRoot")]
    public class DomainFeaturesCapabilitiesSysChRoot : libvirt.Domain.IDomainFeaturesCapabilitiesSysChRoot
    {
