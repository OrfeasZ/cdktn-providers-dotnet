...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesRedirDevsSourceUnixReconnect")]
    public class DomainDevicesRedirDevsSourceUnixReconnect : libvirt.Domain.IDomainDevicesRedirDevsSourceUnixReconnect
    {
