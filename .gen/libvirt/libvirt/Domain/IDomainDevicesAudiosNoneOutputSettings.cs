...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesAudiosNoneOutputSettings), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosNoneOutputSettings")]
    public interface IDomainDevicesAudiosNoneOutputSettings
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesAudiosNoneOutputSettings), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosNoneOutputSettings")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesAudiosNoneOutputSettings
        {
