...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesShmemsAcpi), fullyQualifiedName: "libvirt.domain.DomainDevicesShmemsAcpi")]
    public interface IDomainDevicesShmemsAcpi
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesShmemsAcpi), fullyQualifiedName: "libvirt.domain.DomainDevicesShmemsAcpi")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesShmemsAcpi
        {
