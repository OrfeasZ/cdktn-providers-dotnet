...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksMirrorBackingStoreSource")]
    public class DomainDevicesDisksMirrorBackingStoreSource : libvirt.Domain.IDomainDevicesDisksMirrorBackingStoreSource
    {
