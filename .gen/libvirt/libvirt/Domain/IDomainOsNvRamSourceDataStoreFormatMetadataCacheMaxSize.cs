...
{
    [JsiiInterface(nativeType: typeof(IDomainOsNvRamSourceDataStoreFormatMetadataCacheMaxSize), fullyQualifiedName: "libvirt.domain.DomainOsNvRamSourceDataStoreFormatMetadataCacheMaxSize")]
    public interface IDomainOsNvRamSourceDataStoreFormatMetadataCacheMaxSize
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainOsNvRamSourceDataStoreFormatMetadataCacheMaxSize), fullyQualifiedName: "libvirt.domain.DomainOsNvRamSourceDataStoreFormatMetadataCacheMaxSize")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainOsNvRamSourceDataStoreFormatMetadataCacheMaxSize
        {
