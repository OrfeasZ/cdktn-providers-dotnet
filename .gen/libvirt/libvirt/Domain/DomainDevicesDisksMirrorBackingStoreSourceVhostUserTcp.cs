...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksMirrorBackingStoreSourceVhostUserTcp")]
    public class DomainDevicesDisksMirrorBackingStoreSourceVhostUserTcp : libvirt.Domain.IDomainDevicesDisksMirrorBackingStoreSourceVhostUserTcp
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "reconnect", typeJson: "{\"fqn\":\"libvirt.domain.DomainDevicesDisksMirrorBackingStoreSourceVhostUserTcpReconnect\"}", isOptional: true)]
        public libvirt.Domain.IDomainDevicesDisksMirrorBackingStoreSourceVhostUserTcpReconnect? Reconnect
        {
            get;
            set;
        }
