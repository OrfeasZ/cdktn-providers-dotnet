...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksBackingStoreSourceReservationsSourceUnixReconnect), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackingStoreSourceReservationsSourceUnixReconnect")]
    public interface IDomainDevicesDisksBackingStoreSourceReservationsSourceUnixReconnect
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksBackingStoreSourceReservationsSourceUnixReconnect), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackingStoreSourceReservationsSourceUnixReconnect")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksBackingStoreSourceReservationsSourceUnixReconnect
        {
