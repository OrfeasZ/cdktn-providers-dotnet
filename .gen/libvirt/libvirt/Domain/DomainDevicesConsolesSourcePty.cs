...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesConsolesSourcePty")]
    public class DomainDevicesConsolesSourcePty : libvirt.Domain.IDomainDevicesConsolesSourcePty
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "secLabel", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"libvirt.domain.DomainDevicesConsolesSourcePtySecLabel\"},\"kind\":\"array\"}}]}}", isOptional: true)]
