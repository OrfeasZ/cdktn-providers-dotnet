...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesConsolesSourceDev")]
    public class DomainDevicesConsolesSourceDev : libvirt.Domain.IDomainDevicesConsolesSourceDev
    {
