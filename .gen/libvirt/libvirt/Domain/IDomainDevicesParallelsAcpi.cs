...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesParallelsAcpi), fullyQualifiedName: "libvirt.domain.DomainDevicesParallelsAcpi")]
    public interface IDomainDevicesParallelsAcpi
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesParallelsAcpi), fullyQualifiedName: "libvirt.domain.DomainDevicesParallelsAcpi")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesParallelsAcpi
        {
