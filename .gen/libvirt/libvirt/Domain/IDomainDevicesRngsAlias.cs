...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesRngsAlias), fullyQualifiedName: "libvirt.domain.DomainDevicesRngsAlias")]
    public interface IDomainDevicesRngsAlias
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesRngsAlias), fullyQualifiedName: "libvirt.domain.DomainDevicesRngsAlias")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesRngsAlias
        {
