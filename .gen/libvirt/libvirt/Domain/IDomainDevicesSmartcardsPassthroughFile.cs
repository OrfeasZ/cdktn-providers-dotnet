...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesSmartcardsPassthroughFile), fullyQualifiedName: "libvirt.domain.DomainDevicesSmartcardsPassthroughFile")]
    public interface IDomainDevicesSmartcardsPassthroughFile
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "secLabel", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"libvirt.domain.DomainDevicesSmartcardsPassthroughFileSecLabel\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        object? SecLabel
        {
            get
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesSmartcardsPassthroughFile), fullyQualifiedName: "libvirt.domain.DomainDevicesSmartcardsPassthroughFile")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesSmartcardsPassthroughFile
        {
