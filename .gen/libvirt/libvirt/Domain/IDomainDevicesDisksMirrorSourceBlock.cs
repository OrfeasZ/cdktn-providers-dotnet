...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksMirrorSourceBlock), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceBlock")]
    public interface IDomainDevicesDisksMirrorSourceBlock
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "secLabel", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"libvirt.domain.DomainDevicesDisksMirrorSourceBlockSecLabel\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        object? SecLabel
        {
            get
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksMirrorSourceBlock), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceBlock")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksMirrorSourceBlock
        {
