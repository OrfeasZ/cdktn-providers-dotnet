...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesSerialsSourcePipeSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesSerialsSourcePipeSecLabel")]
    public interface IDomainDevicesSerialsSourcePipeSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesSerialsSourcePipeSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesSerialsSourcePipeSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesSerialsSourcePipeSecLabel
        {
