...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesChannelsSourceUnixSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesChannelsSourceUnixSecLabel")]
    public interface IDomainDevicesChannelsSourceUnixSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesChannelsSourceUnixSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesChannelsSourceUnixSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesChannelsSourceUnixSecLabel
        {
