...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksSourceVhostUserTcp")]
    public class DomainDevicesDisksSourceVhostUserTcp : libvirt.Domain.IDomainDevicesDisksSourceVhostUserTcp
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "reconnect", typeJson: "{\"fqn\":\"libvirt.domain.DomainDevicesDisksSourceVhostUserTcpReconnect\"}", isOptional: true)]
        public libvirt.Domain.IDomainDevicesDisksSourceVhostUserTcpReconnect? Reconnect
        {
            get;
            set;
        }
