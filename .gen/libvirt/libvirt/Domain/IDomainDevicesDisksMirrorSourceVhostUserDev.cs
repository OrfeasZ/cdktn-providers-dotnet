...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksMirrorSourceVhostUserDev), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceVhostUserDev")]
    public interface IDomainDevicesDisksMirrorSourceVhostUserDev
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksMirrorSourceVhostUserDev), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceVhostUserDev")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksMirrorSourceVhostUserDev
        {
