...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksSourceNetwork")]
    public class DomainDevicesDisksSourceNetwork : libvirt.Domain.IDomainDevicesDisksSourceNetwork
    {
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        case Io.Cdktn.IResolvable cast_cd4240:
                            break;
                        case libvirt.Domain.IDomainDevicesDisksSourceNetworkHosts[] cast_cd4240:
                            break;
                        ...
                        case null:
                            break;
                        default:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(libvirt.Domain.IDomainDevicesDisksSourceNetworkHosts).FullName}[]; received {value.GetType().FullName}", nameof(value));
                    }
                }
                _hosts = value;
            }
