...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesSerialsSourceDbus), fullyQualifiedName: "libvirt.domain.DomainDevicesSerialsSourceDbus")]
    public interface IDomainDevicesSerialsSourceDbus
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesSerialsSourceDbus), fullyQualifiedName: "libvirt.domain.DomainDevicesSerialsSourceDbus")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesSerialsSourceDbus
        {
