...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesConsolesLog), fullyQualifiedName: "libvirt.domain.DomainDevicesConsolesLog")]
    public interface IDomainDevicesConsolesLog
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesConsolesLog), fullyQualifiedName: "libvirt.domain.DomainDevicesConsolesLog")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesConsolesLog
        {
