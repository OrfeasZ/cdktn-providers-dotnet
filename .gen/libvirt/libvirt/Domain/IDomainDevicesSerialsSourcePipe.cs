...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesSerialsSourcePipe), fullyQualifiedName: "libvirt.domain.DomainDevicesSerialsSourcePipe")]
    public interface IDomainDevicesSerialsSourcePipe
    {
        ...
        /// <para>Type union: either <see cref="Io.Cdktn.IResolvable" /> or (<see cref="libvirt.Domain.IDomainDevicesSerialsSourcePipeSecLabel" />)[]</para>
        /// </remarks>
        [JsiiProperty(name: "secLabel", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"libvirt.domain.DomainDevicesSerialsSourcePipeSecLabel\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesSerialsSourcePipe), fullyQualifiedName: "libvirt.domain.DomainDevicesSerialsSourcePipe")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesSerialsSourcePipe
        {
