...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesParallelsSourceTcp), fullyQualifiedName: "libvirt.domain.DomainDevicesParallelsSourceTcp")]
    public interface IDomainDevicesParallelsSourceTcp
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "reconnect", typeJson: "{\"fqn\":\"libvirt.domain.DomainDevicesParallelsSourceTcpReconnect\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        libvirt.Domain.IDomainDevicesParallelsSourceTcpReconnect? Reconnect
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesParallelsSourceTcp), fullyQualifiedName: "libvirt.domain.DomainDevicesParallelsSourceTcp")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesParallelsSourceTcp
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "reconnect", typeJson: "{\"fqn\":\"libvirt.domain.DomainDevicesParallelsSourceTcpReconnect\"}", isOptional: true)]
            public libvirt.Domain.IDomainDevicesParallelsSourceTcpReconnect? Reconnect
            {
                get => GetInstanceProperty<libvirt.Domain.IDomainDevicesParallelsSourceTcpReconnect?>();
            }
