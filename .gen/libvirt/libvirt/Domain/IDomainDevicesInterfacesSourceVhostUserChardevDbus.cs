...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesInterfacesSourceVhostUserChardevDbus), fullyQualifiedName: "libvirt.domain.DomainDevicesInterfacesSourceVhostUserChardevDbus")]
    public interface IDomainDevicesInterfacesSourceVhostUserChardevDbus
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesInterfacesSourceVhostUserChardevDbus), fullyQualifiedName: "libvirt.domain.DomainDevicesInterfacesSourceVhostUserChardevDbus")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesInterfacesSourceVhostUserChardevDbus
        {
