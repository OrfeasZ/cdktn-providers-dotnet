...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesParallelsSourceSpicePort), fullyQualifiedName: "libvirt.domain.DomainDevicesParallelsSourceSpicePort")]
    public interface IDomainDevicesParallelsSourceSpicePort
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesParallelsSourceSpicePort), fullyQualifiedName: "libvirt.domain.DomainDevicesParallelsSourceSpicePort")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesParallelsSourceSpicePort
        {
