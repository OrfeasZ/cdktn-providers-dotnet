...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesParallelsSourceUnixReconnect), fullyQualifiedName: "libvirt.domain.DomainDevicesParallelsSourceUnixReconnect")]
    public interface IDomainDevicesParallelsSourceUnixReconnect
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesParallelsSourceUnixReconnect), fullyQualifiedName: "libvirt.domain.DomainDevicesParallelsSourceUnixReconnect")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesParallelsSourceUnixReconnect
        {
