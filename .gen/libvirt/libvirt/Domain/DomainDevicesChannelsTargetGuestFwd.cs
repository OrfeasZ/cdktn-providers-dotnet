...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesChannelsTargetGuestFwd")]
    public class DomainDevicesChannelsTargetGuestFwd : libvirt.Domain.IDomainDevicesChannelsTargetGuestFwd
    {
