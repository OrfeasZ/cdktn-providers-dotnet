...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesAudiosOssOutputSettings), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosOssOutputSettings")]
    public interface IDomainDevicesAudiosOssOutputSettings
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesAudiosOssOutputSettings), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosOssOutputSettings")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesAudiosOssOutputSettings
        {
