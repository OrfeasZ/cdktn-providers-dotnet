...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksMirrorSourceVhostUser")]
    public class DomainDevicesDisksMirrorSourceVhostUser : libvirt.Domain.IDomainDevicesDisksMirrorSourceVhostUser
    {
