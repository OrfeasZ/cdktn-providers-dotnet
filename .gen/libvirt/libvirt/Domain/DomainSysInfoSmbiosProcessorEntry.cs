...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainSysInfoSmbiosProcessorEntry")]
    public class DomainSysInfoSmbiosProcessorEntry : libvirt.Domain.IDomainSysInfoSmbiosProcessorEntry
    {
