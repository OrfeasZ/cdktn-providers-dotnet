...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainFeaturesCapabilitiesLinuxImmutable")]
    public class DomainFeaturesCapabilitiesLinuxImmutable : libvirt.Domain.IDomainFeaturesCapabilitiesLinuxImmutable
    {
