...
{
    [JsiiInterface(nativeType: typeof(IDomainFeaturesCapabilitiesSysAdmin), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesSysAdmin")]
    public interface IDomainFeaturesCapabilitiesSysAdmin
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainFeaturesCapabilitiesSysAdmin), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesSysAdmin")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainFeaturesCapabilitiesSysAdmin
        {
