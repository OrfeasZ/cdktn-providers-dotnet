...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesTpmsBackendExternalSourcePtySecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesTpmsBackendExternalSourcePtySecLabel")]
    public interface IDomainDevicesTpmsBackendExternalSourcePtySecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesTpmsBackendExternalSourcePtySecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesTpmsBackendExternalSourcePtySecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesTpmsBackendExternalSourcePtySecLabel
        {
