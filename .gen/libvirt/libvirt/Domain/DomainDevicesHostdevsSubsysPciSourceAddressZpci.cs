...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesHostdevsSubsysPciSourceAddressZpci")]
    public class DomainDevicesHostdevsSubsysPciSourceAddressZpci : libvirt.Domain.IDomainDevicesHostdevsSubsysPciSourceAddressZpci
    {
