...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksSourceVhostUserPipeSecLabel")]
    public class DomainDevicesDisksSourceVhostUserPipeSecLabel : libvirt.Domain.IDomainDevicesDisksSourceVhostUserPipeSecLabel
    {
