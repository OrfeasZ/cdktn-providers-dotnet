...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesSmartcardsPassthroughPty), fullyQualifiedName: "libvirt.domain.DomainDevicesSmartcardsPassthroughPty")]
    public interface IDomainDevicesSmartcardsPassthroughPty
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesSmartcardsPassthroughPty), fullyQualifiedName: "libvirt.domain.DomainDevicesSmartcardsPassthroughPty")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesSmartcardsPassthroughPty
        {
