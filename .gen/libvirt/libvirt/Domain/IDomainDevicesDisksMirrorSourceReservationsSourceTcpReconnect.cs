...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksMirrorSourceReservationsSourceTcpReconnect), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceReservationsSourceTcpReconnect")]
    public interface IDomainDevicesDisksMirrorSourceReservationsSourceTcpReconnect
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksMirrorSourceReservationsSourceTcpReconnect), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceReservationsSourceTcpReconnect")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksMirrorSourceReservationsSourceTcpReconnect
        {
