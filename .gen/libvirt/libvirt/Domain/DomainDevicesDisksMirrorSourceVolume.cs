...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksMirrorSourceVolume")]
    public class DomainDevicesDisksMirrorSourceVolume : libvirt.Domain.IDomainDevicesDisksMirrorSourceVolume
    {
