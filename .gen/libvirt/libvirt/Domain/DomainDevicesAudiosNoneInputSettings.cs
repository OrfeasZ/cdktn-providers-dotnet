...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesAudiosNoneInputSettings")]
    public class DomainDevicesAudiosNoneInputSettings : libvirt.Domain.IDomainDevicesAudiosNoneInputSettings
    {
