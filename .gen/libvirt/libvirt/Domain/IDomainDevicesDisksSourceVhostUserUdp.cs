...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksSourceVhostUserUdp), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceVhostUserUdp")]
    public interface IDomainDevicesDisksSourceVhostUserUdp
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksSourceVhostUserUdp), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceVhostUserUdp")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksSourceVhostUserUdp
        {
