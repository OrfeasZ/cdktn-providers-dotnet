...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesAudiosAlsaInputSettings), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosAlsaInputSettings")]
    public interface IDomainDevicesAudiosAlsaInputSettings
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesAudiosAlsaInputSettings), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosAlsaInputSettings")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesAudiosAlsaInputSettings
        {
