...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesGraphicsSpiceListenersSocket")]
    public class DomainDevicesGraphicsSpiceListenersSocket : libvirt.Domain.IDomainDevicesGraphicsSpiceListenersSocket
    {
