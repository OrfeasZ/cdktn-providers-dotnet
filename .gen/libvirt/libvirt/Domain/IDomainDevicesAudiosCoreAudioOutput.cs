...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesAudiosCoreAudioOutput), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosCoreAudioOutput")]
    public interface IDomainDevicesAudiosCoreAudioOutput
    {
        ...
        [JsiiProperty(name: "settings", typeJson: "{\"fqn\":\"libvirt.domain.DomainDevicesAudiosCoreAudioOutputSettings\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        libvirt.Domain.IDomainDevicesAudiosCoreAudioOutputSettings? Settings
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesAudiosCoreAudioOutput), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosCoreAudioOutput")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesAudiosCoreAudioOutput
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "settings", typeJson: "{\"fqn\":\"libvirt.domain.DomainDevicesAudiosCoreAudioOutputSettings\"}", isOptional: true)]
            public libvirt.Domain.IDomainDevicesAudiosCoreAudioOutputSettings? Settings
            {
                get => GetInstanceProperty<libvirt.Domain.IDomainDevicesAudiosCoreAudioOutputSettings?>();
            }
