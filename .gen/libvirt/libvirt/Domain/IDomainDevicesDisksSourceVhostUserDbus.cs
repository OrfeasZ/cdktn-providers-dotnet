...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksSourceVhostUserDbus), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceVhostUserDbus")]
    public interface IDomainDevicesDisksSourceVhostUserDbus
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksSourceVhostUserDbus), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceVhostUserDbus")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksSourceVhostUserDbus
        {
