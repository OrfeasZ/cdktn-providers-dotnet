...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesRedirDevsSourceUnix), fullyQualifiedName: "libvirt.domain.DomainDevicesRedirDevsSourceUnix")]
    public interface IDomainDevicesRedirDevsSourceUnix
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        libvirt.Domain.IDomainDevicesRedirDevsSourceUnixReconnect? Reconnect
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesRedirDevsSourceUnix), fullyQualifiedName: "libvirt.domain.DomainDevicesRedirDevsSourceUnix")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesRedirDevsSourceUnix
        {
            ...
            {
                get => GetInstanceProperty<libvirt.Domain.IDomainDevicesRedirDevsSourceUnixReconnect?>();
            }
