...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesInterfacesSourceMcastLocal")]
    public class DomainDevicesInterfacesSourceMcastLocal : libvirt.Domain.IDomainDevicesInterfacesSourceMcastLocal
    {
