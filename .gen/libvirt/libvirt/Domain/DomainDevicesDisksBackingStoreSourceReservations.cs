...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksBackingStoreSourceReservations")]
    public class DomainDevicesDisksBackingStoreSourceReservations : libvirt.Domain.IDomainDevicesDisksBackingStoreSourceReservations
    {
        ...
        /// <summary>Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dmacvicar/libvirt/0.9.9/docs/resources/domain#migration Domain#migration}.</summary>
        [JsiiOptional]
        [JsiiProperty(name: "migration", typeJson: "{\"primitive\":\"string\"}", isOptional: true)]
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "source", typeJson: "{\"fqn\":\"libvirt.domain.DomainDevicesDisksBackingStoreSourceReservationsSource\"}", isOptional: true)]
        public libvirt.Domain.IDomainDevicesDisksBackingStoreSourceReservationsSource? Source
        {
            get;
            set;
        }
