...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksSourceVhostUserUnix), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceVhostUserUnix")]
    public interface IDomainDevicesDisksSourceVhostUserUnix
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "reconnect", typeJson: "{\"fqn\":\"libvirt.domain.DomainDevicesDisksSourceVhostUserUnixReconnect\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        libvirt.Domain.IDomainDevicesDisksSourceVhostUserUnixReconnect? Reconnect
        {
            get
            {
                return null;
        ...
        /// </remarks>
        [JsiiProperty(name: "secLabel", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"libvirt.domain.DomainDevicesDisksSourceVhostUserUnixSecLabel\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        object? SecLabel
        {
            get
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksSourceVhostUserUnix), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceVhostUserUnix")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksSourceVhostUserUnix
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "reconnect", typeJson: "{\"fqn\":\"libvirt.domain.DomainDevicesDisksSourceVhostUserUnixReconnect\"}", isOptional: true)]
            public libvirt.Domain.IDomainDevicesDisksSourceVhostUserUnixReconnect? Reconnect
            {
                get => GetInstanceProperty<libvirt.Domain.IDomainDevicesDisksSourceVhostUserUnixReconnect?>();
            }
