...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesTpmsBackendExternalSourceUnix), fullyQualifiedName: "libvirt.domain.DomainDevicesTpmsBackendExternalSourceUnix")]
    public interface IDomainDevicesTpmsBackendExternalSourceUnix
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "reconnect", typeJson: "{\"fqn\":\"libvirt.domain.DomainDevicesTpmsBackendExternalSourceUnixReconnect\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        libvirt.Domain.IDomainDevicesTpmsBackendExternalSourceUnixReconnect? Reconnect
        {
            get
            {
                return null;
        ...
        /// </remarks>
        [JsiiProperty(name: "secLabel", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"libvirt.domain.DomainDevicesTpmsBackendExternalSourceUnixSecLabel\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        object? SecLabel
        {
            get
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesTpmsBackendExternalSourceUnix), fullyQualifiedName: "libvirt.domain.DomainDevicesTpmsBackendExternalSourceUnix")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesTpmsBackendExternalSourceUnix
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "reconnect", typeJson: "{\"fqn\":\"libvirt.domain.DomainDevicesTpmsBackendExternalSourceUnixReconnect\"}", isOptional: true)]
            public libvirt.Domain.IDomainDevicesTpmsBackendExternalSourceUnixReconnect? Reconnect
            {
                get => GetInstanceProperty<libvirt.Domain.IDomainDevicesTpmsBackendExternalSourceUnixReconnect?>();
            }
