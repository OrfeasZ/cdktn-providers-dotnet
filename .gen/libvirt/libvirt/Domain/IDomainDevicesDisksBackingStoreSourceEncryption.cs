...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksBackingStoreSourceEncryption), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackingStoreSourceEncryption")]
    public interface IDomainDevicesDisksBackingStoreSourceEncryption
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksBackingStoreSourceEncryption), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackingStoreSourceEncryption")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksBackingStoreSourceEncryption
        {
