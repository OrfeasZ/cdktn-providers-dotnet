...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksSourceFile")]
    public class DomainDevicesDisksSourceFile : libvirt.Domain.IDomainDevicesDisksSourceFile
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "secLabel", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"libvirt.domain.DomainDevicesDisksSourceFileSecLabel\"},\"kind\":\"array\"}}]}}", isOptional: true)]
