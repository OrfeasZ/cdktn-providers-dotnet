...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksBackingStoreSourceEncryptionSecrets), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackingStoreSourceEncryptionSecrets")]
    public interface IDomainDevicesDisksBackingStoreSourceEncryptionSecrets
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksBackingStoreSourceEncryptionSecrets), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackingStoreSourceEncryptionSecrets")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksBackingStoreSourceEncryptionSecrets
        {
