...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksSourceFileSecLabel")]
    public class DomainDevicesDisksSourceFileSecLabel : libvirt.Domain.IDomainDevicesDisksSourceFileSecLabel
    {
