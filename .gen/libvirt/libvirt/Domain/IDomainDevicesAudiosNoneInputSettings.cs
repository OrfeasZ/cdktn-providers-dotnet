...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesAudiosNoneInputSettings), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosNoneInputSettings")]
    public interface IDomainDevicesAudiosNoneInputSettings
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesAudiosNoneInputSettings), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosNoneInputSettings")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesAudiosNoneInputSettings
        {
