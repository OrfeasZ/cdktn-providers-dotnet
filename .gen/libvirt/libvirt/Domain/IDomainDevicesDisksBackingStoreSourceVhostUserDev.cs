...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksBackingStoreSourceVhostUserDev), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackingStoreSourceVhostUserDev")]
    public interface IDomainDevicesDisksBackingStoreSourceVhostUserDev
    {
        ...
        /// <para>Type union: either <see cref="Io.Cdktn.IResolvable" /> or (<see cref="libvirt.Domain.IDomainDevicesDisksBackingStoreSourceVhostUserDevSecLabel" />)[]</para>
        /// </remarks>
        [JsiiProperty(name: "secLabel", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"libvirt.domain.DomainDevicesDisksBackingStoreSourceVhostUserDevSecLabel\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksBackingStoreSourceVhostUserDev), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackingStoreSourceVhostUserDev")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksBackingStoreSourceVhostUserDev
        {
