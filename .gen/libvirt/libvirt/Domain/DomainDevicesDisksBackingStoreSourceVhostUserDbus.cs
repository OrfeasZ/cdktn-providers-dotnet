...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksBackingStoreSourceVhostUserDbus")]
    public class DomainDevicesDisksBackingStoreSourceVhostUserDbus : libvirt.Domain.IDomainDevicesDisksBackingStoreSourceVhostUserDbus
    {
