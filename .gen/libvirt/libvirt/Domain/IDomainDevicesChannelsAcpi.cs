...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesChannelsAcpi), fullyQualifiedName: "libvirt.domain.DomainDevicesChannelsAcpi")]
    public interface IDomainDevicesChannelsAcpi
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesChannelsAcpi), fullyQualifiedName: "libvirt.domain.DomainDevicesChannelsAcpi")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesChannelsAcpi
        {
