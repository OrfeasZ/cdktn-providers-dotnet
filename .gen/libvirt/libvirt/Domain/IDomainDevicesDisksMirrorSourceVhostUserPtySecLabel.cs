...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksMirrorSourceVhostUserPtySecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceVhostUserPtySecLabel")]
    public interface IDomainDevicesDisksMirrorSourceVhostUserPtySecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksMirrorSourceVhostUserPtySecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceVhostUserPtySecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksMirrorSourceVhostUserPtySecLabel
        {
