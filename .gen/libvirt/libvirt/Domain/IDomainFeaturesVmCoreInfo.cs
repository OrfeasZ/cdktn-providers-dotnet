...
{
    [JsiiInterface(nativeType: typeof(IDomainFeaturesVmCoreInfo), fullyQualifiedName: "libvirt.domain.DomainFeaturesVmCoreInfo")]
    public interface IDomainFeaturesVmCoreInfo
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainFeaturesVmCoreInfo), fullyQualifiedName: "libvirt.domain.DomainFeaturesVmCoreInfo")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainFeaturesVmCoreInfo
        {
