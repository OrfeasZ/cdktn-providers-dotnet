...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainFeaturesCapabilitiesNetRaw")]
    public class DomainFeaturesCapabilitiesNetRaw : libvirt.Domain.IDomainFeaturesCapabilitiesNetRaw
    {
