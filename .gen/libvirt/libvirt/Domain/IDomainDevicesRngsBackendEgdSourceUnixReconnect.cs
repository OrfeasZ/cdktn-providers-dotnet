...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesRngsBackendEgdSourceUnixReconnect), fullyQualifiedName: "libvirt.domain.DomainDevicesRngsBackendEgdSourceUnixReconnect")]
    public interface IDomainDevicesRngsBackendEgdSourceUnixReconnect
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesRngsBackendEgdSourceUnixReconnect), fullyQualifiedName: "libvirt.domain.DomainDevicesRngsBackendEgdSourceUnixReconnect")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesRngsBackendEgdSourceUnixReconnect
        {
