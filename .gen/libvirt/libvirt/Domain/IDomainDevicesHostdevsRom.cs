...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesHostdevsRom), fullyQualifiedName: "libvirt.domain.DomainDevicesHostdevsRom")]
    public interface IDomainDevicesHostdevsRom
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesHostdevsRom), fullyQualifiedName: "libvirt.domain.DomainDevicesHostdevsRom")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesHostdevsRom
        {
