...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesSmartcardsPassthroughNmdm")]
    public class DomainDevicesSmartcardsPassthroughNmdm : libvirt.Domain.IDomainDevicesSmartcardsPassthroughNmdm
    {
