...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksSourceFile), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceFile")]
    public interface IDomainDevicesDisksSourceFile
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksSourceFile), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceFile")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksSourceFile
        {
