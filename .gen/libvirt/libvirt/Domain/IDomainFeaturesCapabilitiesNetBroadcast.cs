...
{
    [JsiiInterface(nativeType: typeof(IDomainFeaturesCapabilitiesNetBroadcast), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesNetBroadcast")]
    public interface IDomainFeaturesCapabilitiesNetBroadcast
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainFeaturesCapabilitiesNetBroadcast), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesNetBroadcast")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainFeaturesCapabilitiesNetBroadcast
        {
