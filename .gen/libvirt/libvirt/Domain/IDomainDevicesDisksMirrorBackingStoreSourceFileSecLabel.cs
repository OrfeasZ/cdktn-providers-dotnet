...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksMirrorBackingStoreSourceFileSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorBackingStoreSourceFileSecLabel")]
    public interface IDomainDevicesDisksMirrorBackingStoreSourceFileSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksMirrorBackingStoreSourceFileSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorBackingStoreSourceFileSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksMirrorBackingStoreSourceFileSecLabel
        {
