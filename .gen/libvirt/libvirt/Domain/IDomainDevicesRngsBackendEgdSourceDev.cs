...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesRngsBackendEgdSourceDev), fullyQualifiedName: "libvirt.domain.DomainDevicesRngsBackendEgdSourceDev")]
    public interface IDomainDevicesRngsBackendEgdSourceDev
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesRngsBackendEgdSourceDev), fullyQualifiedName: "libvirt.domain.DomainDevicesRngsBackendEgdSourceDev")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesRngsBackendEgdSourceDev
        {
