...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksSourceDataStoreFormat")]
    public class DomainDevicesDisksSourceDataStoreFormat : libvirt.Domain.IDomainDevicesDisksSourceDataStoreFormat
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "metadataCache", typeJson: "{\"fqn\":\"libvirt.domain.DomainDevicesDisksSourceDataStoreFormatMetadataCache\"}", isOptional: true)]
        public libvirt.Domain.IDomainDevicesDisksSourceDataStoreFormatMetadataCache? MetadataCache
        {
            get;
            set;
        }
