...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesSerialsSourceDev")]
    public class DomainDevicesSerialsSourceDev : libvirt.Domain.IDomainDevicesSerialsSourceDev
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "secLabel", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"libvirt.domain.DomainDevicesSerialsSourceDevSecLabel\"},\"kind\":\"array\"}}]}}", isOptional: true)]
