...
{
    [JsiiInterface(nativeType: typeof(IDomainFeaturesRas), fullyQualifiedName: "libvirt.domain.DomainFeaturesRas")]
    public interface IDomainFeaturesRas
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainFeaturesRas), fullyQualifiedName: "libvirt.domain.DomainFeaturesRas")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainFeaturesRas
        {
