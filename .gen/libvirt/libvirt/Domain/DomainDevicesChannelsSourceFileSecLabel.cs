...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesChannelsSourceFileSecLabel")]
    public class DomainDevicesChannelsSourceFileSecLabel : libvirt.Domain.IDomainDevicesChannelsSourceFileSecLabel
    {
