...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesChannelsSourcePipeSecLabel")]
    public class DomainDevicesChannelsSourcePipeSecLabel : libvirt.Domain.IDomainDevicesChannelsSourcePipeSecLabel
    {
