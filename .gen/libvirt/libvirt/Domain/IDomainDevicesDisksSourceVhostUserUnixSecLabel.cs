...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksSourceVhostUserUnixSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceVhostUserUnixSecLabel")]
    public interface IDomainDevicesDisksSourceVhostUserUnixSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksSourceVhostUserUnixSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceVhostUserUnixSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksSourceVhostUserUnixSecLabel
        {
