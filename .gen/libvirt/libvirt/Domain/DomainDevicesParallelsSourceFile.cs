...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesParallelsSourceFile")]
    public class DomainDevicesParallelsSourceFile : libvirt.Domain.IDomainDevicesParallelsSourceFile
    {
