...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksMirrorBackingStoreSourceFile), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorBackingStoreSourceFile")]
    public interface IDomainDevicesDisksMirrorBackingStoreSourceFile
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksMirrorBackingStoreSourceFile), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorBackingStoreSourceFile")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksMirrorBackingStoreSourceFile
        {
