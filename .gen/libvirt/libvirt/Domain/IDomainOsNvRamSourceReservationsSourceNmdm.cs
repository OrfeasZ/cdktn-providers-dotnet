...
{
    [JsiiInterface(nativeType: typeof(IDomainOsNvRamSourceReservationsSourceNmdm), fullyQualifiedName: "libvirt.domain.DomainOsNvRamSourceReservationsSourceNmdm")]
    public interface IDomainOsNvRamSourceReservationsSourceNmdm
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainOsNvRamSourceReservationsSourceNmdm), fullyQualifiedName: "libvirt.domain.DomainOsNvRamSourceReservationsSourceNmdm")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainOsNvRamSourceReservationsSourceNmdm
        {
