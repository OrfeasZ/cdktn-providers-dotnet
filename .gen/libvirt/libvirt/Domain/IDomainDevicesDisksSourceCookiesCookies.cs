...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksSourceCookiesCookies), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceCookiesCookies")]
    public interface IDomainDevicesDisksSourceCookiesCookies
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksSourceCookiesCookies), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceCookiesCookies")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksSourceCookiesCookies
        {
