...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesMemBalloonDriver), fullyQualifiedName: "libvirt.domain.DomainDevicesMemBalloonDriver")]
    public interface IDomainDevicesMemBalloonDriver
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesMemBalloonDriver), fullyQualifiedName: "libvirt.domain.DomainDevicesMemBalloonDriver")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesMemBalloonDriver
        {
