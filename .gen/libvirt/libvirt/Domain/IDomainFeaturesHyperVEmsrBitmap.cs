...
{
    [JsiiInterface(nativeType: typeof(IDomainFeaturesHyperVEmsrBitmap), fullyQualifiedName: "libvirt.domain.DomainFeaturesHyperVEmsrBitmap")]
    public interface IDomainFeaturesHyperVEmsrBitmap
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainFeaturesHyperVEmsrBitmap), fullyQualifiedName: "libvirt.domain.DomainFeaturesHyperVEmsrBitmap")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainFeaturesHyperVEmsrBitmap
        {
