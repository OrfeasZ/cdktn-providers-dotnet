...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksSourceReservationsSourceNmdm), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceReservationsSourceNmdm")]
    public interface IDomainDevicesDisksSourceReservationsSourceNmdm
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksSourceReservationsSourceNmdm), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceReservationsSourceNmdm")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksSourceReservationsSourceNmdm
        {
