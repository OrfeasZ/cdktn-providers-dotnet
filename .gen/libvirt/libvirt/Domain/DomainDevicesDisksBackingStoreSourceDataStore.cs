...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksBackingStoreSourceDataStore")]
    public class DomainDevicesDisksBackingStoreSourceDataStore : libvirt.Domain.IDomainDevicesDisksBackingStoreSourceDataStore
    {
