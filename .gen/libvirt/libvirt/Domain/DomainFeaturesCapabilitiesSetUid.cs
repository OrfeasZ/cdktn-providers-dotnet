...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainFeaturesCapabilitiesSetUid")]
    public class DomainFeaturesCapabilitiesSetUid : libvirt.Domain.IDomainFeaturesCapabilitiesSetUid
    {
