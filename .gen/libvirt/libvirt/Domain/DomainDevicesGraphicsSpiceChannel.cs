...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesGraphicsSpiceChannel")]
    public class DomainDevicesGraphicsSpiceChannel : libvirt.Domain.IDomainDevicesGraphicsSpiceChannel
    {
