...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksSourceNetworkAuth), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceNetworkAuth")]
    public interface IDomainDevicesDisksSourceNetworkAuth
    {
        ...
        libvirt.Domain.IDomainDevicesDisksSourceNetworkAuthSecret? Secret
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksSourceNetworkAuth), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceNetworkAuth")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksSourceNetworkAuth
        {
            ...
            {
                get => GetInstanceProperty<libvirt.Domain.IDomainDevicesDisksSourceNetworkAuthSecret?>();
            }
