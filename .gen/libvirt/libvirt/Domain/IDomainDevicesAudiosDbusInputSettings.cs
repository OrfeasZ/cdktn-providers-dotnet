...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesAudiosDbusInputSettings), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosDbusInputSettings")]
    public interface IDomainDevicesAudiosDbusInputSettings
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesAudiosDbusInputSettings), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosDbusInputSettings")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesAudiosDbusInputSettings
        {
