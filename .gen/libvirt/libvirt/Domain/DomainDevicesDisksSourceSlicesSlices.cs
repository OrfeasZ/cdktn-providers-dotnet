...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksSourceSlicesSlices")]
    public class DomainDevicesDisksSourceSlicesSlices : libvirt.Domain.IDomainDevicesDisksSourceSlicesSlices
    {
