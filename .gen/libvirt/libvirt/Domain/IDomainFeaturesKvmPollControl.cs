...
{
    [JsiiInterface(nativeType: typeof(IDomainFeaturesKvmPollControl), fullyQualifiedName: "libvirt.domain.DomainFeaturesKvmPollControl")]
    public interface IDomainFeaturesKvmPollControl
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainFeaturesKvmPollControl), fullyQualifiedName: "libvirt.domain.DomainFeaturesKvmPollControl")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainFeaturesKvmPollControl
        {
