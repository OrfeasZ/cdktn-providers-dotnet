...
{
    [JsiiInterface(nativeType: typeof(IDomainFeaturesCapabilitiesSetGid), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesSetGid")]
    public interface IDomainFeaturesCapabilitiesSetGid
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainFeaturesCapabilitiesSetGid), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesSetGid")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainFeaturesCapabilitiesSetGid
        {
