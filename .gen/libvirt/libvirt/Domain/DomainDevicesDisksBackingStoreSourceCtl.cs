...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksBackingStoreSourceCtl")]
    public class DomainDevicesDisksBackingStoreSourceCtl : libvirt.Domain.IDomainDevicesDisksBackingStoreSourceCtl
    {
