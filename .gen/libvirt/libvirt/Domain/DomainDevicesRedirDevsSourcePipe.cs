...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesRedirDevsSourcePipe")]
    public class DomainDevicesRedirDevsSourcePipe : libvirt.Domain.IDomainDevicesRedirDevsSourcePipe
    {
