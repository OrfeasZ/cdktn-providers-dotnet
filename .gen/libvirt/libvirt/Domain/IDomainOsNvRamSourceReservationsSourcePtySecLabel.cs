...
{
    [JsiiInterface(nativeType: typeof(IDomainOsNvRamSourceReservationsSourcePtySecLabel), fullyQualifiedName: "libvirt.domain.DomainOsNvRamSourceReservationsSourcePtySecLabel")]
    public interface IDomainOsNvRamSourceReservationsSourcePtySecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainOsNvRamSourceReservationsSourcePtySecLabel), fullyQualifiedName: "libvirt.domain.DomainOsNvRamSourceReservationsSourcePtySecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainOsNvRamSourceReservationsSourcePtySecLabel
        {
