...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesRedirDevsSourceTcpReconnect), fullyQualifiedName: "libvirt.domain.DomainDevicesRedirDevsSourceTcpReconnect")]
    public interface IDomainDevicesRedirDevsSourceTcpReconnect
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesRedirDevsSourceTcpReconnect), fullyQualifiedName: "libvirt.domain.DomainDevicesRedirDevsSourceTcpReconnect")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesRedirDevsSourceTcpReconnect
        {
