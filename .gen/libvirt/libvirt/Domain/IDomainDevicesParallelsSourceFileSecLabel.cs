...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesParallelsSourceFileSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesParallelsSourceFileSecLabel")]
    public interface IDomainDevicesParallelsSourceFileSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesParallelsSourceFileSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesParallelsSourceFileSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesParallelsSourceFileSecLabel
        {
