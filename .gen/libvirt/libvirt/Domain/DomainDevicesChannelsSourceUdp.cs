...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesChannelsSourceUdp")]
    public class DomainDevicesChannelsSourceUdp : libvirt.Domain.IDomainDevicesChannelsSourceUdp
    {
