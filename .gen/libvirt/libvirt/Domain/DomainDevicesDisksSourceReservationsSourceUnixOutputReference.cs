...
namespace libvirt.Domain
{
    ...
    public class DomainDevicesDisksSourceReservationsSourceUnixOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        /// <param name="value">Type union: either <see cref="Io.Cdktn.IResolvable" /> or (<see cref="libvirt.Domain.IDomainDevicesDisksSourceReservationsSourceUnixSecLabel" />)[]</param>
        ...
        /// <remarks>
        /// <para>Type union: either <see cref="Io.Cdktn.IResolvable" /> or <see cref="libvirt.Domain.IDomainDevicesDisksSourceReservationsSourceUnix" /></para>
        /// </remarks>
        [JsiiOptional]
