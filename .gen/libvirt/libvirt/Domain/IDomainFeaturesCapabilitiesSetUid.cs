...
{
    [JsiiInterface(nativeType: typeof(IDomainFeaturesCapabilitiesSetUid), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesSetUid")]
    public interface IDomainFeaturesCapabilitiesSetUid
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainFeaturesCapabilitiesSetUid), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesSetUid")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainFeaturesCapabilitiesSetUid
        {
