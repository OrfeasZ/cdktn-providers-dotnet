...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainFeaturesCapabilitiesSysResource")]
    public class DomainFeaturesCapabilitiesSysResource : libvirt.Domain.IDomainFeaturesCapabilitiesSysResource
    {
