...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesParallelsSourcePipeSecLabel")]
    public class DomainDevicesParallelsSourcePipeSecLabel : libvirt.Domain.IDomainDevicesParallelsSourcePipeSecLabel
    {
