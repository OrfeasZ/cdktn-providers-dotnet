...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesConsolesSourcePty), fullyQualifiedName: "libvirt.domain.DomainDevicesConsolesSourcePty")]
    public interface IDomainDevicesConsolesSourcePty
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesConsolesSourcePty), fullyQualifiedName: "libvirt.domain.DomainDevicesConsolesSourcePty")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesConsolesSourcePty
        {
