...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesInterfacesSourceVhostUserChardevPtySecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesInterfacesSourceVhostUserChardevPtySecLabel")]
    public interface IDomainDevicesInterfacesSourceVhostUserChardevPtySecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesInterfacesSourceVhostUserChardevPtySecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesInterfacesSourceVhostUserChardevPtySecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesInterfacesSourceVhostUserChardevPtySecLabel
        {
