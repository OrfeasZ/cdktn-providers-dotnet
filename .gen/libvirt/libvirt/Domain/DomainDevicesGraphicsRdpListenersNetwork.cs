...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesGraphicsRdpListenersNetwork")]
    public class DomainDevicesGraphicsRdpListenersNetwork : libvirt.Domain.IDomainDevicesGraphicsRdpListenersNetwork
    {
