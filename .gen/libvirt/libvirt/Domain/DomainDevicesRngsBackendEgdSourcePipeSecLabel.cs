...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesRngsBackendEgdSourcePipeSecLabel")]
    public class DomainDevicesRngsBackendEgdSourcePipeSecLabel : libvirt.Domain.IDomainDevicesRngsBackendEgdSourcePipeSecLabel
    {
