...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesConsolesProtocol), fullyQualifiedName: "libvirt.domain.DomainDevicesConsolesProtocol")]
    public interface IDomainDevicesConsolesProtocol
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesConsolesProtocol), fullyQualifiedName: "libvirt.domain.DomainDevicesConsolesProtocol")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesConsolesProtocol
        {
