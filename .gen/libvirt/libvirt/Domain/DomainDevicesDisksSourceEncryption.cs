...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksSourceEncryption")]
    public class DomainDevicesDisksSourceEncryption : libvirt.Domain.IDomainDevicesDisksSourceEncryption
    {
