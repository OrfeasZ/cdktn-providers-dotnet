...
namespace libvirt.Domain
{
    ...
    public class DomainDevicesDisksSourceReservationsSourcePtyOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        /// <param name="value">Type union: either <see cref="Io.Cdktn.IResolvable" /> or (<see cref="libvirt.Domain.IDomainDevicesDisksSourceReservationsSourcePtySecLabel" />)[]</param>
        ...
        /// <remarks>
        /// <para>Type union: either <see cref="Io.Cdktn.IResolvable" /> or <see cref="libvirt.Domain.IDomainDevicesDisksSourceReservationsSourcePty" /></para>
        /// </remarks>
        [JsiiOptional]
