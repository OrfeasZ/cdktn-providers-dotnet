...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksMirrorSourceVhostUserPty), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceVhostUserPty")]
    public interface IDomainDevicesDisksMirrorSourceVhostUserPty
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksMirrorSourceVhostUserPty), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceVhostUserPty")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksMirrorSourceVhostUserPty
        {
