...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesAudiosOssOutputSettings")]
    public class DomainDevicesAudiosOssOutputSettings : libvirt.Domain.IDomainDevicesAudiosOssOutputSettings
    {
