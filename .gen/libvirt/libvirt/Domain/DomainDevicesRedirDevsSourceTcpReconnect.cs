...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesRedirDevsSourceTcpReconnect")]
    public class DomainDevicesRedirDevsSourceTcpReconnect : libvirt.Domain.IDomainDevicesRedirDevsSourceTcpReconnect
    {
