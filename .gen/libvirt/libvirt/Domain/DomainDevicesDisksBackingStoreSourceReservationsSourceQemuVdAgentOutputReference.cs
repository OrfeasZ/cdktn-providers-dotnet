...
namespace libvirt.Domain
{
    ...
    public class DomainDevicesDisksBackingStoreSourceReservationsSourceQemuVdAgentOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        /// <remarks>
        /// <para>Type union: either <see cref="Io.Cdktn.IResolvable" /> or <see cref="libvirt.Domain.IDomainDevicesDisksBackingStoreSourceReservationsSourceQemuVdAgentClipBoard" /></para>
        /// </remarks>
        [JsiiOptional]
        ...
        /// <remarks>
        /// <para>Type union: either <see cref="Io.Cdktn.IResolvable" /> or <see cref="libvirt.Domain.IDomainDevicesDisksBackingStoreSourceReservationsSourceQemuVdAgentMouse" /></para>
        /// </remarks>
        [JsiiOptional]
