...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksMirrorSourceReservationsSourceUnixSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceReservationsSourceUnixSecLabel")]
    public interface IDomainDevicesDisksMirrorSourceReservationsSourceUnixSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksMirrorSourceReservationsSourceUnixSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceReservationsSourceUnixSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksMirrorSourceReservationsSourceUnixSecLabel
        {
