...
{
    [JsiiInterface(nativeType: typeof(IDomainFeaturesCapabilitiesSysRawIo), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesSysRawIo")]
    public interface IDomainFeaturesCapabilitiesSysRawIo
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainFeaturesCapabilitiesSysRawIo), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesSysRawIo")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainFeaturesCapabilitiesSysRawIo
        {
