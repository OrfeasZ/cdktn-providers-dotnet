...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesSerialsSourceDev), fullyQualifiedName: "libvirt.domain.DomainDevicesSerialsSourceDev")]
    public interface IDomainDevicesSerialsSourceDev
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesSerialsSourceDev), fullyQualifiedName: "libvirt.domain.DomainDevicesSerialsSourceDev")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesSerialsSourceDev
        {
