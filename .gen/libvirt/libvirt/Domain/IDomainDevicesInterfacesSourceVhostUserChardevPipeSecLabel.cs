...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesInterfacesSourceVhostUserChardevPipeSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesInterfacesSourceVhostUserChardevPipeSecLabel")]
    public interface IDomainDevicesInterfacesSourceVhostUserChardevPipeSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesInterfacesSourceVhostUserChardevPipeSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesInterfacesSourceVhostUserChardevPipeSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesInterfacesSourceVhostUserChardevPipeSecLabel
        {
