...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesRedirDevsSourceTcp")]
    public class DomainDevicesRedirDevsSourceTcp : libvirt.Domain.IDomainDevicesRedirDevsSourceTcp
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "reconnect", typeJson: "{\"fqn\":\"libvirt.domain.DomainDevicesRedirDevsSourceTcpReconnect\"}", isOptional: true)]
        public libvirt.Domain.IDomainDevicesRedirDevsSourceTcpReconnect? Reconnect
        {
            get;
            set;
        }
