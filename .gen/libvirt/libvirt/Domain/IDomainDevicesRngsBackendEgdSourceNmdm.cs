...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesRngsBackendEgdSourceNmdm), fullyQualifiedName: "libvirt.domain.DomainDevicesRngsBackendEgdSourceNmdm")]
    public interface IDomainDevicesRngsBackendEgdSourceNmdm
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesRngsBackendEgdSourceNmdm), fullyQualifiedName: "libvirt.domain.DomainDevicesRngsBackendEgdSourceNmdm")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesRngsBackendEgdSourceNmdm
        {
