...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesTpmsBackendExternalSourceDev), fullyQualifiedName: "libvirt.domain.DomainDevicesTpmsBackendExternalSourceDev")]
    public interface IDomainDevicesTpmsBackendExternalSourceDev
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesTpmsBackendExternalSourceDev), fullyQualifiedName: "libvirt.domain.DomainDevicesTpmsBackendExternalSourceDev")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesTpmsBackendExternalSourceDev
        {
