...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesChannelsSourceFileSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesChannelsSourceFileSecLabel")]
    public interface IDomainDevicesChannelsSourceFileSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesChannelsSourceFileSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesChannelsSourceFileSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesChannelsSourceFileSecLabel
        {
