...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesGraphicsVncListenersAddress")]
    public class DomainDevicesGraphicsVncListenersAddress : libvirt.Domain.IDomainDevicesGraphicsVncListenersAddress
    {
