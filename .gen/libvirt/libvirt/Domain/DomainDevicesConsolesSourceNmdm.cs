...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesConsolesSourceNmdm")]
    public class DomainDevicesConsolesSourceNmdm : libvirt.Domain.IDomainDevicesConsolesSourceNmdm
    {
