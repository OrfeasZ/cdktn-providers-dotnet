...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesGraphicsSpiceListenersSocket), fullyQualifiedName: "libvirt.domain.DomainDevicesGraphicsSpiceListenersSocket")]
    public interface IDomainDevicesGraphicsSpiceListenersSocket
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesGraphicsSpiceListenersSocket), fullyQualifiedName: "libvirt.domain.DomainDevicesGraphicsSpiceListenersSocket")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesGraphicsSpiceListenersSocket
        {
