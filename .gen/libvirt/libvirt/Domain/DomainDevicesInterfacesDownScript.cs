...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesInterfacesDownScript")]
    public class DomainDevicesInterfacesDownScript : libvirt.Domain.IDomainDevicesInterfacesDownScript
    {
