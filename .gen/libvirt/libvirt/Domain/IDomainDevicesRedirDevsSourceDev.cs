...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesRedirDevsSourceDev), fullyQualifiedName: "libvirt.domain.DomainDevicesRedirDevsSourceDev")]
    public interface IDomainDevicesRedirDevsSourceDev
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesRedirDevsSourceDev), fullyQualifiedName: "libvirt.domain.DomainDevicesRedirDevsSourceDev")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesRedirDevsSourceDev
        {
