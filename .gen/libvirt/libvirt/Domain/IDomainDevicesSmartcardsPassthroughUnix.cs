...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesSmartcardsPassthroughUnix), fullyQualifiedName: "libvirt.domain.DomainDevicesSmartcardsPassthroughUnix")]
    public interface IDomainDevicesSmartcardsPassthroughUnix
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "reconnect", typeJson: "{\"fqn\":\"libvirt.domain.DomainDevicesSmartcardsPassthroughUnixReconnect\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        libvirt.Domain.IDomainDevicesSmartcardsPassthroughUnixReconnect? Reconnect
        {
            get
            {
                return null;
        ...
        /// </remarks>
        [JsiiProperty(name: "secLabel", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"libvirt.domain.DomainDevicesSmartcardsPassthroughUnixSecLabel\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        object? SecLabel
        {
            get
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesSmartcardsPassthroughUnix), fullyQualifiedName: "libvirt.domain.DomainDevicesSmartcardsPassthroughUnix")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesSmartcardsPassthroughUnix
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "reconnect", typeJson: "{\"fqn\":\"libvirt.domain.DomainDevicesSmartcardsPassthroughUnixReconnect\"}", isOptional: true)]
            public libvirt.Domain.IDomainDevicesSmartcardsPassthroughUnixReconnect? Reconnect
            {
                get => GetInstanceProperty<libvirt.Domain.IDomainDevicesSmartcardsPassthroughUnixReconnect?>();
            }
