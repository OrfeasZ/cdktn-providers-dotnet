...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksSourceReservationsSourceTcp), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceReservationsSourceTcp")]
    public interface IDomainDevicesDisksSourceReservationsSourceTcp
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "reconnect", typeJson: "{\"fqn\":\"libvirt.domain.DomainDevicesDisksSourceReservationsSourceTcpReconnect\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        libvirt.Domain.IDomainDevicesDisksSourceReservationsSourceTcpReconnect? Reconnect
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksSourceReservationsSourceTcp), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceReservationsSourceTcp")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksSourceReservationsSourceTcp
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "reconnect", typeJson: "{\"fqn\":\"libvirt.domain.DomainDevicesDisksSourceReservationsSourceTcpReconnect\"}", isOptional: true)]
            public libvirt.Domain.IDomainDevicesDisksSourceReservationsSourceTcpReconnect? Reconnect
            {
                get => GetInstanceProperty<libvirt.Domain.IDomainDevicesDisksSourceReservationsSourceTcpReconnect?>();
            }
