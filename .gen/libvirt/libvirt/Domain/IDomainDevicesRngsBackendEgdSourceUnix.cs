...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesRngsBackendEgdSourceUnix), fullyQualifiedName: "libvirt.domain.DomainDevicesRngsBackendEgdSourceUnix")]
    public interface IDomainDevicesRngsBackendEgdSourceUnix
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        libvirt.Domain.IDomainDevicesRngsBackendEgdSourceUnixReconnect? Reconnect
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesRngsBackendEgdSourceUnix), fullyQualifiedName: "libvirt.domain.DomainDevicesRngsBackendEgdSourceUnix")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesRngsBackendEgdSourceUnix
        {
            ...
            {
                get => GetInstanceProperty<libvirt.Domain.IDomainDevicesRngsBackendEgdSourceUnixReconnect?>();
            }
