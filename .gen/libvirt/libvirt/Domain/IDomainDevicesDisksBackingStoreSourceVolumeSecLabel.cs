...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksBackingStoreSourceVolumeSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackingStoreSourceVolumeSecLabel")]
    public interface IDomainDevicesDisksBackingStoreSourceVolumeSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksBackingStoreSourceVolumeSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackingStoreSourceVolumeSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksBackingStoreSourceVolumeSecLabel
        {
