...
{
    [JsiiInterface(nativeType: typeof(IDomainOsNvRamSourceEncryptionSecrets), fullyQualifiedName: "libvirt.domain.DomainOsNvRamSourceEncryptionSecrets")]
    public interface IDomainOsNvRamSourceEncryptionSecrets
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainOsNvRamSourceEncryptionSecrets), fullyQualifiedName: "libvirt.domain.DomainOsNvRamSourceEncryptionSecrets")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainOsNvRamSourceEncryptionSecrets
        {
