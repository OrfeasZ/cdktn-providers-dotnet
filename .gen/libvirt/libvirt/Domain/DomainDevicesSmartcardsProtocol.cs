...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesSmartcardsProtocol")]
    public class DomainDevicesSmartcardsProtocol : libvirt.Domain.IDomainDevicesSmartcardsProtocol
    {
