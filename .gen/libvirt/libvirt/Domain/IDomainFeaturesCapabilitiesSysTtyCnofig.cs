...
{
    [JsiiInterface(nativeType: typeof(IDomainFeaturesCapabilitiesSysTtyCnofig), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesSysTtyCnofig")]
    public interface IDomainFeaturesCapabilitiesSysTtyCnofig
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainFeaturesCapabilitiesSysTtyCnofig), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesSysTtyCnofig")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainFeaturesCapabilitiesSysTtyCnofig
        {
