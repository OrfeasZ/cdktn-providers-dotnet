...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesChannelsSourcePty), fullyQualifiedName: "libvirt.domain.DomainDevicesChannelsSourcePty")]
    public interface IDomainDevicesChannelsSourcePty
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesChannelsSourcePty), fullyQualifiedName: "libvirt.domain.DomainDevicesChannelsSourcePty")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesChannelsSourcePty
        {
