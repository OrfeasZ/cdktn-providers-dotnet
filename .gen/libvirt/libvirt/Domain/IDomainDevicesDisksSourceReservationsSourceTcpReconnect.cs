...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksSourceReservationsSourceTcpReconnect), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceReservationsSourceTcpReconnect")]
    public interface IDomainDevicesDisksSourceReservationsSourceTcpReconnect
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksSourceReservationsSourceTcpReconnect), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceReservationsSourceTcpReconnect")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksSourceReservationsSourceTcpReconnect
        {
