...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesHostdevsCapsMiscSource")]
    public class DomainDevicesHostdevsCapsMiscSource : libvirt.Domain.IDomainDevicesHostdevsCapsMiscSource
    {
