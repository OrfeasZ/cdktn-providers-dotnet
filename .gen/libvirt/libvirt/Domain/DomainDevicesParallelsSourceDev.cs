...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesParallelsSourceDev")]
    public class DomainDevicesParallelsSourceDev : libvirt.Domain.IDomainDevicesParallelsSourceDev
    {
