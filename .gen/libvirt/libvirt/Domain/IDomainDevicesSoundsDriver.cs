...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesSoundsDriver), fullyQualifiedName: "libvirt.domain.DomainDevicesSoundsDriver")]
    public interface IDomainDevicesSoundsDriver
    {
        /// <summary>Enables or disables Address Translation Service (ATS) support for a virtio-based sound device; value is typically "on" or "off".</summary>
        /// <remarks>
        ...
        /// <summary>Enables or disables use of the emulated IOMMU for the virtio-based sound device; value is typically "on" or "off".</summary>
        /// <remarks>
        /// See: <a href="https://libvirt.org/formatdomain.html#virtio-related-options">https://libvirt.org/formatdomain.html#virtio-related-options</a>
        ///
        ...
        /// <summary>Enables or disables packed virtqueue format for a virtio-based sound device to potentially improve performance;</summary>
        /// <remarks>
        ...
        /// <summary>Enables or disables allocation of a separate page per virtqueue for the virtio-based sound device;</summary>
        /// <remarks>
        /// value is typically "on" or "off".
        ///
        /// See: <a href="https://libvirt.org/formatdomain.html#virtio-related-options">https://libvirt.org/formatdomain.html#virtio-related-options</a>
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesSoundsDriver), fullyQualifiedName: "libvirt.domain.DomainDevicesSoundsDriver")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesSoundsDriver
        {
