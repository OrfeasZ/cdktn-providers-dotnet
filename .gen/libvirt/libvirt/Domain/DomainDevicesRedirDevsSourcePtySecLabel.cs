...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesRedirDevsSourcePtySecLabel")]
    public class DomainDevicesRedirDevsSourcePtySecLabel : libvirt.Domain.IDomainDevicesRedirDevsSourcePtySecLabel
    {
