...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesAudiosSpiceInputSettings")]
    public class DomainDevicesAudiosSpiceInputSettings : libvirt.Domain.IDomainDevicesAudiosSpiceInputSettings
    {
