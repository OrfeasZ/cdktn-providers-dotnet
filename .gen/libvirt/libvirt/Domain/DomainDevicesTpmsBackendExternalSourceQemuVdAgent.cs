...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesTpmsBackendExternalSourceQemuVdAgent")]
    public class DomainDevicesTpmsBackendExternalSourceQemuVdAgent : libvirt.Domain.IDomainDevicesTpmsBackendExternalSourceQemuVdAgent
    {
