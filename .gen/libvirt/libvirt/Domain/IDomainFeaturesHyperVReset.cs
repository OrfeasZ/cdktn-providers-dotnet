...
{
    [JsiiInterface(nativeType: typeof(IDomainFeaturesHyperVReset), fullyQualifiedName: "libvirt.domain.DomainFeaturesHyperVReset")]
    public interface IDomainFeaturesHyperVReset
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainFeaturesHyperVReset), fullyQualifiedName: "libvirt.domain.DomainFeaturesHyperVReset")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainFeaturesHyperVReset
        {
