...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksSourceVhostUserTcp), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceVhostUserTcp")]
    public interface IDomainDevicesDisksSourceVhostUserTcp
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        libvirt.Domain.IDomainDevicesDisksSourceVhostUserTcpReconnect? Reconnect
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksSourceVhostUserTcp), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceVhostUserTcp")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksSourceVhostUserTcp
        {
            ...
            {
                get => GetInstanceProperty<libvirt.Domain.IDomainDevicesDisksSourceVhostUserTcpReconnect?>();
            }
