...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesParallelsSourceUnixSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesParallelsSourceUnixSecLabel")]
    public interface IDomainDevicesParallelsSourceUnixSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesParallelsSourceUnixSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesParallelsSourceUnixSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesParallelsSourceUnixSecLabel
        {
