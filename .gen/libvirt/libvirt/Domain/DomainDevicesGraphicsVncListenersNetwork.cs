...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesGraphicsVncListenersNetwork")]
    public class DomainDevicesGraphicsVncListenersNetwork : libvirt.Domain.IDomainDevicesGraphicsVncListenersNetwork
    {
