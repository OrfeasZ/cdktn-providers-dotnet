...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesIommuDriverGranule), fullyQualifiedName: "libvirt.domain.DomainDevicesIommuDriverGranule")]
    public interface IDomainDevicesIommuDriverGranule
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesIommuDriverGranule), fullyQualifiedName: "libvirt.domain.DomainDevicesIommuDriverGranule")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesIommuDriverGranule
        {
