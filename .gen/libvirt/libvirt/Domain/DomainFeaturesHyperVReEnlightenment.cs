...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainFeaturesHyperVReEnlightenment")]
    public class DomainFeaturesHyperVReEnlightenment : libvirt.Domain.IDomainFeaturesHyperVReEnlightenment
    {
