...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainOsNvRamSourceBlockSecLabel")]
    public class DomainOsNvRamSourceBlockSecLabel : libvirt.Domain.IDomainOsNvRamSourceBlockSecLabel
    {
