...
{
    [JsiiInterface(nativeType: typeof(IDomainFeaturesCapabilitiesSysPTrace), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesSysPTrace")]
    public interface IDomainFeaturesCapabilitiesSysPTrace
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainFeaturesCapabilitiesSysPTrace), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesSysPTrace")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainFeaturesCapabilitiesSysPTrace
        {
