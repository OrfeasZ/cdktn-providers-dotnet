...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesAudiosPipeWireInput), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosPipeWireInput")]
    public interface IDomainDevicesAudiosPipeWireInput
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        libvirt.Domain.IDomainDevicesAudiosPipeWireInputSettings? Settings
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesAudiosPipeWireInput), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosPipeWireInput")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesAudiosPipeWireInput
        {
            ...
            {
                get => GetInstanceProperty<libvirt.Domain.IDomainDevicesAudiosPipeWireInputSettings?>();
            }
