...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesSmartcardsPassthroughPipeSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesSmartcardsPassthroughPipeSecLabel")]
    public interface IDomainDevicesSmartcardsPassthroughPipeSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesSmartcardsPassthroughPipeSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesSmartcardsPassthroughPipeSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesSmartcardsPassthroughPipeSecLabel
        {
