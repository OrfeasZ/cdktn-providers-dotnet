...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesHostdevsSubsysUsbSourceProduct")]
    public class DomainDevicesHostdevsSubsysUsbSourceProduct : libvirt.Domain.IDomainDevicesHostdevsSubsysUsbSourceProduct
    {
