...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesAudiosSdlOutput")]
    public class DomainDevicesAudiosSdlOutput : libvirt.Domain.IDomainDevicesAudiosSdlOutput
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "settings", typeJson: "{\"fqn\":\"libvirt.domain.DomainDevicesAudiosSdlOutputSettings\"}", isOptional: true)]
        public libvirt.Domain.IDomainDevicesAudiosSdlOutputSettings? Settings
        {
            get;
            set;
        }
