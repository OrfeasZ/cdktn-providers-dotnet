...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesFilesystemsAlias), fullyQualifiedName: "libvirt.domain.DomainDevicesFilesystemsAlias")]
    public interface IDomainDevicesFilesystemsAlias
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesFilesystemsAlias), fullyQualifiedName: "libvirt.domain.DomainDevicesFilesystemsAlias")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesFilesystemsAlias
        {
