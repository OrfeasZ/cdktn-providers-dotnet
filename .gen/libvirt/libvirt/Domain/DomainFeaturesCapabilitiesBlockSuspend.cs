...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainFeaturesCapabilitiesBlockSuspend")]
    public class DomainFeaturesCapabilitiesBlockSuspend : libvirt.Domain.IDomainFeaturesCapabilitiesBlockSuspend
    {
