...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesAudiosSpiceOutputSettings), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosSpiceOutputSettings")]
    public interface IDomainDevicesAudiosSpiceOutputSettings
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesAudiosSpiceOutputSettings), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosSpiceOutputSettings")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesAudiosSpiceOutputSettings
        {
