...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesInterfacesSourceVhostUserChardevPipe), fullyQualifiedName: "libvirt.domain.DomainDevicesInterfacesSourceVhostUserChardevPipe")]
    public interface IDomainDevicesInterfacesSourceVhostUserChardevPipe
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesInterfacesSourceVhostUserChardevPipe), fullyQualifiedName: "libvirt.domain.DomainDevicesInterfacesSourceVhostUserChardevPipe")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesInterfacesSourceVhostUserChardevPipe
        {
