...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesSerialsAlias), fullyQualifiedName: "libvirt.domain.DomainDevicesSerialsAlias")]
    public interface IDomainDevicesSerialsAlias
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesSerialsAlias), fullyQualifiedName: "libvirt.domain.DomainDevicesSerialsAlias")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesSerialsAlias
        {
