...
{
    [JsiiInterface(nativeType: typeof(IDomainOsNvRamSourceVhostUserTcpReconnect), fullyQualifiedName: "libvirt.domain.DomainOsNvRamSourceVhostUserTcpReconnect")]
    public interface IDomainOsNvRamSourceVhostUserTcpReconnect
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainOsNvRamSourceVhostUserTcpReconnect), fullyQualifiedName: "libvirt.domain.DomainOsNvRamSourceVhostUserTcpReconnect")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainOsNvRamSourceVhostUserTcpReconnect
        {
