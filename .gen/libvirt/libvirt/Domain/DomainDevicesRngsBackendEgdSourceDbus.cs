...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesRngsBackendEgdSourceDbus")]
    public class DomainDevicesRngsBackendEgdSourceDbus : libvirt.Domain.IDomainDevicesRngsBackendEgdSourceDbus
    {
