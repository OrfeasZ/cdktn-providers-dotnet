...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainFeaturesCapabilitiesLease")]
    public class DomainFeaturesCapabilitiesLease : libvirt.Domain.IDomainFeaturesCapabilitiesLease
    {
