...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksMirrorSourceFile")]
    public class DomainDevicesDisksMirrorSourceFile : libvirt.Domain.IDomainDevicesDisksMirrorSourceFile
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "secLabel", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"libvirt.domain.DomainDevicesDisksMirrorSourceFileSecLabel\"},\"kind\":\"array\"}}]}}", isOptional: true)]
