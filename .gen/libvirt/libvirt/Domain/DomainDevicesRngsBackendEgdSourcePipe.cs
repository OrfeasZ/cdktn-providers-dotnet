...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesRngsBackendEgdSourcePipe")]
    public class DomainDevicesRngsBackendEgdSourcePipe : libvirt.Domain.IDomainDevicesRngsBackendEgdSourcePipe
    {
