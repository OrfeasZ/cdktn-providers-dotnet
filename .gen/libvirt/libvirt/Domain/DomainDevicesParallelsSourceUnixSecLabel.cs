...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesParallelsSourceUnixSecLabel")]
    public class DomainDevicesParallelsSourceUnixSecLabel : libvirt.Domain.IDomainDevicesParallelsSourceUnixSecLabel
    {
