...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainFeaturesCapabilitiesChown")]
    public class DomainFeaturesCapabilitiesChown : libvirt.Domain.IDomainFeaturesCapabilitiesChown
    {
