...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksBackingStoreSourceDir")]
    public class DomainDevicesDisksBackingStoreSourceDir : libvirt.Domain.IDomainDevicesDisksBackingStoreSourceDir
    {
