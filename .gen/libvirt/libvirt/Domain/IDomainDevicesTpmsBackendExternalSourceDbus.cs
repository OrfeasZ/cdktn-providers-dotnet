...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesTpmsBackendExternalSourceDbus), fullyQualifiedName: "libvirt.domain.DomainDevicesTpmsBackendExternalSourceDbus")]
    public interface IDomainDevicesTpmsBackendExternalSourceDbus
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesTpmsBackendExternalSourceDbus), fullyQualifiedName: "libvirt.domain.DomainDevicesTpmsBackendExternalSourceDbus")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesTpmsBackendExternalSourceDbus
        {
