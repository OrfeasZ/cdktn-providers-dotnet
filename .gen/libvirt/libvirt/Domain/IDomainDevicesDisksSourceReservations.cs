...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksSourceReservations), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceReservations")]
    public interface IDomainDevicesDisksSourceReservations
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "source", typeJson: "{\"fqn\":\"libvirt.domain.DomainDevicesDisksSourceReservationsSource\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        libvirt.Domain.IDomainDevicesDisksSourceReservationsSource? Source
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksSourceReservations), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceReservations")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksSourceReservations
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "source", typeJson: "{\"fqn\":\"libvirt.domain.DomainDevicesDisksSourceReservationsSource\"}", isOptional: true)]
            public libvirt.Domain.IDomainDevicesDisksSourceReservationsSource? Source
            {
                get => GetInstanceProperty<libvirt.Domain.IDomainDevicesDisksSourceReservationsSource?>();
            }
        }
    }
}
