...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesChannelsSourcePipe")]
    public class DomainDevicesChannelsSourcePipe : libvirt.Domain.IDomainDevicesChannelsSourcePipe
    {
