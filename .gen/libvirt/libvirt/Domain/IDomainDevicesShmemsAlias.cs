...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesShmemsAlias), fullyQualifiedName: "libvirt.domain.DomainDevicesShmemsAlias")]
    public interface IDomainDevicesShmemsAlias
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesShmemsAlias), fullyQualifiedName: "libvirt.domain.DomainDevicesShmemsAlias")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesShmemsAlias
        {
