...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesSerialsSourceNmdm), fullyQualifiedName: "libvirt.domain.DomainDevicesSerialsSourceNmdm")]
    public interface IDomainDevicesSerialsSourceNmdm
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesSerialsSourceNmdm), fullyQualifiedName: "libvirt.domain.DomainDevicesSerialsSourceNmdm")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesSerialsSourceNmdm
        {
