...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesHubsAlias), fullyQualifiedName: "libvirt.domain.DomainDevicesHubsAlias")]
    public interface IDomainDevicesHubsAlias
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesHubsAlias), fullyQualifiedName: "libvirt.domain.DomainDevicesHubsAlias")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesHubsAlias
        {
