...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesRedirDevsSourceDbus), fullyQualifiedName: "libvirt.domain.DomainDevicesRedirDevsSourceDbus")]
    public interface IDomainDevicesRedirDevsSourceDbus
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesRedirDevsSourceDbus), fullyQualifiedName: "libvirt.domain.DomainDevicesRedirDevsSourceDbus")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesRedirDevsSourceDbus
        {
