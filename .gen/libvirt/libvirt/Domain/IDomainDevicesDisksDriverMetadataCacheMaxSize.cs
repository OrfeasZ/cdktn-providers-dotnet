...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksDriverMetadataCacheMaxSize), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksDriverMetadataCacheMaxSize")]
    public interface IDomainDevicesDisksDriverMetadataCacheMaxSize
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksDriverMetadataCacheMaxSize), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksDriverMetadataCacheMaxSize")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksDriverMetadataCacheMaxSize
        {
