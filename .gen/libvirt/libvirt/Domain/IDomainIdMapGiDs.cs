...
{
    [JsiiInterface(nativeType: typeof(IDomainIdMapGiDs), fullyQualifiedName: "libvirt.domain.DomainIdMapGiDs")]
    public interface IDomainIdMapGiDs
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainIdMapGiDs), fullyQualifiedName: "libvirt.domain.DomainIdMapGiDs")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainIdMapGiDs
        {
