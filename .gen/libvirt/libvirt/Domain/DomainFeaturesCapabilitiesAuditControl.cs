...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainFeaturesCapabilitiesAuditControl")]
    public class DomainFeaturesCapabilitiesAuditControl : libvirt.Domain.IDomainFeaturesCapabilitiesAuditControl
    {
