...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksAuthSecret), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksAuthSecret")]
    public interface IDomainDevicesDisksAuthSecret
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksAuthSecret), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksAuthSecret")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksAuthSecret
        {
