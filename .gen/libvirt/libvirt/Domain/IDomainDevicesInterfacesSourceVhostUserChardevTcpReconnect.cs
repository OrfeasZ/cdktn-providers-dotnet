...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesInterfacesSourceVhostUserChardevTcpReconnect), fullyQualifiedName: "libvirt.domain.DomainDevicesInterfacesSourceVhostUserChardevTcpReconnect")]
    public interface IDomainDevicesInterfacesSourceVhostUserChardevTcpReconnect
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesInterfacesSourceVhostUserChardevTcpReconnect), fullyQualifiedName: "libvirt.domain.DomainDevicesInterfacesSourceVhostUserChardevTcpReconnect")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesInterfacesSourceVhostUserChardevTcpReconnect
        {
