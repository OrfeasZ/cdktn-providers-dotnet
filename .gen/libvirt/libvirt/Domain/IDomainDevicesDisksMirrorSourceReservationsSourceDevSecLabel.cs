...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksMirrorSourceReservationsSourceDevSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceReservationsSourceDevSecLabel")]
    public interface IDomainDevicesDisksMirrorSourceReservationsSourceDevSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksMirrorSourceReservationsSourceDevSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceReservationsSourceDevSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksMirrorSourceReservationsSourceDevSecLabel
        {
