...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksSourceNetworkConfig")]
    public class DomainDevicesDisksSourceNetworkConfig : libvirt.Domain.IDomainDevicesDisksSourceNetworkConfig
    {
