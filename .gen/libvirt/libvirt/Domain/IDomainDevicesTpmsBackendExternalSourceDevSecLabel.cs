...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesTpmsBackendExternalSourceDevSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesTpmsBackendExternalSourceDevSecLabel")]
    public interface IDomainDevicesTpmsBackendExternalSourceDevSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesTpmsBackendExternalSourceDevSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesTpmsBackendExternalSourceDevSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesTpmsBackendExternalSourceDevSecLabel
        {
