...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesSmartcardsPassthroughDbus), fullyQualifiedName: "libvirt.domain.DomainDevicesSmartcardsPassthroughDbus")]
    public interface IDomainDevicesSmartcardsPassthroughDbus
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesSmartcardsPassthroughDbus), fullyQualifiedName: "libvirt.domain.DomainDevicesSmartcardsPassthroughDbus")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesSmartcardsPassthroughDbus
        {
