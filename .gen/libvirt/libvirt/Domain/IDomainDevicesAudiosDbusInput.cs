...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesAudiosDbusInput), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosDbusInput")]
    public interface IDomainDevicesAudiosDbusInput
    {
        ...
        [JsiiProperty(name: "settings", typeJson: "{\"fqn\":\"libvirt.domain.DomainDevicesAudiosDbusInputSettings\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        libvirt.Domain.IDomainDevicesAudiosDbusInputSettings? Settings
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesAudiosDbusInput), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosDbusInput")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesAudiosDbusInput
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "settings", typeJson: "{\"fqn\":\"libvirt.domain.DomainDevicesAudiosDbusInputSettings\"}", isOptional: true)]
            public libvirt.Domain.IDomainDevicesAudiosDbusInputSettings? Settings
            {
                get => GetInstanceProperty<libvirt.Domain.IDomainDevicesAudiosDbusInputSettings?>();
            }
