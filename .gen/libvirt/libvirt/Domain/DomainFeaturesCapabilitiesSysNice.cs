...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainFeaturesCapabilitiesSysNice")]
    public class DomainFeaturesCapabilitiesSysNice : libvirt.Domain.IDomainFeaturesCapabilitiesSysNice
    {
