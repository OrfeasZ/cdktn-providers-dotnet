...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainFeaturesCapabilitiesIpcLock")]
    public class DomainFeaturesCapabilitiesIpcLock : libvirt.Domain.IDomainFeaturesCapabilitiesIpcLock
    {
