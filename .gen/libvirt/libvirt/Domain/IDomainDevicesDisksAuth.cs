...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksAuth), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksAuth")]
    public interface IDomainDevicesDisksAuth
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "secret", typeJson: "{\"fqn\":\"libvirt.domain.DomainDevicesDisksAuthSecret\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        libvirt.Domain.IDomainDevicesDisksAuthSecret? Secret
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksAuth), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksAuth")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksAuth
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "secret", typeJson: "{\"fqn\":\"libvirt.domain.DomainDevicesDisksAuthSecret\"}", isOptional: true)]
            public libvirt.Domain.IDomainDevicesDisksAuthSecret? Secret
            {
                get => GetInstanceProperty<libvirt.Domain.IDomainDevicesDisksAuthSecret?>();
            }
