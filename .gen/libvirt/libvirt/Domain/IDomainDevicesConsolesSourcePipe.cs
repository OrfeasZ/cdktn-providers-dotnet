...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesConsolesSourcePipe), fullyQualifiedName: "libvirt.domain.DomainDevicesConsolesSourcePipe")]
    public interface IDomainDevicesConsolesSourcePipe
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesConsolesSourcePipe), fullyQualifiedName: "libvirt.domain.DomainDevicesConsolesSourcePipe")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesConsolesSourcePipe
        {
