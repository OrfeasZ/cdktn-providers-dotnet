...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesRngsBackendEgdSourcePtySecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesRngsBackendEgdSourcePtySecLabel")]
    public interface IDomainDevicesRngsBackendEgdSourcePtySecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesRngsBackendEgdSourcePtySecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesRngsBackendEgdSourcePtySecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesRngsBackendEgdSourcePtySecLabel
        {
