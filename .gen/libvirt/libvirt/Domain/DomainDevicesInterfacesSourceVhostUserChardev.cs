...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesInterfacesSourceVhostUserChardev")]
    public class DomainDevicesInterfacesSourceVhostUserChardev : libvirt.Domain.IDomainDevicesInterfacesSourceVhostUserChardev
    {
