...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksSourceBlockSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceBlockSecLabel")]
    public interface IDomainDevicesDisksSourceBlockSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksSourceBlockSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceBlockSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksSourceBlockSecLabel
        {
