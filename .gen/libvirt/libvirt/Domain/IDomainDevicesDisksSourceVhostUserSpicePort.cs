...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksSourceVhostUserSpicePort), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceVhostUserSpicePort")]
    public interface IDomainDevicesDisksSourceVhostUserSpicePort
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksSourceVhostUserSpicePort), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceVhostUserSpicePort")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksSourceVhostUserSpicePort
        {
