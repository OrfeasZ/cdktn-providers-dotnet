...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesTpmsBackendExternalSourceFile), fullyQualifiedName: "libvirt.domain.DomainDevicesTpmsBackendExternalSourceFile")]
    public interface IDomainDevicesTpmsBackendExternalSourceFile
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesTpmsBackendExternalSourceFile), fullyQualifiedName: "libvirt.domain.DomainDevicesTpmsBackendExternalSourceFile")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesTpmsBackendExternalSourceFile
        {
