...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesVideosAcpi), fullyQualifiedName: "libvirt.domain.DomainDevicesVideosAcpi")]
    public interface IDomainDevicesVideosAcpi
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesVideosAcpi), fullyQualifiedName: "libvirt.domain.DomainDevicesVideosAcpi")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesVideosAcpi
        {
