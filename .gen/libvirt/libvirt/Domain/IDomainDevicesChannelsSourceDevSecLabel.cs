...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesChannelsSourceDevSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesChannelsSourceDevSecLabel")]
    public interface IDomainDevicesChannelsSourceDevSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesChannelsSourceDevSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesChannelsSourceDevSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesChannelsSourceDevSecLabel
        {
