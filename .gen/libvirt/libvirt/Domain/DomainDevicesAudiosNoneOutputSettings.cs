...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesAudiosNoneOutputSettings")]
    public class DomainDevicesAudiosNoneOutputSettings : libvirt.Domain.IDomainDevicesAudiosNoneOutputSettings
    {
