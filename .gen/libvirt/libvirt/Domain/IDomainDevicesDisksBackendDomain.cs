...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksBackendDomain), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackendDomain")]
    public interface IDomainDevicesDisksBackendDomain
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksBackendDomain), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackendDomain")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksBackendDomain
        {
