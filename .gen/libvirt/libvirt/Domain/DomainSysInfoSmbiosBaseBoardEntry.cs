...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainSysInfoSmbiosBaseBoardEntry")]
    public class DomainSysInfoSmbiosBaseBoardEntry : libvirt.Domain.IDomainSysInfoSmbiosBaseBoardEntry
    {
