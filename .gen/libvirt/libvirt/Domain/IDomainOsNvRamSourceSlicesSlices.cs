...
{
    [JsiiInterface(nativeType: typeof(IDomainOsNvRamSourceSlicesSlices), fullyQualifiedName: "libvirt.domain.DomainOsNvRamSourceSlicesSlices")]
    public interface IDomainOsNvRamSourceSlicesSlices
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainOsNvRamSourceSlicesSlices), fullyQualifiedName: "libvirt.domain.DomainOsNvRamSourceSlicesSlices")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainOsNvRamSourceSlicesSlices
        {
