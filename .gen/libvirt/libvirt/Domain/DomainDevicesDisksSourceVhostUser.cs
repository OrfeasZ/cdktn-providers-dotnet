...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksSourceVhostUser")]
    public class DomainDevicesDisksSourceVhostUser : libvirt.Domain.IDomainDevicesDisksSourceVhostUser
    {
