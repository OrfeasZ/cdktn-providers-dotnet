...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesTpmsBackendExternalSourceNmdm), fullyQualifiedName: "libvirt.domain.DomainDevicesTpmsBackendExternalSourceNmdm")]
    public interface IDomainDevicesTpmsBackendExternalSourceNmdm
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesTpmsBackendExternalSourceNmdm), fullyQualifiedName: "libvirt.domain.DomainDevicesTpmsBackendExternalSourceNmdm")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesTpmsBackendExternalSourceNmdm
        {
