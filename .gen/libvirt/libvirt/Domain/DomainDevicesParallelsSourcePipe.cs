...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesParallelsSourcePipe")]
    public class DomainDevicesParallelsSourcePipe : libvirt.Domain.IDomainDevicesParallelsSourcePipe
    {
