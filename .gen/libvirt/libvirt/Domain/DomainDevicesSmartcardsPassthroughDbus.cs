...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesSmartcardsPassthroughDbus")]
    public class DomainDevicesSmartcardsPassthroughDbus : libvirt.Domain.IDomainDevicesSmartcardsPassthroughDbus
    {
