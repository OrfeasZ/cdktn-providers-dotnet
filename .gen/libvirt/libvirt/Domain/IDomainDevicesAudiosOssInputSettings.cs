...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesAudiosOssInputSettings), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosOssInputSettings")]
    public interface IDomainDevicesAudiosOssInputSettings
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesAudiosOssInputSettings), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosOssInputSettings")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesAudiosOssInputSettings
        {
