...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksSourceNetworkHosts), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceNetworkHosts")]
    public interface IDomainDevicesDisksSourceNetworkHosts
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksSourceNetworkHosts), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceNetworkHosts")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksSourceNetworkHosts
        {
