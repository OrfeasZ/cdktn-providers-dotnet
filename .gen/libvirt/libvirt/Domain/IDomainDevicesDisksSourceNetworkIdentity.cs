...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksSourceNetworkIdentity), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceNetworkIdentity")]
    public interface IDomainDevicesDisksSourceNetworkIdentity
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksSourceNetworkIdentity), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceNetworkIdentity")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksSourceNetworkIdentity
        {
