...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksMirrorSourceVolume), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceVolume")]
    public interface IDomainDevicesDisksMirrorSourceVolume
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "secLabel", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"libvirt.domain.DomainDevicesDisksMirrorSourceVolumeSecLabel\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        object? SecLabel
        {
            get
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksMirrorSourceVolume), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceVolume")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksMirrorSourceVolume
        {
