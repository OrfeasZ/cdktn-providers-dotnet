...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesAudiosPipeWireOutput")]
    public class DomainDevicesAudiosPipeWireOutput : libvirt.Domain.IDomainDevicesAudiosPipeWireOutput
    {
