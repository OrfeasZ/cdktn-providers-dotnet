...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksSourceBlockSecLabel")]
    public class DomainDevicesDisksSourceBlockSecLabel : libvirt.Domain.IDomainDevicesDisksSourceBlockSecLabel
    {
