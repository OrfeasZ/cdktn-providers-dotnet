...
{
    [JsiiInterface(nativeType: typeof(IDomainFeaturesCapabilitiesSysLog), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesSysLog")]
    public interface IDomainFeaturesCapabilitiesSysLog
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainFeaturesCapabilitiesSysLog), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesSysLog")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainFeaturesCapabilitiesSysLog
        {
