...
{
    [JsiiInterface(nativeType: typeof(IDomainOsNvRamSourceVhostUserFile), fullyQualifiedName: "libvirt.domain.DomainOsNvRamSourceVhostUserFile")]
    public interface IDomainOsNvRamSourceVhostUserFile
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainOsNvRamSourceVhostUserFile), fullyQualifiedName: "libvirt.domain.DomainOsNvRamSourceVhostUserFile")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainOsNvRamSourceVhostUserFile
        {
