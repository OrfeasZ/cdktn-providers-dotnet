...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksMirrorBackingStoreFormat")]
    public class DomainDevicesDisksMirrorBackingStoreFormat : libvirt.Domain.IDomainDevicesDisksMirrorBackingStoreFormat
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "metadataCache", typeJson: "{\"fqn\":\"libvirt.domain.DomainDevicesDisksMirrorBackingStoreFormatMetadataCache\"}", isOptional: true)]
        public libvirt.Domain.IDomainDevicesDisksMirrorBackingStoreFormatMetadataCache? MetadataCache
        {
            get;
            set;
        }
