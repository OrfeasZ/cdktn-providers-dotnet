...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesRngsBackendEgdSourceDevSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesRngsBackendEgdSourceDevSecLabel")]
    public interface IDomainDevicesRngsBackendEgdSourceDevSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesRngsBackendEgdSourceDevSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesRngsBackendEgdSourceDevSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesRngsBackendEgdSourceDevSecLabel
        {
