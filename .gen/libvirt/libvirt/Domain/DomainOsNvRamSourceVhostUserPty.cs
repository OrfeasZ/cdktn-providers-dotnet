...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainOsNvRamSourceVhostUserPty")]
    public class DomainOsNvRamSourceVhostUserPty : libvirt.Domain.IDomainOsNvRamSourceVhostUserPty
    {
