...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesAudiosFileOutputSettings), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosFileOutputSettings")]
    public interface IDomainDevicesAudiosFileOutputSettings
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesAudiosFileOutputSettings), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosFileOutputSettings")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesAudiosFileOutputSettings
        {
