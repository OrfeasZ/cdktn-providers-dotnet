...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesSmartcardsPassthroughUnixSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesSmartcardsPassthroughUnixSecLabel")]
    public interface IDomainDevicesSmartcardsPassthroughUnixSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesSmartcardsPassthroughUnixSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesSmartcardsPassthroughUnixSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesSmartcardsPassthroughUnixSecLabel
        {
