...
{
    [JsiiInterface(nativeType: typeof(IDomainFeaturesCapabilitiesLease), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesLease")]
    public interface IDomainFeaturesCapabilitiesLease
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainFeaturesCapabilitiesLease), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesLease")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainFeaturesCapabilitiesLease
        {
