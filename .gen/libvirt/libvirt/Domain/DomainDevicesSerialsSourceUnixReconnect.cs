...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesSerialsSourceUnixReconnect")]
    public class DomainDevicesSerialsSourceUnixReconnect : libvirt.Domain.IDomainDevicesSerialsSourceUnixReconnect
    {
