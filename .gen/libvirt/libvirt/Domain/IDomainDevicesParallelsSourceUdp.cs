...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesParallelsSourceUdp), fullyQualifiedName: "libvirt.domain.DomainDevicesParallelsSourceUdp")]
    public interface IDomainDevicesParallelsSourceUdp
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesParallelsSourceUdp), fullyQualifiedName: "libvirt.domain.DomainDevicesParallelsSourceUdp")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesParallelsSourceUdp
        {
