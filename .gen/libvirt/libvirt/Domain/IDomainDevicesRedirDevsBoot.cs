...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesRedirDevsBoot), fullyQualifiedName: "libvirt.domain.DomainDevicesRedirDevsBoot")]
    public interface IDomainDevicesRedirDevsBoot
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesRedirDevsBoot), fullyQualifiedName: "libvirt.domain.DomainDevicesRedirDevsBoot")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesRedirDevsBoot
        {
