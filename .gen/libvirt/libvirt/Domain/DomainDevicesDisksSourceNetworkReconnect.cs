...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksSourceNetworkReconnect")]
    public class DomainDevicesDisksSourceNetworkReconnect : libvirt.Domain.IDomainDevicesDisksSourceNetworkReconnect
    {
