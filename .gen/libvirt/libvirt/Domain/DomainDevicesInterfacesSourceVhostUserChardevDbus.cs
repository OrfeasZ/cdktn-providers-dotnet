...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesInterfacesSourceVhostUserChardevDbus")]
    public class DomainDevicesInterfacesSourceVhostUserChardevDbus : libvirt.Domain.IDomainDevicesInterfacesSourceVhostUserChardevDbus
    {
