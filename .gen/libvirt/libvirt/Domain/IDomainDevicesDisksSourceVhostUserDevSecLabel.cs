...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksSourceVhostUserDevSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceVhostUserDevSecLabel")]
    public interface IDomainDevicesDisksSourceVhostUserDevSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksSourceVhostUserDevSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceVhostUserDevSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksSourceVhostUserDevSecLabel
        {
