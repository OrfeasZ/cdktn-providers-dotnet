...
{
    [JsiiInterface(nativeType: typeof(IDomainFeaturesCapabilitiesSysChRoot), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesSysChRoot")]
    public interface IDomainFeaturesCapabilitiesSysChRoot
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainFeaturesCapabilitiesSysChRoot), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesSysChRoot")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainFeaturesCapabilitiesSysChRoot
        {
