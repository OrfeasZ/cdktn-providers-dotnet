...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksSourceReservations")]
    public class DomainDevicesDisksSourceReservations : libvirt.Domain.IDomainDevicesDisksSourceReservations
    {
