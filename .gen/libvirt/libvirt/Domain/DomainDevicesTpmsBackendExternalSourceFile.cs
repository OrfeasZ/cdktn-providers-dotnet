...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesTpmsBackendExternalSourceFile")]
    public class DomainDevicesTpmsBackendExternalSourceFile : libvirt.Domain.IDomainDevicesTpmsBackendExternalSourceFile
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "secLabel", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"libvirt.domain.DomainDevicesTpmsBackendExternalSourceFileSecLabel\"},\"kind\":\"array\"}}]}}", isOptional: true)]
