...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesAudiosPipeWireInput")]
    public class DomainDevicesAudiosPipeWireInput : libvirt.Domain.IDomainDevicesAudiosPipeWireInput
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "settings", typeJson: "{\"fqn\":\"libvirt.domain.DomainDevicesAudiosPipeWireInputSettings\"}", isOptional: true)]
        public libvirt.Domain.IDomainDevicesAudiosPipeWireInputSettings? Settings
        {
            get;
            set;
        }
