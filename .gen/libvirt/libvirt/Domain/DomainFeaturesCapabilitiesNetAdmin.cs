...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainFeaturesCapabilitiesNetAdmin")]
    public class DomainFeaturesCapabilitiesNetAdmin : libvirt.Domain.IDomainFeaturesCapabilitiesNetAdmin
    {
