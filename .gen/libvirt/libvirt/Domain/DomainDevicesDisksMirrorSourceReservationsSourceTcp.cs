...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksMirrorSourceReservationsSourceTcp")]
    public class DomainDevicesDisksMirrorSourceReservationsSourceTcp : libvirt.Domain.IDomainDevicesDisksMirrorSourceReservationsSourceTcp
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "reconnect", typeJson: "{\"fqn\":\"libvirt.domain.DomainDevicesDisksMirrorSourceReservationsSourceTcpReconnect\"}", isOptional: true)]
        public libvirt.Domain.IDomainDevicesDisksMirrorSourceReservationsSourceTcpReconnect? Reconnect
        {
            get;
            set;
        }
