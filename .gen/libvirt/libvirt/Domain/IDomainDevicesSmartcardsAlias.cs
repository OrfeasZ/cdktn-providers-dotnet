...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesSmartcardsAlias), fullyQualifiedName: "libvirt.domain.DomainDevicesSmartcardsAlias")]
    public interface IDomainDevicesSmartcardsAlias
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesSmartcardsAlias), fullyQualifiedName: "libvirt.domain.DomainDevicesSmartcardsAlias")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesSmartcardsAlias
        {
