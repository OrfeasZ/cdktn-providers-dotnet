...
{
    [JsiiInterface(nativeType: typeof(IDomainFeaturesHyperVVpIndex), fullyQualifiedName: "libvirt.domain.DomainFeaturesHyperVVpIndex")]
    public interface IDomainFeaturesHyperVVpIndex
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainFeaturesHyperVVpIndex), fullyQualifiedName: "libvirt.domain.DomainFeaturesHyperVVpIndex")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainFeaturesHyperVVpIndex
        {
