...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesSerialsAcpi), fullyQualifiedName: "libvirt.domain.DomainDevicesSerialsAcpi")]
    public interface IDomainDevicesSerialsAcpi
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesSerialsAcpi), fullyQualifiedName: "libvirt.domain.DomainDevicesSerialsAcpi")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesSerialsAcpi
        {
