...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksBackingStoreSourceVhostUserNmdm), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackingStoreSourceVhostUserNmdm")]
    public interface IDomainDevicesDisksBackingStoreSourceVhostUserNmdm
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksBackingStoreSourceVhostUserNmdm), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackingStoreSourceVhostUserNmdm")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksBackingStoreSourceVhostUserNmdm
        {
