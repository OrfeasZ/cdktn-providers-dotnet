...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainOsNvRamSourceNetworkReconnect")]
    public class DomainOsNvRamSourceNetworkReconnect : libvirt.Domain.IDomainOsNvRamSourceNetworkReconnect
    {
