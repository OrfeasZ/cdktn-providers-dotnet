...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesAudiosCoreAudioOutputSettings")]
    public class DomainDevicesAudiosCoreAudioOutputSettings : libvirt.Domain.IDomainDevicesAudiosCoreAudioOutputSettings
    {
