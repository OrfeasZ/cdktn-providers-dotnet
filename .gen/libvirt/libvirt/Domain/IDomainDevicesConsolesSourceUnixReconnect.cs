...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesConsolesSourceUnixReconnect), fullyQualifiedName: "libvirt.domain.DomainDevicesConsolesSourceUnixReconnect")]
    public interface IDomainDevicesConsolesSourceUnixReconnect
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesConsolesSourceUnixReconnect), fullyQualifiedName: "libvirt.domain.DomainDevicesConsolesSourceUnixReconnect")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesConsolesSourceUnixReconnect
        {
