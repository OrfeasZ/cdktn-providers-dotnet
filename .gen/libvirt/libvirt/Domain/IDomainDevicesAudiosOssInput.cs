...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesAudiosOssInput), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosOssInput")]
    public interface IDomainDevicesAudiosOssInput
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        libvirt.Domain.IDomainDevicesAudiosOssInputSettings? Settings
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesAudiosOssInput), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosOssInput")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesAudiosOssInput
        {
            ...
            {
                get => GetInstanceProperty<libvirt.Domain.IDomainDevicesAudiosOssInputSettings?>();
            }
