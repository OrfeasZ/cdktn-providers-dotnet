...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainFeaturesHyperVTlbFlushDirect")]
    public class DomainFeaturesHyperVTlbFlushDirect : libvirt.Domain.IDomainFeaturesHyperVTlbFlushDirect
    {
