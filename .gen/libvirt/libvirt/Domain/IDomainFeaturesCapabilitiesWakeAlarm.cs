...
{
    [JsiiInterface(nativeType: typeof(IDomainFeaturesCapabilitiesWakeAlarm), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesWakeAlarm")]
    public interface IDomainFeaturesCapabilitiesWakeAlarm
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainFeaturesCapabilitiesWakeAlarm), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesWakeAlarm")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainFeaturesCapabilitiesWakeAlarm
        {
