...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesChannelsSourcePipeSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesChannelsSourcePipeSecLabel")]
    public interface IDomainDevicesChannelsSourcePipeSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesChannelsSourcePipeSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesChannelsSourcePipeSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesChannelsSourcePipeSecLabel
        {
