...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesSmartcardsPassthroughDevSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesSmartcardsPassthroughDevSecLabel")]
    public interface IDomainDevicesSmartcardsPassthroughDevSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesSmartcardsPassthroughDevSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesSmartcardsPassthroughDevSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesSmartcardsPassthroughDevSecLabel
        {
