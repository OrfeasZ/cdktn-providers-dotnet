...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesConsolesSourceTcp), fullyQualifiedName: "libvirt.domain.DomainDevicesConsolesSourceTcp")]
    public interface IDomainDevicesConsolesSourceTcp
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        libvirt.Domain.IDomainDevicesConsolesSourceTcpReconnect? Reconnect
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesConsolesSourceTcp), fullyQualifiedName: "libvirt.domain.DomainDevicesConsolesSourceTcp")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesConsolesSourceTcp
        {
            ...
            {
                get => GetInstanceProperty<libvirt.Domain.IDomainDevicesConsolesSourceTcpReconnect?>();
            }
