...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesInterfacesAlias), fullyQualifiedName: "libvirt.domain.DomainDevicesInterfacesAlias")]
    public interface IDomainDevicesInterfacesAlias
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesInterfacesAlias), fullyQualifiedName: "libvirt.domain.DomainDevicesInterfacesAlias")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesInterfacesAlias
        {
