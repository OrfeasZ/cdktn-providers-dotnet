...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesConsolesSourceTcpReconnect), fullyQualifiedName: "libvirt.domain.DomainDevicesConsolesSourceTcpReconnect")]
    public interface IDomainDevicesConsolesSourceTcpReconnect
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesConsolesSourceTcpReconnect), fullyQualifiedName: "libvirt.domain.DomainDevicesConsolesSourceTcpReconnect")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesConsolesSourceTcpReconnect
        {
