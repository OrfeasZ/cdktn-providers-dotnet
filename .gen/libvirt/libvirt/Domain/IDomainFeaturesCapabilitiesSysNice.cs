...
{
    [JsiiInterface(nativeType: typeof(IDomainFeaturesCapabilitiesSysNice), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesSysNice")]
    public interface IDomainFeaturesCapabilitiesSysNice
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainFeaturesCapabilitiesSysNice), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesSysNice")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainFeaturesCapabilitiesSysNice
        {
