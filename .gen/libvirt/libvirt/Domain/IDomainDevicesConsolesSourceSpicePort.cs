...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesConsolesSourceSpicePort), fullyQualifiedName: "libvirt.domain.DomainDevicesConsolesSourceSpicePort")]
    public interface IDomainDevicesConsolesSourceSpicePort
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesConsolesSourceSpicePort), fullyQualifiedName: "libvirt.domain.DomainDevicesConsolesSourceSpicePort")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesConsolesSourceSpicePort
        {
