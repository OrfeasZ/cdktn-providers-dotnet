...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesConsolesSourceFile")]
    public class DomainDevicesConsolesSourceFile : libvirt.Domain.IDomainDevicesConsolesSourceFile
    {
