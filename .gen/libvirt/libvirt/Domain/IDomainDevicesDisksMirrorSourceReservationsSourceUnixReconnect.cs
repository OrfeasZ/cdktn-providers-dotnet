...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksMirrorSourceReservationsSourceUnixReconnect), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceReservationsSourceUnixReconnect")]
    public interface IDomainDevicesDisksMirrorSourceReservationsSourceUnixReconnect
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksMirrorSourceReservationsSourceUnixReconnect), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceReservationsSourceUnixReconnect")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksMirrorSourceReservationsSourceUnixReconnect
        {
