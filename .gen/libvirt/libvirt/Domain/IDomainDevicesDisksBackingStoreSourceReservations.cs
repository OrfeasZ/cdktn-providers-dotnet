...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksBackingStoreSourceReservations), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackingStoreSourceReservations")]
    public interface IDomainDevicesDisksBackingStoreSourceReservations
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        libvirt.Domain.IDomainDevicesDisksBackingStoreSourceReservationsSource? Source
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksBackingStoreSourceReservations), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackingStoreSourceReservations")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksBackingStoreSourceReservations
        {
            ...
            {
                get => GetInstanceProperty<libvirt.Domain.IDomainDevicesDisksBackingStoreSourceReservationsSource?>();
            }
        }
    }
}
