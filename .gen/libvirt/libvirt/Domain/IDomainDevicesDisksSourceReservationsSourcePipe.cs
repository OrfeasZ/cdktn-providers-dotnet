...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksSourceReservationsSourcePipe), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceReservationsSourcePipe")]
    public interface IDomainDevicesDisksSourceReservationsSourcePipe
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksSourceReservationsSourcePipe), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceReservationsSourcePipe")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksSourceReservationsSourcePipe
        {
