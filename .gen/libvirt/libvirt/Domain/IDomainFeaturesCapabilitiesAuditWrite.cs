...
{
    [JsiiInterface(nativeType: typeof(IDomainFeaturesCapabilitiesAuditWrite), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesAuditWrite")]
    public interface IDomainFeaturesCapabilitiesAuditWrite
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainFeaturesCapabilitiesAuditWrite), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesAuditWrite")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainFeaturesCapabilitiesAuditWrite
        {
