...
{
    [JsiiInterface(nativeType: typeof(IDomainOsNvRamSourceReservations), fullyQualifiedName: "libvirt.domain.DomainOsNvRamSourceReservations")]
    public interface IDomainOsNvRamSourceReservations
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        libvirt.Domain.IDomainOsNvRamSourceReservationsSource? Source
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainOsNvRamSourceReservations), fullyQualifiedName: "libvirt.domain.DomainOsNvRamSourceReservations")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainOsNvRamSourceReservations
        {
            ...
            {
                get => GetInstanceProperty<libvirt.Domain.IDomainOsNvRamSourceReservationsSource?>();
            }
        }
    }
}
