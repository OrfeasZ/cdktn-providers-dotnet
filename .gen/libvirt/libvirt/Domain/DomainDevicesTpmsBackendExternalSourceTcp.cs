...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesTpmsBackendExternalSourceTcp")]
    public class DomainDevicesTpmsBackendExternalSourceTcp : libvirt.Domain.IDomainDevicesTpmsBackendExternalSourceTcp
    {
