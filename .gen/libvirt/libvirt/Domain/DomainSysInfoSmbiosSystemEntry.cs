...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainSysInfoSmbiosSystemEntry")]
    public class DomainSysInfoSmbiosSystemEntry : libvirt.Domain.IDomainSysInfoSmbiosSystemEntry
    {
