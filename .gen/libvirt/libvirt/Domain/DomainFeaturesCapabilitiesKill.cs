...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainFeaturesCapabilitiesKill")]
    public class DomainFeaturesCapabilitiesKill : libvirt.Domain.IDomainFeaturesCapabilitiesKill
    {
