...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesSmartcardsPassthroughPtySecLabel")]
    public class DomainDevicesSmartcardsPassthroughPtySecLabel : libvirt.Domain.IDomainDevicesSmartcardsPassthroughPtySecLabel
    {
