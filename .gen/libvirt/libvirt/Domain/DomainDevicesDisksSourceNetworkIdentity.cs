...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksSourceNetworkIdentity")]
    public class DomainDevicesDisksSourceNetworkIdentity : libvirt.Domain.IDomainDevicesDisksSourceNetworkIdentity
    {
