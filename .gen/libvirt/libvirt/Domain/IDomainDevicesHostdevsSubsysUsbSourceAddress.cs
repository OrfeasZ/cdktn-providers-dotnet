...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesHostdevsSubsysUsbSourceAddress), fullyQualifiedName: "libvirt.domain.DomainDevicesHostdevsSubsysUsbSourceAddress")]
    public interface IDomainDevicesHostdevsSubsysUsbSourceAddress
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesHostdevsSubsysUsbSourceAddress), fullyQualifiedName: "libvirt.domain.DomainDevicesHostdevsSubsysUsbSourceAddress")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesHostdevsSubsysUsbSourceAddress
        {
