...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksSourceReservationsSourceUnixSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceReservationsSourceUnixSecLabel")]
    public interface IDomainDevicesDisksSourceReservationsSourceUnixSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksSourceReservationsSourceUnixSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceReservationsSourceUnixSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksSourceReservationsSourceUnixSecLabel
        {
