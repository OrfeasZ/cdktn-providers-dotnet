...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksSourceVhostUserPtySecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceVhostUserPtySecLabel")]
    public interface IDomainDevicesDisksSourceVhostUserPtySecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksSourceVhostUserPtySecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceVhostUserPtySecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksSourceVhostUserPtySecLabel
        {
