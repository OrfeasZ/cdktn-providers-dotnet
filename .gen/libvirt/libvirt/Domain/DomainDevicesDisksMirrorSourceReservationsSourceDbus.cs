...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksMirrorSourceReservationsSourceDbus")]
    public class DomainDevicesDisksMirrorSourceReservationsSourceDbus : libvirt.Domain.IDomainDevicesDisksMirrorSourceReservationsSourceDbus
    {
