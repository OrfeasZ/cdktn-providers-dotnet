...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesIommUsAlias), fullyQualifiedName: "libvirt.domain.DomainDevicesIommUsAlias")]
    public interface IDomainDevicesIommUsAlias
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesIommUsAlias), fullyQualifiedName: "libvirt.domain.DomainDevicesIommUsAlias")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesIommUsAlias
        {
