...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesSerialsSourceSpicePort")]
    public class DomainDevicesSerialsSourceSpicePort : libvirt.Domain.IDomainDevicesSerialsSourceSpicePort
    {
