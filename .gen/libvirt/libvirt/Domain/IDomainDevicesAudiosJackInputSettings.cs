...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesAudiosJackInputSettings), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosJackInputSettings")]
    public interface IDomainDevicesAudiosJackInputSettings
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesAudiosJackInputSettings), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosJackInputSettings")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesAudiosJackInputSettings
        {
