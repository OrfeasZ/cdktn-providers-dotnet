...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesSmartcardsPassthroughFileSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesSmartcardsPassthroughFileSecLabel")]
    public interface IDomainDevicesSmartcardsPassthroughFileSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesSmartcardsPassthroughFileSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesSmartcardsPassthroughFileSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesSmartcardsPassthroughFileSecLabel
        {
