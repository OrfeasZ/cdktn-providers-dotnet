...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksBackingStoreSourceFileSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackingStoreSourceFileSecLabel")]
    public interface IDomainDevicesDisksBackingStoreSourceFileSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksBackingStoreSourceFileSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackingStoreSourceFileSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksBackingStoreSourceFileSecLabel
        {
