...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesRngsBackendEgdSourceFile")]
    public class DomainDevicesRngsBackendEgdSourceFile : libvirt.Domain.IDomainDevicesRngsBackendEgdSourceFile
    {
