...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesParallelsSourceSpicePort")]
    public class DomainDevicesParallelsSourceSpicePort : libvirt.Domain.IDomainDevicesParallelsSourceSpicePort
    {
