...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesTpmsBackendExternalSourceDevSecLabel")]
    public class DomainDevicesTpmsBackendExternalSourceDevSecLabel : libvirt.Domain.IDomainDevicesTpmsBackendExternalSourceDevSecLabel
    {
