...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesConsolesSourceUnixSecLabel")]
    public class DomainDevicesConsolesSourceUnixSecLabel : libvirt.Domain.IDomainDevicesConsolesSourceUnixSecLabel
    {
