...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksBackingStoreSourceVhostUserUnixReconnect), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackingStoreSourceVhostUserUnixReconnect")]
    public interface IDomainDevicesDisksBackingStoreSourceVhostUserUnixReconnect
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksBackingStoreSourceVhostUserUnixReconnect), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackingStoreSourceVhostUserUnixReconnect")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksBackingStoreSourceVhostUserUnixReconnect
        {
