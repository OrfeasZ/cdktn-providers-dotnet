...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksEncryptionSecrets), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksEncryptionSecrets")]
    public interface IDomainDevicesDisksEncryptionSecrets
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksEncryptionSecrets), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksEncryptionSecrets")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksEncryptionSecrets
        {
