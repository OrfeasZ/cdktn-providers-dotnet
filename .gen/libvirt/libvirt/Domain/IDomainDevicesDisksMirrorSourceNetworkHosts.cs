...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksMirrorSourceNetworkHosts), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceNetworkHosts")]
    public interface IDomainDevicesDisksMirrorSourceNetworkHosts
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksMirrorSourceNetworkHosts), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceNetworkHosts")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksMirrorSourceNetworkHosts
        {
