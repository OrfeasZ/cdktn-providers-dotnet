...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesTpmsBackendExternalSourceDbus")]
    public class DomainDevicesTpmsBackendExternalSourceDbus : libvirt.Domain.IDomainDevicesTpmsBackendExternalSourceDbus
    {
