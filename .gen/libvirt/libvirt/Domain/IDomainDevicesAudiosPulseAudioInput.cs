...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesAudiosPulseAudioInput), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosPulseAudioInput")]
    public interface IDomainDevicesAudiosPulseAudioInput
    {
        ...
        [JsiiProperty(name: "settings", typeJson: "{\"fqn\":\"libvirt.domain.DomainDevicesAudiosPulseAudioInputSettings\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        libvirt.Domain.IDomainDevicesAudiosPulseAudioInputSettings? Settings
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesAudiosPulseAudioInput), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosPulseAudioInput")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesAudiosPulseAudioInput
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "settings", typeJson: "{\"fqn\":\"libvirt.domain.DomainDevicesAudiosPulseAudioInputSettings\"}", isOptional: true)]
            public libvirt.Domain.IDomainDevicesAudiosPulseAudioInputSettings? Settings
            {
                get => GetInstanceProperty<libvirt.Domain.IDomainDevicesAudiosPulseAudioInputSettings?>();
            }
