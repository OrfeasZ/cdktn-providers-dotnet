...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesAudiosPulseAudioInputSettings), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosPulseAudioInputSettings")]
    public interface IDomainDevicesAudiosPulseAudioInputSettings
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesAudiosPulseAudioInputSettings), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosPulseAudioInputSettings")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesAudiosPulseAudioInputSettings
        {
