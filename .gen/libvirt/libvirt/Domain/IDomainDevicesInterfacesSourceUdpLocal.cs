...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesInterfacesSourceUdpLocal), fullyQualifiedName: "libvirt.domain.DomainDevicesInterfacesSourceUdpLocal")]
    public interface IDomainDevicesInterfacesSourceUdpLocal
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesInterfacesSourceUdpLocal), fullyQualifiedName: "libvirt.domain.DomainDevicesInterfacesSourceUdpLocal")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesInterfacesSourceUdpLocal
        {
