...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksMirrorSourceCtl")]
    public class DomainDevicesDisksMirrorSourceCtl : libvirt.Domain.IDomainDevicesDisksMirrorSourceCtl
    {
