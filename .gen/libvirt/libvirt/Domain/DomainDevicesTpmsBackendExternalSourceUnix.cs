...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesTpmsBackendExternalSourceUnix")]
    public class DomainDevicesTpmsBackendExternalSourceUnix : libvirt.Domain.IDomainDevicesTpmsBackendExternalSourceUnix
    {
