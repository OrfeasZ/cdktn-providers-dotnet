...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesIommUsAcpi), fullyQualifiedName: "libvirt.domain.DomainDevicesIommUsAcpi")]
    public interface IDomainDevicesIommUsAcpi
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesIommUsAcpi), fullyQualifiedName: "libvirt.domain.DomainDevicesIommUsAcpi")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesIommUsAcpi
        {
