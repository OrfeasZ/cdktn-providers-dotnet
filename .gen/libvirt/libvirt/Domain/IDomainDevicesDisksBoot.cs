...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksBoot), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBoot")]
    public interface IDomainDevicesDisksBoot
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksBoot), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBoot")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksBoot
        {
