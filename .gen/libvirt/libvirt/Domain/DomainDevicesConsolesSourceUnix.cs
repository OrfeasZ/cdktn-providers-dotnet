...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesConsolesSourceUnix")]
    public class DomainDevicesConsolesSourceUnix : libvirt.Domain.IDomainDevicesConsolesSourceUnix
    {
