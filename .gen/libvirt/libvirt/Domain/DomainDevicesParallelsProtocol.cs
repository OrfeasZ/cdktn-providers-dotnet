...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesParallelsProtocol")]
    public class DomainDevicesParallelsProtocol : libvirt.Domain.IDomainDevicesParallelsProtocol
    {
