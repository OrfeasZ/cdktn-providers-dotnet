...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesAudiosSpiceOutputSettings")]
    public class DomainDevicesAudiosSpiceOutputSettings : libvirt.Domain.IDomainDevicesAudiosSpiceOutputSettings
    {
