...
{
    [JsiiInterface(nativeType: typeof(IDomainFeaturesVmPort), fullyQualifiedName: "libvirt.domain.DomainFeaturesVmPort")]
    public interface IDomainFeaturesVmPort
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainFeaturesVmPort), fullyQualifiedName: "libvirt.domain.DomainFeaturesVmPort")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainFeaturesVmPort
        {
