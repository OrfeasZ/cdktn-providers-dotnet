...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesConsolesSourceUnixReconnect")]
    public class DomainDevicesConsolesSourceUnixReconnect : libvirt.Domain.IDomainDevicesConsolesSourceUnixReconnect
    {
