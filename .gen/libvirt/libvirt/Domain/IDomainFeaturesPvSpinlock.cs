...
{
    [JsiiInterface(nativeType: typeof(IDomainFeaturesPvSpinlock), fullyQualifiedName: "libvirt.domain.DomainFeaturesPvSpinlock")]
    public interface IDomainFeaturesPvSpinlock
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainFeaturesPvSpinlock), fullyQualifiedName: "libvirt.domain.DomainFeaturesPvSpinlock")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainFeaturesPvSpinlock
        {
