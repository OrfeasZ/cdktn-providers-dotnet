...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesRedirDevsSourcePtySecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesRedirDevsSourcePtySecLabel")]
    public interface IDomainDevicesRedirDevsSourcePtySecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesRedirDevsSourcePtySecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesRedirDevsSourcePtySecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesRedirDevsSourcePtySecLabel
        {
