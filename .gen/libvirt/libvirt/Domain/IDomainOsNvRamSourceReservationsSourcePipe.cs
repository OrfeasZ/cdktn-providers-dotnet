...
{
    [JsiiInterface(nativeType: typeof(IDomainOsNvRamSourceReservationsSourcePipe), fullyQualifiedName: "libvirt.domain.DomainOsNvRamSourceReservationsSourcePipe")]
    public interface IDomainOsNvRamSourceReservationsSourcePipe
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainOsNvRamSourceReservationsSourcePipe), fullyQualifiedName: "libvirt.domain.DomainOsNvRamSourceReservationsSourcePipe")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainOsNvRamSourceReservationsSourcePipe
        {
