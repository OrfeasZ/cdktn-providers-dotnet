...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesAudiosDbusOutputSettings), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosDbusOutputSettings")]
    public interface IDomainDevicesAudiosDbusOutputSettings
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesAudiosDbusOutputSettings), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosDbusOutputSettings")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesAudiosDbusOutputSettings
        {
