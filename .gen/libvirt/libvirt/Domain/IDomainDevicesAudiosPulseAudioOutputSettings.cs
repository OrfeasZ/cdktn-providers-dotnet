...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesAudiosPulseAudioOutputSettings), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosPulseAudioOutputSettings")]
    public interface IDomainDevicesAudiosPulseAudioOutputSettings
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesAudiosPulseAudioOutputSettings), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosPulseAudioOutputSettings")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesAudiosPulseAudioOutputSettings
        {
