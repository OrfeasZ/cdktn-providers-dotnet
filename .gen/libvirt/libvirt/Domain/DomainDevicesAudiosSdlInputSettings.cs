...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesAudiosSdlInputSettings")]
    public class DomainDevicesAudiosSdlInputSettings : libvirt.Domain.IDomainDevicesAudiosSdlInputSettings
    {
