...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesSerialsSourceTcp")]
    public class DomainDevicesSerialsSourceTcp : libvirt.Domain.IDomainDevicesSerialsSourceTcp
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "reconnect", typeJson: "{\"fqn\":\"libvirt.domain.DomainDevicesSerialsSourceTcpReconnect\"}", isOptional: true)]
        public libvirt.Domain.IDomainDevicesSerialsSourceTcpReconnect? Reconnect
        {
            get;
            set;
        }
