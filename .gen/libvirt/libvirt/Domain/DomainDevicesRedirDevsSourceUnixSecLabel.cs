...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesRedirDevsSourceUnixSecLabel")]
    public class DomainDevicesRedirDevsSourceUnixSecLabel : libvirt.Domain.IDomainDevicesRedirDevsSourceUnixSecLabel
    {
