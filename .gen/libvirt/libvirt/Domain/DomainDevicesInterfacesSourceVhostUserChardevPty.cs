...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesInterfacesSourceVhostUserChardevPty")]
    public class DomainDevicesInterfacesSourceVhostUserChardevPty : libvirt.Domain.IDomainDevicesInterfacesSourceVhostUserChardevPty
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "secLabel", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"libvirt.domain.DomainDevicesInterfacesSourceVhostUserChardevPtySecLabel\"},\"kind\":\"array\"}}]}}", isOptional: true)]
