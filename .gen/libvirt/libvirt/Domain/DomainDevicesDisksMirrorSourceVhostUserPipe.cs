...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksMirrorSourceVhostUserPipe")]
    public class DomainDevicesDisksMirrorSourceVhostUserPipe : libvirt.Domain.IDomainDevicesDisksMirrorSourceVhostUserPipe
    {
