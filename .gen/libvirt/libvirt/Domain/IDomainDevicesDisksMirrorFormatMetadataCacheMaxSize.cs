...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksMirrorFormatMetadataCacheMaxSize), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorFormatMetadataCacheMaxSize")]
    public interface IDomainDevicesDisksMirrorFormatMetadataCacheMaxSize
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksMirrorFormatMetadataCacheMaxSize), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorFormatMetadataCacheMaxSize")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksMirrorFormatMetadataCacheMaxSize
        {
