...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksBackingStoreSourceNetworkAuthSecret), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackingStoreSourceNetworkAuthSecret")]
    public interface IDomainDevicesDisksBackingStoreSourceNetworkAuthSecret
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksBackingStoreSourceNetworkAuthSecret), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackingStoreSourceNetworkAuthSecret")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksBackingStoreSourceNetworkAuthSecret
        {
