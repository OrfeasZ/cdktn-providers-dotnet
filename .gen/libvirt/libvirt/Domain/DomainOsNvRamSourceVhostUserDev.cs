...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainOsNvRamSourceVhostUserDev")]
    public class DomainOsNvRamSourceVhostUserDev : libvirt.Domain.IDomainOsNvRamSourceVhostUserDev
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "secLabel", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"libvirt.domain.DomainOsNvRamSourceVhostUserDevSecLabel\"},\"kind\":\"array\"}}]}}", isOptional: true)]
