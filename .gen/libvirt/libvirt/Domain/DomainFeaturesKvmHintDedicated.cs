...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainFeaturesKvmHintDedicated")]
    public class DomainFeaturesKvmHintDedicated : libvirt.Domain.IDomainFeaturesKvmHintDedicated
    {
