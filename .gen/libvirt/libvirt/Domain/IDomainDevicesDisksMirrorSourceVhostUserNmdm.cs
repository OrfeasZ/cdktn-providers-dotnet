...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksMirrorSourceVhostUserNmdm), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceVhostUserNmdm")]
    public interface IDomainDevicesDisksMirrorSourceVhostUserNmdm
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksMirrorSourceVhostUserNmdm), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceVhostUserNmdm")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksMirrorSourceVhostUserNmdm
        {
