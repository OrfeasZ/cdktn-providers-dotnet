...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesRngsBackendEgdSourcePty")]
    public class DomainDevicesRngsBackendEgdSourcePty : libvirt.Domain.IDomainDevicesRngsBackendEgdSourcePty
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "secLabel", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"libvirt.domain.DomainDevicesRngsBackendEgdSourcePtySecLabel\"},\"kind\":\"array\"}}]}}", isOptional: true)]
