...
{
    [JsiiInterface(nativeType: typeof(IDomainFeaturesCapabilitiesNetRaw), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesNetRaw")]
    public interface IDomainFeaturesCapabilitiesNetRaw
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainFeaturesCapabilitiesNetRaw), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesNetRaw")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainFeaturesCapabilitiesNetRaw
        {
