...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesRngsBackendEgdSourcePipeSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesRngsBackendEgdSourcePipeSecLabel")]
    public interface IDomainDevicesRngsBackendEgdSourcePipeSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesRngsBackendEgdSourcePipeSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesRngsBackendEgdSourcePipeSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesRngsBackendEgdSourcePipeSecLabel
        {
