...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksSourceVhostUserSpicePort")]
    public class DomainDevicesDisksSourceVhostUserSpicePort : libvirt.Domain.IDomainDevicesDisksSourceVhostUserSpicePort
    {
