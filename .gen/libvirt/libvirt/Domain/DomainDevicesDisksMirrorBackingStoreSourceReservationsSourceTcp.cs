...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksMirrorBackingStoreSourceReservationsSourceTcp")]
    public class DomainDevicesDisksMirrorBackingStoreSourceReservationsSourceTcp : libvirt.Domain.IDomainDevicesDisksMirrorBackingStoreSourceReservationsSourceTcp
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "reconnect", typeJson: "{\"fqn\":\"libvirt.domain.DomainDevicesDisksMirrorBackingStoreSourceReservationsSourceTcpReconnect\"}", isOptional: true)]
        public libvirt.Domain.IDomainDevicesDisksMirrorBackingStoreSourceReservationsSourceTcpReconnect? Reconnect
        {
            get;
            set;
        }
