...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesInterfacesSourceServerLocal")]
    public class DomainDevicesInterfacesSourceServerLocal : libvirt.Domain.IDomainDevicesInterfacesSourceServerLocal
    {
