...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksMirrorSourceVhostUserDbus), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceVhostUserDbus")]
    public interface IDomainDevicesDisksMirrorSourceVhostUserDbus
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksMirrorSourceVhostUserDbus), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceVhostUserDbus")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksMirrorSourceVhostUserDbus
        {
