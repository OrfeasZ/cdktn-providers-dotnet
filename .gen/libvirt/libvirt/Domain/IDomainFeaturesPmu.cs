...
{
    [JsiiInterface(nativeType: typeof(IDomainFeaturesPmu), fullyQualifiedName: "libvirt.domain.DomainFeaturesPmu")]
    public interface IDomainFeaturesPmu
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainFeaturesPmu), fullyQualifiedName: "libvirt.domain.DomainFeaturesPmu")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainFeaturesPmu
        {
