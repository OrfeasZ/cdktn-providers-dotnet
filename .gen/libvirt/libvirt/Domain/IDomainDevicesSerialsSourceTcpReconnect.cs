...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesSerialsSourceTcpReconnect), fullyQualifiedName: "libvirt.domain.DomainDevicesSerialsSourceTcpReconnect")]
    public interface IDomainDevicesSerialsSourceTcpReconnect
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesSerialsSourceTcpReconnect), fullyQualifiedName: "libvirt.domain.DomainDevicesSerialsSourceTcpReconnect")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesSerialsSourceTcpReconnect
        {
