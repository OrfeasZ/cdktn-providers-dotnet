...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksMirrorBackingStoreSourceEncryptionSecrets), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorBackingStoreSourceEncryptionSecrets")]
    public interface IDomainDevicesDisksMirrorBackingStoreSourceEncryptionSecrets
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksMirrorBackingStoreSourceEncryptionSecrets), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorBackingStoreSourceEncryptionSecrets")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksMirrorBackingStoreSourceEncryptionSecrets
        {
