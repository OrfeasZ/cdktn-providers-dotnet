...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksBackingStoreSourceBlockSecLabel")]
    public class DomainDevicesDisksBackingStoreSourceBlockSecLabel : libvirt.Domain.IDomainDevicesDisksBackingStoreSourceBlockSecLabel
    {
