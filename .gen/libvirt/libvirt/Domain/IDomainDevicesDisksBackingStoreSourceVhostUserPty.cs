...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksBackingStoreSourceVhostUserPty), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackingStoreSourceVhostUserPty")]
    public interface IDomainDevicesDisksBackingStoreSourceVhostUserPty
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksBackingStoreSourceVhostUserPty), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackingStoreSourceVhostUserPty")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksBackingStoreSourceVhostUserPty
        {
