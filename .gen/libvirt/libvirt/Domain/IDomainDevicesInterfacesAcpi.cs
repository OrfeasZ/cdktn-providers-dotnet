...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesInterfacesAcpi), fullyQualifiedName: "libvirt.domain.DomainDevicesInterfacesAcpi")]
    public interface IDomainDevicesInterfacesAcpi
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesInterfacesAcpi), fullyQualifiedName: "libvirt.domain.DomainDevicesInterfacesAcpi")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesInterfacesAcpi
        {
