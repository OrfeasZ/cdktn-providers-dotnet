...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesRngsBackendEgdSourceUdp")]
    public class DomainDevicesRngsBackendEgdSourceUdp : libvirt.Domain.IDomainDevicesRngsBackendEgdSourceUdp
    {
