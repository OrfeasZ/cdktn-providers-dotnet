...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesGraphicsVncListenersNetwork), fullyQualifiedName: "libvirt.domain.DomainDevicesGraphicsVncListenersNetwork")]
    public interface IDomainDevicesGraphicsVncListenersNetwork
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesGraphicsVncListenersNetwork), fullyQualifiedName: "libvirt.domain.DomainDevicesGraphicsVncListenersNetwork")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesGraphicsVncListenersNetwork
        {
