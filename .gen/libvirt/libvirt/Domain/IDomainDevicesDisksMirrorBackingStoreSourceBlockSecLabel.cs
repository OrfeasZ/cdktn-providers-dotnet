...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksMirrorBackingStoreSourceBlockSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorBackingStoreSourceBlockSecLabel")]
    public interface IDomainDevicesDisksMirrorBackingStoreSourceBlockSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksMirrorBackingStoreSourceBlockSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorBackingStoreSourceBlockSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksMirrorBackingStoreSourceBlockSecLabel
        {
