...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesChannelsSourceTcpReconnect")]
    public class DomainDevicesChannelsSourceTcpReconnect : libvirt.Domain.IDomainDevicesChannelsSourceTcpReconnect
    {
