...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesAudiosCoreAudioOutput")]
    public class DomainDevicesAudiosCoreAudioOutput : libvirt.Domain.IDomainDevicesAudiosCoreAudioOutput
    {
