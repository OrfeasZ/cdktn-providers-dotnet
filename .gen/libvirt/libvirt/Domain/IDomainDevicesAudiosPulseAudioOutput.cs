...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesAudiosPulseAudioOutput), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosPulseAudioOutput")]
    public interface IDomainDevicesAudiosPulseAudioOutput
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        libvirt.Domain.IDomainDevicesAudiosPulseAudioOutputSettings? Settings
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesAudiosPulseAudioOutput), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosPulseAudioOutput")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesAudiosPulseAudioOutput
        {
            ...
            {
                get => GetInstanceProperty<libvirt.Domain.IDomainDevicesAudiosPulseAudioOutputSettings?>();
            }
