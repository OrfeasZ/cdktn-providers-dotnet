...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesTpmsBackendExternalSourcePipe), fullyQualifiedName: "libvirt.domain.DomainDevicesTpmsBackendExternalSourcePipe")]
    public interface IDomainDevicesTpmsBackendExternalSourcePipe
    {
        ...
        /// <para>Type union: either <see cref="Io.Cdktn.IResolvable" /> or (<see cref="libvirt.Domain.IDomainDevicesTpmsBackendExternalSourcePipeSecLabel" />)[]</para>
        /// </remarks>
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesTpmsBackendExternalSourcePipe), fullyQualifiedName: "libvirt.domain.DomainDevicesTpmsBackendExternalSourcePipe")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesTpmsBackendExternalSourcePipe
        {
