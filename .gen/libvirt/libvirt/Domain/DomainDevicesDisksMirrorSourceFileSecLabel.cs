...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksMirrorSourceFileSecLabel")]
    public class DomainDevicesDisksMirrorSourceFileSecLabel : libvirt.Domain.IDomainDevicesDisksMirrorSourceFileSecLabel
    {
