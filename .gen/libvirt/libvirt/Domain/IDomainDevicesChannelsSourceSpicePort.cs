...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesChannelsSourceSpicePort), fullyQualifiedName: "libvirt.domain.DomainDevicesChannelsSourceSpicePort")]
    public interface IDomainDevicesChannelsSourceSpicePort
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesChannelsSourceSpicePort), fullyQualifiedName: "libvirt.domain.DomainDevicesChannelsSourceSpicePort")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesChannelsSourceSpicePort
        {
