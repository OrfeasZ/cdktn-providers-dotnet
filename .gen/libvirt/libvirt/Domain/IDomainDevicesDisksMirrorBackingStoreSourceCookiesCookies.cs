...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksMirrorBackingStoreSourceCookiesCookies), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorBackingStoreSourceCookiesCookies")]
    public interface IDomainDevicesDisksMirrorBackingStoreSourceCookiesCookies
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksMirrorBackingStoreSourceCookiesCookies), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorBackingStoreSourceCookiesCookies")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksMirrorBackingStoreSourceCookiesCookies
        {
