...
{
    [JsiiInterface(nativeType: typeof(IDomainLxcNamespaceShareIpc), fullyQualifiedName: "libvirt.domain.DomainLxcNamespaceShareIpc")]
    public interface IDomainLxcNamespaceShareIpc
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainLxcNamespaceShareIpc), fullyQualifiedName: "libvirt.domain.DomainLxcNamespaceShareIpc")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainLxcNamespaceShareIpc
        {
