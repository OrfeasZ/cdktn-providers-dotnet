...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesRedirDevsAcpi), fullyQualifiedName: "libvirt.domain.DomainDevicesRedirDevsAcpi")]
    public interface IDomainDevicesRedirDevsAcpi
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesRedirDevsAcpi), fullyQualifiedName: "libvirt.domain.DomainDevicesRedirDevsAcpi")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesRedirDevsAcpi
        {
