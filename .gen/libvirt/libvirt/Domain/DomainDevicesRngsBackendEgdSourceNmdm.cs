...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesRngsBackendEgdSourceNmdm")]
    public class DomainDevicesRngsBackendEgdSourceNmdm : libvirt.Domain.IDomainDevicesRngsBackendEgdSourceNmdm
    {
