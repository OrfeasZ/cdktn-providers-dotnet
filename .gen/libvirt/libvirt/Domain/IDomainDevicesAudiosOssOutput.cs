...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesAudiosOssOutput), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosOssOutput")]
    public interface IDomainDevicesAudiosOssOutput
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        libvirt.Domain.IDomainDevicesAudiosOssOutputSettings? Settings
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesAudiosOssOutput), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosOssOutput")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesAudiosOssOutput
        {
            ...
            {
                get => GetInstanceProperty<libvirt.Domain.IDomainDevicesAudiosOssOutputSettings?>();
            }
