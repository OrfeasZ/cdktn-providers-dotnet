...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesHostdevsAcpi), fullyQualifiedName: "libvirt.domain.DomainDevicesHostdevsAcpi")]
    public interface IDomainDevicesHostdevsAcpi
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesHostdevsAcpi), fullyQualifiedName: "libvirt.domain.DomainDevicesHostdevsAcpi")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesHostdevsAcpi
        {
