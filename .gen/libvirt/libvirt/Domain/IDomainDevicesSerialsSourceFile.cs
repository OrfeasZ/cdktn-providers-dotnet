...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesSerialsSourceFile), fullyQualifiedName: "libvirt.domain.DomainDevicesSerialsSourceFile")]
    public interface IDomainDevicesSerialsSourceFile
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "secLabel", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"libvirt.domain.DomainDevicesSerialsSourceFileSecLabel\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        object? SecLabel
        {
            get
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesSerialsSourceFile), fullyQualifiedName: "libvirt.domain.DomainDevicesSerialsSourceFile")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesSerialsSourceFile
        {
