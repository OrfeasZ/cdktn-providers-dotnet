...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksSourceReservationsSourceFile), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceReservationsSourceFile")]
    public interface IDomainDevicesDisksSourceReservationsSourceFile
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "secLabel", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"libvirt.domain.DomainDevicesDisksSourceReservationsSourceFileSecLabel\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        object? SecLabel
        {
            get
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksSourceReservationsSourceFile), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceReservationsSourceFile")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksSourceReservationsSourceFile
        {
