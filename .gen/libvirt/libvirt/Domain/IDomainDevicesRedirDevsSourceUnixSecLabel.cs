...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesRedirDevsSourceUnixSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesRedirDevsSourceUnixSecLabel")]
    public interface IDomainDevicesRedirDevsSourceUnixSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesRedirDevsSourceUnixSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesRedirDevsSourceUnixSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesRedirDevsSourceUnixSecLabel
        {
