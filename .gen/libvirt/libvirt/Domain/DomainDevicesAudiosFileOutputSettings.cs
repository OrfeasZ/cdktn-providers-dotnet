...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesAudiosFileOutputSettings")]
    public class DomainDevicesAudiosFileOutputSettings : libvirt.Domain.IDomainDevicesAudiosFileOutputSettings
    {
