...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksMirrorSourceReservationsSourcePipeSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceReservationsSourcePipeSecLabel")]
    public interface IDomainDevicesDisksMirrorSourceReservationsSourcePipeSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksMirrorSourceReservationsSourcePipeSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceReservationsSourcePipeSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksMirrorSourceReservationsSourcePipeSecLabel
        {
