...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesChannelsSourceTcp), fullyQualifiedName: "libvirt.domain.DomainDevicesChannelsSourceTcp")]
    public interface IDomainDevicesChannelsSourceTcp
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "reconnect", typeJson: "{\"fqn\":\"libvirt.domain.DomainDevicesChannelsSourceTcpReconnect\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        libvirt.Domain.IDomainDevicesChannelsSourceTcpReconnect? Reconnect
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesChannelsSourceTcp), fullyQualifiedName: "libvirt.domain.DomainDevicesChannelsSourceTcp")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesChannelsSourceTcp
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "reconnect", typeJson: "{\"fqn\":\"libvirt.domain.DomainDevicesChannelsSourceTcpReconnect\"}", isOptional: true)]
            public libvirt.Domain.IDomainDevicesChannelsSourceTcpReconnect? Reconnect
            {
                get => GetInstanceProperty<libvirt.Domain.IDomainDevicesChannelsSourceTcpReconnect?>();
            }
