...
{
    [JsiiInterface(nativeType: typeof(IDomainOsNvRamSourceNetworkHosts), fullyQualifiedName: "libvirt.domain.DomainOsNvRamSourceNetworkHosts")]
    public interface IDomainOsNvRamSourceNetworkHosts
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainOsNvRamSourceNetworkHosts), fullyQualifiedName: "libvirt.domain.DomainOsNvRamSourceNetworkHosts")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainOsNvRamSourceNetworkHosts
        {
