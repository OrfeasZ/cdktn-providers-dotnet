...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainFeaturesCapabilitiesSysPTrace")]
    public class DomainFeaturesCapabilitiesSysPTrace : libvirt.Domain.IDomainFeaturesCapabilitiesSysPTrace
    {
