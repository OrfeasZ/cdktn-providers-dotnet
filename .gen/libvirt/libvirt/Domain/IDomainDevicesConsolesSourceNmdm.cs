...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesConsolesSourceNmdm), fullyQualifiedName: "libvirt.domain.DomainDevicesConsolesSourceNmdm")]
    public interface IDomainDevicesConsolesSourceNmdm
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesConsolesSourceNmdm), fullyQualifiedName: "libvirt.domain.DomainDevicesConsolesSourceNmdm")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesConsolesSourceNmdm
        {
