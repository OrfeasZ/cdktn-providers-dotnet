...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksSourceNetworkKnownHosts")]
    public class DomainDevicesDisksSourceNetworkKnownHosts : libvirt.Domain.IDomainDevicesDisksSourceNetworkKnownHosts
    {
