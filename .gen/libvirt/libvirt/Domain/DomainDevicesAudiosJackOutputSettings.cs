...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesAudiosJackOutputSettings")]
    public class DomainDevicesAudiosJackOutputSettings : libvirt.Domain.IDomainDevicesAudiosJackOutputSettings
    {
