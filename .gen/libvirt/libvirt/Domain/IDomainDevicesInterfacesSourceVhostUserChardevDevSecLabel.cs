...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesInterfacesSourceVhostUserChardevDevSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesInterfacesSourceVhostUserChardevDevSecLabel")]
    public interface IDomainDevicesInterfacesSourceVhostUserChardevDevSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesInterfacesSourceVhostUserChardevDevSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesInterfacesSourceVhostUserChardevDevSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesInterfacesSourceVhostUserChardevDevSecLabel
        {
