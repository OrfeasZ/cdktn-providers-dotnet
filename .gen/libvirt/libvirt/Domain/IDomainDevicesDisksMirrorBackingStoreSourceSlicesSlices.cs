...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksMirrorBackingStoreSourceSlicesSlices), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorBackingStoreSourceSlicesSlices")]
    public interface IDomainDevicesDisksMirrorBackingStoreSourceSlicesSlices
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksMirrorBackingStoreSourceSlicesSlices), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorBackingStoreSourceSlicesSlices")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksMirrorBackingStoreSourceSlicesSlices
        {
