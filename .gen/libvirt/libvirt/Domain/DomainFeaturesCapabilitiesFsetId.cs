...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainFeaturesCapabilitiesFsetId")]
    public class DomainFeaturesCapabilitiesFsetId : libvirt.Domain.IDomainFeaturesCapabilitiesFsetId
    {
