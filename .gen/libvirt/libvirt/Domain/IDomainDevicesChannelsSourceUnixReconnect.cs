...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesChannelsSourceUnixReconnect), fullyQualifiedName: "libvirt.domain.DomainDevicesChannelsSourceUnixReconnect")]
    public interface IDomainDevicesChannelsSourceUnixReconnect
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesChannelsSourceUnixReconnect), fullyQualifiedName: "libvirt.domain.DomainDevicesChannelsSourceUnixReconnect")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesChannelsSourceUnixReconnect
        {
