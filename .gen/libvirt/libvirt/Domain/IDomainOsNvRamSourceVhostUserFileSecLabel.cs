...
{
    [JsiiInterface(nativeType: typeof(IDomainOsNvRamSourceVhostUserFileSecLabel), fullyQualifiedName: "libvirt.domain.DomainOsNvRamSourceVhostUserFileSecLabel")]
    public interface IDomainOsNvRamSourceVhostUserFileSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainOsNvRamSourceVhostUserFileSecLabel), fullyQualifiedName: "libvirt.domain.DomainOsNvRamSourceVhostUserFileSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainOsNvRamSourceVhostUserFileSecLabel
        {
