...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksSourceNetworkAuthSecret")]
    public class DomainDevicesDisksSourceNetworkAuthSecret : libvirt.Domain.IDomainDevicesDisksSourceNetworkAuthSecret
    {
