...
{
    [JsiiInterface(nativeType: typeof(IDomainOsNvRamSourceVhostUserDevSecLabel), fullyQualifiedName: "libvirt.domain.DomainOsNvRamSourceVhostUserDevSecLabel")]
    public interface IDomainOsNvRamSourceVhostUserDevSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainOsNvRamSourceVhostUserDevSecLabel), fullyQualifiedName: "libvirt.domain.DomainOsNvRamSourceVhostUserDevSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainOsNvRamSourceVhostUserDevSecLabel
        {
