...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesAudiosNoneOutput), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosNoneOutput")]
    public interface IDomainDevicesAudiosNoneOutput
    {
        ...
        [JsiiProperty(name: "settings", typeJson: "{\"fqn\":\"libvirt.domain.DomainDevicesAudiosNoneOutputSettings\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        libvirt.Domain.IDomainDevicesAudiosNoneOutputSettings? Settings
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesAudiosNoneOutput), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosNoneOutput")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesAudiosNoneOutput
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "settings", typeJson: "{\"fqn\":\"libvirt.domain.DomainDevicesAudiosNoneOutputSettings\"}", isOptional: true)]
            public libvirt.Domain.IDomainDevicesAudiosNoneOutputSettings? Settings
            {
                get => GetInstanceProperty<libvirt.Domain.IDomainDevicesAudiosNoneOutputSettings?>();
            }
