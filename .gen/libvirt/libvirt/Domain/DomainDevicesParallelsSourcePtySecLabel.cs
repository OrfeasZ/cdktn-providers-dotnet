...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesParallelsSourcePtySecLabel")]
    public class DomainDevicesParallelsSourcePtySecLabel : libvirt.Domain.IDomainDevicesParallelsSourcePtySecLabel
    {
