...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesChannelsSourceNmdm")]
    public class DomainDevicesChannelsSourceNmdm : libvirt.Domain.IDomainDevicesChannelsSourceNmdm
    {
