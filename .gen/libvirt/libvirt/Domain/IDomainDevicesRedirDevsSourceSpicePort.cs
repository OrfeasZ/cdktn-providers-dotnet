...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesRedirDevsSourceSpicePort), fullyQualifiedName: "libvirt.domain.DomainDevicesRedirDevsSourceSpicePort")]
    public interface IDomainDevicesRedirDevsSourceSpicePort
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesRedirDevsSourceSpicePort), fullyQualifiedName: "libvirt.domain.DomainDevicesRedirDevsSourceSpicePort")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesRedirDevsSourceSpicePort
        {
