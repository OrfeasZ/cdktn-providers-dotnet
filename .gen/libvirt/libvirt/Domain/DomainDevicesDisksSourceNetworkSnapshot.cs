...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksSourceNetworkSnapshot")]
    public class DomainDevicesDisksSourceNetworkSnapshot : libvirt.Domain.IDomainDevicesDisksSourceNetworkSnapshot
    {
