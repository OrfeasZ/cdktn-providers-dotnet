...
{
    [JsiiInterface(nativeType: typeof(IDomainFeaturesHyperVEvmcs), fullyQualifiedName: "libvirt.domain.DomainFeaturesHyperVEvmcs")]
    public interface IDomainFeaturesHyperVEvmcs
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainFeaturesHyperVEvmcs), fullyQualifiedName: "libvirt.domain.DomainFeaturesHyperVEvmcs")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainFeaturesHyperVEvmcs
        {
