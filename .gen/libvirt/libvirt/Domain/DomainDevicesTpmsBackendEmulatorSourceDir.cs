...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesTpmsBackendEmulatorSourceDir")]
    public class DomainDevicesTpmsBackendEmulatorSourceDir : libvirt.Domain.IDomainDevicesTpmsBackendEmulatorSourceDir
    {
