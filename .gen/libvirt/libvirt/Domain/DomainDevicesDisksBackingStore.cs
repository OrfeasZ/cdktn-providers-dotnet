...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksBackingStore")]
    public class DomainDevicesDisksBackingStore : libvirt.Domain.IDomainDevicesDisksBackingStore
    {
