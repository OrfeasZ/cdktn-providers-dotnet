...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesTpmsBackendExternalSourceUnixReconnect), fullyQualifiedName: "libvirt.domain.DomainDevicesTpmsBackendExternalSourceUnixReconnect")]
    public interface IDomainDevicesTpmsBackendExternalSourceUnixReconnect
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesTpmsBackendExternalSourceUnixReconnect), fullyQualifiedName: "libvirt.domain.DomainDevicesTpmsBackendExternalSourceUnixReconnect")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesTpmsBackendExternalSourceUnixReconnect
        {
