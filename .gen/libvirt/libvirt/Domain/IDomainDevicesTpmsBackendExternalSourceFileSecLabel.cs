...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesTpmsBackendExternalSourceFileSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesTpmsBackendExternalSourceFileSecLabel")]
    public interface IDomainDevicesTpmsBackendExternalSourceFileSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesTpmsBackendExternalSourceFileSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesTpmsBackendExternalSourceFileSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesTpmsBackendExternalSourceFileSecLabel
        {
