...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesRedirDevsSourceNmdm")]
    public class DomainDevicesRedirDevsSourceNmdm : libvirt.Domain.IDomainDevicesRedirDevsSourceNmdm
    {
