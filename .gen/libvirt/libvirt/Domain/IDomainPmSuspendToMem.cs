...
{
    [JsiiInterface(nativeType: typeof(IDomainPmSuspendToMem), fullyQualifiedName: "libvirt.domain.DomainPmSuspendToMem")]
    public interface IDomainPmSuspendToMem
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainPmSuspendToMem), fullyQualifiedName: "libvirt.domain.DomainPmSuspendToMem")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainPmSuspendToMem
        {
