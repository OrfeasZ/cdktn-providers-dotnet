...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesAudiosPipeWireInputSettings")]
    public class DomainDevicesAudiosPipeWireInputSettings : libvirt.Domain.IDomainDevicesAudiosPipeWireInputSettings
    {
