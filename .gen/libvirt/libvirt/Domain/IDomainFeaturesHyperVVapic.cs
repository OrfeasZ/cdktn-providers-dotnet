...
{
    [JsiiInterface(nativeType: typeof(IDomainFeaturesHyperVVapic), fullyQualifiedName: "libvirt.domain.DomainFeaturesHyperVVapic")]
    public interface IDomainFeaturesHyperVVapic
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainFeaturesHyperVVapic), fullyQualifiedName: "libvirt.domain.DomainFeaturesHyperVVapic")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainFeaturesHyperVVapic
        {
