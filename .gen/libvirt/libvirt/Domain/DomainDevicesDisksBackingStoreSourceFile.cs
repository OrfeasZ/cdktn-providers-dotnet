...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksBackingStoreSourceFile")]
    public class DomainDevicesDisksBackingStoreSourceFile : libvirt.Domain.IDomainDevicesDisksBackingStoreSourceFile
    {
