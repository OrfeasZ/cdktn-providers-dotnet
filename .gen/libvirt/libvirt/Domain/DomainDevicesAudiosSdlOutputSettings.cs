...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesAudiosSdlOutputSettings")]
    public class DomainDevicesAudiosSdlOutputSettings : libvirt.Domain.IDomainDevicesAudiosSdlOutputSettings
    {
