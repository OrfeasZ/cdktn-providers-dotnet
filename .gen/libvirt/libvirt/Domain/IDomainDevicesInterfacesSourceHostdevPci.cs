...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesInterfacesSourceHostdevPci), fullyQualifiedName: "libvirt.domain.DomainDevicesInterfacesSourceHostdevPci")]
    public interface IDomainDevicesInterfacesSourceHostdevPci
    {
        ...
        libvirt.Domain.IDomainDevicesInterfacesSourceHostdevPciAddress? Address
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesInterfacesSourceHostdevPci), fullyQualifiedName: "libvirt.domain.DomainDevicesInterfacesSourceHostdevPci")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesInterfacesSourceHostdevPci
        {
            ...
            {
                get => GetInstanceProperty<libvirt.Domain.IDomainDevicesInterfacesSourceHostdevPciAddress?>();
            }
