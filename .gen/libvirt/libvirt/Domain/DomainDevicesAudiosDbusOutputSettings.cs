...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesAudiosDbusOutputSettings")]
    public class DomainDevicesAudiosDbusOutputSettings : libvirt.Domain.IDomainDevicesAudiosDbusOutputSettings
    {
