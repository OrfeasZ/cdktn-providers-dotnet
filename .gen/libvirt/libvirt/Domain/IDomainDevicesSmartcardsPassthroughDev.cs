...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesSmartcardsPassthroughDev), fullyQualifiedName: "libvirt.domain.DomainDevicesSmartcardsPassthroughDev")]
    public interface IDomainDevicesSmartcardsPassthroughDev
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesSmartcardsPassthroughDev), fullyQualifiedName: "libvirt.domain.DomainDevicesSmartcardsPassthroughDev")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesSmartcardsPassthroughDev
        {
