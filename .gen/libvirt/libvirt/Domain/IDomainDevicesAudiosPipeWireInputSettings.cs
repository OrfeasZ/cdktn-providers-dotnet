...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesAudiosPipeWireInputSettings), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosPipeWireInputSettings")]
    public interface IDomainDevicesAudiosPipeWireInputSettings
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesAudiosPipeWireInputSettings), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosPipeWireInputSettings")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesAudiosPipeWireInputSettings
        {
