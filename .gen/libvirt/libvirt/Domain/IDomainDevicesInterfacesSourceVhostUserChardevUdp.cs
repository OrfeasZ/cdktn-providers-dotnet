...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesInterfacesSourceVhostUserChardevUdp), fullyQualifiedName: "libvirt.domain.DomainDevicesInterfacesSourceVhostUserChardevUdp")]
    public interface IDomainDevicesInterfacesSourceVhostUserChardevUdp
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesInterfacesSourceVhostUserChardevUdp), fullyQualifiedName: "libvirt.domain.DomainDevicesInterfacesSourceVhostUserChardevUdp")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesInterfacesSourceVhostUserChardevUdp
        {
