...
{
    [JsiiInterface(nativeType: typeof(IDomainFeaturesAsyncTeardown), fullyQualifiedName: "libvirt.domain.DomainFeaturesAsyncTeardown")]
    public interface IDomainFeaturesAsyncTeardown
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainFeaturesAsyncTeardown), fullyQualifiedName: "libvirt.domain.DomainFeaturesAsyncTeardown")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainFeaturesAsyncTeardown
        {
