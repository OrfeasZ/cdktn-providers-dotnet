...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksMirrorBackingStoreSourceNetworkHosts), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorBackingStoreSourceNetworkHosts")]
    public interface IDomainDevicesDisksMirrorBackingStoreSourceNetworkHosts
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksMirrorBackingStoreSourceNetworkHosts), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorBackingStoreSourceNetworkHosts")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksMirrorBackingStoreSourceNetworkHosts
        {
