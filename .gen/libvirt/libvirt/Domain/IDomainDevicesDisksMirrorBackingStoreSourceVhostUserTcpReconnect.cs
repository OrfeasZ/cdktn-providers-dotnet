...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksMirrorBackingStoreSourceVhostUserTcpReconnect), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorBackingStoreSourceVhostUserTcpReconnect")]
    public interface IDomainDevicesDisksMirrorBackingStoreSourceVhostUserTcpReconnect
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksMirrorBackingStoreSourceVhostUserTcpReconnect), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorBackingStoreSourceVhostUserTcpReconnect")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksMirrorBackingStoreSourceVhostUserTcpReconnect
        {
