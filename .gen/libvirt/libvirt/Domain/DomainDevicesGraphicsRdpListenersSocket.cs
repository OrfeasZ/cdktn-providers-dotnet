...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesGraphicsRdpListenersSocket")]
    public class DomainDevicesGraphicsRdpListenersSocket : libvirt.Domain.IDomainDevicesGraphicsRdpListenersSocket
    {
