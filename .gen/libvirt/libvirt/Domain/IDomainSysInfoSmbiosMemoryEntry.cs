...
{
    [JsiiInterface(nativeType: typeof(IDomainSysInfoSmbiosMemoryEntry), fullyQualifiedName: "libvirt.domain.DomainSysInfoSmbiosMemoryEntry")]
    public interface IDomainSysInfoSmbiosMemoryEntry
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainSysInfoSmbiosMemoryEntry), fullyQualifiedName: "libvirt.domain.DomainSysInfoSmbiosMemoryEntry")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainSysInfoSmbiosMemoryEntry
        {
