...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainOsNvRamSourceReservationsSourceNmdm")]
    public class DomainOsNvRamSourceReservationsSourceNmdm : libvirt.Domain.IDomainOsNvRamSourceReservationsSourceNmdm
    {
