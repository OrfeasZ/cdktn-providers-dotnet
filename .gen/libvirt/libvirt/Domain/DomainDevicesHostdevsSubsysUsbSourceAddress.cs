...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesHostdevsSubsysUsbSourceAddress")]
    public class DomainDevicesHostdevsSubsysUsbSourceAddress : libvirt.Domain.IDomainDevicesHostdevsSubsysUsbSourceAddress
    {
