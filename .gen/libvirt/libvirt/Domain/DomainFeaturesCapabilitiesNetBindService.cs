...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainFeaturesCapabilitiesNetBindService")]
    public class DomainFeaturesCapabilitiesNetBindService : libvirt.Domain.IDomainFeaturesCapabilitiesNetBindService
    {
