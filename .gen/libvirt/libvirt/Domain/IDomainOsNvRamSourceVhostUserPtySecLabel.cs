...
{
    [JsiiInterface(nativeType: typeof(IDomainOsNvRamSourceVhostUserPtySecLabel), fullyQualifiedName: "libvirt.domain.DomainOsNvRamSourceVhostUserPtySecLabel")]
    public interface IDomainOsNvRamSourceVhostUserPtySecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainOsNvRamSourceVhostUserPtySecLabel), fullyQualifiedName: "libvirt.domain.DomainOsNvRamSourceVhostUserPtySecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainOsNvRamSourceVhostUserPtySecLabel
        {
