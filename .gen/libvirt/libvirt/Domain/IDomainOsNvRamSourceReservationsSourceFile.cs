...
{
    [JsiiInterface(nativeType: typeof(IDomainOsNvRamSourceReservationsSourceFile), fullyQualifiedName: "libvirt.domain.DomainOsNvRamSourceReservationsSourceFile")]
    public interface IDomainOsNvRamSourceReservationsSourceFile
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainOsNvRamSourceReservationsSourceFile), fullyQualifiedName: "libvirt.domain.DomainOsNvRamSourceReservationsSourceFile")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainOsNvRamSourceReservationsSourceFile
        {
