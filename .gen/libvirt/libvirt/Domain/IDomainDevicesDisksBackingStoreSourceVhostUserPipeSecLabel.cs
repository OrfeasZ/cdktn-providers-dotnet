...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksBackingStoreSourceVhostUserPipeSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackingStoreSourceVhostUserPipeSecLabel")]
    public interface IDomainDevicesDisksBackingStoreSourceVhostUserPipeSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksBackingStoreSourceVhostUserPipeSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackingStoreSourceVhostUserPipeSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksBackingStoreSourceVhostUserPipeSecLabel
        {
