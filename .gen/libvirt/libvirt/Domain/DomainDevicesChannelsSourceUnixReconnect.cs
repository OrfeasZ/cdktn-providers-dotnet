...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesChannelsSourceUnixReconnect")]
    public class DomainDevicesChannelsSourceUnixReconnect : libvirt.Domain.IDomainDevicesChannelsSourceUnixReconnect
    {
