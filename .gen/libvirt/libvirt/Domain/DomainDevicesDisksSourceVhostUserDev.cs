...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksSourceVhostUserDev")]
    public class DomainDevicesDisksSourceVhostUserDev : libvirt.Domain.IDomainDevicesDisksSourceVhostUserDev
    {
