...
{
    [JsiiInterface(nativeType: typeof(IDomainFeaturesKvmPvipi), fullyQualifiedName: "libvirt.domain.DomainFeaturesKvmPvipi")]
    public interface IDomainFeaturesKvmPvipi
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainFeaturesKvmPvipi), fullyQualifiedName: "libvirt.domain.DomainFeaturesKvmPvipi")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainFeaturesKvmPvipi
        {
