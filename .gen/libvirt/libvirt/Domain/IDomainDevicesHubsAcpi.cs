...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesHubsAcpi), fullyQualifiedName: "libvirt.domain.DomainDevicesHubsAcpi")]
    public interface IDomainDevicesHubsAcpi
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesHubsAcpi), fullyQualifiedName: "libvirt.domain.DomainDevicesHubsAcpi")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesHubsAcpi
        {
