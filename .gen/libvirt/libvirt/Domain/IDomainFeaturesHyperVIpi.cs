...
{
    [JsiiInterface(nativeType: typeof(IDomainFeaturesHyperVIpi), fullyQualifiedName: "libvirt.domain.DomainFeaturesHyperVIpi")]
    public interface IDomainFeaturesHyperVIpi
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainFeaturesHyperVIpi), fullyQualifiedName: "libvirt.domain.DomainFeaturesHyperVIpi")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainFeaturesHyperVIpi
        {
