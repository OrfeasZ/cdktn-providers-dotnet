...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksMirrorSourceDataStore")]
    public class DomainDevicesDisksMirrorSourceDataStore : libvirt.Domain.IDomainDevicesDisksMirrorSourceDataStore
    {
