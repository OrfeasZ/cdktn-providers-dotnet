...
{
    [JsiiInterface(nativeType: typeof(IDomainFeaturesHap), fullyQualifiedName: "libvirt.domain.DomainFeaturesHap")]
    public interface IDomainFeaturesHap
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainFeaturesHap), fullyQualifiedName: "libvirt.domain.DomainFeaturesHap")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainFeaturesHap
        {
