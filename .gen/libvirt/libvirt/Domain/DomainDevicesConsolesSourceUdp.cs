...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesConsolesSourceUdp")]
    public class DomainDevicesConsolesSourceUdp : libvirt.Domain.IDomainDevicesConsolesSourceUdp
    {
