...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksEncryptionSecrets")]
    public class DomainDevicesDisksEncryptionSecrets : libvirt.Domain.IDomainDevicesDisksEncryptionSecrets
    {
