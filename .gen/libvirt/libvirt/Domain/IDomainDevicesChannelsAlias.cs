...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesChannelsAlias), fullyQualifiedName: "libvirt.domain.DomainDevicesChannelsAlias")]
    public interface IDomainDevicesChannelsAlias
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesChannelsAlias), fullyQualifiedName: "libvirt.domain.DomainDevicesChannelsAlias")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesChannelsAlias
        {
