...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesAudiosOssInputSettings")]
    public class DomainDevicesAudiosOssInputSettings : libvirt.Domain.IDomainDevicesAudiosOssInputSettings
    {
