...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainFeaturesCapabilitiesAuditWrite")]
    public class DomainFeaturesCapabilitiesAuditWrite : libvirt.Domain.IDomainFeaturesCapabilitiesAuditWrite
    {
