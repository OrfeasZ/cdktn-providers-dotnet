...
{
    [JsiiInterface(nativeType: typeof(IDomainFeaturesCapabilitiesSysTime), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesSysTime")]
    public interface IDomainFeaturesCapabilitiesSysTime
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainFeaturesCapabilitiesSysTime), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesSysTime")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainFeaturesCapabilitiesSysTime
        {
