...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainOsNvRamSourceVhostUserUnixSecLabel")]
    public class DomainOsNvRamSourceVhostUserUnixSecLabel : libvirt.Domain.IDomainOsNvRamSourceVhostUserUnixSecLabel
    {
