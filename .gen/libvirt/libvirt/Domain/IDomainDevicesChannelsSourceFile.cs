...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesChannelsSourceFile), fullyQualifiedName: "libvirt.domain.DomainDevicesChannelsSourceFile")]
    public interface IDomainDevicesChannelsSourceFile
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesChannelsSourceFile), fullyQualifiedName: "libvirt.domain.DomainDevicesChannelsSourceFile")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesChannelsSourceFile
        {
