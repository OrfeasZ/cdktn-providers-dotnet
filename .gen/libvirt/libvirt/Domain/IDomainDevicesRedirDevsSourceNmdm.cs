...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesRedirDevsSourceNmdm), fullyQualifiedName: "libvirt.domain.DomainDevicesRedirDevsSourceNmdm")]
    public interface IDomainDevicesRedirDevsSourceNmdm
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesRedirDevsSourceNmdm), fullyQualifiedName: "libvirt.domain.DomainDevicesRedirDevsSourceNmdm")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesRedirDevsSourceNmdm
        {
