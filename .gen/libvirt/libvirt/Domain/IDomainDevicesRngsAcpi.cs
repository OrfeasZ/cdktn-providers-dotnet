...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesRngsAcpi), fullyQualifiedName: "libvirt.domain.DomainDevicesRngsAcpi")]
    public interface IDomainDevicesRngsAcpi
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesRngsAcpi), fullyQualifiedName: "libvirt.domain.DomainDevicesRngsAcpi")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesRngsAcpi
        {
