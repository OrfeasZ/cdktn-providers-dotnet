...
{
    [JsiiInterface(nativeType: typeof(IDomainOsNvRamSourceVhostUserUnixSecLabel), fullyQualifiedName: "libvirt.domain.DomainOsNvRamSourceVhostUserUnixSecLabel")]
    public interface IDomainOsNvRamSourceVhostUserUnixSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainOsNvRamSourceVhostUserUnixSecLabel), fullyQualifiedName: "libvirt.domain.DomainOsNvRamSourceVhostUserUnixSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainOsNvRamSourceVhostUserUnixSecLabel
        {
