...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksSourceNetworkAuthSecret), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceNetworkAuthSecret")]
    public interface IDomainDevicesDisksSourceNetworkAuthSecret
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksSourceNetworkAuthSecret), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceNetworkAuthSecret")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksSourceNetworkAuthSecret
        {
