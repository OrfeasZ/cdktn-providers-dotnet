...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainFeaturesCapabilitiesFowner")]
    public class DomainFeaturesCapabilitiesFowner : libvirt.Domain.IDomainFeaturesCapabilitiesFowner
    {
