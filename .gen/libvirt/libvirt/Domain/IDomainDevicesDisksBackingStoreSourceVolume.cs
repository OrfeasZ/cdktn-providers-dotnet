...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksBackingStoreSourceVolume), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackingStoreSourceVolume")]
    public interface IDomainDevicesDisksBackingStoreSourceVolume
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksBackingStoreSourceVolume), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackingStoreSourceVolume")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksBackingStoreSourceVolume
        {
