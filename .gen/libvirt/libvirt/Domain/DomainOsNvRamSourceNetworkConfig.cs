...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainOsNvRamSourceNetworkConfig")]
    public class DomainOsNvRamSourceNetworkConfig : libvirt.Domain.IDomainOsNvRamSourceNetworkConfig
    {
