...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksMirrorSourceCookiesCookies), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceCookiesCookies")]
    public interface IDomainDevicesDisksMirrorSourceCookiesCookies
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksMirrorSourceCookiesCookies), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceCookiesCookies")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksMirrorSourceCookiesCookies
        {
