...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesGraphicsSpiceListenersNetwork), fullyQualifiedName: "libvirt.domain.DomainDevicesGraphicsSpiceListenersNetwork")]
    public interface IDomainDevicesGraphicsSpiceListenersNetwork
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesGraphicsSpiceListenersNetwork), fullyQualifiedName: "libvirt.domain.DomainDevicesGraphicsSpiceListenersNetwork")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesGraphicsSpiceListenersNetwork
        {
