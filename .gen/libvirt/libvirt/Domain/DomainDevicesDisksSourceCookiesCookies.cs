...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksSourceCookiesCookies")]
    public class DomainDevicesDisksSourceCookiesCookies : libvirt.Domain.IDomainDevicesDisksSourceCookiesCookies
    {
