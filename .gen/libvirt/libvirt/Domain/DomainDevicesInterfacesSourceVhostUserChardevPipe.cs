...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesInterfacesSourceVhostUserChardevPipe")]
    public class DomainDevicesInterfacesSourceVhostUserChardevPipe : libvirt.Domain.IDomainDevicesInterfacesSourceVhostUserChardevPipe
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "secLabel", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"libvirt.domain.DomainDevicesInterfacesSourceVhostUserChardevPipeSecLabel\"},\"kind\":\"array\"}}]}}", isOptional: true)]
