...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksBackingStoreSourceVhostUserDevSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackingStoreSourceVhostUserDevSecLabel")]
    public interface IDomainDevicesDisksBackingStoreSourceVhostUserDevSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksBackingStoreSourceVhostUserDevSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackingStoreSourceVhostUserDevSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksBackingStoreSourceVhostUserDevSecLabel
        {
