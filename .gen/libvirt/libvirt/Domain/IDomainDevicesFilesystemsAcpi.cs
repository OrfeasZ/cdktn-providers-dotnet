...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesFilesystemsAcpi), fullyQualifiedName: "libvirt.domain.DomainDevicesFilesystemsAcpi")]
    public interface IDomainDevicesFilesystemsAcpi
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesFilesystemsAcpi), fullyQualifiedName: "libvirt.domain.DomainDevicesFilesystemsAcpi")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesFilesystemsAcpi
        {
