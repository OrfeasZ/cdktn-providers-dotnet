...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesNvramAlias), fullyQualifiedName: "libvirt.domain.DomainDevicesNvramAlias")]
    public interface IDomainDevicesNvramAlias
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesNvramAlias), fullyQualifiedName: "libvirt.domain.DomainDevicesNvramAlias")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesNvramAlias
        {
