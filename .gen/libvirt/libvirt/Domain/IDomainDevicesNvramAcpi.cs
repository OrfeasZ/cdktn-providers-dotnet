...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesNvramAcpi), fullyQualifiedName: "libvirt.domain.DomainDevicesNvramAcpi")]
    public interface IDomainDevicesNvramAcpi
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesNvramAcpi), fullyQualifiedName: "libvirt.domain.DomainDevicesNvramAcpi")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesNvramAcpi
        {
