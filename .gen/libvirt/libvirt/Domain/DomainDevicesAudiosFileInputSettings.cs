...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesAudiosFileInputSettings")]
    public class DomainDevicesAudiosFileInputSettings : libvirt.Domain.IDomainDevicesAudiosFileInputSettings
    {
