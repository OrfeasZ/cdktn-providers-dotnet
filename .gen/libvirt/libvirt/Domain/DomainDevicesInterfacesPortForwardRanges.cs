...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesInterfacesPortForwardRanges")]
    public class DomainDevicesInterfacesPortForwardRanges : libvirt.Domain.IDomainDevicesInterfacesPortForwardRanges
    {
