...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesChannelsSourceDevSecLabel")]
    public class DomainDevicesChannelsSourceDevSecLabel : libvirt.Domain.IDomainDevicesChannelsSourceDevSecLabel
    {
