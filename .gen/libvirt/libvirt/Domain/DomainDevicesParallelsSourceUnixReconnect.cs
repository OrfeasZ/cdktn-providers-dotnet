...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesParallelsSourceUnixReconnect")]
    public class DomainDevicesParallelsSourceUnixReconnect : libvirt.Domain.IDomainDevicesParallelsSourceUnixReconnect
    {
