...
{
    [JsiiInterface(nativeType: typeof(IDomainOsNvRamSourceVolume), fullyQualifiedName: "libvirt.domain.DomainOsNvRamSourceVolume")]
    public interface IDomainOsNvRamSourceVolume
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "secLabel", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"libvirt.domain.DomainOsNvRamSourceVolumeSecLabel\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        object? SecLabel
        {
            get
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainOsNvRamSourceVolume), fullyQualifiedName: "libvirt.domain.DomainOsNvRamSourceVolume")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainOsNvRamSourceVolume
        {
