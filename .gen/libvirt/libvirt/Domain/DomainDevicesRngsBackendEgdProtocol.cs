...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesRngsBackendEgdProtocol")]
    public class DomainDevicesRngsBackendEgdProtocol : libvirt.Domain.IDomainDevicesRngsBackendEgdProtocol
    {
