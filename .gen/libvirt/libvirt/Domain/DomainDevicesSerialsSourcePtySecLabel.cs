...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesSerialsSourcePtySecLabel")]
    public class DomainDevicesSerialsSourcePtySecLabel : libvirt.Domain.IDomainDevicesSerialsSourcePtySecLabel
    {
