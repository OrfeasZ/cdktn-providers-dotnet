...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesInterfacesBackendDomain")]
    public class DomainDevicesInterfacesBackendDomain : libvirt.Domain.IDomainDevicesInterfacesBackendDomain
    {
