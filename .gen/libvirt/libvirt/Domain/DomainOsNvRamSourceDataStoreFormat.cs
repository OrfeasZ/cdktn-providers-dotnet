...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainOsNvRamSourceDataStoreFormat")]
    public class DomainOsNvRamSourceDataStoreFormat : libvirt.Domain.IDomainOsNvRamSourceDataStoreFormat
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "metadataCache", typeJson: "{\"fqn\":\"libvirt.domain.DomainOsNvRamSourceDataStoreFormatMetadataCache\"}", isOptional: true)]
        public libvirt.Domain.IDomainOsNvRamSourceDataStoreFormatMetadataCache? MetadataCache
        {
            get;
            set;
        }
