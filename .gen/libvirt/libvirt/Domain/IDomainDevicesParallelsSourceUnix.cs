...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesParallelsSourceUnix), fullyQualifiedName: "libvirt.domain.DomainDevicesParallelsSourceUnix")]
    public interface IDomainDevicesParallelsSourceUnix
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        libvirt.Domain.IDomainDevicesParallelsSourceUnixReconnect? Reconnect
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesParallelsSourceUnix), fullyQualifiedName: "libvirt.domain.DomainDevicesParallelsSourceUnix")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesParallelsSourceUnix
        {
            ...
            {
                get => GetInstanceProperty<libvirt.Domain.IDomainDevicesParallelsSourceUnixReconnect?>();
            }
