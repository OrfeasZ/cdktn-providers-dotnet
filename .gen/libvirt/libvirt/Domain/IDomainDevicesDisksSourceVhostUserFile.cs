...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksSourceVhostUserFile), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceVhostUserFile")]
    public interface IDomainDevicesDisksSourceVhostUserFile
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksSourceVhostUserFile), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceVhostUserFile")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksSourceVhostUserFile
        {
