...
{
    [JsiiInterface(nativeType: typeof(IDomainOsNvRamSourceVhostUserUnixReconnect), fullyQualifiedName: "libvirt.domain.DomainOsNvRamSourceVhostUserUnixReconnect")]
    public interface IDomainOsNvRamSourceVhostUserUnixReconnect
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainOsNvRamSourceVhostUserUnixReconnect), fullyQualifiedName: "libvirt.domain.DomainOsNvRamSourceVhostUserUnixReconnect")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainOsNvRamSourceVhostUserUnixReconnect
        {
