...
{
    [JsiiInterface(nativeType: typeof(IDomainMemoryTune), fullyQualifiedName: "libvirt.domain.DomainMemoryTune")]
    public interface IDomainMemoryTune
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainMemoryTune), fullyQualifiedName: "libvirt.domain.DomainMemoryTune")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainMemoryTune
        {
