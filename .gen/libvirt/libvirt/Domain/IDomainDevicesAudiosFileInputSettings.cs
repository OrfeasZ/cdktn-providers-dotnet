...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesAudiosFileInputSettings), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosFileInputSettings")]
    public interface IDomainDevicesAudiosFileInputSettings
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesAudiosFileInputSettings), fullyQualifiedName: "libvirt.domain.DomainDevicesAudiosFileInputSettings")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesAudiosFileInputSettings
        {
