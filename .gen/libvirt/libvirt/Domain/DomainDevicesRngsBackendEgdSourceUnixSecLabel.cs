...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesRngsBackendEgdSourceUnixSecLabel")]
    public class DomainDevicesRngsBackendEgdSourceUnixSecLabel : libvirt.Domain.IDomainDevicesRngsBackendEgdSourceUnixSecLabel
    {
