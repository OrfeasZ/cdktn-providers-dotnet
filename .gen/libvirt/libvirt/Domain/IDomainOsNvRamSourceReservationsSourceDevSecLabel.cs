...
{
    [JsiiInterface(nativeType: typeof(IDomainOsNvRamSourceReservationsSourceDevSecLabel), fullyQualifiedName: "libvirt.domain.DomainOsNvRamSourceReservationsSourceDevSecLabel")]
    public interface IDomainOsNvRamSourceReservationsSourceDevSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainOsNvRamSourceReservationsSourceDevSecLabel), fullyQualifiedName: "libvirt.domain.DomainOsNvRamSourceReservationsSourceDevSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainOsNvRamSourceReservationsSourceDevSecLabel
        {
