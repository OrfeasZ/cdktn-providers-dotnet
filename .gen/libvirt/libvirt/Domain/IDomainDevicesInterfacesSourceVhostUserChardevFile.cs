...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesInterfacesSourceVhostUserChardevFile), fullyQualifiedName: "libvirt.domain.DomainDevicesInterfacesSourceVhostUserChardevFile")]
    public interface IDomainDevicesInterfacesSourceVhostUserChardevFile
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesInterfacesSourceVhostUserChardevFile), fullyQualifiedName: "libvirt.domain.DomainDevicesInterfacesSourceVhostUserChardevFile")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesInterfacesSourceVhostUserChardevFile
        {
