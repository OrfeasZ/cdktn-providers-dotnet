...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksBackingStoreSourceBlock), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackingStoreSourceBlock")]
    public interface IDomainDevicesDisksBackingStoreSourceBlock
    {
        ...
        /// <para>Type union: either <see cref="Io.Cdktn.IResolvable" /> or (<see cref="libvirt.Domain.IDomainDevicesDisksBackingStoreSourceBlockSecLabel" />)[]</para>
        /// </remarks>
        [JsiiProperty(name: "secLabel", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"libvirt.domain.DomainDevicesDisksBackingStoreSourceBlockSecLabel\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        object? SecLabel
        {
            get
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksBackingStoreSourceBlock), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackingStoreSourceBlock")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksBackingStoreSourceBlock
        {
