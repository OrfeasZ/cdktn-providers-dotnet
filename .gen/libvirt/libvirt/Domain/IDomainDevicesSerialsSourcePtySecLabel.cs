...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesSerialsSourcePtySecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesSerialsSourcePtySecLabel")]
    public interface IDomainDevicesSerialsSourcePtySecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesSerialsSourcePtySecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesSerialsSourcePtySecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesSerialsSourcePtySecLabel
        {
