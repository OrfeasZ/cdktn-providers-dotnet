...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksMirrorSourceNetworkAuth")]
    public class DomainDevicesDisksMirrorSourceNetworkAuth : libvirt.Domain.IDomainDevicesDisksMirrorSourceNetworkAuth
    {
