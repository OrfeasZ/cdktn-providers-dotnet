...
{
    [JsiiInterface(nativeType: typeof(IDomainFeaturesCapabilitiesSetPCap), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesSetPCap")]
    public interface IDomainFeaturesCapabilitiesSetPCap
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainFeaturesCapabilitiesSetPCap), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesSetPCap")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainFeaturesCapabilitiesSetPCap
        {
