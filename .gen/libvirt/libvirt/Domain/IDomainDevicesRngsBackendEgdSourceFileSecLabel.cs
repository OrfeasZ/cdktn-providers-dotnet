...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesRngsBackendEgdSourceFileSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesRngsBackendEgdSourceFileSecLabel")]
    public interface IDomainDevicesRngsBackendEgdSourceFileSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesRngsBackendEgdSourceFileSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesRngsBackendEgdSourceFileSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesRngsBackendEgdSourceFileSecLabel
        {
