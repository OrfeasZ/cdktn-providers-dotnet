...
{
    [JsiiInterface(nativeType: typeof(IDomainFeaturesCapabilitiesIpcOwner), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesIpcOwner")]
    public interface IDomainFeaturesCapabilitiesIpcOwner
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainFeaturesCapabilitiesIpcOwner), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesIpcOwner")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainFeaturesCapabilitiesIpcOwner
        {
