...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesParallelsSourceDbus")]
    public class DomainDevicesParallelsSourceDbus : libvirt.Domain.IDomainDevicesParallelsSourceDbus
    {
