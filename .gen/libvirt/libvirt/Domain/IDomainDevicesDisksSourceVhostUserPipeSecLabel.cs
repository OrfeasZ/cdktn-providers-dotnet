...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksSourceVhostUserPipeSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceVhostUserPipeSecLabel")]
    public interface IDomainDevicesDisksSourceVhostUserPipeSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksSourceVhostUserPipeSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceVhostUserPipeSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksSourceVhostUserPipeSecLabel
        {
