...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesConsolesSourceDevSecLabel")]
    public class DomainDevicesConsolesSourceDevSecLabel : libvirt.Domain.IDomainDevicesConsolesSourceDevSecLabel
    {
