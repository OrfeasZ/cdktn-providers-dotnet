...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesVsockAcpi), fullyQualifiedName: "libvirt.domain.DomainDevicesVsockAcpi")]
    public interface IDomainDevicesVsockAcpi
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesVsockAcpi), fullyQualifiedName: "libvirt.domain.DomainDevicesVsockAcpi")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesVsockAcpi
        {
