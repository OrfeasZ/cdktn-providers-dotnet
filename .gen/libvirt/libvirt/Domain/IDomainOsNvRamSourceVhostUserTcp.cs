...
{
    [JsiiInterface(nativeType: typeof(IDomainOsNvRamSourceVhostUserTcp), fullyQualifiedName: "libvirt.domain.DomainOsNvRamSourceVhostUserTcp")]
    public interface IDomainOsNvRamSourceVhostUserTcp
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "reconnect", typeJson: "{\"fqn\":\"libvirt.domain.DomainOsNvRamSourceVhostUserTcpReconnect\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        libvirt.Domain.IDomainOsNvRamSourceVhostUserTcpReconnect? Reconnect
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainOsNvRamSourceVhostUserTcp), fullyQualifiedName: "libvirt.domain.DomainOsNvRamSourceVhostUserTcp")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainOsNvRamSourceVhostUserTcp
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "reconnect", typeJson: "{\"fqn\":\"libvirt.domain.DomainOsNvRamSourceVhostUserTcpReconnect\"}", isOptional: true)]
            public libvirt.Domain.IDomainOsNvRamSourceVhostUserTcpReconnect? Reconnect
            {
                get => GetInstanceProperty<libvirt.Domain.IDomainOsNvRamSourceVhostUserTcpReconnect?>();
            }
