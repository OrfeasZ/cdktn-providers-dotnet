...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainCpuNumaInterconnectsLatencies")]
    public class DomainCpuNumaInterconnectsLatencies : libvirt.Domain.IDomainCpuNumaInterconnectsLatencies
    {
