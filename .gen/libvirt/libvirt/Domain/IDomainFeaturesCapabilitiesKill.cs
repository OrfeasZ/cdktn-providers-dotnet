...
{
    [JsiiInterface(nativeType: typeof(IDomainFeaturesCapabilitiesKill), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesKill")]
    public interface IDomainFeaturesCapabilitiesKill
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainFeaturesCapabilitiesKill), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesKill")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainFeaturesCapabilitiesKill
        {
