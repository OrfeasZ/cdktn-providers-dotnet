...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainOsNvRamSourceVhostUserNmdm")]
    public class DomainOsNvRamSourceVhostUserNmdm : libvirt.Domain.IDomainOsNvRamSourceVhostUserNmdm
    {
