...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainOsNvRamSourceReservationsSourcePty")]
    public class DomainOsNvRamSourceReservationsSourcePty : libvirt.Domain.IDomainOsNvRamSourceReservationsSourcePty
    {
