...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesRedirDevsAlias), fullyQualifiedName: "libvirt.domain.DomainDevicesRedirDevsAlias")]
    public interface IDomainDevicesRedirDevsAlias
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesRedirDevsAlias), fullyQualifiedName: "libvirt.domain.DomainDevicesRedirDevsAlias")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesRedirDevsAlias
        {
