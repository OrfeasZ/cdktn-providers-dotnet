...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesTpmsBackendExternalSourceUdp")]
    public class DomainDevicesTpmsBackendExternalSourceUdp : libvirt.Domain.IDomainDevicesTpmsBackendExternalSourceUdp
    {
