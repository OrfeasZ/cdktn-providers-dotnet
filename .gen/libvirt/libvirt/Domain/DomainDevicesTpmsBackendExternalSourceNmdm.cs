...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesTpmsBackendExternalSourceNmdm")]
    public class DomainDevicesTpmsBackendExternalSourceNmdm : libvirt.Domain.IDomainDevicesTpmsBackendExternalSourceNmdm
    {
