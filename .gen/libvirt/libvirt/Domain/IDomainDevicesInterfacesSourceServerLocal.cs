...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesInterfacesSourceServerLocal), fullyQualifiedName: "libvirt.domain.DomainDevicesInterfacesSourceServerLocal")]
    public interface IDomainDevicesInterfacesSourceServerLocal
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesInterfacesSourceServerLocal), fullyQualifiedName: "libvirt.domain.DomainDevicesInterfacesSourceServerLocal")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesInterfacesSourceServerLocal
        {
