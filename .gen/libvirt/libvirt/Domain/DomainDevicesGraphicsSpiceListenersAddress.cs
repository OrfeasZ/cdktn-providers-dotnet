...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesGraphicsSpiceListenersAddress")]
    public class DomainDevicesGraphicsSpiceListenersAddress : libvirt.Domain.IDomainDevicesGraphicsSpiceListenersAddress
    {
