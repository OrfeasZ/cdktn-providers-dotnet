...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesParallelsSourceFileSecLabel")]
    public class DomainDevicesParallelsSourceFileSecLabel : libvirt.Domain.IDomainDevicesParallelsSourceFileSecLabel
    {
