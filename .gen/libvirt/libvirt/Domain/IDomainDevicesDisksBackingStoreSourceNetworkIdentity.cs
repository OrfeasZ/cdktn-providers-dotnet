...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksBackingStoreSourceNetworkIdentity), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackingStoreSourceNetworkIdentity")]
    public interface IDomainDevicesDisksBackingStoreSourceNetworkIdentity
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksBackingStoreSourceNetworkIdentity), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackingStoreSourceNetworkIdentity")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksBackingStoreSourceNetworkIdentity
        {
