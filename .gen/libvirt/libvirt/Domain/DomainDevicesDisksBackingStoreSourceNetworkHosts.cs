...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksBackingStoreSourceNetworkHosts")]
    public class DomainDevicesDisksBackingStoreSourceNetworkHosts : libvirt.Domain.IDomainDevicesDisksBackingStoreSourceNetworkHosts
    {
