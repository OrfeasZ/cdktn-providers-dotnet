...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksBackingStoreSourceSsl")]
    public class DomainDevicesDisksBackingStoreSourceSsl : libvirt.Domain.IDomainDevicesDisksBackingStoreSourceSsl
    {
