...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesRedirDevsSourceFileSecLabel")]
    public class DomainDevicesRedirDevsSourceFileSecLabel : libvirt.Domain.IDomainDevicesRedirDevsSourceFileSecLabel
    {
