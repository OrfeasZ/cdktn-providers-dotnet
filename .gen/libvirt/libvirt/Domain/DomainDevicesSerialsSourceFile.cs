...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesSerialsSourceFile")]
    public class DomainDevicesSerialsSourceFile : libvirt.Domain.IDomainDevicesSerialsSourceFile
    {
