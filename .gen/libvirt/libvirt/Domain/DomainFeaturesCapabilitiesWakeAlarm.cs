...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainFeaturesCapabilitiesWakeAlarm")]
    public class DomainFeaturesCapabilitiesWakeAlarm : libvirt.Domain.IDomainFeaturesCapabilitiesWakeAlarm
    {
