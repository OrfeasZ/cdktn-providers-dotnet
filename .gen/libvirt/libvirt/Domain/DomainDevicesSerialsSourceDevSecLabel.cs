...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesSerialsSourceDevSecLabel")]
    public class DomainDevicesSerialsSourceDevSecLabel : libvirt.Domain.IDomainDevicesSerialsSourceDevSecLabel
    {
