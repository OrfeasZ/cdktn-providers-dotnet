...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesSmartcardsPassthroughPipe), fullyQualifiedName: "libvirt.domain.DomainDevicesSmartcardsPassthroughPipe")]
    public interface IDomainDevicesSmartcardsPassthroughPipe
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesSmartcardsPassthroughPipe), fullyQualifiedName: "libvirt.domain.DomainDevicesSmartcardsPassthroughPipe")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesSmartcardsPassthroughPipe
        {
