...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainOsNvRamSourceVhostUserTcpReconnect")]
    public class DomainOsNvRamSourceVhostUserTcpReconnect : libvirt.Domain.IDomainOsNvRamSourceVhostUserTcpReconnect
    {
