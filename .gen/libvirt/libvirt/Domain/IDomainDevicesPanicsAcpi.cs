...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesPanicsAcpi), fullyQualifiedName: "libvirt.domain.DomainDevicesPanicsAcpi")]
    public interface IDomainDevicesPanicsAcpi
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesPanicsAcpi), fullyQualifiedName: "libvirt.domain.DomainDevicesPanicsAcpi")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesPanicsAcpi
        {
