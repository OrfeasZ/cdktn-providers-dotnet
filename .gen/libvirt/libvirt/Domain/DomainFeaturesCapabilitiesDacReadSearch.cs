...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainFeaturesCapabilitiesDacReadSearch")]
    public class DomainFeaturesCapabilitiesDacReadSearch : libvirt.Domain.IDomainFeaturesCapabilitiesDacReadSearch
    {
