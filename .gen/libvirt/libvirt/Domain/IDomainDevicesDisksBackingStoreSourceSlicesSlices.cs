...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksBackingStoreSourceSlicesSlices), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackingStoreSourceSlicesSlices")]
    public interface IDomainDevicesDisksBackingStoreSourceSlicesSlices
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksBackingStoreSourceSlicesSlices), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksBackingStoreSourceSlicesSlices")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksBackingStoreSourceSlicesSlices
        {
