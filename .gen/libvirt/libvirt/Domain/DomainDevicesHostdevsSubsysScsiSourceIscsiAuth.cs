...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesHostdevsSubsysScsiSourceIscsiAuth")]
    public class DomainDevicesHostdevsSubsysScsiSourceIscsiAuth : libvirt.Domain.IDomainDevicesHostdevsSubsysScsiSourceIscsiAuth
    {
