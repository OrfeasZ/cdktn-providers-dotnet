...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesVideosAlias), fullyQualifiedName: "libvirt.domain.DomainDevicesVideosAlias")]
    public interface IDomainDevicesVideosAlias
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesVideosAlias), fullyQualifiedName: "libvirt.domain.DomainDevicesVideosAlias")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesVideosAlias
        {
