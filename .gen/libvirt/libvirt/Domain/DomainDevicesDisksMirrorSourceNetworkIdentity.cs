...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksMirrorSourceNetworkIdentity")]
    public class DomainDevicesDisksMirrorSourceNetworkIdentity : libvirt.Domain.IDomainDevicesDisksMirrorSourceNetworkIdentity
    {
