...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesSmartcardsPassthroughNmdm), fullyQualifiedName: "libvirt.domain.DomainDevicesSmartcardsPassthroughNmdm")]
    public interface IDomainDevicesSmartcardsPassthroughNmdm
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesSmartcardsPassthroughNmdm), fullyQualifiedName: "libvirt.domain.DomainDevicesSmartcardsPassthroughNmdm")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesSmartcardsPassthroughNmdm
        {
