...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesConsolesSourceFileSecLabel")]
    public class DomainDevicesConsolesSourceFileSecLabel : libvirt.Domain.IDomainDevicesConsolesSourceFileSecLabel
    {
