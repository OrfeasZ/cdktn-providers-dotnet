...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesHostdevsSubsysPciSourceAddress), fullyQualifiedName: "libvirt.domain.DomainDevicesHostdevsSubsysPciSourceAddress")]
    public interface IDomainDevicesHostdevsSubsysPciSourceAddress
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        libvirt.Domain.IDomainDevicesHostdevsSubsysPciSourceAddressZpci? Zpci
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesHostdevsSubsysPciSourceAddress), fullyQualifiedName: "libvirt.domain.DomainDevicesHostdevsSubsysPciSourceAddress")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesHostdevsSubsysPciSourceAddress
        {
            ...
            {
                get => GetInstanceProperty<libvirt.Domain.IDomainDevicesHostdevsSubsysPciSourceAddressZpci?>();
            }
        }
    }
}
