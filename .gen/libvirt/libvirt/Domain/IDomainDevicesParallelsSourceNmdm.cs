...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesParallelsSourceNmdm), fullyQualifiedName: "libvirt.domain.DomainDevicesParallelsSourceNmdm")]
    public interface IDomainDevicesParallelsSourceNmdm
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesParallelsSourceNmdm), fullyQualifiedName: "libvirt.domain.DomainDevicesParallelsSourceNmdm")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesParallelsSourceNmdm
        {
