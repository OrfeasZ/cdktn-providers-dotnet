...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksMirrorSourceVhostUserPipeSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceVhostUserPipeSecLabel")]
    public interface IDomainDevicesDisksMirrorSourceVhostUserPipeSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksMirrorSourceVhostUserPipeSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceVhostUserPipeSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksMirrorSourceVhostUserPipeSecLabel
        {
