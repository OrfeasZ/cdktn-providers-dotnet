...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesConsolesSourceUnix), fullyQualifiedName: "libvirt.domain.DomainDevicesConsolesSourceUnix")]
    public interface IDomainDevicesConsolesSourceUnix
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "reconnect", typeJson: "{\"fqn\":\"libvirt.domain.DomainDevicesConsolesSourceUnixReconnect\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        libvirt.Domain.IDomainDevicesConsolesSourceUnixReconnect? Reconnect
        {
            get
            {
                return null;
        ...
        /// </remarks>
        [JsiiProperty(name: "secLabel", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"libvirt.domain.DomainDevicesConsolesSourceUnixSecLabel\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        object? SecLabel
        {
            get
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesConsolesSourceUnix), fullyQualifiedName: "libvirt.domain.DomainDevicesConsolesSourceUnix")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesConsolesSourceUnix
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "reconnect", typeJson: "{\"fqn\":\"libvirt.domain.DomainDevicesConsolesSourceUnixReconnect\"}", isOptional: true)]
            public libvirt.Domain.IDomainDevicesConsolesSourceUnixReconnect? Reconnect
            {
                get => GetInstanceProperty<libvirt.Domain.IDomainDevicesConsolesSourceUnixReconnect?>();
            }
