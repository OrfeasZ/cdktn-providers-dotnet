...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksMirrorBackingStoreSourceVolumeSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorBackingStoreSourceVolumeSecLabel")]
    public interface IDomainDevicesDisksMirrorBackingStoreSourceVolumeSecLabel
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksMirrorBackingStoreSourceVolumeSecLabel), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorBackingStoreSourceVolumeSecLabel")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksMirrorBackingStoreSourceVolumeSecLabel
        {
