...
{
    [JsiiInterface(nativeType: typeof(IDomainFeaturesCapabilitiesSysPAcct), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesSysPAcct")]
    public interface IDomainFeaturesCapabilitiesSysPAcct
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainFeaturesCapabilitiesSysPAcct), fullyQualifiedName: "libvirt.domain.DomainFeaturesCapabilitiesSysPAcct")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainFeaturesCapabilitiesSysPAcct
        {
