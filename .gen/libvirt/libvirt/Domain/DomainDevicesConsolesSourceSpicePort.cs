...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesConsolesSourceSpicePort")]
    public class DomainDevicesConsolesSourceSpicePort : libvirt.Domain.IDomainDevicesConsolesSourceSpicePort
    {
