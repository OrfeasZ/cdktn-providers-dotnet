...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksMirrorSourceVhostUserTcpReconnect), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceVhostUserTcpReconnect")]
    public interface IDomainDevicesDisksMirrorSourceVhostUserTcpReconnect
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksMirrorSourceVhostUserTcpReconnect), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksMirrorSourceVhostUserTcpReconnect")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksMirrorSourceVhostUserTcpReconnect
        {
