...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksMirrorBackingStoreSourceFile")]
    public class DomainDevicesDisksMirrorBackingStoreSourceFile : libvirt.Domain.IDomainDevicesDisksMirrorBackingStoreSourceFile
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "secLabel", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"libvirt.domain.DomainDevicesDisksMirrorBackingStoreSourceFileSecLabel\"},\"kind\":\"array\"}}]}}", isOptional: true)]
