...
{
    [JsiiInterface(nativeType: typeof(IDomainOsNvRamSourceVhostUserUnix), fullyQualifiedName: "libvirt.domain.DomainOsNvRamSourceVhostUserUnix")]
    public interface IDomainOsNvRamSourceVhostUserUnix
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "reconnect", typeJson: "{\"fqn\":\"libvirt.domain.DomainOsNvRamSourceVhostUserUnixReconnect\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        libvirt.Domain.IDomainOsNvRamSourceVhostUserUnixReconnect? Reconnect
        {
            get
            {
                return null;
        ...
        /// </remarks>
        [JsiiProperty(name: "secLabel", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"libvirt.domain.DomainOsNvRamSourceVhostUserUnixSecLabel\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        object? SecLabel
        {
            get
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainOsNvRamSourceVhostUserUnix), fullyQualifiedName: "libvirt.domain.DomainOsNvRamSourceVhostUserUnix")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainOsNvRamSourceVhostUserUnix
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "reconnect", typeJson: "{\"fqn\":\"libvirt.domain.DomainOsNvRamSourceVhostUserUnixReconnect\"}", isOptional: true)]
            public libvirt.Domain.IDomainOsNvRamSourceVhostUserUnixReconnect? Reconnect
            {
                get => GetInstanceProperty<libvirt.Domain.IDomainOsNvRamSourceVhostUserUnixReconnect?>();
            }
