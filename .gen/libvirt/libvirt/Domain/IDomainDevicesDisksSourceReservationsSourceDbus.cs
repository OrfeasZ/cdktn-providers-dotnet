...
{
    [JsiiInterface(nativeType: typeof(IDomainDevicesDisksSourceReservationsSourceDbus), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceReservationsSourceDbus")]
    public interface IDomainDevicesDisksSourceReservationsSourceDbus
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainDevicesDisksSourceReservationsSourceDbus), fullyQualifiedName: "libvirt.domain.DomainDevicesDisksSourceReservationsSourceDbus")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainDevicesDisksSourceReservationsSourceDbus
        {
