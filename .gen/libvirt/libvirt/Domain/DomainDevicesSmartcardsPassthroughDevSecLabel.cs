...
{
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesSmartcardsPassthroughDevSecLabel")]
    public class DomainDevicesSmartcardsPassthroughDevSecLabel : libvirt.Domain.IDomainDevicesSmartcardsPassthroughDevSecLabel
    {
