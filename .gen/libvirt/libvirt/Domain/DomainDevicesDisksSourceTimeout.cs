...
namespace libvirt.Domain
{
    ...
    [JsiiByValue(fqn: "libvirt.domain.DomainDevicesDisksSourceTimeout")]
    public class DomainDevicesDisksSourceTimeout : libvirt.Domain.IDomainDevicesDisksSourceTimeout
    {
