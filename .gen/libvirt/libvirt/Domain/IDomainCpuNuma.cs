...
{
    [JsiiInterface(nativeType: typeof(IDomainCpuNuma), fullyQualifiedName: "libvirt.domain.DomainCpuNuma")]
    public interface IDomainCpuNuma
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        libvirt.Domain.IDomainCpuNumaInterconnects? Interconnects
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IDomainCpuNuma), fullyQualifiedName: "libvirt.domain.DomainCpuNuma")]
        internal sealed class _Proxy : DeputyBase, libvirt.Domain.IDomainCpuNuma
        {
            ...
            {
                get => GetInstanceProperty<libvirt.Domain.IDomainCpuNumaInterconnects?>();
            }
        }
    }
}
