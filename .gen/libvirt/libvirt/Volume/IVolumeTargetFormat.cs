...
{
    [JsiiInterface(nativeType: typeof(IVolumeTargetFormat), fullyQualifiedName: "libvirt.volume.VolumeTargetFormat")]
    public interface IVolumeTargetFormat
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IVolumeTargetFormat), fullyQualifiedName: "libvirt.volume.VolumeTargetFormat")]
        internal sealed class _Proxy : DeputyBase, libvirt.Volume.IVolumeTargetFormat
        {
