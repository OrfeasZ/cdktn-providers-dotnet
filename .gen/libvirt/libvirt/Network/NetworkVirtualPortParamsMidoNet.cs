...
{
    [JsiiByValue(fqn: "libvirt.network.NetworkVirtualPortParamsMidoNet")]
    public class NetworkVirtualPortParamsMidoNet : libvirt.Network.INetworkVirtualPortParamsMidoNet
    {
