...
{
    [JsiiByValue(fqn: "libvirt.network.NetworkPortGroupsVirtualPortParamsAny")]
    public class NetworkPortGroupsVirtualPortParamsAny : libvirt.Network.INetworkPortGroupsVirtualPortParamsAny
    {
