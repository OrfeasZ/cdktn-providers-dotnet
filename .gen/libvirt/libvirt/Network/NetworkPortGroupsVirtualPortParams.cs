...
{
    [JsiiByValue(fqn: "libvirt.network.NetworkPortGroupsVirtualPortParams")]
    public class NetworkPortGroupsVirtualPortParams : libvirt.Network.INetworkPortGroupsVirtualPortParams
    {
