...
{
    [JsiiByValue(fqn: "libvirt.network.NetworkVirtualPortParamsOpenVSwitch")]
    public class NetworkVirtualPortParamsOpenVSwitch : libvirt.Network.INetworkVirtualPortParamsOpenVSwitch
    {
