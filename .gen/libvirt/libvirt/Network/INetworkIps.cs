...
{
    [JsiiInterface(nativeType: typeof(INetworkIps), fullyQualifiedName: "libvirt.network.NetworkIps")]
    public interface INetworkIps
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        libvirt.Network.INetworkIpsDhcp? Dhcp
        {
            get
            {
                return null;
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        libvirt.Network.INetworkIpsTftp? Tftp
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(INetworkIps), fullyQualifiedName: "libvirt.network.NetworkIps")]
        internal sealed class _Proxy : DeputyBase, libvirt.Network.INetworkIps
        {
            ...
            {
                get => GetInstanceProperty<libvirt.Network.INetworkIpsDhcp?>();
            }
            ...
            {
                get => GetInstanceProperty<libvirt.Network.INetworkIpsTftp?>();
            }
        }
    }
}
