...
{
    [JsiiInterface(nativeType: typeof(INetworkVirtualPortParamsOpenVSwitch), fullyQualifiedName: "libvirt.network.NetworkVirtualPortParamsOpenVSwitch")]
    public interface INetworkVirtualPortParamsOpenVSwitch
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(INetworkVirtualPortParamsOpenVSwitch), fullyQualifiedName: "libvirt.network.NetworkVirtualPortParamsOpenVSwitch")]
        internal sealed class _Proxy : DeputyBase, libvirt.Network.INetworkVirtualPortParamsOpenVSwitch
        {
