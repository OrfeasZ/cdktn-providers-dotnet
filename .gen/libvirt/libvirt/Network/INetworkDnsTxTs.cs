...
{
    [JsiiInterface(nativeType: typeof(INetworkDnsTxTs), fullyQualifiedName: "libvirt.network.NetworkDnsTxTs")]
    public interface INetworkDnsTxTs
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(INetworkDnsTxTs), fullyQualifiedName: "libvirt.network.NetworkDnsTxTs")]
        internal sealed class _Proxy : DeputyBase, libvirt.Network.INetworkDnsTxTs
        {
