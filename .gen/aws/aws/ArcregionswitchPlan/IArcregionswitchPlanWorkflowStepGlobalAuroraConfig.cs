...
{
    [JsiiInterface(nativeType: typeof(IArcregionswitchPlanWorkflowStepGlobalAuroraConfig), fullyQualifiedName: "aws.arcregionswitchPlan.ArcregionswitchPlanWorkflowStepGlobalAuroraConfig")]
    public interface IArcregionswitchPlanWorkflowStepGlobalAuroraConfig
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "ungraceful", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.arcregionswitchPlan.ArcregionswitchPlanWorkflowStepGlobalAuroraConfigUngraceful\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        object? Ungraceful
        {
            get
        ...
        [JsiiTypeProxy(nativeType: typeof(IArcregionswitchPlanWorkflowStepGlobalAuroraConfig), fullyQualifiedName: "aws.arcregionswitchPlan.ArcregionswitchPlanWorkflowStepGlobalAuroraConfig")]
        internal sealed class _Proxy : DeputyBase, aws.ArcregionswitchPlan.IArcregionswitchPlanWorkflowStepGlobalAuroraConfig
        {
