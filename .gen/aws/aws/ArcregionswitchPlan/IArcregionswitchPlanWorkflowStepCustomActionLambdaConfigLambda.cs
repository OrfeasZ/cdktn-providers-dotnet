...
{
    [JsiiInterface(nativeType: typeof(IArcregionswitchPlanWorkflowStepCustomActionLambdaConfigLambda), fullyQualifiedName: "aws.arcregionswitchPlan.ArcregionswitchPlanWorkflowStepCustomActionLambdaConfigLambda")]
    public interface IArcregionswitchPlanWorkflowStepCustomActionLambdaConfigLambda
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IArcregionswitchPlanWorkflowStepCustomActionLambdaConfigLambda), fullyQualifiedName: "aws.arcregionswitchPlan.ArcregionswitchPlanWorkflowStepCustomActionLambdaConfigLambda")]
        internal sealed class _Proxy : DeputyBase, aws.ArcregionswitchPlan.IArcregionswitchPlanWorkflowStepCustomActionLambdaConfigLambda
        {
