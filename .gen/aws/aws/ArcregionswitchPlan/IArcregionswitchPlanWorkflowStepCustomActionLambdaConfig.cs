...
{
    [JsiiInterface(nativeType: typeof(IArcregionswitchPlanWorkflowStepCustomActionLambdaConfig), fullyQualifiedName: "aws.arcregionswitchPlan.ArcregionswitchPlanWorkflowStepCustomActionLambdaConfig")]
    public interface IArcregionswitchPlanWorkflowStepCustomActionLambdaConfig
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IArcregionswitchPlanWorkflowStepCustomActionLambdaConfig), fullyQualifiedName: "aws.arcregionswitchPlan.ArcregionswitchPlanWorkflowStepCustomActionLambdaConfig")]
        internal sealed class _Proxy : DeputyBase, aws.ArcregionswitchPlan.IArcregionswitchPlanWorkflowStepCustomActionLambdaConfig
        {
