...
{
    [JsiiInterface(nativeType: typeof(IArcregionswitchPlanWorkflowStepRegionSwitchPlanConfig), fullyQualifiedName: "aws.arcregionswitchPlan.ArcregionswitchPlanWorkflowStepRegionSwitchPlanConfig")]
    public interface IArcregionswitchPlanWorkflowStepRegionSwitchPlanConfig
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IArcregionswitchPlanWorkflowStepRegionSwitchPlanConfig), fullyQualifiedName: "aws.arcregionswitchPlan.ArcregionswitchPlanWorkflowStepRegionSwitchPlanConfig")]
        internal sealed class _Proxy : DeputyBase, aws.ArcregionswitchPlan.IArcregionswitchPlanWorkflowStepRegionSwitchPlanConfig
        {
