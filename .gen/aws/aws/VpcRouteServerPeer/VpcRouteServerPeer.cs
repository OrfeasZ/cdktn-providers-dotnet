...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.41.0/docs/resources/vpc_route_server_peer aws_vpc_route_server_peer}.</summary>
    ...
    public class VpcRouteServerPeer : Io.Cdktn.TerraformResource
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.41.0/docs/resources/vpc_route_server_peer aws_vpc_route_server_peer} Resource.</summary>
        ...
        /// <summary>Generates CDKTN code for importing a VpcRouteServerPeer resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
            ...
            if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
            {
                switch (@value)
                {
                    ...
                    case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_2ed7d7:
                        ...
                        break;
                    case null:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.VpcRouteServerPeer.IVpcRouteServerPeerBgpOptions).FullName}[]; received null", nameof(@value));
                    default:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.VpcRouteServerPeer.IVpcRouteServerPeerBgpOptions).FullName}[]; received {@value.GetType().FullName}", nameof(@value));
                }
            }
