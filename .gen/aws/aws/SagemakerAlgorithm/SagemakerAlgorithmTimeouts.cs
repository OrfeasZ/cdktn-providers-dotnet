...
{
    [JsiiByValue(fqn: "aws.sagemakerAlgorithm.SagemakerAlgorithmTimeouts")]
    public class SagemakerAlgorithmTimeouts : aws.SagemakerAlgorithm.ISagemakerAlgorithmTimeouts
    {
