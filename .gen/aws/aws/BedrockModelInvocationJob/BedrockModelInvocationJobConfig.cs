...
namespace aws.BedrockModelInvocationJob
{
    ...
    [JsiiByValue(fqn: "aws.bedrockModelInvocationJob.BedrockModelInvocationJobConfig")]
    public class BedrockModelInvocationJobConfig : aws.BedrockModelInvocationJob.IBedrockModelInvocationJobConfig
    {
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        case Io.Cdktn.IResolvable cast_cd4240:
                            break;
                        case aws.BedrockModelInvocationJob.IBedrockModelInvocationJobInputDataConfig[] cast_cd4240:
                            break;
                        ...
                        case null:
                            break;
                        default:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.BedrockModelInvocationJob.IBedrockModelInvocationJobInputDataConfig).FullName}[]; received {value.GetType().FullName}", nameof(value));
                    }
                }
