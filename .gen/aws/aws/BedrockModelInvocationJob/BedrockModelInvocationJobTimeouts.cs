...
{
    [JsiiByValue(fqn: "aws.bedrockModelInvocationJob.BedrockModelInvocationJobTimeouts")]
    public class BedrockModelInvocationJobTimeouts : aws.BedrockModelInvocationJob.IBedrockModelInvocationJobTimeouts
    {
