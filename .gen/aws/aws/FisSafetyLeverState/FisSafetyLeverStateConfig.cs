...
{
    [JsiiByValue(fqn: "aws.fisSafetyLeverState.FisSafetyLeverStateConfig")]
    public class FisSafetyLeverStateConfig : aws.FisSafetyLeverState.IFisSafetyLeverStateConfig
    {
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        case Io.Cdktn.IResolvable cast_cd4240:
                            break;
                        case aws.FisSafetyLeverState.IFisSafetyLeverStateState[] cast_cd4240:
                            break;
                        ...
                        case null:
                            break;
                        default:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.FisSafetyLeverState.IFisSafetyLeverStateState).FullName}[]; received {value.GetType().FullName}", nameof(value));
                    }
                }
                _state = value;
            }
