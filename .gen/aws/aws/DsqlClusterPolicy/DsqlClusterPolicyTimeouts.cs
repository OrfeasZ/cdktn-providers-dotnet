...
{
    [JsiiByValue(fqn: "aws.dsqlClusterPolicy.DsqlClusterPolicyTimeouts")]
    public class DsqlClusterPolicyTimeouts : aws.DsqlClusterPolicy.IDsqlClusterPolicyTimeouts
    {
