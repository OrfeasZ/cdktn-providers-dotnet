...
{
    [JsiiByValue(fqn: "aws.ebsFastSnapshotRestore.EbsFastSnapshotRestoreTimeouts")]
    public class EbsFastSnapshotRestoreTimeouts : aws.EbsFastSnapshotRestore.IEbsFastSnapshotRestoreTimeouts
    {
