...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.59.0/docs/data-sources/eks_cluster aws_eks_cluster}.</summary>
    ...
    public class DataAwsEksCluster : Io.Cdktn.TerraformDataSource
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.59.0/docs/data-sources/eks_cluster aws_eks_cluster} Data Source.</summary>
        ...
        /// <summary>Generates CDKTN code for importing a DataAwsEksCluster resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        ...
        [JsiiMethod(name: "generateConfigForImport", returnsJson: "{\"type\":{\"fqn\":\"cdktn.ImportableResource\"}}", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"summary\":\"The construct id used in the generated config for the DataAwsEksCluster to import.\"},\"name\":\"importToId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"remarks\":\"Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.59.0/docs/data-sources/eks_cluster#import import section} in the documentation of this resource for the id to use\",\"summary\":\"The id of the existing DataAwsEksCluster that should be imported.\"},\"name\":\"importFromId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"? Optional instance of the provider where the DataAwsEksCluster to import is found.\"},\"name\":\"provider\",\"optional\":true,\"type\":{\"fqn\":\"cdktn.TerraformProvider\"}}]")]
        public static Io.Cdktn.ImportableResource GenerateConfigForImport(Constructs.Construct scope, string importToId, string importFromId, Io.Cdktn.TerraformProvider? provider = null)
        {
            return InvokeStaticMethod<Io.Cdktn.ImportableResource>(typeof(aws.DataAwsEksCluster.DataAwsEksCluster), new System.Type[]{typeof(Constructs.Construct), typeof(string), typeof(string), typeof(Io.Cdktn.TerraformProvider)}, new object?[]{scope, importToId, importFromId, provider})!;
        }
        ...
        [JsiiProperty(name: "controlPlaneScalingConfig", typeJson: "{\"fqn\":\"aws.dataAwsEksCluster.DataAwsEksClusterControlPlaneScalingConfigList\"}")]
        public virtual aws.DataAwsEksCluster.DataAwsEksClusterControlPlaneScalingConfigList ControlPlaneScalingConfig
        {
            get => GetInstanceProperty<aws.DataAwsEksCluster.DataAwsEksClusterControlPlaneScalingConfigList>()!;
        }
        ...
        [JsiiProperty(name: "kubeApiServerConfig", typeJson: "{\"fqn\":\"aws.dataAwsEksCluster.DataAwsEksClusterKubeApiServerConfigList\"}")]
        public virtual aws.DataAwsEksCluster.DataAwsEksClusterKubeApiServerConfigList KubeApiServerConfig
        {
            get => GetInstanceProperty<aws.DataAwsEksCluster.DataAwsEksClusterKubeApiServerConfigList>()!;
        }

        [JsiiProperty(name: "kubeControllerManagerConfig", typeJson: "{\"fqn\":\"aws.dataAwsEksCluster.DataAwsEksClusterKubeControllerManagerConfigList\"}")]
        public virtual aws.DataAwsEksCluster.DataAwsEksClusterKubeControllerManagerConfigList KubeControllerManagerConfig
        {
            get => GetInstanceProperty<aws.DataAwsEksCluster.DataAwsEksClusterKubeControllerManagerConfigList>()!;
        }
        ...
        [JsiiProperty(name: "kubeSchedulerConfig", typeJson: "{\"fqn\":\"aws.dataAwsEksCluster.DataAwsEksClusterKubeSchedulerConfigList\"}")]
        public virtual aws.DataAwsEksCluster.DataAwsEksClusterKubeSchedulerConfigList KubeSchedulerConfig
        {
            get => GetInstanceProperty<aws.DataAwsEksCluster.DataAwsEksClusterKubeSchedulerConfigList>()!;
        }
