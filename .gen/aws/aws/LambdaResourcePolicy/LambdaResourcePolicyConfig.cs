...
namespace aws.LambdaResourcePolicy
{
    ...
    [JsiiByValue(fqn: "aws.lambdaResourcePolicy.LambdaResourcePolicyConfig")]
    public class LambdaResourcePolicyConfig : aws.LambdaResourcePolicy.ILambdaResourcePolicyConfig
    {
