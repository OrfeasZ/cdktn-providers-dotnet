...
{
    [JsiiInterface(nativeType: typeof(ILambdaResourcePolicyConfig), fullyQualifiedName: "aws.lambdaResourcePolicy.LambdaResourcePolicyConfig")]
    public interface ILambdaResourcePolicyConfig : Io.Cdktn.ITerraformMetaArguments
    {
        /// <summary>JSON-formatted resource-based policy document to attach to the Lambda resource.</summary>
        /// <remarks>
        ...
        [JsiiTypeProxy(nativeType: typeof(ILambdaResourcePolicyConfig), fullyQualifiedName: "aws.lambdaResourcePolicy.LambdaResourcePolicyConfig")]
        internal sealed class _Proxy : DeputyBase, aws.LambdaResourcePolicy.ILambdaResourcePolicyConfig
        {
