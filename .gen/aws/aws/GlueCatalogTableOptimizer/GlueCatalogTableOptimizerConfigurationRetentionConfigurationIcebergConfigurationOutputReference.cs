...
namespace aws.GlueCatalogTableOptimizer
{
    ...
    public class GlueCatalogTableOptimizerConfigurationRetentionConfigurationIcebergConfigurationOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        [JsiiMethod(name: "resetRunRateInHours")]
        public virtual void ResetRunRateInHours()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "cleanExpiredFilesInput", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktn.IResolvable\"}]}}", isOptional: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "runRateInHoursInput", typeJson: "{\"primitive\":\"number\"}", isOptional: true)]
        public virtual double? RunRateInHoursInput
        {
            get => GetInstanceProperty<double?>();
        }
        ...
        [JsiiProperty(name: "cleanExpiredFiles", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktn.IResolvable\"}]}}")]
        ...
        [JsiiProperty(name: "runRateInHours", typeJson: "{\"primitive\":\"number\"}")]
        public virtual double RunRateInHours
        {
            get => GetInstanceProperty<double>()!;
            set => SetInstanceProperty(value);
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"aws.glueCatalogTableOptimizer.GlueCatalogTableOptimizerConfigurationRetentionConfigurationIcebergConfiguration\"}]}}", isOptional: true)]
