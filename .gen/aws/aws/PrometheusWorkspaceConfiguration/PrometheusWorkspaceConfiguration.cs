...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.59.0/docs/resources/prometheus_workspace_configuration aws_prometheus_workspace_configuration}.</summary>
    ...
    public class PrometheusWorkspaceConfiguration : Io.Cdktn.TerraformResource
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.59.0/docs/resources/prometheus_workspace_configuration aws_prometheus_workspace_configuration} Resource.</summary>
        ...
        /// <summary>Generates CDKTN code for importing a PrometheusWorkspaceConfiguration resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
            ...
            if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
            {
                switch (@value)
                {
                    ...
                    case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_2ed7d7:
                        ...
                        break;
                    case null:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.PrometheusWorkspaceConfiguration.IPrometheusWorkspaceConfigurationLimitsPerLabelSet).FullName}[]; received null", nameof(@value));
                    default:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.PrometheusWorkspaceConfiguration.IPrometheusWorkspaceConfigurationLimitsPerLabelSet).FullName}[]; received {@value.GetType().FullName}", nameof(@value));
                }
            }
        ...
        [JsiiMethod(name: "resetOutOfOrderTimeWindowInSeconds")]
        public virtual void ResetOutOfOrderTimeWindowInSeconds()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        [JsiiMethod(name: "resetRuleQueryOffsetInSeconds")]
        public virtual void ResetRuleQueryOffsetInSeconds()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "outOfOrderTimeWindowInSecondsInput", typeJson: "{\"primitive\":\"number\"}", isOptional: true)]
        public virtual double? OutOfOrderTimeWindowInSecondsInput
        {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "ruleQueryOffsetInSecondsInput", typeJson: "{\"primitive\":\"number\"}", isOptional: true)]
        public virtual double? RuleQueryOffsetInSecondsInput
        {
            get => GetInstanceProperty<double?>();
        }
        ...
        [JsiiProperty(name: "outOfOrderTimeWindowInSeconds", typeJson: "{\"primitive\":\"number\"}")]
        public virtual double OutOfOrderTimeWindowInSeconds
        {
            get => GetInstanceProperty<double>()!;
        ...
        [JsiiProperty(name: "ruleQueryOffsetInSeconds", typeJson: "{\"primitive\":\"number\"}")]
        public virtual double RuleQueryOffsetInSeconds
        {
            get => GetInstanceProperty<double>()!;
            set => SetInstanceProperty(value);
        }
