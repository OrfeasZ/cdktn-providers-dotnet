...
namespace aws.PrometheusWorkspaceConfiguration
{
    ...
    public class PrometheusWorkspaceConfigurationLimitsPerLabelSetLimitsOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"aws.prometheusWorkspaceConfiguration.PrometheusWorkspaceConfigurationLimitsPerLabelSetLimits\"}]}}", isOptional: true)]
