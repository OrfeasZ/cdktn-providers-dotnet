...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.41.0/docs/resources/dynamodb_table aws_dynamodb_table}.</summary>
    ...
    public class DynamodbTable : Io.Cdktn.TerraformResource
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.41.0/docs/resources/dynamodb_table aws_dynamodb_table} Resource.</summary>
        ...
        /// <summary>Generates CDKTN code for importing a DynamodbTable resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
            ...
            if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
            {
                switch (@value)
                {
                    ...
                    case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_2ed7d7:
                        ...
                        break;
                    case null:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.DynamodbTable.IDynamodbTableAttribute).FullName}[]; received null", nameof(@value));
                    default:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.DynamodbTable.IDynamodbTableAttribute).FullName}[]; received {@value.GetType().FullName}", nameof(@value));
                }
            }
            ...
            if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
            {
                switch (@value)
                {
                    ...
                    case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_2ed7d7:
                        ...
                        break;
                    case null:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.DynamodbTable.IDynamodbTableGlobalSecondaryIndex).FullName}[]; received null", nameof(@value));
                    default:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.DynamodbTable.IDynamodbTableGlobalSecondaryIndex).FullName}[]; received {@value.GetType().FullName}", nameof(@value));
                }
            }
            InvokeInstanceVoidMethod(new System.Type[]{typeof(object)}, new object[]{@value});
        }

        [JsiiMethod(name: "putGlobalTableWitness", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"aws.dynamodbTable.DynamodbTableGlobalTableWitness\"}}]")]
        public virtual void PutGlobalTableWitness(aws.DynamodbTable.IDynamodbTableGlobalTableWitness @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(aws.DynamodbTable.IDynamodbTableGlobalTableWitness)}, new object[]{@value});
        }
            ...
            if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
            {
                switch (@value)
                {
                    ...
                    case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_2ed7d7:
                        ...
                        break;
                    case null:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.DynamodbTable.IDynamodbTableLocalSecondaryIndex).FullName}[]; received null", nameof(@value));
                    default:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.DynamodbTable.IDynamodbTableLocalSecondaryIndex).FullName}[]; received {@value.GetType().FullName}", nameof(@value));
                }
            }
            InvokeInstanceVoidMethod(new System.Type[]{typeof(object)}, new object[]{@value});
        }
            ...
            if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
            {
                switch (@value)
                {
                    ...
                    case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_2ed7d7:
                        ...
                        break;
                    case null:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.DynamodbTable.IDynamodbTableReplica).FullName}[]; received null", nameof(@value));
                    default:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.DynamodbTable.IDynamodbTableReplica).FullName}[]; received {@value.GetType().FullName}", nameof(@value));
                }
            }
            InvokeInstanceVoidMethod(new System.Type[]{typeof(object)}, new object[]{@value});
        }
        ...
        [JsiiMethod(name: "putWarmThroughput", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"aws.dynamodbTable.DynamodbTableWarmThroughput\"}}]")]
        public virtual void PutWarmThroughput(aws.DynamodbTable.IDynamodbTableWarmThroughput @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(aws.DynamodbTable.IDynamodbTableWarmThroughput)}, new object[]{@value});
        }
        ...
        [JsiiMethod(name: "resetGlobalTableWitness")]
        public virtual void ResetGlobalTableWitness()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        [JsiiMethod(name: "resetRestoreBackupArn")]
        public virtual void ResetRestoreBackupArn()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        [JsiiProperty(name: "globalTableWitness", typeJson: "{\"fqn\":\"aws.dynamodbTable.DynamodbTableGlobalTableWitnessOutputReference\"}")]
        public virtual aws.DynamodbTable.DynamodbTableGlobalTableWitnessOutputReference GlobalTableWitness
        {
            get => GetInstanceProperty<aws.DynamodbTable.DynamodbTableGlobalTableWitnessOutputReference>()!;
        }
        ...
        [JsiiProperty(name: "warmThroughput", typeJson: "{\"fqn\":\"aws.dynamodbTable.DynamodbTableWarmThroughputOutputReference\"}")]
        public virtual aws.DynamodbTable.DynamodbTableWarmThroughputOutputReference WarmThroughput
        {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "globalTableWitnessInput", typeJson: "{\"fqn\":\"aws.dynamodbTable.DynamodbTableGlobalTableWitness\"}", isOptional: true)]
        public virtual aws.DynamodbTable.IDynamodbTableGlobalTableWitness? GlobalTableWitnessInput
        {
            get => GetInstanceProperty<aws.DynamodbTable.IDynamodbTableGlobalTableWitness?>();
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "restoreBackupArnInput", typeJson: "{\"primitive\":\"string\"}", isOptional: true)]
        public virtual string? RestoreBackupArnInput
        {
            get => GetInstanceProperty<string?>();
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "warmThroughputInput", typeJson: "{\"fqn\":\"aws.dynamodbTable.DynamodbTableWarmThroughput\"}", isOptional: true)]
        public virtual aws.DynamodbTable.IDynamodbTableWarmThroughput? WarmThroughputInput
        {
        ...
        [JsiiProperty(name: "restoreBackupArn", typeJson: "{\"primitive\":\"string\"}")]
        public virtual string RestoreBackupArn
        {
            get => GetInstanceProperty<string>()!;
            set => SetInstanceProperty(value);
        }
