...
namespace aws.DynamodbTable
{
    ...
    public interface IDynamodbTableConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.DynamodbTable.IDynamodbTableGlobalTableWitness? GlobalTableWitness
        {
            get
            {
                return null;
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.DynamodbTable.IDynamodbTableWarmThroughput? WarmThroughput
        {
            get
            {
                return null;
