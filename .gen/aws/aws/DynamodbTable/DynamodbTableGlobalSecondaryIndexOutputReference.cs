...
{
    [JsiiClass(nativeType: typeof(aws.DynamodbTable.DynamodbTableGlobalSecondaryIndexOutputReference), fullyQualifiedName: "aws.dynamodbTable.DynamodbTableGlobalSecondaryIndexOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktn.IInterpolatingParent\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"the index of this item in the list.\"},\"name\":\"complexObjectIndex\",\"type\":{\"primitive\":\"number\"}},{\"docs\":{\"summary\":\"whether the list is wrapping a set (will add tolist() to be able to access an item via an index).\"},\"name\":\"complexObjectIsFromSet\",\"type\":{\"primitive\":\"boolean\"}}]")]
    public class DynamodbTableGlobalSecondaryIndexOutputReference : Io.Cdktn.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        /// <param name="complexObjectIndex">the index of this item in the list.</param>
        /// <param name="complexObjectIsFromSet">whether the list is wrapping a set (will add tolist() to be able to access an item via an index).</param>
        public DynamodbTableGlobalSecondaryIndexOutputReference(Io.Cdktn.IInterpolatingParent terraformResource, string terraformAttribute, double complexObjectIndex, bool complexObjectIsFromSet): base(_MakeDeputyProps(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet))
        {
        }
            ...
            if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
            {
                switch (@value)
                {
                    case Io.Cdktn.IResolvable cast_2ed7d7:
                        break;
                    case aws.DynamodbTable.IDynamodbTableGlobalSecondaryIndexKeySchema[] cast_2ed7d7:
                        break;
                    case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_2ed7d7:
                        // Not enough information to type-check...
                        break;
                    case null:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.DynamodbTable.IDynamodbTableGlobalSecondaryIndexKeySchema).FullName}[]; received null", nameof(@value));
                    default:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.DynamodbTable.IDynamodbTableGlobalSecondaryIndexKeySchema).FullName}[]; received {@value.GetType().FullName}", nameof(@value));
                }
            }
        ...
        [JsiiMethod(name: "putWarmThroughput", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"aws.dynamodbTable.DynamodbTableGlobalSecondaryIndexWarmThroughput\"}}]")]
        public virtual void PutWarmThroughput(aws.DynamodbTable.IDynamodbTableGlobalSecondaryIndexWarmThroughput @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(aws.DynamodbTable.IDynamodbTableGlobalSecondaryIndexWarmThroughput)}, new object[]{@value});
        }
        ...
        [JsiiProperty(name: "keySchema", typeJson: "{\"fqn\":\"aws.dynamodbTable.DynamodbTableGlobalSecondaryIndexKeySchemaList\"}")]
        public virtual aws.DynamodbTable.DynamodbTableGlobalSecondaryIndexKeySchemaList KeySchema
        {
            get => GetInstanceProperty<aws.DynamodbTable.DynamodbTableGlobalSecondaryIndexKeySchemaList>()!;
        }
        ...
        [JsiiProperty(name: "warmThroughput", typeJson: "{\"fqn\":\"aws.dynamodbTable.DynamodbTableGlobalSecondaryIndexWarmThroughputOutputReference\"}")]
        public virtual aws.DynamodbTable.DynamodbTableGlobalSecondaryIndexWarmThroughputOutputReference WarmThroughput
        {
            get => GetInstanceProperty<aws.DynamodbTable.DynamodbTableGlobalSecondaryIndexWarmThroughputOutputReference>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "warmThroughputInput", typeJson: "{\"fqn\":\"aws.dynamodbTable.DynamodbTableGlobalSecondaryIndexWarmThroughput\"}", isOptional: true)]
        public virtual aws.DynamodbTable.IDynamodbTableGlobalSecondaryIndexWarmThroughput? WarmThroughputInput
        {
            get => GetInstanceProperty<aws.DynamodbTable.IDynamodbTableGlobalSecondaryIndexWarmThroughput?>();
        }
