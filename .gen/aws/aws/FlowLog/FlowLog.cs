...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/flow_log aws_flow_log}.</summary>
    ...
    public class FlowLog : Io.Cdktn.TerraformResource
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/flow_log aws_flow_log} Resource.</summary>
        ...
        /// <summary>Generates CDKTN code for importing a FlowLog resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        ...
        [JsiiMethod(name: "generateConfigForImport", returnsJson: "{\"type\":{\"fqn\":\"cdktn.ImportableResource\"}}", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"summary\":\"The construct id used in the generated config for the FlowLog to import.\"},\"name\":\"importToId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"remarks\":\"Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/flow_log#import import section} in the documentation of this resource for the id to use\",\"summary\":\"The id of the existing FlowLog that should be imported.\"},\"name\":\"importFromId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"? Optional instance of the provider where the FlowLog to import is found.\"},\"name\":\"provider\",\"optional\":true,\"type\":{\"fqn\":\"cdktn.TerraformProvider\"}}]")]
        public static Io.Cdktn.ImportableResource GenerateConfigForImport(Constructs.Construct scope, string importToId, string importFromId, Io.Cdktn.TerraformProvider? provider = null)
        {
            return InvokeStaticMethod<Io.Cdktn.ImportableResource>(typeof(aws.FlowLog.FlowLog), new System.Type[]{typeof(Constructs.Construct), typeof(string), typeof(string), typeof(Io.Cdktn.TerraformProvider)}, new object?[]{scope, importToId, importFromId, provider})!;
        }
        ...
        /// <param name="value">Type union: either <see cref="Io.Cdktn.IResolvable" /> or (<see cref="aws.FlowLog.IFlowLogTagFieldSpecification" />)[]</param>
        [JsiiMethod(name: "putTagFieldSpecification", parametersJson: "[{\"name\":\"value\",\"type\":{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.flowLog.FlowLogTagFieldSpecification\"},\"kind\":\"array\"}}]}}}]")]
        public virtual void PutTagFieldSpecification(object @value)
        {
            if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
            {
                switch (@value)
                {
                    case Io.Cdktn.IResolvable cast_2ed7d7:
                        break;
                    case aws.FlowLog.IFlowLogTagFieldSpecification[] cast_2ed7d7:
                        break;
                    case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_2ed7d7:
                        // Not enough information to type-check...
                        break;
                    case null:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.FlowLog.IFlowLogTagFieldSpecification).FullName}[]; received null", nameof(@value));
                    default:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.FlowLog.IFlowLogTagFieldSpecification).FullName}[]; received {@value.GetType().FullName}", nameof(@value));
                }
            }
        ...
        [JsiiMethod(name: "resetRegionalNatGatewayId")]
        public virtual void ResetRegionalNatGatewayId()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        [JsiiMethod(name: "resetTagFieldSpecification")]
        public virtual void ResetTagFieldSpecification()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        [JsiiProperty(name: "tagFieldSpecification", typeJson: "{\"fqn\":\"aws.flowLog.FlowLogTagFieldSpecificationList\"}")]
        public virtual aws.FlowLog.FlowLogTagFieldSpecificationList TagFieldSpecification
        {
            get => GetInstanceProperty<aws.FlowLog.FlowLogTagFieldSpecificationList>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "regionalNatGatewayIdInput", typeJson: "{\"primitive\":\"string\"}", isOptional: true)]
        public virtual string? RegionalNatGatewayIdInput
        {
            get => GetInstanceProperty<string?>();
        }
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "tagFieldSpecificationInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.flowLog.FlowLogTagFieldSpecification\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        public virtual object? TagFieldSpecificationInput
        {
        ...
        [JsiiProperty(name: "regionalNatGatewayId", typeJson: "{\"primitive\":\"string\"}")]
        public virtual string RegionalNatGatewayId
        {
            get => GetInstanceProperty<string>()!;
            set => SetInstanceProperty(value);
        }
