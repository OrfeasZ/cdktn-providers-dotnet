...
namespace aws.EmrCluster
{
    ...
    public class EmrClusterCoreInstanceFleetLaunchSpecificationsSpotSpecificationOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"aws.emrCluster.EmrClusterCoreInstanceFleetLaunchSpecificationsSpotSpecification\"}]}}", isOptional: true)]
