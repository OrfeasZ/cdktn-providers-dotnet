...
namespace aws.Lexv2ModelsIntent
{
    ...
    public class Lexv2ModelsIntentClosingSetting : aws.Lexv2ModelsIntent.ILexv2ModelsIntentClosingSetting
    {
        ...
        /// <remarks>
        /// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.42.0/docs/resources/lexv2models_intent#closing_response Lexv2ModelsIntent#closing_response}
        /// </remarks>
        [JsiiOptional]
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case null:
                            break;
                        default:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.Lexv2ModelsIntent.ILexv2ModelsIntentClosingSettingConditional).FullName}[]; received {value.GetType().FullName}", nameof(value));
                    }
                }
                _conditional = value;
            }
