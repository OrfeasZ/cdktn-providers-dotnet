...
namespace aws.DataAwsBatchJobDefinition
{
    ...
    public class DataAwsBatchJobDefinitionEksPropertiesPodPropertiesOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        [JsiiProperty(name: "hostNetwork", typeJson: "{\"fqn\":\"cdktn.IResolvable\"}")]
        public virtual Io.Cdktn.IResolvable HostNetwork
        {
        ...
        [JsiiProperty(name: "shareProcessNamespace", typeJson: "{\"fqn\":\"cdktn.IResolvable\"}")]
        public virtual Io.Cdktn.IResolvable ShareProcessNamespace
        {
            get => GetInstanceProperty<Io.Cdktn.IResolvable>()!;
        }
