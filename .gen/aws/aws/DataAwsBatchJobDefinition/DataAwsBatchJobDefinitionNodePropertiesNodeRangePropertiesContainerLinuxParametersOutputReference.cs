...
namespace aws.DataAwsBatchJobDefinition
{
    ...
    public class DataAwsBatchJobDefinitionNodePropertiesNodeRangePropertiesContainerLinuxParametersOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        [JsiiProperty(name: "initProcessEnabled", typeJson: "{\"fqn\":\"cdktn.IResolvable\"}")]
        public virtual Io.Cdktn.IResolvable InitProcessEnabled
        {
