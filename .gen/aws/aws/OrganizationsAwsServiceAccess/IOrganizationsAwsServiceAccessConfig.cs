...
namespace aws.OrganizationsAwsServiceAccess
{
    ...
    public interface IOrganizationsAwsServiceAccessConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IOrganizationsAwsServiceAccessConfig), fullyQualifiedName: "aws.organizationsAwsServiceAccess.OrganizationsAwsServiceAccessConfig")]
        internal sealed class _Proxy : DeputyBase, aws.OrganizationsAwsServiceAccess.IOrganizationsAwsServiceAccessConfig
        {
