...
{
    [JsiiClass(nativeType: typeof(aws.LbListenerRule.LbListenerRuleActionOutputReference), fullyQualifiedName: "aws.lbListenerRule.LbListenerRuleActionOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktn.IInterpolatingParent\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"the index of this item in the list.\"},\"name\":\"complexObjectIndex\",\"type\":{\"primitive\":\"number\"}},{\"docs\":{\"summary\":\"whether the list is wrapping a set (will add tolist() to be able to access an item via an index).\"},\"name\":\"complexObjectIsFromSet\",\"type\":{\"primitive\":\"boolean\"}}]")]
    public class LbListenerRuleActionOutputReference : Io.Cdktn.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        /// <param name="complexObjectIndex">the index of this item in the list.</param>
        /// <param name="complexObjectIsFromSet">whether the list is wrapping a set (will add tolist() to be able to access an item via an index).</param>
        public LbListenerRuleActionOutputReference(Io.Cdktn.IInterpolatingParent terraformResource, string terraformAttribute, double complexObjectIndex, bool complexObjectIsFromSet): base(_MakeDeputyProps(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet))
        {
        }
        ...
        [JsiiMethod(name: "putJwtValidation", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"aws.lbListenerRule.LbListenerRuleActionJwtValidation\"}}]")]
        public virtual void PutJwtValidation(aws.LbListenerRule.ILbListenerRuleActionJwtValidation @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(aws.LbListenerRule.ILbListenerRuleActionJwtValidation)}, new object[]{@value});
        }
        ...
        [JsiiMethod(name: "resetJwtValidation")]
        public virtual void ResetJwtValidation()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        [JsiiProperty(name: "jwtValidation", typeJson: "{\"fqn\":\"aws.lbListenerRule.LbListenerRuleActionJwtValidationOutputReference\"}")]
        public virtual aws.LbListenerRule.LbListenerRuleActionJwtValidationOutputReference JwtValidation
        {
            get => GetInstanceProperty<aws.LbListenerRule.LbListenerRuleActionJwtValidationOutputReference>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "jwtValidationInput", typeJson: "{\"fqn\":\"aws.lbListenerRule.LbListenerRuleActionJwtValidation\"}", isOptional: true)]
        public virtual aws.LbListenerRule.ILbListenerRuleActionJwtValidation? JwtValidationInput
        {
        ...
        /// <remarks>
        /// <para>Type union: either <see cref="Io.Cdktn.IResolvable" /> or <see cref="aws.LbListenerRule.ILbListenerRuleAction" /></para>
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"aws.lbListenerRule.LbListenerRuleAction\"}]}}", isOptional: true)]
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case null:
                            break;
                        default:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.LbListenerRule.ILbListenerRuleAction).FullName}; received {value.GetType().FullName}", nameof(value));
                    }
                }
