...
namespace aws.LbListenerRule
{
    ...
    public interface ILbListenerRuleTransformHostHeaderRewriteConfigRewrite
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ILbListenerRuleTransformHostHeaderRewriteConfigRewrite), fullyQualifiedName: "aws.lbListenerRule.LbListenerRuleTransformHostHeaderRewriteConfigRewrite")]
        internal sealed class _Proxy : DeputyBase, aws.LbListenerRule.ILbListenerRuleTransformHostHeaderRewriteConfigRewrite
        {
