...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.43.0/docs/resources/verifiedpermissions_schema aws_verifiedpermissions_schema}.</summary>
    ...
    public class VerifiedpermissionsSchema : Io.Cdktn.TerraformResource
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.43.0/docs/resources/verifiedpermissions_schema aws_verifiedpermissions_schema} Resource.</summary>
        ...
        /// <summary>Generates CDKTN code for importing a VerifiedpermissionsSchema resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
            ...
            if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
            {
                switch (@value)
                {
                    case Io.Cdktn.IResolvable cast_2ed7d7:
                        break;
                    case aws.VerifiedpermissionsSchema.IVerifiedpermissionsSchemaDefinition[] cast_2ed7d7:
                        break;
                    case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_2ed7d7:
                        // Not enough information to type-check...
                        break;
                    case null:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.VerifiedpermissionsSchema.IVerifiedpermissionsSchemaDefinition).FullName}[]; received null", nameof(@value));
                    default:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.VerifiedpermissionsSchema.IVerifiedpermissionsSchemaDefinition).FullName}[]; received {@value.GetType().FullName}", nameof(@value));
                }
            }
        ...
        [JsiiProperty(name: "definition", typeJson: "{\"fqn\":\"aws.verifiedpermissionsSchema.VerifiedpermissionsSchemaDefinitionList\"}")]
        public virtual aws.VerifiedpermissionsSchema.VerifiedpermissionsSchemaDefinitionList Definition
        {
            get => GetInstanceProperty<aws.VerifiedpermissionsSchema.VerifiedpermissionsSchemaDefinitionList>()!;
        }
