...
namespace aws.OsisPipelineEndpoint
{
    ...
    [JsiiByValue(fqn: "aws.osisPipelineEndpoint.OsisPipelineEndpointConfig")]
    public class OsisPipelineEndpointConfig : aws.OsisPipelineEndpoint.IOsisPipelineEndpointConfig
    {
