...
{
    [JsiiByValue(fqn: "aws.osisPipelineEndpoint.OsisPipelineEndpointTimeouts")]
    public class OsisPipelineEndpointTimeouts : aws.OsisPipelineEndpoint.IOsisPipelineEndpointTimeouts
    {
