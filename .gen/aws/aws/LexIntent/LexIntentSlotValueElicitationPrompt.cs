...
namespace aws.LexIntent
{
    ...
    public class LexIntentSlotValueElicitationPrompt : aws.LexIntent.ILexIntentSlotValueElicitationPrompt
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "message", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.lexIntent.LexIntentSlotValueElicitationPromptMessage\"},\"kind\":\"array\"}}]}}")]
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            ...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.LexIntent.ILexIntentSlotValueElicitationPromptMessage).FullName}[]; received null", nameof(value));
                        default:
