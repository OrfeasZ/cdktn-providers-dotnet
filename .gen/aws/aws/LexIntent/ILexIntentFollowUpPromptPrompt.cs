...
namespace aws.LexIntent
{
    ...
    public interface ILexIntentFollowUpPromptPrompt
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "message", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.lexIntent.LexIntentFollowUpPromptPromptMessage\"},\"kind\":\"array\"}}]}}")]
        object Message
        {
            get;
        }
