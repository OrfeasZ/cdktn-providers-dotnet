...
namespace aws.QuicksightDataSet
{
    ...
    public interface IQuicksightDataSetLogicalTableMapDataTransformsCreateColumnsOperation
    {
        ...
        /// <remarks>
        /// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/quicksight_data_set#columns QuicksightDataSet#columns}
        ...
        /// </remarks>
        [JsiiProperty(name: "columns", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.quicksightDataSet.QuicksightDataSetLogicalTableMapDataTransformsCreateColumnsOperationColumns\"},\"kind\":\"array\"}}]}}")]
        object Columns
        {
            get;
        }
