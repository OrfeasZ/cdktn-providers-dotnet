...
namespace aws.BedrockEvaluationJob
{
    ...
    public interface IBedrockEvaluationJobOutputDataConfig
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IBedrockEvaluationJobOutputDataConfig), fullyQualifiedName: "aws.bedrockEvaluationJob.BedrockEvaluationJobOutputDataConfig")]
        internal sealed class _Proxy : DeputyBase, aws.BedrockEvaluationJob.IBedrockEvaluationJobOutputDataConfig
        {
