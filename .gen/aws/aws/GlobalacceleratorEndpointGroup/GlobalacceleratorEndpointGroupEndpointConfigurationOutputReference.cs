...
namespace aws.GlobalacceleratorEndpointGroup
{
    ...
    public class GlobalacceleratorEndpointGroupEndpointConfigurationOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"aws.globalacceleratorEndpointGroup.GlobalacceleratorEndpointGroupEndpointConfiguration\"}]}}", isOptional: true)]
