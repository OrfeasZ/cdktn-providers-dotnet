...
namespace aws.AppsyncChannelNamespace
{
    ...
    public class AppsyncChannelNamespaceHandlerConfigsOnSubscribeIntegrationOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        /// <param name="value">Type union: either <see cref="Io.Cdktn.IResolvable" /> or (<see cref="aws.AppsyncChannelNamespace.IAppsyncChannelNamespaceHandlerConfigsOnSubscribeIntegrationLambdaConfig" />)[]</param>
