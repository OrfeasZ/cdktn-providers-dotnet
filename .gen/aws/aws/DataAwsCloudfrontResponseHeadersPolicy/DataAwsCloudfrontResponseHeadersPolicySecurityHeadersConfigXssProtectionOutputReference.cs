...
namespace aws.DataAwsCloudfrontResponseHeadersPolicy
{
    ...
    public class DataAwsCloudfrontResponseHeadersPolicySecurityHeadersConfigXssProtectionOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        [JsiiProperty(name: "modeBlock", typeJson: "{\"fqn\":\"cdktn.IResolvable\"}")]
        public virtual Io.Cdktn.IResolvable ModeBlock
        {
        ...
        [JsiiProperty(name: "protection", typeJson: "{\"fqn\":\"cdktn.IResolvable\"}")]
        public virtual Io.Cdktn.IResolvable Protection
        {
            get => GetInstanceProperty<Io.Cdktn.IResolvable>()!;
        }
