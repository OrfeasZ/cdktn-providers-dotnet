...
namespace aws.MskChannel
{
    ...
    [JsiiByValue(fqn: "aws.mskChannel.MskChannelLoggingInfoCloudwatchLogs")]
    public class MskChannelLoggingInfoCloudwatchLogs : aws.MskChannel.IMskChannelLoggingInfoCloudwatchLogs
    {
