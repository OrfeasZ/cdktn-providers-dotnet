...
namespace aws.DataAwsMskCluster
{
    ...
    public class DataAwsMskClusterBrokerNodeGroupInfoConnectivityInfoVpcConnectivityClientAuthenticationSaslOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        [JsiiProperty(name: "iam", typeJson: "{\"fqn\":\"cdktn.IResolvable\"}")]
        public virtual Io.Cdktn.IResolvable Iam
        {
            get => GetInstanceProperty<Io.Cdktn.IResolvable>()!;
        }

        [JsiiProperty(name: "scram", typeJson: "{\"fqn\":\"cdktn.IResolvable\"}")]
        public virtual Io.Cdktn.IResolvable Scram
        {
            get => GetInstanceProperty<Io.Cdktn.IResolvable>()!;
        }
