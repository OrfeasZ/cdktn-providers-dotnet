...
namespace aws.LaunchTemplate
{
    ...
    public interface ILaunchTemplateConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.LaunchTemplate.ILaunchTemplateNetworkPerformanceOptions? NetworkPerformanceOptions
        {
            get
            {
                return null;
