...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.42.0/docs/resources/appstream_directory_config aws_appstream_directory_config}.</summary>
    ...
    public class AppstreamDirectoryConfig : Io.Cdktn.TerraformResource
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.42.0/docs/resources/appstream_directory_config aws_appstream_directory_config} Resource.</summary>
        ...
        /// <summary>Generates CDKTN code for importing a AppstreamDirectoryConfig resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        ...
        [JsiiMethod(name: "generateConfigForImport", returnsJson: "{\"type\":{\"fqn\":\"cdktn.ImportableResource\"}}", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"summary\":\"The construct id used in the generated config for the AppstreamDirectoryConfig to import.\"},\"name\":\"importToId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"remarks\":\"Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.42.0/docs/resources/appstream_directory_config#import import section} in the documentation of this resource for the id to use\",\"summary\":\"The id of the existing AppstreamDirectoryConfig that should be imported.\"},\"name\":\"importFromId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"? Optional instance of the provider where the AppstreamDirectoryConfig to import is found.\"},\"name\":\"provider\",\"optional\":true,\"type\":{\"fqn\":\"cdktn.TerraformProvider\"}}]")]
        public static Io.Cdktn.ImportableResource GenerateConfigForImport(Constructs.Construct scope, string importToId, string importFromId, Io.Cdktn.TerraformProvider? provider = null)
        {
            return InvokeStaticMethod<Io.Cdktn.ImportableResource>(typeof(aws.AppstreamDirectoryConfig.AppstreamDirectoryConfig), new System.Type[]{typeof(Constructs.Construct), typeof(string), typeof(string), typeof(Io.Cdktn.TerraformProvider)}, new object?[]{scope, importToId, importFromId, provider})!;
        }

        [JsiiMethod(name: "putCertificateBasedAuthProperties", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"aws.appstreamDirectoryConfig.AppstreamDirectoryConfigCertificateBasedAuthProperties\"}}]")]
        public virtual void PutCertificateBasedAuthProperties(aws.AppstreamDirectoryConfig.IAppstreamDirectoryConfigCertificateBasedAuthProperties @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(aws.AppstreamDirectoryConfig.IAppstreamDirectoryConfigCertificateBasedAuthProperties)}, new object[]{@value});
        }
        ...
        [JsiiProperty(name: "certificateBasedAuthProperties", typeJson: "{\"fqn\":\"aws.appstreamDirectoryConfig.AppstreamDirectoryConfigCertificateBasedAuthPropertiesOutputReference\"}")]
        public virtual aws.AppstreamDirectoryConfig.AppstreamDirectoryConfigCertificateBasedAuthPropertiesOutputReference CertificateBasedAuthProperties
        {
            get => GetInstanceProperty<aws.AppstreamDirectoryConfig.AppstreamDirectoryConfigCertificateBasedAuthPropertiesOutputReference>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "certificateBasedAuthPropertiesInput", typeJson: "{\"fqn\":\"aws.appstreamDirectoryConfig.AppstreamDirectoryConfigCertificateBasedAuthProperties\"}", isOptional: true)]
        public virtual aws.AppstreamDirectoryConfig.IAppstreamDirectoryConfigCertificateBasedAuthProperties? CertificateBasedAuthPropertiesInput
        {
