...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.43.0/docs/data-sources/iam_policy_document aws_iam_policy_document}.</summary>
    ...
    public class DataAwsIamPolicyDocument : Io.Cdktn.TerraformDataSource
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.43.0/docs/data-sources/iam_policy_document aws_iam_policy_document} Data Source.</summary>
        ...
        /// <summary>Generates CDKTN code for importing a DataAwsIamPolicyDocument resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
            ...
            if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
            {
                switch (@value)
                {
                    ...
                    case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_2ed7d7:
                        ...
                        break;
                    case null:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.DataAwsIamPolicyDocument.IDataAwsIamPolicyDocumentStatement).FullName}[]; received null", nameof(@value));
                    default:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.DataAwsIamPolicyDocument.IDataAwsIamPolicyDocumentStatement).FullName}[]; received {@value.GetType().FullName}", nameof(@value));
                }
            }
