...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/mailmanager_ingress_point aws_mailmanager_ingress_point}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/mailmanager_ingress_point aws_mailmanager_ingress_point} Resource.</summary>
        ...
        [JsiiMethod(name: "resetStatusToUpdate")]
        public virtual void ResetStatusToUpdate()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "statusToUpdateInput", typeJson: "{\"primitive\":\"string\"}", isOptional: true)]
        public virtual string? StatusToUpdateInput
        {
            get => GetInstanceProperty<string?>();
        }
        ...
        [JsiiProperty(name: "statusToUpdate", typeJson: "{\"primitive\":\"string\"}")]
        public virtual string StatusToUpdate
        {
            get => GetInstanceProperty<string>()!;
            set => SetInstanceProperty(value);
        }
