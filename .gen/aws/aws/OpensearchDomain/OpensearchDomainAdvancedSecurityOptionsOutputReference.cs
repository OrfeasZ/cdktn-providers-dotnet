...
namespace aws.OpensearchDomain
{
    ...
    public class OpensearchDomainAdvancedSecurityOptionsOutputReference : Io.Cdktn.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        public OpensearchDomainAdvancedSecurityOptionsOutputReference(Io.Cdktn.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
        ...
        [JsiiMethod(name: "putJwtOptions", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"aws.opensearchDomain.OpensearchDomainAdvancedSecurityOptionsJwtOptions\"}}]")]
        public virtual void PutJwtOptions(aws.OpensearchDomain.IOpensearchDomainAdvancedSecurityOptionsJwtOptions @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(aws.OpensearchDomain.IOpensearchDomainAdvancedSecurityOptionsJwtOptions)}, new object[]{@value});
        }
        ...
        [JsiiMethod(name: "resetJwtOptions")]
        public virtual void ResetJwtOptions()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        [JsiiProperty(name: "jwtOptions", typeJson: "{\"fqn\":\"aws.opensearchDomain.OpensearchDomainAdvancedSecurityOptionsJwtOptionsOutputReference\"}")]
        public virtual aws.OpensearchDomain.OpensearchDomainAdvancedSecurityOptionsJwtOptionsOutputReference JwtOptions
        {
            get => GetInstanceProperty<aws.OpensearchDomain.OpensearchDomainAdvancedSecurityOptionsJwtOptionsOutputReference>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "anonymousAuthEnabledInput", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktn.IResolvable\"}]}}", isOptional: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "jwtOptionsInput", typeJson: "{\"fqn\":\"aws.opensearchDomain.OpensearchDomainAdvancedSecurityOptionsJwtOptions\"}", isOptional: true)]
        public virtual aws.OpensearchDomain.IOpensearchDomainAdvancedSecurityOptionsJwtOptions? JwtOptionsInput
        {
        ...
        [JsiiProperty(name: "anonymousAuthEnabled", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktn.IResolvable\"}]}}")]
