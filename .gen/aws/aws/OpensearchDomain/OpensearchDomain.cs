...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.43.0/docs/resources/opensearch_domain aws_opensearch_domain}.</summary>
    ...
    public class OpensearchDomain : Io.Cdktn.TerraformResource
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.43.0/docs/resources/opensearch_domain aws_opensearch_domain} Resource.</summary>
        ...
        /// <summary>Generates CDKTN code for importing a OpensearchDomain resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        ...
        [JsiiMethod(name: "generateConfigForImport", returnsJson: "{\"type\":{\"fqn\":\"cdktn.ImportableResource\"}}", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"summary\":\"The construct id used in the generated config for the OpensearchDomain to import.\"},\"name\":\"importToId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"remarks\":\"Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.43.0/docs/resources/opensearch_domain#import import section} in the documentation of this resource for the id to use\",\"summary\":\"The id of the existing OpensearchDomain that should be imported.\"},\"name\":\"importFromId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"? Optional instance of the provider where the OpensearchDomain to import is found.\"},\"name\":\"provider\",\"optional\":true,\"type\":{\"fqn\":\"cdktn.TerraformProvider\"}}]")]
        public static Io.Cdktn.ImportableResource GenerateConfigForImport(Constructs.Construct scope, string importToId, string importFromId, Io.Cdktn.TerraformProvider? provider = null)
        {
            return InvokeStaticMethod<Io.Cdktn.ImportableResource>(typeof(aws.OpensearchDomain.OpensearchDomain), new System.Type[]{typeof(Constructs.Construct), typeof(string), typeof(string), typeof(Io.Cdktn.TerraformProvider)}, new object?[]{scope, importToId, importFromId, provider})!;
        }
        ...
        [JsiiMethod(name: "putAimlOptions", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"aws.opensearchDomain.OpensearchDomainAimlOptions\"}}]")]
        public virtual void PutAimlOptions(aws.OpensearchDomain.IOpensearchDomainAimlOptions @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(aws.OpensearchDomain.IOpensearchDomainAimlOptions)}, new object[]{@value});
        }
        ...
        [JsiiMethod(name: "putDeploymentStrategyOptions", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"aws.opensearchDomain.OpensearchDomainDeploymentStrategyOptions\"}}]")]
        public virtual void PutDeploymentStrategyOptions(aws.OpensearchDomain.IOpensearchDomainDeploymentStrategyOptions @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(aws.OpensearchDomain.IOpensearchDomainDeploymentStrategyOptions)}, new object[]{@value});
        }
        ...
        [JsiiMethod(name: "putIdentityCenterOptions", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"aws.opensearchDomain.OpensearchDomainIdentityCenterOptions\"}}]")]
        public virtual void PutIdentityCenterOptions(aws.OpensearchDomain.IOpensearchDomainIdentityCenterOptions @value)
        {
            ...
            if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
            {
                switch (@value)
                {
                    ...
                    case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_2ed7d7:
                        ...
                        break;
                    case null:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.OpensearchDomain.IOpensearchDomainLogPublishingOptions).FullName}[]; received null", nameof(@value));
                    default:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.OpensearchDomain.IOpensearchDomainLogPublishingOptions).FullName}[]; received {@value.GetType().FullName}", nameof(@value));
                }
            }
        ...
        [JsiiMethod(name: "resetAimlOptions")]
        public virtual void ResetAimlOptions()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        [JsiiMethod(name: "resetDeploymentStrategyOptions")]
        public virtual void ResetDeploymentStrategyOptions()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        [JsiiMethod(name: "resetIdentityCenterOptions")]
        public virtual void ResetIdentityCenterOptions()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        [JsiiProperty(name: "aimlOptions", typeJson: "{\"fqn\":\"aws.opensearchDomain.OpensearchDomainAimlOptionsOutputReference\"}")]
        public virtual aws.OpensearchDomain.OpensearchDomainAimlOptionsOutputReference AimlOptions
        {
            get => GetInstanceProperty<aws.OpensearchDomain.OpensearchDomainAimlOptionsOutputReference>()!;
        }
        ...
        [JsiiProperty(name: "deploymentStrategyOptions", typeJson: "{\"fqn\":\"aws.opensearchDomain.OpensearchDomainDeploymentStrategyOptionsOutputReference\"}")]
        public virtual aws.OpensearchDomain.OpensearchDomainDeploymentStrategyOptionsOutputReference DeploymentStrategyOptions
        {
            get => GetInstanceProperty<aws.OpensearchDomain.OpensearchDomainDeploymentStrategyOptionsOutputReference>()!;
        }
        ...
        [JsiiProperty(name: "identityCenterOptions", typeJson: "{\"fqn\":\"aws.opensearchDomain.OpensearchDomainIdentityCenterOptionsOutputReference\"}")]
        public virtual aws.OpensearchDomain.OpensearchDomainIdentityCenterOptionsOutputReference IdentityCenterOptions
        {
            get => GetInstanceProperty<aws.OpensearchDomain.OpensearchDomainIdentityCenterOptionsOutputReference>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "aimlOptionsInput", typeJson: "{\"fqn\":\"aws.opensearchDomain.OpensearchDomainAimlOptions\"}", isOptional: true)]
        public virtual aws.OpensearchDomain.IOpensearchDomainAimlOptions? AimlOptionsInput
        {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "deploymentStrategyOptionsInput", typeJson: "{\"fqn\":\"aws.opensearchDomain.OpensearchDomainDeploymentStrategyOptions\"}", isOptional: true)]
        public virtual aws.OpensearchDomain.IOpensearchDomainDeploymentStrategyOptions? DeploymentStrategyOptionsInput
        {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "identityCenterOptionsInput", typeJson: "{\"fqn\":\"aws.opensearchDomain.OpensearchDomainIdentityCenterOptions\"}", isOptional: true)]
        public virtual aws.OpensearchDomain.IOpensearchDomainIdentityCenterOptions? IdentityCenterOptionsInput
        {
