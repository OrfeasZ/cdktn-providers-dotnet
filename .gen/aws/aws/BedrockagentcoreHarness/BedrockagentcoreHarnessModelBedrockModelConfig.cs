...
namespace aws.BedrockagentcoreHarness
{
    ...
    public class BedrockagentcoreHarnessModelBedrockModelConfig : aws.BedrockagentcoreHarness.IBedrockagentcoreHarnessModelBedrockModelConfig
    {
        ...
        /// <summary>Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.64.0/docs/resources/bedrockagentcore_harness#api_format BedrockagentcoreHarness#api_format}.</summary>
        [JsiiOptional]
        [JsiiProperty(name: "apiFormat", typeJson: "{\"primitive\":\"string\"}", isOptional: true)]
