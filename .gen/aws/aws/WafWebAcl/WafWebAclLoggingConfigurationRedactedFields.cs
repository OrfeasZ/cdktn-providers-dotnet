...
namespace aws.WafWebAcl
{
    ...
    public class WafWebAclLoggingConfigurationRedactedFields : aws.WafWebAcl.IWafWebAclLoggingConfigurationRedactedFields
    {
        ...
        /// <remarks>
        /// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.0/docs/resources/waf_web_acl#field_to_match WafWebAcl#field_to_match}
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            ...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.WafWebAcl.IWafWebAclLoggingConfigurationRedactedFieldsFieldToMatch).FullName}[]; received null", nameof(value));
                        default:
