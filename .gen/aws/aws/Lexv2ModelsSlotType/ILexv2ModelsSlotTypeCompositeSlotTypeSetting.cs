...
namespace aws.Lexv2ModelsSlotType
{
    ...
    public interface ILexv2ModelsSlotTypeCompositeSlotTypeSetting
    {
        ...
        /// <remarks>
        /// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.59.0/docs/resources/lexv2models_slot_type#sub_slots Lexv2ModelsSlotType#sub_slots}
        ...
        /// </remarks>
        [JsiiProperty(name: "subSlots", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.lexv2ModelsSlotType.Lexv2ModelsSlotTypeCompositeSlotTypeSettingSubSlots\"},\"kind\":\"array\"}}]}}", isOptional: true)]
