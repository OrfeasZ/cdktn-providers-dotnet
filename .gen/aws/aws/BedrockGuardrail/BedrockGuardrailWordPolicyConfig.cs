...
namespace aws.BedrockGuardrail
{
    ...
    public class BedrockGuardrailWordPolicyConfig : aws.BedrockGuardrail.IBedrockGuardrailWordPolicyConfig
    {
        ...
        /// <remarks>
        /// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.42.0/docs/resources/bedrock_guardrail#managed_word_lists_config BedrockGuardrail#managed_word_lists_config}
        /// </remarks>
        [JsiiOptional]
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case null:
                            break;
                        default:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.BedrockGuardrail.IBedrockGuardrailWordPolicyConfigManagedWordListsConfig).FullName}[]; received {value.GetType().FullName}", nameof(value));
                    }
                }
        ...
        /// <remarks>
        /// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.42.0/docs/resources/bedrock_guardrail#words_config BedrockGuardrail#words_config}
        /// </remarks>
        [JsiiOptional]
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case null:
                            break;
                        default:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.BedrockGuardrail.IBedrockGuardrailWordPolicyConfigWordsConfig).FullName}[]; received {value.GetType().FullName}", nameof(value));
                    }
                }
                _wordsConfig = value;
            }
