...
namespace aws.BedrockGuardrail
{
    ...
    public class BedrockGuardrailConfig : aws.BedrockGuardrail.IBedrockGuardrailConfig
    {
        ...
        private object? _crossRegionConfig;
            ...
            set
            {
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        case Io.Cdktn.IResolvable cast_cd4240:
                            break;
                        case aws.BedrockGuardrail.IBedrockGuardrailCrossRegionConfig[] cast_cd4240:
                            break;
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            // Not enough information to type-check...
                            break;
                        case null:
                            break;
                        default:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.BedrockGuardrail.IBedrockGuardrailCrossRegionConfig).FullName}[]; received {value.GetType().FullName}", nameof(value));
                    }
                }
                _crossRegionConfig = value;
            }
        }
