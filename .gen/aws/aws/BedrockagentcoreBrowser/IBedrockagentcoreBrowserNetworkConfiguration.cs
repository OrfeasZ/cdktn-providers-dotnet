...
{
    [JsiiInterface(nativeType: typeof(IBedrockagentcoreBrowserNetworkConfiguration), fullyQualifiedName: "aws.bedrockagentcoreBrowser.BedrockagentcoreBrowserNetworkConfiguration")]
    public interface IBedrockagentcoreBrowserNetworkConfiguration
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IBedrockagentcoreBrowserNetworkConfiguration), fullyQualifiedName: "aws.bedrockagentcoreBrowser.BedrockagentcoreBrowserNetworkConfiguration")]
        internal sealed class _Proxy : DeputyBase, aws.BedrockagentcoreBrowser.IBedrockagentcoreBrowserNetworkConfiguration
        {
