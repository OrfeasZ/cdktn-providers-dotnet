...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.42.0/docs/resources/emrserverless_application aws_emrserverless_application}.</summary>
    ...
    public class EmrserverlessApplication : Io.Cdktn.TerraformResource
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.42.0/docs/resources/emrserverless_application aws_emrserverless_application} Resource.</summary>
        ...
        /// <summary>Generates CDKTN code for importing a EmrserverlessApplication resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        ...
        [JsiiMethod(name: "generateConfigForImport", returnsJson: "{\"type\":{\"fqn\":\"cdktn.ImportableResource\"}}", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"summary\":\"The construct id used in the generated config for the EmrserverlessApplication to import.\"},\"name\":\"importToId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"remarks\":\"Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.42.0/docs/resources/emrserverless_application#import import section} in the documentation of this resource for the id to use\",\"summary\":\"The id of the existing EmrserverlessApplication that should be imported.\"},\"name\":\"importFromId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"? Optional instance of the provider where the EmrserverlessApplication to import is found.\"},\"name\":\"provider\",\"optional\":true,\"type\":{\"fqn\":\"cdktn.TerraformProvider\"}}]")]
        public static Io.Cdktn.ImportableResource GenerateConfigForImport(Constructs.Construct scope, string importToId, string importFromId, Io.Cdktn.TerraformProvider? provider = null)
        {
            return InvokeStaticMethod<Io.Cdktn.ImportableResource>(typeof(aws.EmrserverlessApplication.EmrserverlessApplication), new System.Type[]{typeof(Constructs.Construct), typeof(string), typeof(string), typeof(Io.Cdktn.TerraformProvider)}, new object?[]{scope, importToId, importFromId, provider})!;
        }
            ...
            if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
            {
                switch (@value)
                {
                    ...
                    case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_2ed7d7:
                        ...
                        break;
                    case null:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.EmrserverlessApplication.IEmrserverlessApplicationInitialCapacity).FullName}[]; received null", nameof(@value));
                    default:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.EmrserverlessApplication.IEmrserverlessApplicationInitialCapacity).FullName}[]; received {@value.GetType().FullName}", nameof(@value));
                }
            }
        ...
        [JsiiMethod(name: "putJobLevelCostAllocationConfiguration", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"aws.emrserverlessApplication.EmrserverlessApplicationJobLevelCostAllocationConfiguration\"}}]")]
        public virtual void PutJobLevelCostAllocationConfiguration(aws.EmrserverlessApplication.IEmrserverlessApplicationJobLevelCostAllocationConfiguration @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(aws.EmrserverlessApplication.IEmrserverlessApplicationJobLevelCostAllocationConfiguration)}, new object[]{@value});
        }
        ...
        [JsiiMethod(name: "putMonitoringConfiguration", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"aws.emrserverlessApplication.EmrserverlessApplicationMonitoringConfiguration\"}}]")]
        public virtual void PutMonitoringConfiguration(aws.EmrserverlessApplication.IEmrserverlessApplicationMonitoringConfiguration @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(aws.EmrserverlessApplication.IEmrserverlessApplicationMonitoringConfiguration)}, new object[]{@value});
        }
        ...
        public virtual void PutRuntimeConfiguration(object @value)
        {
            if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
            {
                switch (@value)
                {
                    case Io.Cdktn.IResolvable cast_2ed7d7:
                        break;
                    case aws.EmrserverlessApplication.IEmrserverlessApplicationRuntimeConfiguration[] cast_2ed7d7:
                        break;
                    case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_2ed7d7:
                        // Not enough information to type-check...
                        break;
                    case null:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.EmrserverlessApplication.IEmrserverlessApplicationRuntimeConfiguration).FullName}[]; received null", nameof(@value));
                    default:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.EmrserverlessApplication.IEmrserverlessApplicationRuntimeConfiguration).FullName}[]; received {@value.GetType().FullName}", nameof(@value));
                }
            }
            InvokeInstanceVoidMethod(new System.Type[]{typeof(object)}, new object[]{@value});
        }

        [JsiiMethod(name: "putSchedulerConfiguration", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"aws.emrserverlessApplication.EmrserverlessApplicationSchedulerConfiguration\"}}]")]
        public virtual void PutSchedulerConfiguration(aws.EmrserverlessApplication.IEmrserverlessApplicationSchedulerConfiguration @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(aws.EmrserverlessApplication.IEmrserverlessApplicationSchedulerConfiguration)}, new object[]{@value});
        }
        ...
        [JsiiMethod(name: "resetJobLevelCostAllocationConfiguration")]
        public virtual void ResetJobLevelCostAllocationConfiguration()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        [JsiiMethod(name: "resetSchedulerConfiguration")]
        public virtual void ResetSchedulerConfiguration()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        [JsiiProperty(name: "jobLevelCostAllocationConfiguration", typeJson: "{\"fqn\":\"aws.emrserverlessApplication.EmrserverlessApplicationJobLevelCostAllocationConfigurationOutputReference\"}")]
        public virtual aws.EmrserverlessApplication.EmrserverlessApplicationJobLevelCostAllocationConfigurationOutputReference JobLevelCostAllocationConfiguration
        {
            get => GetInstanceProperty<aws.EmrserverlessApplication.EmrserverlessApplicationJobLevelCostAllocationConfigurationOutputReference>()!;
        }
        ...
        [JsiiProperty(name: "monitoringConfiguration", typeJson: "{\"fqn\":\"aws.emrserverlessApplication.EmrserverlessApplicationMonitoringConfigurationOutputReference\"}")]
        public virtual aws.EmrserverlessApplication.EmrserverlessApplicationMonitoringConfigurationOutputReference MonitoringConfiguration
        {
            get => GetInstanceProperty<aws.EmrserverlessApplication.EmrserverlessApplicationMonitoringConfigurationOutputReference>()!;
        }
        ...
        [JsiiProperty(name: "runtimeConfiguration", typeJson: "{\"fqn\":\"aws.emrserverlessApplication.EmrserverlessApplicationRuntimeConfigurationList\"}")]
        public virtual aws.EmrserverlessApplication.EmrserverlessApplicationRuntimeConfigurationList RuntimeConfiguration
        {
            get => GetInstanceProperty<aws.EmrserverlessApplication.EmrserverlessApplicationRuntimeConfigurationList>()!;
        }

        [JsiiProperty(name: "schedulerConfiguration", typeJson: "{\"fqn\":\"aws.emrserverlessApplication.EmrserverlessApplicationSchedulerConfigurationOutputReference\"}")]
        public virtual aws.EmrserverlessApplication.EmrserverlessApplicationSchedulerConfigurationOutputReference SchedulerConfiguration
        {
            get => GetInstanceProperty<aws.EmrserverlessApplication.EmrserverlessApplicationSchedulerConfigurationOutputReference>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "jobLevelCostAllocationConfigurationInput", typeJson: "{\"fqn\":\"aws.emrserverlessApplication.EmrserverlessApplicationJobLevelCostAllocationConfiguration\"}", isOptional: true)]
        public virtual aws.EmrserverlessApplication.IEmrserverlessApplicationJobLevelCostAllocationConfiguration? JobLevelCostAllocationConfigurationInput
        {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "monitoringConfigurationInput", typeJson: "{\"fqn\":\"aws.emrserverlessApplication.EmrserverlessApplicationMonitoringConfiguration\"}", isOptional: true)]
        public virtual aws.EmrserverlessApplication.IEmrserverlessApplicationMonitoringConfiguration? MonitoringConfigurationInput
        {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "schedulerConfigurationInput", typeJson: "{\"fqn\":\"aws.emrserverlessApplication.EmrserverlessApplicationSchedulerConfiguration\"}", isOptional: true)]
        public virtual aws.EmrserverlessApplication.IEmrserverlessApplicationSchedulerConfiguration? SchedulerConfigurationInput
        {
