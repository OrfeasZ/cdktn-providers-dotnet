...
namespace aws.GuarddutyFilter
{
    ...
    public class GuarddutyFilterFindingCriteria : aws.GuarddutyFilter.IGuarddutyFilterFindingCriteria
    {
        ...
        /// <remarks>
        /// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.59.0/docs/resources/guardduty_filter#criterion GuarddutyFilter#criterion}
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            ...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.GuarddutyFilter.IGuarddutyFilterFindingCriteriaCriterion).FullName}[]; received null", nameof(value));
                        default:
