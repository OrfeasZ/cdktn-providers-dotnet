...
{
    [JsiiByValue(fqn: "aws.timestreaminfluxdbDbCluster.TimestreaminfluxdbDbClusterTimeouts")]
    public class TimestreaminfluxdbDbClusterTimeouts : aws.TimestreaminfluxdbDbCluster.ITimestreaminfluxdbDbClusterTimeouts
    {
