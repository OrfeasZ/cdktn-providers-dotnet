...
namespace aws.DataAwsIamRolePolicies
{
    ...
    public interface IDataAwsIamRolePoliciesConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataAwsIamRolePoliciesConfig), fullyQualifiedName: "aws.dataAwsIamRolePolicies.DataAwsIamRolePoliciesConfig")]
        internal sealed class _Proxy : DeputyBase, aws.DataAwsIamRolePolicies.IDataAwsIamRolePoliciesConfig
        {
