...
namespace aws.DataAwsBackupPlan
{
    ...
    public class DataAwsBackupPlanRuleOutputReference : Io.Cdktn.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        /// <param name="complexObjectIndex">the index of this item in the list.</param>
        /// <param name="complexObjectIsFromSet">whether the list is wrapping a set (will add tolist() to be able to access an item via an index).</param>
        public DataAwsBackupPlanRuleOutputReference(Io.Cdktn.IInterpolatingParent terraformResource, string terraformAttribute, double complexObjectIndex, bool complexObjectIsFromSet): base(_MakeDeputyProps(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet))
        {
        }
        ...
        [JsiiProperty(name: "enableContinuousBackup", typeJson: "{\"fqn\":\"cdktn.IResolvable\"}")]
        public virtual Io.Cdktn.IResolvable EnableContinuousBackup
        {
        ...
        [JsiiProperty(name: "recoveryPointTags", typeJson: "{\"fqn\":\"cdktn.StringMap\"}")]
        public virtual Io.Cdktn.StringMap RecoveryPointTags
        {
        ...
        [JsiiProperty(name: "scanAction", typeJson: "{\"fqn\":\"aws.dataAwsBackupPlan.DataAwsBackupPlanRuleScanActionList\"}")]
        public virtual aws.DataAwsBackupPlan.DataAwsBackupPlanRuleScanActionList ScanAction
        {
            get => GetInstanceProperty<aws.DataAwsBackupPlan.DataAwsBackupPlanRuleScanActionList>()!;
        }
        ...
        [JsiiProperty(name: "targetLogicallyAirGappedBackupVaultArn", typeJson: "{\"primitive\":\"string\"}")]
        public virtual string TargetLogicallyAirGappedBackupVaultArn
        {
            get => GetInstanceProperty<string>()!;
        }
