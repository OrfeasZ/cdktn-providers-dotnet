...
namespace aws.UxcAccountCustomizations
{
    ...
    public interface IUxcAccountCustomizationsConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IUxcAccountCustomizationsConfig), fullyQualifiedName: "aws.uxcAccountCustomizations.UxcAccountCustomizationsConfig")]
        internal sealed class _Proxy : DeputyBase, aws.UxcAccountCustomizations.IUxcAccountCustomizationsConfig
        {
