...
namespace aws.LambdamicrovmsMicrovm
{
    ...
    [JsiiByValue(fqn: "aws.lambdamicrovmsMicrovm.LambdamicrovmsMicrovmConfig")]
    public class LambdamicrovmsMicrovmConfig : aws.LambdamicrovmsMicrovm.ILambdamicrovmsMicrovmConfig
    {
