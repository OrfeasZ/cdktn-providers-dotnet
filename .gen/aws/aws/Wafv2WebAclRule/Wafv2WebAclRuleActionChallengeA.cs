...
{
    [JsiiByValue(fqn: "aws.wafv2WebAclRule.Wafv2WebAclRuleActionChallengeA")]
    public class Wafv2WebAclRuleActionChallengeA : aws.Wafv2WebAclRule.IWafv2WebAclRuleActionChallengeA
    {
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        case Io.Cdktn.IResolvable cast_cd4240:
                            break;
                        case aws.Wafv2WebAclRule.IWafv2WebAclRuleActionChallengeCustomRequestHandlingA[] cast_cd4240:
                            break;
                        ...
                        case null:
                            break;
                        default:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.Wafv2WebAclRule.IWafv2WebAclRuleActionChallengeCustomRequestHandlingA).FullName}[]; received {value.GetType().FullName}", nameof(value));
                    }
                }
