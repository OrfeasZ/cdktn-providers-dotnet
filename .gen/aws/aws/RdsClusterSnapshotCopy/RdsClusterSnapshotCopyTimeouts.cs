...
namespace aws.RdsClusterSnapshotCopy
{
    ...
    public class RdsClusterSnapshotCopyTimeouts : aws.RdsClusterSnapshotCopy.IRdsClusterSnapshotCopyTimeouts
    {
        ...
        /// <remarks>
        /// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/rds_cluster_snapshot_copy#create RdsClusterSnapshotCopy#create}
        /// </remarks>
        [JsiiOptional]
