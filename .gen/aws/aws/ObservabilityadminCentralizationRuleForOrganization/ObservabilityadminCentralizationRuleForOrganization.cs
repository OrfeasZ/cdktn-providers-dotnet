...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/observabilityadmin_centralization_rule_for_organization aws_observabilityadmin_centralization_rule_for_organization}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/observabilityadmin_centralization_rule_for_organization aws_observabilityadmin_centralization_rule_for_organization} Resource.</summary>
        ...
        /// <param name="value">Type union: either <see cref="Io.Cdktn.IResolvable" /> or (<see cref="aws.ObservabilityadminCentralizationRuleForOrganization.IObservabilityadminCentralizationRuleForOrganizationRule" />)[]</param>
        ...
        [JsiiProperty(name: "tagPropagationFailureReason", typeJson: "{\"primitive\":\"string\"}")]
        public virtual string TagPropagationFailureReason
        {
            get => GetInstanceProperty<string>()!;
        }

        [JsiiProperty(name: "tagPropagationStatus", typeJson: "{\"primitive\":\"string\"}")]
        public virtual string TagPropagationStatus
        {
            get => GetInstanceProperty<string>()!;
        }
