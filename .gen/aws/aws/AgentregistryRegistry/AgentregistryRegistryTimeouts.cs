...
{
    [JsiiByValue(fqn: "aws.agentregistryRegistry.AgentregistryRegistryTimeouts")]
    public class AgentregistryRegistryTimeouts : aws.AgentregistryRegistry.IAgentregistryRegistryTimeouts
    {
