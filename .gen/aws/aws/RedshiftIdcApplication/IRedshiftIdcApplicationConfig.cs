...
{
    [JsiiInterface(nativeType: typeof(IRedshiftIdcApplicationConfig), fullyQualifiedName: "aws.redshiftIdcApplication.RedshiftIdcApplicationConfig")]
    public interface IRedshiftIdcApplicationConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IRedshiftIdcApplicationConfig), fullyQualifiedName: "aws.redshiftIdcApplication.RedshiftIdcApplicationConfig")]
        internal sealed class _Proxy : DeputyBase, aws.RedshiftIdcApplication.IRedshiftIdcApplicationConfig
        {
