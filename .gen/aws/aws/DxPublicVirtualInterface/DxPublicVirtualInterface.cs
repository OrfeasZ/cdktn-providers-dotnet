...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/dx_public_virtual_interface aws_dx_public_virtual_interface}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/dx_public_virtual_interface aws_dx_public_virtual_interface} Resource.</summary>
        ...
        /// <summary>Generates CDKTN code for importing a DxPublicVirtualInterface resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "timeoutsInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"aws.dxPublicVirtualInterface.DxPublicVirtualInterfaceTimeouts\"}]}}", isOptional: true)]
