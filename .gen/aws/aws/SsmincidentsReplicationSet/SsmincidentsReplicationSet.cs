...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.43.0/docs/resources/ssmincidents_replication_set aws_ssmincidents_replication_set}.</summary>
    [JsiiClass(nativeType: typeof(aws.SsmincidentsReplicationSet.SsmincidentsReplicationSet), fullyQualifiedName: "aws.ssmincidentsReplicationSet.SsmincidentsReplicationSet", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"remarks\":\"Must be unique amongst siblings in the same scope\",\"summary\":\"The scoped construct ID.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"optional\":true,\"type\":{\"fqn\":\"aws.ssmincidentsReplicationSet.SsmincidentsReplicationSetConfig\"}}]")]
    public class SsmincidentsReplicationSet : Io.Cdktn.TerraformResource
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.43.0/docs/resources/ssmincidents_replication_set aws_ssmincidents_replication_set} Resource.</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        /// <param name="id">The scoped construct ID.</param>
        public SsmincidentsReplicationSet(Constructs.Construct scope, string id, aws.SsmincidentsReplicationSet.ISsmincidentsReplicationSetConfig? config = null): base(_MakeDeputyProps(scope, id, config))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(Constructs.Construct scope, string id, aws.SsmincidentsReplicationSet.ISsmincidentsReplicationSetConfig? config = null)
        {
        ...
        /// <summary>Generates CDKTN code for importing a SsmincidentsReplicationSet resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
            ...
            if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
            {
                switch (@value)
                {
                    ...
                    case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_2ed7d7:
                        ...
                        break;
                    case null:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.SsmincidentsReplicationSet.ISsmincidentsReplicationSetRegion).FullName}[]; received null", nameof(@value));
                    default:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.SsmincidentsReplicationSet.ISsmincidentsReplicationSetRegion).FullName}[]; received {@value.GetType().FullName}", nameof(@value));
                }
            }
        ...
        public virtual void PutRegions(object @value)
        {
            if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
            {
                switch (@value)
                {
                    case Io.Cdktn.IResolvable cast_2ed7d7:
                        break;
                    case aws.SsmincidentsReplicationSet.ISsmincidentsReplicationSetRegions[] cast_2ed7d7:
                        break;
                    case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_2ed7d7:
                        // Not enough information to type-check...
                        break;
                    case null:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.SsmincidentsReplicationSet.ISsmincidentsReplicationSetRegions).FullName}[]; received null", nameof(@value));
                    default:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.SsmincidentsReplicationSet.ISsmincidentsReplicationSetRegions).FullName}[]; received {@value.GetType().FullName}", nameof(@value));
                }
            }
            InvokeInstanceVoidMethod(new System.Type[]{typeof(object)}, new object[]{@value});
        }
        ...
        [JsiiProperty(name: "regions", typeJson: "{\"fqn\":\"aws.ssmincidentsReplicationSet.SsmincidentsReplicationSetRegionsList\"}")]
        public virtual aws.SsmincidentsReplicationSet.SsmincidentsReplicationSetRegionsList Regions
        {
            get => GetInstanceProperty<aws.SsmincidentsReplicationSet.SsmincidentsReplicationSetRegionsList>()!;
        }
