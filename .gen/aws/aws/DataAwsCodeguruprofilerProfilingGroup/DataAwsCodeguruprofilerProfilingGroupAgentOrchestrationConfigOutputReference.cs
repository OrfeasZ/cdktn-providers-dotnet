...
namespace aws.DataAwsCodeguruprofilerProfilingGroup
{
    ...
    public class DataAwsCodeguruprofilerProfilingGroupAgentOrchestrationConfigOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        [JsiiProperty(name: "profilingEnabled", typeJson: "{\"fqn\":\"cdktn.IResolvable\"}")]
        public virtual Io.Cdktn.IResolvable ProfilingEnabled
        {
