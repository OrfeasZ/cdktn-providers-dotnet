...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/resources/codebuild_webhook aws_codebuild_webhook}.</summary>
    ...
    public class CodebuildWebhook : Io.Cdktn.TerraformResource
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/resources/codebuild_webhook aws_codebuild_webhook} Resource.</summary>
        ...
        /// <summary>Generates CDKTN code for importing a CodebuildWebhook resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        ...
        [JsiiMethod(name: "generateConfigForImport", returnsJson: "{\"type\":{\"fqn\":\"cdktn.ImportableResource\"}}", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"summary\":\"The construct id used in the generated config for the CodebuildWebhook to import.\"},\"name\":\"importToId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"remarks\":\"Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/resources/codebuild_webhook#import import section} in the documentation of this resource for the id to use\",\"summary\":\"The id of the existing CodebuildWebhook that should be imported.\"},\"name\":\"importFromId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"? Optional instance of the provider where the CodebuildWebhook to import is found.\"},\"name\":\"provider\",\"optional\":true,\"type\":{\"fqn\":\"cdktn.TerraformProvider\"}}]")]
        public static Io.Cdktn.ImportableResource GenerateConfigForImport(Constructs.Construct scope, string importToId, string importFromId, Io.Cdktn.TerraformProvider? provider = null)
        {
            return InvokeStaticMethod<Io.Cdktn.ImportableResource>(typeof(aws.CodebuildWebhook.CodebuildWebhook), new System.Type[]{typeof(Constructs.Construct), typeof(string), typeof(string), typeof(Io.Cdktn.TerraformProvider)}, new object?[]{scope, importToId, importFromId, provider})!;
        }

        /// <param name="value">Type union: either <see cref="Io.Cdktn.IResolvable" /> or (<see cref="aws.CodebuildWebhook.ICodebuildWebhookFilterGroup" />)[]</param>
        [JsiiMethod(name: "putFilterGroup", parametersJson: "[{\"name\":\"value\",\"type\":{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.codebuildWebhook.CodebuildWebhookFilterGroup\"},\"kind\":\"array\"}}]}}}]")]
            ...
            if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
            {
                switch (@value)
                {
                    ...
                    case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_2ed7d7:
                        ...
                        break;
                    case null:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.CodebuildWebhook.ICodebuildWebhookFilterGroup).FullName}[]; received null", nameof(@value));
                    default:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.CodebuildWebhook.ICodebuildWebhookFilterGroup).FullName}[]; received {@value.GetType().FullName}", nameof(@value));
                }
            }
            InvokeInstanceVoidMethod(new System.Type[]{typeof(object)}, new object[]{@value});
        }

        [JsiiMethod(name: "putPullRequestBuildPolicy", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"aws.codebuildWebhook.CodebuildWebhookPullRequestBuildPolicy\"}}]")]
        public virtual void PutPullRequestBuildPolicy(aws.CodebuildWebhook.ICodebuildWebhookPullRequestBuildPolicy @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(aws.CodebuildWebhook.ICodebuildWebhookPullRequestBuildPolicy)}, new object[]{@value});
        }
        ...
        [JsiiMethod(name: "resetPullRequestBuildPolicy")]
        public virtual void ResetPullRequestBuildPolicy()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        [JsiiProperty(name: "pullRequestBuildPolicy", typeJson: "{\"fqn\":\"aws.codebuildWebhook.CodebuildWebhookPullRequestBuildPolicyOutputReference\"}")]
        public virtual aws.CodebuildWebhook.CodebuildWebhookPullRequestBuildPolicyOutputReference PullRequestBuildPolicy
        {
            get => GetInstanceProperty<aws.CodebuildWebhook.CodebuildWebhookPullRequestBuildPolicyOutputReference>()!;
        }
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "filterGroupInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.codebuildWebhook.CodebuildWebhookFilterGroup\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "manualCreationInput", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktn.IResolvable\"}]}}", isOptional: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "pullRequestBuildPolicyInput", typeJson: "{\"fqn\":\"aws.codebuildWebhook.CodebuildWebhookPullRequestBuildPolicy\"}", isOptional: true)]
        public virtual aws.CodebuildWebhook.ICodebuildWebhookPullRequestBuildPolicy? PullRequestBuildPolicyInput
        {
        ...
        /// <para>Type union: either bool or <see cref="Io.Cdktn.IResolvable" /></para>
        /// </remarks>
        [JsiiProperty(name: "manualCreation", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktn.IResolvable\"}]}}")]
