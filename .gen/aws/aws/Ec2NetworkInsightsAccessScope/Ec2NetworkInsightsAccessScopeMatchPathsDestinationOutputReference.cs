...
namespace aws.Ec2NetworkInsightsAccessScope
{
    ...
    public class Ec2NetworkInsightsAccessScopeMatchPathsDestinationOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        /// <param name="value">Type union: either <see cref="Io.Cdktn.IResolvable" /> or (<see cref="aws.Ec2NetworkInsightsAccessScope.IEc2NetworkInsightsAccessScopeMatchPathsDestinationPacketHeaderStatement" />)[]</param>
        ...
        /// <param name="value">Type union: either <see cref="Io.Cdktn.IResolvable" /> or (<see cref="aws.Ec2NetworkInsightsAccessScope.IEc2NetworkInsightsAccessScopeMatchPathsDestinationResourceStatement" />)[]</param>
