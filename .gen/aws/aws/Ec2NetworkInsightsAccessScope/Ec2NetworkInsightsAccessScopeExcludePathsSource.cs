...
namespace aws.Ec2NetworkInsightsAccessScope
{
    ...
    public class Ec2NetworkInsightsAccessScopeExcludePathsSource : aws.Ec2NetworkInsightsAccessScope.IEc2NetworkInsightsAccessScopeExcludePathsSource
    {
        ...
        /// <para>Type union: either <see cref="Io.Cdktn.IResolvable" /> or (<see cref="aws.Ec2NetworkInsightsAccessScope.IEc2NetworkInsightsAccessScopeExcludePathsSourcePacketHeaderStatement" />)[]</para>
        /// </remarks>
        [JsiiOptional]
        ...
        /// <para>Type union: either <see cref="Io.Cdktn.IResolvable" /> or (<see cref="aws.Ec2NetworkInsightsAccessScope.IEc2NetworkInsightsAccessScopeExcludePathsSourceResourceStatement" />)[]</para>
        /// </remarks>
        [JsiiOptional]
