...
{
    [JsiiByValue(fqn: "aws.outpostsCapacityTask.OutpostsCapacityTaskTimeouts")]
    public class OutpostsCapacityTaskTimeouts : aws.OutpostsCapacityTask.IOutpostsCapacityTaskTimeouts
    {
