...
{
    [JsiiByValue(fqn: "aws.dmsDataProvider.DmsDataProviderSettingsOracleSettings")]
    public class DmsDataProviderSettingsOracleSettings : aws.DmsDataProvider.IDmsDataProviderSettingsOracleSettings
    {
