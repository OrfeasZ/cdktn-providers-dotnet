...
{
    [JsiiByValue(fqn: "aws.dmsDataProvider.DmsDataProviderSettingsPostgresqlSettings")]
    public class DmsDataProviderSettingsPostgresqlSettings : aws.DmsDataProvider.IDmsDataProviderSettingsPostgresqlSettings
    {
