...
{
    [JsiiByValue(fqn: "aws.dmsDataProvider.DmsDataProviderSettingsMariaDbSettings")]
    public class DmsDataProviderSettingsMariaDbSettings : aws.DmsDataProvider.IDmsDataProviderSettingsMariaDbSettings
    {
