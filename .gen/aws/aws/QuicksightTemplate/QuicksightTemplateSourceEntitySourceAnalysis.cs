...
namespace aws.QuicksightTemplate
{
    ...
    public class QuicksightTemplateSourceEntitySourceAnalysis : aws.QuicksightTemplate.IQuicksightTemplateSourceEntitySourceAnalysis
    {
        ...
        /// <remarks>
        /// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.59.0/docs/resources/quicksight_template#data_set_references QuicksightTemplate#data_set_references}
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            ...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.QuicksightTemplate.IQuicksightTemplateSourceEntitySourceAnalysisDataSetReferences).FullName}[]; received null", nameof(value));
                        default:
