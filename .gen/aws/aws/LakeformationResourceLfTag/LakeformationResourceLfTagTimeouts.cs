...
{
    [JsiiByValue(fqn: "aws.lakeformationResourceLfTag.LakeformationResourceLfTagTimeouts")]
    public class LakeformationResourceLfTagTimeouts : aws.LakeformationResourceLfTag.ILakeformationResourceLfTagTimeouts
    {
