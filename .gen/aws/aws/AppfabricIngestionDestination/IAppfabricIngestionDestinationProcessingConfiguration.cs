...
namespace aws.AppfabricIngestionDestination
{
    ...
    public interface IAppfabricIngestionDestinationProcessingConfiguration
    {
        ...
        /// <remarks>
        /// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.43.0/docs/resources/appfabric_ingestion_destination#audit_log AppfabricIngestionDestination#audit_log}
        /// </remarks>
        [JsiiProperty(name: "auditLog", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.appfabricIngestionDestination.AppfabricIngestionDestinationProcessingConfigurationAuditLog\"},\"kind\":\"array\"}}]}}", isOptional: true)]
