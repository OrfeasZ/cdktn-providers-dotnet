...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.41.0/docs/resources/cognito_identity_pool aws_cognito_identity_pool}.</summary>
    ...
    public class CognitoIdentityPool : Io.Cdktn.TerraformResource
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.41.0/docs/resources/cognito_identity_pool aws_cognito_identity_pool} Resource.</summary>
        ...
        /// <summary>Generates CDKTN code for importing a CognitoIdentityPool resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
            ...
            if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
            {
                switch (@value)
                {
                    ...
                    case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_2ed7d7:
                        ...
                        break;
                    case null:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.CognitoIdentityPool.ICognitoIdentityPoolCognitoIdentityProviders).FullName}[]; received null", nameof(@value));
                    default:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.CognitoIdentityPool.ICognitoIdentityPoolCognitoIdentityProviders).FullName}[]; received {@value.GetType().FullName}", nameof(@value));
                }
            }
