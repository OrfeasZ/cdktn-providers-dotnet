...
namespace aws.SecurityhubFeatureV2
{
    ...
    [JsiiByValue(fqn: "aws.securityhubFeatureV2.SecurityhubFeatureV2Config")]
    public class SecurityhubFeatureV2Config : aws.SecurityhubFeatureV2.ISecurityhubFeatureV2Config
    {
