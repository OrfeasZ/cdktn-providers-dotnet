...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.64.0/docs/resources/cloudwatch_metric_alarm aws_cloudwatch_metric_alarm}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.64.0/docs/resources/cloudwatch_metric_alarm aws_cloudwatch_metric_alarm} Resource.</summary>
        ...
        /// <summary>Generates CDKTN code for importing a CloudwatchMetricAlarm resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
            ...
            if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
            {
                switch (@value)
                {
                    ...
                    case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_2ed7d7:
                        ...
                        break;
                    case null:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.CloudwatchMetricAlarm.ICloudwatchMetricAlarmMetricQuery).FullName}[]; received null", nameof(@value));
                    default:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.CloudwatchMetricAlarm.ICloudwatchMetricAlarmMetricQuery).FullName}[]; received {@value.GetType().FullName}", nameof(@value));
                }
            }
            InvokeInstanceVoidMethod(new System.Type[]{typeof(object)}, new object[]{@value});
        }

        [JsiiMethod(name: "putWarmUpConfiguration", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"aws.cloudwatchMetricAlarm.CloudwatchMetricAlarmWarmUpConfiguration\"}}]")]
        public virtual void PutWarmUpConfiguration(aws.CloudwatchMetricAlarm.ICloudwatchMetricAlarmWarmUpConfiguration @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(aws.CloudwatchMetricAlarm.ICloudwatchMetricAlarmWarmUpConfiguration)}, new object[]{@value});
        }
        ...
        [JsiiMethod(name: "resetWarmUpConfiguration")]
        public virtual void ResetWarmUpConfiguration()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        [JsiiProperty(name: "warmUpConfiguration", typeJson: "{\"fqn\":\"aws.cloudwatchMetricAlarm.CloudwatchMetricAlarmWarmUpConfigurationOutputReference\"}")]
        public virtual aws.CloudwatchMetricAlarm.CloudwatchMetricAlarmWarmUpConfigurationOutputReference WarmUpConfiguration
        {
            get => GetInstanceProperty<aws.CloudwatchMetricAlarm.CloudwatchMetricAlarmWarmUpConfigurationOutputReference>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "warmUpConfigurationInput", typeJson: "{\"fqn\":\"aws.cloudwatchMetricAlarm.CloudwatchMetricAlarmWarmUpConfiguration\"}", isOptional: true)]
        public virtual aws.CloudwatchMetricAlarm.ICloudwatchMetricAlarmWarmUpConfiguration? WarmUpConfigurationInput
        {
            get => GetInstanceProperty<aws.CloudwatchMetricAlarm.ICloudwatchMetricAlarmWarmUpConfiguration?>();
        }
