...
{
    [JsiiClass(nativeType: typeof(aws.AlbListenerRule.AlbListenerRuleActionOutputReference), fullyQualifiedName: "aws.albListenerRule.AlbListenerRuleActionOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktn.IInterpolatingParent\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"the index of this item in the list.\"},\"name\":\"complexObjectIndex\",\"type\":{\"primitive\":\"number\"}},{\"docs\":{\"summary\":\"whether the list is wrapping a set (will add tolist() to be able to access an item via an index).\"},\"name\":\"complexObjectIsFromSet\",\"type\":{\"primitive\":\"boolean\"}}]")]
    public class AlbListenerRuleActionOutputReference : Io.Cdktn.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        /// <param name="complexObjectIndex">the index of this item in the list.</param>
        /// <param name="complexObjectIsFromSet">whether the list is wrapping a set (will add tolist() to be able to access an item via an index).</param>
        public AlbListenerRuleActionOutputReference(Io.Cdktn.IInterpolatingParent terraformResource, string terraformAttribute, double complexObjectIndex, bool complexObjectIsFromSet): base(_MakeDeputyProps(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet))
        {
        }
        ...
        [JsiiMethod(name: "putJwtValidation", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"aws.albListenerRule.AlbListenerRuleActionJwtValidation\"}}]")]
        public virtual void PutJwtValidation(aws.AlbListenerRule.IAlbListenerRuleActionJwtValidation @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(aws.AlbListenerRule.IAlbListenerRuleActionJwtValidation)}, new object[]{@value});
        }
        ...
        [JsiiProperty(name: "jwtValidation", typeJson: "{\"fqn\":\"aws.albListenerRule.AlbListenerRuleActionJwtValidationOutputReference\"}")]
        public virtual aws.AlbListenerRule.AlbListenerRuleActionJwtValidationOutputReference JwtValidation
        {
            get => GetInstanceProperty<aws.AlbListenerRule.AlbListenerRuleActionJwtValidationOutputReference>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "jwtValidationInput", typeJson: "{\"fqn\":\"aws.albListenerRule.AlbListenerRuleActionJwtValidation\"}", isOptional: true)]
        public virtual aws.AlbListenerRule.IAlbListenerRuleActionJwtValidation? JwtValidationInput
        {
            get => GetInstanceProperty<aws.AlbListenerRule.IAlbListenerRuleActionJwtValidation?>();
        }
