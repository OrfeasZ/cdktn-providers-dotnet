...
namespace aws.MailmanagerRuleSet
{
    ...
    public interface IMailmanagerRuleSetRuleConditionBooleanExpressionEvaluateIsInAddressListStruct
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IMailmanagerRuleSetRuleConditionBooleanExpressionEvaluateIsInAddressListStruct), fullyQualifiedName: "aws.mailmanagerRuleSet.MailmanagerRuleSetRuleConditionBooleanExpressionEvaluateIsInAddressListStruct")]
        internal sealed class _Proxy : DeputyBase, aws.MailmanagerRuleSet.IMailmanagerRuleSetRuleConditionBooleanExpressionEvaluateIsInAddressListStruct
        {
