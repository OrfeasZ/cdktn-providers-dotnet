...
{
    [JsiiByValue(fqn: "aws.budgetsBudget.BudgetsBudgetFilterExpressionOrOrCostCategories")]
    public class BudgetsBudgetFilterExpressionOrOrCostCategories : aws.BudgetsBudget.IBudgetsBudgetFilterExpressionOrOrCostCategories
    {
