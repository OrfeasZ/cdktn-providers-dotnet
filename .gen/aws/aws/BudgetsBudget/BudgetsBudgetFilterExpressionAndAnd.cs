...
{
    [JsiiByValue(fqn: "aws.budgetsBudget.BudgetsBudgetFilterExpressionAndAnd")]
    public class BudgetsBudgetFilterExpressionAndAnd : aws.BudgetsBudget.IBudgetsBudgetFilterExpressionAndAnd
    {
