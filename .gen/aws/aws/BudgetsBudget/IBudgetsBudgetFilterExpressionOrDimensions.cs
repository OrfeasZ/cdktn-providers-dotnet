...
{
    [JsiiInterface(nativeType: typeof(IBudgetsBudgetFilterExpressionOrDimensions), fullyQualifiedName: "aws.budgetsBudget.BudgetsBudgetFilterExpressionOrDimensions")]
    public interface IBudgetsBudgetFilterExpressionOrDimensions
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IBudgetsBudgetFilterExpressionOrDimensions), fullyQualifiedName: "aws.budgetsBudget.BudgetsBudgetFilterExpressionOrDimensions")]
        internal sealed class _Proxy : DeputyBase, aws.BudgetsBudget.IBudgetsBudgetFilterExpressionOrDimensions
        {
