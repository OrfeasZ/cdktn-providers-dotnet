...
{
    [JsiiInterface(nativeType: typeof(IBudgetsBudgetFilterExpressionOrOrTags), fullyQualifiedName: "aws.budgetsBudget.BudgetsBudgetFilterExpressionOrOrTags")]
    public interface IBudgetsBudgetFilterExpressionOrOrTags
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IBudgetsBudgetFilterExpressionOrOrTags), fullyQualifiedName: "aws.budgetsBudget.BudgetsBudgetFilterExpressionOrOrTags")]
        internal sealed class _Proxy : DeputyBase, aws.BudgetsBudget.IBudgetsBudgetFilterExpressionOrOrTags
        {
