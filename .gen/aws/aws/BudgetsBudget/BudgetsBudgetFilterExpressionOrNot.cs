...
{
    [JsiiByValue(fqn: "aws.budgetsBudget.BudgetsBudgetFilterExpressionOrNot")]
    public class BudgetsBudgetFilterExpressionOrNot : aws.BudgetsBudget.IBudgetsBudgetFilterExpressionOrNot
    {
