...
{
    [JsiiInterface(nativeType: typeof(IBudgetsBudgetFilterExpressionAndOrCostCategories), fullyQualifiedName: "aws.budgetsBudget.BudgetsBudgetFilterExpressionAndOrCostCategories")]
    public interface IBudgetsBudgetFilterExpressionAndOrCostCategories
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IBudgetsBudgetFilterExpressionAndOrCostCategories), fullyQualifiedName: "aws.budgetsBudget.BudgetsBudgetFilterExpressionAndOrCostCategories")]
        internal sealed class _Proxy : DeputyBase, aws.BudgetsBudget.IBudgetsBudgetFilterExpressionAndOrCostCategories
        {
