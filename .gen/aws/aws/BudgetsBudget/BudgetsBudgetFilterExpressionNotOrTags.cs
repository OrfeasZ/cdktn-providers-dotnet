...
{
    [JsiiByValue(fqn: "aws.budgetsBudget.BudgetsBudgetFilterExpressionNotOrTags")]
    public class BudgetsBudgetFilterExpressionNotOrTags : aws.BudgetsBudget.IBudgetsBudgetFilterExpressionNotOrTags
    {
