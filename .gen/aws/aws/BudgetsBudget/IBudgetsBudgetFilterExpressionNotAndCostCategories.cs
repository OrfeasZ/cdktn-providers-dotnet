...
{
    [JsiiInterface(nativeType: typeof(IBudgetsBudgetFilterExpressionNotAndCostCategories), fullyQualifiedName: "aws.budgetsBudget.BudgetsBudgetFilterExpressionNotAndCostCategories")]
    public interface IBudgetsBudgetFilterExpressionNotAndCostCategories
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IBudgetsBudgetFilterExpressionNotAndCostCategories), fullyQualifiedName: "aws.budgetsBudget.BudgetsBudgetFilterExpressionNotAndCostCategories")]
        internal sealed class _Proxy : DeputyBase, aws.BudgetsBudget.IBudgetsBudgetFilterExpressionNotAndCostCategories
        {
