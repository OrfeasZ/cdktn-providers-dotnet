...
{
    [JsiiByValue(fqn: "aws.budgetsBudget.BudgetsBudgetFilterExpressionNotAndTags")]
    public class BudgetsBudgetFilterExpressionNotAndTags : aws.BudgetsBudget.IBudgetsBudgetFilterExpressionNotAndTags
    {
