...
{
    [JsiiByValue(fqn: "aws.budgetsBudget.BudgetsBudgetFilterExpressionAndNotTags")]
    public class BudgetsBudgetFilterExpressionAndNotTags : aws.BudgetsBudget.IBudgetsBudgetFilterExpressionAndNotTags
    {
