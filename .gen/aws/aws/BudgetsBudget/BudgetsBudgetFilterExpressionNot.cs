...
{
    [JsiiByValue(fqn: "aws.budgetsBudget.BudgetsBudgetFilterExpressionNot")]
    public class BudgetsBudgetFilterExpressionNot : aws.BudgetsBudget.IBudgetsBudgetFilterExpressionNot
    {
        private object? _and;
