...
{
    [JsiiInterface(nativeType: typeof(IBudgetsBudgetFilterExpressionNotOrTags), fullyQualifiedName: "aws.budgetsBudget.BudgetsBudgetFilterExpressionNotOrTags")]
    public interface IBudgetsBudgetFilterExpressionNotOrTags
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IBudgetsBudgetFilterExpressionNotOrTags), fullyQualifiedName: "aws.budgetsBudget.BudgetsBudgetFilterExpressionNotOrTags")]
        internal sealed class _Proxy : DeputyBase, aws.BudgetsBudget.IBudgetsBudgetFilterExpressionNotOrTags
        {
