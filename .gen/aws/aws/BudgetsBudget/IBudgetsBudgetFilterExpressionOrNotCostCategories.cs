...
{
    [JsiiInterface(nativeType: typeof(IBudgetsBudgetFilterExpressionOrNotCostCategories), fullyQualifiedName: "aws.budgetsBudget.BudgetsBudgetFilterExpressionOrNotCostCategories")]
    public interface IBudgetsBudgetFilterExpressionOrNotCostCategories
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IBudgetsBudgetFilterExpressionOrNotCostCategories), fullyQualifiedName: "aws.budgetsBudget.BudgetsBudgetFilterExpressionOrNotCostCategories")]
        internal sealed class _Proxy : DeputyBase, aws.BudgetsBudget.IBudgetsBudgetFilterExpressionOrNotCostCategories
        {
