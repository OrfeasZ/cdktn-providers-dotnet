...
{
    [JsiiByValue(fqn: "aws.budgetsBudget.BudgetsBudgetFilterExpressionAndAndTags")]
    public class BudgetsBudgetFilterExpressionAndAndTags : aws.BudgetsBudget.IBudgetsBudgetFilterExpressionAndAndTags
    {
