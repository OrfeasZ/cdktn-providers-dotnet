...
{
    [JsiiByValue(fqn: "aws.budgetsBudget.BudgetsBudgetFilterExpressionOrTags")]
    public class BudgetsBudgetFilterExpressionOrTags : aws.BudgetsBudget.IBudgetsBudgetFilterExpressionOrTags
    {
