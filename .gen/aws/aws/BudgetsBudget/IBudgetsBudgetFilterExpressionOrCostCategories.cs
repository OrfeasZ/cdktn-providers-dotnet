...
{
    [JsiiInterface(nativeType: typeof(IBudgetsBudgetFilterExpressionOrCostCategories), fullyQualifiedName: "aws.budgetsBudget.BudgetsBudgetFilterExpressionOrCostCategories")]
    public interface IBudgetsBudgetFilterExpressionOrCostCategories
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IBudgetsBudgetFilterExpressionOrCostCategories), fullyQualifiedName: "aws.budgetsBudget.BudgetsBudgetFilterExpressionOrCostCategories")]
        internal sealed class _Proxy : DeputyBase, aws.BudgetsBudget.IBudgetsBudgetFilterExpressionOrCostCategories
        {
