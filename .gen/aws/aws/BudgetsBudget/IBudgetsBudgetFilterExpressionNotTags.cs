...
{
    [JsiiInterface(nativeType: typeof(IBudgetsBudgetFilterExpressionNotTags), fullyQualifiedName: "aws.budgetsBudget.BudgetsBudgetFilterExpressionNotTags")]
    public interface IBudgetsBudgetFilterExpressionNotTags
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IBudgetsBudgetFilterExpressionNotTags), fullyQualifiedName: "aws.budgetsBudget.BudgetsBudgetFilterExpressionNotTags")]
        internal sealed class _Proxy : DeputyBase, aws.BudgetsBudget.IBudgetsBudgetFilterExpressionNotTags
        {
