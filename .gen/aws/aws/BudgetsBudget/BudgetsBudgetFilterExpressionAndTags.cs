...
{
    [JsiiByValue(fqn: "aws.budgetsBudget.BudgetsBudgetFilterExpressionAndTags")]
    public class BudgetsBudgetFilterExpressionAndTags : aws.BudgetsBudget.IBudgetsBudgetFilterExpressionAndTags
    {
