...
{
    [JsiiByValue(fqn: "aws.budgetsBudget.BudgetsBudgetFilterExpressionOrAndCostCategories")]
    public class BudgetsBudgetFilterExpressionOrAndCostCategories : aws.BudgetsBudget.IBudgetsBudgetFilterExpressionOrAndCostCategories
    {
