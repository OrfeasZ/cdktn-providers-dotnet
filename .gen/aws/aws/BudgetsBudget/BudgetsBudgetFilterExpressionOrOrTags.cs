...
{
    [JsiiByValue(fqn: "aws.budgetsBudget.BudgetsBudgetFilterExpressionOrOrTags")]
    public class BudgetsBudgetFilterExpressionOrOrTags : aws.BudgetsBudget.IBudgetsBudgetFilterExpressionOrOrTags
    {
