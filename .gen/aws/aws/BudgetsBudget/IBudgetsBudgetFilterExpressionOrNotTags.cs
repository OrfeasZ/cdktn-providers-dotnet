...
{
    [JsiiInterface(nativeType: typeof(IBudgetsBudgetFilterExpressionOrNotTags), fullyQualifiedName: "aws.budgetsBudget.BudgetsBudgetFilterExpressionOrNotTags")]
    public interface IBudgetsBudgetFilterExpressionOrNotTags
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IBudgetsBudgetFilterExpressionOrNotTags), fullyQualifiedName: "aws.budgetsBudget.BudgetsBudgetFilterExpressionOrNotTags")]
        internal sealed class _Proxy : DeputyBase, aws.BudgetsBudget.IBudgetsBudgetFilterExpressionOrNotTags
        {
