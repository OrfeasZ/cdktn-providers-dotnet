...
{
    [JsiiInterface(nativeType: typeof(IBudgetsBudgetFilterExpressionOrAndTags), fullyQualifiedName: "aws.budgetsBudget.BudgetsBudgetFilterExpressionOrAndTags")]
    public interface IBudgetsBudgetFilterExpressionOrAndTags
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IBudgetsBudgetFilterExpressionOrAndTags), fullyQualifiedName: "aws.budgetsBudget.BudgetsBudgetFilterExpressionOrAndTags")]
        internal sealed class _Proxy : DeputyBase, aws.BudgetsBudget.IBudgetsBudgetFilterExpressionOrAndTags
        {
