...
{
    [JsiiByValue(fqn: "aws.budgetsBudget.BudgetsBudgetFilterExpressionAndAndCostCategories")]
    public class BudgetsBudgetFilterExpressionAndAndCostCategories : aws.BudgetsBudget.IBudgetsBudgetFilterExpressionAndAndCostCategories
    {
