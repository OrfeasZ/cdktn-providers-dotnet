...
{
    [JsiiInterface(nativeType: typeof(IBudgetsBudgetFilterExpressionNotOrDimensions), fullyQualifiedName: "aws.budgetsBudget.BudgetsBudgetFilterExpressionNotOrDimensions")]
    public interface IBudgetsBudgetFilterExpressionNotOrDimensions
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IBudgetsBudgetFilterExpressionNotOrDimensions), fullyQualifiedName: "aws.budgetsBudget.BudgetsBudgetFilterExpressionNotOrDimensions")]
        internal sealed class _Proxy : DeputyBase, aws.BudgetsBudget.IBudgetsBudgetFilterExpressionNotOrDimensions
        {
