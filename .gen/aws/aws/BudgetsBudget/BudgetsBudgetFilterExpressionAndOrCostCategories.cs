...
{
    [JsiiByValue(fqn: "aws.budgetsBudget.BudgetsBudgetFilterExpressionAndOrCostCategories")]
    public class BudgetsBudgetFilterExpressionAndOrCostCategories : aws.BudgetsBudget.IBudgetsBudgetFilterExpressionAndOrCostCategories
    {
