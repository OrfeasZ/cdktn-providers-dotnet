...
{
    [JsiiByValue(fqn: "aws.budgetsBudget.BudgetsBudgetFilterExpressionTags")]
    public class BudgetsBudgetFilterExpressionTags : aws.BudgetsBudget.IBudgetsBudgetFilterExpressionTags
    {
