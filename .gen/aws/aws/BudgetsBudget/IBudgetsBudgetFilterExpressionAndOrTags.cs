...
{
    [JsiiInterface(nativeType: typeof(IBudgetsBudgetFilterExpressionAndOrTags), fullyQualifiedName: "aws.budgetsBudget.BudgetsBudgetFilterExpressionAndOrTags")]
    public interface IBudgetsBudgetFilterExpressionAndOrTags
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IBudgetsBudgetFilterExpressionAndOrTags), fullyQualifiedName: "aws.budgetsBudget.BudgetsBudgetFilterExpressionAndOrTags")]
        internal sealed class _Proxy : DeputyBase, aws.BudgetsBudget.IBudgetsBudgetFilterExpressionAndOrTags
        {
