...
{
    [JsiiByValue(fqn: "aws.budgetsBudget.BudgetsBudgetFilterExpressionAndCostCategories")]
    public class BudgetsBudgetFilterExpressionAndCostCategories : aws.BudgetsBudget.IBudgetsBudgetFilterExpressionAndCostCategories
    {
