...
{
    [JsiiInterface(nativeType: typeof(IBudgetsBudgetFilterExpressionAndNotCostCategories), fullyQualifiedName: "aws.budgetsBudget.BudgetsBudgetFilterExpressionAndNotCostCategories")]
    public interface IBudgetsBudgetFilterExpressionAndNotCostCategories
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IBudgetsBudgetFilterExpressionAndNotCostCategories), fullyQualifiedName: "aws.budgetsBudget.BudgetsBudgetFilterExpressionAndNotCostCategories")]
        internal sealed class _Proxy : DeputyBase, aws.BudgetsBudget.IBudgetsBudgetFilterExpressionAndNotCostCategories
        {
