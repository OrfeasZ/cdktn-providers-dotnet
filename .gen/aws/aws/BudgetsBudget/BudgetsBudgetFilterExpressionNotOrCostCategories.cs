...
{
    [JsiiByValue(fqn: "aws.budgetsBudget.BudgetsBudgetFilterExpressionNotOrCostCategories")]
    public class BudgetsBudgetFilterExpressionNotOrCostCategories : aws.BudgetsBudget.IBudgetsBudgetFilterExpressionNotOrCostCategories
    {
