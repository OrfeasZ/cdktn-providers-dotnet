...
{
    [JsiiByValue(fqn: "aws.budgetsBudget.BudgetsBudgetFilterExpressionNotNotTags")]
    public class BudgetsBudgetFilterExpressionNotNotTags : aws.BudgetsBudget.IBudgetsBudgetFilterExpressionNotNotTags
    {
