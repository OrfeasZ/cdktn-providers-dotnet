...
{
    [JsiiByValue(fqn: "aws.budgetsBudget.BudgetsBudgetFilterExpressionOrCostCategories")]
    public class BudgetsBudgetFilterExpressionOrCostCategories : aws.BudgetsBudget.IBudgetsBudgetFilterExpressionOrCostCategories
    {
