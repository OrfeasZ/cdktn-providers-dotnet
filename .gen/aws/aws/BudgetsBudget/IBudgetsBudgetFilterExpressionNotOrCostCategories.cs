...
{
    [JsiiInterface(nativeType: typeof(IBudgetsBudgetFilterExpressionNotOrCostCategories), fullyQualifiedName: "aws.budgetsBudget.BudgetsBudgetFilterExpressionNotOrCostCategories")]
    public interface IBudgetsBudgetFilterExpressionNotOrCostCategories
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IBudgetsBudgetFilterExpressionNotOrCostCategories), fullyQualifiedName: "aws.budgetsBudget.BudgetsBudgetFilterExpressionNotOrCostCategories")]
        internal sealed class _Proxy : DeputyBase, aws.BudgetsBudget.IBudgetsBudgetFilterExpressionNotOrCostCategories
        {
