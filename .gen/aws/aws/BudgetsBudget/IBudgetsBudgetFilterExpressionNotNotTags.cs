...
{
    [JsiiInterface(nativeType: typeof(IBudgetsBudgetFilterExpressionNotNotTags), fullyQualifiedName: "aws.budgetsBudget.BudgetsBudgetFilterExpressionNotNotTags")]
    public interface IBudgetsBudgetFilterExpressionNotNotTags
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IBudgetsBudgetFilterExpressionNotNotTags), fullyQualifiedName: "aws.budgetsBudget.BudgetsBudgetFilterExpressionNotNotTags")]
        internal sealed class _Proxy : DeputyBase, aws.BudgetsBudget.IBudgetsBudgetFilterExpressionNotNotTags
        {
