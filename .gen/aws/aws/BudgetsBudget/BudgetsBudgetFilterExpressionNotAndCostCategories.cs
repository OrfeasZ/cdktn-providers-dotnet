...
{
    [JsiiByValue(fqn: "aws.budgetsBudget.BudgetsBudgetFilterExpressionNotAndCostCategories")]
    public class BudgetsBudgetFilterExpressionNotAndCostCategories : aws.BudgetsBudget.IBudgetsBudgetFilterExpressionNotAndCostCategories
    {
