...
{
    [JsiiByValue(fqn: "aws.budgetsBudget.BudgetsBudgetFilterExpressionNotTags")]
    public class BudgetsBudgetFilterExpressionNotTags : aws.BudgetsBudget.IBudgetsBudgetFilterExpressionNotTags
    {
