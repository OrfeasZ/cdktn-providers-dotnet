...
{
    [JsiiByValue(fqn: "aws.budgetsBudget.BudgetsBudgetFilterExpressionAndNotCostCategories")]
    public class BudgetsBudgetFilterExpressionAndNotCostCategories : aws.BudgetsBudget.IBudgetsBudgetFilterExpressionAndNotCostCategories
    {
