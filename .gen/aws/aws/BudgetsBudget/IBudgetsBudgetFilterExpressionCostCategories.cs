...
{
    [JsiiInterface(nativeType: typeof(IBudgetsBudgetFilterExpressionCostCategories), fullyQualifiedName: "aws.budgetsBudget.BudgetsBudgetFilterExpressionCostCategories")]
    public interface IBudgetsBudgetFilterExpressionCostCategories
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IBudgetsBudgetFilterExpressionCostCategories), fullyQualifiedName: "aws.budgetsBudget.BudgetsBudgetFilterExpressionCostCategories")]
        internal sealed class _Proxy : DeputyBase, aws.BudgetsBudget.IBudgetsBudgetFilterExpressionCostCategories
        {
