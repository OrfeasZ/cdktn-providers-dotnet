...
{
    [JsiiInterface(nativeType: typeof(IBudgetsBudgetFilterExpressionOrNotDimensions), fullyQualifiedName: "aws.budgetsBudget.BudgetsBudgetFilterExpressionOrNotDimensions")]
    public interface IBudgetsBudgetFilterExpressionOrNotDimensions
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IBudgetsBudgetFilterExpressionOrNotDimensions), fullyQualifiedName: "aws.budgetsBudget.BudgetsBudgetFilterExpressionOrNotDimensions")]
        internal sealed class _Proxy : DeputyBase, aws.BudgetsBudget.IBudgetsBudgetFilterExpressionOrNotDimensions
        {
