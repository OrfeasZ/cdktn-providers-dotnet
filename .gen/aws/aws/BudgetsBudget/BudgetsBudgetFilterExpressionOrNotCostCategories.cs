...
{
    [JsiiByValue(fqn: "aws.budgetsBudget.BudgetsBudgetFilterExpressionOrNotCostCategories")]
    public class BudgetsBudgetFilterExpressionOrNotCostCategories : aws.BudgetsBudget.IBudgetsBudgetFilterExpressionOrNotCostCategories
    {
