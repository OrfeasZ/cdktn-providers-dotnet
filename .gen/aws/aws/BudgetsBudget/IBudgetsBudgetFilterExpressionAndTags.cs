...
{
    [JsiiInterface(nativeType: typeof(IBudgetsBudgetFilterExpressionAndTags), fullyQualifiedName: "aws.budgetsBudget.BudgetsBudgetFilterExpressionAndTags")]
    public interface IBudgetsBudgetFilterExpressionAndTags
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IBudgetsBudgetFilterExpressionAndTags), fullyQualifiedName: "aws.budgetsBudget.BudgetsBudgetFilterExpressionAndTags")]
        internal sealed class _Proxy : DeputyBase, aws.BudgetsBudget.IBudgetsBudgetFilterExpressionAndTags
        {
