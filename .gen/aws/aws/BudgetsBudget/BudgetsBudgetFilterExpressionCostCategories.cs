...
{
    [JsiiByValue(fqn: "aws.budgetsBudget.BudgetsBudgetFilterExpressionCostCategories")]
    public class BudgetsBudgetFilterExpressionCostCategories : aws.BudgetsBudget.IBudgetsBudgetFilterExpressionCostCategories
    {
