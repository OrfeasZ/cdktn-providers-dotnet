...
{
    [JsiiClass(nativeType: typeof(aws.EcsService.EcsServiceServiceConnectConfigurationOutputReference), fullyQualifiedName: "aws.ecsService.EcsServiceServiceConnectConfigurationOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktn.IInterpolatingParent\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}}]")]
    public class EcsServiceServiceConnectConfigurationOutputReference : Io.Cdktn.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        public EcsServiceServiceConnectConfigurationOutputReference(Io.Cdktn.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
        ...
        [JsiiMethod(name: "putAccessLogConfiguration", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"aws.ecsService.EcsServiceServiceConnectConfigurationAccessLogConfiguration\"}}]")]
        public virtual void PutAccessLogConfiguration(aws.EcsService.IEcsServiceServiceConnectConfigurationAccessLogConfiguration @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(aws.EcsService.IEcsServiceServiceConnectConfigurationAccessLogConfiguration)}, new object[]{@value});
        }
            ...
            if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
            {
                switch (@value)
                {
                    ...
                    case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_2ed7d7:
                        ...
                        break;
                    case null:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.EcsService.IEcsServiceServiceConnectConfigurationService).FullName}[]; received null", nameof(@value));
                    default:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.EcsService.IEcsServiceServiceConnectConfigurationService).FullName}[]; received {@value.GetType().FullName}", nameof(@value));
                }
            }
            InvokeInstanceVoidMethod(new System.Type[]{typeof(object)}, new object[]{@value});
        }

        [JsiiMethod(name: "resetAccessLogConfiguration")]
        public virtual void ResetAccessLogConfiguration()
        {
        ...
        [JsiiProperty(name: "accessLogConfiguration", typeJson: "{\"fqn\":\"aws.ecsService.EcsServiceServiceConnectConfigurationAccessLogConfigurationOutputReference\"}")]
        public virtual aws.EcsService.EcsServiceServiceConnectConfigurationAccessLogConfigurationOutputReference AccessLogConfiguration
        {
            get => GetInstanceProperty<aws.EcsService.EcsServiceServiceConnectConfigurationAccessLogConfigurationOutputReference>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "accessLogConfigurationInput", typeJson: "{\"fqn\":\"aws.ecsService.EcsServiceServiceConnectConfigurationAccessLogConfiguration\"}", isOptional: true)]
        public virtual aws.EcsService.IEcsServiceServiceConnectConfigurationAccessLogConfiguration? AccessLogConfigurationInput
        {
