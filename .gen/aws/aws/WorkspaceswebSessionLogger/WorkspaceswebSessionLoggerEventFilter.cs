...
namespace aws.WorkspaceswebSessionLogger
{
    ...
    public class WorkspaceswebSessionLoggerEventFilter : aws.WorkspaceswebSessionLogger.IWorkspaceswebSessionLoggerEventFilter
    {
        ...
        /// <summary>Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/workspacesweb_session_logger#include WorkspaceswebSessionLogger#include}.</summary>
        [JsiiOptional]
