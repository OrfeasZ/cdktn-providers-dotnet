...
namespace aws.DlmLifecyclePolicy
{
    ...
    public class DlmLifecyclePolicyPolicyDetailsActionCrossRegionCopyOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"aws.dlmLifecyclePolicy.DlmLifecyclePolicyPolicyDetailsActionCrossRegionCopy\"}]}}", isOptional: true)]
