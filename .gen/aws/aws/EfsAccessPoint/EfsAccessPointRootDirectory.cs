...
namespace aws.EfsAccessPoint
{
    ...
    public class EfsAccessPointRootDirectory : aws.EfsAccessPoint.IEfsAccessPointRootDirectory
    {
        ...
        /// <summary>Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/efs_access_point#path EfsAccessPoint#path}.</summary>
        [JsiiOptional]
