...
namespace aws.AppsyncApi
{
    ...
    public interface IAppsyncApiEventConfigDefaultPublishAuthMode
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IAppsyncApiEventConfigDefaultPublishAuthMode), fullyQualifiedName: "aws.appsyncApi.AppsyncApiEventConfigDefaultPublishAuthMode")]
        internal sealed class _Proxy : DeputyBase, aws.AppsyncApi.IAppsyncApiEventConfigDefaultPublishAuthMode
        {
