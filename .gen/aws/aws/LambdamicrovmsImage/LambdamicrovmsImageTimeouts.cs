...
{
    [JsiiByValue(fqn: "aws.lambdamicrovmsImage.LambdamicrovmsImageTimeouts")]
    public class LambdamicrovmsImageTimeouts : aws.LambdamicrovmsImage.ILambdamicrovmsImageTimeouts
    {
