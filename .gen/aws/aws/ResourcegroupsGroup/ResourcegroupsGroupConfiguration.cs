...
namespace aws.ResourcegroupsGroup
{
    ...
    public class ResourcegroupsGroupConfiguration : aws.ResourcegroupsGroup.IResourcegroupsGroupConfiguration
    {
        ...
        /// <remarks>
        /// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.0/docs/resources/resourcegroups_group#parameters ResourcegroupsGroup#parameters}
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case null:
                            break;
                        default:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.ResourcegroupsGroup.IResourcegroupsGroupConfigurationParameters).FullName}[]; received {value.GetType().FullName}", nameof(value));
                    }
                }
                _parameters = value;
            }
