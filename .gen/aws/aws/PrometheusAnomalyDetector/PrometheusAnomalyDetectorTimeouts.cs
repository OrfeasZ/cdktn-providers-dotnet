...
{
    [JsiiByValue(fqn: "aws.prometheusAnomalyDetector.PrometheusAnomalyDetectorTimeouts")]
    public class PrometheusAnomalyDetectorTimeouts : aws.PrometheusAnomalyDetector.IPrometheusAnomalyDetectorTimeouts
    {
