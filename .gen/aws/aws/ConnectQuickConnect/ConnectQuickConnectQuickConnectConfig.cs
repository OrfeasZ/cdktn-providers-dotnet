...
namespace aws.ConnectQuickConnect
{
    ...
    {
        /// <summary>Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.59.0/docs/resources/connect_quick_connect#quick_connect_type ConnectQuickConnect#quick_connect_type}.</summary>
        ...
        /// <remarks>
        /// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.59.0/docs/resources/connect_quick_connect#phone_config ConnectQuickConnect#phone_config}
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case null:
                            break;
                        default:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.ConnectQuickConnect.IConnectQuickConnectQuickConnectConfigPhoneConfig).FullName}[]; received {value.GetType().FullName}", nameof(value));
                    }
                }
                _phoneConfig = value;
            }
        ...
        /// <remarks>
        /// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.59.0/docs/resources/connect_quick_connect#queue_config ConnectQuickConnect#queue_config}
        ...
        /// <remarks>
        /// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.59.0/docs/resources/connect_quick_connect#user_config ConnectQuickConnect#user_config}
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case null:
                            break;
                        default:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.ConnectQuickConnect.IConnectQuickConnectQuickConnectConfigUserConfig).FullName}[]; received {value.GetType().FullName}", nameof(value));
                    }
                }
                _userConfig = value;
            }
