...
namespace aws.LbListener
{
    ...
    public class LbListenerDefaultActionOutputReference : Io.Cdktn.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        /// <param name="complexObjectIndex">the index of this item in the list.</param>
        /// <param name="complexObjectIsFromSet">whether the list is wrapping a set (will add tolist() to be able to access an item via an index).</param>
        public LbListenerDefaultActionOutputReference(Io.Cdktn.IInterpolatingParent terraformResource, string terraformAttribute, double complexObjectIndex, bool complexObjectIsFromSet): base(_MakeDeputyProps(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet))
        {
        }
        ...
        [JsiiMethod(name: "putJwtValidation", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"aws.lbListener.LbListenerDefaultActionJwtValidation\"}}]")]
        public virtual void PutJwtValidation(aws.LbListener.ILbListenerDefaultActionJwtValidation @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(aws.LbListener.ILbListenerDefaultActionJwtValidation)}, new object[]{@value});
        }
        ...
        [JsiiProperty(name: "jwtValidation", typeJson: "{\"fqn\":\"aws.lbListener.LbListenerDefaultActionJwtValidationOutputReference\"}")]
        public virtual aws.LbListener.LbListenerDefaultActionJwtValidationOutputReference JwtValidation
        {
            get => GetInstanceProperty<aws.LbListener.LbListenerDefaultActionJwtValidationOutputReference>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "jwtValidationInput", typeJson: "{\"fqn\":\"aws.lbListener.LbListenerDefaultActionJwtValidation\"}", isOptional: true)]
        public virtual aws.LbListener.ILbListenerDefaultActionJwtValidation? JwtValidationInput
        {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"aws.lbListener.LbListenerDefaultAction\"}]}}", isOptional: true)]
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case null:
                            break;
                        default:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.LbListener.ILbListenerDefaultAction).FullName}; received {value.GetType().FullName}", nameof(value));
                    }
                }
