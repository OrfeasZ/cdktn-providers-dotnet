...
{
    [JsiiClass(nativeType: typeof(aws.AlbListener.AlbListenerDefaultActionOutputReference), fullyQualifiedName: "aws.albListener.AlbListenerDefaultActionOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktn.IInterpolatingParent\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"the index of this item in the list.\"},\"name\":\"complexObjectIndex\",\"type\":{\"primitive\":\"number\"}},{\"docs\":{\"summary\":\"whether the list is wrapping a set (will add tolist() to be able to access an item via an index).\"},\"name\":\"complexObjectIsFromSet\",\"type\":{\"primitive\":\"boolean\"}}]")]
    public class AlbListenerDefaultActionOutputReference : Io.Cdktn.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        /// <param name="complexObjectIndex">the index of this item in the list.</param>
        /// <param name="complexObjectIsFromSet">whether the list is wrapping a set (will add tolist() to be able to access an item via an index).</param>
        public AlbListenerDefaultActionOutputReference(Io.Cdktn.IInterpolatingParent terraformResource, string terraformAttribute, double complexObjectIndex, bool complexObjectIsFromSet): base(_MakeDeputyProps(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet))
        {
        }
        ...
        [JsiiMethod(name: "putJwtValidation", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"aws.albListener.AlbListenerDefaultActionJwtValidation\"}}]")]
        public virtual void PutJwtValidation(aws.AlbListener.IAlbListenerDefaultActionJwtValidation @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(aws.AlbListener.IAlbListenerDefaultActionJwtValidation)}, new object[]{@value});
        }
        ...
        [JsiiProperty(name: "jwtValidation", typeJson: "{\"fqn\":\"aws.albListener.AlbListenerDefaultActionJwtValidationOutputReference\"}")]
        public virtual aws.AlbListener.AlbListenerDefaultActionJwtValidationOutputReference JwtValidation
        {
            get => GetInstanceProperty<aws.AlbListener.AlbListenerDefaultActionJwtValidationOutputReference>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "jwtValidationInput", typeJson: "{\"fqn\":\"aws.albListener.AlbListenerDefaultActionJwtValidation\"}", isOptional: true)]
        public virtual aws.AlbListener.IAlbListenerDefaultActionJwtValidation? JwtValidationInput
        {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"aws.albListener.AlbListenerDefaultAction\"}]}}", isOptional: true)]
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case null:
                            break;
                        default:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.AlbListener.IAlbListenerDefaultAction).FullName}; received {value.GetType().FullName}", nameof(value));
                    }
                }
