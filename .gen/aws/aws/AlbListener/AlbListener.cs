...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.52.0/docs/resources/alb_listener aws_alb_listener}.</summary>
    [JsiiClass(nativeType: typeof(aws.AlbListener.AlbListener), fullyQualifiedName: "aws.albListener.AlbListener", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"remarks\":\"Must be unique amongst siblings in the same scope\",\"summary\":\"The scoped construct ID.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.albListener.AlbListenerConfig\"}}]")]
    public class AlbListener : Io.Cdktn.TerraformResource
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.52.0/docs/resources/alb_listener aws_alb_listener} Resource.</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        /// <param name="id">The scoped construct ID.</param>
        public AlbListener(Constructs.Construct scope, string id, aws.AlbListener.IAlbListenerConfig config): base(_MakeDeputyProps(scope, id, config))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(Constructs.Construct scope, string id, aws.AlbListener.IAlbListenerConfig config)
        {
        ...
        /// <summary>Generates CDKTN code for importing a AlbListener resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        /// <param name="importToId">The construct id used in the generated config for the AlbListener to import.</param>
        /// <param name="importFromId">The id of the existing AlbListener that should be imported.</param>
        /// <param name="provider">? Optional instance of the provider where the AlbListener to import is found.</param>
        [JsiiMethod(name: "generateConfigForImport", returnsJson: "{\"type\":{\"fqn\":\"cdktn.ImportableResource\"}}", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"summary\":\"The construct id used in the generated config for the AlbListener to import.\"},\"name\":\"importToId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"remarks\":\"Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.52.0/docs/resources/alb_listener#import import section} in the documentation of this resource for the id to use\",\"summary\":\"The id of the existing AlbListener that should be imported.\"},\"name\":\"importFromId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"? Optional instance of the provider where the AlbListener to import is found.\"},\"name\":\"provider\",\"optional\":true,\"type\":{\"fqn\":\"cdktn.TerraformProvider\"}}]")]
        public static Io.Cdktn.ImportableResource GenerateConfigForImport(Constructs.Construct scope, string importToId, string importFromId, Io.Cdktn.TerraformProvider? provider = null)
        {
            return InvokeStaticMethod<Io.Cdktn.ImportableResource>(typeof(aws.AlbListener.AlbListener), new System.Type[]{typeof(Constructs.Construct), typeof(string), typeof(string), typeof(Io.Cdktn.TerraformProvider)}, new object?[]{scope, importToId, importFromId, provider})!;
        }

        /// <param name="value">Type union: either <see cref="Io.Cdktn.IResolvable" /> or (<see cref="aws.AlbListener.IAlbListenerDefaultAction" />)[]</param>
        [JsiiMethod(name: "putDefaultAction", parametersJson: "[{\"name\":\"value\",\"type\":{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.albListener.AlbListenerDefaultAction\"},\"kind\":\"array\"}}]}}}]")]
            ...
            if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
            {
                switch (@value)
                {
                    case Io.Cdktn.IResolvable cast_2ed7d7:
                        break;
                    case aws.AlbListener.IAlbListenerDefaultAction[] cast_2ed7d7:
                        break;
                    case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_2ed7d7:
                        // Not enough information to type-check...
                        break;
                    case null:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.AlbListener.IAlbListenerDefaultAction).FullName}[]; received null", nameof(@value));
                    default:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.AlbListener.IAlbListenerDefaultAction).FullName}[]; received {@value.GetType().FullName}", nameof(@value));
                }
            }
            InvokeInstanceVoidMethod(new System.Type[]{typeof(object)}, new object[]{@value});
        }

        [JsiiMethod(name: "putMutualAuthentication", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"aws.albListener.AlbListenerMutualAuthentication\"}}]")]
        public virtual void PutMutualAuthentication(aws.AlbListener.IAlbListenerMutualAuthentication @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(aws.AlbListener.IAlbListenerMutualAuthentication)}, new object[]{@value});
        }

        [JsiiMethod(name: "putTimeouts", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"aws.albListener.AlbListenerTimeouts\"}}]")]
        public virtual void PutTimeouts(aws.AlbListener.IAlbListenerTimeouts @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(aws.AlbListener.IAlbListenerTimeouts)}, new object[]{@value});
        }
        ...
        = GetStaticProperty<string>(typeof(aws.AlbListener.AlbListener))!;
        ...
        [JsiiProperty(name: "defaultAction", typeJson: "{\"fqn\":\"aws.albListener.AlbListenerDefaultActionList\"}")]
        public virtual aws.AlbListener.AlbListenerDefaultActionList DefaultAction
        {
            get => GetInstanceProperty<aws.AlbListener.AlbListenerDefaultActionList>()!;
        }

        [JsiiProperty(name: "mutualAuthentication", typeJson: "{\"fqn\":\"aws.albListener.AlbListenerMutualAuthenticationOutputReference\"}")]
        public virtual aws.AlbListener.AlbListenerMutualAuthenticationOutputReference MutualAuthentication
        {
            get => GetInstanceProperty<aws.AlbListener.AlbListenerMutualAuthenticationOutputReference>()!;
        }

        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.albListener.AlbListenerTimeoutsOutputReference\"}")]
        public virtual aws.AlbListener.AlbListenerTimeoutsOutputReference Timeouts
        {
            get => GetInstanceProperty<aws.AlbListener.AlbListenerTimeoutsOutputReference>()!;
        }
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "defaultActionInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.albListener.AlbListenerDefaultAction\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "mutualAuthenticationInput", typeJson: "{\"fqn\":\"aws.albListener.AlbListenerMutualAuthentication\"}", isOptional: true)]
        public virtual aws.AlbListener.IAlbListenerMutualAuthentication? MutualAuthenticationInput
        {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "routingHttpResponseServerEnabledInput", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktn.IResolvable\"}]}}", isOptional: true)]
        ...
        /// <remarks>
        /// <para>Type union: either <see cref="Io.Cdktn.IResolvable" /> or <see cref="aws.AlbListener.IAlbListenerTimeouts" /></para>
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "timeoutsInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"aws.albListener.AlbListenerTimeouts\"}]}}", isOptional: true)]
        ...
        /// <para>Type union: either bool or <see cref="Io.Cdktn.IResolvable" /></para>
        /// </remarks>
        [JsiiProperty(name: "routingHttpResponseServerEnabled", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktn.IResolvable\"}]}}")]
