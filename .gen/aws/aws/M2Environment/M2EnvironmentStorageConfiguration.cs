...
namespace aws.M2Environment
{
    ...
    public class M2EnvironmentStorageConfiguration : aws.M2Environment.IM2EnvironmentStorageConfiguration
    {
        ...
        /// <remarks>
        /// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.41.0/docs/resources/m2_environment#efs M2Environment#efs}
        /// </remarks>
        [JsiiOptional]
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case null:
                            break;
                        default:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.M2Environment.IM2EnvironmentStorageConfigurationEfs).FullName}[]; received {value.GetType().FullName}", nameof(value));
                    }
                }
                _efs = value;
            }
        ...
        /// <remarks>
        /// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.41.0/docs/resources/m2_environment#fsx M2Environment#fsx}
        /// </remarks>
        [JsiiOptional]
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case null:
                            break;
                        default:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.M2Environment.IM2EnvironmentStorageConfigurationFsx).FullName}[]; received {value.GetType().FullName}", nameof(value));
                    }
                }
                _fsx = value;
            }
