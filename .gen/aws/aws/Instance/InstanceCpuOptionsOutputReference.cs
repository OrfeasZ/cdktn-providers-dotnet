...
{
    [JsiiClass(nativeType: typeof(aws.Instance.InstanceCpuOptionsOutputReference), fullyQualifiedName: "aws.instance.InstanceCpuOptionsOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktn.IInterpolatingParent\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}}]")]
    public class InstanceCpuOptionsOutputReference : Io.Cdktn.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        public InstanceCpuOptionsOutputReference(Io.Cdktn.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
        ...
        [JsiiMethod(name: "resetNestedVirtualization")]
        public virtual void ResetNestedVirtualization()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "nestedVirtualizationInput", typeJson: "{\"primitive\":\"string\"}", isOptional: true)]
        public virtual string? NestedVirtualizationInput
        {
            get => GetInstanceProperty<string?>();
        }
        ...
        [JsiiProperty(name: "nestedVirtualization", typeJson: "{\"primitive\":\"string\"}")]
        public virtual string NestedVirtualization
        {
            get => GetInstanceProperty<string>()!;
            set => SetInstanceProperty(value);
        }
