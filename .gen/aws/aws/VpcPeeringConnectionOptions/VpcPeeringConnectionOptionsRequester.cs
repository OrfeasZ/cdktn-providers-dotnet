...
namespace aws.VpcPeeringConnectionOptions
{
    ...
    public class VpcPeeringConnectionOptionsRequester : aws.VpcPeeringConnectionOptions.IVpcPeeringConnectionOptionsRequester
    {
        ...
        /// <summary>Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.41.0/docs/resources/vpc_peering_connection_options#allow_remote_vpc_dns_resolution VpcPeeringConnectionOptions#allow_remote_vpc_dns_resolution}.</summary>
        [JsiiOptional]
