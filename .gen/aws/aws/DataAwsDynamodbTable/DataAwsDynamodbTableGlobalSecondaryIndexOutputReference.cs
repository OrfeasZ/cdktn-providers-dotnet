...
{
    [JsiiClass(nativeType: typeof(aws.DataAwsDynamodbTable.DataAwsDynamodbTableGlobalSecondaryIndexOutputReference), fullyQualifiedName: "aws.dataAwsDynamodbTable.DataAwsDynamodbTableGlobalSecondaryIndexOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktn.IInterpolatingParent\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"the index of this item in the list.\"},\"name\":\"complexObjectIndex\",\"type\":{\"primitive\":\"number\"}},{\"docs\":{\"summary\":\"whether the list is wrapping a set (will add tolist() to be able to access an item via an index).\"},\"name\":\"complexObjectIsFromSet\",\"type\":{\"primitive\":\"boolean\"}}]")]
    public class DataAwsDynamodbTableGlobalSecondaryIndexOutputReference : Io.Cdktn.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        /// <param name="complexObjectIndex">the index of this item in the list.</param>
        /// <param name="complexObjectIsFromSet">whether the list is wrapping a set (will add tolist() to be able to access an item via an index).</param>
        public DataAwsDynamodbTableGlobalSecondaryIndexOutputReference(Io.Cdktn.IInterpolatingParent terraformResource, string terraformAttribute, double complexObjectIndex, bool complexObjectIsFromSet): base(_MakeDeputyProps(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet))
        {
        }
        ...
        [JsiiProperty(name: "keySchema", typeJson: "{\"fqn\":\"aws.dataAwsDynamodbTable.DataAwsDynamodbTableGlobalSecondaryIndexKeySchemaList\"}")]
        public virtual aws.DataAwsDynamodbTable.DataAwsDynamodbTableGlobalSecondaryIndexKeySchemaList KeySchema
        {
            get => GetInstanceProperty<aws.DataAwsDynamodbTable.DataAwsDynamodbTableGlobalSecondaryIndexKeySchemaList>()!;
        }
        ...
        [JsiiProperty(name: "warmThroughput", typeJson: "{\"fqn\":\"aws.dataAwsDynamodbTable.DataAwsDynamodbTableGlobalSecondaryIndexWarmThroughputList\"}")]
        public virtual aws.DataAwsDynamodbTable.DataAwsDynamodbTableGlobalSecondaryIndexWarmThroughputList WarmThroughput
        {
            get => GetInstanceProperty<aws.DataAwsDynamodbTable.DataAwsDynamodbTableGlobalSecondaryIndexWarmThroughputList>()!;
        }
