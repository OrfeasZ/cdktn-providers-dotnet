...
{
    [JsiiClass(nativeType: typeof(aws.GluePartition.GluePartitionStorageDescriptorSkewedInfoOutputReference), fullyQualifiedName: "aws.gluePartition.GluePartitionStorageDescriptorSkewedInfoOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktn.IInterpolatingParent\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}}]")]
    public class GluePartitionStorageDescriptorSkewedInfoOutputReference : Io.Cdktn.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        public GluePartitionStorageDescriptorSkewedInfoOutputReference(Io.Cdktn.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
        ...
        protected GluePartitionStorageDescriptorSkewedInfoOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected GluePartitionStorageDescriptorSkewedInfoOutputReference(DeputyProps props): base(props)
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"aws.gluePartition.GluePartitionStorageDescriptorSkewedInfo\"}", isOptional: true)]
        public virtual aws.GluePartition.IGluePartitionStorageDescriptorSkewedInfo? InternalValue
        {
