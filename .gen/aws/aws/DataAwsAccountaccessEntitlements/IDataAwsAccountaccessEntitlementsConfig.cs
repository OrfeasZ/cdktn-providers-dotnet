...
{
    [JsiiInterface(nativeType: typeof(IDataAwsAccountaccessEntitlementsConfig), fullyQualifiedName: "aws.dataAwsAccountaccessEntitlements.DataAwsAccountaccessEntitlementsConfig")]
    public interface IDataAwsAccountaccessEntitlementsConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataAwsAccountaccessEntitlementsConfig), fullyQualifiedName: "aws.dataAwsAccountaccessEntitlements.DataAwsAccountaccessEntitlementsConfig")]
        internal sealed class _Proxy : DeputyBase, aws.DataAwsAccountaccessEntitlements.IDataAwsAccountaccessEntitlementsConfig
        {
