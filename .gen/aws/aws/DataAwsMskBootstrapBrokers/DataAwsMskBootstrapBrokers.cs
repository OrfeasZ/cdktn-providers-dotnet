...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/msk_bootstrap_brokers aws_msk_bootstrap_brokers}.</summary>
    ...
    public class DataAwsMskBootstrapBrokers : Io.Cdktn.TerraformDataSource
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/msk_bootstrap_brokers aws_msk_bootstrap_brokers} Data Source.</summary>
        ...
        /// <summary>Generates CDKTN code for importing a DataAwsMskBootstrapBrokers resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        ...
        [JsiiMethod(name: "generateConfigForImport", returnsJson: "{\"type\":{\"fqn\":\"cdktn.ImportableResource\"}}", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"summary\":\"The construct id used in the generated config for the DataAwsMskBootstrapBrokers to import.\"},\"name\":\"importToId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"remarks\":\"Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/msk_bootstrap_brokers#import import section} in the documentation of this resource for the id to use\",\"summary\":\"The id of the existing DataAwsMskBootstrapBrokers that should be imported.\"},\"name\":\"importFromId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"? Optional instance of the provider where the DataAwsMskBootstrapBrokers to import is found.\"},\"name\":\"provider\",\"optional\":true,\"type\":{\"fqn\":\"cdktn.TerraformProvider\"}}]")]
        public static Io.Cdktn.ImportableResource GenerateConfigForImport(Constructs.Construct scope, string importToId, string importFromId, Io.Cdktn.TerraformProvider? provider = null)
        {
            return InvokeStaticMethod<Io.Cdktn.ImportableResource>(typeof(aws.DataAwsMskBootstrapBrokers.DataAwsMskBootstrapBrokers), new System.Type[]{typeof(Constructs.Construct), typeof(string), typeof(string), typeof(Io.Cdktn.TerraformProvider)}, new object?[]{scope, importToId, importFromId, provider})!;
        }
        ...
        [JsiiProperty(name: "bootstrapBrokersIpv6", typeJson: "{\"primitive\":\"string\"}")]
        public virtual string BootstrapBrokersIpv6
        {
            get => GetInstanceProperty<string>()!;
        }
        ...
        [JsiiProperty(name: "bootstrapBrokersSaslIamIpv6", typeJson: "{\"primitive\":\"string\"}")]
        public virtual string BootstrapBrokersSaslIamIpv6
        {
            get => GetInstanceProperty<string>()!;
        }
        ...
        [JsiiProperty(name: "bootstrapBrokersSaslScramIpv6", typeJson: "{\"primitive\":\"string\"}")]
        public virtual string BootstrapBrokersSaslScramIpv6
        {
            get => GetInstanceProperty<string>()!;
        }
        ...
        [JsiiProperty(name: "bootstrapBrokersTlsIpv6", typeJson: "{\"primitive\":\"string\"}")]
        public virtual string BootstrapBrokersTlsIpv6
        {
            get => GetInstanceProperty<string>()!;
        }
