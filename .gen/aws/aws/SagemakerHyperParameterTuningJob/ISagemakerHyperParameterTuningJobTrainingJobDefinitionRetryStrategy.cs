...
namespace aws.SagemakerHyperParameterTuningJob
{
    ...
    public interface ISagemakerHyperParameterTuningJobTrainingJobDefinitionRetryStrategy
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ISagemakerHyperParameterTuningJobTrainingJobDefinitionRetryStrategy), fullyQualifiedName: "aws.sagemakerHyperParameterTuningJob.SagemakerHyperParameterTuningJobTrainingJobDefinitionRetryStrategy")]
        internal sealed class _Proxy : DeputyBase, aws.SagemakerHyperParameterTuningJob.ISagemakerHyperParameterTuningJobTrainingJobDefinitionRetryStrategy
        {
