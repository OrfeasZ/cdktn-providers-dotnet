...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.43.0/docs/resources/appfabric_app_authorization_connection aws_appfabric_app_authorization_connection}.</summary>
    ...
    public class AppfabricAppAuthorizationConnection : Io.Cdktn.TerraformResource
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.43.0/docs/resources/appfabric_app_authorization_connection aws_appfabric_app_authorization_connection} Resource.</summary>
        ...
        /// <summary>Generates CDKTN code for importing a AppfabricAppAuthorizationConnection resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
            ...
            if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
            {
                switch (@value)
                {
                    ...
                    case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_2ed7d7:
                        ...
                        break;
                    case null:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.AppfabricAppAuthorizationConnection.IAppfabricAppAuthorizationConnectionAuthRequest).FullName}[]; received null", nameof(@value));
                    default:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.AppfabricAppAuthorizationConnection.IAppfabricAppAuthorizationConnectionAuthRequest).FullName}[]; received {@value.GetType().FullName}", nameof(@value));
                }
            }
