...
namespace aws.DataAwsSsmincidentsResponsePlan
{
    ...
    public class DataAwsSsmincidentsResponsePlanActionSsmAutomationOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        [JsiiProperty(name: "dynamicParameters", typeJson: "{\"fqn\":\"cdktn.StringMap\"}")]
        public virtual Io.Cdktn.StringMap DynamicParameters
        {
