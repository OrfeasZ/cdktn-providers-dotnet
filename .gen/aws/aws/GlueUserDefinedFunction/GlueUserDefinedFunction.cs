...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.42.0/docs/resources/glue_user_defined_function aws_glue_user_defined_function}.</summary>
    ...
    public class GlueUserDefinedFunction : Io.Cdktn.TerraformResource
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.42.0/docs/resources/glue_user_defined_function aws_glue_user_defined_function} Resource.</summary>
        ...
        /// <summary>Generates CDKTN code for importing a GlueUserDefinedFunction resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
            ...
            if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
            {
                switch (@value)
                {
                    ...
                    case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_2ed7d7:
                        ...
                        break;
                    case null:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.GlueUserDefinedFunction.IGlueUserDefinedFunctionResourceUris).FullName}[]; received null", nameof(@value));
                    default:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.GlueUserDefinedFunction.IGlueUserDefinedFunctionResourceUris).FullName}[]; received {@value.GetType().FullName}", nameof(@value));
                }
            }
