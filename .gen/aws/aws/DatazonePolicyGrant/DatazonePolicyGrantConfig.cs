...
namespace aws.DatazonePolicyGrant
{
    ...
    [JsiiByValue(fqn: "aws.datazonePolicyGrant.DatazonePolicyGrantConfig")]
    public class DatazonePolicyGrantConfig : aws.DatazonePolicyGrant.IDatazonePolicyGrantConfig
    {
