...
{
    [JsiiByValue(fqn: "aws.datazonePolicyGrant.DatazonePolicyGrantDetailCreateDomainUnit")]
    public class DatazonePolicyGrantDetailCreateDomainUnit : aws.DatazonePolicyGrant.IDatazonePolicyGrantDetailCreateDomainUnit
    {
