...
{
    [JsiiByValue(fqn: "aws.datazonePolicyGrant.DatazonePolicyGrantPrincipal")]
    public class DatazonePolicyGrantPrincipal : aws.DatazonePolicyGrant.IDatazonePolicyGrantPrincipal
    {
        private object? _domainUnit;
