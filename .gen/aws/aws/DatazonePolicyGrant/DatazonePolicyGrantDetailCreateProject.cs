...
{
    [JsiiByValue(fqn: "aws.datazonePolicyGrant.DatazonePolicyGrantDetailCreateProject")]
    public class DatazonePolicyGrantDetailCreateProject : aws.DatazonePolicyGrant.IDatazonePolicyGrantDetailCreateProject
    {
