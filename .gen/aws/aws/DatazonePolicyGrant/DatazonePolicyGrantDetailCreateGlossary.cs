...
{
    [JsiiByValue(fqn: "aws.datazonePolicyGrant.DatazonePolicyGrantDetailCreateGlossary")]
    public class DatazonePolicyGrantDetailCreateGlossary : aws.DatazonePolicyGrant.IDatazonePolicyGrantDetailCreateGlossary
    {
