...
{
    [JsiiByValue(fqn: "aws.datazonePolicyGrant.DatazonePolicyGrantDetailUseAssetType")]
    public class DatazonePolicyGrantDetailUseAssetType : aws.DatazonePolicyGrant.IDatazonePolicyGrantDetailUseAssetType
    {
