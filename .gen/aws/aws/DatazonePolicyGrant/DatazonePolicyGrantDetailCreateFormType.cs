...
{
    [JsiiByValue(fqn: "aws.datazonePolicyGrant.DatazonePolicyGrantDetailCreateFormType")]
    public class DatazonePolicyGrantDetailCreateFormType : aws.DatazonePolicyGrant.IDatazonePolicyGrantDetailCreateFormType
    {
