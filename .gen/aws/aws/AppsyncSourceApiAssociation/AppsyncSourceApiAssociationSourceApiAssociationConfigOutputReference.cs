...
namespace aws.AppsyncSourceApiAssociation
{
    ...
    public class AppsyncSourceApiAssociationSourceApiAssociationConfigOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"aws.appsyncSourceApiAssociation.AppsyncSourceApiAssociationSourceApiAssociationConfig\"}]}}", isOptional: true)]
