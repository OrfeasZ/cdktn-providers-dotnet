...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/transfer_connector aws_transfer_connector}.</summary>
    ...
    public class TransferConnector : Io.Cdktn.TerraformResource
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/transfer_connector aws_transfer_connector} Resource.</summary>
        ...
        /// <summary>Generates CDKTN code for importing a TransferConnector resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        ...
        [JsiiMethod(name: "generateConfigForImport", returnsJson: "{\"type\":{\"fqn\":\"cdktn.ImportableResource\"}}", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"summary\":\"The construct id used in the generated config for the TransferConnector to import.\"},\"name\":\"importToId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"remarks\":\"Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/transfer_connector#import import section} in the documentation of this resource for the id to use\",\"summary\":\"The id of the existing TransferConnector that should be imported.\"},\"name\":\"importFromId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"? Optional instance of the provider where the TransferConnector to import is found.\"},\"name\":\"provider\",\"optional\":true,\"type\":{\"fqn\":\"cdktn.TerraformProvider\"}}]")]
        public static Io.Cdktn.ImportableResource GenerateConfigForImport(Constructs.Construct scope, string importToId, string importFromId, Io.Cdktn.TerraformProvider? provider = null)
        {
            return InvokeStaticMethod<Io.Cdktn.ImportableResource>(typeof(aws.TransferConnector.TransferConnector), new System.Type[]{typeof(Constructs.Construct), typeof(string), typeof(string), typeof(Io.Cdktn.TerraformProvider)}, new object?[]{scope, importToId, importFromId, provider})!;
        }
        ...
        [JsiiMethod(name: "putEgressConfig", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"aws.transferConnector.TransferConnectorEgressConfig\"}}]")]
        public virtual void PutEgressConfig(aws.TransferConnector.ITransferConnectorEgressConfig @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(aws.TransferConnector.ITransferConnectorEgressConfig)}, new object[]{@value});
        }
        ...
        [JsiiMethod(name: "putTimeouts", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"aws.transferConnector.TransferConnectorTimeouts\"}}]")]
        public virtual void PutTimeouts(aws.TransferConnector.ITransferConnectorTimeouts @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(aws.TransferConnector.ITransferConnectorTimeouts)}, new object[]{@value});
        }
        ...
        [JsiiMethod(name: "resetEgressConfig")]
        public virtual void ResetEgressConfig()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        [JsiiProperty(name: "egressConfig", typeJson: "{\"fqn\":\"aws.transferConnector.TransferConnectorEgressConfigOutputReference\"}")]
        public virtual aws.TransferConnector.TransferConnectorEgressConfigOutputReference EgressConfig
        {
            get => GetInstanceProperty<aws.TransferConnector.TransferConnectorEgressConfigOutputReference>()!;
        }
        ...
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.transferConnector.TransferConnectorTimeoutsOutputReference\"}")]
        public virtual aws.TransferConnector.TransferConnectorTimeoutsOutputReference Timeouts
        {
            get => GetInstanceProperty<aws.TransferConnector.TransferConnectorTimeoutsOutputReference>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "egressConfigInput", typeJson: "{\"fqn\":\"aws.transferConnector.TransferConnectorEgressConfig\"}", isOptional: true)]
        public virtual aws.TransferConnector.ITransferConnectorEgressConfig? EgressConfigInput
        {
        ...
        /// <remarks>
        /// <para>Type union: either <see cref="Io.Cdktn.IResolvable" /> or <see cref="aws.TransferConnector.ITransferConnectorTimeouts" /></para>
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "timeoutsInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"aws.transferConnector.TransferConnectorTimeouts\"}]}}", isOptional: true)]
