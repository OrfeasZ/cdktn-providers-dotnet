...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.43.0/docs/resources/medialive_multiplex_program aws_medialive_multiplex_program}.</summary>
    ...
    public class MedialiveMultiplexProgram : Io.Cdktn.TerraformResource
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.43.0/docs/resources/medialive_multiplex_program aws_medialive_multiplex_program} Resource.</summary>
        ...
        /// <summary>Generates CDKTN code for importing a MedialiveMultiplexProgram resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
            ...
            if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
            {
                switch (@value)
                {
                    ...
                    case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_2ed7d7:
                        ...
                        break;
                    case null:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.MedialiveMultiplexProgram.IMedialiveMultiplexProgramMultiplexProgramSettings).FullName}[]; received null", nameof(@value));
                    default:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.MedialiveMultiplexProgram.IMedialiveMultiplexProgramMultiplexProgramSettings).FullName}[]; received {@value.GetType().FullName}", nameof(@value));
                }
            }
