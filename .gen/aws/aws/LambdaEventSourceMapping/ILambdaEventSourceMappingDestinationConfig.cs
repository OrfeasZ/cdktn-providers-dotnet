...
namespace aws.LambdaEventSourceMapping
{
    ...
    public interface ILambdaEventSourceMappingDestinationConfig
    {
        ...
        /// <remarks>
        /// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.0/docs/resources/lambda_event_source_mapping#on_failure LambdaEventSourceMapping#on_failure}
        /// </remarks>
