...
namespace aws.Wafv2WebAcl
{
    ...
    public interface IWafv2WebAclDataProtectionConfig
    {
        ...
        /// <remarks>
        /// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.41.0/docs/resources/wafv2_web_acl#data_protection Wafv2WebAcl#data_protection}
        /// </remarks>
        [JsiiProperty(name: "dataProtection", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.wafv2WebAcl.Wafv2WebAclDataProtectionConfigDataProtection\"},\"kind\":\"array\"}}]}}", isOptional: true)]
