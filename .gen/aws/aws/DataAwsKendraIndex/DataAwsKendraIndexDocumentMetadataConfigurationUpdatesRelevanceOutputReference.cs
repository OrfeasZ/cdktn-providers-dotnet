...
namespace aws.DataAwsKendraIndex
{
    ...
    public class DataAwsKendraIndexDocumentMetadataConfigurationUpdatesRelevanceOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        [JsiiProperty(name: "freshness", typeJson: "{\"fqn\":\"cdktn.IResolvable\"}")]
        public virtual Io.Cdktn.IResolvable Freshness
        {
        ...
        [JsiiProperty(name: "valuesImportanceMap", typeJson: "{\"fqn\":\"cdktn.NumberMap\"}")]
        public virtual Io.Cdktn.NumberMap ValuesImportanceMap
        {
