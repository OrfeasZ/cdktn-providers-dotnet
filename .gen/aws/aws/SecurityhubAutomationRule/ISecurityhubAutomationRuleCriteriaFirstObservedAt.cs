...
namespace aws.SecurityhubAutomationRule
{
    ...
    public interface ISecurityhubAutomationRuleCriteriaFirstObservedAt
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "dateRange", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.securityhubAutomationRule.SecurityhubAutomationRuleCriteriaFirstObservedAtDateRange\"},\"kind\":\"array\"}}]}}", isOptional: true)]
