...
namespace aws.LightsailContainerService
{
    ...
    public class LightsailContainerServicePublicDomainNames : aws.LightsailContainerService.ILightsailContainerServicePublicDomainNames
    {
        ...
        /// <remarks>
        /// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.59.0/docs/resources/lightsail_container_service#certificate LightsailContainerService#certificate}
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            ...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.LightsailContainerService.ILightsailContainerServicePublicDomainNamesCertificate).FullName}[]; received null", nameof(value));
                        default:
