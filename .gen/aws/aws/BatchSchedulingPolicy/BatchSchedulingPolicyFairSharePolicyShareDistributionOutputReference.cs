...
namespace aws.BatchSchedulingPolicy
{
    ...
    public class BatchSchedulingPolicyFairSharePolicyShareDistributionOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"aws.batchSchedulingPolicy.BatchSchedulingPolicyFairSharePolicyShareDistribution\"}]}}", isOptional: true)]
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case null:
                            break;
                        default:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(aws.BatchSchedulingPolicy.IBatchSchedulingPolicyFairSharePolicyShareDistribution).FullName}; received {value.GetType().FullName}", nameof(value));
                    }
                }
