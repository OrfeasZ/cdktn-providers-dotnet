...
namespace aws.NetworkmanagerAttachmentRoutingPolicyLabel
{
    ...
    public interface INetworkmanagerAttachmentRoutingPolicyLabelConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(INetworkmanagerAttachmentRoutingPolicyLabelConfig), fullyQualifiedName: "aws.networkmanagerAttachmentRoutingPolicyLabel.NetworkmanagerAttachmentRoutingPolicyLabelConfig")]
        internal sealed class _Proxy : DeputyBase, aws.NetworkmanagerAttachmentRoutingPolicyLabel.INetworkmanagerAttachmentRoutingPolicyLabelConfig
        {
