...
namespace cloudflare.DataCloudflareCustomHostname
{
    ...
    public interface IDataCloudflareCustomHostnameConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataCloudflareCustomHostnameConfig), fullyQualifiedName: "cloudflare.dataCloudflareCustomHostname.DataCloudflareCustomHostnameConfig")]
        internal sealed class _Proxy : DeputyBase, cloudflare.DataCloudflareCustomHostname.IDataCloudflareCustomHostnameConfig
        {
            ...
            {
                get => GetInstanceProperty<cloudflare.DataCloudflareCustomHostname.IDataCloudflareCustomHostnameFilter?>();
            }
