...
namespace cloudflare.UserGroupMembers
{
    ...
    [JsiiByValue(fqn: "cloudflare.userGroupMembers.UserGroupMembersMembers")]
    public class UserGroupMembersMembers : cloudflare.UserGroupMembers.IUserGroupMembersMembers
    {
