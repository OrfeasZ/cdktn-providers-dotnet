...
{
    [JsiiByValue(fqn: "cloudflare.workersScript.WorkersScriptMigrationsRenamedClasses")]
    public class WorkersScriptMigrationsRenamedClasses : cloudflare.WorkersScript.IWorkersScriptMigrationsRenamedClasses
    {
