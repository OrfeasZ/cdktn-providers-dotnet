...
namespace cloudflare.WorkersScript
{
    ...
    public class WorkersScriptObservability : cloudflare.WorkersScript.IWorkersScriptObservability
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "issues", typeJson: "{\"fqn\":\"cloudflare.workersScript.WorkersScriptObservabilityIssues\"}", isOptional: true)]
        public cloudflare.WorkersScript.IWorkersScriptObservabilityIssues? Issues
        {
            get;
            set;
        }
