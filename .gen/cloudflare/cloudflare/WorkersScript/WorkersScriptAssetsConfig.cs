...
{
    [JsiiByValue(fqn: "cloudflare.workersScript.WorkersScriptAssetsConfig")]
    public class WorkersScriptAssetsConfig : cloudflare.WorkersScript.IWorkersScriptAssetsConfig
    {
        ...
        private object? _runWorkerFirst;
        ...
        public object? RunWorkerFirst
        {
            ...
            set
            {
                ...
                _runWorkerFirst = value;
            }
        }

        private object? _serveDirectly;
