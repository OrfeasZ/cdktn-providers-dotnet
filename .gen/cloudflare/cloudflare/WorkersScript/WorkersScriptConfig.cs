...
namespace cloudflare.WorkersScript
{
    ...
    public class WorkersScriptConfig : cloudflare.WorkersScript.IWorkersScriptConfig
    {
        ...
        /// <summary>Additional modules and data files to include in the multipart Worker upload.</summary>
        /// <remarks>
        /// Map keys are multipart part names referenced by binding <c>part</c> values and module imports.
        ///
        ...
        /// <para>Type union: either <see cref="Io.Cdktn.IResolvable" /> or Dictionary&lt;string, <see cref="cloudflare.WorkersScript.IWorkersScriptFiles" />&gt;</para>
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "files", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"cloudflare.workersScript.WorkersScriptFiles\"},\"kind\":\"map\"}}]}}", isOptional: true)]
        public object? Files
        {
            get => _files;
            set
            {
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        case Io.Cdktn.IResolvable cast_cd4240:
                            break;
                        case System.Collections.Generic.IDictionary<string, cloudflare.WorkersScript.IWorkersScriptFiles> cast_cd4240:
                            break;
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            // Not enough information to type-check...
                            break;
                        case null:
                            break;
                        default:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, System.Collections.Generic.IDictionary<string, {typeof(cloudflare.WorkersScript.IWorkersScriptFiles).FullName}>; received {value.GetType().FullName}", nameof(value));
                    }
                }
                _files = value;
            }
