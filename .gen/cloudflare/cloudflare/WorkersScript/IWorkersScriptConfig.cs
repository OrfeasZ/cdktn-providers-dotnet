...
namespace cloudflare.WorkersScript
{
    ...
    public interface IWorkersScriptConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        cloudflare.WorkersScript.IWorkersScriptAnnotations? Annotations
        {
            get
            {
                return null;
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        cloudflare.WorkersScript.IWorkersScriptCacheOptions? CacheOptions
        {
            get
            {
                return null;
        ...
        internal sealed class _Proxy : DeputyBase, cloudflare.WorkersScript.IWorkersScriptConfig
        {
            ...
            {
                get => GetInstanceProperty<cloudflare.WorkersScript.IWorkersScriptAnnotations?>();
            }
            ...
            {
                get => GetInstanceProperty<cloudflare.WorkersScript.IWorkersScriptCacheOptions?>();
            }
