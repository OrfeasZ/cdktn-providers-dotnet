...
namespace cloudflare.WorkersScript
{
    ...
    [JsiiByValue(fqn: "cloudflare.workersScript.WorkersScriptExportsCache")]
    public class WorkersScriptExportsCache : cloudflare.WorkersScript.IWorkersScriptExportsCache
    {
