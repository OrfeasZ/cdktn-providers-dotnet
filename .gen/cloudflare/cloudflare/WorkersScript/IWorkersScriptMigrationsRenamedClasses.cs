...
{
    [JsiiInterface(nativeType: typeof(IWorkersScriptMigrationsRenamedClasses), fullyQualifiedName: "cloudflare.workersScript.WorkersScriptMigrationsRenamedClasses")]
    public interface IWorkersScriptMigrationsRenamedClasses
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IWorkersScriptMigrationsRenamedClasses), fullyQualifiedName: "cloudflare.workersScript.WorkersScriptMigrationsRenamedClasses")]
        internal sealed class _Proxy : DeputyBase, cloudflare.WorkersScript.IWorkersScriptMigrationsRenamedClasses
        {
