...
{
    [JsiiByValue(fqn: "cloudflare.workersScript.WorkersScriptCacheOptions")]
    public class WorkersScriptCacheOptions : cloudflare.WorkersScript.IWorkersScriptCacheOptions
    {
