...
{
    [JsiiByValue(fqn: "cloudflare.workersScript.WorkersScriptObservabilityTraces")]
    public class WorkersScriptObservabilityTraces : cloudflare.WorkersScript.IWorkersScriptObservabilityTraces
    {
