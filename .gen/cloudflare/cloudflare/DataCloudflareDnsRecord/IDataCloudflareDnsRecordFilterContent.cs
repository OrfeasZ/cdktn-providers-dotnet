...
{
    [JsiiInterface(nativeType: typeof(IDataCloudflareDnsRecordFilterContent), fullyQualifiedName: "cloudflare.dataCloudflareDnsRecord.DataCloudflareDnsRecordFilterContent")]
    public interface IDataCloudflareDnsRecordFilterContent
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataCloudflareDnsRecordFilterContent), fullyQualifiedName: "cloudflare.dataCloudflareDnsRecord.DataCloudflareDnsRecordFilterContent")]
        internal sealed class _Proxy : DeputyBase, cloudflare.DataCloudflareDnsRecord.IDataCloudflareDnsRecordFilterContent
        {
