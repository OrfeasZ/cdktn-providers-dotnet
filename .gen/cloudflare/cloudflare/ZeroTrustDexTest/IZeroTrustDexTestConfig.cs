...
namespace cloudflare.ZeroTrustDexTest
{
    ...
    public interface IZeroTrustDexTestConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IZeroTrustDexTestConfig), fullyQualifiedName: "cloudflare.zeroTrustDexTest.ZeroTrustDexTestConfig")]
        internal sealed class _Proxy : DeputyBase, cloudflare.ZeroTrustDexTest.IZeroTrustDexTestConfig
        {
            ...
            {
                get => GetInstanceProperty<cloudflare.ZeroTrustDexTest.IZeroTrustDexTestData>()!;
            }
