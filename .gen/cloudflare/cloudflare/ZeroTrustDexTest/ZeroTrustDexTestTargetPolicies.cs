...
namespace cloudflare.ZeroTrustDexTest
{
    ...
    [JsiiByValue(fqn: "cloudflare.zeroTrustDexTest.ZeroTrustDexTestTargetPolicies")]
    public class ZeroTrustDexTestTargetPolicies : cloudflare.ZeroTrustDexTest.IZeroTrustDexTestTargetPolicies
    {
