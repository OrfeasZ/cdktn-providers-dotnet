...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.19.0/docs/data-sources/workers_kv_namespace cloudflare_workers_kv_namespace}.</summary>
    [JsiiClass(nativeType: typeof(cloudflare.DataCloudflareWorkersKvNamespace.DataCloudflareWorkersKvNamespace), fullyQualifiedName: "cloudflare.dataCloudflareWorkersKvNamespace.DataCloudflareWorkersKvNamespace", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"remarks\":\"Must be unique amongst siblings in the same scope\",\"summary\":\"The scoped construct ID.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"optional\":true,\"type\":{\"fqn\":\"cloudflare.dataCloudflareWorkersKvNamespace.DataCloudflareWorkersKvNamespaceConfig\"}}]")]
    public class DataCloudflareWorkersKvNamespace : Io.Cdktn.TerraformDataSource
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.19.0/docs/data-sources/workers_kv_namespace cloudflare_workers_kv_namespace} Data Source.</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        /// <param name="id">The scoped construct ID.</param>
        public DataCloudflareWorkersKvNamespace(Constructs.Construct scope, string id, cloudflare.DataCloudflareWorkersKvNamespace.IDataCloudflareWorkersKvNamespaceConfig? config = null): base(_MakeDeputyProps(scope, id, config))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(Constructs.Construct scope, string id, cloudflare.DataCloudflareWorkersKvNamespace.IDataCloudflareWorkersKvNamespaceConfig? config = null)
        {
