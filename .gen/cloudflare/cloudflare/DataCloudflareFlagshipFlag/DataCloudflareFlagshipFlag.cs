...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.23.0/docs/data-sources/flagship_flag cloudflare_flagship_flag}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.23.0/docs/data-sources/flagship_flag cloudflare_flagship_flag} Data Source.</summary>
        ...
        private static DeputyProps _MakeDeputyProps(Constructs.Construct scope, string id, cloudflare.DataCloudflareFlagshipFlag.IDataCloudflareFlagshipFlagConfig config)
        {
        ...
        protected DataCloudflareFlagshipFlag(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected DataCloudflareFlagshipFlag(DeputyProps props): base(props)
        {
        }

        /// <summary>Generates CDKTN code for importing a DataCloudflareFlagshipFlag resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        ...
        = GetStaticProperty<string>(typeof(cloudflare.DataCloudflareFlagshipFlag.DataCloudflareFlagshipFlag))!;
        ...
        [JsiiProperty(name: "rules", typeJson: "{\"fqn\":\"cloudflare.dataCloudflareFlagshipFlag.DataCloudflareFlagshipFlagRulesList\"}")]
        public virtual cloudflare.DataCloudflareFlagshipFlag.DataCloudflareFlagshipFlagRulesList Rules
        {
            get => GetInstanceProperty<cloudflare.DataCloudflareFlagshipFlag.DataCloudflareFlagshipFlagRulesList>()!;
        }
