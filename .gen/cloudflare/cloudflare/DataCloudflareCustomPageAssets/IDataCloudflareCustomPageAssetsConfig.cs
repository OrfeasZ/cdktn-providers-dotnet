...
{
    [JsiiInterface(nativeType: typeof(IDataCloudflareCustomPageAssetsConfig), fullyQualifiedName: "cloudflare.dataCloudflareCustomPageAssets.DataCloudflareCustomPageAssetsConfig")]
    public interface IDataCloudflareCustomPageAssetsConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataCloudflareCustomPageAssetsConfig), fullyQualifiedName: "cloudflare.dataCloudflareCustomPageAssets.DataCloudflareCustomPageAssetsConfig")]
        internal sealed class _Proxy : DeputyBase, cloudflare.DataCloudflareCustomPageAssets.IDataCloudflareCustomPageAssetsConfig
        {
