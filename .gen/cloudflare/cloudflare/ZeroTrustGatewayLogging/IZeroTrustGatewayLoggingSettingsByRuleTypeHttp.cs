...
{
    [JsiiInterface(nativeType: typeof(IZeroTrustGatewayLoggingSettingsByRuleTypeHttp), fullyQualifiedName: "cloudflare.zeroTrustGatewayLogging.ZeroTrustGatewayLoggingSettingsByRuleTypeHttp")]
    public interface IZeroTrustGatewayLoggingSettingsByRuleTypeHttp
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IZeroTrustGatewayLoggingSettingsByRuleTypeHttp), fullyQualifiedName: "cloudflare.zeroTrustGatewayLogging.ZeroTrustGatewayLoggingSettingsByRuleTypeHttp")]
        internal sealed class _Proxy : DeputyBase, cloudflare.ZeroTrustGatewayLogging.IZeroTrustGatewayLoggingSettingsByRuleTypeHttp
        {
