...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/data-sources/workers_routes cloudflare_workers_routes}.</summary>
    [JsiiClass(nativeType: typeof(cloudflare.DataCloudflareWorkersRoutes.DataCloudflareWorkersRoutes), fullyQualifiedName: "cloudflare.dataCloudflareWorkersRoutes.DataCloudflareWorkersRoutes", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"remarks\":\"Must be unique amongst siblings in the same scope\",\"summary\":\"The scoped construct ID.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"cloudflare.dataCloudflareWorkersRoutes.DataCloudflareWorkersRoutesConfig\"}}]")]
    public class DataCloudflareWorkersRoutes : Io.Cdktn.TerraformDataSource
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/data-sources/workers_routes cloudflare_workers_routes} Data Source.</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        /// <param name="id">The scoped construct ID.</param>
        public DataCloudflareWorkersRoutes(Constructs.Construct scope, string id, cloudflare.DataCloudflareWorkersRoutes.IDataCloudflareWorkersRoutesConfig config): base(_MakeDeputyProps(scope, id, config))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(Constructs.Construct scope, string id, cloudflare.DataCloudflareWorkersRoutes.IDataCloudflareWorkersRoutesConfig config)
        {
