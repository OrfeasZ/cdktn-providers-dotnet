...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.19.0/docs/data-sources/argo_tiered_caching cloudflare_argo_tiered_caching}.</summary>
    [JsiiClass(nativeType: typeof(cloudflare.DataCloudflareArgoTieredCaching.DataCloudflareArgoTieredCaching), fullyQualifiedName: "cloudflare.dataCloudflareArgoTieredCaching.DataCloudflareArgoTieredCaching", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"remarks\":\"Must be unique amongst siblings in the same scope\",\"summary\":\"The scoped construct ID.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"optional\":true,\"type\":{\"fqn\":\"cloudflare.dataCloudflareArgoTieredCaching.DataCloudflareArgoTieredCachingConfig\"}}]")]
    public class DataCloudflareArgoTieredCaching : Io.Cdktn.TerraformDataSource
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.19.0/docs/data-sources/argo_tiered_caching cloudflare_argo_tiered_caching} Data Source.</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        /// <param name="id">The scoped construct ID.</param>
        public DataCloudflareArgoTieredCaching(Constructs.Construct scope, string id, cloudflare.DataCloudflareArgoTieredCaching.IDataCloudflareArgoTieredCachingConfig? config = null): base(_MakeDeputyProps(scope, id, config))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(Constructs.Construct scope, string id, cloudflare.DataCloudflareArgoTieredCaching.IDataCloudflareArgoTieredCachingConfig? config = null)
        {
