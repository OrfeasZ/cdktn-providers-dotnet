...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/data-sources/email_security_block_sender cloudflare_email_security_block_sender}.</summary>
    [JsiiClass(nativeType: typeof(cloudflare.DataCloudflareEmailSecurityBlockSender.DataCloudflareEmailSecurityBlockSender), fullyQualifiedName: "cloudflare.dataCloudflareEmailSecurityBlockSender.DataCloudflareEmailSecurityBlockSender", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"remarks\":\"Must be unique amongst siblings in the same scope\",\"summary\":\"The scoped construct ID.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"cloudflare.dataCloudflareEmailSecurityBlockSender.DataCloudflareEmailSecurityBlockSenderConfig\"}}]")]
    public class DataCloudflareEmailSecurityBlockSender : Io.Cdktn.TerraformDataSource
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/data-sources/email_security_block_sender cloudflare_email_security_block_sender} Data Source.</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        /// <param name="id">The scoped construct ID.</param>
        public DataCloudflareEmailSecurityBlockSender(Constructs.Construct scope, string id, cloudflare.DataCloudflareEmailSecurityBlockSender.IDataCloudflareEmailSecurityBlockSenderConfig config): base(_MakeDeputyProps(scope, id, config))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(Constructs.Construct scope, string id, cloudflare.DataCloudflareEmailSecurityBlockSender.IDataCloudflareEmailSecurityBlockSenderConfig config)
        {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "patternIdInput", typeJson: "{\"primitive\":\"string\"}", isOptional: true)]
        public virtual string? PatternIdInput
        {
            get => GetInstanceProperty<string?>();
        }
        ...
        [JsiiProperty(name: "patternId", typeJson: "{\"primitive\":\"string\"}")]
        public virtual string PatternId
        {
            get => GetInstanceProperty<string>()!;
            set => SetInstanceProperty(value);
        }
