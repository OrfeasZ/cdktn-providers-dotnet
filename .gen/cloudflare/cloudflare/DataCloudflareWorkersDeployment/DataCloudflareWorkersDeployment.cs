...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.7.1/docs/data-sources/workers_deployment cloudflare_workers_deployment}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.7.1/docs/data-sources/workers_deployment cloudflare_workers_deployment} Data Source.</summary>
        ...
        [JsiiProperty(name: "deployments", typeJson: "{\"fqn\":\"cloudflare.dataCloudflareWorkersDeployment.DataCloudflareWorkersDeploymentDeploymentsList\"}")]
        public virtual cloudflare.DataCloudflareWorkersDeployment.DataCloudflareWorkersDeploymentDeploymentsList Deployments
        {
            get => GetInstanceProperty<cloudflare.DataCloudflareWorkersDeployment.DataCloudflareWorkersDeploymentDeploymentsList>()!;
        }
