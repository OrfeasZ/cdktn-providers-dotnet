...
namespace cloudflare.DataCloudflareZeroTrustAccessInfrastructureTargets
{
    ...
    public interface IDataCloudflareZeroTrustAccessInfrastructureTargetsConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        /// <summary>Filter by tag key:value pairs.</summary>
        /// <remarks>
        /// Multiple <c>tag</c> params are AND'd.
        /// Format: <c>tag=key:value</c> (e.g., <c>tag=environment:production</c>).
        /// Key and value must both be non-empty; <c>tag=:value</c> and <c>tag=key:</c> return 400.
        ///
