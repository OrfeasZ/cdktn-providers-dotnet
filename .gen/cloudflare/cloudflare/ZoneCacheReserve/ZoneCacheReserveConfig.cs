...
namespace cloudflare.ZoneCacheReserve
{
    ...
    [JsiiByValue(fqn: "cloudflare.zoneCacheReserve.ZoneCacheReserveConfig")]
    public class ZoneCacheReserveConfig : cloudflare.ZoneCacheReserve.IZoneCacheReserveConfig
    {
