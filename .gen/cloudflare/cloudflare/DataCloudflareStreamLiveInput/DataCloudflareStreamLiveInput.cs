...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/data-sources/stream_live_input cloudflare_stream_live_input}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/data-sources/stream_live_input cloudflare_stream_live_input} Data Source.</summary>
        ...
        [JsiiProperty(name: "keysRotatedAt", typeJson: "{\"primitive\":\"string\"}")]
        public virtual string KeysRotatedAt
        {
            get => GetInstanceProperty<string>()!;
        }
        ...
        [JsiiProperty(name: "playback", typeJson: "{\"fqn\":\"cloudflare.dataCloudflareStreamLiveInput.DataCloudflareStreamLiveInputPlaybackOutputReference\"}")]
        public virtual cloudflare.DataCloudflareStreamLiveInput.DataCloudflareStreamLiveInputPlaybackOutputReference Playback
        {
            get => GetInstanceProperty<cloudflare.DataCloudflareStreamLiveInput.DataCloudflareStreamLiveInputPlaybackOutputReference>()!;
        }

        [JsiiProperty(name: "preferLowLatency", typeJson: "{\"fqn\":\"cdktn.IResolvable\"}")]
        public virtual Io.Cdktn.IResolvable PreferLowLatency
        {
            get => GetInstanceProperty<Io.Cdktn.IResolvable>()!;
        }
