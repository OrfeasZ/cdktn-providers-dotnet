...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.19.1/docs/data-sources/firewall_rule cloudflare_firewall_rule}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.19.1/docs/data-sources/firewall_rule cloudflare_firewall_rule} Data Source.</summary>
        ...
        protected DataCloudflareFirewallRule(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected DataCloudflareFirewallRule(DeputyProps props): base(props)
        {
        }

        /// <summary>Generates CDKTN code for importing a DataCloudflareFirewallRule resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        ...
        = GetStaticProperty<string>(typeof(cloudflare.DataCloudflareFirewallRule.DataCloudflareFirewallRule))!;
