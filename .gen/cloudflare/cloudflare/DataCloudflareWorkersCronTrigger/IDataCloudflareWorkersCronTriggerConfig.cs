...
namespace cloudflare.DataCloudflareWorkersCronTrigger
{
    ...
    public interface IDataCloudflareWorkersCronTriggerConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataCloudflareWorkersCronTriggerConfig), fullyQualifiedName: "cloudflare.dataCloudflareWorkersCronTrigger.DataCloudflareWorkersCronTriggerConfig")]
        internal sealed class _Proxy : DeputyBase, cloudflare.DataCloudflareWorkersCronTrigger.IDataCloudflareWorkersCronTriggerConfig
        {
