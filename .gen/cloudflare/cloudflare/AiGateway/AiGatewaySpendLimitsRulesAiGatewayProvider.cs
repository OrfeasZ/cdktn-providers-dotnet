...
namespace cloudflare.AiGateway
{
    ...
    [JsiiByValue(fqn: "cloudflare.aiGateway.AiGatewaySpendLimitsRulesAiGatewayProvider")]
    public class AiGatewaySpendLimitsRulesAiGatewayProvider : cloudflare.AiGateway.IAiGatewaySpendLimitsRulesAiGatewayProvider
    {
