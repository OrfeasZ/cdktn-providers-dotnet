...
{
    [JsiiInterface(nativeType: typeof(IDataCloudflareDnsFirewallConfig), fullyQualifiedName: "cloudflare.dataCloudflareDnsFirewall.DataCloudflareDnsFirewallConfig")]
    public interface IDataCloudflareDnsFirewallConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataCloudflareDnsFirewallConfig), fullyQualifiedName: "cloudflare.dataCloudflareDnsFirewall.DataCloudflareDnsFirewallConfig")]
        internal sealed class _Proxy : DeputyBase, cloudflare.DataCloudflareDnsFirewall.IDataCloudflareDnsFirewallConfig
        {
