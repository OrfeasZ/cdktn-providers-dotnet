...
{
    [JsiiInterface(nativeType: typeof(IZeroTrustTunnelCloudflaredConfigConfigOriginRequestAccess), fullyQualifiedName: "cloudflare.zeroTrustTunnelCloudflaredConfig.ZeroTrustTunnelCloudflaredConfigConfigOriginRequestAccess")]
    public interface IZeroTrustTunnelCloudflaredConfigConfigOriginRequestAccess
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IZeroTrustTunnelCloudflaredConfigConfigOriginRequestAccess), fullyQualifiedName: "cloudflare.zeroTrustTunnelCloudflaredConfig.ZeroTrustTunnelCloudflaredConfigConfigOriginRequestAccess")]
        internal sealed class _Proxy : DeputyBase, cloudflare.ZeroTrustTunnelCloudflaredConfig.IZeroTrustTunnelCloudflaredConfigConfigOriginRequestAccess
        {
