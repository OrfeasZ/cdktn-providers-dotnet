...
{
    [JsiiInterface(nativeType: typeof(IDataCloudflareAiSearchInstanceConfig), fullyQualifiedName: "cloudflare.dataCloudflareAiSearchInstance.DataCloudflareAiSearchInstanceConfig")]
    public interface IDataCloudflareAiSearchInstanceConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        cloudflare.DataCloudflareAiSearchInstance.IDataCloudflareAiSearchInstanceFilter? Filter
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataCloudflareAiSearchInstanceConfig), fullyQualifiedName: "cloudflare.dataCloudflareAiSearchInstance.DataCloudflareAiSearchInstanceConfig")]
        internal sealed class _Proxy : DeputyBase, cloudflare.DataCloudflareAiSearchInstance.IDataCloudflareAiSearchInstanceConfig
        {
            ...
            {
                get => GetInstanceProperty<cloudflare.DataCloudflareAiSearchInstance.IDataCloudflareAiSearchInstanceFilter?>();
            }
