...
{
    [JsiiByValue(fqn: "cloudflare.worker.WorkerPreviewsBaseConfigObservabilityLogs")]
    public class WorkerPreviewsBaseConfigObservabilityLogs : cloudflare.Worker.IWorkerPreviewsBaseConfigObservabilityLogs
    {
