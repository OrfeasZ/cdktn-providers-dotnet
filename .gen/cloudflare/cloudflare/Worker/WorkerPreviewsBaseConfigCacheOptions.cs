...
{
    [JsiiByValue(fqn: "cloudflare.worker.WorkerPreviewsBaseConfigCacheOptions")]
    public class WorkerPreviewsBaseConfigCacheOptions : cloudflare.Worker.IWorkerPreviewsBaseConfigCacheOptions
    {
