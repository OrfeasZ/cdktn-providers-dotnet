...
namespace cloudflare.Worker
{
    ...
    [JsiiByValue(fqn: "cloudflare.worker.WorkerPreviewsBaseConfigTailConsumers")]
    public class WorkerPreviewsBaseConfigTailConsumers : cloudflare.Worker.IWorkerPreviewsBaseConfigTailConsumers
    {
