...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.26.0/docs/resources/worker cloudflare_worker}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.26.0/docs/resources/worker cloudflare_worker} Resource.</summary>
        ...
        [JsiiMethod(name: "putPreviewsBaseConfig", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"cloudflare.worker.WorkerPreviewsBaseConfig\"}}]")]
        public virtual void PutPreviewsBaseConfig(cloudflare.Worker.IWorkerPreviewsBaseConfig @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(cloudflare.Worker.IWorkerPreviewsBaseConfig)}, new object[]{@value});
        }
        ...
        [JsiiMethod(name: "resetPreviewsBaseConfig")]
        public virtual void ResetPreviewsBaseConfig()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        [JsiiProperty(name: "previewsBaseConfig", typeJson: "{\"fqn\":\"cloudflare.worker.WorkerPreviewsBaseConfigOutputReference\"}")]
        public virtual cloudflare.Worker.WorkerPreviewsBaseConfigOutputReference PreviewsBaseConfig
        {
            get => GetInstanceProperty<cloudflare.Worker.WorkerPreviewsBaseConfigOutputReference>()!;
        }
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "previewsBaseConfigInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"cloudflare.worker.WorkerPreviewsBaseConfig\"}]}}", isOptional: true)]
        public virtual object? PreviewsBaseConfigInput
        {
            get => GetInstanceProperty<object?>();
        }
