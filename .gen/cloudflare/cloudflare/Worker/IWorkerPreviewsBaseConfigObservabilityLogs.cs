...
{
    [JsiiInterface(nativeType: typeof(IWorkerPreviewsBaseConfigObservabilityLogs), fullyQualifiedName: "cloudflare.worker.WorkerPreviewsBaseConfigObservabilityLogs")]
    public interface IWorkerPreviewsBaseConfigObservabilityLogs
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IWorkerPreviewsBaseConfigObservabilityLogs), fullyQualifiedName: "cloudflare.worker.WorkerPreviewsBaseConfigObservabilityLogs")]
        internal sealed class _Proxy : DeputyBase, cloudflare.Worker.IWorkerPreviewsBaseConfigObservabilityLogs
        {
