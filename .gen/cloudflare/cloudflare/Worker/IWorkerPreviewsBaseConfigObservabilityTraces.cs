...
{
    [JsiiInterface(nativeType: typeof(IWorkerPreviewsBaseConfigObservabilityTraces), fullyQualifiedName: "cloudflare.worker.WorkerPreviewsBaseConfigObservabilityTraces")]
    public interface IWorkerPreviewsBaseConfigObservabilityTraces
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IWorkerPreviewsBaseConfigObservabilityTraces), fullyQualifiedName: "cloudflare.worker.WorkerPreviewsBaseConfigObservabilityTraces")]
        internal sealed class _Proxy : DeputyBase, cloudflare.Worker.IWorkerPreviewsBaseConfigObservabilityTraces
        {
