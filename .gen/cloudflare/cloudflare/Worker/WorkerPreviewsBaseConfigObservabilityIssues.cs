...
{
    [JsiiByValue(fqn: "cloudflare.worker.WorkerPreviewsBaseConfigObservabilityIssues")]
    public class WorkerPreviewsBaseConfigObservabilityIssues : cloudflare.Worker.IWorkerPreviewsBaseConfigObservabilityIssues
    {
