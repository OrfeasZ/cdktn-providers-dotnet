...
{
    [JsiiByValue(fqn: "cloudflare.worker.WorkerPreviewsBaseConfigObservabilityTraces")]
    public class WorkerPreviewsBaseConfigObservabilityTraces : cloudflare.Worker.IWorkerPreviewsBaseConfigObservabilityTraces
    {
