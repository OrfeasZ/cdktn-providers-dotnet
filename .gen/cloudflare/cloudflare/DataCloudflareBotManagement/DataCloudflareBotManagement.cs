...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.26.0/docs/data-sources/bot_management cloudflare_bot_management}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.26.0/docs/data-sources/bot_management cloudflare_bot_management} Data Source.</summary>
        ...
        [JsiiProperty(name: "aiBotsMigrationOptOut", typeJson: "{\"fqn\":\"cdktn.IResolvable\"}")]
        public virtual Io.Cdktn.IResolvable AiBotsMigrationOptOut
        {
        ...
        [JsiiProperty(name: "botPreferenceSyncEnabled", typeJson: "{\"fqn\":\"cdktn.IResolvable\"}")]
        public virtual Io.Cdktn.IResolvable BotPreferenceSyncEnabled
        {
            get => GetInstanceProperty<Io.Cdktn.IResolvable>()!;
        }
        ...
        [JsiiProperty(name: "jsdApiResultsEnabled", typeJson: "{\"fqn\":\"cdktn.IResolvable\"}")]
        public virtual Io.Cdktn.IResolvable JsdApiResultsEnabled
        {
            get => GetInstanceProperty<Io.Cdktn.IResolvable>()!;
        }
