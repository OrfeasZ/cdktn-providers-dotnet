...
namespace cloudflare.DataCloudflareZeroTrustGatewayAppTypesList
{
    ...
    public interface IDataCloudflareZeroTrustGatewayAppTypesListConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataCloudflareZeroTrustGatewayAppTypesListConfig), fullyQualifiedName: "cloudflare.dataCloudflareZeroTrustGatewayAppTypesList.DataCloudflareZeroTrustGatewayAppTypesListConfig")]
        internal sealed class _Proxy : DeputyBase, cloudflare.DataCloudflareZeroTrustGatewayAppTypesList.IDataCloudflareZeroTrustGatewayAppTypesListConfig
        {
