...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.24.0/docs/resources/zone_dns_settings cloudflare_zone_dns_settings}.</summary>
    [JsiiClass(nativeType: typeof(cloudflare.ZoneDnsSettings.ZoneDnsSettings), fullyQualifiedName: "cloudflare.zoneDnsSettings.ZoneDnsSettings", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"remarks\":\"Must be unique amongst siblings in the same scope\",\"summary\":\"The scoped construct ID.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"cloudflare.zoneDnsSettings.ZoneDnsSettingsConfig\"}}]")]
    public class ZoneDnsSettings : Io.Cdktn.TerraformResource
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.24.0/docs/resources/zone_dns_settings cloudflare_zone_dns_settings} Resource.</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        /// <param name="id">The scoped construct ID.</param>
        public ZoneDnsSettings(Constructs.Construct scope, string id, cloudflare.ZoneDnsSettings.IZoneDnsSettingsConfig config): base(_MakeDeputyProps(scope, id, config))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(Constructs.Construct scope, string id, cloudflare.ZoneDnsSettings.IZoneDnsSettingsConfig config)
        {
        ...
        /// <remarks>
        /// <para>Type union: either <see cref="Io.Cdktn.IResolvable" /> or <see cref="cloudflare.ZoneDnsSettings.IZoneDnsSettingsInternalDns" /></para>
        /// </remarks>
        [JsiiOptional]
