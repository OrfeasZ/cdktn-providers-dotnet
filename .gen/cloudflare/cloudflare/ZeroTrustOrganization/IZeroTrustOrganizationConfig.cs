...
namespace cloudflare.ZeroTrustOrganization
{
    ...
    public interface IZeroTrustOrganizationConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        /// <summary>Configures automatic enforcement for inactive service tokens.</summary>
        /// <remarks>
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        cloudflare.ZeroTrustOrganization.IZeroTrustOrganizationServiceTokenInactivity? ServiceTokenInactivity
        {
            get
            {
                return null;
        ...
        internal sealed class _Proxy : DeputyBase, cloudflare.ZeroTrustOrganization.IZeroTrustOrganizationConfig
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "serviceTokenInactivity", typeJson: "{\"fqn\":\"cloudflare.zeroTrustOrganization.ZeroTrustOrganizationServiceTokenInactivity\"}", isOptional: true)]
            public cloudflare.ZeroTrustOrganization.IZeroTrustOrganizationServiceTokenInactivity? ServiceTokenInactivity
            {
                get => GetInstanceProperty<cloudflare.ZeroTrustOrganization.IZeroTrustOrganizationServiceTokenInactivity?>();
            }
