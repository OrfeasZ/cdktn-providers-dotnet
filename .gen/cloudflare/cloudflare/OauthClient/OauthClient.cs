...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/resources/oauth_client cloudflare_oauth_client}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/resources/oauth_client cloudflare_oauth_client} Resource.</summary>
        ...
        [JsiiMethod(name: "resetOptionalScopes")]
        public virtual void ResetOptionalScopes()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "optionalScopesInput", typeJson: "{\"collection\":{\"elementtype\":{\"primitive\":\"string\"},\"kind\":\"array\"}}", isOptional: true)]
        public virtual string[]? OptionalScopesInput
        {
            get => GetInstanceProperty<string[]?>();
        }
