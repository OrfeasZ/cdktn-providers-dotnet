...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.19.0/docs/data-sources/images cloudflare_images}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.19.0/docs/data-sources/images cloudflare_images} Data Source.</summary>
        ...
        protected DataCloudflareImages(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected DataCloudflareImages(DeputyProps props): base(props)
        {
        }

        /// <summary>Generates CDKTN code for importing a DataCloudflareImages resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        ...
        = GetStaticProperty<string>(typeof(cloudflare.DataCloudflareImages.DataCloudflareImages))!;

        [JsiiProperty(name: "result", typeJson: "{\"fqn\":\"cloudflare.dataCloudflareImages.DataCloudflareImagesResultList\"}")]
        public virtual cloudflare.DataCloudflareImages.DataCloudflareImagesResultList Result
        {
            get => GetInstanceProperty<cloudflare.DataCloudflareImages.DataCloudflareImagesResultList>()!;
        }
