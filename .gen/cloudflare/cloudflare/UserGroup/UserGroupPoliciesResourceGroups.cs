...
namespace cloudflare.UserGroup
{
    ...
    [JsiiByValue(fqn: "cloudflare.userGroup.UserGroupPoliciesResourceGroups")]
    public class UserGroupPoliciesResourceGroups : cloudflare.UserGroup.IUserGroupPoliciesResourceGroups
    {
