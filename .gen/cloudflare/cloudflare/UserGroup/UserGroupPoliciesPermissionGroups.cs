...
namespace cloudflare.UserGroup
{
    ...
    [JsiiByValue(fqn: "cloudflare.userGroup.UserGroupPoliciesPermissionGroups")]
    public class UserGroupPoliciesPermissionGroups : cloudflare.UserGroup.IUserGroupPoliciesPermissionGroups
    {
