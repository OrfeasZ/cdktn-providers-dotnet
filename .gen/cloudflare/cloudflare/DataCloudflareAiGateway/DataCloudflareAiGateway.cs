...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.26.0/docs/data-sources/ai_gateway cloudflare_ai_gateway}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.26.0/docs/data-sources/ai_gateway cloudflare_ai_gateway} Data Source.</summary>
        ...
        [JsiiProperty(name: "byokOnly", typeJson: "{\"fqn\":\"cdktn.IResolvable\"}")]
        public virtual Io.Cdktn.IResolvable ByokOnly
        {
            get => GetInstanceProperty<Io.Cdktn.IResolvable>()!;
        }
        ...
        [JsiiProperty(name: "guardrails", typeJson: "{\"fqn\":\"cloudflare.dataCloudflareAiGateway.DataCloudflareAiGatewayGuardrailsOutputReference\"}")]
        public virtual cloudflare.DataCloudflareAiGateway.DataCloudflareAiGatewayGuardrailsOutputReference Guardrails
        {
            get => GetInstanceProperty<cloudflare.DataCloudflareAiGateway.DataCloudflareAiGatewayGuardrailsOutputReference>()!;
        }
        ...
        [JsiiProperty(name: "spendLimits", typeJson: "{\"fqn\":\"cloudflare.dataCloudflareAiGateway.DataCloudflareAiGatewaySpendLimitsOutputReference\"}")]
        public virtual cloudflare.DataCloudflareAiGateway.DataCloudflareAiGatewaySpendLimitsOutputReference SpendLimits
        {
            get => GetInstanceProperty<cloudflare.DataCloudflareAiGateway.DataCloudflareAiGatewaySpendLimitsOutputReference>()!;
        }
