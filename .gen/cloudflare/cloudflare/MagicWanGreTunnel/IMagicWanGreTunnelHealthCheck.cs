...
{
    [JsiiInterface(nativeType: typeof(IMagicWanGreTunnelHealthCheck), fullyQualifiedName: "cloudflare.magicWanGreTunnel.MagicWanGreTunnelHealthCheck")]
    public interface IMagicWanGreTunnelHealthCheck
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        cloudflare.MagicWanGreTunnel.IMagicWanGreTunnelHealthCheckTarget? Target
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IMagicWanGreTunnelHealthCheck), fullyQualifiedName: "cloudflare.magicWanGreTunnel.MagicWanGreTunnelHealthCheck")]
        internal sealed class _Proxy : DeputyBase, cloudflare.MagicWanGreTunnel.IMagicWanGreTunnelHealthCheck
        {
            ...
            {
                get => GetInstanceProperty<cloudflare.MagicWanGreTunnel.IMagicWanGreTunnelHealthCheckTarget?>();
            }
