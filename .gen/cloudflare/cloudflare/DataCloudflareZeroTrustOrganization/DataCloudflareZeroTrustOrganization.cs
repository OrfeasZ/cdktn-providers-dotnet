...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.26.0/docs/data-sources/zero_trust_organization cloudflare_zero_trust_organization}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.26.0/docs/data-sources/zero_trust_organization cloudflare_zero_trust_organization} Data Source.</summary>
        ...
        [JsiiProperty(name: "serviceTokenInactivity", typeJson: "{\"fqn\":\"cloudflare.dataCloudflareZeroTrustOrganization.DataCloudflareZeroTrustOrganizationServiceTokenInactivityOutputReference\"}")]
        public virtual cloudflare.DataCloudflareZeroTrustOrganization.DataCloudflareZeroTrustOrganizationServiceTokenInactivityOutputReference ServiceTokenInactivity
        {
            get => GetInstanceProperty<cloudflare.DataCloudflareZeroTrustOrganization.DataCloudflareZeroTrustOrganizationServiceTokenInactivityOutputReference>()!;
        }
        ...
        [JsiiProperty(name: "warpAuthNonBrowser401", typeJson: "{\"fqn\":\"cdktn.IResolvable\"}")]
        public virtual Io.Cdktn.IResolvable WarpAuthNonBrowser401
        {
            get => GetInstanceProperty<Io.Cdktn.IResolvable>()!;
        }
