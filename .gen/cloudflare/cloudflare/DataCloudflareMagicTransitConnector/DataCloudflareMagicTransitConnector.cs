...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.22.0/docs/data-sources/magic_transit_connector cloudflare_magic_transit_connector}.</summary>
    [JsiiClass(nativeType: typeof(cloudflare.DataCloudflareMagicTransitConnector.DataCloudflareMagicTransitConnector), fullyQualifiedName: "cloudflare.dataCloudflareMagicTransitConnector.DataCloudflareMagicTransitConnector", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"remarks\":\"Must be unique amongst siblings in the same scope\",\"summary\":\"The scoped construct ID.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"optional\":true,\"type\":{\"fqn\":\"cloudflare.dataCloudflareMagicTransitConnector.DataCloudflareMagicTransitConnectorConfig\"}}]")]
    public class DataCloudflareMagicTransitConnector : Io.Cdktn.TerraformDataSource
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.22.0/docs/data-sources/magic_transit_connector cloudflare_magic_transit_connector} Data Source.</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        /// <param name="id">The scoped construct ID.</param>
        public DataCloudflareMagicTransitConnector(Constructs.Construct scope, string id, cloudflare.DataCloudflareMagicTransitConnector.IDataCloudflareMagicTransitConnectorConfig? config = null): base(_MakeDeputyProps(scope, id, config))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(Constructs.Construct scope, string id, cloudflare.DataCloudflareMagicTransitConnector.IDataCloudflareMagicTransitConnectorConfig? config = null)
        {
        ...
        [JsiiMethod(name: "putFilter", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"cloudflare.dataCloudflareMagicTransitConnector.DataCloudflareMagicTransitConnectorFilter\"}}]")]
        public virtual void PutFilter(cloudflare.DataCloudflareMagicTransitConnector.IDataCloudflareMagicTransitConnectorFilter @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(cloudflare.DataCloudflareMagicTransitConnector.IDataCloudflareMagicTransitConnectorFilter)}, new object[]{@value});
        }
        ...
        [JsiiProperty(name: "filter", typeJson: "{\"fqn\":\"cloudflare.dataCloudflareMagicTransitConnector.DataCloudflareMagicTransitConnectorFilterOutputReference\"}")]
        public virtual cloudflare.DataCloudflareMagicTransitConnector.DataCloudflareMagicTransitConnectorFilterOutputReference Filter
        {
            get => GetInstanceProperty<cloudflare.DataCloudflareMagicTransitConnector.DataCloudflareMagicTransitConnectorFilterOutputReference>()!;
        }
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "filterInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"cloudflare.dataCloudflareMagicTransitConnector.DataCloudflareMagicTransitConnectorFilter\"}]}}", isOptional: true)]
