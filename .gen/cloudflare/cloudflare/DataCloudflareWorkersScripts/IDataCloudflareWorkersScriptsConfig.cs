...
{
    [JsiiInterface(nativeType: typeof(IDataCloudflareWorkersScriptsConfig), fullyQualifiedName: "cloudflare.dataCloudflareWorkersScripts.DataCloudflareWorkersScriptsConfig")]
    public interface IDataCloudflareWorkersScriptsConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataCloudflareWorkersScriptsConfig), fullyQualifiedName: "cloudflare.dataCloudflareWorkersScripts.DataCloudflareWorkersScriptsConfig")]
        internal sealed class _Proxy : DeputyBase, cloudflare.DataCloudflareWorkersScripts.IDataCloudflareWorkersScriptsConfig
        {
