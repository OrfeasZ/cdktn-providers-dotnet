...
namespace cloudflare.LogpullRetention
{
    ...
    [JsiiByValue(fqn: "cloudflare.logpullRetention.LogpullRetentionConfig")]
    public class LogpullRetentionConfig : cloudflare.LogpullRetention.ILogpullRetentionConfig
    {
