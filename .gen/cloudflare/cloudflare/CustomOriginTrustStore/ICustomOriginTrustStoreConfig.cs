...
namespace cloudflare.CustomOriginTrustStore
{
    ...
    public interface ICustomOriginTrustStoreConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ICustomOriginTrustStoreConfig), fullyQualifiedName: "cloudflare.customOriginTrustStore.CustomOriginTrustStoreConfig")]
        internal sealed class _Proxy : DeputyBase, cloudflare.CustomOriginTrustStore.ICustomOriginTrustStoreConfig
        {
