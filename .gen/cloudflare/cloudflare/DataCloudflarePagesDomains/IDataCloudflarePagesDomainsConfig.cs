...
namespace cloudflare.DataCloudflarePagesDomains
{
    ...
    public interface IDataCloudflarePagesDomainsConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataCloudflarePagesDomainsConfig), fullyQualifiedName: "cloudflare.dataCloudflarePagesDomains.DataCloudflarePagesDomainsConfig")]
        internal sealed class _Proxy : DeputyBase, cloudflare.DataCloudflarePagesDomains.IDataCloudflarePagesDomainsConfig
        {
