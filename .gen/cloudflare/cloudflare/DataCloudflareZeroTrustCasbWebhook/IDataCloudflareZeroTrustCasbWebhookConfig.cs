...
namespace cloudflare.DataCloudflareZeroTrustCasbWebhook
{
    ...
    public interface IDataCloudflareZeroTrustCasbWebhookConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataCloudflareZeroTrustCasbWebhookConfig), fullyQualifiedName: "cloudflare.dataCloudflareZeroTrustCasbWebhook.DataCloudflareZeroTrustCasbWebhookConfig")]
        internal sealed class _Proxy : DeputyBase, cloudflare.DataCloudflareZeroTrustCasbWebhook.IDataCloudflareZeroTrustCasbWebhookConfig
        {
