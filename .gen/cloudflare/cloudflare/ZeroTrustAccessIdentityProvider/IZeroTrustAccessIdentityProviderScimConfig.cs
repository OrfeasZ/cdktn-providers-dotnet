...
{
    [JsiiInterface(nativeType: typeof(IZeroTrustAccessIdentityProviderScimConfig), fullyQualifiedName: "cloudflare.zeroTrustAccessIdentityProvider.ZeroTrustAccessIdentityProviderScimConfig")]
    public interface IZeroTrustAccessIdentityProviderScimConfig
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IZeroTrustAccessIdentityProviderScimConfig), fullyQualifiedName: "cloudflare.zeroTrustAccessIdentityProvider.ZeroTrustAccessIdentityProviderScimConfig")]
        internal sealed class _Proxy : DeputyBase, cloudflare.ZeroTrustAccessIdentityProvider.IZeroTrustAccessIdentityProviderScimConfig
        {
