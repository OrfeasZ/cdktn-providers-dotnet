...
namespace cloudflare.ZeroTrustAccessIdentityProvider
{
    ...
    public interface IZeroTrustAccessIdentityProviderConfigA
    {
        ...
        /// <summary>Asks the IdP to reauthenticate the user for each SAML authentication request.</summary>
        /// <remarks>
        ...
        /// <para>Type union: either bool or <see cref="Io.Cdktn.IResolvable" /></para>
        /// </remarks>
        [JsiiProperty(name: "forceAuthn", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktn.IResolvable\"}]}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        object? ForceAuthn
        {
            get
        ...
        /// <summary>The maximum URL length the IdP accepts for the SSO redirect URL.</summary>
        /// <remarks>
        ...
        /// </remarks>
        [JsiiProperty(name: "maxSsoUrlLength", typeJson: "{\"primitive\":\"number\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        double? MaxSsoUrlLength
        {
            get
            {
                return null;
        ...
        /// <summary>Whether to use a previously authenticated Access email as a Google login hint when exactly one email matches the Workspace domain.</summary>
        /// <remarks>
        ...
        /// <para>Type union: either bool or <see cref="Io.Cdktn.IResolvable" /></para>
        /// </remarks>
        [JsiiProperty(name: "useLoginHint", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktn.IResolvable\"}]}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        object? UseLoginHint
        {
            get
