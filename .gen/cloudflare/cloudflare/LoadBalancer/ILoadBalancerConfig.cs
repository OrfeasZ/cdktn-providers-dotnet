...
namespace cloudflare.LoadBalancer
{
    ...
    public interface ILoadBalancerConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        /// <summary>Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.7.1/docs/resources/load_balancer#zone_id LoadBalancer#zone_id}.</summary>
        ...
        /// <remarks>
        /// Once the expiry time has been reached, subsequent requests may get sent to a different origin server. The accepted ranges per <c>session_affinity</c> policy are:
        ///
        /// <list type="bullet">
        /// <description><c>"cookie"</c> / <c>"ip_cookie"</c>: The current default of 23 hours will be used unless explicitly set. The accepted range of values is between [1800, 604800].</description>
        /// <description><c>"header"</c>: The current default of 1800 seconds will be used unless explicitly set. The accepted range of values is between [30, 3600]. Note: With session affinity by header, sessions only expire after they haven't been used for the number of seconds specified.</description>
        /// </list>
        ///
