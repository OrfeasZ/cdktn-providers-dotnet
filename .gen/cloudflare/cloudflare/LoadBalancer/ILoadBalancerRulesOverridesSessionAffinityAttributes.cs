...
{
    [JsiiInterface(nativeType: typeof(ILoadBalancerRulesOverridesSessionAffinityAttributes), fullyQualifiedName: "cloudflare.loadBalancer.LoadBalancerRulesOverridesSessionAffinityAttributes")]
    public interface ILoadBalancerRulesOverridesSessionAffinityAttributes
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ILoadBalancerRulesOverridesSessionAffinityAttributes), fullyQualifiedName: "cloudflare.loadBalancer.LoadBalancerRulesOverridesSessionAffinityAttributes")]
        internal sealed class _Proxy : DeputyBase, cloudflare.LoadBalancer.ILoadBalancerRulesOverridesSessionAffinityAttributes
        {
