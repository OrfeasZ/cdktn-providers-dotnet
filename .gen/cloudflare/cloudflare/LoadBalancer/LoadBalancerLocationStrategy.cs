...
{
    [JsiiByValue(fqn: "cloudflare.loadBalancer.LoadBalancerLocationStrategy")]
    public class LoadBalancerLocationStrategy : cloudflare.LoadBalancer.ILoadBalancerLocationStrategy
    {
