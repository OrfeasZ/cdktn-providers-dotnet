...
{
    [JsiiInterface(nativeType: typeof(ILoadBalancerRulesOverridesAdaptiveRouting), fullyQualifiedName: "cloudflare.loadBalancer.LoadBalancerRulesOverridesAdaptiveRouting")]
    public interface ILoadBalancerRulesOverridesAdaptiveRouting
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ILoadBalancerRulesOverridesAdaptiveRouting), fullyQualifiedName: "cloudflare.loadBalancer.LoadBalancerRulesOverridesAdaptiveRouting")]
        internal sealed class _Proxy : DeputyBase, cloudflare.LoadBalancer.ILoadBalancerRulesOverridesAdaptiveRouting
        {
