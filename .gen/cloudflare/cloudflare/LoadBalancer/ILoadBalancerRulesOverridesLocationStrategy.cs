...
{
    [JsiiInterface(nativeType: typeof(ILoadBalancerRulesOverridesLocationStrategy), fullyQualifiedName: "cloudflare.loadBalancer.LoadBalancerRulesOverridesLocationStrategy")]
    public interface ILoadBalancerRulesOverridesLocationStrategy
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ILoadBalancerRulesOverridesLocationStrategy), fullyQualifiedName: "cloudflare.loadBalancer.LoadBalancerRulesOverridesLocationStrategy")]
        internal sealed class _Proxy : DeputyBase, cloudflare.LoadBalancer.ILoadBalancerRulesOverridesLocationStrategy
        {
