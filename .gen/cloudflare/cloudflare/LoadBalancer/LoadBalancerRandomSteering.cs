...
{
    [JsiiByValue(fqn: "cloudflare.loadBalancer.LoadBalancerRandomSteering")]
    public class LoadBalancerRandomSteering : cloudflare.LoadBalancer.ILoadBalancerRandomSteering
    {
