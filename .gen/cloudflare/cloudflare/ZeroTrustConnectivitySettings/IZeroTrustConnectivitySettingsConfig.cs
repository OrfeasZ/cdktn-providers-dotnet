...
{
    [JsiiInterface(nativeType: typeof(IZeroTrustConnectivitySettingsConfig), fullyQualifiedName: "cloudflare.zeroTrustConnectivitySettings.ZeroTrustConnectivitySettingsConfig")]
    public interface IZeroTrustConnectivitySettingsConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IZeroTrustConnectivitySettingsConfig), fullyQualifiedName: "cloudflare.zeroTrustConnectivitySettings.ZeroTrustConnectivitySettingsConfig")]
        internal sealed class _Proxy : DeputyBase, cloudflare.ZeroTrustConnectivitySettings.IZeroTrustConnectivitySettingsConfig
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "icmpProxyEnabled", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktn.IResolvable\"}]}}", isOptional: true)]
            public object? IcmpProxyEnabled
            {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "offrampWarpEnabled", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktn.IResolvable\"}]}}", isOptional: true)]
            public object? OfframpWarpEnabled
            {
                get => GetInstanceProperty<object?>();
            }
