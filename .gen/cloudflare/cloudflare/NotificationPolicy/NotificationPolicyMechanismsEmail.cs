...
{
    [JsiiByValue(fqn: "cloudflare.notificationPolicy.NotificationPolicyMechanismsEmail")]
    public class NotificationPolicyMechanismsEmail : cloudflare.NotificationPolicy.INotificationPolicyMechanismsEmail
    {
