...
{
    [JsiiInterface(nativeType: typeof(IPageRuleActionsCacheKeyFieldsCookie), fullyQualifiedName: "cloudflare.pageRule.PageRuleActionsCacheKeyFieldsCookie")]
    public interface IPageRuleActionsCacheKeyFieldsCookie
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IPageRuleActionsCacheKeyFieldsCookie), fullyQualifiedName: "cloudflare.pageRule.PageRuleActionsCacheKeyFieldsCookie")]
        internal sealed class _Proxy : DeputyBase, cloudflare.PageRule.IPageRuleActionsCacheKeyFieldsCookie
        {
