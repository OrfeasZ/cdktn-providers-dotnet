...
{
    [JsiiByValue(fqn: "cloudflare.pageRule.PageRuleActionsCacheKeyFieldsHeader")]
    public class PageRuleActionsCacheKeyFieldsHeader : cloudflare.PageRule.IPageRuleActionsCacheKeyFieldsHeader
    {
