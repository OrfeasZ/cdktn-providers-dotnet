...
{
    [JsiiInterface(nativeType: typeof(IDataCloudflareDnsRecordsName), fullyQualifiedName: "cloudflare.dataCloudflareDnsRecords.DataCloudflareDnsRecordsName")]
    public interface IDataCloudflareDnsRecordsName
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataCloudflareDnsRecordsName), fullyQualifiedName: "cloudflare.dataCloudflareDnsRecords.DataCloudflareDnsRecordsName")]
        internal sealed class _Proxy : DeputyBase, cloudflare.DataCloudflareDnsRecords.IDataCloudflareDnsRecordsName
        {
