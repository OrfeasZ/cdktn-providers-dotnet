...
{
    [JsiiClass(nativeType: typeof(cloudflare.PagesProject.PagesProjectCanonicalDeploymentSourceConfigOutputReference), fullyQualifiedName: "cloudflare.pagesProject.PagesProjectCanonicalDeploymentSourceConfigOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktn.IInterpolatingParent\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}}]")]
    public class PagesProjectCanonicalDeploymentSourceConfigOutputReference : Io.Cdktn.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        public PagesProjectCanonicalDeploymentSourceConfigOutputReference(Io.Cdktn.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
        ...
        protected PagesProjectCanonicalDeploymentSourceConfigOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected PagesProjectCanonicalDeploymentSourceConfigOutputReference(DeputyProps props): base(props)
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"cloudflare.pagesProject.PagesProjectCanonicalDeploymentSourceConfig\"}", isOptional: true)]
        public virtual cloudflare.PagesProject.IPagesProjectCanonicalDeploymentSourceConfig? InternalValue
        {
            get => GetInstanceProperty<cloudflare.PagesProject.IPagesProjectCanonicalDeploymentSourceConfig?>();
