...
{
    [JsiiClass(nativeType: typeof(cloudflare.PagesProject.PagesProjectLatestDeploymentSourceConfigOutputReference), fullyQualifiedName: "cloudflare.pagesProject.PagesProjectLatestDeploymentSourceConfigOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktn.IInterpolatingParent\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}}]")]
    public class PagesProjectLatestDeploymentSourceConfigOutputReference : Io.Cdktn.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        public PagesProjectLatestDeploymentSourceConfigOutputReference(Io.Cdktn.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
        ...
        protected PagesProjectLatestDeploymentSourceConfigOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected PagesProjectLatestDeploymentSourceConfigOutputReference(DeputyProps props): base(props)
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"cloudflare.pagesProject.PagesProjectLatestDeploymentSourceConfig\"}", isOptional: true)]
        public virtual cloudflare.PagesProject.IPagesProjectLatestDeploymentSourceConfig? InternalValue
        {
            get => GetInstanceProperty<cloudflare.PagesProject.IPagesProjectLatestDeploymentSourceConfig?>();
