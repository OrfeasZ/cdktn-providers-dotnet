...
namespace cloudflare.DataCloudflareOrganizationProfile
{
    ...
    public interface IDataCloudflareOrganizationProfileAConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataCloudflareOrganizationProfileAConfig), fullyQualifiedName: "cloudflare.dataCloudflareOrganizationProfile.DataCloudflareOrganizationProfileAConfig")]
        internal sealed class _Proxy : DeputyBase, cloudflare.DataCloudflareOrganizationProfile.IDataCloudflareOrganizationProfileAConfig
        {
