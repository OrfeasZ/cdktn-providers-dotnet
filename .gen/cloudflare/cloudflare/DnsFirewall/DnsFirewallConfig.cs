...
namespace cloudflare.DnsFirewall
{
    ...
    public class DnsFirewallConfig : cloudflare.DnsFirewall.IDnsFirewallConfig
    {
        ...
        /// <summary>Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.7.1/docs/resources/dns_firewall#upstream_ips DnsFirewall#upstream_ips}.</summary>
        ...
        /// <summary>Maximum DNS cache TTL This setting sets an upper bound on DNS TTLs for purposes of caching between DNS Firewall and the upstream servers.</summary>
        /// <remarks>
        ...
        /// <summary>Minimum DNS cache TTL This setting sets a lower bound on DNS TTLs for purposes of caching between DNS Firewall and the upstream servers.</summary>
        /// <remarks>
