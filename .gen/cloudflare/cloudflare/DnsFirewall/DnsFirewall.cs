...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.24.0/docs/resources/dns_firewall cloudflare_dns_firewall}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.24.0/docs/resources/dns_firewall cloudflare_dns_firewall} Resource.</summary>
        ...
        [JsiiMethod(name: "resetDnsFirewallIpCount")]
        public virtual void ResetDnsFirewallIpCount()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "dnsFirewallIpCountInput", typeJson: "{\"primitive\":\"number\"}", isOptional: true)]
        public virtual double? DnsFirewallIpCountInput
        {
        ...
        [JsiiProperty(name: "dnsFirewallIpCount", typeJson: "{\"primitive\":\"number\"}")]
        public virtual double DnsFirewallIpCount
        {
            get => GetInstanceProperty<double>()!;
            set => SetInstanceProperty(value);
        }
