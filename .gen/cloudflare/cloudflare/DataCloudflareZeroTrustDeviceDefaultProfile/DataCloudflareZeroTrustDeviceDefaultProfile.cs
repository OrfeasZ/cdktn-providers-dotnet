...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.24.0/docs/data-sources/zero_trust_device_default_profile cloudflare_zero_trust_device_default_profile}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.24.0/docs/data-sources/zero_trust_device_default_profile cloudflare_zero_trust_device_default_profile} Data Source.</summary>
        ...
        [JsiiProperty(name: "dnsSearchSuffixes", typeJson: "{\"fqn\":\"cloudflare.dataCloudflareZeroTrustDeviceDefaultProfile.DataCloudflareZeroTrustDeviceDefaultProfileDnsSearchSuffixesList\"}")]
        public virtual cloudflare.DataCloudflareZeroTrustDeviceDefaultProfile.DataCloudflareZeroTrustDeviceDefaultProfileDnsSearchSuffixesList DnsSearchSuffixes
        {
            get => GetInstanceProperty<cloudflare.DataCloudflareZeroTrustDeviceDefaultProfile.DataCloudflareZeroTrustDeviceDefaultProfileDnsSearchSuffixesList>()!;
        }
        ...
        [JsiiProperty(name: "virtualNetworks", typeJson: "{\"fqn\":\"cloudflare.dataCloudflareZeroTrustDeviceDefaultProfile.DataCloudflareZeroTrustDeviceDefaultProfileVirtualNetworksOutputReference\"}")]
        public virtual cloudflare.DataCloudflareZeroTrustDeviceDefaultProfile.DataCloudflareZeroTrustDeviceDefaultProfileVirtualNetworksOutputReference VirtualNetworks
        {
            get => GetInstanceProperty<cloudflare.DataCloudflareZeroTrustDeviceDefaultProfile.DataCloudflareZeroTrustDeviceDefaultProfileVirtualNetworksOutputReference>()!;
        }
