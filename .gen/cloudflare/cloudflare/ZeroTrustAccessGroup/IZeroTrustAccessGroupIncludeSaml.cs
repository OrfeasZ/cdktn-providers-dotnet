...
{
    [JsiiInterface(nativeType: typeof(IZeroTrustAccessGroupIncludeSaml), fullyQualifiedName: "cloudflare.zeroTrustAccessGroup.ZeroTrustAccessGroupIncludeSaml")]
    public interface IZeroTrustAccessGroupIncludeSaml
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IZeroTrustAccessGroupIncludeSaml), fullyQualifiedName: "cloudflare.zeroTrustAccessGroup.ZeroTrustAccessGroupIncludeSaml")]
        internal sealed class _Proxy : DeputyBase, cloudflare.ZeroTrustAccessGroup.IZeroTrustAccessGroupIncludeSaml
        {
