...
{
    [JsiiInterface(nativeType: typeof(IZeroTrustAccessGroupRequireSaml), fullyQualifiedName: "cloudflare.zeroTrustAccessGroup.ZeroTrustAccessGroupRequireSaml")]
    public interface IZeroTrustAccessGroupRequireSaml
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IZeroTrustAccessGroupRequireSaml), fullyQualifiedName: "cloudflare.zeroTrustAccessGroup.ZeroTrustAccessGroupRequireSaml")]
        internal sealed class _Proxy : DeputyBase, cloudflare.ZeroTrustAccessGroup.IZeroTrustAccessGroupRequireSaml
        {
