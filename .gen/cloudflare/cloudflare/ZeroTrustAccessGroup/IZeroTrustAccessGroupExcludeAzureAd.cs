...
{
    [JsiiInterface(nativeType: typeof(IZeroTrustAccessGroupExcludeAzureAd), fullyQualifiedName: "cloudflare.zeroTrustAccessGroup.ZeroTrustAccessGroupExcludeAzureAd")]
    public interface IZeroTrustAccessGroupExcludeAzureAd
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IZeroTrustAccessGroupExcludeAzureAd), fullyQualifiedName: "cloudflare.zeroTrustAccessGroup.ZeroTrustAccessGroupExcludeAzureAd")]
        internal sealed class _Proxy : DeputyBase, cloudflare.ZeroTrustAccessGroup.IZeroTrustAccessGroupExcludeAzureAd
        {
