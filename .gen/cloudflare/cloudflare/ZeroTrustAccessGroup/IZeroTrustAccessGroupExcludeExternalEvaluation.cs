...
{
    [JsiiInterface(nativeType: typeof(IZeroTrustAccessGroupExcludeExternalEvaluation), fullyQualifiedName: "cloudflare.zeroTrustAccessGroup.ZeroTrustAccessGroupExcludeExternalEvaluation")]
    public interface IZeroTrustAccessGroupExcludeExternalEvaluation
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IZeroTrustAccessGroupExcludeExternalEvaluation), fullyQualifiedName: "cloudflare.zeroTrustAccessGroup.ZeroTrustAccessGroupExcludeExternalEvaluation")]
        internal sealed class _Proxy : DeputyBase, cloudflare.ZeroTrustAccessGroup.IZeroTrustAccessGroupExcludeExternalEvaluation
        {
