...
{
    [JsiiInterface(nativeType: typeof(IZeroTrustAccessGroupRequire), fullyQualifiedName: "cloudflare.zeroTrustAccessGroup.ZeroTrustAccessGroupRequire")]
    public interface IZeroTrustAccessGroupRequire
    {
        ...
        cloudflare.ZeroTrustAccessGroup.IZeroTrustAccessGroupRequireAnyValidServiceToken? AnyValidServiceToken
        {
            get
            {
                return null;
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        cloudflare.ZeroTrustAccessGroup.IZeroTrustAccessGroupRequireEveryone? Everyone
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IZeroTrustAccessGroupRequire), fullyQualifiedName: "cloudflare.zeroTrustAccessGroup.ZeroTrustAccessGroupRequire")]
        internal sealed class _Proxy : DeputyBase, cloudflare.ZeroTrustAccessGroup.IZeroTrustAccessGroupRequire
        {
            ...
            {
                get => GetInstanceProperty<cloudflare.ZeroTrustAccessGroup.IZeroTrustAccessGroupRequireEmailListStruct?>();
            }
            ...
            {
                get => GetInstanceProperty<cloudflare.ZeroTrustAccessGroup.IZeroTrustAccessGroupRequireUserRiskScore?>();
            }
        }
    }
}
