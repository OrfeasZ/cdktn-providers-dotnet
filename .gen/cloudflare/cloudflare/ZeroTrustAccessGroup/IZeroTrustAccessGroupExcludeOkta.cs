...
{
    [JsiiInterface(nativeType: typeof(IZeroTrustAccessGroupExcludeOkta), fullyQualifiedName: "cloudflare.zeroTrustAccessGroup.ZeroTrustAccessGroupExcludeOkta")]
    public interface IZeroTrustAccessGroupExcludeOkta
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IZeroTrustAccessGroupExcludeOkta), fullyQualifiedName: "cloudflare.zeroTrustAccessGroup.ZeroTrustAccessGroupExcludeOkta")]
        internal sealed class _Proxy : DeputyBase, cloudflare.ZeroTrustAccessGroup.IZeroTrustAccessGroupExcludeOkta
        {
