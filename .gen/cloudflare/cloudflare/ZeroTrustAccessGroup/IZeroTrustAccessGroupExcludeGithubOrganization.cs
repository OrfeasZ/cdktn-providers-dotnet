...
{
    [JsiiInterface(nativeType: typeof(IZeroTrustAccessGroupExcludeGithubOrganization), fullyQualifiedName: "cloudflare.zeroTrustAccessGroup.ZeroTrustAccessGroupExcludeGithubOrganization")]
    public interface IZeroTrustAccessGroupExcludeGithubOrganization
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IZeroTrustAccessGroupExcludeGithubOrganization), fullyQualifiedName: "cloudflare.zeroTrustAccessGroup.ZeroTrustAccessGroupExcludeGithubOrganization")]
        internal sealed class _Proxy : DeputyBase, cloudflare.ZeroTrustAccessGroup.IZeroTrustAccessGroupExcludeGithubOrganization
        {
