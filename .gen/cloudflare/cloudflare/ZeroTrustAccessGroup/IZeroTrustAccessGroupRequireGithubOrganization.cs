...
{
    [JsiiInterface(nativeType: typeof(IZeroTrustAccessGroupRequireGithubOrganization), fullyQualifiedName: "cloudflare.zeroTrustAccessGroup.ZeroTrustAccessGroupRequireGithubOrganization")]
    public interface IZeroTrustAccessGroupRequireGithubOrganization
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IZeroTrustAccessGroupRequireGithubOrganization), fullyQualifiedName: "cloudflare.zeroTrustAccessGroup.ZeroTrustAccessGroupRequireGithubOrganization")]
        internal sealed class _Proxy : DeputyBase, cloudflare.ZeroTrustAccessGroup.IZeroTrustAccessGroupRequireGithubOrganization
        {
