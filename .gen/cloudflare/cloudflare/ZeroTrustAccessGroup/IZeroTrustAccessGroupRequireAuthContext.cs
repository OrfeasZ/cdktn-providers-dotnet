...
{
    [JsiiInterface(nativeType: typeof(IZeroTrustAccessGroupRequireAuthContext), fullyQualifiedName: "cloudflare.zeroTrustAccessGroup.ZeroTrustAccessGroupRequireAuthContext")]
    public interface IZeroTrustAccessGroupRequireAuthContext
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IZeroTrustAccessGroupRequireAuthContext), fullyQualifiedName: "cloudflare.zeroTrustAccessGroup.ZeroTrustAccessGroupRequireAuthContext")]
        internal sealed class _Proxy : DeputyBase, cloudflare.ZeroTrustAccessGroup.IZeroTrustAccessGroupRequireAuthContext
        {
