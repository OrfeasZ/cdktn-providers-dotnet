...
namespace cloudflare.ZeroTrustAccessGroup
{
    ...
    public interface IZeroTrustAccessGroupInclude
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        cloudflare.ZeroTrustAccessGroup.IZeroTrustAccessGroupIncludeCloudflareAccountMember? CloudflareAccountMember
        {
            get
            {
                return null;
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        cloudflare.ZeroTrustAccessGroup.IZeroTrustAccessGroupIncludeUserRiskScore? UserRiskScore
        {
            get
            {
                return null;
        ...
        internal sealed class _Proxy : DeputyBase, cloudflare.ZeroTrustAccessGroup.IZeroTrustAccessGroupInclude
        {
            ...
            {
                get => GetInstanceProperty<cloudflare.ZeroTrustAccessGroup.IZeroTrustAccessGroupIncludeCloudflareAccountMember?>();
            }
            ...
            {
                get => GetInstanceProperty<cloudflare.ZeroTrustAccessGroup.IZeroTrustAccessGroupIncludeUserRiskScore?>();
            }
        }
    }
}
