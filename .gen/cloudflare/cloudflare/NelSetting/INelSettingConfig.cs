...
{
    [JsiiInterface(nativeType: typeof(INelSettingConfig), fullyQualifiedName: "cloudflare.nelSetting.NelSettingConfig")]
    public interface INelSettingConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(INelSettingConfig), fullyQualifiedName: "cloudflare.nelSetting.NelSettingConfig")]
        internal sealed class _Proxy : DeputyBase, cloudflare.NelSetting.INelSettingConfig
        {
            ...
            {
                get => GetInstanceProperty<cloudflare.NelSetting.INelSettingValue>()!;
            }
