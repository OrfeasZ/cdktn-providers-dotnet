...
namespace cloudflare.PipelineStream
{
    ...
    [JsiiByValue(fqn: "cloudflare.pipelineStream.PipelineStreamSchemaFormat")]
    public class PipelineStreamSchemaFormat : cloudflare.PipelineStream.IPipelineStreamSchemaFormat
    {
