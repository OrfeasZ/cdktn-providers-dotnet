...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.26.0/docs/resources/worker_version cloudflare_worker_version}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.26.0/docs/resources/worker_version cloudflare_worker_version} Resource.</summary>
        ...
        /// <param name="value">Type union: either <see cref="Io.Cdktn.IResolvable" /> or Dictionary&lt;string, <see cref="cloudflare.WorkerVersion.IWorkerVersionExports" />&gt;</param>
        [JsiiMethod(name: "putExports", parametersJson: "[{\"name\":\"value\",\"type\":{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"cloudflare.workerVersion.WorkerVersionExports\"},\"kind\":\"map\"}}]}}}]")]
        public virtual void PutExports(object @value)
        {
            if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
            {
                switch (@value)
                {
                    case Io.Cdktn.IResolvable cast_2ed7d7:
                        break;
                    case System.Collections.Generic.IDictionary<string, cloudflare.WorkerVersion.IWorkerVersionExports> cast_2ed7d7:
                        break;
                    case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_2ed7d7:
                        // Not enough information to type-check...
                        break;
                    case null:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, System.Collections.Generic.IDictionary<string, {typeof(cloudflare.WorkerVersion.IWorkerVersionExports).FullName}>; received null", nameof(@value));
                    default:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, System.Collections.Generic.IDictionary<string, {typeof(cloudflare.WorkerVersion.IWorkerVersionExports).FullName}>; received {@value.GetType().FullName}", nameof(@value));
                }
            }
            InvokeInstanceVoidMethod(new System.Type[]{typeof(object)}, new object[]{@value});
        }
        ...
        [JsiiProperty(name: "exports", typeJson: "{\"fqn\":\"cloudflare.workerVersion.WorkerVersionExportsMap\"}")]
        public virtual cloudflare.WorkerVersion.WorkerVersionExportsMap Exports
        {
            get => GetInstanceProperty<cloudflare.WorkerVersion.WorkerVersionExportsMap>()!;
        }

        [JsiiProperty(name: "exportsReconciliation", typeJson: "{\"fqn\":\"cloudflare.workerVersion.WorkerVersionExportsReconciliationOutputReference\"}")]
        public virtual cloudflare.WorkerVersion.WorkerVersionExportsReconciliationOutputReference ExportsReconciliation
        {
            get => GetInstanceProperty<cloudflare.WorkerVersion.WorkerVersionExportsReconciliationOutputReference>()!;
        }
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "exportsInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"cloudflare.workerVersion.WorkerVersionExports\"},\"kind\":\"map\"}}]}}", isOptional: true)]
