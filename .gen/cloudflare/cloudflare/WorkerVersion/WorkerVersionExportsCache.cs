...
namespace cloudflare.WorkerVersion
{
    ...
    [JsiiByValue(fqn: "cloudflare.workerVersion.WorkerVersionExportsCache")]
    public class WorkerVersionExportsCache : cloudflare.WorkerVersion.IWorkerVersionExportsCache
    {
