...
{
    [JsiiInterface(nativeType: typeof(IPipelineSinkFormat), fullyQualifiedName: "cloudflare.pipelineSink.PipelineSinkFormat")]
    public interface IPipelineSinkFormat
    {
        ...
        /// <summary>Specifies the compression applied to JSON sink output. Available values: "uncompressed", "gzip", "snappy", "zstd", "lz4".</summary>
        /// <remarks>
        ...
        /// <summary>Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/resources/pipeline_sink#row_group_bytes PipelineSink#row_group_bytes}.</summary>
        ...
        /// <summary>Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/resources/pipeline_sink#unstructured PipelineSink#unstructured}.</summary>
        /// <remarks>
        ...
        [JsiiTypeProxy(nativeType: typeof(IPipelineSinkFormat), fullyQualifiedName: "cloudflare.pipelineSink.PipelineSinkFormat")]
        internal sealed class _Proxy : DeputyBase, cloudflare.PipelineSink.IPipelineSinkFormat
        {
