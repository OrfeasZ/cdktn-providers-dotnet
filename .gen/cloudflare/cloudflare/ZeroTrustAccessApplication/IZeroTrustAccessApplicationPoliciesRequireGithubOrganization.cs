...
{
    [JsiiInterface(nativeType: typeof(IZeroTrustAccessApplicationPoliciesRequireGithubOrganization), fullyQualifiedName: "cloudflare.zeroTrustAccessApplication.ZeroTrustAccessApplicationPoliciesRequireGithubOrganization")]
    public interface IZeroTrustAccessApplicationPoliciesRequireGithubOrganization
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IZeroTrustAccessApplicationPoliciesRequireGithubOrganization), fullyQualifiedName: "cloudflare.zeroTrustAccessApplication.ZeroTrustAccessApplicationPoliciesRequireGithubOrganization")]
        internal sealed class _Proxy : DeputyBase, cloudflare.ZeroTrustAccessApplication.IZeroTrustAccessApplicationPoliciesRequireGithubOrganization
        {
