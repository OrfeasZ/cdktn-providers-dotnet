...
namespace cloudflare.ZeroTrustAccessApplication
{
    ...
    public interface IZeroTrustAccessApplicationPolicies
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        cloudflare.ZeroTrustAccessApplication.IZeroTrustAccessApplicationPoliciesMfaConfig? MfaConfig
        {
            get
            {
                return null;
        ...
        internal sealed class _Proxy : DeputyBase, cloudflare.ZeroTrustAccessApplication.IZeroTrustAccessApplicationPolicies
        {
            ...
            {
                get => GetInstanceProperty<cloudflare.ZeroTrustAccessApplication.IZeroTrustAccessApplicationPoliciesMfaConfig?>();
            }
