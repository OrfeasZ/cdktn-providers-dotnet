...
{
    [JsiiInterface(nativeType: typeof(IZeroTrustAccessApplicationPoliciesRequireExternalEvaluation), fullyQualifiedName: "cloudflare.zeroTrustAccessApplication.ZeroTrustAccessApplicationPoliciesRequireExternalEvaluation")]
    public interface IZeroTrustAccessApplicationPoliciesRequireExternalEvaluation
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IZeroTrustAccessApplicationPoliciesRequireExternalEvaluation), fullyQualifiedName: "cloudflare.zeroTrustAccessApplication.ZeroTrustAccessApplicationPoliciesRequireExternalEvaluation")]
        internal sealed class _Proxy : DeputyBase, cloudflare.ZeroTrustAccessApplication.IZeroTrustAccessApplicationPoliciesRequireExternalEvaluation
        {
