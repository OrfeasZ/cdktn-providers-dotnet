...
{
    [JsiiInterface(nativeType: typeof(IZeroTrustAccessApplicationPoliciesRequireSaml), fullyQualifiedName: "cloudflare.zeroTrustAccessApplication.ZeroTrustAccessApplicationPoliciesRequireSaml")]
    public interface IZeroTrustAccessApplicationPoliciesRequireSaml
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IZeroTrustAccessApplicationPoliciesRequireSaml), fullyQualifiedName: "cloudflare.zeroTrustAccessApplication.ZeroTrustAccessApplicationPoliciesRequireSaml")]
        internal sealed class _Proxy : DeputyBase, cloudflare.ZeroTrustAccessApplication.IZeroTrustAccessApplicationPoliciesRequireSaml
        {
