...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.7.1/docs/resources/queue_consumer cloudflare_queue_consumer}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.7.1/docs/resources/queue_consumer cloudflare_queue_consumer} Resource.</summary>
        ...
        [JsiiMethod(name: "resetConsumerId")]
        public virtual void ResetConsumerId()
        {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "consumerIdInput", typeJson: "{\"primitive\":\"string\"}", isOptional: true)]
        public virtual string? ConsumerIdInput
        {
            get => GetInstanceProperty<string?>();
        }
