...
namespace cloudflare.QueueConsumer
{
    ...
    [JsiiByValue(fqn: "cloudflare.queueConsumer.QueueConsumerSettingsEmail")]
    public class QueueConsumerSettingsEmail : cloudflare.QueueConsumer.IQueueConsumerSettingsEmail
    {
