...
namespace cloudflare.QueueConsumer
{
    ...
    [JsiiByValue(fqn: "cloudflare.queueConsumer.QueueConsumerSettingsWebhooks")]
    public class QueueConsumerSettingsWebhooks : cloudflare.QueueConsumer.IQueueConsumerSettingsWebhooks
    {
