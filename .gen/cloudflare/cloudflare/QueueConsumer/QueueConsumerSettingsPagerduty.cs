...
namespace cloudflare.QueueConsumer
{
    ...
    [JsiiByValue(fqn: "cloudflare.queueConsumer.QueueConsumerSettingsPagerduty")]
    public class QueueConsumerSettingsPagerduty : cloudflare.QueueConsumer.IQueueConsumerSettingsPagerduty
    {
