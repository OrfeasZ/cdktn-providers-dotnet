...
{
    [JsiiInterface(nativeType: typeof(IZeroTrustDeviceDefaultProfileExclude), fullyQualifiedName: "cloudflare.zeroTrustDeviceDefaultProfile.ZeroTrustDeviceDefaultProfileExclude")]
    public interface IZeroTrustDeviceDefaultProfileExclude
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IZeroTrustDeviceDefaultProfileExclude), fullyQualifiedName: "cloudflare.zeroTrustDeviceDefaultProfile.ZeroTrustDeviceDefaultProfileExclude")]
        internal sealed class _Proxy : DeputyBase, cloudflare.ZeroTrustDeviceDefaultProfile.IZeroTrustDeviceDefaultProfileExclude
        {
