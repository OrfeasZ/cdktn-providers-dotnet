...
namespace cloudflare.RegionalHostname
{
    ...
    [JsiiByValue(fqn: "cloudflare.regionalHostname.RegionalHostnameConfig")]
    public class RegionalHostnameConfig : cloudflare.RegionalHostname.IRegionalHostnameConfig
    {
