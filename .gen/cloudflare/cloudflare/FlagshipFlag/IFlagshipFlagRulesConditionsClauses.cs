...
{
    [JsiiInterface(nativeType: typeof(IFlagshipFlagRulesConditionsClauses), fullyQualifiedName: "cloudflare.flagshipFlag.FlagshipFlagRulesConditionsClauses")]
    public interface IFlagshipFlagRulesConditionsClauses
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IFlagshipFlagRulesConditionsClauses), fullyQualifiedName: "cloudflare.flagshipFlag.FlagshipFlagRulesConditionsClauses")]
        internal sealed class _Proxy : DeputyBase, cloudflare.FlagshipFlag.IFlagshipFlagRulesConditionsClauses
        {
