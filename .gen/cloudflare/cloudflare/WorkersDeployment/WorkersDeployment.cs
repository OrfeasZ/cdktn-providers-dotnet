...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.7.1/docs/resources/workers_deployment cloudflare_workers_deployment}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.7.1/docs/resources/workers_deployment cloudflare_workers_deployment} Resource.</summary>
        ...
        [JsiiProperty(name: "deployments", typeJson: "{\"fqn\":\"cloudflare.workersDeployment.WorkersDeploymentDeploymentsList\"}")]
        public virtual cloudflare.WorkersDeployment.WorkersDeploymentDeploymentsList Deployments
        {
            get => GetInstanceProperty<cloudflare.WorkersDeployment.WorkersDeploymentDeploymentsList>()!;
        }
