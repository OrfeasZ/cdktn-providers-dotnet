...
namespace cloudflare.EmailRoutingCatchAll
{
    ...
    [JsiiByValue(fqn: "cloudflare.emailRoutingCatchAll.EmailRoutingCatchAllConfig")]
    public class EmailRoutingCatchAllConfig : cloudflare.EmailRoutingCatchAll.IEmailRoutingCatchAllConfig
    {
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            ...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(cloudflare.EmailRoutingCatchAll.IEmailRoutingCatchAllActions).FullName}[]; received null", nameof(value));
                        default:
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            ...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(cloudflare.EmailRoutingCatchAll.IEmailRoutingCatchAllMatchers).FullName}[]; received null", nameof(value));
                        default:
