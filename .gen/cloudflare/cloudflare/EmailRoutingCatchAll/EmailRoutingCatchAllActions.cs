...
namespace cloudflare.EmailRoutingCatchAll
{
    ...
    public class EmailRoutingCatchAllActions : cloudflare.EmailRoutingCatchAll.IEmailRoutingCatchAllActions
    {
        ...
        /// <summary>Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.23.0/docs/resources/email_routing_catch_all#value EmailRoutingCatchAll#value}.</summary>
        [JsiiOptional]
