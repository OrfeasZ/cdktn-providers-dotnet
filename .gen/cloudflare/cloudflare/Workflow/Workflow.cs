...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/resources/workflow cloudflare_workflow}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/resources/workflow cloudflare_workflow} Resource.</summary>
        ...
        [JsiiMethod(name: "putConcurrency", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"cloudflare.workflow.WorkflowConcurrency\"}}]")]
        public virtual void PutConcurrency(cloudflare.Workflow.IWorkflowConcurrency @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(cloudflare.Workflow.IWorkflowConcurrency)}, new object[]{@value});
        }

        [JsiiMethod(name: "putDefaultRetention", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"cloudflare.workflow.WorkflowDefaultRetention\"}}]")]
        public virtual void PutDefaultRetention(cloudflare.Workflow.IWorkflowDefaultRetention @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(cloudflare.Workflow.IWorkflowDefaultRetention)}, new object[]{@value});
        }

        [JsiiMethod(name: "putLimits", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"cloudflare.workflow.WorkflowLimits\"}}]")]
        public virtual void PutLimits(cloudflare.Workflow.IWorkflowLimits @value)
        {
            ...
            if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
            {
                switch (@value)
                {
                    case Io.Cdktn.IResolvable cast_2ed7d7:
                        break;
                    case cloudflare.Workflow.IWorkflowSchedules[] cast_2ed7d7:
                        break;
                    case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_2ed7d7:
                        // Not enough information to type-check...
                        break;
                    case null:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(cloudflare.Workflow.IWorkflowSchedules).FullName}[]; received null", nameof(@value));
                    default:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(cloudflare.Workflow.IWorkflowSchedules).FullName}[]; received {@value.GetType().FullName}", nameof(@value));
                }
            }
        ...
        [JsiiProperty(name: "concurrency", typeJson: "{\"fqn\":\"cloudflare.workflow.WorkflowConcurrencyOutputReference\"}")]
        public virtual cloudflare.Workflow.WorkflowConcurrencyOutputReference Concurrency
        {
            get => GetInstanceProperty<cloudflare.Workflow.WorkflowConcurrencyOutputReference>()!;
        }
        ...
        [JsiiProperty(name: "defaultRetention", typeJson: "{\"fqn\":\"cloudflare.workflow.WorkflowDefaultRetentionOutputReference\"}")]
        public virtual cloudflare.Workflow.WorkflowDefaultRetentionOutputReference DefaultRetention
        {
            get => GetInstanceProperty<cloudflare.Workflow.WorkflowDefaultRetentionOutputReference>()!;
        }
        ...
        [JsiiProperty(name: "limits", typeJson: "{\"fqn\":\"cloudflare.workflow.WorkflowLimitsOutputReference\"}")]
        public virtual cloudflare.Workflow.WorkflowLimitsOutputReference Limits
        {
            get => GetInstanceProperty<cloudflare.Workflow.WorkflowLimitsOutputReference>()!;
        }
        ...
        [JsiiProperty(name: "schedules", typeJson: "{\"fqn\":\"cloudflare.workflow.WorkflowSchedulesList\"}")]
        public virtual cloudflare.Workflow.WorkflowSchedulesList Schedules
        {
            get => GetInstanceProperty<cloudflare.Workflow.WorkflowSchedulesList>()!;
        }
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "concurrencyInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"cloudflare.workflow.WorkflowConcurrency\"}]}}", isOptional: true)]
        public virtual object? ConcurrencyInput
        {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "defaultRetentionInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"cloudflare.workflow.WorkflowDefaultRetention\"}]}}", isOptional: true)]
        public virtual object? DefaultRetentionInput
        {
            get => GetInstanceProperty<object?>();
        }
