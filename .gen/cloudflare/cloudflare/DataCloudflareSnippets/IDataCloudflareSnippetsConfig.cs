...
namespace cloudflare.DataCloudflareSnippets
{
    ...
    public interface IDataCloudflareSnippetsConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataCloudflareSnippetsConfig), fullyQualifiedName: "cloudflare.dataCloudflareSnippets.DataCloudflareSnippetsConfig")]
        internal sealed class _Proxy : DeputyBase, cloudflare.DataCloudflareSnippets.IDataCloudflareSnippetsConfig
        {
