...
{
    [JsiiInterface(nativeType: typeof(IDataCloudflareCertificatePacksConfig), fullyQualifiedName: "cloudflare.dataCloudflareCertificatePacks.DataCloudflareCertificatePacksConfig")]
    public interface IDataCloudflareCertificatePacksConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataCloudflareCertificatePacksConfig), fullyQualifiedName: "cloudflare.dataCloudflareCertificatePacks.DataCloudflareCertificatePacksConfig")]
        internal sealed class _Proxy : DeputyBase, cloudflare.DataCloudflareCertificatePacks.IDataCloudflareCertificatePacksConfig
        {
