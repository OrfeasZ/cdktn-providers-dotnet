...
namespace cloudflare.ZeroTrustDeviceCustomProfile
{
    ...
    public interface IZeroTrustDeviceCustomProfileConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        cloudflare.ZeroTrustDeviceCustomProfile.IZeroTrustDeviceCustomProfileBrowserExtensionConfig? BrowserExtensionConfig
        {
            get
            {
                return null;
        ...
        internal sealed class _Proxy : DeputyBase, cloudflare.ZeroTrustDeviceCustomProfile.IZeroTrustDeviceCustomProfileConfig
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "browserExtensionConfig", typeJson: "{\"fqn\":\"cloudflare.zeroTrustDeviceCustomProfile.ZeroTrustDeviceCustomProfileBrowserExtensionConfig\"}", isOptional: true)]
            public cloudflare.ZeroTrustDeviceCustomProfile.IZeroTrustDeviceCustomProfileBrowserExtensionConfig? BrowserExtensionConfig
            {
                get => GetInstanceProperty<cloudflare.ZeroTrustDeviceCustomProfile.IZeroTrustDeviceCustomProfileBrowserExtensionConfig?>();
            }
