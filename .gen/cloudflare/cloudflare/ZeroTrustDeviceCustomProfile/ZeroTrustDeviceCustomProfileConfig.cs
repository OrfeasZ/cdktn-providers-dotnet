...
namespace cloudflare.ZeroTrustDeviceCustomProfile
{
    ...
    public class ZeroTrustDeviceCustomProfileConfig : cloudflare.ZeroTrustDeviceCustomProfile.IZeroTrustDeviceCustomProfileConfig
    {
        ...
        private object? _dnsSearchSuffixes;
            ...
            set
            {
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        case Io.Cdktn.IResolvable cast_cd4240:
                            break;
                        case cloudflare.ZeroTrustDeviceCustomProfile.IZeroTrustDeviceCustomProfileDnsSearchSuffixes[] cast_cd4240:
                            break;
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            // Not enough information to type-check...
                            break;
                        case null:
                            break;
                        default:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(cloudflare.ZeroTrustDeviceCustomProfile.IZeroTrustDeviceCustomProfileDnsSearchSuffixes).FullName}[]; received {value.GetType().FullName}", nameof(value));
                    }
                }
                _dnsSearchSuffixes = value;
            }
        }
