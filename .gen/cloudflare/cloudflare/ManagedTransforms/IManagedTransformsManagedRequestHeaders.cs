...
{
    [JsiiInterface(nativeType: typeof(IManagedTransformsManagedRequestHeaders), fullyQualifiedName: "cloudflare.managedTransforms.ManagedTransformsManagedRequestHeaders")]
    public interface IManagedTransformsManagedRequestHeaders
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IManagedTransformsManagedRequestHeaders), fullyQualifiedName: "cloudflare.managedTransforms.ManagedTransformsManagedRequestHeaders")]
        internal sealed class _Proxy : DeputyBase, cloudflare.ManagedTransforms.IManagedTransformsManagedRequestHeaders
        {
