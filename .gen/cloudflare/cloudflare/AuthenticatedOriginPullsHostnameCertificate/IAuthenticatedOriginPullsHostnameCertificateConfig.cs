...
{
    [JsiiInterface(nativeType: typeof(IAuthenticatedOriginPullsHostnameCertificateConfig), fullyQualifiedName: "cloudflare.authenticatedOriginPullsHostnameCertificate.AuthenticatedOriginPullsHostnameCertificateConfig")]
    public interface IAuthenticatedOriginPullsHostnameCertificateConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IAuthenticatedOriginPullsHostnameCertificateConfig), fullyQualifiedName: "cloudflare.authenticatedOriginPullsHostnameCertificate.AuthenticatedOriginPullsHostnameCertificateConfig")]
        internal sealed class _Proxy : DeputyBase, cloudflare.AuthenticatedOriginPullsHostnameCertificate.IAuthenticatedOriginPullsHostnameCertificateConfig
        {
