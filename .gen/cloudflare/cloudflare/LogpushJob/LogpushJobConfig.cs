...
namespace cloudflare.LogpushJob
{
    ...
    [JsiiByValue(fqn: "cloudflare.logpushJob.LogpushJobConfig")]
    public class LogpushJobConfig : cloudflare.LogpushJob.ILogpushJobConfig
    {
        ...
        private object? _filterAttackTraffic;

        /// <summary>When true, excludes DDoS attack traffic from logs. This option is supported for the `http_requests`, `firewall_events`, and `network_analytics_logs` datasets.</summary>
        /// <remarks>
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "filterAttackTraffic", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktn.IResolvable\"}]}}", isOptional: true)]
        public object? FilterAttackTraffic
        {
            get => _filterAttackTraffic;
            set
            {
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
