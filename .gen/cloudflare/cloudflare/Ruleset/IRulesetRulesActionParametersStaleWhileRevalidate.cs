...
{
    [JsiiInterface(nativeType: typeof(IRulesetRulesActionParametersStaleWhileRevalidate), fullyQualifiedName: "cloudflare.ruleset.RulesetRulesActionParametersStaleWhileRevalidate")]
    public interface IRulesetRulesActionParametersStaleWhileRevalidate
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IRulesetRulesActionParametersStaleWhileRevalidate), fullyQualifiedName: "cloudflare.ruleset.RulesetRulesActionParametersStaleWhileRevalidate")]
        internal sealed class _Proxy : DeputyBase, cloudflare.Ruleset.IRulesetRulesActionParametersStaleWhileRevalidate
        {
