...
{
    [JsiiInterface(nativeType: typeof(IRulesetRulesActionParametersNoStore), fullyQualifiedName: "cloudflare.ruleset.RulesetRulesActionParametersNoStore")]
    public interface IRulesetRulesActionParametersNoStore
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IRulesetRulesActionParametersNoStore), fullyQualifiedName: "cloudflare.ruleset.RulesetRulesActionParametersNoStore")]
        internal sealed class _Proxy : DeputyBase, cloudflare.Ruleset.IRulesetRulesActionParametersNoStore
        {
