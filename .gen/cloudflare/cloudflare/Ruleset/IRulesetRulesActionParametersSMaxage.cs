...
{
    [JsiiInterface(nativeType: typeof(IRulesetRulesActionParametersSMaxage), fullyQualifiedName: "cloudflare.ruleset.RulesetRulesActionParametersSMaxage")]
    public interface IRulesetRulesActionParametersSMaxage
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IRulesetRulesActionParametersSMaxage), fullyQualifiedName: "cloudflare.ruleset.RulesetRulesActionParametersSMaxage")]
        internal sealed class _Proxy : DeputyBase, cloudflare.Ruleset.IRulesetRulesActionParametersSMaxage
        {
