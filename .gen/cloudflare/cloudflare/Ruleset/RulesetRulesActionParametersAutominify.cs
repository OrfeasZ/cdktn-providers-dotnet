...
{
    [JsiiByValue(fqn: "cloudflare.ruleset.RulesetRulesActionParametersAutominify")]
    public class RulesetRulesActionParametersAutominify : cloudflare.Ruleset.IRulesetRulesActionParametersAutominify
    {
        private object? _css;
