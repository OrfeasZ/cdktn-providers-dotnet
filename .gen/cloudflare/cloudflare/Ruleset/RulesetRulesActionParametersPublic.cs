...
namespace cloudflare.Ruleset
{
    ...
    [JsiiByValue(fqn: "cloudflare.ruleset.RulesetRulesActionParametersPublic")]
    public class RulesetRulesActionParametersPublic : cloudflare.Ruleset.IRulesetRulesActionParametersPublic
    {
