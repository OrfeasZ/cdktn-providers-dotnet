...
namespace cloudflare.Ruleset
{
    ...
    [JsiiByValue(fqn: "cloudflare.ruleset.RulesetRulesActionParametersImmutable")]
    public class RulesetRulesActionParametersImmutable : cloudflare.Ruleset.IRulesetRulesActionParametersImmutable
    {
