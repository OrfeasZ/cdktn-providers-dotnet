...
namespace cloudflare.Ruleset
{
    ...
    [JsiiByValue(fqn: "cloudflare.ruleset.RulesetRulesActionParametersMaxAge")]
    public class RulesetRulesActionParametersMaxAge : cloudflare.Ruleset.IRulesetRulesActionParametersMaxAge
    {
