...
{
    [JsiiInterface(nativeType: typeof(IRulesetRulesActionParametersProxyRevalidate), fullyQualifiedName: "cloudflare.ruleset.RulesetRulesActionParametersProxyRevalidate")]
    public interface IRulesetRulesActionParametersProxyRevalidate
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IRulesetRulesActionParametersProxyRevalidate), fullyQualifiedName: "cloudflare.ruleset.RulesetRulesActionParametersProxyRevalidate")]
        internal sealed class _Proxy : DeputyBase, cloudflare.Ruleset.IRulesetRulesActionParametersProxyRevalidate
        {
