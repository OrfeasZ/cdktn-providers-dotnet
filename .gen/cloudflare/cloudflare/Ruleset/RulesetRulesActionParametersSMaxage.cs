...
namespace cloudflare.Ruleset
{
    ...
    [JsiiByValue(fqn: "cloudflare.ruleset.RulesetRulesActionParametersSMaxage")]
    public class RulesetRulesActionParametersSMaxage : cloudflare.Ruleset.IRulesetRulesActionParametersSMaxage
    {
