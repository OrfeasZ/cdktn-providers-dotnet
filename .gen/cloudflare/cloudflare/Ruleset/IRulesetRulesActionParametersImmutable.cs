...
{
    [JsiiInterface(nativeType: typeof(IRulesetRulesActionParametersImmutable), fullyQualifiedName: "cloudflare.ruleset.RulesetRulesActionParametersImmutable")]
    public interface IRulesetRulesActionParametersImmutable
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IRulesetRulesActionParametersImmutable), fullyQualifiedName: "cloudflare.ruleset.RulesetRulesActionParametersImmutable")]
        internal sealed class _Proxy : DeputyBase, cloudflare.Ruleset.IRulesetRulesActionParametersImmutable
        {
