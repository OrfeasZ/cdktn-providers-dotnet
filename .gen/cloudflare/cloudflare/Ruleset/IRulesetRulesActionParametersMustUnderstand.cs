...
{
    [JsiiInterface(nativeType: typeof(IRulesetRulesActionParametersMustUnderstand), fullyQualifiedName: "cloudflare.ruleset.RulesetRulesActionParametersMustUnderstand")]
    public interface IRulesetRulesActionParametersMustUnderstand
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IRulesetRulesActionParametersMustUnderstand), fullyQualifiedName: "cloudflare.ruleset.RulesetRulesActionParametersMustUnderstand")]
        internal sealed class _Proxy : DeputyBase, cloudflare.Ruleset.IRulesetRulesActionParametersMustUnderstand
        {
