...
namespace cloudflare.Ruleset
{
    ...
    [JsiiByValue(fqn: "cloudflare.ruleset.RulesetRulesActionParametersNoCache")]
    public class RulesetRulesActionParametersNoCache : cloudflare.Ruleset.IRulesetRulesActionParametersNoCache
    {
