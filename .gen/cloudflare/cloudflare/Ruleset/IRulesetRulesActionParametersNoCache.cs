...
{
    [JsiiInterface(nativeType: typeof(IRulesetRulesActionParametersNoCache), fullyQualifiedName: "cloudflare.ruleset.RulesetRulesActionParametersNoCache")]
    public interface IRulesetRulesActionParametersNoCache
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IRulesetRulesActionParametersNoCache), fullyQualifiedName: "cloudflare.ruleset.RulesetRulesActionParametersNoCache")]
        internal sealed class _Proxy : DeputyBase, cloudflare.Ruleset.IRulesetRulesActionParametersNoCache
        {
