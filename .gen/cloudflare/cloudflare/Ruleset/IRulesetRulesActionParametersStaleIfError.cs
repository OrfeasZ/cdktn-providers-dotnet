...
{
    [JsiiInterface(nativeType: typeof(IRulesetRulesActionParametersStaleIfError), fullyQualifiedName: "cloudflare.ruleset.RulesetRulesActionParametersStaleIfError")]
    public interface IRulesetRulesActionParametersStaleIfError
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IRulesetRulesActionParametersStaleIfError), fullyQualifiedName: "cloudflare.ruleset.RulesetRulesActionParametersStaleIfError")]
        internal sealed class _Proxy : DeputyBase, cloudflare.Ruleset.IRulesetRulesActionParametersStaleIfError
        {
