...
{
    [JsiiInterface(nativeType: typeof(IRulesetRulesActionParametersNoTransform), fullyQualifiedName: "cloudflare.ruleset.RulesetRulesActionParametersNoTransform")]
    public interface IRulesetRulesActionParametersNoTransform
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IRulesetRulesActionParametersNoTransform), fullyQualifiedName: "cloudflare.ruleset.RulesetRulesActionParametersNoTransform")]
        internal sealed class _Proxy : DeputyBase, cloudflare.Ruleset.IRulesetRulesActionParametersNoTransform
        {
