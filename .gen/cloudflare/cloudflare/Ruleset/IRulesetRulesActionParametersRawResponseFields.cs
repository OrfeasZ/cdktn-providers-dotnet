...
{
    [JsiiInterface(nativeType: typeof(IRulesetRulesActionParametersRawResponseFields), fullyQualifiedName: "cloudflare.ruleset.RulesetRulesActionParametersRawResponseFields")]
    public interface IRulesetRulesActionParametersRawResponseFields
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IRulesetRulesActionParametersRawResponseFields), fullyQualifiedName: "cloudflare.ruleset.RulesetRulesActionParametersRawResponseFields")]
        internal sealed class _Proxy : DeputyBase, cloudflare.Ruleset.IRulesetRulesActionParametersRawResponseFields
        {
