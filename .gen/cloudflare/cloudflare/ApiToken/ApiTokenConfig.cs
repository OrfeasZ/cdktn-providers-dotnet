...
namespace cloudflare.ApiToken
{
    ...
    [JsiiByValue(fqn: "cloudflare.apiToken.ApiTokenConfig")]
    public class ApiTokenConfig : cloudflare.ApiToken.IApiTokenConfig
    {
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            ...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(cloudflare.ApiToken.IApiTokenPolicies).FullName}[]; received null", nameof(value));
                        default:
        ...
        /// <summary>Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/resources/api_token#condition ApiToken#condition}.</summary>
        [JsiiOptional]
