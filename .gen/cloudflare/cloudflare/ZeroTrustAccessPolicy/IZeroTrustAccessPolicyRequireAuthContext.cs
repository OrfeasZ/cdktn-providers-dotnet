...
{
    [JsiiInterface(nativeType: typeof(IZeroTrustAccessPolicyRequireAuthContext), fullyQualifiedName: "cloudflare.zeroTrustAccessPolicy.ZeroTrustAccessPolicyRequireAuthContext")]
    public interface IZeroTrustAccessPolicyRequireAuthContext
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IZeroTrustAccessPolicyRequireAuthContext), fullyQualifiedName: "cloudflare.zeroTrustAccessPolicy.ZeroTrustAccessPolicyRequireAuthContext")]
        internal sealed class _Proxy : DeputyBase, cloudflare.ZeroTrustAccessPolicy.IZeroTrustAccessPolicyRequireAuthContext
        {
