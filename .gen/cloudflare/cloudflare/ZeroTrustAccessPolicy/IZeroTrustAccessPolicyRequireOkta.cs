...
{
    [JsiiInterface(nativeType: typeof(IZeroTrustAccessPolicyRequireOkta), fullyQualifiedName: "cloudflare.zeroTrustAccessPolicy.ZeroTrustAccessPolicyRequireOkta")]
    public interface IZeroTrustAccessPolicyRequireOkta
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IZeroTrustAccessPolicyRequireOkta), fullyQualifiedName: "cloudflare.zeroTrustAccessPolicy.ZeroTrustAccessPolicyRequireOkta")]
        internal sealed class _Proxy : DeputyBase, cloudflare.ZeroTrustAccessPolicy.IZeroTrustAccessPolicyRequireOkta
        {
