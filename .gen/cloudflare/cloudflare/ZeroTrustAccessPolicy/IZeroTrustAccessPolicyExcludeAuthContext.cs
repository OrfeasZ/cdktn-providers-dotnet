...
{
    [JsiiInterface(nativeType: typeof(IZeroTrustAccessPolicyExcludeAuthContext), fullyQualifiedName: "cloudflare.zeroTrustAccessPolicy.ZeroTrustAccessPolicyExcludeAuthContext")]
    public interface IZeroTrustAccessPolicyExcludeAuthContext
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IZeroTrustAccessPolicyExcludeAuthContext), fullyQualifiedName: "cloudflare.zeroTrustAccessPolicy.ZeroTrustAccessPolicyExcludeAuthContext")]
        internal sealed class _Proxy : DeputyBase, cloudflare.ZeroTrustAccessPolicy.IZeroTrustAccessPolicyExcludeAuthContext
        {
