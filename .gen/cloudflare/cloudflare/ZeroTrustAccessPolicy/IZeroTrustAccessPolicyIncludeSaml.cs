...
{
    [JsiiInterface(nativeType: typeof(IZeroTrustAccessPolicyIncludeSaml), fullyQualifiedName: "cloudflare.zeroTrustAccessPolicy.ZeroTrustAccessPolicyIncludeSaml")]
    public interface IZeroTrustAccessPolicyIncludeSaml
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IZeroTrustAccessPolicyIncludeSaml), fullyQualifiedName: "cloudflare.zeroTrustAccessPolicy.ZeroTrustAccessPolicyIncludeSaml")]
        internal sealed class _Proxy : DeputyBase, cloudflare.ZeroTrustAccessPolicy.IZeroTrustAccessPolicyIncludeSaml
        {
