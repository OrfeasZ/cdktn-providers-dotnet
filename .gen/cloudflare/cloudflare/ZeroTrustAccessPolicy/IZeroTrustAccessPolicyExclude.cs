...
namespace cloudflare.ZeroTrustAccessPolicy
{
    ...
    public interface IZeroTrustAccessPolicyExclude
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        cloudflare.ZeroTrustAccessPolicy.IZeroTrustAccessPolicyExcludeCloudflareAccountMember? CloudflareAccountMember
        {
            get
            {
                return null;
        ...
        internal sealed class _Proxy : DeputyBase, cloudflare.ZeroTrustAccessPolicy.IZeroTrustAccessPolicyExclude
        {
            ...
            {
                get => GetInstanceProperty<cloudflare.ZeroTrustAccessPolicy.IZeroTrustAccessPolicyExcludeCloudflareAccountMember?>();
            }
