...
{
    [JsiiInterface(nativeType: typeof(IZeroTrustAccessPolicyRequireExternalEvaluation), fullyQualifiedName: "cloudflare.zeroTrustAccessPolicy.ZeroTrustAccessPolicyRequireExternalEvaluation")]
    public interface IZeroTrustAccessPolicyRequireExternalEvaluation
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IZeroTrustAccessPolicyRequireExternalEvaluation), fullyQualifiedName: "cloudflare.zeroTrustAccessPolicy.ZeroTrustAccessPolicyRequireExternalEvaluation")]
        internal sealed class _Proxy : DeputyBase, cloudflare.ZeroTrustAccessPolicy.IZeroTrustAccessPolicyRequireExternalEvaluation
        {
