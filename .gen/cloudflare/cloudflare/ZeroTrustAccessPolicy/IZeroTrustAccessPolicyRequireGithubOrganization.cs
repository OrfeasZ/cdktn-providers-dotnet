...
{
    [JsiiInterface(nativeType: typeof(IZeroTrustAccessPolicyRequireGithubOrganization), fullyQualifiedName: "cloudflare.zeroTrustAccessPolicy.ZeroTrustAccessPolicyRequireGithubOrganization")]
    public interface IZeroTrustAccessPolicyRequireGithubOrganization
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IZeroTrustAccessPolicyRequireGithubOrganization), fullyQualifiedName: "cloudflare.zeroTrustAccessPolicy.ZeroTrustAccessPolicyRequireGithubOrganization")]
        internal sealed class _Proxy : DeputyBase, cloudflare.ZeroTrustAccessPolicy.IZeroTrustAccessPolicyRequireGithubOrganization
        {
