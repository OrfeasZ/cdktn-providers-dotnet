...
{
    [JsiiInterface(nativeType: typeof(IZeroTrustAccessPolicyExcludeSaml), fullyQualifiedName: "cloudflare.zeroTrustAccessPolicy.ZeroTrustAccessPolicyExcludeSaml")]
    public interface IZeroTrustAccessPolicyExcludeSaml
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IZeroTrustAccessPolicyExcludeSaml), fullyQualifiedName: "cloudflare.zeroTrustAccessPolicy.ZeroTrustAccessPolicyExcludeSaml")]
        internal sealed class _Proxy : DeputyBase, cloudflare.ZeroTrustAccessPolicy.IZeroTrustAccessPolicyExcludeSaml
        {
