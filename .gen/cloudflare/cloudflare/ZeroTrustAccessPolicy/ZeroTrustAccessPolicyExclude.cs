...
namespace cloudflare.ZeroTrustAccessPolicy
{
    ...
    public class ZeroTrustAccessPolicyExclude : cloudflare.ZeroTrustAccessPolicy.IZeroTrustAccessPolicyExclude
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "cloudflareAccountMember", typeJson: "{\"fqn\":\"cloudflare.zeroTrustAccessPolicy.ZeroTrustAccessPolicyExcludeCloudflareAccountMember\"}", isOptional: true)]
        public cloudflare.ZeroTrustAccessPolicy.IZeroTrustAccessPolicyExcludeCloudflareAccountMember? CloudflareAccountMember
        {
            get;
            set;
        }
