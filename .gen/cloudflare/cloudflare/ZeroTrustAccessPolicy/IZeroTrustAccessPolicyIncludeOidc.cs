...
{
    [JsiiInterface(nativeType: typeof(IZeroTrustAccessPolicyIncludeOidc), fullyQualifiedName: "cloudflare.zeroTrustAccessPolicy.ZeroTrustAccessPolicyIncludeOidc")]
    public interface IZeroTrustAccessPolicyIncludeOidc
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IZeroTrustAccessPolicyIncludeOidc), fullyQualifiedName: "cloudflare.zeroTrustAccessPolicy.ZeroTrustAccessPolicyIncludeOidc")]
        internal sealed class _Proxy : DeputyBase, cloudflare.ZeroTrustAccessPolicy.IZeroTrustAccessPolicyIncludeOidc
        {
