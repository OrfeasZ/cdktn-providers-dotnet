...
{
    [JsiiInterface(nativeType: typeof(IZeroTrustAccessPolicyRequireAzureAd), fullyQualifiedName: "cloudflare.zeroTrustAccessPolicy.ZeroTrustAccessPolicyRequireAzureAd")]
    public interface IZeroTrustAccessPolicyRequireAzureAd
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IZeroTrustAccessPolicyRequireAzureAd), fullyQualifiedName: "cloudflare.zeroTrustAccessPolicy.ZeroTrustAccessPolicyRequireAzureAd")]
        internal sealed class _Proxy : DeputyBase, cloudflare.ZeroTrustAccessPolicy.IZeroTrustAccessPolicyRequireAzureAd
        {
