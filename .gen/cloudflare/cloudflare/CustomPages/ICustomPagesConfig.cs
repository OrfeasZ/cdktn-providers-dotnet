...
namespace cloudflare.CustomPages
{
    ...
    public interface ICustomPagesConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ICustomPagesConfig), fullyQualifiedName: "cloudflare.customPages.CustomPagesConfig")]
        internal sealed class _Proxy : DeputyBase, cloudflare.CustomPages.ICustomPagesConfig
        {
