...
namespace cloudflare.MagicTransitSiteAcl
{
    ...
    [JsiiByValue(fqn: "cloudflare.magicTransitSiteAcl.MagicTransitSiteAclLan1")]
    public class MagicTransitSiteAclLan1 : cloudflare.MagicTransitSiteAcl.IMagicTransitSiteAclLan1
    {
