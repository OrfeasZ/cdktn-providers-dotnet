...
namespace cloudflare.UniversalSslSetting
{
    ...
    [JsiiByValue(fqn: "cloudflare.universalSslSetting.UniversalSslSettingConfig")]
    public class UniversalSslSettingConfig : cloudflare.UniversalSslSetting.IUniversalSslSettingConfig
    {
