...
namespace cloudflare.R2BucketLifecycle
{
    ...
    public class R2BucketLifecycleRulesAbortMultipartUploadsTransitionOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        /// <remarks>
        /// <para>Type union: either <see cref="Io.Cdktn.IResolvable" /> or <see cref="cloudflare.R2BucketLifecycle.IR2BucketLifecycleRulesAbortMultipartUploadsTransitionCondition" /></para>
        /// </remarks>
        [JsiiOptional]
