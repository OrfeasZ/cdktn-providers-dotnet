...
{
    [JsiiInterface(nativeType: typeof(IDataCloudflareLoadBalancersResult), fullyQualifiedName: "cloudflare.dataCloudflareLoadBalancers.DataCloudflareLoadBalancersResult")]
    public interface IDataCloudflareLoadBalancersResult
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataCloudflareLoadBalancersResult), fullyQualifiedName: "cloudflare.dataCloudflareLoadBalancers.DataCloudflareLoadBalancersResult")]
        internal sealed class _Proxy : DeputyBase, cloudflare.DataCloudflareLoadBalancers.IDataCloudflareLoadBalancersResult
        {
