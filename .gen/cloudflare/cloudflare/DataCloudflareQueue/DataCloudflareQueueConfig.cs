...
namespace cloudflare.DataCloudflareQueue
{
    ...
    [JsiiByValue(fqn: "cloudflare.dataCloudflareQueue.DataCloudflareQueueConfig")]
    public class DataCloudflareQueueConfig : cloudflare.DataCloudflareQueue.IDataCloudflareQueueConfig
    {
