...
{
    [JsiiInterface(nativeType: typeof(IDataCloudflareQueueConfig), fullyQualifiedName: "cloudflare.dataCloudflareQueue.DataCloudflareQueueConfig")]
    public interface IDataCloudflareQueueConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataCloudflareQueueConfig), fullyQualifiedName: "cloudflare.dataCloudflareQueue.DataCloudflareQueueConfig")]
        internal sealed class _Proxy : DeputyBase, cloudflare.DataCloudflareQueue.IDataCloudflareQueueConfig
        {
