...
namespace cloudflare.DataCloudflareZeroTrustCasbWebhooks
{
    ...
    public interface IDataCloudflareZeroTrustCasbWebhooksConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataCloudflareZeroTrustCasbWebhooksConfig), fullyQualifiedName: "cloudflare.dataCloudflareZeroTrustCasbWebhooks.DataCloudflareZeroTrustCasbWebhooksConfig")]
        internal sealed class _Proxy : DeputyBase, cloudflare.DataCloudflareZeroTrustCasbWebhooks.IDataCloudflareZeroTrustCasbWebhooksConfig
        {
