...
{
    [JsiiClass(nativeType: typeof(cloudflare.DataCloudflareLogpushJobs.DataCloudflareLogpushJobsResultOutputOptionsOutputReference), fullyQualifiedName: "cloudflare.dataCloudflareLogpushJobs.DataCloudflareLogpushJobsResultOutputOptionsOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktn.IInterpolatingParent\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}}]")]
    public class DataCloudflareLogpushJobsResultOutputOptionsOutputReference : Io.Cdktn.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        public DataCloudflareLogpushJobsResultOutputOptionsOutputReference(Io.Cdktn.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
        ...
        protected DataCloudflareLogpushJobsResultOutputOptionsOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected DataCloudflareLogpushJobsResultOutputOptionsOutputReference(DeputyProps props): base(props)
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"cloudflare.dataCloudflareLogpushJobs.DataCloudflareLogpushJobsResultOutputOptions\"}", isOptional: true)]
        public virtual cloudflare.DataCloudflareLogpushJobs.IDataCloudflareLogpushJobsResultOutputOptions? InternalValue
        {
            get => GetInstanceProperty<cloudflare.DataCloudflareLogpushJobs.IDataCloudflareLogpushJobsResultOutputOptions?>();
