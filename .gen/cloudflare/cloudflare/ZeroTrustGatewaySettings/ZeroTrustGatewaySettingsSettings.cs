...
namespace cloudflare.ZeroTrustGatewaySettings
{
    ...
    public class ZeroTrustGatewaySettingsSettings : cloudflare.ZeroTrustGatewaySettings.IZeroTrustGatewaySettingsSettings
    {
        ...
        /// <summary>Account-level cap on DNS response TTLs, in seconds.</summary>
        /// <remarks>
        /// Gateway rewrites DNS responses so returned record TTLs do not exceed this value. Null means no cap. Each DNS location can inherit, override, or disable it through the location <c>max_ttl</c> setting.
        ///
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "maxTtlSecs", typeJson: "{\"primitive\":\"number\"}", isOptional: true)]
        public double? MaxTtlSecs
        {
            get;
            set;
        }
