...
namespace cloudflare.LoadBalancerPool
{
    ...
    public class LoadBalancerPoolNotificationFilter : cloudflare.LoadBalancerPool.ILoadBalancerPoolNotificationFilter
    {
        ...
        /// <remarks>
        /// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/load_balancer_pool#origin LoadBalancerPool#origin}
        /// </remarks>
        [JsiiOptional]
        ...
        /// <summary>Filter options for a particular resource type (pool or origin). Use null to reset.</summary>
        /// <remarks>
        /// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/load_balancer_pool#pool LoadBalancerPool#pool}
        /// </remarks>
        [JsiiOptional]
