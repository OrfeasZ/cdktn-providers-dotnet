...
{
    [JsiiByValue(fqn: "cloudflare.loadBalancerPool.LoadBalancerPoolNotificationFilterOrigin")]
    public class LoadBalancerPoolNotificationFilterOrigin : cloudflare.LoadBalancerPool.ILoadBalancerPoolNotificationFilterOrigin
    {
        private object? _disable;

        /// <summary>If set true, disable notifications for this type of resource (pool or origin).</summary>
        /// <remarks>
        /// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.19.1/docs/resources/load_balancer_pool#disable LoadBalancerPool#disable}
        /// </remarks>
        [JsiiOptional]
        ...
        /// <remarks>
        /// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.19.1/docs/resources/load_balancer_pool#healthy LoadBalancerPool#healthy}
        /// </remarks>
        [JsiiOptional]
