...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.24.0/docs/resources/load_balancer_pool cloudflare_load_balancer_pool}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.24.0/docs/resources/load_balancer_pool cloudflare_load_balancer_pool} Resource.</summary>
        ...
        [JsiiMethod(name: "resetHealthSources")]
        public virtual void ResetHealthSources()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "healthSourcesInput", typeJson: "{\"collection\":{\"elementtype\":{\"primitive\":\"string\"},\"kind\":\"array\"}}", isOptional: true)]
        public virtual string[]? HealthSourcesInput
        {
            get => GetInstanceProperty<string[]?>();
        }
