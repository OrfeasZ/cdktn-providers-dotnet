...
namespace cloudflare.LoadBalancerPool
{
    ...
    public class LoadBalancerPoolOriginSteering : cloudflare.LoadBalancerPool.ILoadBalancerPoolOriginSteering
    {
        ...
        /// </list>
        ///
        /// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/resources/load_balancer_pool#policy LoadBalancerPool#policy}
        /// </remarks>
        [JsiiOptional]
