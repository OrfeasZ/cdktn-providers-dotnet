...
namespace cloudflare.DataCloudflareEmailRoutingRules
{
    ...
    public interface IDataCloudflareEmailRoutingRulesConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataCloudflareEmailRoutingRulesConfig), fullyQualifiedName: "cloudflare.dataCloudflareEmailRoutingRules.DataCloudflareEmailRoutingRulesConfig")]
        internal sealed class _Proxy : DeputyBase, cloudflare.DataCloudflareEmailRoutingRules.IDataCloudflareEmailRoutingRulesConfig
        {
