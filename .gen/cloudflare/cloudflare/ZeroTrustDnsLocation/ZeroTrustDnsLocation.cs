...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.22.0/docs/resources/zero_trust_dns_location cloudflare_zero_trust_dns_location}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.22.0/docs/resources/zero_trust_dns_location cloudflare_zero_trust_dns_location} Resource.</summary>
        ...
        [JsiiMethod(name: "putMaxTtl", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"cloudflare.zeroTrustDnsLocation.ZeroTrustDnsLocationMaxTtl\"}}]")]
        public virtual void PutMaxTtl(cloudflare.ZeroTrustDnsLocation.IZeroTrustDnsLocationMaxTtl @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(cloudflare.ZeroTrustDnsLocation.IZeroTrustDnsLocationMaxTtl)}, new object[]{@value});
        }

        /// <param name="value">Type union: either <see cref="Io.Cdktn.IResolvable" /> or (<see cref="cloudflare.ZeroTrustDnsLocation.IZeroTrustDnsLocationNetworks" />)[]</param>
        ...
        [JsiiProperty(name: "maxTtl", typeJson: "{\"fqn\":\"cloudflare.zeroTrustDnsLocation.ZeroTrustDnsLocationMaxTtlOutputReference\"}")]
        public virtual cloudflare.ZeroTrustDnsLocation.ZeroTrustDnsLocationMaxTtlOutputReference MaxTtl
        {
            get => GetInstanceProperty<cloudflare.ZeroTrustDnsLocation.ZeroTrustDnsLocationMaxTtlOutputReference>()!;
        }
        ...
        /// <remarks>
        /// <para>Type union: either <see cref="Io.Cdktn.IResolvable" /> or <see cref="cloudflare.ZeroTrustDnsLocation.IZeroTrustDnsLocationMaxTtl" /></para>
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "maxTtlInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"cloudflare.zeroTrustDnsLocation.ZeroTrustDnsLocationMaxTtl\"}]}}", isOptional: true)]
        public virtual object? MaxTtlInput
        {
            get => GetInstanceProperty<object?>();
        }
