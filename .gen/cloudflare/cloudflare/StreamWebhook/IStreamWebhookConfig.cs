...
{
    [JsiiInterface(nativeType: typeof(IStreamWebhookConfig), fullyQualifiedName: "cloudflare.streamWebhook.StreamWebhookConfig")]
    public interface IStreamWebhookConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        internal sealed class _Proxy : DeputyBase, cloudflare.StreamWebhook.IStreamWebhookConfig
        {
