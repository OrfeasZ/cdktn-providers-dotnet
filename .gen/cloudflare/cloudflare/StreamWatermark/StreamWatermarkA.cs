...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.19.1/docs/resources/stream_watermark cloudflare_stream_watermark}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.19.1/docs/resources/stream_watermark cloudflare_stream_watermark} Resource.</summary>
        ...
        protected StreamWatermarkA(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected StreamWatermarkA(DeputyProps props): base(props)
        {
        }

        /// <summary>Generates CDKTN code for importing a StreamWatermarkA resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        ...
        = GetStaticProperty<string>(typeof(cloudflare.StreamWatermark.StreamWatermarkA))!;
        ...
        [JsiiOptional]
        [JsiiProperty(name: "opacityInput", typeJson: "{\"primitive\":\"number\"}", isOptional: true)]
        public virtual double? OpacityInput
        {
            get => GetInstanceProperty<double?>();
        }

        [JsiiOptional]
        [JsiiProperty(name: "paddingInput", typeJson: "{\"primitive\":\"number\"}", isOptional: true)]
        public virtual double? PaddingInput
        {
            get => GetInstanceProperty<double?>();
        }
