...
{
    [JsiiInterface(nativeType: typeof(IDataCloudflareUserAgentBlockingRulesConfig), fullyQualifiedName: "cloudflare.dataCloudflareUserAgentBlockingRules.DataCloudflareUserAgentBlockingRulesConfig")]
    public interface IDataCloudflareUserAgentBlockingRulesConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataCloudflareUserAgentBlockingRulesConfig), fullyQualifiedName: "cloudflare.dataCloudflareUserAgentBlockingRules.DataCloudflareUserAgentBlockingRulesConfig")]
        internal sealed class _Proxy : DeputyBase, cloudflare.DataCloudflareUserAgentBlockingRules.IDataCloudflareUserAgentBlockingRulesConfig
        {
