...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.19.1/docs/resources/connectivity_directory_service cloudflare_connectivity_directory_service}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.19.1/docs/resources/connectivity_directory_service cloudflare_connectivity_directory_service} Resource.</summary>
        ...
        private static DeputyProps _MakeDeputyProps(Constructs.Construct scope, string id, cloudflare.ConnectivityDirectoryService.IConnectivityDirectoryServiceConfig config)
        {
        ...
        protected ConnectivityDirectoryService(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected ConnectivityDirectoryService(DeputyProps props): base(props)
        {
        }

        /// <summary>Generates CDKTN code for importing a ConnectivityDirectoryService resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        ...
        [JsiiMethod(name: "putHost", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"cloudflare.connectivityDirectoryService.ConnectivityDirectoryServiceHost\"}}]")]
        public virtual void PutHost(cloudflare.ConnectivityDirectoryService.IConnectivityDirectoryServiceHost @value)
        {
        ...
        = GetStaticProperty<string>(typeof(cloudflare.ConnectivityDirectoryService.ConnectivityDirectoryService))!;
        ...
        [JsiiProperty(name: "host", typeJson: "{\"fqn\":\"cloudflare.connectivityDirectoryService.ConnectivityDirectoryServiceHostOutputReference\"}")]
        public virtual cloudflare.ConnectivityDirectoryService.ConnectivityDirectoryServiceHostOutputReference Host
        {
            get => GetInstanceProperty<cloudflare.ConnectivityDirectoryService.ConnectivityDirectoryServiceHostOutputReference>()!;
        }
