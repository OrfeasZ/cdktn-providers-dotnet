...
{
    [JsiiByValue(fqn: "cloudflare.magicTransitSiteLan.MagicTransitSiteLanNat")]
    public class MagicTransitSiteLanNat : cloudflare.MagicTransitSiteLan.IMagicTransitSiteLanNat
    {
