...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.19.0/docs/resources/magic_transit_site_lan cloudflare_magic_transit_site_lan}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.19.0/docs/resources/magic_transit_site_lan cloudflare_magic_transit_site_lan} Resource.</summary>
        ...
        [JsiiMethod(name: "resetIsBreakout")]
        public virtual void ResetIsBreakout()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }

        [JsiiMethod(name: "resetIsPrioritized")]
        public virtual void ResetIsPrioritized()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
