...
namespace cloudflare.WebAnalyticsRule
{
    ...
    [JsiiByValue(fqn: "cloudflare.webAnalyticsRule.WebAnalyticsRuleConfig")]
    public class WebAnalyticsRuleConfig : cloudflare.WebAnalyticsRule.IWebAnalyticsRuleConfig
    {
