...
namespace oci.DataOciDataSafeAttributeSetAssociatedResources
{
    ...
    public interface IDataOciDataSafeAttributeSetAssociatedResourcesConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataOciDataSafeAttributeSetAssociatedResourcesConfig), fullyQualifiedName: "oci.dataOciDataSafeAttributeSetAssociatedResources.DataOciDataSafeAttributeSetAssociatedResourcesConfig")]
        internal sealed class _Proxy : DeputyBase, oci.DataOciDataSafeAttributeSetAssociatedResources.IDataOciDataSafeAttributeSetAssociatedResourcesConfig
        {
