...
namespace oci.DataOciDataSafeCryptoAssessmentKeys
{
    ...
    public interface IDataOciDataSafeCryptoAssessmentKeysConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataOciDataSafeCryptoAssessmentKeysConfig), fullyQualifiedName: "oci.dataOciDataSafeCryptoAssessmentKeys.DataOciDataSafeCryptoAssessmentKeysConfig")]
        internal sealed class _Proxy : DeputyBase, oci.DataOciDataSafeCryptoAssessmentKeys.IDataOciDataSafeCryptoAssessmentKeysConfig
        {
