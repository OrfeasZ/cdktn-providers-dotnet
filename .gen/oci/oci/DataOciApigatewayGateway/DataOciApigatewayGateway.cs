...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/oracle/oci/8.26.0/docs/data-sources/apigateway_gateway oci_apigateway_gateway}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/oracle/oci/8.26.0/docs/data-sources/apigateway_gateway oci_apigateway_gateway} Data Source.</summary>
        ...
        private static DeputyProps _MakeDeputyProps(Constructs.Construct scope, string id, oci.DataOciApigatewayGateway.IDataOciApigatewayGatewayConfig config)
        {
        ...
        protected DataOciApigatewayGateway(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected DataOciApigatewayGateway(DeputyProps props): base(props)
        {
        }

        /// <summary>Generates CDKTN code for importing a DataOciApigatewayGateway resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        ...
        = GetStaticProperty<string>(typeof(oci.DataOciApigatewayGateway.DataOciApigatewayGateway))!;

        [JsiiProperty(name: "caBundles", typeJson: "{\"fqn\":\"oci.dataOciApigatewayGateway.DataOciApigatewayGatewayCaBundlesList\"}")]
        public virtual oci.DataOciApigatewayGateway.DataOciApigatewayGatewayCaBundlesList CaBundles
        {
            get => GetInstanceProperty<oci.DataOciApigatewayGateway.DataOciApigatewayGatewayCaBundlesList>()!;
        }
        ...
        [JsiiProperty(name: "ipAddresses", typeJson: "{\"fqn\":\"oci.dataOciApigatewayGateway.DataOciApigatewayGatewayIpAddressesList\"}")]
        ...
        [JsiiProperty(name: "locks", typeJson: "{\"fqn\":\"oci.dataOciApigatewayGateway.DataOciApigatewayGatewayLocksList\"}")]
        public virtual oci.DataOciApigatewayGateway.DataOciApigatewayGatewayLocksList Locks
        {
            get => GetInstanceProperty<oci.DataOciApigatewayGateway.DataOciApigatewayGatewayLocksList>()!;
        }
        ...
        [JsiiProperty(name: "responseCacheDetails", typeJson: "{\"fqn\":\"oci.dataOciApigatewayGateway.DataOciApigatewayGatewayResponseCacheDetailsList\"}")]
        public virtual oci.DataOciApigatewayGateway.DataOciApigatewayGatewayResponseCacheDetailsList ResponseCacheDetails
        {
            get => GetInstanceProperty<oci.DataOciApigatewayGateway.DataOciApigatewayGatewayResponseCacheDetailsList>()!;
        }
