...
namespace oci.DataOciJmsAnnouncements
{
    ...
    [JsiiByValue(fqn: "oci.dataOciJmsAnnouncements.DataOciJmsAnnouncementsFilter")]
    public class DataOciJmsAnnouncementsFilter : oci.DataOciJmsAnnouncements.IDataOciJmsAnnouncementsFilter
    {
