...
{
    [JsiiInterface(nativeType: typeof(IDataOciSelfSelfPartnerSubscriptionsConfig), fullyQualifiedName: "oci.dataOciSelfSelfPartnerSubscriptions.DataOciSelfSelfPartnerSubscriptionsConfig")]
    public interface IDataOciSelfSelfPartnerSubscriptionsConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "filter", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"oci.dataOciSelfSelfPartnerSubscriptions.DataOciSelfSelfPartnerSubscriptionsFilter\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        object? Filter
        {
            get
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataOciSelfSelfPartnerSubscriptionsConfig), fullyQualifiedName: "oci.dataOciSelfSelfPartnerSubscriptions.DataOciSelfSelfPartnerSubscriptionsConfig")]
        internal sealed class _Proxy : DeputyBase, oci.DataOciSelfSelfPartnerSubscriptions.IDataOciSelfSelfPartnerSubscriptionsConfig
        {
