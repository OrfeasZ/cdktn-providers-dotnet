...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/oracle/oci/8.29.0/docs/resources/core_cross_connect oci_core_cross_connect}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/oracle/oci/8.29.0/docs/resources/core_cross_connect oci_core_cross_connect} Resource.</summary>
        ...
        [JsiiMethod(name: "resetOciPhysicalDeviceName")]
        public virtual void ResetOciPhysicalDeviceName()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "ociPhysicalDeviceNameInput", typeJson: "{\"primitive\":\"string\"}", isOptional: true)]
        public virtual string? OciPhysicalDeviceNameInput
        {
            get => GetInstanceProperty<string?>();
        }
