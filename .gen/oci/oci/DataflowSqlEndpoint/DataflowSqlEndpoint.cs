...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/oracle/oci/8.29.0/docs/resources/dataflow_sql_endpoint oci_dataflow_sql_endpoint}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/oracle/oci/8.29.0/docs/resources/dataflow_sql_endpoint oci_dataflow_sql_endpoint} Resource.</summary>
        ...
        [JsiiMethod(name: "resetLogCompartmentId")]
        public virtual void ResetLogCompartmentId()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }

        [JsiiMethod(name: "resetLogDisplayName")]
        public virtual void ResetLogDisplayName()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        [JsiiMethod(name: "resetLogRetentionDuration")]
        public virtual void ResetLogRetentionDuration()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "logCompartmentIdInput", typeJson: "{\"primitive\":\"string\"}", isOptional: true)]
        public virtual string? LogCompartmentIdInput
        {
            get => GetInstanceProperty<string?>();
        }

        [JsiiOptional]
        [JsiiProperty(name: "logDisplayNameInput", typeJson: "{\"primitive\":\"string\"}", isOptional: true)]
        public virtual string? LogDisplayNameInput
        {
            get => GetInstanceProperty<string?>();
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "logRetentionDurationInput", typeJson: "{\"primitive\":\"number\"}", isOptional: true)]
        public virtual double? LogRetentionDurationInput
        {
