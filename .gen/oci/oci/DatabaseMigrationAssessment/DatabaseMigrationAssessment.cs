...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/oracle/oci/9.3.0/docs/resources/database_migration_assessment oci_database_migration_assessment}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/oracle/oci/9.3.0/docs/resources/database_migration_assessment oci_database_migration_assessment} Resource.</summary>
        ...
        [JsiiMethod(name: "resetMigrationScope")]
        public virtual void ResetMigrationScope()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "migrationScopeInput", typeJson: "{\"primitive\":\"string\"}", isOptional: true)]
        public virtual string? MigrationScopeInput
        {
            get => GetInstanceProperty<string?>();
        }
