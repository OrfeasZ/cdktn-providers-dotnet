...
namespace oci.IdentityDomainsOauthClientCertificate
{
    ...
    [JsiiByValue(fqn: "oci.identityDomainsOauthClientCertificate.IdentityDomainsOauthClientCertificateConfig")]
    public class IdentityDomainsOauthClientCertificateConfig : oci.IdentityDomainsOauthClientCertificate.IIdentityDomainsOauthClientCertificateConfig
    {
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        case Io.Cdktn.IResolvable cast_cd4240:
                            break;
                        case oci.IdentityDomainsOauthClientCertificate.IIdentityDomainsOauthClientCertificateTags[] cast_cd4240:
                            break;
                        ...
                        case null:
                            break;
                        default:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(oci.IdentityDomainsOauthClientCertificate.IIdentityDomainsOauthClientCertificateTags).FullName}[]; received {value.GetType().FullName}", nameof(value));
                    }
                }
                _tags = value;
            }
