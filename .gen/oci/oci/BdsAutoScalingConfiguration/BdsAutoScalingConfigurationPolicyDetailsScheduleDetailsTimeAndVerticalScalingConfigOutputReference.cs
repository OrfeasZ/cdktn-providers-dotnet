...
namespace oci.BdsAutoScalingConfiguration
{
    ...
    public class BdsAutoScalingConfigurationPolicyDetailsScheduleDetailsTimeAndVerticalScalingConfigOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        /// <remarks>
        /// <para>Type union: either <see cref="Io.Cdktn.IResolvable" /> or <see cref="oci.BdsAutoScalingConfiguration.IBdsAutoScalingConfigurationPolicyDetailsScheduleDetailsTimeAndVerticalScalingConfig" /></para>
        /// </remarks>
        [JsiiOptional]
