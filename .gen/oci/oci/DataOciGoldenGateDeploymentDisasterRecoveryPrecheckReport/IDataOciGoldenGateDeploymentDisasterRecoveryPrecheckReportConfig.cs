...
namespace oci.DataOciGoldenGateDeploymentDisasterRecoveryPrecheckReport
{
    ...
    public interface IDataOciGoldenGateDeploymentDisasterRecoveryPrecheckReportConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataOciGoldenGateDeploymentDisasterRecoveryPrecheckReportConfig), fullyQualifiedName: "oci.dataOciGoldenGateDeploymentDisasterRecoveryPrecheckReport.DataOciGoldenGateDeploymentDisasterRecoveryPrecheckReportConfig")]
        internal sealed class _Proxy : DeputyBase, oci.DataOciGoldenGateDeploymentDisasterRecoveryPrecheckReport.IDataOciGoldenGateDeploymentDisasterRecoveryPrecheckReportConfig
        {
