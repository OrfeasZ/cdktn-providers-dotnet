...
namespace oci.DataOciIotDigitalTwinRelationships
{
    ...
    [JsiiByValue(fqn: "oci.dataOciIotDigitalTwinRelationships.DataOciIotDigitalTwinRelationshipsConfig")]
    public class DataOciIotDigitalTwinRelationshipsConfig : oci.DataOciIotDigitalTwinRelationships.IDataOciIotDigitalTwinRelationshipsConfig
    {
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        case Io.Cdktn.IResolvable cast_cd4240:
                            break;
                        case oci.DataOciIotDigitalTwinRelationships.IDataOciIotDigitalTwinRelationshipsFilter[] cast_cd4240:
                            break;
                        ...
                        case null:
                            break;
                        default:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(oci.DataOciIotDigitalTwinRelationships.IDataOciIotDigitalTwinRelationshipsFilter).FullName}[]; received {value.GetType().FullName}", nameof(value));
                    }
                }
                _filter = value;
            }
