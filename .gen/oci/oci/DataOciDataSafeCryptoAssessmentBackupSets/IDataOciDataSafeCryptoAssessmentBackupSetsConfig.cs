...
namespace oci.DataOciDataSafeCryptoAssessmentBackupSets
{
    ...
    public interface IDataOciDataSafeCryptoAssessmentBackupSetsConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataOciDataSafeCryptoAssessmentBackupSetsConfig), fullyQualifiedName: "oci.dataOciDataSafeCryptoAssessmentBackupSets.DataOciDataSafeCryptoAssessmentBackupSetsConfig")]
        internal sealed class _Proxy : DeputyBase, oci.DataOciDataSafeCryptoAssessmentBackupSets.IDataOciDataSafeCryptoAssessmentBackupSetsConfig
        {
