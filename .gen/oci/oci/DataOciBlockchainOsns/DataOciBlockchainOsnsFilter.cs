...
namespace oci.DataOciBlockchainOsns
{
    ...
    [JsiiByValue(fqn: "oci.dataOciBlockchainOsns.DataOciBlockchainOsnsFilter")]
    public class DataOciBlockchainOsnsFilter : oci.DataOciBlockchainOsns.IDataOciBlockchainOsnsFilter
    {
