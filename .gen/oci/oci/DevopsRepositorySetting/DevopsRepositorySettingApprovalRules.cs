...
namespace oci.DevopsRepositorySetting
{
    ...
    [JsiiByValue(fqn: "oci.devopsRepositorySetting.DevopsRepositorySettingApprovalRules")]
    public class DevopsRepositorySettingApprovalRules : oci.DevopsRepositorySetting.IDevopsRepositorySettingApprovalRules
    {
        private object _items;

        /// <summary>items block.</summary>
        /// <remarks>
        /// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/8.21.0/docs/resources/devops_repository_setting#items DevopsRepositorySetting#items}
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            ...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(oci.DevopsRepositorySetting.IDevopsRepositorySettingApprovalRulesItems).FullName}[]; received null", nameof(value));
                        default:
