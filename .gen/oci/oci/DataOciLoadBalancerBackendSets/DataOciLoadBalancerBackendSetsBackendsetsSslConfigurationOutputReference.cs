...
namespace oci.DataOciLoadBalancerBackendSets
{
    ...
    public class DataOciLoadBalancerBackendSetsBackendsetsSslConfigurationOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        protected DataOciLoadBalancerBackendSetsBackendsetsSslConfigurationOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected DataOciLoadBalancerBackendSetsBackendsetsSslConfigurationOutputReference(DeputyProps props): base(props)
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"oci.dataOciLoadBalancerBackendSets.DataOciLoadBalancerBackendSetsBackendsetsSslConfiguration\"}", isOptional: true)]
        public virtual oci.DataOciLoadBalancerBackendSets.IDataOciLoadBalancerBackendSetsBackendsetsSslConfiguration? InternalValue
        {
            get => GetInstanceProperty<oci.DataOciLoadBalancerBackendSets.IDataOciLoadBalancerBackendSetsBackendsetsSslConfiguration?>();
