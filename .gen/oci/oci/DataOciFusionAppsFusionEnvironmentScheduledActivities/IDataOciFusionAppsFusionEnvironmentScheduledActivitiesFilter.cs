...
namespace oci.DataOciFusionAppsFusionEnvironmentScheduledActivities
{
    ...
    public interface IDataOciFusionAppsFusionEnvironmentScheduledActivitiesFilter
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataOciFusionAppsFusionEnvironmentScheduledActivitiesFilter), fullyQualifiedName: "oci.dataOciFusionAppsFusionEnvironmentScheduledActivities.DataOciFusionAppsFusionEnvironmentScheduledActivitiesFilter")]
        internal sealed class _Proxy : DeputyBase, oci.DataOciFusionAppsFusionEnvironmentScheduledActivities.IDataOciFusionAppsFusionEnvironmentScheduledActivitiesFilter
        {
