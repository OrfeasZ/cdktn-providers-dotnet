...
namespace oci.DataOciLustreFileStorageAvailableOverrideMaintenanceStartTimes
{
    ...
    public interface IDataOciLustreFileStorageAvailableOverrideMaintenanceStartTimesFilter
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataOciLustreFileStorageAvailableOverrideMaintenanceStartTimesFilter), fullyQualifiedName: "oci.dataOciLustreFileStorageAvailableOverrideMaintenanceStartTimes.DataOciLustreFileStorageAvailableOverrideMaintenanceStartTimesFilter")]
        internal sealed class _Proxy : DeputyBase, oci.DataOciLustreFileStorageAvailableOverrideMaintenanceStartTimes.IDataOciLustreFileStorageAvailableOverrideMaintenanceStartTimesFilter
        {
