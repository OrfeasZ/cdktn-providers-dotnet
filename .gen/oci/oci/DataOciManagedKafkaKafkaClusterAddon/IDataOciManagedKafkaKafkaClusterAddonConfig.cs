...
namespace oci.DataOciManagedKafkaKafkaClusterAddon
{
    ...
    public interface IDataOciManagedKafkaKafkaClusterAddonConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataOciManagedKafkaKafkaClusterAddonConfig), fullyQualifiedName: "oci.dataOciManagedKafkaKafkaClusterAddon.DataOciManagedKafkaKafkaClusterAddonConfig")]
        internal sealed class _Proxy : DeputyBase, oci.DataOciManagedKafkaKafkaClusterAddon.IDataOciManagedKafkaKafkaClusterAddonConfig
        {
