...
namespace oci.DnsActionCreateZoneFromZoneFile
{
    ...
    public class DnsActionCreateZoneFromZoneFileDnssecConfigZskDnssecKeyVersionsOutputReference : Io.Cdktn.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        /// <param name="complexObjectIndex">the index of this item in the list.</param>
        /// <param name="complexObjectIsFromSet">whether the list is wrapping a set (will add tolist() to be able to access an item via an index).</param>
        public DnsActionCreateZoneFromZoneFileDnssecConfigZskDnssecKeyVersionsOutputReference(Io.Cdktn.IInterpolatingParent terraformResource, string terraformAttribute, double complexObjectIndex, bool complexObjectIsFromSet): base(_MakeDeputyProps(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet))
        {
        }
        ...
        protected DnsActionCreateZoneFromZoneFileDnssecConfigZskDnssecKeyVersionsOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected DnsActionCreateZoneFromZoneFileDnssecConfigZskDnssecKeyVersionsOutputReference(DeputyProps props): base(props)
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"oci.dnsActionCreateZoneFromZoneFile.DnsActionCreateZoneFromZoneFileDnssecConfigZskDnssecKeyVersions\"}", isOptional: true)]
        public virtual oci.DnsActionCreateZoneFromZoneFile.IDnsActionCreateZoneFromZoneFileDnssecConfigZskDnssecKeyVersions? InternalValue
        {
            get => GetInstanceProperty<oci.DnsActionCreateZoneFromZoneFile.IDnsActionCreateZoneFromZoneFileDnssecConfigZskDnssecKeyVersions?>();
