...
namespace oci.CoreServiceGateway
{
    ...
    [JsiiByValue(fqn: "oci.coreServiceGateway.CoreServiceGatewayConfig")]
    public class CoreServiceGatewayConfig : oci.CoreServiceGateway.ICoreServiceGatewayConfig
    {
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            ...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(oci.CoreServiceGateway.ICoreServiceGatewayServices).FullName}[]; received null", nameof(value));
                        default:
