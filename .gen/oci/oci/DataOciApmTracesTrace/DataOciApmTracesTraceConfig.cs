...
namespace oci.DataOciApmTracesTrace
{
    ...
    [JsiiByValue(fqn: "oci.dataOciApmTracesTrace.DataOciApmTracesTraceConfig")]
    public class DataOciApmTracesTraceConfig : oci.DataOciApmTracesTrace.IDataOciApmTracesTraceConfig
    {
