...
namespace oci.CoreVolume
{
    ...
    public interface ICoreVolumeBlockVolumeReplicas
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ICoreVolumeBlockVolumeReplicas), fullyQualifiedName: "oci.coreVolume.CoreVolumeBlockVolumeReplicas")]
        internal sealed class _Proxy : DeputyBase, oci.CoreVolume.ICoreVolumeBlockVolumeReplicas
        {
