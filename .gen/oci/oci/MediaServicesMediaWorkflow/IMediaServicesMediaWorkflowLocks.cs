...
{
    [JsiiInterface(nativeType: typeof(IMediaServicesMediaWorkflowLocks), fullyQualifiedName: "oci.mediaServicesMediaWorkflow.MediaServicesMediaWorkflowLocks")]
    public interface IMediaServicesMediaWorkflowLocks
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IMediaServicesMediaWorkflowLocks), fullyQualifiedName: "oci.mediaServicesMediaWorkflow.MediaServicesMediaWorkflowLocks")]
        internal sealed class _Proxy : DeputyBase, oci.MediaServicesMediaWorkflow.IMediaServicesMediaWorkflowLocks
        {
