...
{
    [JsiiClass(nativeType: typeof(oci.LoadBalancerBackendSet.LoadBalancerBackendSetLbCookieSessionPersistenceConfigurationOutputReference), fullyQualifiedName: "oci.loadBalancerBackendSet.LoadBalancerBackendSetLbCookieSessionPersistenceConfigurationOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktn.IInterpolatingParent\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}}]")]
    public class LoadBalancerBackendSetLbCookieSessionPersistenceConfigurationOutputReference : Io.Cdktn.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        public LoadBalancerBackendSetLbCookieSessionPersistenceConfigurationOutputReference(Io.Cdktn.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
        ...
        protected LoadBalancerBackendSetLbCookieSessionPersistenceConfigurationOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected LoadBalancerBackendSetLbCookieSessionPersistenceConfigurationOutputReference(DeputyProps props): base(props)
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"oci.loadBalancerBackendSet.LoadBalancerBackendSetLbCookieSessionPersistenceConfiguration\"}", isOptional: true)]
        public virtual oci.LoadBalancerBackendSet.ILoadBalancerBackendSetLbCookieSessionPersistenceConfiguration? InternalValue
        {
