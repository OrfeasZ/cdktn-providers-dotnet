...
namespace oci.IdentityDomainsGroup
{
    ...
    [JsiiByValue(fqn: "oci.identityDomainsGroup.IdentityDomainsGroupTags")]
    public class IdentityDomainsGroupTags : oci.IdentityDomainsGroup.IIdentityDomainsGroupTags
    {
