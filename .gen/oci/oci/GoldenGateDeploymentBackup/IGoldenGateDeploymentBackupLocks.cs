...
namespace oci.GoldenGateDeploymentBackup
{
    ...
    public interface IGoldenGateDeploymentBackupLocks
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IGoldenGateDeploymentBackupLocks), fullyQualifiedName: "oci.goldenGateDeploymentBackup.GoldenGateDeploymentBackupLocks")]
        internal sealed class _Proxy : DeputyBase, oci.GoldenGateDeploymentBackup.IGoldenGateDeploymentBackupLocks
        {
