...
namespace oci.DatabaseAutonomousContainerDatabase
{
    ...
    public class DatabaseAutonomousContainerDatabaseCustomerContactsOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        protected DatabaseAutonomousContainerDatabaseCustomerContactsOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected DatabaseAutonomousContainerDatabaseCustomerContactsOutputReference(DeputyProps props): base(props)
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"oci.databaseAutonomousContainerDatabase.DatabaseAutonomousContainerDatabaseCustomerContacts\"}]}}", isOptional: true)]
