...
namespace oci.DatabaseAutonomousContainerDatabase
{
    ...
    public class DatabaseAutonomousContainerDatabaseDataguardGroupMembersOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        protected DatabaseAutonomousContainerDatabaseDataguardGroupMembersOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected DatabaseAutonomousContainerDatabaseDataguardGroupMembersOutputReference(DeputyProps props): base(props)
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"oci.databaseAutonomousContainerDatabase.DatabaseAutonomousContainerDatabaseDataguardGroupMembers\"}", isOptional: true)]
        public virtual oci.DatabaseAutonomousContainerDatabase.IDatabaseAutonomousContainerDatabaseDataguardGroupMembers? InternalValue
        {
            get => GetInstanceProperty<oci.DatabaseAutonomousContainerDatabase.IDatabaseAutonomousContainerDatabaseDataguardGroupMembers?>();
