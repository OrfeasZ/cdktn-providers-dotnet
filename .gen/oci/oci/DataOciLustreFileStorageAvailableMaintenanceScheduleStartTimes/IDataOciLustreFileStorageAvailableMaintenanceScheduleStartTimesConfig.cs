...
namespace oci.DataOciLustreFileStorageAvailableMaintenanceScheduleStartTimes
{
    ...
    public interface IDataOciLustreFileStorageAvailableMaintenanceScheduleStartTimesConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataOciLustreFileStorageAvailableMaintenanceScheduleStartTimesConfig), fullyQualifiedName: "oci.dataOciLustreFileStorageAvailableMaintenanceScheduleStartTimes.DataOciLustreFileStorageAvailableMaintenanceScheduleStartTimesConfig")]
        internal sealed class _Proxy : DeputyBase, oci.DataOciLustreFileStorageAvailableMaintenanceScheduleStartTimes.IDataOciLustreFileStorageAvailableMaintenanceScheduleStartTimesConfig
        {
