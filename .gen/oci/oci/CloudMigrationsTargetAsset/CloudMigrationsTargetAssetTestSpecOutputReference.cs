...
namespace oci.CloudMigrationsTargetAsset
{
    ...
    public class CloudMigrationsTargetAssetTestSpecOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"oci.cloudMigrationsTargetAsset.CloudMigrationsTargetAssetTestSpec\"}]}}", isOptional: true)]
