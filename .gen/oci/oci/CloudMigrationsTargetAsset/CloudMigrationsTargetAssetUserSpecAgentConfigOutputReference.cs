...
namespace oci.CloudMigrationsTargetAsset
{
    ...
    public class CloudMigrationsTargetAssetUserSpecAgentConfigOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        /// <param name="value">Type union: either <see cref="Io.Cdktn.IResolvable" /> or (<see cref="oci.CloudMigrationsTargetAsset.ICloudMigrationsTargetAssetUserSpecAgentConfigPluginsConfig" />)[]</param>
