...
{
    [JsiiByValue(fqn: "oci.devopsDeployStage.DevopsDeployStageLoadBalancerConfig")]
    public class DevopsDeployStageLoadBalancerConfig : oci.DevopsDeployStage.IDevopsDeployStageLoadBalancerConfig
    {
