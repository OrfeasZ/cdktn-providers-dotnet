...
{
    [JsiiByValue(fqn: "oci.devopsDeployStage.DevopsDeployStageGreenBackendIps")]
    public class DevopsDeployStageGreenBackendIps : oci.DevopsDeployStage.IDevopsDeployStageGreenBackendIps
    {
