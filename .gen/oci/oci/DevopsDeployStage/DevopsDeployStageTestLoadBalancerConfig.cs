...
{
    [JsiiByValue(fqn: "oci.devopsDeployStage.DevopsDeployStageTestLoadBalancerConfig")]
    public class DevopsDeployStageTestLoadBalancerConfig : oci.DevopsDeployStage.IDevopsDeployStageTestLoadBalancerConfig
    {
