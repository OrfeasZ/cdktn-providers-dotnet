...
{
    [JsiiByValue(fqn: "oci.devopsDeployStage.DevopsDeployStageSetStringItems")]
    public class DevopsDeployStageSetStringItems : oci.DevopsDeployStage.IDevopsDeployStageSetStringItems
    {
