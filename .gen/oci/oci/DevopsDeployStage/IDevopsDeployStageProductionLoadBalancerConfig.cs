...
{
    [JsiiInterface(nativeType: typeof(IDevopsDeployStageProductionLoadBalancerConfig), fullyQualifiedName: "oci.devopsDeployStage.DevopsDeployStageProductionLoadBalancerConfig")]
    public interface IDevopsDeployStageProductionLoadBalancerConfig
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDevopsDeployStageProductionLoadBalancerConfig), fullyQualifiedName: "oci.devopsDeployStage.DevopsDeployStageProductionLoadBalancerConfig")]
        internal sealed class _Proxy : DeputyBase, oci.DevopsDeployStage.IDevopsDeployStageProductionLoadBalancerConfig
        {
