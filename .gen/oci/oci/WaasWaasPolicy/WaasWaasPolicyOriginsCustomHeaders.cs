...
namespace oci.WaasWaasPolicy
{
    ...
    [JsiiByValue(fqn: "oci.waasWaasPolicy.WaasWaasPolicyOriginsCustomHeaders")]
    public class WaasWaasPolicyOriginsCustomHeaders : oci.WaasWaasPolicy.IWaasWaasPolicyOriginsCustomHeaders
    {
