...
namespace oci.ApigatewayDeployment
{
    ...
    public class ApigatewayDeploymentSpecificationRequestPoliciesAuthenticationOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        /// <param name="value">Type union: either <see cref="Io.Cdktn.IResolvable" /> or (<see cref="oci.ApigatewayDeployment.IApigatewayDeploymentSpecificationRequestPoliciesAuthenticationVerifyClaims" />)[]</param>
