...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/oracle/oci/8.24.0/docs/resources/mysql_mysql_backup oci_mysql_mysql_backup}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/oracle/oci/8.24.0/docs/resources/mysql_mysql_backup oci_mysql_mysql_backup} Resource.</summary>
        ...
        /// <param name="value">Type union: either <see cref="Io.Cdktn.IResolvable" /> or (<see cref="oci.MysqlMysqlBackup.IMysqlMysqlBackupDbSystemSnapshotSummary" />)[]</param>
        ...
        /// <param name="value">Type union: either <see cref="Io.Cdktn.IResolvable" /> or (<see cref="oci.MysqlMysqlBackup.IMysqlMysqlBackupValidateBackupDetails" />)[]</param>
