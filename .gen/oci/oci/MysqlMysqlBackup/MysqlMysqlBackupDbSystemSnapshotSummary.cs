...
{
    [JsiiByValue(fqn: "oci.mysqlMysqlBackup.MysqlMysqlBackupDbSystemSnapshotSummary")]
    public class MysqlMysqlBackupDbSystemSnapshotSummary : oci.MysqlMysqlBackup.IMysqlMysqlBackupDbSystemSnapshotSummary
    {
