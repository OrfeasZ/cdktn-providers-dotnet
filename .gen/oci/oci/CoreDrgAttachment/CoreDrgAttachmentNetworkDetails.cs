...
namespace oci.CoreDrgAttachment
{
    ...
    [JsiiByValue(fqn: "oci.coreDrgAttachment.CoreDrgAttachmentNetworkDetails")]
    public class CoreDrgAttachmentNetworkDetails : oci.CoreDrgAttachment.ICoreDrgAttachmentNetworkDetails
    {
