...
namespace oci.DatabaseToolsDatabaseToolsIdentity
{
    ...
    public class DatabaseToolsDatabaseToolsIdentityLocks : oci.DatabaseToolsDatabaseToolsIdentity.IDatabaseToolsDatabaseToolsIdentityLocks
    {
        ...
        /// <summary>Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/9.0.0/docs/resources/database_tools_database_tools_identity#message DatabaseToolsDatabaseToolsIdentity#message}.</summary>
        [JsiiOptional]
