...
namespace oci.FleetAppsManagementRunbook
{
    ...
    public class FleetAppsManagementRunbookRunbookVersionRollbackWorkflowDetailsWorkflowOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        /// <param name="value">Type union: either <see cref="Io.Cdktn.IResolvable" /> or (<see cref="oci.FleetAppsManagementRunbook.IFleetAppsManagementRunbookRunbookVersionRollbackWorkflowDetailsWorkflowSteps" />)[]</param>
