...
namespace oci.IdentityDomainsIdentitySetting
{
    ...
    public class IdentityDomainsIdentitySettingPosixGidOutputReference : Io.Cdktn.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        public IdentityDomainsIdentitySettingPosixGidOutputReference(Io.Cdktn.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
        ...
        protected IdentityDomainsIdentitySettingPosixGidOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected IdentityDomainsIdentitySettingPosixGidOutputReference(DeputyProps props): base(props)
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"oci.identityDomainsIdentitySetting.IdentityDomainsIdentitySettingPosixGid\"}", isOptional: true)]
        public virtual oci.IdentityDomainsIdentitySetting.IIdentityDomainsIdentitySettingPosixGid? InternalValue
        {
