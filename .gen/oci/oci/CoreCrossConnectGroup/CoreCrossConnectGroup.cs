...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/oracle/oci/8.26.0/docs/resources/core_cross_connect_group oci_core_cross_connect_group}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/oracle/oci/8.26.0/docs/resources/core_cross_connect_group oci_core_cross_connect_group} Resource.</summary>
        ...
        [JsiiMethod(name: "resetMinimumLinks")]
        public virtual void ResetMinimumLinks()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "minimumLinksInput", typeJson: "{\"primitive\":\"number\"}", isOptional: true)]
        public virtual double? MinimumLinksInput
        {
            get => GetInstanceProperty<double?>();
        }

        /// <remarks>
        /// <para>Type union: either <see cref="Io.Cdktn.IResolvable" /> or <see cref="oci.CoreCrossConnectGroup.ICoreCrossConnectGroupTimeouts" /></para>
        /// </remarks>
        [JsiiOptional]
