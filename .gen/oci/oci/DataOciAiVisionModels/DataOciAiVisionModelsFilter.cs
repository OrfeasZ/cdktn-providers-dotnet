...
namespace oci.DataOciAiVisionModels
{
    ...
    [JsiiByValue(fqn: "oci.dataOciAiVisionModels.DataOciAiVisionModelsFilter")]
    public class DataOciAiVisionModelsFilter : oci.DataOciAiVisionModels.IDataOciAiVisionModelsFilter
    {
