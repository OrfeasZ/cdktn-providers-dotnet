...
namespace oci.ResourceSchedulerSchedule
{
    ...
    [JsiiByValue(fqn: "oci.resourceSchedulerSchedule.ResourceSchedulerScheduleConfig")]
    public class ResourceSchedulerScheduleConfig : oci.ResourceSchedulerSchedule.IResourceSchedulerScheduleConfig
    {
        ...
        private object? _resourceFilters;
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        case Io.Cdktn.IResolvable cast_cd4240:
                            break;
                        case oci.ResourceSchedulerSchedule.IResourceSchedulerScheduleResourceFilters[] cast_cd4240:
                            break;
                        ...
                        case null:
                            break;
                        default:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(oci.ResourceSchedulerSchedule.IResourceSchedulerScheduleResourceFilters).FullName}[]; received {value.GetType().FullName}", nameof(value));
                    }
                }
                _resourceFilters = value;
            }
        }
