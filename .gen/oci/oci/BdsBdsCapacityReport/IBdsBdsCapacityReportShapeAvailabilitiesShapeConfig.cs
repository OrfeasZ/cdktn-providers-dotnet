...
{
    [JsiiInterface(nativeType: typeof(IBdsBdsCapacityReportShapeAvailabilitiesShapeConfig), fullyQualifiedName: "oci.bdsBdsCapacityReport.BdsBdsCapacityReportShapeAvailabilitiesShapeConfig")]
    public interface IBdsBdsCapacityReportShapeAvailabilitiesShapeConfig
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IBdsBdsCapacityReportShapeAvailabilitiesShapeConfig), fullyQualifiedName: "oci.bdsBdsCapacityReport.BdsBdsCapacityReportShapeAvailabilitiesShapeConfig")]
        internal sealed class _Proxy : DeputyBase, oci.BdsBdsCapacityReport.IBdsBdsCapacityReportShapeAvailabilitiesShapeConfig
        {
