...
namespace oci.DataOciLoadBalancers
{
    ...
    [JsiiByValue(fqn: "oci.dataOciLoadBalancers.DataOciLoadBalancersFilter")]
    public class DataOciLoadBalancersFilter : oci.DataOciLoadBalancers.IDataOciLoadBalancersFilter
    {
