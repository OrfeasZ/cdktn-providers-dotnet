...
namespace oci.DataOciMediaServicesMediaAssetDistributionChannelAttachment
{
    ...
    public class DataOciMediaServicesMediaAssetDistributionChannelAttachmentLocksOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        protected DataOciMediaServicesMediaAssetDistributionChannelAttachmentLocksOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected DataOciMediaServicesMediaAssetDistributionChannelAttachmentLocksOutputReference(DeputyProps props): base(props)
        {
        }
