...
namespace oci.CoreInstancePool
{
    ...
    public class CoreInstancePoolPlacementConfigurationsPrimaryVnicSubnetsOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        /// <param name="value">Type union: either <see cref="Io.Cdktn.IResolvable" /> or (<see cref="oci.CoreInstancePool.ICoreInstancePoolPlacementConfigurationsPrimaryVnicSubnetsIpv6AddressIpv6SubnetCidrPairDetails" />)[]</param>
