...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/oracle/oci/8.28.0/docs/resources/core_instance_pool oci_core_instance_pool}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/oracle/oci/8.28.0/docs/resources/core_instance_pool oci_core_instance_pool} Resource.</summary>
        ...
        private static DeputyProps _MakeDeputyProps(Constructs.Construct scope, string id, oci.CoreInstancePool.ICoreInstancePoolConfig config)
        {
        ...
        protected CoreInstancePool(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected CoreInstancePool(DeputyProps props): base(props)
        {
        }

        /// <summary>Generates CDKTN code for importing a CoreInstancePool resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
            ...
            if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
            {
                switch (@value)
                {
                    case Io.Cdktn.IResolvable cast_2ed7d7:
                        break;
                    case oci.CoreInstancePool.ICoreInstancePoolLoadBalancers[] cast_2ed7d7:
                        break;
                    case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_2ed7d7:
                        // Not enough information to type-check...
                        break;
                    case null:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(oci.CoreInstancePool.ICoreInstancePoolLoadBalancers).FullName}[]; received null", nameof(@value));
                    default:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(oci.CoreInstancePool.ICoreInstancePoolLoadBalancers).FullName}[]; received {@value.GetType().FullName}", nameof(@value));
                }
            }
        ...
        public virtual void PutPlacementConfigurations(object @value)
        {
            if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
            {
                switch (@value)
                {
                    case Io.Cdktn.IResolvable cast_2ed7d7:
                        break;
                    case oci.CoreInstancePool.ICoreInstancePoolPlacementConfigurations[] cast_2ed7d7:
                        break;
                    case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_2ed7d7:
                        // Not enough information to type-check...
                        break;
                    case null:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(oci.CoreInstancePool.ICoreInstancePoolPlacementConfigurations).FullName}[]; received null", nameof(@value));
                    default:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(oci.CoreInstancePool.ICoreInstancePoolPlacementConfigurations).FullName}[]; received {@value.GetType().FullName}", nameof(@value));
                }
            }
            InvokeInstanceVoidMethod(new System.Type[]{typeof(object)}, new object[]{@value});
        }

        [JsiiMethod(name: "putTimeouts", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"oci.coreInstancePool.CoreInstancePoolTimeouts\"}}]")]
        public virtual void PutTimeouts(oci.CoreInstancePool.ICoreInstancePoolTimeouts @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(oci.CoreInstancePool.ICoreInstancePoolTimeouts)}, new object[]{@value});
        }
        ...
        [JsiiMethod(name: "resetInstanceDisplayNameFormatter")]
        public virtual void ResetInstanceDisplayNameFormatter()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }

        [JsiiMethod(name: "resetInstanceHostnameFormatter")]
        public virtual void ResetInstanceHostnameFormatter()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        = GetStaticProperty<string>(typeof(oci.CoreInstancePool.CoreInstancePool))!;
        ...
        public virtual oci.CoreInstancePool.CoreInstancePoolLoadBalancersList LoadBalancers
        {
            get => GetInstanceProperty<oci.CoreInstancePool.CoreInstancePoolLoadBalancersList>()!;
        }

        [JsiiProperty(name: "placementConfigurations", typeJson: "{\"fqn\":\"oci.coreInstancePool.CoreInstancePoolPlacementConfigurationsList\"}")]
        public virtual oci.CoreInstancePool.CoreInstancePoolPlacementConfigurationsList PlacementConfigurations
        {
            get => GetInstanceProperty<oci.CoreInstancePool.CoreInstancePoolPlacementConfigurationsList>()!;
        }
        ...
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"oci.coreInstancePool.CoreInstancePoolTimeoutsOutputReference\"}")]
        public virtual oci.CoreInstancePool.CoreInstancePoolTimeoutsOutputReference Timeouts
        {
            get => GetInstanceProperty<oci.CoreInstancePool.CoreInstancePoolTimeoutsOutputReference>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "instanceDisplayNameFormatterInput", typeJson: "{\"primitive\":\"string\"}", isOptional: true)]
        public virtual string? InstanceDisplayNameFormatterInput
        {
            get => GetInstanceProperty<string?>();
        }

        [JsiiOptional]
        [JsiiProperty(name: "instanceHostnameFormatterInput", typeJson: "{\"primitive\":\"string\"}", isOptional: true)]
        public virtual string? InstanceHostnameFormatterInput
        {
            get => GetInstanceProperty<string?>();
        }
