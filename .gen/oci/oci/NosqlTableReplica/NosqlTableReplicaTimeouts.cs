...
{
    [JsiiByValue(fqn: "oci.nosqlTableReplica.NosqlTableReplicaTimeouts")]
    public class NosqlTableReplicaTimeouts : oci.NosqlTableReplica.INosqlTableReplicaTimeouts
    {
