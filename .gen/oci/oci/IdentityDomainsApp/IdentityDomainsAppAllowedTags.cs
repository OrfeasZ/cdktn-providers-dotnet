...
namespace oci.IdentityDomainsApp
{
    ...
    [JsiiByValue(fqn: "oci.identityDomainsApp.IdentityDomainsAppAllowedTags")]
    public class IdentityDomainsAppAllowedTags : oci.IdentityDomainsApp.IIdentityDomainsAppAllowedTags
    {
