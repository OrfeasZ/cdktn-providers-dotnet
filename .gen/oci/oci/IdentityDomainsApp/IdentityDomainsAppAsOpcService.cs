...
namespace oci.IdentityDomainsApp
{
    ...
    [JsiiByValue(fqn: "oci.identityDomainsApp.IdentityDomainsAppAsOpcService")]
    public class IdentityDomainsAppAsOpcService : oci.IdentityDomainsApp.IIdentityDomainsAppAsOpcService
    {
