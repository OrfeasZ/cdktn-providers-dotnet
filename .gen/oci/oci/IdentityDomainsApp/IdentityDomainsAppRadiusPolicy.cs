...
namespace oci.IdentityDomainsApp
{
    ...
    [JsiiByValue(fqn: "oci.identityDomainsApp.IdentityDomainsAppRadiusPolicy")]
    public class IdentityDomainsAppRadiusPolicy : oci.IdentityDomainsApp.IIdentityDomainsAppRadiusPolicy
    {
