...
namespace oci.IdentityDomainsApp
{
    ...
    [JsiiByValue(fqn: "oci.identityDomainsApp.IdentityDomainsAppAliasApps")]
    public class IdentityDomainsAppAliasApps : oci.IdentityDomainsApp.IIdentityDomainsAppAliasApps
    {
