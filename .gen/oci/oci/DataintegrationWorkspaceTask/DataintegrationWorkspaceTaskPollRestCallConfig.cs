...
{
    [JsiiByValue(fqn: "oci.dataintegrationWorkspaceTask.DataintegrationWorkspaceTaskPollRestCallConfig")]
    public class DataintegrationWorkspaceTaskPollRestCallConfig : oci.DataintegrationWorkspaceTask.IDataintegrationWorkspaceTaskPollRestCallConfig
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "configValues", typeJson: "{\"fqn\":\"oci.dataintegrationWorkspaceTask.DataintegrationWorkspaceTaskPollRestCallConfigConfigValues\"}", isOptional: true)]
        public oci.DataintegrationWorkspaceTask.IDataintegrationWorkspaceTaskPollRestCallConfigConfigValues? ConfigValues
        {
            get;
            set;
        }
