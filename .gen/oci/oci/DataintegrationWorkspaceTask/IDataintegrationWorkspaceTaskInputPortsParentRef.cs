...
{
    [JsiiInterface(nativeType: typeof(IDataintegrationWorkspaceTaskInputPortsParentRef), fullyQualifiedName: "oci.dataintegrationWorkspaceTask.DataintegrationWorkspaceTaskInputPortsParentRef")]
    public interface IDataintegrationWorkspaceTaskInputPortsParentRef
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataintegrationWorkspaceTaskInputPortsParentRef), fullyQualifiedName: "oci.dataintegrationWorkspaceTask.DataintegrationWorkspaceTaskInputPortsParentRef")]
        internal sealed class _Proxy : DeputyBase, oci.DataintegrationWorkspaceTask.IDataintegrationWorkspaceTaskInputPortsParentRef
        {
