...
{
    [JsiiInterface(nativeType: typeof(IDataintegrationWorkspaceTaskOutputPortsParentRef), fullyQualifiedName: "oci.dataintegrationWorkspaceTask.DataintegrationWorkspaceTaskOutputPortsParentRef")]
    public interface IDataintegrationWorkspaceTaskOutputPortsParentRef
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataintegrationWorkspaceTaskOutputPortsParentRef), fullyQualifiedName: "oci.dataintegrationWorkspaceTask.DataintegrationWorkspaceTaskOutputPortsParentRef")]
        internal sealed class _Proxy : DeputyBase, oci.DataintegrationWorkspaceTask.IDataintegrationWorkspaceTaskOutputPortsParentRef
        {
