...
namespace oci.DataOciGenerativeAiHostedDeployment
{
    ...
    public interface IDataOciGenerativeAiHostedDeploymentConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataOciGenerativeAiHostedDeploymentConfig), fullyQualifiedName: "oci.dataOciGenerativeAiHostedDeployment.DataOciGenerativeAiHostedDeploymentConfig")]
        internal sealed class _Proxy : DeputyBase, oci.DataOciGenerativeAiHostedDeployment.IDataOciGenerativeAiHostedDeploymentConfig
        {
