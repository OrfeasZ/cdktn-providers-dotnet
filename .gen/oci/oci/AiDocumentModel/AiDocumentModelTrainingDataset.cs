...
namespace oci.AiDocumentModel
{
    ...
    [JsiiByValue(fqn: "oci.aiDocumentModel.AiDocumentModelTrainingDataset")]
    public class AiDocumentModelTrainingDataset : oci.AiDocumentModel.IAiDocumentModelTrainingDataset
    {
