...
namespace oci.AiDocumentModel
{
    ...
    [JsiiByValue(fqn: "oci.aiDocumentModel.AiDocumentModelValidationDataset")]
    public class AiDocumentModelValidationDataset : oci.AiDocumentModel.IAiDocumentModelValidationDataset
    {
