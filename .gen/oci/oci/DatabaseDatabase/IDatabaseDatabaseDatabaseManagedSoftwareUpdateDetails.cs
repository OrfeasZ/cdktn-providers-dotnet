...
{
    [JsiiInterface(nativeType: typeof(IDatabaseDatabaseDatabaseManagedSoftwareUpdateDetails), fullyQualifiedName: "oci.databaseDatabase.DatabaseDatabaseDatabaseManagedSoftwareUpdateDetails")]
    public interface IDatabaseDatabaseDatabaseManagedSoftwareUpdateDetails
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDatabaseDatabaseDatabaseManagedSoftwareUpdateDetails), fullyQualifiedName: "oci.databaseDatabase.DatabaseDatabaseDatabaseManagedSoftwareUpdateDetails")]
        internal sealed class _Proxy : DeputyBase, oci.DatabaseDatabase.IDatabaseDatabaseDatabaseManagedSoftwareUpdateDetails
        {
