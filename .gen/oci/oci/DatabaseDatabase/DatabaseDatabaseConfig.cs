...
namespace oci.DatabaseDatabase
{
    ...
    [JsiiByValue(fqn: "oci.databaseDatabase.DatabaseDatabaseConfig")]
    public class DatabaseDatabaseConfig : oci.DatabaseDatabase.IDatabaseDatabaseConfig
    {
        ...
        private object? _kmsKeyMigration;
