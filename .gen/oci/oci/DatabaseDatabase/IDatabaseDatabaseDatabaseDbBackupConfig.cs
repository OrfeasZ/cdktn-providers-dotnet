...
{
    [JsiiInterface(nativeType: typeof(IDatabaseDatabaseDatabaseDbBackupConfig), fullyQualifiedName: "oci.databaseDatabase.DatabaseDatabaseDatabaseDbBackupConfig")]
    public interface IDatabaseDatabaseDatabaseDbBackupConfig
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDatabaseDatabaseDatabaseDbBackupConfig), fullyQualifiedName: "oci.databaseDatabase.DatabaseDatabaseDatabaseDbBackupConfig")]
        internal sealed class _Proxy : DeputyBase, oci.DatabaseDatabase.IDatabaseDatabaseDatabaseDbBackupConfig
        {
