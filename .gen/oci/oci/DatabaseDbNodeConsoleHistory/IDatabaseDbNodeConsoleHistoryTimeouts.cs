...
{
    [JsiiInterface(nativeType: typeof(IDatabaseDbNodeConsoleHistoryTimeouts), fullyQualifiedName: "oci.databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistoryTimeouts")]
    public interface IDatabaseDbNodeConsoleHistoryTimeouts
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDatabaseDbNodeConsoleHistoryTimeouts), fullyQualifiedName: "oci.databaseDbNodeConsoleHistory.DatabaseDbNodeConsoleHistoryTimeouts")]
        internal sealed class _Proxy : DeputyBase, oci.DatabaseDbNodeConsoleHistory.IDatabaseDbNodeConsoleHistoryTimeouts
        {
