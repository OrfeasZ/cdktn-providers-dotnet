...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/oracle/oci/8.25.0/docs/resources/cloud_migrations_migration oci_cloud_migrations_migration}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/oracle/oci/8.25.0/docs/resources/cloud_migrations_migration oci_cloud_migrations_migration} Resource.</summary>
        ...
        private static DeputyProps _MakeDeputyProps(Constructs.Construct scope, string id, oci.CloudMigrationsMigration.ICloudMigrationsMigrationConfig config)
        {
        ...
        protected CloudMigrationsMigration(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected CloudMigrationsMigration(DeputyProps props): base(props)
        {
        }

        /// <summary>Generates CDKTN code for importing a CloudMigrationsMigration resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        ...
        public virtual void PutTimeouts(oci.CloudMigrationsMigration.ICloudMigrationsMigrationTimeouts @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(oci.CloudMigrationsMigration.ICloudMigrationsMigrationTimeouts)}, new object[]{@value});
        }
        ...
        [JsiiMethod(name: "resetIsCompleted")]
        public virtual void ResetIsCompleted()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        = GetStaticProperty<string>(typeof(oci.CloudMigrationsMigration.CloudMigrationsMigration))!;
        ...
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"oci.cloudMigrationsMigration.CloudMigrationsMigrationTimeoutsOutputReference\"}")]
        public virtual oci.CloudMigrationsMigration.CloudMigrationsMigrationTimeoutsOutputReference Timeouts
        {
            get => GetInstanceProperty<oci.CloudMigrationsMigration.CloudMigrationsMigrationTimeoutsOutputReference>()!;
        }
