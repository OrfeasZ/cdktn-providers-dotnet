...
{
    [JsiiInterface(nativeType: typeof(ICorePublicIpConfig), fullyQualifiedName: "oci.corePublicIp.CorePublicIpConfig")]
    public interface ICorePublicIpConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        oci.CorePublicIp.ICorePublicIpTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(ICorePublicIpConfig), fullyQualifiedName: "oci.corePublicIp.CorePublicIpConfig")]
        internal sealed class _Proxy : DeputyBase, oci.CorePublicIp.ICorePublicIpConfig
        {
            ...
            {
                get => GetInstanceProperty<oci.CorePublicIp.ICorePublicIpTimeouts?>();
            }
