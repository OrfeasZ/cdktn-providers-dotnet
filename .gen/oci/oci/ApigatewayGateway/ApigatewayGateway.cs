...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/oracle/oci/8.29.0/docs/resources/apigateway_gateway oci_apigateway_gateway}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/oracle/oci/8.29.0/docs/resources/apigateway_gateway oci_apigateway_gateway} Resource.</summary>
        ...
        private static DeputyProps _MakeDeputyProps(Constructs.Construct scope, string id, oci.ApigatewayGateway.IApigatewayGatewayConfig config)
        {
        ...
        protected ApigatewayGateway(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected ApigatewayGateway(DeputyProps props): base(props)
        {
        }

        /// <summary>Generates CDKTN code for importing a ApigatewayGateway resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
            ...
            if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
            {
                switch (@value)
                {
                    case Io.Cdktn.IResolvable cast_2ed7d7:
                        break;
                    case oci.ApigatewayGateway.IApigatewayGatewayCaBundles[] cast_2ed7d7:
                        break;
                    case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_2ed7d7:
                        // Not enough information to type-check...
                        break;
                    case null:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(oci.ApigatewayGateway.IApigatewayGatewayCaBundles).FullName}[]; received null", nameof(@value));
                    default:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(oci.ApigatewayGateway.IApigatewayGatewayCaBundles).FullName}[]; received {@value.GetType().FullName}", nameof(@value));
                }
            }
        ...
        public virtual void PutLocks(object @value)
        {
            if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
            {
                switch (@value)
                {
                    case Io.Cdktn.IResolvable cast_2ed7d7:
                        break;
                    case oci.ApigatewayGateway.IApigatewayGatewayLocks[] cast_2ed7d7:
                        break;
                    case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_2ed7d7:
                        // Not enough information to type-check...
                        break;
                    case null:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(oci.ApigatewayGateway.IApigatewayGatewayLocks).FullName}[]; received null", nameof(@value));
                    default:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(oci.ApigatewayGateway.IApigatewayGatewayLocks).FullName}[]; received {@value.GetType().FullName}", nameof(@value));
                }
            }
            InvokeInstanceVoidMethod(new System.Type[]{typeof(object)}, new object[]{@value});
        }

        [JsiiMethod(name: "putResponseCacheDetails", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"oci.apigatewayGateway.ApigatewayGatewayResponseCacheDetails\"}}]")]
        public virtual void PutResponseCacheDetails(oci.ApigatewayGateway.IApigatewayGatewayResponseCacheDetails @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(oci.ApigatewayGateway.IApigatewayGatewayResponseCacheDetails)}, new object[]{@value});
        }

        [JsiiMethod(name: "putTimeouts", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"oci.apigatewayGateway.ApigatewayGatewayTimeouts\"}}]")]
        public virtual void PutTimeouts(oci.ApigatewayGateway.IApigatewayGatewayTimeouts @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(oci.ApigatewayGateway.IApigatewayGatewayTimeouts)}, new object[]{@value});
        }

        [JsiiMethod(name: "resetCaBundles")]
        public virtual void ResetCaBundles()
        {
        ...
        [JsiiMethod(name: "resetResponseCacheDetails")]
        public virtual void ResetResponseCacheDetails()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        = GetStaticProperty<string>(typeof(oci.ApigatewayGateway.ApigatewayGateway))!;

        [JsiiProperty(name: "caBundles", typeJson: "{\"fqn\":\"oci.apigatewayGateway.ApigatewayGatewayCaBundlesList\"}")]
        public virtual oci.ApigatewayGateway.ApigatewayGatewayCaBundlesList CaBundles
        {
            get => GetInstanceProperty<oci.ApigatewayGateway.ApigatewayGatewayCaBundlesList>()!;
        }
        ...
        [JsiiProperty(name: "ipAddresses", typeJson: "{\"fqn\":\"oci.apigatewayGateway.ApigatewayGatewayIpAddressesList\"}")]
        public virtual oci.ApigatewayGateway.ApigatewayGatewayIpAddressesList IpAddresses
        {
        ...
        [JsiiProperty(name: "locks", typeJson: "{\"fqn\":\"oci.apigatewayGateway.ApigatewayGatewayLocksList\"}")]
        public virtual oci.ApigatewayGateway.ApigatewayGatewayLocksList Locks
        {
            get => GetInstanceProperty<oci.ApigatewayGateway.ApigatewayGatewayLocksList>()!;
        }

        [JsiiProperty(name: "responseCacheDetails", typeJson: "{\"fqn\":\"oci.apigatewayGateway.ApigatewayGatewayResponseCacheDetailsOutputReference\"}")]
        public virtual oci.ApigatewayGateway.ApigatewayGatewayResponseCacheDetailsOutputReference ResponseCacheDetails
        {
            get => GetInstanceProperty<oci.ApigatewayGateway.ApigatewayGatewayResponseCacheDetailsOutputReference>()!;
        }
        ...
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"oci.apigatewayGateway.ApigatewayGatewayTimeoutsOutputReference\"}")]
        public virtual oci.ApigatewayGateway.ApigatewayGatewayTimeoutsOutputReference Timeouts
        {
            get => GetInstanceProperty<oci.ApigatewayGateway.ApigatewayGatewayTimeoutsOutputReference>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "responseCacheDetailsInput", typeJson: "{\"fqn\":\"oci.apigatewayGateway.ApigatewayGatewayResponseCacheDetails\"}", isOptional: true)]
        public virtual oci.ApigatewayGateway.IApigatewayGatewayResponseCacheDetails? ResponseCacheDetailsInput
        {
