...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/oracle/oci/8.23.0/docs/resources/data_safe_unified_audit_policy oci_data_safe_unified_audit_policy}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/oracle/oci/8.23.0/docs/resources/data_safe_unified_audit_policy oci_data_safe_unified_audit_policy} Resource.</summary>
        ...
        private static DeputyProps _MakeDeputyProps(Constructs.Construct scope, string id, oci.DataSafeUnifiedAuditPolicy.IDataSafeUnifiedAuditPolicyConfig config)
        {
        ...
        protected DataSafeUnifiedAuditPolicy(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected DataSafeUnifiedAuditPolicy(DeputyProps props): base(props)
        {
        }

        /// <summary>Generates CDKTN code for importing a DataSafeUnifiedAuditPolicy resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
            ...
            if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
            {
                switch (@value)
                {
                    case Io.Cdktn.IResolvable cast_2ed7d7:
                        break;
                    case oci.DataSafeUnifiedAuditPolicy.IDataSafeUnifiedAuditPolicyConditions[] cast_2ed7d7:
                        break;
                    case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_2ed7d7:
                        // Not enough information to type-check...
                        break;
                    case null:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(oci.DataSafeUnifiedAuditPolicy.IDataSafeUnifiedAuditPolicyConditions).FullName}[]; received null", nameof(@value));
                    default:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(oci.DataSafeUnifiedAuditPolicy.IDataSafeUnifiedAuditPolicyConditions).FullName}[]; received {@value.GetType().FullName}", nameof(@value));
                }
            }
            InvokeInstanceVoidMethod(new System.Type[]{typeof(object)}, new object[]{@value});
        }

        [JsiiMethod(name: "putTimeouts", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"oci.dataSafeUnifiedAuditPolicy.DataSafeUnifiedAuditPolicyTimeouts\"}}]")]
        public virtual void PutTimeouts(oci.DataSafeUnifiedAuditPolicy.IDataSafeUnifiedAuditPolicyTimeouts @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(oci.DataSafeUnifiedAuditPolicy.IDataSafeUnifiedAuditPolicyTimeouts)}, new object[]{@value});
        }
        ...
        = GetStaticProperty<string>(typeof(oci.DataSafeUnifiedAuditPolicy.DataSafeUnifiedAuditPolicy))!;

        [JsiiProperty(name: "conditions", typeJson: "{\"fqn\":\"oci.dataSafeUnifiedAuditPolicy.DataSafeUnifiedAuditPolicyConditionsList\"}")]
        public virtual oci.DataSafeUnifiedAuditPolicy.DataSafeUnifiedAuditPolicyConditionsList Conditions
        {
            get => GetInstanceProperty<oci.DataSafeUnifiedAuditPolicy.DataSafeUnifiedAuditPolicyConditionsList>()!;
        }
        ...
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"oci.dataSafeUnifiedAuditPolicy.DataSafeUnifiedAuditPolicyTimeoutsOutputReference\"}")]
        public virtual oci.DataSafeUnifiedAuditPolicy.DataSafeUnifiedAuditPolicyTimeoutsOutputReference Timeouts
        {
            get => GetInstanceProperty<oci.DataSafeUnifiedAuditPolicy.DataSafeUnifiedAuditPolicyTimeoutsOutputReference>()!;
        }
