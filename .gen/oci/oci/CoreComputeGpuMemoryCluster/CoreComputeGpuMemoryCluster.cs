...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/oracle/oci/8.22.0/docs/resources/core_compute_gpu_memory_cluster oci_core_compute_gpu_memory_cluster}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/oracle/oci/8.22.0/docs/resources/core_compute_gpu_memory_cluster oci_core_compute_gpu_memory_cluster} Resource.</summary>
        ...
        private static DeputyProps _MakeDeputyProps(Constructs.Construct scope, string id, oci.CoreComputeGpuMemoryCluster.ICoreComputeGpuMemoryClusterConfig config)
        {
        ...
        protected CoreComputeGpuMemoryCluster(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected CoreComputeGpuMemoryCluster(DeputyProps props): base(props)
        {
        }

        /// <summary>Generates CDKTN code for importing a CoreComputeGpuMemoryCluster resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        ...
        public virtual void PutTimeouts(oci.CoreComputeGpuMemoryCluster.ICoreComputeGpuMemoryClusterTimeouts @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(oci.CoreComputeGpuMemoryCluster.ICoreComputeGpuMemoryClusterTimeouts)}, new object[]{@value});
        }
        ...
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"oci.coreComputeGpuMemoryCluster.CoreComputeGpuMemoryClusterTimeoutsOutputReference\"}")]
        public virtual oci.CoreComputeGpuMemoryCluster.CoreComputeGpuMemoryClusterTimeoutsOutputReference Timeouts
        {
            get => GetInstanceProperty<oci.CoreComputeGpuMemoryCluster.CoreComputeGpuMemoryClusterTimeoutsOutputReference>()!;
        }
