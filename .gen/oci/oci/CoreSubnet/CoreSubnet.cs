...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/oracle/oci/8.26.0/docs/resources/core_subnet oci_core_subnet}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/oracle/oci/8.26.0/docs/resources/core_subnet oci_core_subnet} Resource.</summary>
        ...
        [JsiiMethod(name: "resetIpv4CidrBlocks")]
        public virtual void ResetIpv4CidrBlocks()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "ipv4CidrBlocksInput", typeJson: "{\"collection\":{\"elementtype\":{\"primitive\":\"string\"},\"kind\":\"array\"}}", isOptional: true)]
        public virtual string[]? Ipv4CidrBlocksInput
        {
            get => GetInstanceProperty<string[]?>();
        }
        ...
        /// <remarks>
        /// <para>Type union: either <see cref="Io.Cdktn.IResolvable" /> or <see cref="oci.CoreSubnet.ICoreSubnetTimeouts" /></para>
        /// </remarks>
        [JsiiOptional]
