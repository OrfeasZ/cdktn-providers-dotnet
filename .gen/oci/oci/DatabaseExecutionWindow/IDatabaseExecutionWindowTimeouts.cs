...
{
    [JsiiInterface(nativeType: typeof(IDatabaseExecutionWindowTimeouts), fullyQualifiedName: "oci.databaseExecutionWindow.DatabaseExecutionWindowTimeouts")]
    public interface IDatabaseExecutionWindowTimeouts
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDatabaseExecutionWindowTimeouts), fullyQualifiedName: "oci.databaseExecutionWindow.DatabaseExecutionWindowTimeouts")]
        internal sealed class _Proxy : DeputyBase, oci.DatabaseExecutionWindow.IDatabaseExecutionWindowTimeouts
        {
