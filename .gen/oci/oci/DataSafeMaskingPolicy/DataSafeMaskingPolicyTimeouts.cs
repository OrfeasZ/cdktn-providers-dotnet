...
{
    [JsiiByValue(fqn: "oci.dataSafeMaskingPolicy.DataSafeMaskingPolicyTimeouts")]
    public class DataSafeMaskingPolicyTimeouts : oci.DataSafeMaskingPolicy.IDataSafeMaskingPolicyTimeouts
    {
