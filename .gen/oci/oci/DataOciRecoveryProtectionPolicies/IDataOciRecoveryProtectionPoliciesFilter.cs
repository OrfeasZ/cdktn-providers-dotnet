...
{
    [JsiiInterface(nativeType: typeof(IDataOciRecoveryProtectionPoliciesFilter), fullyQualifiedName: "oci.dataOciRecoveryProtectionPolicies.DataOciRecoveryProtectionPoliciesFilter")]
    public interface IDataOciRecoveryProtectionPoliciesFilter
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataOciRecoveryProtectionPoliciesFilter), fullyQualifiedName: "oci.dataOciRecoveryProtectionPolicies.DataOciRecoveryProtectionPoliciesFilter")]
        internal sealed class _Proxy : DeputyBase, oci.DataOciRecoveryProtectionPolicies.IDataOciRecoveryProtectionPoliciesFilter
        {
