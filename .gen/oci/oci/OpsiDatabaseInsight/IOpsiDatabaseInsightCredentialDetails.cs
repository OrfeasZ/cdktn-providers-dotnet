...
{
    [JsiiInterface(nativeType: typeof(IOpsiDatabaseInsightCredentialDetails), fullyQualifiedName: "oci.opsiDatabaseInsight.OpsiDatabaseInsightCredentialDetails")]
    public interface IOpsiDatabaseInsightCredentialDetails
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IOpsiDatabaseInsightCredentialDetails), fullyQualifiedName: "oci.opsiDatabaseInsight.OpsiDatabaseInsightCredentialDetails")]
        internal sealed class _Proxy : DeputyBase, oci.OpsiDatabaseInsight.IOpsiDatabaseInsightCredentialDetails
        {
