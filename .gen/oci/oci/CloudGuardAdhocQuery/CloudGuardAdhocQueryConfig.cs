...
namespace oci.CloudGuardAdhocQuery
{
    ...
    [JsiiByValue(fqn: "oci.cloudGuardAdhocQuery.CloudGuardAdhocQueryConfig")]
    public class CloudGuardAdhocQueryConfig : oci.CloudGuardAdhocQuery.ICloudGuardAdhocQueryConfig
    {
