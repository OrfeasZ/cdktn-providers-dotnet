...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/oracle/oci/8.19.0/docs/resources/bds_bds_instance_replace_node_action oci_bds_bds_instance_replace_node_action}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/oracle/oci/8.19.0/docs/resources/bds_bds_instance_replace_node_action oci_bds_bds_instance_replace_node_action} Resource.</summary>
        ...
        [JsiiMethod(name: "resetNodeBackupId")]
        public virtual void ResetNodeBackupId()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
