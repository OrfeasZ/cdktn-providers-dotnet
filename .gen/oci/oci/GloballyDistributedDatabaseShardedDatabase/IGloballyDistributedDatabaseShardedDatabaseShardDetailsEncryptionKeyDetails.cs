...
{
    [JsiiInterface(nativeType: typeof(IGloballyDistributedDatabaseShardedDatabaseShardDetailsEncryptionKeyDetails), fullyQualifiedName: "oci.globallyDistributedDatabaseShardedDatabase.GloballyDistributedDatabaseShardedDatabaseShardDetailsEncryptionKeyDetails")]
    public interface IGloballyDistributedDatabaseShardedDatabaseShardDetailsEncryptionKeyDetails
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IGloballyDistributedDatabaseShardedDatabaseShardDetailsEncryptionKeyDetails), fullyQualifiedName: "oci.globallyDistributedDatabaseShardedDatabase.GloballyDistributedDatabaseShardedDatabaseShardDetailsEncryptionKeyDetails")]
        internal sealed class _Proxy : DeputyBase, oci.GloballyDistributedDatabaseShardedDatabase.IGloballyDistributedDatabaseShardedDatabaseShardDetailsEncryptionKeyDetails
        {
