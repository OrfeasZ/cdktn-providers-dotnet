...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/oracle/oci/8.25.0/docs/resources/data_safe_library_masking_format oci_data_safe_library_masking_format}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/oracle/oci/8.25.0/docs/resources/data_safe_library_masking_format oci_data_safe_library_masking_format} Resource.</summary>
        ...
        private static DeputyProps _MakeDeputyProps(Constructs.Construct scope, string id, oci.DataSafeLibraryMaskingFormat.IDataSafeLibraryMaskingFormatConfig config)
        {
        ...
        protected DataSafeLibraryMaskingFormat(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected DataSafeLibraryMaskingFormat(DeputyProps props): base(props)
        {
        }

        /// <summary>Generates CDKTN code for importing a DataSafeLibraryMaskingFormat resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
            ...
            if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
            {
                switch (@value)
                {
                    case Io.Cdktn.IResolvable cast_2ed7d7:
                        break;
                    case oci.DataSafeLibraryMaskingFormat.IDataSafeLibraryMaskingFormatFormatEntries[] cast_2ed7d7:
                        break;
                    case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_2ed7d7:
                        // Not enough information to type-check...
                        break;
                    case null:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(oci.DataSafeLibraryMaskingFormat.IDataSafeLibraryMaskingFormatFormatEntries).FullName}[]; received null", nameof(@value));
                    default:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(oci.DataSafeLibraryMaskingFormat.IDataSafeLibraryMaskingFormatFormatEntries).FullName}[]; received {@value.GetType().FullName}", nameof(@value));
                }
            }
            InvokeInstanceVoidMethod(new System.Type[]{typeof(object)}, new object[]{@value});
        }

        [JsiiMethod(name: "putTimeouts", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"oci.dataSafeLibraryMaskingFormat.DataSafeLibraryMaskingFormatTimeouts\"}}]")]
        public virtual void PutTimeouts(oci.DataSafeLibraryMaskingFormat.IDataSafeLibraryMaskingFormatTimeouts @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(oci.DataSafeLibraryMaskingFormat.IDataSafeLibraryMaskingFormatTimeouts)}, new object[]{@value});
        }
        ...
        = GetStaticProperty<string>(typeof(oci.DataSafeLibraryMaskingFormat.DataSafeLibraryMaskingFormat))!;

        [JsiiProperty(name: "formatEntries", typeJson: "{\"fqn\":\"oci.dataSafeLibraryMaskingFormat.DataSafeLibraryMaskingFormatFormatEntriesList\"}")]
        public virtual oci.DataSafeLibraryMaskingFormat.DataSafeLibraryMaskingFormatFormatEntriesList FormatEntries
        {
            get => GetInstanceProperty<oci.DataSafeLibraryMaskingFormat.DataSafeLibraryMaskingFormatFormatEntriesList>()!;
        }
        ...
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"oci.dataSafeLibraryMaskingFormat.DataSafeLibraryMaskingFormatTimeoutsOutputReference\"}")]
        public virtual oci.DataSafeLibraryMaskingFormat.DataSafeLibraryMaskingFormatTimeoutsOutputReference Timeouts
        {
            get => GetInstanceProperty<oci.DataSafeLibraryMaskingFormat.DataSafeLibraryMaskingFormatTimeoutsOutputReference>()!;
        }
