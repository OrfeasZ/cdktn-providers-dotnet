...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/oracle/oci/8.22.0/docs/resources/dbmulticloud_oracle_db_gcp_key_ring oci_dbmulticloud_oracle_db_gcp_key_ring}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/oracle/oci/8.22.0/docs/resources/dbmulticloud_oracle_db_gcp_key_ring oci_dbmulticloud_oracle_db_gcp_key_ring} Resource.</summary>
        ...
        private static DeputyProps _MakeDeputyProps(Constructs.Construct scope, string id, oci.DbmulticloudOracleDbGcpKeyRing.IDbmulticloudOracleDbGcpKeyRingConfig config)
        {
        ...
        protected DbmulticloudOracleDbGcpKeyRing(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected DbmulticloudOracleDbGcpKeyRing(DeputyProps props): base(props)
        {
        }

        /// <summary>Generates CDKTN code for importing a DbmulticloudOracleDbGcpKeyRing resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        ...
        [JsiiMethod(name: "putTimeouts", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"oci.dbmulticloudOracleDbGcpKeyRing.DbmulticloudOracleDbGcpKeyRingTimeouts\"}}]")]
        ...
        [JsiiMethod(name: "resetGcpKeyRingId")]
        public virtual void ResetGcpKeyRingId()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        = GetStaticProperty<string>(typeof(oci.DbmulticloudOracleDbGcpKeyRing.DbmulticloudOracleDbGcpKeyRing))!;
        ...
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"oci.dbmulticloudOracleDbGcpKeyRing.DbmulticloudOracleDbGcpKeyRingTimeoutsOutputReference\"}")]
        public virtual oci.DbmulticloudOracleDbGcpKeyRing.DbmulticloudOracleDbGcpKeyRingTimeoutsOutputReference Timeouts
        {
            get => GetInstanceProperty<oci.DbmulticloudOracleDbGcpKeyRing.DbmulticloudOracleDbGcpKeyRingTimeoutsOutputReference>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "gcpKeyRingIdInput", typeJson: "{\"primitive\":\"string\"}", isOptional: true)]
        public virtual string? GcpKeyRingIdInput
        {
            get => GetInstanceProperty<string?>();
        }
