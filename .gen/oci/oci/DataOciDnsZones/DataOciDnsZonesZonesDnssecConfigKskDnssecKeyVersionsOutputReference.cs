...
namespace oci.DataOciDnsZones
{
    ...
    public class DataOciDnsZonesZonesDnssecConfigKskDnssecKeyVersionsOutputReference : Io.Cdktn.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        /// <param name="complexObjectIndex">the index of this item in the list.</param>
        /// <param name="complexObjectIsFromSet">whether the list is wrapping a set (will add tolist() to be able to access an item via an index).</param>
        public DataOciDnsZonesZonesDnssecConfigKskDnssecKeyVersionsOutputReference(Io.Cdktn.IInterpolatingParent terraformResource, string terraformAttribute, double complexObjectIndex, bool complexObjectIsFromSet): base(_MakeDeputyProps(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet))
        {
        }
        ...
        protected DataOciDnsZonesZonesDnssecConfigKskDnssecKeyVersionsOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected DataOciDnsZonesZonesDnssecConfigKskDnssecKeyVersionsOutputReference(DeputyProps props): base(props)
        {
        }
        ...
        [JsiiProperty(name: "dsData", typeJson: "{\"fqn\":\"oci.dataOciDnsZones.DataOciDnsZonesZonesDnssecConfigKskDnssecKeyVersionsDsDataList\"}")]
        public virtual oci.DataOciDnsZones.DataOciDnsZonesZonesDnssecConfigKskDnssecKeyVersionsDsDataList DsData
        {
            get => GetInstanceProperty<oci.DataOciDnsZones.DataOciDnsZonesZonesDnssecConfigKskDnssecKeyVersionsDsDataList>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"oci.dataOciDnsZones.DataOciDnsZonesZonesDnssecConfigKskDnssecKeyVersions\"}", isOptional: true)]
        public virtual oci.DataOciDnsZones.IDataOciDnsZonesZonesDnssecConfigKskDnssecKeyVersions? InternalValue
        {
            get => GetInstanceProperty<oci.DataOciDnsZones.IDataOciDnsZonesZonesDnssecConfigKskDnssecKeyVersions?>();
