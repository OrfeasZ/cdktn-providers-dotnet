...
namespace oci.DbmulticloudMultiCloudResourceDiscovery
{
    ...
    public interface IDbmulticloudMultiCloudResourceDiscoveryConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        oci.DbmulticloudMultiCloudResourceDiscovery.IDbmulticloudMultiCloudResourceDiscoveryTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IDbmulticloudMultiCloudResourceDiscoveryConfig), fullyQualifiedName: "oci.dbmulticloudMultiCloudResourceDiscovery.DbmulticloudMultiCloudResourceDiscoveryConfig")]
        internal sealed class _Proxy : DeputyBase, oci.DbmulticloudMultiCloudResourceDiscovery.IDbmulticloudMultiCloudResourceDiscoveryConfig
        {
            ...
            {
                get => GetInstanceProperty<oci.DbmulticloudMultiCloudResourceDiscovery.IDbmulticloudMultiCloudResourceDiscoveryTimeouts?>();
            }
