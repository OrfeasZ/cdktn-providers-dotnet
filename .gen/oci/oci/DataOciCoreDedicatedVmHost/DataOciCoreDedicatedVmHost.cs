...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/oracle/oci/8.24.0/docs/data-sources/core_dedicated_vm_host oci_core_dedicated_vm_host}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/oracle/oci/8.24.0/docs/data-sources/core_dedicated_vm_host oci_core_dedicated_vm_host} Data Source.</summary>
        ...
        private static DeputyProps _MakeDeputyProps(Constructs.Construct scope, string id, oci.DataOciCoreDedicatedVmHost.IDataOciCoreDedicatedVmHostConfig config)
        {
        ...
        protected DataOciCoreDedicatedVmHost(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected DataOciCoreDedicatedVmHost(DeputyProps props): base(props)
        {
        }

        /// <summary>Generates CDKTN code for importing a DataOciCoreDedicatedVmHost resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        ...
        = GetStaticProperty<string>(typeof(oci.DataOciCoreDedicatedVmHost.DataOciCoreDedicatedVmHost))!;
        ...
        [JsiiProperty(name: "capacityBins", typeJson: "{\"fqn\":\"oci.dataOciCoreDedicatedVmHost.DataOciCoreDedicatedVmHostCapacityBinsList\"}")]
