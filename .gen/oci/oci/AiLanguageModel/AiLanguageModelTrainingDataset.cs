...
namespace oci.AiLanguageModel
{
    ...
    [JsiiByValue(fqn: "oci.aiLanguageModel.AiLanguageModelTrainingDataset")]
    public class AiLanguageModelTrainingDataset : oci.AiLanguageModel.IAiLanguageModelTrainingDataset
    {
        ...
        public oci.AiLanguageModel.IAiLanguageModelTrainingDatasetLocationDetails? LocationDetails
        {
            get;
            set;
        }
