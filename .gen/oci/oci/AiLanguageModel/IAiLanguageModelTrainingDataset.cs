...
namespace oci.AiLanguageModel
{
    ...
    public interface IAiLanguageModelTrainingDataset
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        oci.AiLanguageModel.IAiLanguageModelTrainingDatasetLocationDetails? LocationDetails
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IAiLanguageModelTrainingDataset), fullyQualifiedName: "oci.aiLanguageModel.AiLanguageModelTrainingDataset")]
        internal sealed class _Proxy : DeputyBase, oci.AiLanguageModel.IAiLanguageModelTrainingDataset
        {
