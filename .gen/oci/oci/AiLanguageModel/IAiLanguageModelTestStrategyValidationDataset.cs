...
{
    [JsiiInterface(nativeType: typeof(IAiLanguageModelTestStrategyValidationDataset), fullyQualifiedName: "oci.aiLanguageModel.AiLanguageModelTestStrategyValidationDataset")]
    public interface IAiLanguageModelTestStrategyValidationDataset
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        oci.AiLanguageModel.IAiLanguageModelTestStrategyValidationDatasetLocationDetails? LocationDetails
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IAiLanguageModelTestStrategyValidationDataset), fullyQualifiedName: "oci.aiLanguageModel.AiLanguageModelTestStrategyValidationDataset")]
        internal sealed class _Proxy : DeputyBase, oci.AiLanguageModel.IAiLanguageModelTestStrategyValidationDataset
        {
