...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/oracle/oci/8.22.0/docs/data-sources/multicloud_network_anchors oci_multicloud_network_anchors}.</summary>
    [JsiiClass(nativeType: typeof(oci.DataOciMulticloudNetworkAnchors.DataOciMulticloudNetworkAnchors), fullyQualifiedName: "oci.dataOciMulticloudNetworkAnchors.DataOciMulticloudNetworkAnchors", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"remarks\":\"Must be unique amongst siblings in the same scope\",\"summary\":\"The scoped construct ID.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"optional\":true,\"type\":{\"fqn\":\"oci.dataOciMulticloudNetworkAnchors.DataOciMulticloudNetworkAnchorsConfig\"}}]")]
    public class DataOciMulticloudNetworkAnchors : Io.Cdktn.TerraformDataSource
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/oracle/oci/8.22.0/docs/data-sources/multicloud_network_anchors oci_multicloud_network_anchors} Data Source.</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        /// <param name="id">The scoped construct ID.</param>
        public DataOciMulticloudNetworkAnchors(Constructs.Construct scope, string id, oci.DataOciMulticloudNetworkAnchors.IDataOciMulticloudNetworkAnchorsConfig? config = null): base(_MakeDeputyProps(scope, id, config))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(Constructs.Construct scope, string id, oci.DataOciMulticloudNetworkAnchors.IDataOciMulticloudNetworkAnchorsConfig? config = null)
        {
        ...
        [JsiiMethod(name: "resetShouldFetchVcnName")]
        public virtual void ResetShouldFetchVcnName()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "shouldFetchVcnNameInput", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktn.IResolvable\"}]}}", isOptional: true)]
        public virtual object? ShouldFetchVcnNameInput
        {
            get => GetInstanceProperty<object?>();
        }
        ...
        /// <para>Type union: either bool or <see cref="Io.Cdktn.IResolvable" /></para>
        /// </remarks>
        [JsiiProperty(name: "shouldFetchVcnName", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktn.IResolvable\"}]}}")]
        public virtual object ShouldFetchVcnName
        {
            get => GetInstanceProperty<object>()!;
            set
            {
