...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/oracle/oci/8.23.0/docs/data-sources/resource_analytics_monitored_regions oci_resource_analytics_monitored_regions}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/oracle/oci/8.23.0/docs/data-sources/resource_analytics_monitored_regions oci_resource_analytics_monitored_regions} Data Source.</summary>
        ...
        private static DeputyProps _MakeDeputyProps(Constructs.Construct scope, string id, oci.DataOciResourceAnalyticsMonitoredRegions.IDataOciResourceAnalyticsMonitoredRegionsConfig? config = null)
        {
        ...
        protected DataOciResourceAnalyticsMonitoredRegions(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected DataOciResourceAnalyticsMonitoredRegions(DeputyProps props): base(props)
        {
        }

        /// <summary>Generates CDKTN code for importing a DataOciResourceAnalyticsMonitoredRegions resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
            ...
            if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
            {
                switch (@value)
                {
                    case Io.Cdktn.IResolvable cast_2ed7d7:
                        break;
                    case oci.DataOciResourceAnalyticsMonitoredRegions.IDataOciResourceAnalyticsMonitoredRegionsFilter[] cast_2ed7d7:
                        break;
                    case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_2ed7d7:
                        // Not enough information to type-check...
                        break;
                    case null:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(oci.DataOciResourceAnalyticsMonitoredRegions.IDataOciResourceAnalyticsMonitoredRegionsFilter).FullName}[]; received null", nameof(@value));
                    default:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(oci.DataOciResourceAnalyticsMonitoredRegions.IDataOciResourceAnalyticsMonitoredRegionsFilter).FullName}[]; received {@value.GetType().FullName}", nameof(@value));
                }
            }
        ...
        = GetStaticProperty<string>(typeof(oci.DataOciResourceAnalyticsMonitoredRegions.DataOciResourceAnalyticsMonitoredRegions))!;

        [JsiiProperty(name: "filter", typeJson: "{\"fqn\":\"oci.dataOciResourceAnalyticsMonitoredRegions.DataOciResourceAnalyticsMonitoredRegionsFilterList\"}")]
        public virtual oci.DataOciResourceAnalyticsMonitoredRegions.DataOciResourceAnalyticsMonitoredRegionsFilterList Filter
        {
            get => GetInstanceProperty<oci.DataOciResourceAnalyticsMonitoredRegions.DataOciResourceAnalyticsMonitoredRegionsFilterList>()!;
        }

        [JsiiProperty(name: "monitoredRegionCollection", typeJson: "{\"fqn\":\"oci.dataOciResourceAnalyticsMonitoredRegions.DataOciResourceAnalyticsMonitoredRegionsMonitoredRegionCollectionList\"}")]
        public virtual oci.DataOciResourceAnalyticsMonitoredRegions.DataOciResourceAnalyticsMonitoredRegionsMonitoredRegionCollectionList MonitoredRegionCollection
        {
