...
namespace oci.DataOciDatabaseAutonomousContainerDatabase
{
    ...
    public class DataOciDatabaseAutonomousContainerDatabaseDataguardGroupMembersOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        protected DataOciDatabaseAutonomousContainerDatabaseDataguardGroupMembersOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected DataOciDatabaseAutonomousContainerDatabaseDataguardGroupMembersOutputReference(DeputyProps props): base(props)
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"oci.dataOciDatabaseAutonomousContainerDatabase.DataOciDatabaseAutonomousContainerDatabaseDataguardGroupMembers\"}", isOptional: true)]
        public virtual oci.DataOciDatabaseAutonomousContainerDatabase.IDataOciDatabaseAutonomousContainerDatabaseDataguardGroupMembers? InternalValue
        {
            get => GetInstanceProperty<oci.DataOciDatabaseAutonomousContainerDatabase.IDataOciDatabaseAutonomousContainerDatabaseDataguardGroupMembers?>();
