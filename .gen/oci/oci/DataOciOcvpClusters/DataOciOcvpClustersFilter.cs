...
namespace oci.DataOciOcvpClusters
{
    ...
    [JsiiByValue(fqn: "oci.dataOciOcvpClusters.DataOciOcvpClustersFilter")]
    public class DataOciOcvpClustersFilter : oci.DataOciOcvpClusters.IDataOciOcvpClustersFilter
    {
