...
namespace oci.ApmSyntheticsMonitor
{
    ...
    public interface IApmSyntheticsMonitorConfigurationReqAuthenticationDetailsAuthHeaders
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IApmSyntheticsMonitorConfigurationReqAuthenticationDetailsAuthHeaders), fullyQualifiedName: "oci.apmSyntheticsMonitor.ApmSyntheticsMonitorConfigurationReqAuthenticationDetailsAuthHeaders")]
        internal sealed class _Proxy : DeputyBase, oci.ApmSyntheticsMonitor.IApmSyntheticsMonitorConfigurationReqAuthenticationDetailsAuthHeaders
        {
