...
{
    [JsiiInterface(nativeType: typeof(IDatabaseMigrationConnectionTimeouts), fullyQualifiedName: "oci.databaseMigrationConnection.DatabaseMigrationConnectionTimeouts")]
    public interface IDatabaseMigrationConnectionTimeouts
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDatabaseMigrationConnectionTimeouts), fullyQualifiedName: "oci.databaseMigrationConnection.DatabaseMigrationConnectionTimeouts")]
        internal sealed class _Proxy : DeputyBase, oci.DatabaseMigrationConnection.IDatabaseMigrationConnectionTimeouts
        {
