...
{
    [JsiiByValue(fqn: "oci.dataOciMediaServicesMediaAssets.DataOciMediaServicesMediaAssetsConfig")]
    public class DataOciMediaServicesMediaAssetsConfig : oci.DataOciMediaServicesMediaAssets.IDataOciMediaServicesMediaAssetsConfig
    {
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        case Io.Cdktn.IResolvable cast_cd4240:
                            break;
                        case oci.DataOciMediaServicesMediaAssets.IDataOciMediaServicesMediaAssetsFilter[] cast_cd4240:
                            break;
                        ...
                        case null:
                            break;
                        default:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(oci.DataOciMediaServicesMediaAssets.IDataOciMediaServicesMediaAssetsFilter).FullName}[]; received {value.GetType().FullName}", nameof(value));
                    }
                }
                _filter = value;
            }
