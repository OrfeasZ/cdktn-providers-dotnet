...
namespace oci.DataOciGenerativeAiHostedApplicationIam
{
    ...
    public interface IDataOciGenerativeAiHostedApplicationIamConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataOciGenerativeAiHostedApplicationIamConfig), fullyQualifiedName: "oci.dataOciGenerativeAiHostedApplicationIam.DataOciGenerativeAiHostedApplicationIamConfig")]
        internal sealed class _Proxy : DeputyBase, oci.DataOciGenerativeAiHostedApplicationIam.IDataOciGenerativeAiHostedApplicationIamConfig
        {
