...
namespace oci.AiVisionModel
{
    ...
    [JsiiByValue(fqn: "oci.aiVisionModel.AiVisionModelTrainingDataset")]
    public class AiVisionModelTrainingDataset : oci.AiVisionModel.IAiVisionModelTrainingDataset
    {
