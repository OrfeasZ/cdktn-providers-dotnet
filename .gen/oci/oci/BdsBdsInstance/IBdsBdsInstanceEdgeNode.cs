...
{
    [JsiiInterface(nativeType: typeof(IBdsBdsInstanceEdgeNode), fullyQualifiedName: "oci.bdsBdsInstance.BdsBdsInstanceEdgeNode")]
    public interface IBdsBdsInstanceEdgeNode
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "shapeConfig", typeJson: "{\"fqn\":\"oci.bdsBdsInstance.BdsBdsInstanceEdgeNodeShapeConfig\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        oci.BdsBdsInstance.IBdsBdsInstanceEdgeNodeShapeConfig? ShapeConfig
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IBdsBdsInstanceEdgeNode), fullyQualifiedName: "oci.bdsBdsInstance.BdsBdsInstanceEdgeNode")]
        internal sealed class _Proxy : DeputyBase, oci.BdsBdsInstance.IBdsBdsInstanceEdgeNode
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "shapeConfig", typeJson: "{\"fqn\":\"oci.bdsBdsInstance.BdsBdsInstanceEdgeNodeShapeConfig\"}", isOptional: true)]
            public oci.BdsBdsInstance.IBdsBdsInstanceEdgeNodeShapeConfig? ShapeConfig
            {
