...
{
    [JsiiByValue(fqn: "oci.bdsBdsInstance.BdsBdsInstanceUtilNodeShapeConfig")]
    public class BdsBdsInstanceUtilNodeShapeConfig : oci.BdsBdsInstance.IBdsBdsInstanceUtilNodeShapeConfig
    {
