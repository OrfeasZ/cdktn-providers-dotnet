...
{
    [JsiiInterface(nativeType: typeof(IBdsBdsInstanceComputeOnlyWorkerNode), fullyQualifiedName: "oci.bdsBdsInstance.BdsBdsInstanceComputeOnlyWorkerNode")]
    public interface IBdsBdsInstanceComputeOnlyWorkerNode
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        oci.BdsBdsInstance.IBdsBdsInstanceComputeOnlyWorkerNodeShapeConfig? ShapeConfig
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IBdsBdsInstanceComputeOnlyWorkerNode), fullyQualifiedName: "oci.bdsBdsInstance.BdsBdsInstanceComputeOnlyWorkerNode")]
        internal sealed class _Proxy : DeputyBase, oci.BdsBdsInstance.IBdsBdsInstanceComputeOnlyWorkerNode
        {
