...
{
    [JsiiInterface(nativeType: typeof(IBdsBdsInstanceMasterNode), fullyQualifiedName: "oci.bdsBdsInstance.BdsBdsInstanceMasterNode")]
    public interface IBdsBdsInstanceMasterNode
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "shapeConfig", typeJson: "{\"fqn\":\"oci.bdsBdsInstance.BdsBdsInstanceMasterNodeShapeConfig\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        oci.BdsBdsInstance.IBdsBdsInstanceMasterNodeShapeConfig? ShapeConfig
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IBdsBdsInstanceMasterNode), fullyQualifiedName: "oci.bdsBdsInstance.BdsBdsInstanceMasterNode")]
        internal sealed class _Proxy : DeputyBase, oci.BdsBdsInstance.IBdsBdsInstanceMasterNode
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "shapeConfig", typeJson: "{\"fqn\":\"oci.bdsBdsInstance.BdsBdsInstanceMasterNodeShapeConfig\"}", isOptional: true)]
            public oci.BdsBdsInstance.IBdsBdsInstanceMasterNodeShapeConfig? ShapeConfig
            {
