...
{
    [JsiiByValue(fqn: "oci.bdsBdsInstance.BdsBdsInstanceWorkerNodeShapeConfig")]
    public class BdsBdsInstanceWorkerNodeShapeConfig : oci.BdsBdsInstance.IBdsBdsInstanceWorkerNodeShapeConfig
    {
