...
{
    [JsiiInterface(nativeType: typeof(IBdsBdsInstanceWorkerNodeShapeConfig), fullyQualifiedName: "oci.bdsBdsInstance.BdsBdsInstanceWorkerNodeShapeConfig")]
    public interface IBdsBdsInstanceWorkerNodeShapeConfig
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IBdsBdsInstanceWorkerNodeShapeConfig), fullyQualifiedName: "oci.bdsBdsInstance.BdsBdsInstanceWorkerNodeShapeConfig")]
        internal sealed class _Proxy : DeputyBase, oci.BdsBdsInstance.IBdsBdsInstanceWorkerNodeShapeConfig
        {
