...
namespace oci.BdsBdsInstance
{
    ...
    public class BdsBdsInstanceMasterNodeShapeConfigOutputReference : Io.Cdktn.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        public BdsBdsInstanceMasterNodeShapeConfigOutputReference(Io.Cdktn.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
        ...
        protected BdsBdsInstanceMasterNodeShapeConfigOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected BdsBdsInstanceMasterNodeShapeConfigOutputReference(DeputyProps props): base(props)
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"oci.bdsBdsInstance.BdsBdsInstanceMasterNodeShapeConfig\"}", isOptional: true)]
        public virtual oci.BdsBdsInstance.IBdsBdsInstanceMasterNodeShapeConfig? InternalValue
        {
            get => GetInstanceProperty<oci.BdsBdsInstance.IBdsBdsInstanceMasterNodeShapeConfig?>();
            set => SetInstanceProperty(value);
        }
    }
}
