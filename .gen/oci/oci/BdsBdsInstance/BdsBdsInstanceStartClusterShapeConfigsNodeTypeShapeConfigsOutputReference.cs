...
namespace oci.BdsBdsInstance
{
    ...
    public class BdsBdsInstanceStartClusterShapeConfigsNodeTypeShapeConfigsOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        protected BdsBdsInstanceStartClusterShapeConfigsNodeTypeShapeConfigsOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected BdsBdsInstanceStartClusterShapeConfigsNodeTypeShapeConfigsOutputReference(DeputyProps props): base(props)
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"oci.bdsBdsInstance.BdsBdsInstanceStartClusterShapeConfigsNodeTypeShapeConfigs\"}]}}", isOptional: true)]
