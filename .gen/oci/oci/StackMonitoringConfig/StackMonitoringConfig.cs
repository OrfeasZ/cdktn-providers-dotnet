...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/oracle/oci/8.26.0/docs/resources/stack_monitoring_config oci_stack_monitoring_config}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/oracle/oci/8.26.0/docs/resources/stack_monitoring_config oci_stack_monitoring_config} Resource.</summary>
        ...
        private static DeputyProps _MakeDeputyProps(Constructs.Construct scope, string id, oci.StackMonitoringConfig.IStackMonitoringConfigConfig config)
        {
        ...
        protected StackMonitoringConfig(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected StackMonitoringConfig(DeputyProps props): base(props)
        {
        }

        /// <summary>Generates CDKTN code for importing a StackMonitoringConfig resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        ...
        [JsiiMethod(name: "putAdditionalConfigurations", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"oci.stackMonitoringConfig.StackMonitoringConfigAdditionalConfigurations\"}}]")]
        public virtual void PutAdditionalConfigurations(oci.StackMonitoringConfig.IStackMonitoringConfigAdditionalConfigurations @value)
        {
            ...
            if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
            {
                switch (@value)
                {
                    case Io.Cdktn.IResolvable cast_2ed7d7:
                        break;
                    case oci.StackMonitoringConfig.IStackMonitoringConfigDynamicGroups[] cast_2ed7d7:
                        break;
                    case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_2ed7d7:
                        // Not enough information to type-check...
                        break;
                    case null:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(oci.StackMonitoringConfig.IStackMonitoringConfigDynamicGroups).FullName}[]; received null", nameof(@value));
                    default:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(oci.StackMonitoringConfig.IStackMonitoringConfigDynamicGroups).FullName}[]; received {@value.GetType().FullName}", nameof(@value));
                }
            }
            InvokeInstanceVoidMethod(new System.Type[]{typeof(object)}, new object[]{@value});
        }

        [JsiiMethod(name: "putTimeouts", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"oci.stackMonitoringConfig.StackMonitoringConfigTimeouts\"}}]")]
        public virtual void PutTimeouts(oci.StackMonitoringConfig.IStackMonitoringConfigTimeouts @value)
        {
        ...
        public virtual void PutUserGroups(object @value)
        {
            if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
            {
                switch (@value)
                {
                    case Io.Cdktn.IResolvable cast_2ed7d7:
                        break;
                    case oci.StackMonitoringConfig.IStackMonitoringConfigUserGroups[] cast_2ed7d7:
                        break;
                    case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_2ed7d7:
                        // Not enough information to type-check...
                        break;
                    case null:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(oci.StackMonitoringConfig.IStackMonitoringConfigUserGroups).FullName}[]; received null", nameof(@value));
                    default:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(oci.StackMonitoringConfig.IStackMonitoringConfigUserGroups).FullName}[]; received {@value.GetType().FullName}", nameof(@value));
                }
            }
            InvokeInstanceVoidMethod(new System.Type[]{typeof(object)}, new object[]{@value});
        }

        [JsiiMethod(name: "resetAdditionalConfigurations")]
        public virtual void ResetAdditionalConfigurations()
        {
        ...
        [JsiiMethod(name: "resetDynamicGroups")]
        public virtual void ResetDynamicGroups()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        [JsiiMethod(name: "resetIsManuallyOnboarded")]
        public virtual void ResetIsManuallyOnboarded()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        = GetStaticProperty<string>(typeof(oci.StackMonitoringConfig.StackMonitoringConfig))!;

        [JsiiProperty(name: "additionalConfigurations", typeJson: "{\"fqn\":\"oci.stackMonitoringConfig.StackMonitoringConfigAdditionalConfigurationsOutputReference\"}")]
        public virtual oci.StackMonitoringConfig.StackMonitoringConfigAdditionalConfigurationsOutputReference AdditionalConfigurations
        {
            get => GetInstanceProperty<oci.StackMonitoringConfig.StackMonitoringConfigAdditionalConfigurationsOutputReference>()!;
        }

        [JsiiProperty(name: "dynamicGroups", typeJson: "{\"fqn\":\"oci.stackMonitoringConfig.StackMonitoringConfigDynamicGroupsList\"}")]
        public virtual oci.StackMonitoringConfig.StackMonitoringConfigDynamicGroupsList DynamicGroups
        {
            get => GetInstanceProperty<oci.StackMonitoringConfig.StackMonitoringConfigDynamicGroupsList>()!;
        }
        ...
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"oci.stackMonitoringConfig.StackMonitoringConfigTimeoutsOutputReference\"}")]
        public virtual oci.StackMonitoringConfig.StackMonitoringConfigTimeoutsOutputReference Timeouts
        {
            get => GetInstanceProperty<oci.StackMonitoringConfig.StackMonitoringConfigTimeoutsOutputReference>()!;
        }
        ...
        [JsiiProperty(name: "userGroups", typeJson: "{\"fqn\":\"oci.stackMonitoringConfig.StackMonitoringConfigUserGroupsList\"}")]
        public virtual oci.StackMonitoringConfig.StackMonitoringConfigUserGroupsList UserGroups
        {
            get => GetInstanceProperty<oci.StackMonitoringConfig.StackMonitoringConfigUserGroupsList>()!;
        }

        [JsiiOptional]
        [JsiiProperty(name: "additionalConfigurationsInput", typeJson: "{\"fqn\":\"oci.stackMonitoringConfig.StackMonitoringConfigAdditionalConfigurations\"}", isOptional: true)]
        public virtual oci.StackMonitoringConfig.IStackMonitoringConfigAdditionalConfigurations? AdditionalConfigurationsInput
        {
