...
namespace oci.DataOciDatabaseDatabases
{
    ...
    public class DataOciDatabaseDatabasesDatabasesDatabaseOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        [JsiiProperty(name: "autoFailoverConfiguration", typeJson: "{\"fqn\":\"oci.dataOciDatabaseDatabases.DataOciDatabaseDatabasesDatabasesDatabaseAutoFailoverConfigurationList\"}")]
        public virtual oci.DataOciDatabaseDatabases.DataOciDatabaseDatabasesDatabasesDatabaseAutoFailoverConfigurationList AutoFailoverConfiguration
        {
            get => GetInstanceProperty<oci.DataOciDatabaseDatabases.DataOciDatabaseDatabasesDatabasesDatabaseAutoFailoverConfigurationList>()!;
        }
        ...
        [JsiiProperty(name: "managedSoftwareUpdateDetails", typeJson: "{\"fqn\":\"oci.dataOciDatabaseDatabases.DataOciDatabaseDatabasesDatabasesDatabaseManagedSoftwareUpdateDetailsList\"}")]
        public virtual oci.DataOciDatabaseDatabases.DataOciDatabaseDatabasesDatabasesDatabaseManagedSoftwareUpdateDetailsList ManagedSoftwareUpdateDetails
        {
            get => GetInstanceProperty<oci.DataOciDatabaseDatabases.DataOciDatabaseDatabasesDatabasesDatabaseManagedSoftwareUpdateDetailsList>()!;
        }
        ...
        [JsiiProperty(name: "patchOptions", typeJson: "{\"fqn\":\"oci.dataOciDatabaseDatabases.DataOciDatabaseDatabasesDatabasesDatabasePatchOptionsList\"}")]
        public virtual oci.DataOciDatabaseDatabases.DataOciDatabaseDatabasesDatabasesDatabasePatchOptionsList PatchOptions
        {
            get => GetInstanceProperty<oci.DataOciDatabaseDatabases.DataOciDatabaseDatabasesDatabasesDatabasePatchOptionsList>()!;
        }
