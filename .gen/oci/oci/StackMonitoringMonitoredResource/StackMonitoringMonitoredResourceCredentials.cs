...
{
    [JsiiByValue(fqn: "oci.stackMonitoringMonitoredResource.StackMonitoringMonitoredResourceCredentials")]
    public class StackMonitoringMonitoredResourceCredentials : oci.StackMonitoringMonitoredResource.IStackMonitoringMonitoredResourceCredentials
    {
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        case Io.Cdktn.IResolvable cast_cd4240:
                            break;
                        case oci.StackMonitoringMonitoredResource.IStackMonitoringMonitoredResourceCredentialsProperties[] cast_cd4240:
                            break;
                        ...
                        case null:
                            break;
                        default:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(oci.StackMonitoringMonitoredResource.IStackMonitoringMonitoredResourceCredentialsProperties).FullName}[]; received {value.GetType().FullName}", nameof(value));
                    }
                }
                _properties = value;
            }
