...
namespace oci.WaaWebAppAccelerationPolicy
{
    ...
    public class WaaWebAppAccelerationPolicyResponseCompressionPolicy : oci.WaaWebAppAccelerationPolicy.IWaaWebAppAccelerationPolicyResponseCompressionPolicy
    {
        ...
        /// <remarks>
        /// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/8.22.0/docs/resources/waa_web_app_acceleration_policy#gzip_compression WaaWebAppAccelerationPolicy#gzip_compression}
        /// </remarks>
        [JsiiOptional]
