...
{
    [JsiiClass(nativeType: typeof(oci.DatascienceJob.DatascienceJobJobConfigurationDetailsStartupProbeDetailsOutputReference), fullyQualifiedName: "oci.datascienceJob.DatascienceJobJobConfigurationDetailsStartupProbeDetailsOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktn.IInterpolatingParent\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}}]")]
    public class DatascienceJobJobConfigurationDetailsStartupProbeDetailsOutputReference : Io.Cdktn.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        public DatascienceJobJobConfigurationDetailsStartupProbeDetailsOutputReference(Io.Cdktn.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
        ...
        protected DatascienceJobJobConfigurationDetailsStartupProbeDetailsOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected DatascienceJobJobConfigurationDetailsStartupProbeDetailsOutputReference(DeputyProps props): base(props)
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"oci.datascienceJob.DatascienceJobJobConfigurationDetailsStartupProbeDetails\"}", isOptional: true)]
        public virtual oci.DatascienceJob.IDatascienceJobJobConfigurationDetailsStartupProbeDetails? InternalValue
        {
