...
namespace oci.CoreClusterNetwork
{
    ...
    public class CoreClusterNetworkPlacementConfigurationPrimaryVnicSubnetsOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        /// <param name="value">Type union: either <see cref="Io.Cdktn.IResolvable" /> or (<see cref="oci.CoreClusterNetwork.ICoreClusterNetworkPlacementConfigurationPrimaryVnicSubnetsIpv6AddressIpv6SubnetCidrPairDetails" />)[]</param>
