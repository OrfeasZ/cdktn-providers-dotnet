...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/oracle/oci/8.28.0/docs/resources/database_maintenance_run oci_database_maintenance_run}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/oracle/oci/8.28.0/docs/resources/database_maintenance_run oci_database_maintenance_run} Resource.</summary>
        ...
        [JsiiProperty(name: "windowTypeDescriptions", typeJson: "{\"fqn\":\"oci.databaseMaintenanceRun.DatabaseMaintenanceRunWindowTypeDescriptionsList\"}")]
        public virtual oci.DatabaseMaintenanceRun.DatabaseMaintenanceRunWindowTypeDescriptionsList WindowTypeDescriptions
        {
            get => GetInstanceProperty<oci.DatabaseMaintenanceRun.DatabaseMaintenanceRunWindowTypeDescriptionsList>()!;
        }
