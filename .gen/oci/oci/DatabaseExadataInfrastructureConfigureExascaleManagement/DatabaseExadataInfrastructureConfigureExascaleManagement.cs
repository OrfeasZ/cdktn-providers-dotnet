...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/oracle/oci/8.26.0/docs/resources/database_exadata_infrastructure_configure_exascale_management oci_database_exadata_infrastructure_configure_exascale_management}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/oracle/oci/8.26.0/docs/resources/database_exadata_infrastructure_configure_exascale_management oci_database_exadata_infrastructure_configure_exascale_management} Resource.</summary>
        ...
        private static DeputyProps _MakeDeputyProps(Constructs.Construct scope, string id, oci.DatabaseExadataInfrastructureConfigureExascaleManagement.IDatabaseExadataInfrastructureConfigureExascaleManagementConfig config)
        {
        ...
        protected DatabaseExadataInfrastructureConfigureExascaleManagement(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected DatabaseExadataInfrastructureConfigureExascaleManagement(DeputyProps props): base(props)
        {
        }

        /// <summary>Generates CDKTN code for importing a DatabaseExadataInfrastructureConfigureExascaleManagement resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        ...
        [JsiiMethod(name: "putTimeouts", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"oci.databaseExadataInfrastructureConfigureExascaleManagement.DatabaseExadataInfrastructureConfigureExascaleManagementTimeouts\"}}]")]
        public virtual void PutTimeouts(oci.DatabaseExadataInfrastructureConfigureExascaleManagement.IDatabaseExadataInfrastructureConfigureExascaleManagementTimeouts @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(oci.DatabaseExadataInfrastructureConfigureExascaleManagement.IDatabaseExadataInfrastructureConfigureExascaleManagementTimeouts)}, new object[]{@value});
        }
        ...
        = GetStaticProperty<string>(typeof(oci.DatabaseExadataInfrastructureConfigureExascaleManagement.DatabaseExadataInfrastructureConfigureExascaleManagement))!;
        ...
        [JsiiProperty(name: "contacts", typeJson: "{\"fqn\":\"oci.databaseExadataInfrastructureConfigureExascaleManagement.DatabaseExadataInfrastructureConfigureExascaleManagementContactsList\"}")]
        public virtual oci.DatabaseExadataInfrastructureConfigureExascaleManagement.DatabaseExadataInfrastructureConfigureExascaleManagementContactsList Contacts
        {
            get => GetInstanceProperty<oci.DatabaseExadataInfrastructureConfigureExascaleManagement.DatabaseExadataInfrastructureConfigureExascaleManagementContactsList>()!;
        }
        ...
        [JsiiProperty(name: "definedFileSystemConfigurations", typeJson: "{\"fqn\":\"oci.databaseExadataInfrastructureConfigureExascaleManagement.DatabaseExadataInfrastructureConfigureExascaleManagementDefinedFileSystemConfigurationsList\"}")]
        public virtual oci.DatabaseExadataInfrastructureConfigureExascaleManagement.DatabaseExadataInfrastructureConfigureExascaleManagementDefinedFileSystemConfigurationsList DefinedFileSystemConfigurations
        {
            get => GetInstanceProperty<oci.DatabaseExadataInfrastructureConfigureExascaleManagement.DatabaseExadataInfrastructureConfigureExascaleManagementDefinedFileSystemConfigurationsList>()!;
        }
        ...
        [JsiiProperty(name: "exascaleConfig", typeJson: "{\"fqn\":\"oci.databaseExadataInfrastructureConfigureExascaleManagement.DatabaseExadataInfrastructureConfigureExascaleManagementExascaleConfigList\"}")]
        public virtual oci.DatabaseExadataInfrastructureConfigureExascaleManagement.DatabaseExadataInfrastructureConfigureExascaleManagementExascaleConfigList ExascaleConfig
        {
            get => GetInstanceProperty<oci.DatabaseExadataInfrastructureConfigureExascaleManagement.DatabaseExadataInfrastructureConfigureExascaleManagementExascaleConfigList>()!;
        }
        ...
        [JsiiProperty(name: "maintenanceWindow", typeJson: "{\"fqn\":\"oci.databaseExadataInfrastructureConfigureExascaleManagement.DatabaseExadataInfrastructureConfigureExascaleManagementMaintenanceWindowList\"}")]
        public virtual oci.DatabaseExadataInfrastructureConfigureExascaleManagement.DatabaseExadataInfrastructureConfigureExascaleManagementMaintenanceWindowList MaintenanceWindow
        {
            get => GetInstanceProperty<oci.DatabaseExadataInfrastructureConfigureExascaleManagement.DatabaseExadataInfrastructureConfigureExascaleManagementMaintenanceWindowList>()!;
        }
        ...
        [JsiiProperty(name: "networkBondingModeDetails", typeJson: "{\"fqn\":\"oci.databaseExadataInfrastructureConfigureExascaleManagement.DatabaseExadataInfrastructureConfigureExascaleManagementNetworkBondingModeDetailsList\"}")]
        public virtual oci.DatabaseExadataInfrastructureConfigureExascaleManagement.DatabaseExadataInfrastructureConfigureExascaleManagementNetworkBondingModeDetailsList NetworkBondingModeDetails
        {
            get => GetInstanceProperty<oci.DatabaseExadataInfrastructureConfigureExascaleManagement.DatabaseExadataInfrastructureConfigureExascaleManagementNetworkBondingModeDetailsList>()!;
        }
        ...
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"oci.databaseExadataInfrastructureConfigureExascaleManagement.DatabaseExadataInfrastructureConfigureExascaleManagementTimeoutsOutputReference\"}")]
        public virtual oci.DatabaseExadataInfrastructureConfigureExascaleManagement.DatabaseExadataInfrastructureConfigureExascaleManagementTimeoutsOutputReference Timeouts
        {
            get => GetInstanceProperty<oci.DatabaseExadataInfrastructureConfigureExascaleManagement.DatabaseExadataInfrastructureConfigureExascaleManagementTimeoutsOutputReference>()!;
        }
