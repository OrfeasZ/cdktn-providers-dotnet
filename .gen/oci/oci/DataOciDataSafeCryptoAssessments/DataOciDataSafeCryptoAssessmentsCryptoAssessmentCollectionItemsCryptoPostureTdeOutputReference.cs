...
namespace oci.DataOciDataSafeCryptoAssessments
{
    ...
    public class DataOciDataSafeCryptoAssessmentsCryptoAssessmentCollectionItemsCryptoPostureTdeOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        protected DataOciDataSafeCryptoAssessmentsCryptoAssessmentCollectionItemsCryptoPostureTdeOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected DataOciDataSafeCryptoAssessmentsCryptoAssessmentCollectionItemsCryptoPostureTdeOutputReference(DeputyProps props): base(props)
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"oci.dataOciDataSafeCryptoAssessments.DataOciDataSafeCryptoAssessmentsCryptoAssessmentCollectionItemsCryptoPostureTde\"}", isOptional: true)]
        public virtual oci.DataOciDataSafeCryptoAssessments.IDataOciDataSafeCryptoAssessmentsCryptoAssessmentCollectionItemsCryptoPostureTde? InternalValue
        {
            get => GetInstanceProperty<oci.DataOciDataSafeCryptoAssessments.IDataOciDataSafeCryptoAssessmentsCryptoAssessmentCollectionItemsCryptoPostureTde?>();
