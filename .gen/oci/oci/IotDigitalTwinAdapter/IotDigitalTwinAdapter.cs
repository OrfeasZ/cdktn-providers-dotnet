...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/oracle/oci/8.22.0/docs/resources/iot_digital_twin_adapter oci_iot_digital_twin_adapter}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/oracle/oci/8.22.0/docs/resources/iot_digital_twin_adapter oci_iot_digital_twin_adapter} Resource.</summary>
        ...
        private static DeputyProps _MakeDeputyProps(Constructs.Construct scope, string id, oci.IotDigitalTwinAdapter.IIotDigitalTwinAdapterConfig config)
        {
        ...
        protected IotDigitalTwinAdapter(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected IotDigitalTwinAdapter(DeputyProps props): base(props)
        {
        }

        /// <summary>Generates CDKTN code for importing a IotDigitalTwinAdapter resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        ...
        [JsiiMethod(name: "putInboundEnvelope", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"oci.iotDigitalTwinAdapter.IotDigitalTwinAdapterInboundEnvelope\"}}]")]
        public virtual void PutInboundEnvelope(oci.IotDigitalTwinAdapter.IIotDigitalTwinAdapterInboundEnvelope @value)
        {
            ...
            if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
            {
                switch (@value)
                {
                    case Io.Cdktn.IResolvable cast_2ed7d7:
                        break;
                    case oci.IotDigitalTwinAdapter.IIotDigitalTwinAdapterInboundRoutes[] cast_2ed7d7:
                        break;
                    case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_2ed7d7:
                        // Not enough information to type-check...
                        break;
                    case null:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(oci.IotDigitalTwinAdapter.IIotDigitalTwinAdapterInboundRoutes).FullName}[]; received null", nameof(@value));
                    default:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(oci.IotDigitalTwinAdapter.IIotDigitalTwinAdapterInboundRoutes).FullName}[]; received {@value.GetType().FullName}", nameof(@value));
                }
            }
            InvokeInstanceVoidMethod(new System.Type[]{typeof(object)}, new object[]{@value});
        }

        [JsiiMethod(name: "putTimeouts", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"oci.iotDigitalTwinAdapter.IotDigitalTwinAdapterTimeouts\"}}]")]
        public virtual void PutTimeouts(oci.IotDigitalTwinAdapter.IIotDigitalTwinAdapterTimeouts @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(oci.IotDigitalTwinAdapter.IIotDigitalTwinAdapterTimeouts)}, new object[]{@value});
        }
        ...
        [JsiiMethod(name: "resetInboundEnvelope")]
        public virtual void ResetInboundEnvelope()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }

        [JsiiMethod(name: "resetInboundRoutes")]
        public virtual void ResetInboundRoutes()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        = GetStaticProperty<string>(typeof(oci.IotDigitalTwinAdapter.IotDigitalTwinAdapter))!;

        [JsiiProperty(name: "inboundEnvelope", typeJson: "{\"fqn\":\"oci.iotDigitalTwinAdapter.IotDigitalTwinAdapterInboundEnvelopeOutputReference\"}")]
        public virtual oci.IotDigitalTwinAdapter.IotDigitalTwinAdapterInboundEnvelopeOutputReference InboundEnvelope
        {
            get => GetInstanceProperty<oci.IotDigitalTwinAdapter.IotDigitalTwinAdapterInboundEnvelopeOutputReference>()!;
        }

        [JsiiProperty(name: "inboundRoutes", typeJson: "{\"fqn\":\"oci.iotDigitalTwinAdapter.IotDigitalTwinAdapterInboundRoutesList\"}")]
        public virtual oci.IotDigitalTwinAdapter.IotDigitalTwinAdapterInboundRoutesList InboundRoutes
        {
            get => GetInstanceProperty<oci.IotDigitalTwinAdapter.IotDigitalTwinAdapterInboundRoutesList>()!;
        }
        ...
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"oci.iotDigitalTwinAdapter.IotDigitalTwinAdapterTimeoutsOutputReference\"}")]
        public virtual oci.IotDigitalTwinAdapter.IotDigitalTwinAdapterTimeoutsOutputReference Timeouts
        {
            get => GetInstanceProperty<oci.IotDigitalTwinAdapter.IotDigitalTwinAdapterTimeoutsOutputReference>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "inboundEnvelopeInput", typeJson: "{\"fqn\":\"oci.iotDigitalTwinAdapter.IotDigitalTwinAdapterInboundEnvelope\"}", isOptional: true)]
        public virtual oci.IotDigitalTwinAdapter.IIotDigitalTwinAdapterInboundEnvelope? InboundEnvelopeInput
        {
