...
{
    [JsiiInterface(nativeType: typeof(IJmsFleetAgentConfigurationMacOsConfiguration), fullyQualifiedName: "oci.jmsFleetAgentConfiguration.JmsFleetAgentConfigurationMacOsConfiguration")]
    public interface IJmsFleetAgentConfigurationMacOsConfiguration
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IJmsFleetAgentConfigurationMacOsConfiguration), fullyQualifiedName: "oci.jmsFleetAgentConfiguration.JmsFleetAgentConfigurationMacOsConfiguration")]
        internal sealed class _Proxy : DeputyBase, oci.JmsFleetAgentConfiguration.IJmsFleetAgentConfigurationMacOsConfiguration
        {
