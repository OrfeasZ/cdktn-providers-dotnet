...
namespace oci.DataOciMysqlMysqlBackup
{
    ...
    public class DataOciMysqlMysqlBackupDbSystemSnapshotReadEndpointOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        protected DataOciMysqlMysqlBackupDbSystemSnapshotReadEndpointOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected DataOciMysqlMysqlBackupDbSystemSnapshotReadEndpointOutputReference(DeputyProps props): base(props)
        {
        }
        ...
        {
            get => GetInstanceProperty<oci.DataOciMysqlMysqlBackup.IDataOciMysqlMysqlBackupDbSystemSnapshotReadEndpoint?>();
