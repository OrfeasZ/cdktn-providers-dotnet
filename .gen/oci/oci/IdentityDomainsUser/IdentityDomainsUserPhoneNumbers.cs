...
namespace oci.IdentityDomainsUser
{
    ...
    [JsiiByValue(fqn: "oci.identityDomainsUser.IdentityDomainsUserPhoneNumbers")]
    public class IdentityDomainsUserPhoneNumbers : oci.IdentityDomainsUser.IIdentityDomainsUserPhoneNumbers
    {
