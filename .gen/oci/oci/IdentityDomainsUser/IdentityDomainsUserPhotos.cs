...
namespace oci.IdentityDomainsUser
{
    ...
    [JsiiByValue(fqn: "oci.identityDomainsUser.IdentityDomainsUserPhotos")]
    public class IdentityDomainsUserPhotos : oci.IdentityDomainsUser.IIdentityDomainsUserPhotos
    {
