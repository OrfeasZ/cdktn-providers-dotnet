...
namespace oci.IdentityDomainsUser
{
    ...
    [JsiiByValue(fqn: "oci.identityDomainsUser.IdentityDomainsUserRoles")]
    public class IdentityDomainsUserRoles : oci.IdentityDomainsUser.IIdentityDomainsUserRoles
    {
