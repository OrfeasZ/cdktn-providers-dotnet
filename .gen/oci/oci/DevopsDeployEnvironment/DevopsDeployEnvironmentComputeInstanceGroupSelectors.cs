...
{
    [JsiiByValue(fqn: "oci.devopsDeployEnvironment.DevopsDeployEnvironmentComputeInstanceGroupSelectors")]
    public class DevopsDeployEnvironmentComputeInstanceGroupSelectors : oci.DevopsDeployEnvironment.IDevopsDeployEnvironmentComputeInstanceGroupSelectors
    {
        private object? _items;

        /// <summary>items block.</summary>
        /// <remarks>
        /// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/8.27.0/docs/resources/devops_deploy_environment#items DevopsDeployEnvironment#items}
