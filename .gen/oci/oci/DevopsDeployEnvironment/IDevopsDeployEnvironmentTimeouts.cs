...
{
    [JsiiInterface(nativeType: typeof(IDevopsDeployEnvironmentTimeouts), fullyQualifiedName: "oci.devopsDeployEnvironment.DevopsDeployEnvironmentTimeouts")]
    public interface IDevopsDeployEnvironmentTimeouts
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDevopsDeployEnvironmentTimeouts), fullyQualifiedName: "oci.devopsDeployEnvironment.DevopsDeployEnvironmentTimeouts")]
        internal sealed class _Proxy : DeputyBase, oci.DevopsDeployEnvironment.IDevopsDeployEnvironmentTimeouts
        {
