...
namespace oci.DataOciCoreDhcpOptions
{
    ...
    [JsiiByValue(fqn: "oci.dataOciCoreDhcpOptions.DataOciCoreDhcpOptionsFilter")]
    public class DataOciCoreDhcpOptionsFilter : oci.DataOciCoreDhcpOptions.IDataOciCoreDhcpOptionsFilter
    {
