...
namespace oci.DataOciBdsBdsCapacityReservation
{
    ...
    public interface IDataOciBdsBdsCapacityReservationConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataOciBdsBdsCapacityReservationConfig), fullyQualifiedName: "oci.dataOciBdsBdsCapacityReservation.DataOciBdsBdsCapacityReservationConfig")]
        internal sealed class _Proxy : DeputyBase, oci.DataOciBdsBdsCapacityReservation.IDataOciBdsBdsCapacityReservationConfig
        {
