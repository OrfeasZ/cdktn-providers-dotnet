...
namespace oci.DataOciDataSafeCryptoAssessmentTdeObjects
{
    ...
    public interface IDataOciDataSafeCryptoAssessmentTdeObjectsFilter
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataOciDataSafeCryptoAssessmentTdeObjectsFilter), fullyQualifiedName: "oci.dataOciDataSafeCryptoAssessmentTdeObjects.DataOciDataSafeCryptoAssessmentTdeObjectsFilter")]
        internal sealed class _Proxy : DeputyBase, oci.DataOciDataSafeCryptoAssessmentTdeObjects.IDataOciDataSafeCryptoAssessmentTdeObjectsFilter
        {
