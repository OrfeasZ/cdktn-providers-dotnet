...
{
    [JsiiByValue(fqn: "oci.cloudGuardSavedQuery.CloudGuardSavedQueryTimeouts")]
    public class CloudGuardSavedQueryTimeouts : oci.CloudGuardSavedQuery.ICloudGuardSavedQueryTimeouts
    {
