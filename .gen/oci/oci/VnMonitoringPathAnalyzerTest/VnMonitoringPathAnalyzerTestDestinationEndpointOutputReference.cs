...
namespace oci.VnMonitoringPathAnalyzerTest
{
    ...
    public class VnMonitoringPathAnalyzerTestDestinationEndpointOutputReference : Io.Cdktn.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        public VnMonitoringPathAnalyzerTestDestinationEndpointOutputReference(Io.Cdktn.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
        ...
        protected VnMonitoringPathAnalyzerTestDestinationEndpointOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected VnMonitoringPathAnalyzerTestDestinationEndpointOutputReference(DeputyProps props): base(props)
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"oci.vnMonitoringPathAnalyzerTest.VnMonitoringPathAnalyzerTestDestinationEndpoint\"}", isOptional: true)]
        public virtual oci.VnMonitoringPathAnalyzerTest.IVnMonitoringPathAnalyzerTestDestinationEndpoint? InternalValue
        {
