...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/oracle/oci/8.28.0/docs/resources/database_cloud_vm_cluster oci_database_cloud_vm_cluster}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/oracle/oci/8.28.0/docs/resources/database_cloud_vm_cluster oci_database_cloud_vm_cluster} Resource.</summary>
        ...
        [JsiiMethod(name: "putUpdateDetails", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"oci.databaseCloudVmCluster.DatabaseCloudVmClusterUpdateDetails\"}}]")]
        public virtual void PutUpdateDetails(oci.DatabaseCloudVmCluster.IDatabaseCloudVmClusterUpdateDetails @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(oci.DatabaseCloudVmCluster.IDatabaseCloudVmClusterUpdateDetails)}, new object[]{@value});
        }
        ...
        [JsiiProperty(name: "liveImageVersionDetails", typeJson: "{\"fqn\":\"oci.databaseCloudVmCluster.DatabaseCloudVmClusterLiveImageVersionDetailsList\"}")]
        public virtual oci.DatabaseCloudVmCluster.DatabaseCloudVmClusterLiveImageVersionDetailsList LiveImageVersionDetails
        {
            get => GetInstanceProperty<oci.DatabaseCloudVmCluster.DatabaseCloudVmClusterLiveImageVersionDetailsList>()!;
        }
        ...
        [JsiiProperty(name: "updateDetails", typeJson: "{\"fqn\":\"oci.databaseCloudVmCluster.DatabaseCloudVmClusterUpdateDetailsOutputReference\"}")]
        public virtual oci.DatabaseCloudVmCluster.DatabaseCloudVmClusterUpdateDetailsOutputReference UpdateDetails
        {
            get => GetInstanceProperty<oci.DatabaseCloudVmCluster.DatabaseCloudVmClusterUpdateDetailsOutputReference>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "updateDetailsInput", typeJson: "{\"fqn\":\"oci.databaseCloudVmCluster.DatabaseCloudVmClusterUpdateDetails\"}", isOptional: true)]
        public virtual oci.DatabaseCloudVmCluster.IDatabaseCloudVmClusterUpdateDetails? UpdateDetailsInput
        {
