...
namespace oci.DataSafeAuditPolicy
{
    ...
    [JsiiByValue(fqn: "oci.dataSafeAuditPolicy.DataSafeAuditPolicyConfig")]
    public class DataSafeAuditPolicyConfig : oci.DataSafeAuditPolicy.IDataSafeAuditPolicyConfig
    {
