...
namespace oci.DatascienceModelGroup
{
    ...
    public class DatascienceModelGroupModelGroupDetailsOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        /// <param name="value">Type union: either <see cref="Io.Cdktn.IResolvable" /> or (<see cref="oci.DatascienceModelGroup.IDatascienceModelGroupModelGroupDetailsCustomMetadataListStruct" />)[]</param>
