...
namespace oci.DatascienceModelGroup
{
    ...
    [JsiiByValue(fqn: "oci.datascienceModelGroup.DatascienceModelGroupConfig")]
    public class DatascienceModelGroupConfig : oci.DatascienceModelGroup.IDatascienceModelGroupConfig
    {
