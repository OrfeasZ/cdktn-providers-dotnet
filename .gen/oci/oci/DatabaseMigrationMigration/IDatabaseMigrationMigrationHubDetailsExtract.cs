...
{
    [JsiiInterface(nativeType: typeof(IDatabaseMigrationMigrationHubDetailsExtract), fullyQualifiedName: "oci.databaseMigrationMigration.DatabaseMigrationMigrationHubDetailsExtract")]
    public interface IDatabaseMigrationMigrationHubDetailsExtract
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDatabaseMigrationMigrationHubDetailsExtract), fullyQualifiedName: "oci.databaseMigrationMigration.DatabaseMigrationMigrationHubDetailsExtract")]
        internal sealed class _Proxy : DeputyBase, oci.DatabaseMigrationMigration.IDatabaseMigrationMigrationHubDetailsExtract
        {
