...
{
    [JsiiInterface(nativeType: typeof(IStackMonitoringProcessSetTimeouts), fullyQualifiedName: "oci.stackMonitoringProcessSet.StackMonitoringProcessSetTimeouts")]
    public interface IStackMonitoringProcessSetTimeouts
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IStackMonitoringProcessSetTimeouts), fullyQualifiedName: "oci.stackMonitoringProcessSet.StackMonitoringProcessSetTimeouts")]
        internal sealed class _Proxy : DeputyBase, oci.StackMonitoringProcessSet.IStackMonitoringProcessSetTimeouts
        {
