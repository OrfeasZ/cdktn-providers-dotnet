...
namespace oci.DataOciCoreIpsecConnectionTunnel
{
    ...
    public class DataOciCoreIpsecConnectionTunnelPhaseOneDetailsOutputReference : Io.Cdktn.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        /// <param name="complexObjectIndex">the index of this item in the list.</param>
        /// <param name="complexObjectIsFromSet">whether the list is wrapping a set (will add tolist() to be able to access an item via an index).</param>
        public DataOciCoreIpsecConnectionTunnelPhaseOneDetailsOutputReference(Io.Cdktn.IInterpolatingParent terraformResource, string terraformAttribute, double complexObjectIndex, bool complexObjectIsFromSet): base(_MakeDeputyProps(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet))
        {
        }
        ...
        protected DataOciCoreIpsecConnectionTunnelPhaseOneDetailsOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected DataOciCoreIpsecConnectionTunnelPhaseOneDetailsOutputReference(DeputyProps props): base(props)
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"oci.dataOciCoreIpsecConnectionTunnel.DataOciCoreIpsecConnectionTunnelPhaseOneDetails\"}", isOptional: true)]
        public virtual oci.DataOciCoreIpsecConnectionTunnel.IDataOciCoreIpsecConnectionTunnelPhaseOneDetails? InternalValue
        {
            get => GetInstanceProperty<oci.DataOciCoreIpsecConnectionTunnel.IDataOciCoreIpsecConnectionTunnelPhaseOneDetails?>();
