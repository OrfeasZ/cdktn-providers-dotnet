...
{
    [JsiiInterface(nativeType: typeof(IDatascienceNotebookSessionTimeouts), fullyQualifiedName: "oci.datascienceNotebookSession.DatascienceNotebookSessionTimeouts")]
    public interface IDatascienceNotebookSessionTimeouts
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDatascienceNotebookSessionTimeouts), fullyQualifiedName: "oci.datascienceNotebookSession.DatascienceNotebookSessionTimeouts")]
        internal sealed class _Proxy : DeputyBase, oci.DatascienceNotebookSession.IDatascienceNotebookSessionTimeouts
        {
