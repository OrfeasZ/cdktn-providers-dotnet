...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/oracle/oci/8.29.0/docs/resources/managed_kafka_kafka_cluster oci_managed_kafka_kafka_cluster}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/oracle/oci/8.29.0/docs/resources/managed_kafka_kafka_cluster oci_managed_kafka_kafka_cluster} Resource.</summary>
        ...
        /// <param name="value">Type union: either <see cref="Io.Cdktn.IResolvable" /> or (<see cref="oci.ManagedKafkaKafkaCluster.IManagedKafkaKafkaClusterAccessSubnets" />)[]</param>
