...
{
    [JsiiClass(nativeType: typeof(oci.DatabaseDbSystem.DatabaseDbSystemMaintenanceWindowDetailsOutputReference), fullyQualifiedName: "oci.databaseDbSystem.DatabaseDbSystemMaintenanceWindowDetailsOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktn.IInterpolatingParent\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}}]")]
    public class DatabaseDbSystemMaintenanceWindowDetailsOutputReference : Io.Cdktn.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        public DatabaseDbSystemMaintenanceWindowDetailsOutputReference(Io.Cdktn.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
        ...
        protected DatabaseDbSystemMaintenanceWindowDetailsOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected DatabaseDbSystemMaintenanceWindowDetailsOutputReference(DeputyProps props): base(props)
        {
        }
            ...
            if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
            {
                switch (@value)
                {
                    case Io.Cdktn.IResolvable cast_2ed7d7:
                        break;
                    case oci.DatabaseDbSystem.IDatabaseDbSystemMaintenanceWindowDetailsDaysOfWeek[] cast_2ed7d7:
                        break;
                    case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_2ed7d7:
                        // Not enough information to type-check...
                        break;
                    case null:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(oci.DatabaseDbSystem.IDatabaseDbSystemMaintenanceWindowDetailsDaysOfWeek).FullName}[]; received null", nameof(@value));
                    default:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(oci.DatabaseDbSystem.IDatabaseDbSystemMaintenanceWindowDetailsDaysOfWeek).FullName}[]; received {@value.GetType().FullName}", nameof(@value));
                }
            }
        ...
        public virtual void PutMonths(object @value)
        {
            if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
            {
                switch (@value)
                {
                    case Io.Cdktn.IResolvable cast_2ed7d7:
                        break;
                    case oci.DatabaseDbSystem.IDatabaseDbSystemMaintenanceWindowDetailsMonths[] cast_2ed7d7:
                        break;
                    case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_2ed7d7:
                        // Not enough information to type-check...
                        break;
                    case null:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(oci.DatabaseDbSystem.IDatabaseDbSystemMaintenanceWindowDetailsMonths).FullName}[]; received null", nameof(@value));
                    default:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(oci.DatabaseDbSystem.IDatabaseDbSystemMaintenanceWindowDetailsMonths).FullName}[]; received {@value.GetType().FullName}", nameof(@value));
                }
            }
            InvokeInstanceVoidMethod(new System.Type[]{typeof(object)}, new object[]{@value});
        }
        ...
        [JsiiProperty(name: "daysOfWeek", typeJson: "{\"fqn\":\"oci.databaseDbSystem.DatabaseDbSystemMaintenanceWindowDetailsDaysOfWeekList\"}")]
        public virtual oci.DatabaseDbSystem.DatabaseDbSystemMaintenanceWindowDetailsDaysOfWeekList DaysOfWeek
        {
            get => GetInstanceProperty<oci.DatabaseDbSystem.DatabaseDbSystemMaintenanceWindowDetailsDaysOfWeekList>()!;
        }

        [JsiiProperty(name: "months", typeJson: "{\"fqn\":\"oci.databaseDbSystem.DatabaseDbSystemMaintenanceWindowDetailsMonthsList\"}")]
        public virtual oci.DatabaseDbSystem.DatabaseDbSystemMaintenanceWindowDetailsMonthsList Months
        {
            get => GetInstanceProperty<oci.DatabaseDbSystem.DatabaseDbSystemMaintenanceWindowDetailsMonthsList>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"oci.databaseDbSystem.DatabaseDbSystemMaintenanceWindowDetails\"}", isOptional: true)]
        public virtual oci.DatabaseDbSystem.IDatabaseDbSystemMaintenanceWindowDetails? InternalValue
        {
