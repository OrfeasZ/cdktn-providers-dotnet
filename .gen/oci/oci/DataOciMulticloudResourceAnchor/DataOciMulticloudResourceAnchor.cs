...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/oracle/oci/8.24.0/docs/data-sources/multicloud_resource_anchor oci_multicloud_resource_anchor}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/oracle/oci/8.24.0/docs/data-sources/multicloud_resource_anchor oci_multicloud_resource_anchor} Data Source.</summary>
        ...
        [JsiiMethod(name: "resetShouldFetchCompartmentName")]
        public virtual void ResetShouldFetchCompartmentName()
        {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "shouldFetchCompartmentNameInput", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktn.IResolvable\"}]}}", isOptional: true)]
        public virtual object? ShouldFetchCompartmentNameInput
        {
        ...
        /// <para>Type union: either bool or <see cref="Io.Cdktn.IResolvable" /></para>
        /// </remarks>
        [JsiiProperty(name: "shouldFetchCompartmentName", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktn.IResolvable\"}]}}")]
        public virtual object ShouldFetchCompartmentName
        {
            get => GetInstanceProperty<object>()!;
            set
            {
