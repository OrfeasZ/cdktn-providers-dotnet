...
namespace oci.DatabaseDbHome
{
    ...
    public class DatabaseDbHomeDatabaseDbBackupConfigOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        /// <param name="value">Type union: either <see cref="Io.Cdktn.IResolvable" /> or (<see cref="oci.DatabaseDbHome.IDatabaseDbHomeDatabaseDbBackupConfigBackupDestinationDetails" />)[]</param>
