...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/oracle/oci/8.23.0/docs/data-sources/database_vm_cluster_recommended_network oci_database_vm_cluster_recommended_network}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/oracle/oci/8.23.0/docs/data-sources/database_vm_cluster_recommended_network oci_database_vm_cluster_recommended_network} Data Source.</summary>
        ...
        /// <param name="value">Type union: either <see cref="Io.Cdktn.IResolvable" /> or (<see cref="oci.DataOciDatabaseVmClusterRecommendedNetwork.IDataOciDatabaseVmClusterRecommendedNetworkNetworks" />)[]</param>
        ...
        [JsiiMethod(name: "resetDrScanListenerPortTcpSsl")]
        public virtual void ResetDrScanListenerPortTcpSsl()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "drScanListenerPortTcpSslInput", typeJson: "{\"primitive\":\"number\"}", isOptional: true)]
        public virtual double? DrScanListenerPortTcpSslInput
        {
            get => GetInstanceProperty<double?>();
        }
        ...
        [JsiiProperty(name: "drScanListenerPortTcpSsl", typeJson: "{\"primitive\":\"number\"}")]
        public virtual double DrScanListenerPortTcpSsl
        {
            get => GetInstanceProperty<double>()!;
            set => SetInstanceProperty(value);
        }
