...
{
    [JsiiInterface(nativeType: typeof(IDatabasePluggableDatabaseTimeouts), fullyQualifiedName: "oci.databasePluggableDatabase.DatabasePluggableDatabaseTimeouts")]
    public interface IDatabasePluggableDatabaseTimeouts
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDatabasePluggableDatabaseTimeouts), fullyQualifiedName: "oci.databasePluggableDatabase.DatabasePluggableDatabaseTimeouts")]
        internal sealed class _Proxy : DeputyBase, oci.DatabasePluggableDatabase.IDatabasePluggableDatabaseTimeouts
        {
