...
{
    [JsiiClass(nativeType: typeof(oci.DataOciCloudBridgeAsset.DataOciCloudBridgeAssetAwsEc2OutputReference), fullyQualifiedName: "oci.dataOciCloudBridgeAsset.DataOciCloudBridgeAssetAwsEc2OutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktn.IInterpolatingParent\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"the index of this item in the list.\"},\"name\":\"complexObjectIndex\",\"type\":{\"primitive\":\"number\"}},{\"docs\":{\"summary\":\"whether the list is wrapping a set (will add tolist() to be able to access an item via an index).\"},\"name\":\"complexObjectIsFromSet\",\"type\":{\"primitive\":\"boolean\"}}]")]
    public class DataOciCloudBridgeAssetAwsEc2OutputReference : Io.Cdktn.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        /// <param name="complexObjectIndex">the index of this item in the list.</param>
        /// <param name="complexObjectIsFromSet">whether the list is wrapping a set (will add tolist() to be able to access an item via an index).</param>
        public DataOciCloudBridgeAssetAwsEc2OutputReference(Io.Cdktn.IInterpolatingParent terraformResource, string terraformAttribute, double complexObjectIndex, bool complexObjectIsFromSet): base(_MakeDeputyProps(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet))
        {
        }
        ...
        protected DataOciCloudBridgeAssetAwsEc2OutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected DataOciCloudBridgeAssetAwsEc2OutputReference(DeputyProps props): base(props)
        {
        }
        ...
        [JsiiProperty(name: "networkInterfaces", typeJson: "{\"fqn\":\"oci.dataOciCloudBridgeAsset.DataOciCloudBridgeAssetAwsEc2NetworkInterfacesList\"}")]
        public virtual oci.DataOciCloudBridgeAsset.DataOciCloudBridgeAssetAwsEc2NetworkInterfacesList NetworkInterfaces
        {
            get => GetInstanceProperty<oci.DataOciCloudBridgeAsset.DataOciCloudBridgeAssetAwsEc2NetworkInterfacesList>()!;
        }

        [JsiiProperty(name: "placement", typeJson: "{\"fqn\":\"oci.dataOciCloudBridgeAsset.DataOciCloudBridgeAssetAwsEc2PlacementList\"}")]
        public virtual oci.DataOciCloudBridgeAsset.DataOciCloudBridgeAssetAwsEc2PlacementList Placement
        {
            get => GetInstanceProperty<oci.DataOciCloudBridgeAsset.DataOciCloudBridgeAssetAwsEc2PlacementList>()!;
        }
        ...
        [JsiiProperty(name: "securityGroups", typeJson: "{\"fqn\":\"oci.dataOciCloudBridgeAsset.DataOciCloudBridgeAssetAwsEc2SecurityGroupsList\"}")]
        public virtual oci.DataOciCloudBridgeAsset.DataOciCloudBridgeAssetAwsEc2SecurityGroupsList SecurityGroups
        {
            get => GetInstanceProperty<oci.DataOciCloudBridgeAsset.DataOciCloudBridgeAssetAwsEc2SecurityGroupsList>()!;
        }
        ...
        [JsiiProperty(name: "state", typeJson: "{\"fqn\":\"oci.dataOciCloudBridgeAsset.DataOciCloudBridgeAssetAwsEc2StateList\"}")]
        public virtual oci.DataOciCloudBridgeAsset.DataOciCloudBridgeAssetAwsEc2StateList State
        {
            get => GetInstanceProperty<oci.DataOciCloudBridgeAsset.DataOciCloudBridgeAssetAwsEc2StateList>()!;
        }
        ...
        [JsiiProperty(name: "tags", typeJson: "{\"fqn\":\"oci.dataOciCloudBridgeAsset.DataOciCloudBridgeAssetAwsEc2TagsList\"}")]
        public virtual oci.DataOciCloudBridgeAsset.DataOciCloudBridgeAssetAwsEc2TagsList Tags
        {
            get => GetInstanceProperty<oci.DataOciCloudBridgeAsset.DataOciCloudBridgeAssetAwsEc2TagsList>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"oci.dataOciCloudBridgeAsset.DataOciCloudBridgeAssetAwsEc2\"}", isOptional: true)]
        public virtual oci.DataOciCloudBridgeAsset.IDataOciCloudBridgeAssetAwsEc2? InternalValue
        {
            get => GetInstanceProperty<oci.DataOciCloudBridgeAsset.IDataOciCloudBridgeAssetAwsEc2?>();
