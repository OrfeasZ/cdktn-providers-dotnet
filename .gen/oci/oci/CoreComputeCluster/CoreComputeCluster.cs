...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/oracle/oci/8.19.0/docs/resources/core_compute_cluster oci_core_compute_cluster}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/oracle/oci/8.19.0/docs/resources/core_compute_cluster oci_core_compute_cluster} Resource.</summary>
        ...
        private static DeputyProps _MakeDeputyProps(Constructs.Construct scope, string id, oci.CoreComputeCluster.ICoreComputeClusterConfig config)
        {
        ...
        protected CoreComputeCluster(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected CoreComputeCluster(DeputyProps props): base(props)
        {
        }

        /// <summary>Generates CDKTN code for importing a CoreComputeCluster resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        ...
        public virtual void PutTimeouts(oci.CoreComputeCluster.ICoreComputeClusterTimeouts @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(oci.CoreComputeCluster.ICoreComputeClusterTimeouts)}, new object[]{@value});
        }
        ...
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"oci.coreComputeCluster.CoreComputeClusterTimeoutsOutputReference\"}")]
        ...
        /// <remarks>
        /// <para>Type union: either <see cref="Io.Cdktn.IResolvable" /> or <see cref="oci.CoreComputeCluster.ICoreComputeClusterTimeouts" /></para>
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "timeoutsInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"oci.coreComputeCluster.CoreComputeClusterTimeouts\"}]}}", isOptional: true)]
