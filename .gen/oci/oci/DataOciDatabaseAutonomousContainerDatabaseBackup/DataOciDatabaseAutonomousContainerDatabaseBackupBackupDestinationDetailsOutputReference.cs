...
namespace oci.DataOciDatabaseAutonomousContainerDatabaseBackup
{
    ...
    public class DataOciDatabaseAutonomousContainerDatabaseBackupBackupDestinationDetailsOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        protected DataOciDatabaseAutonomousContainerDatabaseBackupBackupDestinationDetailsOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected DataOciDatabaseAutonomousContainerDatabaseBackupBackupDestinationDetailsOutputReference(DeputyProps props): base(props)
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"oci.dataOciDatabaseAutonomousContainerDatabaseBackup.DataOciDatabaseAutonomousContainerDatabaseBackupBackupDestinationDetails\"}", isOptional: true)]
        public virtual oci.DataOciDatabaseAutonomousContainerDatabaseBackup.IDataOciDatabaseAutonomousContainerDatabaseBackupBackupDestinationDetails? InternalValue
        {
            get => GetInstanceProperty<oci.DataOciDatabaseAutonomousContainerDatabaseBackup.IDataOciDatabaseAutonomousContainerDatabaseBackupBackupDestinationDetails?>();
