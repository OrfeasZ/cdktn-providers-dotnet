...
namespace oci.DataOciCorePublicIps
{
    ...
    [JsiiByValue(fqn: "oci.dataOciCorePublicIps.DataOciCorePublicIpsFilter")]
    public class DataOciCorePublicIpsFilter : oci.DataOciCorePublicIps.IDataOciCorePublicIpsFilter
    {
