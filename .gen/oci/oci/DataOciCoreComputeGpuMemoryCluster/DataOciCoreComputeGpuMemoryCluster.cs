...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/oracle/oci/8.28.0/docs/data-sources/core_compute_gpu_memory_cluster oci_core_compute_gpu_memory_cluster}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/oracle/oci/8.28.0/docs/data-sources/core_compute_gpu_memory_cluster oci_core_compute_gpu_memory_cluster} Data Source.</summary>
        ...
        [JsiiProperty(name: "gpuMemoryClusterScaleConfig", typeJson: "{\"fqn\":\"oci.dataOciCoreComputeGpuMemoryCluster.DataOciCoreComputeGpuMemoryClusterGpuMemoryClusterScaleConfigList\"}")]
        public virtual oci.DataOciCoreComputeGpuMemoryCluster.DataOciCoreComputeGpuMemoryClusterGpuMemoryClusterScaleConfigList GpuMemoryClusterScaleConfig
        {
            get => GetInstanceProperty<oci.DataOciCoreComputeGpuMemoryCluster.DataOciCoreComputeGpuMemoryClusterGpuMemoryClusterScaleConfigList>()!;
        }
