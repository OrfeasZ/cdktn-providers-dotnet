...
namespace oci.MarketplaceMarketplaceExternalAttestedMetadata
{
    ...
    public interface IMarketplaceMarketplaceExternalAttestedMetadataConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        oci.MarketplaceMarketplaceExternalAttestedMetadata.IMarketplaceMarketplaceExternalAttestedMetadataTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IMarketplaceMarketplaceExternalAttestedMetadataConfig), fullyQualifiedName: "oci.marketplaceMarketplaceExternalAttestedMetadata.MarketplaceMarketplaceExternalAttestedMetadataConfig")]
        internal sealed class _Proxy : DeputyBase, oci.MarketplaceMarketplaceExternalAttestedMetadata.IMarketplaceMarketplaceExternalAttestedMetadataConfig
        {
            ...
            {
                get => GetInstanceProperty<oci.MarketplaceMarketplaceExternalAttestedMetadata.IMarketplaceMarketplaceExternalAttestedMetadataTimeouts?>();
            }
