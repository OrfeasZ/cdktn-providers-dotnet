...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/oracle/oci/8.25.0/docs/resources/recovery_protected_database oci_recovery_protected_database}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/oracle/oci/8.25.0/docs/resources/recovery_protected_database oci_recovery_protected_database} Resource.</summary>
        ...
        private static DeputyProps _MakeDeputyProps(Constructs.Construct scope, string id, oci.RecoveryProtectedDatabase.IRecoveryProtectedDatabaseConfig config)
        {
        ...
        protected RecoveryProtectedDatabase(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected RecoveryProtectedDatabase(DeputyProps props): base(props)
        {
        }

        /// <summary>Generates CDKTN code for importing a RecoveryProtectedDatabase resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
            ...
            if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
            {
                switch (@value)
                {
                    case Io.Cdktn.IResolvable cast_2ed7d7:
                        break;
                    case oci.RecoveryProtectedDatabase.IRecoveryProtectedDatabaseRecoveryServiceSubnets[] cast_2ed7d7:
                        break;
                    case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_2ed7d7:
                        // Not enough information to type-check...
                        break;
                    case null:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(oci.RecoveryProtectedDatabase.IRecoveryProtectedDatabaseRecoveryServiceSubnets).FullName}[]; received null", nameof(@value));
                    default:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(oci.RecoveryProtectedDatabase.IRecoveryProtectedDatabaseRecoveryServiceSubnets).FullName}[]; received {@value.GetType().FullName}", nameof(@value));
                }
            }
            InvokeInstanceVoidMethod(new System.Type[]{typeof(object)}, new object[]{@value});
        }

        [JsiiMethod(name: "putTimeouts", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"oci.recoveryProtectedDatabase.RecoveryProtectedDatabaseTimeouts\"}}]")]
        public virtual void PutTimeouts(oci.RecoveryProtectedDatabase.IRecoveryProtectedDatabaseTimeouts @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(oci.RecoveryProtectedDatabase.IRecoveryProtectedDatabaseTimeouts)}, new object[]{@value});
        }
        ...
        [JsiiMethod(name: "resetDatabaseSize")]
        public virtual void ResetDatabaseSize()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        [JsiiMethod(name: "resetDeletionSchedule")]
        public virtual void ResetDeletionSchedule()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        [JsiiMethod(name: "resetIsRedoLogsShipped")]
        public virtual void ResetIsRedoLogsShipped()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        = GetStaticProperty<string>(typeof(oci.RecoveryProtectedDatabase.RecoveryProtectedDatabase))!;
        ...
        [JsiiProperty(name: "metrics", typeJson: "{\"fqn\":\"oci.recoveryProtectedDatabase.RecoveryProtectedDatabaseMetricsList\"}")]
        public virtual oci.RecoveryProtectedDatabase.RecoveryProtectedDatabaseMetricsList Metrics
        {
            get => GetInstanceProperty<oci.RecoveryProtectedDatabase.RecoveryProtectedDatabaseMetricsList>()!;
        }
        ...
        [JsiiProperty(name: "recoveryServiceSubnets", typeJson: "{\"fqn\":\"oci.recoveryProtectedDatabase.RecoveryProtectedDatabaseRecoveryServiceSubnetsList\"}")]
        public virtual oci.RecoveryProtectedDatabase.RecoveryProtectedDatabaseRecoveryServiceSubnetsList RecoveryServiceSubnets
        {
            get => GetInstanceProperty<oci.RecoveryProtectedDatabase.RecoveryProtectedDatabaseRecoveryServiceSubnetsList>()!;
        }
        ...
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"oci.recoveryProtectedDatabase.RecoveryProtectedDatabaseTimeoutsOutputReference\"}")]
        public virtual oci.RecoveryProtectedDatabase.RecoveryProtectedDatabaseTimeoutsOutputReference Timeouts
        {
            get => GetInstanceProperty<oci.RecoveryProtectedDatabase.RecoveryProtectedDatabaseTimeoutsOutputReference>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "databaseSizeInput", typeJson: "{\"primitive\":\"string\"}", isOptional: true)]
        public virtual string? DatabaseSizeInput
        {
            get => GetInstanceProperty<string?>();
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "deletionScheduleInput", typeJson: "{\"primitive\":\"string\"}", isOptional: true)]
        public virtual string? DeletionScheduleInput
        {
            get => GetInstanceProperty<string?>();
        }
