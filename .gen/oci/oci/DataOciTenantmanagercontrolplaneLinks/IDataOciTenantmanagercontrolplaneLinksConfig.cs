...
namespace oci.DataOciTenantmanagercontrolplaneLinks
{
    ...
    public interface IDataOciTenantmanagercontrolplaneLinksConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataOciTenantmanagercontrolplaneLinksConfig), fullyQualifiedName: "oci.dataOciTenantmanagercontrolplaneLinks.DataOciTenantmanagercontrolplaneLinksConfig")]
        internal sealed class _Proxy : DeputyBase, oci.DataOciTenantmanagercontrolplaneLinks.IDataOciTenantmanagercontrolplaneLinksConfig
        {
