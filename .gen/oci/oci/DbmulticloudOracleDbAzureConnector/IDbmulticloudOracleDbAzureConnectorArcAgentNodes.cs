...
{
    [JsiiInterface(nativeType: typeof(IDbmulticloudOracleDbAzureConnectorArcAgentNodes), fullyQualifiedName: "oci.dbmulticloudOracleDbAzureConnector.DbmulticloudOracleDbAzureConnectorArcAgentNodes")]
    public interface IDbmulticloudOracleDbAzureConnectorArcAgentNodes
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDbmulticloudOracleDbAzureConnectorArcAgentNodes), fullyQualifiedName: "oci.dbmulticloudOracleDbAzureConnector.DbmulticloudOracleDbAzureConnectorArcAgentNodes")]
        internal sealed class _Proxy : DeputyBase, oci.DbmulticloudOracleDbAzureConnector.IDbmulticloudOracleDbAzureConnectorArcAgentNodes
        {
