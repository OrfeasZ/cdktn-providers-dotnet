...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/oracle/oci/8.26.0/docs/resources/file_storage_mount_target oci_file_storage_mount_target}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/oracle/oci/8.26.0/docs/resources/file_storage_mount_target oci_file_storage_mount_target} Resource.</summary>
        ...
        private static DeputyProps _MakeDeputyProps(Constructs.Construct scope, string id, oci.FileStorageMountTarget.IFileStorageMountTargetConfig config)
        {
        ...
        protected FileStorageMountTarget(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected FileStorageMountTarget(DeputyProps props): base(props)
        {
        }

        /// <summary>Generates CDKTN code for importing a FileStorageMountTarget resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        ...
        [JsiiMethod(name: "putKerberos", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"oci.fileStorageMountTarget.FileStorageMountTargetKerberos\"}}]")]
        public virtual void PutKerberos(oci.FileStorageMountTarget.IFileStorageMountTargetKerberos @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(oci.FileStorageMountTarget.IFileStorageMountTargetKerberos)}, new object[]{@value});
        }

        [JsiiMethod(name: "putLdapIdmap", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"oci.fileStorageMountTarget.FileStorageMountTargetLdapIdmap\"}}]")]
        public virtual void PutLdapIdmap(oci.FileStorageMountTarget.IFileStorageMountTargetLdapIdmap @value)
        {
            ...
            if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
            {
                switch (@value)
                {
                    case Io.Cdktn.IResolvable cast_2ed7d7:
                        break;
                    case oci.FileStorageMountTarget.IFileStorageMountTargetLocks[] cast_2ed7d7:
                        break;
                    case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_2ed7d7:
                        // Not enough information to type-check...
                        break;
                    case null:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(oci.FileStorageMountTarget.IFileStorageMountTargetLocks).FullName}[]; received null", nameof(@value));
                    default:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(oci.FileStorageMountTarget.IFileStorageMountTargetLocks).FullName}[]; received {@value.GetType().FullName}", nameof(@value));
                }
            }
            InvokeInstanceVoidMethod(new System.Type[]{typeof(object)}, new object[]{@value});
        }

        [JsiiMethod(name: "putTimeouts", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"oci.fileStorageMountTarget.FileStorageMountTargetTimeouts\"}}]")]
        public virtual void PutTimeouts(oci.FileStorageMountTarget.IFileStorageMountTargetTimeouts @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(oci.FileStorageMountTarget.IFileStorageMountTargetTimeouts)}, new object[]{@value});
        }
        ...
        [JsiiMethod(name: "resetIdmapType")]
        public virtual void ResetIdmapType()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        [JsiiMethod(name: "resetKerberos")]
        public virtual void ResetKerberos()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }

        [JsiiMethod(name: "resetLdapIdmap")]
        public virtual void ResetLdapIdmap()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        [JsiiMethod(name: "resetRequestedThroughput")]
        public virtual void ResetRequestedThroughput()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        = GetStaticProperty<string>(typeof(oci.FileStorageMountTarget.FileStorageMountTarget))!;
        ...
        [JsiiProperty(name: "kerberos", typeJson: "{\"fqn\":\"oci.fileStorageMountTarget.FileStorageMountTargetKerberosOutputReference\"}")]
        public virtual oci.FileStorageMountTarget.FileStorageMountTargetKerberosOutputReference Kerberos
        {
            get => GetInstanceProperty<oci.FileStorageMountTarget.FileStorageMountTargetKerberosOutputReference>()!;
        }

        [JsiiProperty(name: "ldapIdmap", typeJson: "{\"fqn\":\"oci.fileStorageMountTarget.FileStorageMountTargetLdapIdmapOutputReference\"}")]
        public virtual oci.FileStorageMountTarget.FileStorageMountTargetLdapIdmapOutputReference LdapIdmap
        {
            get => GetInstanceProperty<oci.FileStorageMountTarget.FileStorageMountTargetLdapIdmapOutputReference>()!;
        }
        ...
        [JsiiProperty(name: "locks", typeJson: "{\"fqn\":\"oci.fileStorageMountTarget.FileStorageMountTargetLocksList\"}")]
        ...
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"oci.fileStorageMountTarget.FileStorageMountTargetTimeoutsOutputReference\"}")]
        public virtual oci.FileStorageMountTarget.FileStorageMountTargetTimeoutsOutputReference Timeouts
        {
            get => GetInstanceProperty<oci.FileStorageMountTarget.FileStorageMountTargetTimeoutsOutputReference>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "idmapTypeInput", typeJson: "{\"primitive\":\"string\"}", isOptional: true)]
        public virtual string? IdmapTypeInput
        {
            get => GetInstanceProperty<string?>();
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "kerberosInput", typeJson: "{\"fqn\":\"oci.fileStorageMountTarget.FileStorageMountTargetKerberos\"}", isOptional: true)]
        public virtual oci.FileStorageMountTarget.IFileStorageMountTargetKerberos? KerberosInput
        {
            get => GetInstanceProperty<oci.FileStorageMountTarget.IFileStorageMountTargetKerberos?>();
        }

        [JsiiOptional]
        [JsiiProperty(name: "ldapIdmapInput", typeJson: "{\"fqn\":\"oci.fileStorageMountTarget.FileStorageMountTargetLdapIdmap\"}", isOptional: true)]
        public virtual oci.FileStorageMountTarget.IFileStorageMountTargetLdapIdmap? LdapIdmapInput
        {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "requestedThroughputInput", typeJson: "{\"primitive\":\"string\"}", isOptional: true)]
        public virtual string? RequestedThroughputInput
        {
            get => GetInstanceProperty<string?>();
        }
