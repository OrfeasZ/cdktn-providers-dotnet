...
namespace oci.DesktopsDesktopPool
{
    ...
    public interface IDesktopsDesktopPoolSessionLifecycleActionsInactivity
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDesktopsDesktopPoolSessionLifecycleActionsInactivity), fullyQualifiedName: "oci.desktopsDesktopPool.DesktopsDesktopPoolSessionLifecycleActionsInactivity")]
        internal sealed class _Proxy : DeputyBase, oci.DesktopsDesktopPool.IDesktopsDesktopPoolSessionLifecycleActionsInactivity
        {
