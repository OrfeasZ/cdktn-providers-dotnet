...
namespace oci.GenerativeAiAgentAgentEndpoint
{
    ...
    public interface IGenerativeAiAgentAgentEndpointGuardrailConfigPersonallyIdentifiableInformationConfig
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IGenerativeAiAgentAgentEndpointGuardrailConfigPersonallyIdentifiableInformationConfig), fullyQualifiedName: "oci.generativeAiAgentAgentEndpoint.GenerativeAiAgentAgentEndpointGuardrailConfigPersonallyIdentifiableInformationConfig")]
        internal sealed class _Proxy : DeputyBase, oci.GenerativeAiAgentAgentEndpoint.IGenerativeAiAgentAgentEndpointGuardrailConfigPersonallyIdentifiableInformationConfig
        {
