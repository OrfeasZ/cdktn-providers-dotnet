...
{
    [JsiiInterface(nativeType: typeof(ICoreInstanceConfigurationInstanceDetailsBlockVolumesAttachDetails), fullyQualifiedName: "oci.coreInstanceConfiguration.CoreInstanceConfigurationInstanceDetailsBlockVolumesAttachDetails")]
    public interface ICoreInstanceConfigurationInstanceDetailsBlockVolumesAttachDetails
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ICoreInstanceConfigurationInstanceDetailsBlockVolumesAttachDetails), fullyQualifiedName: "oci.coreInstanceConfiguration.CoreInstanceConfigurationInstanceDetailsBlockVolumesAttachDetails")]
        internal sealed class _Proxy : DeputyBase, oci.CoreInstanceConfiguration.ICoreInstanceConfigurationInstanceDetailsBlockVolumesAttachDetails
        {
