...
{
    [JsiiClass(nativeType: typeof(oci.LoadBalancerBackendsetA.LoadBalancerBackendsetAHealthCheckerOutputReference), fullyQualifiedName: "oci.loadBalancerBackendsetA.LoadBalancerBackendsetAHealthCheckerOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktn.IInterpolatingParent\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}}]")]
    public class LoadBalancerBackendsetAHealthCheckerOutputReference : Io.Cdktn.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        public LoadBalancerBackendsetAHealthCheckerOutputReference(Io.Cdktn.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
        ...
        protected LoadBalancerBackendsetAHealthCheckerOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected LoadBalancerBackendsetAHealthCheckerOutputReference(DeputyProps props): base(props)
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"oci.loadBalancerBackendsetA.LoadBalancerBackendsetAHealthChecker\"}", isOptional: true)]
        public virtual oci.LoadBalancerBackendsetA.ILoadBalancerBackendsetAHealthChecker? InternalValue
        {
