...
namespace oci.DataOciBudgetBudgets
{
    ...
    [JsiiByValue(fqn: "oci.dataOciBudgetBudgets.DataOciBudgetBudgetsFilter")]
    public class DataOciBudgetBudgetsFilter : oci.DataOciBudgetBudgets.IDataOciBudgetBudgetsFilter
    {
