...
namespace oci.DataOciDatabaseToolsDatabaseToolsSqlReport
{
    ...
    public interface IDataOciDatabaseToolsDatabaseToolsSqlReportConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataOciDatabaseToolsDatabaseToolsSqlReportConfig), fullyQualifiedName: "oci.dataOciDatabaseToolsDatabaseToolsSqlReport.DataOciDatabaseToolsDatabaseToolsSqlReportConfig")]
        internal sealed class _Proxy : DeputyBase, oci.DataOciDatabaseToolsDatabaseToolsSqlReport.IDataOciDatabaseToolsDatabaseToolsSqlReportConfig
        {
