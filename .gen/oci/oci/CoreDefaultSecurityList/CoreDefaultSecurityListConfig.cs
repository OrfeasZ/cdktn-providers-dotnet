...
namespace oci.CoreDefaultSecurityList
{
    ...
    [JsiiByValue(fqn: "oci.coreDefaultSecurityList.CoreDefaultSecurityListConfig")]
    public class CoreDefaultSecurityListConfig : oci.CoreDefaultSecurityList.ICoreDefaultSecurityListConfig
    {
