...
namespace oci.DataOciDevopsRepositoryCommits
{
    ...
    public class DataOciDevopsRepositoryCommitsRepositoryCommitCollectionItemsOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        protected DataOciDevopsRepositoryCommitsRepositoryCommitCollectionItemsOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected DataOciDevopsRepositoryCommitsRepositoryCommitCollectionItemsOutputReference(DeputyProps props): base(props)
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"oci.dataOciDevopsRepositoryCommits.DataOciDevopsRepositoryCommitsRepositoryCommitCollectionItems\"}", isOptional: true)]
        public virtual oci.DataOciDevopsRepositoryCommits.IDataOciDevopsRepositoryCommitsRepositoryCommitCollectionItems? InternalValue
        {
            get => GetInstanceProperty<oci.DataOciDevopsRepositoryCommits.IDataOciDevopsRepositoryCommitsRepositoryCommitCollectionItems?>();
