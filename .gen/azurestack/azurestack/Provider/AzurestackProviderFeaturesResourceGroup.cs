...
{
    [JsiiByValue(fqn: "azurestack.provider.AzurestackProviderFeaturesResourceGroup")]
    public class AzurestackProviderFeaturesResourceGroup : azurestack.Provider.IAzurestackProviderFeaturesResourceGroup
    {
