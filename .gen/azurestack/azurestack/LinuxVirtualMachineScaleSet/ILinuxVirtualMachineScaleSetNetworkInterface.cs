...
{
    [JsiiInterface(nativeType: typeof(ILinuxVirtualMachineScaleSetNetworkInterface), fullyQualifiedName: "azurestack.linuxVirtualMachineScaleSet.LinuxVirtualMachineScaleSetNetworkInterface")]
    public interface ILinuxVirtualMachineScaleSetNetworkInterface
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ILinuxVirtualMachineScaleSetNetworkInterface), fullyQualifiedName: "azurestack.linuxVirtualMachineScaleSet.LinuxVirtualMachineScaleSetNetworkInterface")]
        internal sealed class _Proxy : DeputyBase, azurestack.LinuxVirtualMachineScaleSet.ILinuxVirtualMachineScaleSetNetworkInterface
        {
