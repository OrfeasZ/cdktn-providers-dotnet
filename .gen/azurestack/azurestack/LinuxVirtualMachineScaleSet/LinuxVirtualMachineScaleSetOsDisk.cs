...
namespace azurestack.LinuxVirtualMachineScaleSet
{
    ...
    [JsiiByValue(fqn: "azurestack.linuxVirtualMachineScaleSet.LinuxVirtualMachineScaleSetOsDisk")]
    public class LinuxVirtualMachineScaleSetOsDisk : azurestack.LinuxVirtualMachineScaleSet.ILinuxVirtualMachineScaleSetOsDisk
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "diffDiskSettings", typeJson: "{\"fqn\":\"azurestack.linuxVirtualMachineScaleSet.LinuxVirtualMachineScaleSetOsDiskDiffDiskSettings\"}", isOptional: true)]
        public azurestack.LinuxVirtualMachineScaleSet.ILinuxVirtualMachineScaleSetOsDiskDiffDiskSettings? DiffDiskSettings
        {
            get;
            set;
        }
