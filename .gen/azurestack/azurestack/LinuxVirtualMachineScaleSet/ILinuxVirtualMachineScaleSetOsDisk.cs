...
{
    [JsiiInterface(nativeType: typeof(ILinuxVirtualMachineScaleSetOsDisk), fullyQualifiedName: "azurestack.linuxVirtualMachineScaleSet.LinuxVirtualMachineScaleSetOsDisk")]
    public interface ILinuxVirtualMachineScaleSetOsDisk
    {
        ...
        azurestack.LinuxVirtualMachineScaleSet.ILinuxVirtualMachineScaleSetOsDiskDiffDiskSettings? DiffDiskSettings
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(ILinuxVirtualMachineScaleSetOsDisk), fullyQualifiedName: "azurestack.linuxVirtualMachineScaleSet.LinuxVirtualMachineScaleSetOsDisk")]
        internal sealed class _Proxy : DeputyBase, azurestack.LinuxVirtualMachineScaleSet.ILinuxVirtualMachineScaleSetOsDisk
        {
