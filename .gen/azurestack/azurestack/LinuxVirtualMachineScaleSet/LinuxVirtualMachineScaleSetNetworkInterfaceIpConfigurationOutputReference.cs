...
namespace azurestack.LinuxVirtualMachineScaleSet
{
    ...
    public class LinuxVirtualMachineScaleSetNetworkInterfaceIpConfigurationOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"azurestack.linuxVirtualMachineScaleSet.LinuxVirtualMachineScaleSetNetworkInterfaceIpConfiguration\"}]}}", isOptional: true)]
