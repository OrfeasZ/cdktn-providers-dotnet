...
{
    [JsiiInterface(nativeType: typeof(ILinuxVirtualMachineScaleSetPlan), fullyQualifiedName: "azurestack.linuxVirtualMachineScaleSet.LinuxVirtualMachineScaleSetPlan")]
    public interface ILinuxVirtualMachineScaleSetPlan
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ILinuxVirtualMachineScaleSetPlan), fullyQualifiedName: "azurestack.linuxVirtualMachineScaleSet.LinuxVirtualMachineScaleSetPlan")]
        internal sealed class _Proxy : DeputyBase, azurestack.LinuxVirtualMachineScaleSet.ILinuxVirtualMachineScaleSetPlan
        {
