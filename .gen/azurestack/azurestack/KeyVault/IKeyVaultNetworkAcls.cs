...
{
    [JsiiInterface(nativeType: typeof(IKeyVaultNetworkAcls), fullyQualifiedName: "azurestack.keyVault.KeyVaultNetworkAcls")]
    public interface IKeyVaultNetworkAcls
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IKeyVaultNetworkAcls), fullyQualifiedName: "azurestack.keyVault.KeyVaultNetworkAcls")]
        internal sealed class _Proxy : DeputyBase, azurestack.KeyVault.IKeyVaultNetworkAcls
        {
