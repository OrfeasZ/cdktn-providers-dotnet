...
{
    [JsiiInterface(nativeType: typeof(IWindowsVirtualMachineAdditionalUnattendContent), fullyQualifiedName: "azurestack.windowsVirtualMachine.WindowsVirtualMachineAdditionalUnattendContent")]
    public interface IWindowsVirtualMachineAdditionalUnattendContent
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IWindowsVirtualMachineAdditionalUnattendContent), fullyQualifiedName: "azurestack.windowsVirtualMachine.WindowsVirtualMachineAdditionalUnattendContent")]
        internal sealed class _Proxy : DeputyBase, azurestack.WindowsVirtualMachine.IWindowsVirtualMachineAdditionalUnattendContent
        {
