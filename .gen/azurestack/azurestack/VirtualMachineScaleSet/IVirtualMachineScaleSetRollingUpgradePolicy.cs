...
{
    [JsiiInterface(nativeType: typeof(IVirtualMachineScaleSetRollingUpgradePolicy), fullyQualifiedName: "azurestack.virtualMachineScaleSet.VirtualMachineScaleSetRollingUpgradePolicy")]
    public interface IVirtualMachineScaleSetRollingUpgradePolicy
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IVirtualMachineScaleSetRollingUpgradePolicy), fullyQualifiedName: "azurestack.virtualMachineScaleSet.VirtualMachineScaleSetRollingUpgradePolicy")]
        internal sealed class _Proxy : DeputyBase, azurestack.VirtualMachineScaleSet.IVirtualMachineScaleSetRollingUpgradePolicy
        {
