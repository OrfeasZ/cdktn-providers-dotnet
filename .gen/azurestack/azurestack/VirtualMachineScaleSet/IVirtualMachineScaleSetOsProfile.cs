...
{
    [JsiiInterface(nativeType: typeof(IVirtualMachineScaleSetOsProfile), fullyQualifiedName: "azurestack.virtualMachineScaleSet.VirtualMachineScaleSetOsProfile")]
    public interface IVirtualMachineScaleSetOsProfile
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IVirtualMachineScaleSetOsProfile), fullyQualifiedName: "azurestack.virtualMachineScaleSet.VirtualMachineScaleSetOsProfile")]
        internal sealed class _Proxy : DeputyBase, azurestack.VirtualMachineScaleSet.IVirtualMachineScaleSetOsProfile
        {
