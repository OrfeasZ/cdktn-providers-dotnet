...
namespace azurestack.VirtualMachineScaleSet
{
    ...
    public class VirtualMachineScaleSetOsProfileOutputReference : Io.Cdktn.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        public VirtualMachineScaleSetOsProfileOutputReference(Io.Cdktn.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"azurestack.virtualMachineScaleSet.VirtualMachineScaleSetOsProfile\"}", isOptional: true)]
        public virtual azurestack.VirtualMachineScaleSet.IVirtualMachineScaleSetOsProfile? InternalValue
        {
