...
namespace azurestack.VirtualMachineScaleSet
{
    ...
    public class VirtualMachineScaleSetSkuOutputReference : Io.Cdktn.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        public VirtualMachineScaleSetSkuOutputReference(Io.Cdktn.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"azurestack.virtualMachineScaleSet.VirtualMachineScaleSetSku\"}", isOptional: true)]
        public virtual azurestack.VirtualMachineScaleSet.IVirtualMachineScaleSetSku? InternalValue
        {
