...
{
    [JsiiInterface(nativeType: typeof(IVirtualMachineScaleSetOsProfileWindowsConfigAdditionalUnattendConfig), fullyQualifiedName: "azurestack.virtualMachineScaleSet.VirtualMachineScaleSetOsProfileWindowsConfigAdditionalUnattendConfig")]
    public interface IVirtualMachineScaleSetOsProfileWindowsConfigAdditionalUnattendConfig
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IVirtualMachineScaleSetOsProfileWindowsConfigAdditionalUnattendConfig), fullyQualifiedName: "azurestack.virtualMachineScaleSet.VirtualMachineScaleSetOsProfileWindowsConfigAdditionalUnattendConfig")]
        internal sealed class _Proxy : DeputyBase, azurestack.VirtualMachineScaleSet.IVirtualMachineScaleSetOsProfileWindowsConfigAdditionalUnattendConfig
        {
