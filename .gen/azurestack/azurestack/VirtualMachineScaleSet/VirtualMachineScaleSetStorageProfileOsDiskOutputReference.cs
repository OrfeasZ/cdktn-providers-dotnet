...
namespace azurestack.VirtualMachineScaleSet
{
    ...
    public class VirtualMachineScaleSetStorageProfileOsDiskOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"azurestack.virtualMachineScaleSet.VirtualMachineScaleSetStorageProfileOsDisk\"}", isOptional: true)]
        public virtual azurestack.VirtualMachineScaleSet.IVirtualMachineScaleSetStorageProfileOsDisk? InternalValue
        {
