...
{
    [JsiiInterface(nativeType: typeof(ILbBackendAddressPoolTimeouts), fullyQualifiedName: "azurestack.lbBackendAddressPool.LbBackendAddressPoolTimeouts")]
    public interface ILbBackendAddressPoolTimeouts
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ILbBackendAddressPoolTimeouts), fullyQualifiedName: "azurestack.lbBackendAddressPool.LbBackendAddressPoolTimeouts")]
        internal sealed class _Proxy : DeputyBase, azurestack.LbBackendAddressPool.ILbBackendAddressPoolTimeouts
        {
