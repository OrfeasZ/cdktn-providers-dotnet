...
{
    [JsiiByValue(fqn: "azurestack.dataAzurestackPublicIp.DataAzurestackPublicIpTimeouts")]
    public class DataAzurestackPublicIpTimeouts : azurestack.DataAzurestackPublicIp.IDataAzurestackPublicIpTimeouts
    {
