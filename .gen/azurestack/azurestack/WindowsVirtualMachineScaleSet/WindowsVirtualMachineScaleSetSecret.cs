...
namespace azurestack.WindowsVirtualMachineScaleSet
{
    ...
    [JsiiByValue(fqn: "azurestack.windowsVirtualMachineScaleSet.WindowsVirtualMachineScaleSetSecret")]
    public class WindowsVirtualMachineScaleSetSecret : azurestack.WindowsVirtualMachineScaleSet.IWindowsVirtualMachineScaleSetSecret
    {
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        case Io.Cdktn.IResolvable cast_cd4240:
                            break;
                        case azurestack.WindowsVirtualMachineScaleSet.IWindowsVirtualMachineScaleSetSecretCertificate[] cast_cd4240:
                            break;
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            // Not enough information to type-check...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(azurestack.WindowsVirtualMachineScaleSet.IWindowsVirtualMachineScaleSetSecretCertificate).FullName}[]; received null", nameof(value));
                        default:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(azurestack.WindowsVirtualMachineScaleSet.IWindowsVirtualMachineScaleSetSecretCertificate).FullName}[]; received {value.GetType().FullName}", nameof(value));
                    }
                }
                _certificate = value;
            }
