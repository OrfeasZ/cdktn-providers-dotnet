...
namespace azurestack.LinuxVirtualMachine
{
    ...
    [JsiiByValue(fqn: "azurestack.linuxVirtualMachine.LinuxVirtualMachinePlan")]
    public class LinuxVirtualMachinePlan : azurestack.LinuxVirtualMachine.ILinuxVirtualMachinePlan
    {
