...
{
    [JsiiInterface(nativeType: typeof(ILinuxVirtualMachineAdminSshKey), fullyQualifiedName: "azurestack.linuxVirtualMachine.LinuxVirtualMachineAdminSshKey")]
    public interface ILinuxVirtualMachineAdminSshKey
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ILinuxVirtualMachineAdminSshKey), fullyQualifiedName: "azurestack.linuxVirtualMachine.LinuxVirtualMachineAdminSshKey")]
        internal sealed class _Proxy : DeputyBase, azurestack.LinuxVirtualMachine.ILinuxVirtualMachineAdminSshKey
        {
