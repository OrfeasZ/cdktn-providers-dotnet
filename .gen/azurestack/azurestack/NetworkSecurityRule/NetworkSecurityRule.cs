...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/hashicorp/azurestack/1.0.0/docs/resources/network_security_rule azurestack_network_security_rule}.</summary>
    [JsiiClass(nativeType: typeof(azurestack.NetworkSecurityRule.NetworkSecurityRule), fullyQualifiedName: "azurestack.networkSecurityRule.NetworkSecurityRule", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"remarks\":\"Must be unique amongst siblings in the same scope\",\"summary\":\"The scoped construct ID.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"azurestack.networkSecurityRule.NetworkSecurityRuleConfig\"}}]")]
    public class NetworkSecurityRule : Io.Cdktn.TerraformResource
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/hashicorp/azurestack/1.0.0/docs/resources/network_security_rule azurestack_network_security_rule} Resource.</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        /// <param name="id">The scoped construct ID.</param>
        public NetworkSecurityRule(Constructs.Construct scope, string id, azurestack.NetworkSecurityRule.INetworkSecurityRuleConfig config): base(_MakeDeputyProps(scope, id, config))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(Constructs.Construct scope, string id, azurestack.NetworkSecurityRule.INetworkSecurityRuleConfig config)
        {
        ...
        /// <summary>Generates CDKTN code for importing a NetworkSecurityRule resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        ...
        [JsiiMethod(name: "generateConfigForImport", returnsJson: "{\"type\":{\"fqn\":\"cdktn.ImportableResource\"}}", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"summary\":\"The construct id used in the generated config for the NetworkSecurityRule to import.\"},\"name\":\"importToId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"remarks\":\"Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurestack/1.0.0/docs/resources/network_security_rule#import import section} in the documentation of this resource for the id to use\",\"summary\":\"The id of the existing NetworkSecurityRule that should be imported.\"},\"name\":\"importFromId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"? Optional instance of the provider where the NetworkSecurityRule to import is found.\"},\"name\":\"provider\",\"optional\":true,\"type\":{\"fqn\":\"cdktn.TerraformProvider\"}}]")]
        public static Io.Cdktn.ImportableResource GenerateConfigForImport(Constructs.Construct scope, string importToId, string importFromId, Io.Cdktn.TerraformProvider? provider = null)
        {
            return InvokeStaticMethod<Io.Cdktn.ImportableResource>(typeof(azurestack.NetworkSecurityRule.NetworkSecurityRule), new System.Type[]{typeof(Constructs.Construct), typeof(string), typeof(string), typeof(Io.Cdktn.TerraformProvider)}, new object?[]{scope, importToId, importFromId, provider})!;
        }

        [JsiiMethod(name: "putTimeouts", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"azurestack.networkSecurityRule.NetworkSecurityRuleTimeouts\"}}]")]
        public virtual void PutTimeouts(azurestack.NetworkSecurityRule.INetworkSecurityRuleTimeouts @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(azurestack.NetworkSecurityRule.INetworkSecurityRuleTimeouts)}, new object[]{@value});
        }
        ...
        = GetStaticProperty<string>(typeof(azurestack.NetworkSecurityRule.NetworkSecurityRule))!;

        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"azurestack.networkSecurityRule.NetworkSecurityRuleTimeoutsOutputReference\"}")]
        public virtual azurestack.NetworkSecurityRule.NetworkSecurityRuleTimeoutsOutputReference Timeouts
        {
            get => GetInstanceProperty<azurestack.NetworkSecurityRule.NetworkSecurityRuleTimeoutsOutputReference>()!;
        }
        ...
        /// <remarks>
        /// <para>Type union: either <see cref="Io.Cdktn.IResolvable" /> or <see cref="azurestack.NetworkSecurityRule.INetworkSecurityRuleTimeouts" /></para>
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "timeoutsInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"azurestack.networkSecurityRule.NetworkSecurityRuleTimeouts\"}]}}", isOptional: true)]
