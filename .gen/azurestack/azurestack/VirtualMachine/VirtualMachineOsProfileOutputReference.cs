...
{
    [JsiiClass(nativeType: typeof(azurestack.VirtualMachine.VirtualMachineOsProfileOutputReference), fullyQualifiedName: "azurestack.virtualMachine.VirtualMachineOsProfileOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktn.IInterpolatingParent\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}}]")]
    public class VirtualMachineOsProfileOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"azurestack.virtualMachine.VirtualMachineOsProfile\"}", isOptional: true)]
        public virtual azurestack.VirtualMachine.IVirtualMachineOsProfile? InternalValue
        {
