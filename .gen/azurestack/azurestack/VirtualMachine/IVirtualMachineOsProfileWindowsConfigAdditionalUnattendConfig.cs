...
{
    [JsiiInterface(nativeType: typeof(IVirtualMachineOsProfileWindowsConfigAdditionalUnattendConfig), fullyQualifiedName: "azurestack.virtualMachine.VirtualMachineOsProfileWindowsConfigAdditionalUnattendConfig")]
    public interface IVirtualMachineOsProfileWindowsConfigAdditionalUnattendConfig
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IVirtualMachineOsProfileWindowsConfigAdditionalUnattendConfig), fullyQualifiedName: "azurestack.virtualMachine.VirtualMachineOsProfileWindowsConfigAdditionalUnattendConfig")]
        internal sealed class _Proxy : DeputyBase, azurestack.VirtualMachine.IVirtualMachineOsProfileWindowsConfigAdditionalUnattendConfig
        {
