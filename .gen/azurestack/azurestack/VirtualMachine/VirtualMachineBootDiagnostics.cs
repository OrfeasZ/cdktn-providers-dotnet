...
namespace azurestack.VirtualMachine
{
    ...
    [JsiiByValue(fqn: "azurestack.virtualMachine.VirtualMachineBootDiagnostics")]
    public class VirtualMachineBootDiagnostics : azurestack.VirtualMachine.IVirtualMachineBootDiagnostics
    {
