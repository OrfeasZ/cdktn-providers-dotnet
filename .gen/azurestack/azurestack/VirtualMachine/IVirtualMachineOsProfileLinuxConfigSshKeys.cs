...
{
    [JsiiInterface(nativeType: typeof(IVirtualMachineOsProfileLinuxConfigSshKeys), fullyQualifiedName: "azurestack.virtualMachine.VirtualMachineOsProfileLinuxConfigSshKeys")]
    public interface IVirtualMachineOsProfileLinuxConfigSshKeys
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IVirtualMachineOsProfileLinuxConfigSshKeys), fullyQualifiedName: "azurestack.virtualMachine.VirtualMachineOsProfileLinuxConfigSshKeys")]
        internal sealed class _Proxy : DeputyBase, azurestack.VirtualMachine.IVirtualMachineOsProfileLinuxConfigSshKeys
        {
