...
{
    [JsiiInterface(nativeType: typeof(IVirtualNetworkGatewayVpnClientConfigurationRootCertificate), fullyQualifiedName: "azurestack.virtualNetworkGateway.VirtualNetworkGatewayVpnClientConfigurationRootCertificate")]
    public interface IVirtualNetworkGatewayVpnClientConfigurationRootCertificate
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IVirtualNetworkGatewayVpnClientConfigurationRootCertificate), fullyQualifiedName: "azurestack.virtualNetworkGateway.VirtualNetworkGatewayVpnClientConfigurationRootCertificate")]
        internal sealed class _Proxy : DeputyBase, azurestack.VirtualNetworkGateway.IVirtualNetworkGatewayVpnClientConfigurationRootCertificate
        {
