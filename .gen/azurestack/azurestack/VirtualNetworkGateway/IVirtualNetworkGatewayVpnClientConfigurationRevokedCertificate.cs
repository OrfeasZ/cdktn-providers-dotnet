...
{
    [JsiiInterface(nativeType: typeof(IVirtualNetworkGatewayVpnClientConfigurationRevokedCertificate), fullyQualifiedName: "azurestack.virtualNetworkGateway.VirtualNetworkGatewayVpnClientConfigurationRevokedCertificate")]
    public interface IVirtualNetworkGatewayVpnClientConfigurationRevokedCertificate
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IVirtualNetworkGatewayVpnClientConfigurationRevokedCertificate), fullyQualifiedName: "azurestack.virtualNetworkGateway.VirtualNetworkGatewayVpnClientConfigurationRevokedCertificate")]
        internal sealed class _Proxy : DeputyBase, azurestack.VirtualNetworkGateway.IVirtualNetworkGatewayVpnClientConfigurationRevokedCertificate
        {
