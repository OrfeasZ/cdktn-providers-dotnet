...
namespace hcloud.StorageBoxSnapshot
{
    ...
    [JsiiByValue(fqn: "hcloud.storageBoxSnapshot.StorageBoxSnapshotConfig")]
    public class StorageBoxSnapshotConfig : hcloud.StorageBoxSnapshot.IStorageBoxSnapshotConfig
    {
