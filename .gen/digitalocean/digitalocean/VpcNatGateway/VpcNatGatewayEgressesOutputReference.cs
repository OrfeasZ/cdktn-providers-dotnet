...
namespace digitalocean.VpcNatGateway
{
    ...
    public class VpcNatGatewayEgressesOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        public VpcNatGatewayEgressesOutputReference(Io.Cdktn.IInterpolatingParent terraformResource, string terraformAttribute, double complexObjectIndex, bool complexObjectIsFromSet): base(_MakeDeputyProps(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet))
        {
        }
