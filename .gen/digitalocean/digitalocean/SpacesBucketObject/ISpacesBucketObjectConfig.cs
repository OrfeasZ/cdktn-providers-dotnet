...
{
    [JsiiInterface(nativeType: typeof(ISpacesBucketObjectConfig), fullyQualifiedName: "digitalocean.spacesBucketObject.SpacesBucketObjectConfig")]
    public interface ISpacesBucketObjectConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ISpacesBucketObjectConfig), fullyQualifiedName: "digitalocean.spacesBucketObject.SpacesBucketObjectConfig")]
        internal sealed class _Proxy : DeputyBase, digitalocean.SpacesBucketObject.ISpacesBucketObjectConfig
        {
