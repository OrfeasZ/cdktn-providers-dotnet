...
{
    [JsiiClass(nativeType: typeof(digitalocean.GradientaiAgent.GradientaiAgentTemplateKnowledgeBasesLastIndexingJobOutputReference), fullyQualifiedName: "digitalocean.gradientaiAgent.GradientaiAgentTemplateKnowledgeBasesLastIndexingJobOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktn.IInterpolatingParent\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}}]")]
    public class GradientaiAgentTemplateKnowledgeBasesLastIndexingJobOutputReference : Io.Cdktn.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        public GradientaiAgentTemplateKnowledgeBasesLastIndexingJobOutputReference(Io.Cdktn.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
        ...
        protected GradientaiAgentTemplateKnowledgeBasesLastIndexingJobOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected GradientaiAgentTemplateKnowledgeBasesLastIndexingJobOutputReference(DeputyProps props): base(props)
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"digitalocean.gradientaiAgent.GradientaiAgentTemplateKnowledgeBasesLastIndexingJob\"}", isOptional: true)]
        public virtual digitalocean.GradientaiAgent.IGradientaiAgentTemplateKnowledgeBasesLastIndexingJob? InternalValue
        {
