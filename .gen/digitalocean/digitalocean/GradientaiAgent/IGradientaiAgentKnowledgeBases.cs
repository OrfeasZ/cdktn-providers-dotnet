...
{
    [JsiiInterface(nativeType: typeof(IGradientaiAgentKnowledgeBases), fullyQualifiedName: "digitalocean.gradientaiAgent.GradientaiAgentKnowledgeBases")]
    public interface IGradientaiAgentKnowledgeBases
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "lastIndexingJob", typeJson: "{\"fqn\":\"digitalocean.gradientaiAgent.GradientaiAgentKnowledgeBasesLastIndexingJob\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        digitalocean.GradientaiAgent.IGradientaiAgentKnowledgeBasesLastIndexingJob? LastIndexingJob
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IGradientaiAgentKnowledgeBases), fullyQualifiedName: "digitalocean.gradientaiAgent.GradientaiAgentKnowledgeBases")]
        internal sealed class _Proxy : DeputyBase, digitalocean.GradientaiAgent.IGradientaiAgentKnowledgeBases
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "lastIndexingJob", typeJson: "{\"fqn\":\"digitalocean.gradientaiAgent.GradientaiAgentKnowledgeBasesLastIndexingJob\"}", isOptional: true)]
            public digitalocean.GradientaiAgent.IGradientaiAgentKnowledgeBasesLastIndexingJob? LastIndexingJob
            {
