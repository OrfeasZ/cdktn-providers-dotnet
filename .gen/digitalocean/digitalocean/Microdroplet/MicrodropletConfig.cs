...
namespace digitalocean.Microdroplet
{
    ...
    [JsiiByValue(fqn: "digitalocean.microdroplet.MicrodropletConfig")]
    public class MicrodropletConfig : digitalocean.Microdroplet.IMicrodropletConfig
    {
