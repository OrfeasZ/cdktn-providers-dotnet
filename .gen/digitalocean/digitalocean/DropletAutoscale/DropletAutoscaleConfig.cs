...
namespace digitalocean.DropletAutoscale
{
    ...
    [JsiiByValue(fqn: "digitalocean.dropletAutoscale.DropletAutoscaleConfig")]
    public class DropletAutoscaleConfig : digitalocean.DropletAutoscale.IDropletAutoscaleConfig
    {
