...
namespace digitalocean.Droplet
{
    ...
    [JsiiByValue(fqn: "digitalocean.droplet.DropletConfig")]
    public class DropletConfig : digitalocean.Droplet.IDropletConfig
    {
        ...
        private object? _privateNetworking;
