...
{
    [JsiiByValue(fqn: "digitalocean.app.AppSpecWorkerAlertDestinations")]
    public class AppSpecWorkerAlertDestinations : digitalocean.App.IAppSpecWorkerAlertDestinations
    {
