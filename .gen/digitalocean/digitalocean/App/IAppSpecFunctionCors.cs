...
{
    [JsiiInterface(nativeType: typeof(IAppSpecFunctionCors), fullyQualifiedName: "digitalocean.app.AppSpecFunctionCors")]
    public interface IAppSpecFunctionCors
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        digitalocean.App.IAppSpecFunctionCorsAllowOrigins? AllowOrigins
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IAppSpecFunctionCors), fullyQualifiedName: "digitalocean.app.AppSpecFunctionCors")]
        internal sealed class _Proxy : DeputyBase, digitalocean.App.IAppSpecFunctionCors
        {
