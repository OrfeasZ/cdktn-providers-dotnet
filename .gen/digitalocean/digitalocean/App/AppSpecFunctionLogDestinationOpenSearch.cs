...
namespace digitalocean.App
{
    ...
    [JsiiByValue(fqn: "digitalocean.app.AppSpecFunctionLogDestinationOpenSearch")]
    public class AppSpecFunctionLogDestinationOpenSearch : digitalocean.App.IAppSpecFunctionLogDestinationOpenSearch
    {
