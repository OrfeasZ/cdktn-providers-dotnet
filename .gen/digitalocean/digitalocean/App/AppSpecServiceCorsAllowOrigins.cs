...
{
    [JsiiByValue(fqn: "digitalocean.app.AppSpecServiceCorsAllowOrigins")]
    public class AppSpecServiceCorsAllowOrigins : digitalocean.App.IAppSpecServiceCorsAllowOrigins
    {
