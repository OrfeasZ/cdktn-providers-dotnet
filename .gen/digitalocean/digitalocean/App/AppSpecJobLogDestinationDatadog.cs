...
namespace digitalocean.App
{
    ...
    [JsiiByValue(fqn: "digitalocean.app.AppSpecJobLogDestinationDatadog")]
    public class AppSpecJobLogDestinationDatadog : digitalocean.App.IAppSpecJobLogDestinationDatadog
    {
