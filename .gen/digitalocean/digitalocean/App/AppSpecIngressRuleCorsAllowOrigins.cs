...
{
    [JsiiByValue(fqn: "digitalocean.app.AppSpecIngressRuleCorsAllowOrigins")]
    public class AppSpecIngressRuleCorsAllowOrigins : digitalocean.App.IAppSpecIngressRuleCorsAllowOrigins
    {
