...
{
    [JsiiInterface(nativeType: typeof(IAppSpecWorkerAlert), fullyQualifiedName: "digitalocean.app.AppSpecWorkerAlert")]
    public interface IAppSpecWorkerAlert
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "destinations", typeJson: "{\"fqn\":\"digitalocean.app.AppSpecWorkerAlertDestinations\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        digitalocean.App.IAppSpecWorkerAlertDestinations? Destinations
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IAppSpecWorkerAlert), fullyQualifiedName: "digitalocean.app.AppSpecWorkerAlert")]
        internal sealed class _Proxy : DeputyBase, digitalocean.App.IAppSpecWorkerAlert
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "destinations", typeJson: "{\"fqn\":\"digitalocean.app.AppSpecWorkerAlertDestinations\"}", isOptional: true)]
            public digitalocean.App.IAppSpecWorkerAlertDestinations? Destinations
            {
