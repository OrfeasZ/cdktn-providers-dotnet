...
{
    [JsiiClass(nativeType: typeof(digitalocean.App.AppSpecFunctionCorsOutputReference), fullyQualifiedName: "digitalocean.app.AppSpecFunctionCorsOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktn.IInterpolatingParent\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}}]")]
    public class AppSpecFunctionCorsOutputReference : Io.Cdktn.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        public AppSpecFunctionCorsOutputReference(Io.Cdktn.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
        ...
        protected AppSpecFunctionCorsOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected AppSpecFunctionCorsOutputReference(DeputyProps props): base(props)
        {
        }

        [JsiiMethod(name: "putAllowOrigins", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"digitalocean.app.AppSpecFunctionCorsAllowOrigins\"}}]")]
        public virtual void PutAllowOrigins(digitalocean.App.IAppSpecFunctionCorsAllowOrigins @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(digitalocean.App.IAppSpecFunctionCorsAllowOrigins)}, new object[]{@value});
        }
        ...
        [JsiiProperty(name: "allowOrigins", typeJson: "{\"fqn\":\"digitalocean.app.AppSpecFunctionCorsAllowOriginsOutputReference\"}")]
        public virtual digitalocean.App.AppSpecFunctionCorsAllowOriginsOutputReference AllowOrigins
        {
            get => GetInstanceProperty<digitalocean.App.AppSpecFunctionCorsAllowOriginsOutputReference>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "allowOriginsInput", typeJson: "{\"fqn\":\"digitalocean.app.AppSpecFunctionCorsAllowOrigins\"}", isOptional: true)]
        public virtual digitalocean.App.IAppSpecFunctionCorsAllowOrigins? AllowOriginsInput
        {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"digitalocean.app.AppSpecFunctionCors\"}", isOptional: true)]
        public virtual digitalocean.App.IAppSpecFunctionCors? InternalValue
        {
