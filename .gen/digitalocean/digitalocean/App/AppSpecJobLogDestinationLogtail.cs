...
namespace digitalocean.App
{
    ...
    [JsiiByValue(fqn: "digitalocean.app.AppSpecJobLogDestinationLogtail")]
    public class AppSpecJobLogDestinationLogtail : digitalocean.App.IAppSpecJobLogDestinationLogtail
    {
