...
{
    [JsiiInterface(nativeType: typeof(IAppSpecStaticSiteCors), fullyQualifiedName: "digitalocean.app.AppSpecStaticSiteCors")]
    public interface IAppSpecStaticSiteCors
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        digitalocean.App.IAppSpecStaticSiteCorsAllowOrigins? AllowOrigins
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IAppSpecStaticSiteCors), fullyQualifiedName: "digitalocean.app.AppSpecStaticSiteCors")]
        internal sealed class _Proxy : DeputyBase, digitalocean.App.IAppSpecStaticSiteCors
        {
