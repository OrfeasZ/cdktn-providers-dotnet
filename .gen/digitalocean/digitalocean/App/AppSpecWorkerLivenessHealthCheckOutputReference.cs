...
{
    [JsiiClass(nativeType: typeof(digitalocean.App.AppSpecWorkerLivenessHealthCheckOutputReference), fullyQualifiedName: "digitalocean.app.AppSpecWorkerLivenessHealthCheckOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktn.IInterpolatingParent\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}}]")]
    public class AppSpecWorkerLivenessHealthCheckOutputReference : Io.Cdktn.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        public AppSpecWorkerLivenessHealthCheckOutputReference(Io.Cdktn.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
        ...
        protected AppSpecWorkerLivenessHealthCheckOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected AppSpecWorkerLivenessHealthCheckOutputReference(DeputyProps props): base(props)
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"digitalocean.app.AppSpecWorkerLivenessHealthCheck\"}", isOptional: true)]
        public virtual digitalocean.App.IAppSpecWorkerLivenessHealthCheck? InternalValue
        {
            get => GetInstanceProperty<digitalocean.App.IAppSpecWorkerLivenessHealthCheck?>();
            set => SetInstanceProperty(value);
        }
    }
}
