...
{
    [JsiiInterface(nativeType: typeof(IAppSpecJobLogDestinationOpenSearch), fullyQualifiedName: "digitalocean.app.AppSpecJobLogDestinationOpenSearch")]
    public interface IAppSpecJobLogDestinationOpenSearch
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "basicAuth", typeJson: "{\"fqn\":\"digitalocean.app.AppSpecJobLogDestinationOpenSearchBasicAuth\"}")]
        digitalocean.App.IAppSpecJobLogDestinationOpenSearchBasicAuth BasicAuth
        {
            get;
        }
        ...
        [JsiiTypeProxy(nativeType: typeof(IAppSpecJobLogDestinationOpenSearch), fullyQualifiedName: "digitalocean.app.AppSpecJobLogDestinationOpenSearch")]
        internal sealed class _Proxy : DeputyBase, digitalocean.App.IAppSpecJobLogDestinationOpenSearch
        {
            ...
            /// </remarks>
            [JsiiProperty(name: "basicAuth", typeJson: "{\"fqn\":\"digitalocean.app.AppSpecJobLogDestinationOpenSearchBasicAuth\"}")]
            public digitalocean.App.IAppSpecJobLogDestinationOpenSearchBasicAuth BasicAuth
            {
