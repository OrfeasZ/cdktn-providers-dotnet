...
namespace digitalocean.App
{
    ...
    [JsiiByValue(fqn: "digitalocean.app.AppSpecWorkerLogDestinationDatadog")]
    public class AppSpecWorkerLogDestinationDatadog : digitalocean.App.IAppSpecWorkerLogDestinationDatadog
    {
