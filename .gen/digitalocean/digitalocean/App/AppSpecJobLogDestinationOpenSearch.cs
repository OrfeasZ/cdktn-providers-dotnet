...
namespace digitalocean.App
{
    ...
    [JsiiByValue(fqn: "digitalocean.app.AppSpecJobLogDestinationOpenSearch")]
    public class AppSpecJobLogDestinationOpenSearch : digitalocean.App.IAppSpecJobLogDestinationOpenSearch
    {
