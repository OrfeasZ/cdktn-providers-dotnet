...
{
    [JsiiInterface(nativeType: typeof(IAppSpecIngressRuleCors), fullyQualifiedName: "digitalocean.app.AppSpecIngressRuleCors")]
    public interface IAppSpecIngressRuleCors
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        digitalocean.App.IAppSpecIngressRuleCorsAllowOrigins? AllowOrigins
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IAppSpecIngressRuleCors), fullyQualifiedName: "digitalocean.app.AppSpecIngressRuleCors")]
        internal sealed class _Proxy : DeputyBase, digitalocean.App.IAppSpecIngressRuleCors
        {
