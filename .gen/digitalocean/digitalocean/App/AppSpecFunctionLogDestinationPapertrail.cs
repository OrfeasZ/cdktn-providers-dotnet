...
namespace digitalocean.App
{
    ...
    [JsiiByValue(fqn: "digitalocean.app.AppSpecFunctionLogDestinationPapertrail")]
    public class AppSpecFunctionLogDestinationPapertrail : digitalocean.App.IAppSpecFunctionLogDestinationPapertrail
    {
