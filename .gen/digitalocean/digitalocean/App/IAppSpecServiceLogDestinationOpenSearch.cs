...
{
    [JsiiInterface(nativeType: typeof(IAppSpecServiceLogDestinationOpenSearch), fullyQualifiedName: "digitalocean.app.AppSpecServiceLogDestinationOpenSearch")]
    public interface IAppSpecServiceLogDestinationOpenSearch
    {
        ...
        digitalocean.App.IAppSpecServiceLogDestinationOpenSearchBasicAuth BasicAuth
        {
            get;
        }
        ...
        [JsiiTypeProxy(nativeType: typeof(IAppSpecServiceLogDestinationOpenSearch), fullyQualifiedName: "digitalocean.app.AppSpecServiceLogDestinationOpenSearch")]
        internal sealed class _Proxy : DeputyBase, digitalocean.App.IAppSpecServiceLogDestinationOpenSearch
        {
