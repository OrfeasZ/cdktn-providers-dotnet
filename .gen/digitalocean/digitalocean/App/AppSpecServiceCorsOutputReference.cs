...
{
    [JsiiClass(nativeType: typeof(digitalocean.App.AppSpecServiceCorsOutputReference), fullyQualifiedName: "digitalocean.app.AppSpecServiceCorsOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktn.IInterpolatingParent\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}}]")]
    public class AppSpecServiceCorsOutputReference : Io.Cdktn.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        public AppSpecServiceCorsOutputReference(Io.Cdktn.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
        ...
        protected AppSpecServiceCorsOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected AppSpecServiceCorsOutputReference(DeputyProps props): base(props)
        {
        }

        [JsiiMethod(name: "putAllowOrigins", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"digitalocean.app.AppSpecServiceCorsAllowOrigins\"}}]")]
        public virtual void PutAllowOrigins(digitalocean.App.IAppSpecServiceCorsAllowOrigins @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(digitalocean.App.IAppSpecServiceCorsAllowOrigins)}, new object[]{@value});
        }
        ...
        [JsiiProperty(name: "allowOrigins", typeJson: "{\"fqn\":\"digitalocean.app.AppSpecServiceCorsAllowOriginsOutputReference\"}")]
        public virtual digitalocean.App.AppSpecServiceCorsAllowOriginsOutputReference AllowOrigins
        {
            get => GetInstanceProperty<digitalocean.App.AppSpecServiceCorsAllowOriginsOutputReference>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "allowOriginsInput", typeJson: "{\"fqn\":\"digitalocean.app.AppSpecServiceCorsAllowOrigins\"}", isOptional: true)]
        public virtual digitalocean.App.IAppSpecServiceCorsAllowOrigins? AllowOriginsInput
        {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"digitalocean.app.AppSpecServiceCors\"}", isOptional: true)]
        public virtual digitalocean.App.IAppSpecServiceCors? InternalValue
        {
