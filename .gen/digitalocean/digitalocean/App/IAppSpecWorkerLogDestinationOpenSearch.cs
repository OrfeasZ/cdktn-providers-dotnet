...
{
    [JsiiInterface(nativeType: typeof(IAppSpecWorkerLogDestinationOpenSearch), fullyQualifiedName: "digitalocean.app.AppSpecWorkerLogDestinationOpenSearch")]
    public interface IAppSpecWorkerLogDestinationOpenSearch
    {
        ...
        digitalocean.App.IAppSpecWorkerLogDestinationOpenSearchBasicAuth BasicAuth
        {
            get;
        }
        ...
        [JsiiTypeProxy(nativeType: typeof(IAppSpecWorkerLogDestinationOpenSearch), fullyQualifiedName: "digitalocean.app.AppSpecWorkerLogDestinationOpenSearch")]
        internal sealed class _Proxy : DeputyBase, digitalocean.App.IAppSpecWorkerLogDestinationOpenSearch
        {
