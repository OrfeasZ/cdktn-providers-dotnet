...
{
    [JsiiByValue(fqn: "digitalocean.app.AppSpecStaticSiteCors")]
    public class AppSpecStaticSiteCors : digitalocean.App.IAppSpecStaticSiteCors
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "allowOrigins", typeJson: "{\"fqn\":\"digitalocean.app.AppSpecStaticSiteCorsAllowOrigins\"}", isOptional: true)]
        public digitalocean.App.IAppSpecStaticSiteCorsAllowOrigins? AllowOrigins
        {
            get;
            set;
        }
