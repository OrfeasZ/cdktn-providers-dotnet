...
namespace digitalocean.KubernetesCluster
{
    ...
    public class KubernetesClusterSsoOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        protected KubernetesClusterSsoOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected KubernetesClusterSsoOutputReference(DeputyProps props): base(props)
        {
        }
