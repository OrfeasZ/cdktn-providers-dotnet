...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.100.0/docs/resources/kubernetes_cluster digitalocean_kubernetes_cluster}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.100.0/docs/resources/kubernetes_cluster digitalocean_kubernetes_cluster} Resource.</summary>
        ...
        [JsiiMethod(name: "putCorednsAutoscaler", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"digitalocean.kubernetesCluster.KubernetesClusterCorednsAutoscaler\"}}]")]
        public virtual void PutCorednsAutoscaler(digitalocean.KubernetesCluster.IKubernetesClusterCorednsAutoscaler @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(digitalocean.KubernetesCluster.IKubernetesClusterCorednsAutoscaler)}, new object[]{@value});
        }
        ...
        [JsiiMethod(name: "resetIsolatedWorkers")]
        public virtual void ResetIsolatedWorkers()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        [JsiiMethod(name: "resetWorkerSubnetUuid")]
        public virtual void ResetWorkerSubnetUuid()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        [JsiiProperty(name: "corednsAutoscaler", typeJson: "{\"fqn\":\"digitalocean.kubernetesCluster.KubernetesClusterCorednsAutoscalerOutputReference\"}")]
        public virtual digitalocean.KubernetesCluster.KubernetesClusterCorednsAutoscalerOutputReference CorednsAutoscaler
        {
            get => GetInstanceProperty<digitalocean.KubernetesCluster.KubernetesClusterCorednsAutoscalerOutputReference>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "corednsAutoscalerInput", typeJson: "{\"fqn\":\"digitalocean.kubernetesCluster.KubernetesClusterCorednsAutoscaler\"}", isOptional: true)]
        public virtual digitalocean.KubernetesCluster.IKubernetesClusterCorednsAutoscaler? CorednsAutoscalerInput
        {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "isolatedWorkersInput", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktn.IResolvable\"}]}}", isOptional: true)]
        public virtual object? IsolatedWorkersInput
        {
            get => GetInstanceProperty<object?>();
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "workerSubnetUuidInput", typeJson: "{\"primitive\":\"string\"}", isOptional: true)]
        public virtual string? WorkerSubnetUuidInput
        {
            get => GetInstanceProperty<string?>();
        }
        ...
        /// <para>Type union: either bool or <see cref="Io.Cdktn.IResolvable" /></para>
        /// </remarks>
        [JsiiProperty(name: "isolatedWorkers", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktn.IResolvable\"}]}}")]
        public virtual object IsolatedWorkers
        {
            get => GetInstanceProperty<object>()!;
            set
            {
