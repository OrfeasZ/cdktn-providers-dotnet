...
namespace tailscale.DeviceAuthorization
{
    ...
    [JsiiByValue(fqn: "tailscale.deviceAuthorization.DeviceAuthorizationConfig")]
    public class DeviceAuthorizationConfig : tailscale.DeviceAuthorization.IDeviceAuthorizationConfig
    {
