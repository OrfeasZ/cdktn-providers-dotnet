...
namespace tailscale.DnsSplitNameservers
{
    ...
    [JsiiByValue(fqn: "tailscale.dnsSplitNameservers.DnsSplitNameserversConfig")]
    public class DnsSplitNameserversConfig : tailscale.DnsSplitNameservers.IDnsSplitNameserversConfig
    {
