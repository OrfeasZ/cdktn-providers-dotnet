...
{
    [JsiiInterface(nativeType: typeof(ILogstreamConfigurationConfig), fullyQualifiedName: "tailscale.logstreamConfiguration.LogstreamConfigurationConfig")]
    public interface ILogstreamConfigurationConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ILogstreamConfigurationConfig), fullyQualifiedName: "tailscale.logstreamConfiguration.LogstreamConfigurationConfig")]
        internal sealed class _Proxy : DeputyBase, tailscale.LogstreamConfiguration.ILogstreamConfigurationConfig
        {
