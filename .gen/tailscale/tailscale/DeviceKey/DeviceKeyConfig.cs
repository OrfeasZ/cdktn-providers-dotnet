...
namespace tailscale.DeviceKey
{
    ...
    [JsiiByValue(fqn: "tailscale.deviceKey.DeviceKeyConfig")]
    public class DeviceKeyConfig : tailscale.DeviceKey.IDeviceKeyConfig
    {
        ...
        private object? _keyExpiryDisabled;
