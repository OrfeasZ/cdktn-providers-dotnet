...
namespace tailscale.PostureIntegration
{
    ...
    [JsiiByValue(fqn: "tailscale.postureIntegration.PostureIntegrationConfig")]
    public class PostureIntegrationConfig : tailscale.PostureIntegration.IPostureIntegrationConfig
    {
