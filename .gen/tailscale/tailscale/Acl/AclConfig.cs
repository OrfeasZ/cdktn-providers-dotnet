...
namespace tailscale.Acl
{
    ...
    [JsiiByValue(fqn: "tailscale.acl.AclConfig")]
    public class AclConfig : tailscale.Acl.IAclConfig
    {
        ...
        private object? _overwriteExistingContent;
        ...
        public object? OverwriteExistingContent
        {
            ...
            set
            {
                ...
                _overwriteExistingContent = value;
            }
        }

        private object? _resetAclOnDestroy;
