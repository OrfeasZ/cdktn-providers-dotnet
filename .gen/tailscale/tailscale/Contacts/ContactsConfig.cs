...
{
    [JsiiByValue(fqn: "tailscale.contacts.ContactsConfig")]
    public class ContactsConfig : tailscale.Contacts.IContactsConfig
    {
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        case Io.Cdktn.IResolvable cast_cd4240:
                            break;
                        case tailscale.Contacts.IContactsAccount[] cast_cd4240:
                            break;
                        ...
                        case null:
                            break;
                        default:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(tailscale.Contacts.IContactsAccount).FullName}[]; received {value.GetType().FullName}", nameof(value));
                    }
                }
                _account = value;
            }
            ...
            set
            {
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        case Io.Cdktn.IResolvable cast_cd4240:
                            break;
                        case tailscale.Contacts.IContactsSupport[] cast_cd4240:
                            break;
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            // Not enough information to type-check...
                            break;
                        case null:
                            break;
                        default:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(tailscale.Contacts.IContactsSupport).FullName}[]; received {value.GetType().FullName}", nameof(value));
                    }
                }
                _support = value;
            }
