...
namespace tailscale.DnsPreferences
{
    ...
    [JsiiByValue(fqn: "tailscale.dnsPreferences.DnsPreferencesConfig")]
    public class DnsPreferencesConfig : tailscale.DnsPreferences.IDnsPreferencesConfig
    {
        private object _magicDns;
