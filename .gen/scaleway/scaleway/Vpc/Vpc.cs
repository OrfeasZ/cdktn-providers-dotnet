...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.73.0/docs/resources/vpc scaleway_vpc}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.73.0/docs/resources/vpc scaleway_vpc} Resource.</summary>
        ...
        private static DeputyProps _MakeDeputyProps(Constructs.Construct scope, string id, scaleway.Vpc.IVpcConfig? config = null)
        {
        ...
        [JsiiMethod(name: "resetEnableCustomRoutesPropagation")]
        public virtual void ResetEnableCustomRoutesPropagation()
        {
        ...
        = GetStaticProperty<string>(typeof(scaleway.Vpc.Vpc))!;
        ...
        [JsiiOptional]
        [JsiiProperty(name: "enableCustomRoutesPropagationInput", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktn.IResolvable\"}]}}", isOptional: true)]
        public virtual object? EnableCustomRoutesPropagationInput
        {
            get => GetInstanceProperty<object?>();
        }

        [JsiiOptional]
        [JsiiProperty(name: "enableRoutingInput", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktn.IResolvable\"}]}}", isOptional: true)]
        public virtual object? EnableRoutingInput
        {
            get => GetInstanceProperty<object?>();
        }
        ...
        [JsiiProperty(name: "enableCustomRoutesPropagation", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktn.IResolvable\"}]}}")]
        public virtual object EnableCustomRoutesPropagation
        {
            get => GetInstanceProperty<object>()!;
            set
            {
