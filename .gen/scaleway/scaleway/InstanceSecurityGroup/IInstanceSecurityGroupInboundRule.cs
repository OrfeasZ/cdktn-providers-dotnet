...
{
    [JsiiInterface(nativeType: typeof(IInstanceSecurityGroupInboundRule), fullyQualifiedName: "scaleway.instanceSecurityGroup.InstanceSecurityGroupInboundRule")]
    public interface IInstanceSecurityGroupInboundRule
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IInstanceSecurityGroupInboundRule), fullyQualifiedName: "scaleway.instanceSecurityGroup.InstanceSecurityGroupInboundRule")]
        internal sealed class _Proxy : DeputyBase, scaleway.InstanceSecurityGroup.IInstanceSecurityGroupInboundRule
        {
