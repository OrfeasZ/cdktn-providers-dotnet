...
namespace scaleway.DataScalewayEdgeServicesRouteStage
{
    ...
    public interface IDataScalewayEdgeServicesRouteStageConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataScalewayEdgeServicesRouteStageConfig), fullyQualifiedName: "scaleway.dataScalewayEdgeServicesRouteStage.DataScalewayEdgeServicesRouteStageConfig")]
        internal sealed class _Proxy : DeputyBase, scaleway.DataScalewayEdgeServicesRouteStage.IDataScalewayEdgeServicesRouteStageConfig
        {
