...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.81.0/docs/resources/rdb_instance scaleway_rdb_instance}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.81.0/docs/resources/rdb_instance scaleway_rdb_instance} Resource.</summary>
        ...
        /// <param name="value">Type union: either <see cref="Io.Cdktn.IResolvable" /> or (<see cref="scaleway.RdbInstance.IRdbInstancePrivateIp" />)[]</param>
        ...
        [JsiiProperty(name: "maintenances", typeJson: "{\"fqn\":\"scaleway.rdbInstance.RdbInstanceMaintenancesList\"}")]
        public virtual scaleway.RdbInstance.RdbInstanceMaintenancesList Maintenances
        {
            get => GetInstanceProperty<scaleway.RdbInstance.RdbInstanceMaintenancesList>()!;
        }
        ...
        /// <remarks>
        /// <para>Type union: either <see cref="Io.Cdktn.IResolvable" /> or <see cref="scaleway.RdbInstance.IRdbInstanceTimeouts" /></para>
        /// </remarks>
        [JsiiOptional]
