...
namespace scaleway.DatawarehouseDeployment
{
    ...
    public class DatawarehouseDeploymentPublicNetworkOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        protected DatawarehouseDeploymentPublicNetworkOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected DatawarehouseDeploymentPublicNetworkOutputReference(DeputyProps props): base(props)
        {
        }
        ...
        [JsiiProperty(name: "services", typeJson: "{\"fqn\":\"scaleway.datawarehouseDeployment.DatawarehouseDeploymentPublicNetworkServicesList\"}")]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"scaleway.datawarehouseDeployment.DatawarehouseDeploymentPublicNetwork\"}", isOptional: true)]
        public virtual scaleway.DatawarehouseDeployment.IDatawarehouseDeploymentPublicNetwork? InternalValue
        {
            get => GetInstanceProperty<scaleway.DatawarehouseDeployment.IDatawarehouseDeploymentPublicNetwork?>();
