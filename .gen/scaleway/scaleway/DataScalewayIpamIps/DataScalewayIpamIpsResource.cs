...
namespace scaleway.DataScalewayIpamIps
{
    ...
    [JsiiByValue(fqn: "scaleway.dataScalewayIpamIps.DataScalewayIpamIpsResource")]
    public class DataScalewayIpamIpsResource : scaleway.DataScalewayIpamIps.IDataScalewayIpamIpsResource
    {
