...
namespace scaleway.OpensearchDeployment
{
    ...
    [JsiiByValue(fqn: "scaleway.opensearchDeployment.OpensearchDeploymentConfig")]
    public class OpensearchDeploymentConfig : scaleway.OpensearchDeployment.IOpensearchDeploymentConfig
    {
