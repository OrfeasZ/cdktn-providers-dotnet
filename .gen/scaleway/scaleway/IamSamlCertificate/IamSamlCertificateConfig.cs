...
namespace scaleway.IamSamlCertificate
{
    ...
    [JsiiByValue(fqn: "scaleway.iamSamlCertificate.IamSamlCertificateConfig")]
    public class IamSamlCertificateConfig : scaleway.IamSamlCertificate.IIamSamlCertificateConfig
    {
