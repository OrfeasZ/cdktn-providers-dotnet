...
{
    [JsiiInterface(nativeType: typeof(IAppleSiliconServerPrivateNetwork), fullyQualifiedName: "scaleway.appleSiliconServer.AppleSiliconServerPrivateNetwork")]
    public interface IAppleSiliconServerPrivateNetwork
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IAppleSiliconServerPrivateNetwork), fullyQualifiedName: "scaleway.appleSiliconServer.AppleSiliconServerPrivateNetwork")]
        internal sealed class _Proxy : DeputyBase, scaleway.AppleSiliconServer.IAppleSiliconServerPrivateNetwork
        {
