...
{
    [JsiiInterface(nativeType: typeof(IDataScalewayKafkaVersionConfig), fullyQualifiedName: "scaleway.dataScalewayKafkaVersion.DataScalewayKafkaVersionConfig")]
    public interface IDataScalewayKafkaVersionConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataScalewayKafkaVersionConfig), fullyQualifiedName: "scaleway.dataScalewayKafkaVersion.DataScalewayKafkaVersionConfig")]
        internal sealed class _Proxy : DeputyBase, scaleway.DataScalewayKafkaVersion.IDataScalewayKafkaVersionConfig
        {
