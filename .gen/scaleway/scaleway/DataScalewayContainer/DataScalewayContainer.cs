...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.76.0/docs/data-sources/container scaleway_container}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.76.0/docs/data-sources/container scaleway_container} Data Source.</summary>
        ...
        [JsiiProperty(name: "httpsConnectionsOnly", typeJson: "{\"fqn\":\"cdktn.IResolvable\"}")]
        public virtual Io.Cdktn.IResolvable HttpsConnectionsOnly
        {
            get => GetInstanceProperty<Io.Cdktn.IResolvable>()!;
        }
        ...
        [JsiiProperty(name: "livenessProbe", typeJson: "{\"fqn\":\"scaleway.dataScalewayContainer.DataScalewayContainerLivenessProbeList\"}")]
        public virtual scaleway.DataScalewayContainer.DataScalewayContainerLivenessProbeList LivenessProbe
        {
            get => GetInstanceProperty<scaleway.DataScalewayContainer.DataScalewayContainerLivenessProbeList>()!;
        }
        ...
        [JsiiProperty(name: "startupProbe", typeJson: "{\"fqn\":\"scaleway.dataScalewayContainer.DataScalewayContainerStartupProbeList\"}")]
        public virtual scaleway.DataScalewayContainer.DataScalewayContainerStartupProbeList StartupProbe
        {
            get => GetInstanceProperty<scaleway.DataScalewayContainer.DataScalewayContainerStartupProbeList>()!;
        }
