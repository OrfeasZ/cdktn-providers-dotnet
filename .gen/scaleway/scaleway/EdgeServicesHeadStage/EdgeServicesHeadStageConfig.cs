...
namespace scaleway.EdgeServicesHeadStage
{
    ...
    [JsiiByValue(fqn: "scaleway.edgeServicesHeadStage.EdgeServicesHeadStageConfig")]
    public class EdgeServicesHeadStageConfig : scaleway.EdgeServicesHeadStage.IEdgeServicesHeadStageConfig
    {
