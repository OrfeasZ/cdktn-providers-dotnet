...
namespace scaleway.ObjectBucketServerSideEncryptionConfiguration
{
    ...
    public interface IObjectBucketServerSideEncryptionConfigurationRuleApplyServerSideEncryptionByDefault
    {
        ...
        internal sealed class _Proxy : DeputyBase, scaleway.ObjectBucketServerSideEncryptionConfiguration.IObjectBucketServerSideEncryptionConfigurationRuleApplyServerSideEncryptionByDefault
        {
