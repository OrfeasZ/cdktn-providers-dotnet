...
{
    [JsiiInterface(nativeType: typeof(IObjectBucketServerSideEncryptionConfigurationConfig), fullyQualifiedName: "scaleway.objectBucketServerSideEncryptionConfiguration.ObjectBucketServerSideEncryptionConfigurationConfig")]
    public interface IObjectBucketServerSideEncryptionConfigurationConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IObjectBucketServerSideEncryptionConfigurationConfig), fullyQualifiedName: "scaleway.objectBucketServerSideEncryptionConfiguration.ObjectBucketServerSideEncryptionConfigurationConfig")]
        internal sealed class _Proxy : DeputyBase, scaleway.ObjectBucketServerSideEncryptionConfiguration.IObjectBucketServerSideEncryptionConfigurationConfig
        {
