...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.79.0/docs/resources/job_definition scaleway_job_definition}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.79.0/docs/resources/job_definition scaleway_job_definition} Resource.</summary>
        ...
        [JsiiMethod(name: "putRetryPolicy", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"scaleway.jobDefinition.JobDefinitionRetryPolicy\"}}]")]
        public virtual void PutRetryPolicy(scaleway.JobDefinition.IJobDefinitionRetryPolicy @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(scaleway.JobDefinition.IJobDefinitionRetryPolicy)}, new object[]{@value});
        }
        ...
        [JsiiProperty(name: "retryPolicy", typeJson: "{\"fqn\":\"scaleway.jobDefinition.JobDefinitionRetryPolicyOutputReference\"}")]
        public virtual scaleway.JobDefinition.JobDefinitionRetryPolicyOutputReference RetryPolicy
        {
            get => GetInstanceProperty<scaleway.JobDefinition.JobDefinitionRetryPolicyOutputReference>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "retryPolicyInput", typeJson: "{\"fqn\":\"scaleway.jobDefinition.JobDefinitionRetryPolicy\"}", isOptional: true)]
        public virtual scaleway.JobDefinition.IJobDefinitionRetryPolicy? RetryPolicyInput
        {
