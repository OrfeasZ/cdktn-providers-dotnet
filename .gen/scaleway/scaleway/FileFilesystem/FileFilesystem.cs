...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.73.0/docs/resources/file_filesystem scaleway_file_filesystem}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.73.0/docs/resources/file_filesystem scaleway_file_filesystem} Resource.</summary>
        ...
        private static DeputyProps _MakeDeputyProps(Constructs.Construct scope, string id, scaleway.FileFilesystem.IFileFilesystemConfig config)
        {
        ...
        protected FileFilesystem(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected FileFilesystem(DeputyProps props): base(props)
        {
        }

        /// <summary>Generates CDKTN code for importing a FileFilesystem resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        ...
        = GetStaticProperty<string>(typeof(scaleway.FileFilesystem.FileFilesystem))!;
