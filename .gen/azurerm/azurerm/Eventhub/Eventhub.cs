...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.80.0/docs/resources/eventhub azurerm_eventhub}.</summary>
    ...
    public class Eventhub : Io.Cdktn.TerraformResource
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.80.0/docs/resources/eventhub azurerm_eventhub} Resource.</summary>
        ...
        /// <summary>Generates CDKTN code for importing a Eventhub resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        ...
        [JsiiMethod(name: "generateConfigForImport", returnsJson: "{\"type\":{\"fqn\":\"cdktn.ImportableResource\"}}", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"summary\":\"The construct id used in the generated config for the Eventhub to import.\"},\"name\":\"importToId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"remarks\":\"Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.80.0/docs/resources/eventhub#import import section} in the documentation of this resource for the id to use\",\"summary\":\"The id of the existing Eventhub that should be imported.\"},\"name\":\"importFromId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"? Optional instance of the provider where the Eventhub to import is found.\"},\"name\":\"provider\",\"optional\":true,\"type\":{\"fqn\":\"cdktn.TerraformProvider\"}}]")]
        public static Io.Cdktn.ImportableResource GenerateConfigForImport(Constructs.Construct scope, string importToId, string importFromId, Io.Cdktn.TerraformProvider? provider = null)
        {
            return InvokeStaticMethod<Io.Cdktn.ImportableResource>(typeof(azurerm.Eventhub.Eventhub), new System.Type[]{typeof(Constructs.Construct), typeof(string), typeof(string), typeof(Io.Cdktn.TerraformProvider)}, new object?[]{scope, importToId, importFromId, provider})!;
        }
        ...
        [JsiiMethod(name: "putRetentionDescription", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"azurerm.eventhub.EventhubRetentionDescription\"}}]")]
        public virtual void PutRetentionDescription(azurerm.Eventhub.IEventhubRetentionDescription @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(azurerm.Eventhub.IEventhubRetentionDescription)}, new object[]{@value});
        }
        ...
        [JsiiMethod(name: "resetMessageRetention")]
        public virtual void ResetMessageRetention()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        [JsiiMethod(name: "resetRetentionDescription")]
        public virtual void ResetRetentionDescription()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        [JsiiProperty(name: "retentionDescription", typeJson: "{\"fqn\":\"azurerm.eventhub.EventhubRetentionDescriptionOutputReference\"}")]
        public virtual azurerm.Eventhub.EventhubRetentionDescriptionOutputReference RetentionDescription
        {
            get => GetInstanceProperty<azurerm.Eventhub.EventhubRetentionDescriptionOutputReference>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "retentionDescriptionInput", typeJson: "{\"fqn\":\"azurerm.eventhub.EventhubRetentionDescription\"}", isOptional: true)]
        public virtual azurerm.Eventhub.IEventhubRetentionDescription? RetentionDescriptionInput
        {
        ...
        /// <remarks>
        /// <para>Type union: either <see cref="Io.Cdktn.IResolvable" /> or <see cref="azurerm.Eventhub.IEventhubTimeouts" /></para>
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "timeoutsInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"azurerm.eventhub.EventhubTimeouts\"}]}}", isOptional: true)]
