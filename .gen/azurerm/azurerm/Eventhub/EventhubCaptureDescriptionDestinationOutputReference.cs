...
{
    [JsiiClass(nativeType: typeof(azurerm.Eventhub.EventhubCaptureDescriptionDestinationOutputReference), fullyQualifiedName: "azurerm.eventhub.EventhubCaptureDescriptionDestinationOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktn.IInterpolatingParent\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}}]")]
    public class EventhubCaptureDescriptionDestinationOutputReference : Io.Cdktn.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        public EventhubCaptureDescriptionDestinationOutputReference(Io.Cdktn.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
        ...
        [JsiiMethod(name: "resetStorageAuthenticationId")]
        public virtual void ResetStorageAuthenticationId()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }

        [JsiiMethod(name: "resetStorageAuthenticationType")]
        public virtual void ResetStorageAuthenticationType()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "storageAuthenticationIdInput", typeJson: "{\"primitive\":\"string\"}", isOptional: true)]
        public virtual string? StorageAuthenticationIdInput
        {
            get => GetInstanceProperty<string?>();
        }
        ...
        [JsiiProperty(name: "storageAuthenticationId", typeJson: "{\"primitive\":\"string\"}")]
        public virtual string StorageAuthenticationId
        {
            get => GetInstanceProperty<string>()!;
            set => SetInstanceProperty(value);
        }
