...
{
    [JsiiClass(nativeType: typeof(azurerm.ContainerApp.ContainerAppIngressCorsOutputReference), fullyQualifiedName: "azurerm.containerApp.ContainerAppIngressCorsOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktn.IInterpolatingParent\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}}]")]
    public class ContainerAppIngressCorsOutputReference : Io.Cdktn.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        public ContainerAppIngressCorsOutputReference(Io.Cdktn.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
        ...
        protected ContainerAppIngressCorsOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected ContainerAppIngressCorsOutputReference(DeputyProps props): base(props)
        {
        }

        [JsiiMethod(name: "resetAllowCredentialsEnabled")]
        public virtual void ResetAllowCredentialsEnabled()
        {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "allowCredentialsEnabledInput", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktn.IResolvable\"}]}}", isOptional: true)]
        public virtual object? AllowCredentialsEnabledInput
        {
        ...
        /// <para>Type union: either bool or <see cref="Io.Cdktn.IResolvable" /></para>
        /// </remarks>
        [JsiiProperty(name: "allowCredentialsEnabled", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktn.IResolvable\"}]}}")]
        public virtual object AllowCredentialsEnabled
        {
            get => GetInstanceProperty<object>()!;
            set
            {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"azurerm.containerApp.ContainerAppIngressCors\"}", isOptional: true)]
        public virtual azurerm.ContainerApp.IContainerAppIngressCors? InternalValue
        {
