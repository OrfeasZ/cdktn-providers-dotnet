...
{
    [JsiiInterface(nativeType: typeof(IMssqlJobTimeouts), fullyQualifiedName: "azurerm.mssqlJob.MssqlJobTimeouts")]
    public interface IMssqlJobTimeouts
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IMssqlJobTimeouts), fullyQualifiedName: "azurerm.mssqlJob.MssqlJobTimeouts")]
        internal sealed class _Proxy : DeputyBase, azurerm.MssqlJob.IMssqlJobTimeouts
        {
