...
{
    [JsiiClass(nativeType: typeof(azurerm.LinuxVirtualMachineScaleSet.LinuxVirtualMachineScaleSetOsDiskOutputReference), fullyQualifiedName: "azurerm.linuxVirtualMachineScaleSet.LinuxVirtualMachineScaleSetOsDiskOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktn.IInterpolatingParent\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}}]")]
    public class LinuxVirtualMachineScaleSetOsDiskOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        [JsiiMethod(name: "putDiffDiskSettings", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"azurerm.linuxVirtualMachineScaleSet.LinuxVirtualMachineScaleSetOsDiskDiffDiskSettings\"}}]")]
        public virtual void PutDiffDiskSettings(azurerm.LinuxVirtualMachineScaleSet.ILinuxVirtualMachineScaleSetOsDiskDiffDiskSettings @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(azurerm.LinuxVirtualMachineScaleSet.ILinuxVirtualMachineScaleSetOsDiskDiffDiskSettings)}, new object[]{@value});
        }
        ...
        [JsiiProperty(name: "diffDiskSettings", typeJson: "{\"fqn\":\"azurerm.linuxVirtualMachineScaleSet.LinuxVirtualMachineScaleSetOsDiskDiffDiskSettingsOutputReference\"}")]
        public virtual azurerm.LinuxVirtualMachineScaleSet.LinuxVirtualMachineScaleSetOsDiskDiffDiskSettingsOutputReference DiffDiskSettings
        {
            get => GetInstanceProperty<azurerm.LinuxVirtualMachineScaleSet.LinuxVirtualMachineScaleSetOsDiskDiffDiskSettingsOutputReference>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "diffDiskSettingsInput", typeJson: "{\"fqn\":\"azurerm.linuxVirtualMachineScaleSet.LinuxVirtualMachineScaleSetOsDiskDiffDiskSettings\"}", isOptional: true)]
        public virtual azurerm.LinuxVirtualMachineScaleSet.ILinuxVirtualMachineScaleSetOsDiskDiffDiskSettings? DiffDiskSettingsInput
        {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"azurerm.linuxVirtualMachineScaleSet.LinuxVirtualMachineScaleSetOsDisk\"}", isOptional: true)]
        public virtual azurerm.LinuxVirtualMachineScaleSet.ILinuxVirtualMachineScaleSetOsDisk? InternalValue
        {
