...
namespace azurerm.LinuxVirtualMachineScaleSet
{
    ...
    public class LinuxVirtualMachineScaleSetDataDiskOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"azurerm.linuxVirtualMachineScaleSet.LinuxVirtualMachineScaleSetDataDisk\"}]}}", isOptional: true)]
