...
namespace azurerm.ApiManagementDiagnostic
{
    ...
    public class ApiManagementDiagnosticBackendResponseDataMaskingQueryParamsOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"azurerm.apiManagementDiagnostic.ApiManagementDiagnosticBackendResponseDataMaskingQueryParams\"}]}}", isOptional: true)]
