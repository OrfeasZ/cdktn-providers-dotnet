...
namespace azurerm.ApiManagementDiagnostic
{
    ...
    public class ApiManagementDiagnosticBackendResponseDataMaskingHeadersOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"azurerm.apiManagementDiagnostic.ApiManagementDiagnosticBackendResponseDataMaskingHeaders\"}]}}", isOptional: true)]
