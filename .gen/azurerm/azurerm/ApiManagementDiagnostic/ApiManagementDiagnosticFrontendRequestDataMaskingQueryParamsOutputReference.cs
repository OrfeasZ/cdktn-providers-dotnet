...
namespace azurerm.ApiManagementDiagnostic
{
    ...
    public class ApiManagementDiagnosticFrontendRequestDataMaskingQueryParamsOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"azurerm.apiManagementDiagnostic.ApiManagementDiagnosticFrontendRequestDataMaskingQueryParams\"}]}}", isOptional: true)]
