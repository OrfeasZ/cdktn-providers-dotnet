...
{
    [JsiiClass(nativeType: typeof(azurerm.ContainerGroup.ContainerGroupContainerLivenessProbeOutputReference), fullyQualifiedName: "azurerm.containerGroup.ContainerGroupContainerLivenessProbeOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktn.IInterpolatingParent\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}}]")]
    public class ContainerGroupContainerLivenessProbeOutputReference : Io.Cdktn.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        public ContainerGroupContainerLivenessProbeOutputReference(Io.Cdktn.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
        ...
        protected ContainerGroupContainerLivenessProbeOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected ContainerGroupContainerLivenessProbeOutputReference(DeputyProps props): base(props)
        {
        }

        /// <param name="value">Type union: either <see cref="Io.Cdktn.IResolvable" /> or (<see cref="azurerm.ContainerGroup.IContainerGroupContainerLivenessProbeHttpGet" />)[]</param>
        [JsiiMethod(name: "putHttpGet", parametersJson: "[{\"name\":\"value\",\"type\":{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"azurerm.containerGroup.ContainerGroupContainerLivenessProbeHttpGet\"},\"kind\":\"array\"}}]}}}]")]
            ...
            if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
            {
                switch (@value)
                {
                    case Io.Cdktn.IResolvable cast_2ed7d7:
                        break;
                    case azurerm.ContainerGroup.IContainerGroupContainerLivenessProbeHttpGet[] cast_2ed7d7:
                        break;
                    case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_2ed7d7:
                        // Not enough information to type-check...
                        break;
                    case null:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(azurerm.ContainerGroup.IContainerGroupContainerLivenessProbeHttpGet).FullName}[]; received null", nameof(@value));
                    default:
                        throw new System.ArgumentException($"Expected argument {nameof(@value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(azurerm.ContainerGroup.IContainerGroupContainerLivenessProbeHttpGet).FullName}[]; received {@value.GetType().FullName}", nameof(@value));
                }
            }
        ...
        [JsiiProperty(name: "httpGet", typeJson: "{\"fqn\":\"azurerm.containerGroup.ContainerGroupContainerLivenessProbeHttpGetList\"}")]
        public virtual azurerm.ContainerGroup.ContainerGroupContainerLivenessProbeHttpGetList HttpGet
        {
            get => GetInstanceProperty<azurerm.ContainerGroup.ContainerGroupContainerLivenessProbeHttpGetList>()!;
        }
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "httpGetInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"azurerm.containerGroup.ContainerGroupContainerLivenessProbeHttpGet\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"azurerm.containerGroup.ContainerGroupContainerLivenessProbe\"}", isOptional: true)]
        public virtual azurerm.ContainerGroup.IContainerGroupContainerLivenessProbe? InternalValue
        {
