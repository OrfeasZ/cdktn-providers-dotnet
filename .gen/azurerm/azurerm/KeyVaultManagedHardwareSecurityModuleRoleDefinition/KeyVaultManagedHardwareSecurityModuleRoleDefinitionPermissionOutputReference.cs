...
namespace azurerm.KeyVaultManagedHardwareSecurityModuleRoleDefinition
{
    ...
    public class KeyVaultManagedHardwareSecurityModuleRoleDefinitionPermissionOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"azurerm.keyVaultManagedHardwareSecurityModuleRoleDefinition.KeyVaultManagedHardwareSecurityModuleRoleDefinitionPermission\"}]}}", isOptional: true)]
