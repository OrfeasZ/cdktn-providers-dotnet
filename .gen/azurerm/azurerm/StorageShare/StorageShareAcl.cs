...
namespace azurerm.StorageShare
{
    ...
    {
        /// <summary>Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.80.0/docs/resources/storage_share#id StorageShare#id}.</summary>
        /// <remarks>
        ...
        /// <remarks>
        /// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.80.0/docs/resources/storage_share#access_policy StorageShare#access_policy}
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case null:
                            break;
                        default:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(azurerm.StorageShare.IStorageShareAclAccessPolicy).FullName}[]; received {value.GetType().FullName}", nameof(value));
                    }
                }
                _accessPolicy = value;
            }
