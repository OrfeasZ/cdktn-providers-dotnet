...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.80.0/docs/resources/container_app_environment_certificate azurerm_container_app_environment_certificate}.</summary>
    ...
    public class ContainerAppEnvironmentCertificate : Io.Cdktn.TerraformResource
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.80.0/docs/resources/container_app_environment_certificate azurerm_container_app_environment_certificate} Resource.</summary>
        ...
        /// <summary>Generates CDKTN code for importing a ContainerAppEnvironmentCertificate resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        ...
        [JsiiMethod(name: "generateConfigForImport", returnsJson: "{\"type\":{\"fqn\":\"cdktn.ImportableResource\"}}", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"summary\":\"The construct id used in the generated config for the ContainerAppEnvironmentCertificate to import.\"},\"name\":\"importToId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"remarks\":\"Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.80.0/docs/resources/container_app_environment_certificate#import import section} in the documentation of this resource for the id to use\",\"summary\":\"The id of the existing ContainerAppEnvironmentCertificate that should be imported.\"},\"name\":\"importFromId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"? Optional instance of the provider where the ContainerAppEnvironmentCertificate to import is found.\"},\"name\":\"provider\",\"optional\":true,\"type\":{\"fqn\":\"cdktn.TerraformProvider\"}}]")]
        public static Io.Cdktn.ImportableResource GenerateConfigForImport(Constructs.Construct scope, string importToId, string importFromId, Io.Cdktn.TerraformProvider? provider = null)
        {
            return InvokeStaticMethod<Io.Cdktn.ImportableResource>(typeof(azurerm.ContainerAppEnvironmentCertificate.ContainerAppEnvironmentCertificate), new System.Type[]{typeof(Constructs.Construct), typeof(string), typeof(string), typeof(Io.Cdktn.TerraformProvider)}, new object?[]{scope, importToId, importFromId, provider})!;
        }

        [JsiiMethod(name: "putCertificateKeyVault", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"azurerm.containerAppEnvironmentCertificate.ContainerAppEnvironmentCertificateCertificateKeyVault\"}}]")]
        public virtual void PutCertificateKeyVault(azurerm.ContainerAppEnvironmentCertificate.IContainerAppEnvironmentCertificateCertificateKeyVault @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(azurerm.ContainerAppEnvironmentCertificate.IContainerAppEnvironmentCertificateCertificateKeyVault)}, new object[]{@value});
        }
        ...
        [JsiiMethod(name: "resetCertificateBlobBase64")]
        public virtual void ResetCertificateBlobBase64()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }

        [JsiiMethod(name: "resetCertificateKeyVault")]
        public virtual void ResetCertificateKeyVault()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        [JsiiProperty(name: "certificateKeyVault", typeJson: "{\"fqn\":\"azurerm.containerAppEnvironmentCertificate.ContainerAppEnvironmentCertificateCertificateKeyVaultOutputReference\"}")]
        public virtual azurerm.ContainerAppEnvironmentCertificate.ContainerAppEnvironmentCertificateCertificateKeyVaultOutputReference CertificateKeyVault
        {
            get => GetInstanceProperty<azurerm.ContainerAppEnvironmentCertificate.ContainerAppEnvironmentCertificateCertificateKeyVaultOutputReference>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "certificateKeyVaultInput", typeJson: "{\"fqn\":\"azurerm.containerAppEnvironmentCertificate.ContainerAppEnvironmentCertificateCertificateKeyVault\"}", isOptional: true)]
        public virtual azurerm.ContainerAppEnvironmentCertificate.IContainerAppEnvironmentCertificateCertificateKeyVault? CertificateKeyVaultInput
        {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "timeoutsInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"azurerm.containerAppEnvironmentCertificate.ContainerAppEnvironmentCertificateTimeouts\"}]}}", isOptional: true)]
