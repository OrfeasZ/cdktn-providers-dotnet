...
namespace azurerm.SpringCloudBuildDeployment
{
    ...
    public class SpringCloudBuildDeploymentQuotaOutputReference : Io.Cdktn.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        public SpringCloudBuildDeploymentQuotaOutputReference(Io.Cdktn.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
        ...
        protected SpringCloudBuildDeploymentQuotaOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected SpringCloudBuildDeploymentQuotaOutputReference(DeputyProps props): base(props)
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"azurerm.springCloudBuildDeployment.SpringCloudBuildDeploymentQuota\"}", isOptional: true)]
        public virtual azurerm.SpringCloudBuildDeployment.ISpringCloudBuildDeploymentQuota? InternalValue
        {
