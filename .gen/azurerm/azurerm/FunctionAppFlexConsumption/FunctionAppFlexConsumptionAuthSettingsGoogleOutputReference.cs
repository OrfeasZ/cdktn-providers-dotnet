...
namespace azurerm.FunctionAppFlexConsumption
{
    ...
    public class FunctionAppFlexConsumptionAuthSettingsGoogleOutputReference : Io.Cdktn.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        public FunctionAppFlexConsumptionAuthSettingsGoogleOutputReference(Io.Cdktn.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
        ...
        protected FunctionAppFlexConsumptionAuthSettingsGoogleOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected FunctionAppFlexConsumptionAuthSettingsGoogleOutputReference(DeputyProps props): base(props)
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"azurerm.functionAppFlexConsumption.FunctionAppFlexConsumptionAuthSettingsGoogle\"}", isOptional: true)]
        public virtual azurerm.FunctionAppFlexConsumption.IFunctionAppFlexConsumptionAuthSettingsGoogle? InternalValue
        {
