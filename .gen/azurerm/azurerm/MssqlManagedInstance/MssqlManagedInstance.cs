...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.80.0/docs/resources/mssql_managed_instance azurerm_mssql_managed_instance}.</summary>
    ...
    public class MssqlManagedInstance : Io.Cdktn.TerraformResource
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.80.0/docs/resources/mssql_managed_instance azurerm_mssql_managed_instance} Resource.</summary>
        ...
        /// <summary>Generates CDKTN code for importing a MssqlManagedInstance resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        ...
        [JsiiMethod(name: "generateConfigForImport", returnsJson: "{\"type\":{\"fqn\":\"cdktn.ImportableResource\"}}", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"summary\":\"The construct id used in the generated config for the MssqlManagedInstance to import.\"},\"name\":\"importToId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"remarks\":\"Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.80.0/docs/resources/mssql_managed_instance#import import section} in the documentation of this resource for the id to use\",\"summary\":\"The id of the existing MssqlManagedInstance that should be imported.\"},\"name\":\"importFromId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"? Optional instance of the provider where the MssqlManagedInstance to import is found.\"},\"name\":\"provider\",\"optional\":true,\"type\":{\"fqn\":\"cdktn.TerraformProvider\"}}]")]
        public static Io.Cdktn.ImportableResource GenerateConfigForImport(Constructs.Construct scope, string importToId, string importFromId, Io.Cdktn.TerraformProvider? provider = null)
        {
            return InvokeStaticMethod<Io.Cdktn.ImportableResource>(typeof(azurerm.MssqlManagedInstance.MssqlManagedInstance), new System.Type[]{typeof(Constructs.Construct), typeof(string), typeof(string), typeof(Io.Cdktn.TerraformProvider)}, new object?[]{scope, importToId, importFromId, provider})!;
        }

        [JsiiMethod(name: "putAzureActiveDirectoryAdministrator", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"azurerm.mssqlManagedInstance.MssqlManagedInstanceAzureActiveDirectoryAdministrator\"}}]")]
        public virtual void PutAzureActiveDirectoryAdministrator(azurerm.MssqlManagedInstance.IMssqlManagedInstanceAzureActiveDirectoryAdministrator @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(azurerm.MssqlManagedInstance.IMssqlManagedInstanceAzureActiveDirectoryAdministrator)}, new object[]{@value});
        }
        ...
        [JsiiMethod(name: "resetAzureActiveDirectoryAdministrator")]
        public virtual void ResetAzureActiveDirectoryAdministrator()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        [JsiiMethod(name: "resetDatabaseFormat")]
        public virtual void ResetDatabaseFormat()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        [JsiiMethod(name: "resetGeneralPurposeV2Enabled")]
        public virtual void ResetGeneralPurposeV2Enabled()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }

        [JsiiMethod(name: "resetHybridSecondaryUsage")]
        public virtual void ResetHybridSecondaryUsage()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        [JsiiMethod(name: "resetServicePrincipalType")]
        public virtual void ResetServicePrincipalType()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        [JsiiProperty(name: "azureActiveDirectoryAdministrator", typeJson: "{\"fqn\":\"azurerm.mssqlManagedInstance.MssqlManagedInstanceAzureActiveDirectoryAdministratorOutputReference\"}")]
        public virtual azurerm.MssqlManagedInstance.MssqlManagedInstanceAzureActiveDirectoryAdministratorOutputReference AzureActiveDirectoryAdministrator
        {
            get => GetInstanceProperty<azurerm.MssqlManagedInstance.MssqlManagedInstanceAzureActiveDirectoryAdministratorOutputReference>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "azureActiveDirectoryAdministratorInput", typeJson: "{\"fqn\":\"azurerm.mssqlManagedInstance.MssqlManagedInstanceAzureActiveDirectoryAdministrator\"}", isOptional: true)]
        public virtual azurerm.MssqlManagedInstance.IMssqlManagedInstanceAzureActiveDirectoryAdministrator? AzureActiveDirectoryAdministratorInput
        {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "databaseFormatInput", typeJson: "{\"primitive\":\"string\"}", isOptional: true)]
        public virtual string? DatabaseFormatInput
        {
            get => GetInstanceProperty<string?>();
        }
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "generalPurposeV2EnabledInput", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktn.IResolvable\"}]}}", isOptional: true)]
        public virtual object? GeneralPurposeV2EnabledInput
        {
            get => GetInstanceProperty<object?>();
        }

        [JsiiOptional]
        [JsiiProperty(name: "hybridSecondaryUsageInput", typeJson: "{\"primitive\":\"string\"}", isOptional: true)]
        public virtual string? HybridSecondaryUsageInput
        {
            get => GetInstanceProperty<string?>();
        }
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "publicDataEndpointEnabledInput", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktn.IResolvable\"}]}}", isOptional: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "servicePrincipalTypeInput", typeJson: "{\"primitive\":\"string\"}", isOptional: true)]
        public virtual string? ServicePrincipalTypeInput
        {
            get => GetInstanceProperty<string?>();
        }
        ...
        /// <remarks>
        /// <para>Type union: either <see cref="Io.Cdktn.IResolvable" /> or <see cref="azurerm.MssqlManagedInstance.IMssqlManagedInstanceTimeouts" /></para>
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "timeoutsInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"azurerm.mssqlManagedInstance.MssqlManagedInstanceTimeouts\"}]}}", isOptional: true)]
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "zoneRedundantEnabledInput", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktn.IResolvable\"}]}}", isOptional: true)]
        ...
        [JsiiProperty(name: "databaseFormat", typeJson: "{\"primitive\":\"string\"}")]
        public virtual string DatabaseFormat
        {
            get => GetInstanceProperty<string>()!;
            set => SetInstanceProperty(value);
        }
        ...
        /// <para>Type union: either bool or <see cref="Io.Cdktn.IResolvable" /></para>
        /// </remarks>
        [JsiiProperty(name: "generalPurposeV2Enabled", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktn.IResolvable\"}]}}")]
        public virtual object GeneralPurposeV2Enabled
        {
            get => GetInstanceProperty<object>()!;
            set
            {
        ...
        [JsiiProperty(name: "hybridSecondaryUsage", typeJson: "{\"primitive\":\"string\"}")]
        public virtual string HybridSecondaryUsage
        {
            get => GetInstanceProperty<string>()!;
            set => SetInstanceProperty(value);
        }
        ...
        /// <para>Type union: either bool or <see cref="Io.Cdktn.IResolvable" /></para>
        /// </remarks>
        [JsiiProperty(name: "publicDataEndpointEnabled", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktn.IResolvable\"}]}}")]
        ...
        [JsiiProperty(name: "servicePrincipalType", typeJson: "{\"primitive\":\"string\"}")]
        public virtual string ServicePrincipalType
        {
            get => GetInstanceProperty<string>()!;
            set => SetInstanceProperty(value);
        }
        ...
        /// <para>Type union: either bool or <see cref="Io.Cdktn.IResolvable" /></para>
        /// </remarks>
        [JsiiProperty(name: "zoneRedundantEnabled", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktn.IResolvable\"}]}}")]
