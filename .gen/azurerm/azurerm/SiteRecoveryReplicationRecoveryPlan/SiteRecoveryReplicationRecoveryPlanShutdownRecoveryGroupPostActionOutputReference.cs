...
namespace azurerm.SiteRecoveryReplicationRecoveryPlan
{
    ...
    public class SiteRecoveryReplicationRecoveryPlanShutdownRecoveryGroupPostActionOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"azurerm.siteRecoveryReplicationRecoveryPlan.SiteRecoveryReplicationRecoveryPlanShutdownRecoveryGroupPostAction\"}]}}", isOptional: true)]
