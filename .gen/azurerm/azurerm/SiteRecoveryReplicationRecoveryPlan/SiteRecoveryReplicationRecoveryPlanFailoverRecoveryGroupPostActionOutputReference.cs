...
namespace azurerm.SiteRecoveryReplicationRecoveryPlan
{
    ...
    public class SiteRecoveryReplicationRecoveryPlanFailoverRecoveryGroupPostActionOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"azurerm.siteRecoveryReplicationRecoveryPlan.SiteRecoveryReplicationRecoveryPlanFailoverRecoveryGroupPostAction\"}]}}", isOptional: true)]
