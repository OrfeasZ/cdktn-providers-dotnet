...
namespace azurerm.SiteRecoveryReplicationRecoveryPlan
{
    ...
    public class SiteRecoveryReplicationRecoveryPlanBootRecoveryGroupPostActionOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"azurerm.siteRecoveryReplicationRecoveryPlan.SiteRecoveryReplicationRecoveryPlanBootRecoveryGroupPostAction\"}]}}", isOptional: true)]
