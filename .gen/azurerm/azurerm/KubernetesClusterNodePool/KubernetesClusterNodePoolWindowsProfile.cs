...
namespace azurerm.KubernetesClusterNodePool
{
    ...
    public class KubernetesClusterNodePoolWindowsProfile : azurerm.KubernetesClusterNodePool.IKubernetesClusterNodePoolWindowsProfile
    {
        ...
        /// <summary>Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.7.0/docs/resources/kubernetes_cluster_node_pool#outbound_nat_enabled KubernetesClusterNodePool#outbound_nat_enabled}.</summary>
        /// <remarks>
