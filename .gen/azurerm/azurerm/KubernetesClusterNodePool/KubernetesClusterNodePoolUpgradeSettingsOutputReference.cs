...
namespace azurerm.KubernetesClusterNodePool
{
    ...
    public class KubernetesClusterNodePoolUpgradeSettingsOutputReference : Io.Cdktn.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        public KubernetesClusterNodePoolUpgradeSettingsOutputReference(Io.Cdktn.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
        ...
        [JsiiMethod(name: "resetUndrainableNodeBehavior")]
        public virtual void ResetUndrainableNodeBehavior()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "maxUnavailableInput", typeJson: "{\"primitive\":\"string\"}", isOptional: true)]
        public virtual string? MaxUnavailableInput
        {
            get => GetInstanceProperty<string?>();
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "undrainableNodeBehaviorInput", typeJson: "{\"primitive\":\"string\"}", isOptional: true)]
        public virtual string? UndrainableNodeBehaviorInput
        {
            get => GetInstanceProperty<string?>();
        }
        ...
        [JsiiProperty(name: "maxUnavailable", typeJson: "{\"primitive\":\"string\"}")]
        public virtual string MaxUnavailable
        {
            get => GetInstanceProperty<string>()!;
            set => SetInstanceProperty(value);
        }
        ...
        [JsiiProperty(name: "undrainableNodeBehavior", typeJson: "{\"primitive\":\"string\"}")]
        public virtual string UndrainableNodeBehavior
        {
            get => GetInstanceProperty<string>()!;
            set => SetInstanceProperty(value);
        }
