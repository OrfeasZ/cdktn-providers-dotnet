...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/key_vault_key azurerm_key_vault_key}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/key_vault_key azurerm_key_vault_key} Resource.</summary>
        ...
        [JsiiMethod(name: "generateConfigForImport", returnsJson: "{\"type\":{\"fqn\":\"cdktn.ImportableResource\"}}", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"summary\":\"The construct id used in the generated config for the KeyVaultKey to import.\"},\"name\":\"importToId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"remarks\":\"Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/key_vault_key#import import section} in the documentation of this resource for the id to use\",\"summary\":\"The id of the existing KeyVaultKey that should be imported.\"},\"name\":\"importFromId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"? Optional instance of the provider where the KeyVaultKey to import is found.\"},\"name\":\"provider\",\"optional\":true,\"type\":{\"fqn\":\"cdktn.TerraformProvider\"}}]")]
        public static Io.Cdktn.ImportableResource GenerateConfigForImport(Constructs.Construct scope, string importToId, string importFromId, Io.Cdktn.TerraformProvider? provider = null)
        {
            return InvokeStaticMethod<Io.Cdktn.ImportableResource>(typeof(azurerm.KeyVaultKey.KeyVaultKey), new System.Type[]{typeof(Constructs.Construct), typeof(string), typeof(string), typeof(Io.Cdktn.TerraformProvider)}, new object?[]{scope, importToId, importFromId, provider})!;
        }

        [JsiiMethod(name: "putReleasePolicy", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"azurerm.keyVaultKey.KeyVaultKeyReleasePolicy\"}}]")]
        public virtual void PutReleasePolicy(azurerm.KeyVaultKey.IKeyVaultKeyReleasePolicy @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(azurerm.KeyVaultKey.IKeyVaultKeyReleasePolicy)}, new object[]{@value});
        }
        ...
        [JsiiMethod(name: "resetReleasePolicy")]
        public virtual void ResetReleasePolicy()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        [JsiiProperty(name: "releasePolicy", typeJson: "{\"fqn\":\"azurerm.keyVaultKey.KeyVaultKeyReleasePolicyOutputReference\"}")]
        public virtual azurerm.KeyVaultKey.KeyVaultKeyReleasePolicyOutputReference ReleasePolicy
        {
            get => GetInstanceProperty<azurerm.KeyVaultKey.KeyVaultKeyReleasePolicyOutputReference>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "releasePolicyInput", typeJson: "{\"fqn\":\"azurerm.keyVaultKey.KeyVaultKeyReleasePolicy\"}", isOptional: true)]
        public virtual azurerm.KeyVaultKey.IKeyVaultKeyReleasePolicy? ReleasePolicyInput
        {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "timeoutsInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"azurerm.keyVaultKey.KeyVaultKeyTimeouts\"}]}}", isOptional: true)]
