...
namespace azurerm.KubernetesCluster
{
    ...
    public class KubernetesClusterNetworkProfileLoadBalancerProfileOutputReference : Io.Cdktn.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        public KubernetesClusterNetworkProfileLoadBalancerProfileOutputReference(Io.Cdktn.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
        ...
        [JsiiMethod(name: "resetBackendPoolType")]
        public virtual void ResetBackendPoolType()
        {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "backendPoolTypeInput", typeJson: "{\"primitive\":\"string\"}", isOptional: true)]
        public virtual string? BackendPoolTypeInput
        {
            get => GetInstanceProperty<string?>();
        }
        ...
        [JsiiProperty(name: "backendPoolType", typeJson: "{\"primitive\":\"string\"}")]
        public virtual string BackendPoolType
        {
            get => GetInstanceProperty<string>()!;
