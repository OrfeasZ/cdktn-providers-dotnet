...
{
    [JsiiClass(nativeType: typeof(azurerm.KubernetesCluster.KubernetesClusterNetworkProfileOutputReference), fullyQualifiedName: "azurerm.kubernetesCluster.KubernetesClusterNetworkProfileOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktn.IInterpolatingParent\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}}]")]
    public class KubernetesClusterNetworkProfileOutputReference : Io.Cdktn.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        public KubernetesClusterNetworkProfileOutputReference(Io.Cdktn.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
        ...
        [JsiiMethod(name: "putAdvancedNetworking", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"azurerm.kubernetesCluster.KubernetesClusterNetworkProfileAdvancedNetworking\"}}]")]
        public virtual void PutAdvancedNetworking(azurerm.KubernetesCluster.IKubernetesClusterNetworkProfileAdvancedNetworking @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(azurerm.KubernetesCluster.IKubernetesClusterNetworkProfileAdvancedNetworking)}, new object[]{@value});
        }
        ...
        [JsiiMethod(name: "resetAdvancedNetworking")]
        public virtual void ResetAdvancedNetworking()
        {
        ...
        [JsiiProperty(name: "advancedNetworking", typeJson: "{\"fqn\":\"azurerm.kubernetesCluster.KubernetesClusterNetworkProfileAdvancedNetworkingOutputReference\"}")]
        public virtual azurerm.KubernetesCluster.KubernetesClusterNetworkProfileAdvancedNetworkingOutputReference AdvancedNetworking
        {
            get => GetInstanceProperty<azurerm.KubernetesCluster.KubernetesClusterNetworkProfileAdvancedNetworkingOutputReference>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "advancedNetworkingInput", typeJson: "{\"fqn\":\"azurerm.kubernetesCluster.KubernetesClusterNetworkProfileAdvancedNetworking\"}", isOptional: true)]
        public virtual azurerm.KubernetesCluster.IKubernetesClusterNetworkProfileAdvancedNetworking? AdvancedNetworkingInput
        {
