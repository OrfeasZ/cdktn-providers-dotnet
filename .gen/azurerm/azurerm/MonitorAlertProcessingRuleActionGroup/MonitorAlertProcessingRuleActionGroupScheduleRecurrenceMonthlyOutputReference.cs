...
namespace azurerm.MonitorAlertProcessingRuleActionGroup
{
    ...
    public class MonitorAlertProcessingRuleActionGroupScheduleRecurrenceMonthlyOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"azurerm.monitorAlertProcessingRuleActionGroup.MonitorAlertProcessingRuleActionGroupScheduleRecurrenceMonthly\"}]}}", isOptional: true)]
