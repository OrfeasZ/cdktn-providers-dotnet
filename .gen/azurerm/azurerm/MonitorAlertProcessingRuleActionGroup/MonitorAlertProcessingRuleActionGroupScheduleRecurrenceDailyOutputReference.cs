...
namespace azurerm.MonitorAlertProcessingRuleActionGroup
{
    ...
    public class MonitorAlertProcessingRuleActionGroupScheduleRecurrenceDailyOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"azurerm.monitorAlertProcessingRuleActionGroup.MonitorAlertProcessingRuleActionGroupScheduleRecurrenceDaily\"}]}}", isOptional: true)]
