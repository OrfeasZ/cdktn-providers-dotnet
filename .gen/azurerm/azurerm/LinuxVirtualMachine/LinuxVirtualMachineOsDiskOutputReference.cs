...
{
    [JsiiClass(nativeType: typeof(azurerm.LinuxVirtualMachine.LinuxVirtualMachineOsDiskOutputReference), fullyQualifiedName: "azurerm.linuxVirtualMachine.LinuxVirtualMachineOsDiskOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktn.IInterpolatingParent\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}}]")]
