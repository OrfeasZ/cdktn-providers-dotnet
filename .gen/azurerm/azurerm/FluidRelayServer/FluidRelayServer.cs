...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.80.0/docs/resources/fluid_relay_server azurerm_fluid_relay_server}.</summary>
    ...
    public class FluidRelayServer : Io.Cdktn.TerraformResource
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.80.0/docs/resources/fluid_relay_server azurerm_fluid_relay_server} Resource.</summary>
        ...
        /// <summary>Generates CDKTN code for importing a FluidRelayServer resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        ...
        [JsiiMethod(name: "generateConfigForImport", returnsJson: "{\"type\":{\"fqn\":\"cdktn.ImportableResource\"}}", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"summary\":\"The construct id used in the generated config for the FluidRelayServer to import.\"},\"name\":\"importToId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"remarks\":\"Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.80.0/docs/resources/fluid_relay_server#import import section} in the documentation of this resource for the id to use\",\"summary\":\"The id of the existing FluidRelayServer that should be imported.\"},\"name\":\"importFromId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"? Optional instance of the provider where the FluidRelayServer to import is found.\"},\"name\":\"provider\",\"optional\":true,\"type\":{\"fqn\":\"cdktn.TerraformProvider\"}}]")]
        public static Io.Cdktn.ImportableResource GenerateConfigForImport(Constructs.Construct scope, string importToId, string importFromId, Io.Cdktn.TerraformProvider? provider = null)
        {
            return InvokeStaticMethod<Io.Cdktn.ImportableResource>(typeof(azurerm.FluidRelayServer.FluidRelayServer), new System.Type[]{typeof(Constructs.Construct), typeof(string), typeof(string), typeof(Io.Cdktn.TerraformProvider)}, new object?[]{scope, importToId, importFromId, provider})!;
        }

        [JsiiMethod(name: "putCustomerManagedKey", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"azurerm.fluidRelayServer.FluidRelayServerCustomerManagedKey\"}}]")]
        public virtual void PutCustomerManagedKey(azurerm.FluidRelayServer.IFluidRelayServerCustomerManagedKey @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(azurerm.FluidRelayServer.IFluidRelayServerCustomerManagedKey)}, new object[]{@value});
        }
        ...
        [JsiiProperty(name: "customerManagedKey", typeJson: "{\"fqn\":\"azurerm.fluidRelayServer.FluidRelayServerCustomerManagedKeyOutputReference\"}")]
        public virtual azurerm.FluidRelayServer.FluidRelayServerCustomerManagedKeyOutputReference CustomerManagedKey
        {
            get => GetInstanceProperty<azurerm.FluidRelayServer.FluidRelayServerCustomerManagedKeyOutputReference>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "customerManagedKeyInput", typeJson: "{\"fqn\":\"azurerm.fluidRelayServer.FluidRelayServerCustomerManagedKey\"}", isOptional: true)]
        public virtual azurerm.FluidRelayServer.IFluidRelayServerCustomerManagedKey? CustomerManagedKeyInput
        {
        ...
        /// <remarks>
        /// <para>Type union: either <see cref="Io.Cdktn.IResolvable" /> or <see cref="azurerm.FluidRelayServer.IFluidRelayServerTimeouts" /></para>
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "timeoutsInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"azurerm.fluidRelayServer.FluidRelayServerTimeouts\"}]}}", isOptional: true)]
