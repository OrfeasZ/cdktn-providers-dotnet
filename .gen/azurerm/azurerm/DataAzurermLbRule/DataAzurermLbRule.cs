...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/data-sources/lb_rule azurerm_lb_rule}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/data-sources/lb_rule azurerm_lb_rule} Data Source.</summary>
        ...
        [JsiiProperty(name: "enableTcpReset", typeJson: "{\"fqn\":\"cdktn.IResolvable\"}")]
        public virtual Io.Cdktn.IResolvable EnableTcpReset
        {
            get => GetInstanceProperty<Io.Cdktn.IResolvable>()!;
        }
