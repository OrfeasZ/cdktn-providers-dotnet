...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.4.0/docs/resources/postgresql_flexible_server azurerm_postgresql_flexible_server}.</summary>
    ...
    public class PostgresqlFlexibleServer : Io.Cdktn.TerraformResource
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.4.0/docs/resources/postgresql_flexible_server azurerm_postgresql_flexible_server} Resource.</summary>
        ...
        /// <summary>Generates CDKTN code for importing a PostgresqlFlexibleServer resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        ...
        [JsiiMethod(name: "generateConfigForImport", returnsJson: "{\"type\":{\"fqn\":\"cdktn.ImportableResource\"}}", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"summary\":\"The construct id used in the generated config for the PostgresqlFlexibleServer to import.\"},\"name\":\"importToId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"remarks\":\"Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.4.0/docs/resources/postgresql_flexible_server#import import section} in the documentation of this resource for the id to use\",\"summary\":\"The id of the existing PostgresqlFlexibleServer that should be imported.\"},\"name\":\"importFromId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"? Optional instance of the provider where the PostgresqlFlexibleServer to import is found.\"},\"name\":\"provider\",\"optional\":true,\"type\":{\"fqn\":\"cdktn.TerraformProvider\"}}]")]
        public static Io.Cdktn.ImportableResource GenerateConfigForImport(Constructs.Construct scope, string importToId, string importFromId, Io.Cdktn.TerraformProvider? provider = null)
        {
            return InvokeStaticMethod<Io.Cdktn.ImportableResource>(typeof(azurerm.PostgresqlFlexibleServer.PostgresqlFlexibleServer), new System.Type[]{typeof(Constructs.Construct), typeof(string), typeof(string), typeof(Io.Cdktn.TerraformProvider)}, new object?[]{scope, importToId, importFromId, provider})!;
        }
        ...
        [JsiiMethod(name: "putCluster", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"azurerm.postgresqlFlexibleServer.PostgresqlFlexibleServerCluster\"}}]")]
        public virtual void PutCluster(azurerm.PostgresqlFlexibleServer.IPostgresqlFlexibleServerCluster @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(azurerm.PostgresqlFlexibleServer.IPostgresqlFlexibleServerCluster)}, new object[]{@value});
        }
        ...
        [JsiiMethod(name: "resetAdministratorPasswordWo")]
        public virtual void ResetAdministratorPasswordWo()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }

        [JsiiMethod(name: "resetAdministratorPasswordWoVersion")]
        public virtual void ResetAdministratorPasswordWoVersion()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        [JsiiMethod(name: "resetStorageIops")]
        public virtual void ResetStorageIops()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        [JsiiProperty(name: "cluster", typeJson: "{\"fqn\":\"azurerm.postgresqlFlexibleServer.PostgresqlFlexibleServerClusterOutputReference\"}")]
        public virtual azurerm.PostgresqlFlexibleServer.PostgresqlFlexibleServerClusterOutputReference Cluster
        {
            get => GetInstanceProperty<azurerm.PostgresqlFlexibleServer.PostgresqlFlexibleServerClusterOutputReference>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "administratorPasswordWoInput", typeJson: "{\"primitive\":\"string\"}", isOptional: true)]
        public virtual string? AdministratorPasswordWoInput
        {
            get => GetInstanceProperty<string?>();
        }

        [JsiiOptional]
        [JsiiProperty(name: "administratorPasswordWoVersionInput", typeJson: "{\"primitive\":\"number\"}", isOptional: true)]
        public virtual double? AdministratorPasswordWoVersionInput
        {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "clusterInput", typeJson: "{\"fqn\":\"azurerm.postgresqlFlexibleServer.PostgresqlFlexibleServerCluster\"}", isOptional: true)]
        public virtual azurerm.PostgresqlFlexibleServer.IPostgresqlFlexibleServerCluster? ClusterInput
        {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "geoRedundantBackupEnabledInput", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktn.IResolvable\"}]}}", isOptional: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "storageIopsInput", typeJson: "{\"primitive\":\"number\"}", isOptional: true)]
        public virtual double? StorageIopsInput
        {
            get => GetInstanceProperty<double?>();
        }
        ...
        /// <remarks>
        /// <para>Type union: either <see cref="Io.Cdktn.IResolvable" /> or <see cref="azurerm.PostgresqlFlexibleServer.IPostgresqlFlexibleServerTimeouts" /></para>
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "timeoutsInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"azurerm.postgresqlFlexibleServer.PostgresqlFlexibleServerTimeouts\"}]}}", isOptional: true)]
        ...
        [JsiiProperty(name: "administratorPasswordWo", typeJson: "{\"primitive\":\"string\"}")]
        public virtual string AdministratorPasswordWo
        {
            get => GetInstanceProperty<string>()!;
            set => SetInstanceProperty(value);
        }

        [JsiiProperty(name: "administratorPasswordWoVersion", typeJson: "{\"primitive\":\"number\"}")]
        public virtual double AdministratorPasswordWoVersion
        {
            get => GetInstanceProperty<double>()!;
            set => SetInstanceProperty(value);
        }
        ...
        /// <para>Type union: either bool or <see cref="Io.Cdktn.IResolvable" /></para>
        /// </remarks>
        [JsiiProperty(name: "geoRedundantBackupEnabled", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktn.IResolvable\"}]}}")]
        ...
        [JsiiProperty(name: "storageIops", typeJson: "{\"primitive\":\"number\"}")]
        public virtual double StorageIops
        {
            get => GetInstanceProperty<double>()!;
            set => SetInstanceProperty(value);
        }
