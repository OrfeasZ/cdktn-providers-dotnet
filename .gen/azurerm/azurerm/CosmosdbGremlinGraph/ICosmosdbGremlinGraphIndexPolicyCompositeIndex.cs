...
namespace azurerm.CosmosdbGremlinGraph
{
    ...
    public interface ICosmosdbGremlinGraphIndexPolicyCompositeIndex
    {
        ...
        /// <remarks>
        /// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.80.0/docs/resources/cosmosdb_gremlin_graph#index CosmosdbGremlinGraph#index}
        ...
        /// </remarks>
        [JsiiProperty(name: "index", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"azurerm.cosmosdbGremlinGraph.CosmosdbGremlinGraphIndexPolicyCompositeIndexIndex\"},\"kind\":\"array\"}}]}}")]
        object Index
        {
            get;
        }
