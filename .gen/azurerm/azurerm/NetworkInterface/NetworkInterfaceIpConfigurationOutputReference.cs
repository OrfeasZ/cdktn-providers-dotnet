...
namespace azurerm.NetworkInterface
{
    ...
    public class NetworkInterfaceIpConfigurationOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"azurerm.networkInterface.NetworkInterfaceIpConfiguration\"}]}}", isOptional: true)]
