...
namespace azurerm.StorageAccountQueueProperties
{
    ...
    public class StorageAccountQueuePropertiesCorsRuleOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"azurerm.storageAccountQueueProperties.StorageAccountQueuePropertiesCorsRule\"}]}}", isOptional: true)]
