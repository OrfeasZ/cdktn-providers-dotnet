...
namespace azurerm.BatchPool
{
    ...
    public class BatchPoolMount : azurerm.BatchPool.IBatchPoolMount
    {
        ...
        /// <remarks>
        /// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.80.0/docs/resources/batch_pool#azure_blob_file_system BatchPool#azure_blob_file_system}
        /// </remarks>
        [JsiiOptional]
        ...
        /// <remarks>
        /// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.80.0/docs/resources/batch_pool#azure_file_share BatchPool#azure_file_share}
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case null:
                            break;
                        default:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(azurerm.BatchPool.IBatchPoolMountAzureFileShare).FullName}[]; received {value.GetType().FullName}", nameof(value));
                    }
                }
        ...
        /// <remarks>
        /// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.80.0/docs/resources/batch_pool#cifs_mount BatchPool#cifs_mount}
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case null:
                            break;
                        default:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(azurerm.BatchPool.IBatchPoolMountCifsMount).FullName}[]; received {value.GetType().FullName}", nameof(value));
                    }
                }
                _cifsMount = value;
            }
        ...
        /// <remarks>
        /// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.80.0/docs/resources/batch_pool#nfs_mount BatchPool#nfs_mount}
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case null:
                            break;
                        default:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(azurerm.BatchPool.IBatchPoolMountNfsMount).FullName}[]; received {value.GetType().FullName}", nameof(value));
                    }
                }
                _nfsMount = value;
            }
