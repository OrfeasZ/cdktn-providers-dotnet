...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.4.0/docs/data-sources/netapp_volume azurerm_netapp_volume}.</summary>
    ...
    public class DataAzurermNetappVolume : Io.Cdktn.TerraformDataSource
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.4.0/docs/data-sources/netapp_volume azurerm_netapp_volume} Data Source.</summary>
        ...
        /// <summary>Generates CDKTN code for importing a DataAzurermNetappVolume resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        ...
        [JsiiMethod(name: "generateConfigForImport", returnsJson: "{\"type\":{\"fqn\":\"cdktn.ImportableResource\"}}", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"summary\":\"The construct id used in the generated config for the DataAzurermNetappVolume to import.\"},\"name\":\"importToId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"remarks\":\"Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.4.0/docs/data-sources/netapp_volume#import import section} in the documentation of this resource for the id to use\",\"summary\":\"The id of the existing DataAzurermNetappVolume that should be imported.\"},\"name\":\"importFromId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"? Optional instance of the provider where the DataAzurermNetappVolume to import is found.\"},\"name\":\"provider\",\"optional\":true,\"type\":{\"fqn\":\"cdktn.TerraformProvider\"}}]")]
        public static Io.Cdktn.ImportableResource GenerateConfigForImport(Constructs.Construct scope, string importToId, string importFromId, Io.Cdktn.TerraformProvider? provider = null)
        {
            return InvokeStaticMethod<Io.Cdktn.ImportableResource>(typeof(azurerm.DataAzurermNetappVolume.DataAzurermNetappVolume), new System.Type[]{typeof(Constructs.Construct), typeof(string), typeof(string), typeof(Io.Cdktn.TerraformProvider)}, new object?[]{scope, importToId, importFromId, provider})!;
        }
        ...
        [JsiiProperty(name: "breakthroughModeEnabled", typeJson: "{\"fqn\":\"cdktn.IResolvable\"}")]
        public virtual Io.Cdktn.IResolvable BreakthroughModeEnabled
        {
            get => GetInstanceProperty<Io.Cdktn.IResolvable>()!;
        }

        [JsiiProperty(name: "dataProtectionAdvancedRansomware", typeJson: "{\"fqn\":\"azurerm.dataAzurermNetappVolume.DataAzurermNetappVolumeDataProtectionAdvancedRansomwareList\"}")]
        public virtual azurerm.DataAzurermNetappVolume.DataAzurermNetappVolumeDataProtectionAdvancedRansomwareList DataProtectionAdvancedRansomware
        {
            get => GetInstanceProperty<azurerm.DataAzurermNetappVolume.DataAzurermNetappVolumeDataProtectionAdvancedRansomwareList>()!;
        }

        [JsiiProperty(name: "dataProtectionBackupPolicy", typeJson: "{\"fqn\":\"azurerm.dataAzurermNetappVolume.DataAzurermNetappVolumeDataProtectionBackupPolicyList\"}")]
        public virtual azurerm.DataAzurermNetappVolume.DataAzurermNetappVolumeDataProtectionBackupPolicyList DataProtectionBackupPolicy
        {
            get => GetInstanceProperty<azurerm.DataAzurermNetappVolume.DataAzurermNetappVolumeDataProtectionBackupPolicyList>()!;
        }
        ...
        [JsiiProperty(name: "largeVolumeEnabled", typeJson: "{\"fqn\":\"cdktn.IResolvable\"}")]
        public virtual Io.Cdktn.IResolvable LargeVolumeEnabled
        {
            get => GetInstanceProperty<Io.Cdktn.IResolvable>()!;
        }
        ...
        [JsiiProperty(name: "mountTarget", typeJson: "{\"fqn\":\"azurerm.dataAzurermNetappVolume.DataAzurermNetappVolumeMountTargetList\"}")]
        public virtual azurerm.DataAzurermNetappVolume.DataAzurermNetappVolumeMountTargetList MountTarget
        {
            get => GetInstanceProperty<azurerm.DataAzurermNetappVolume.DataAzurermNetappVolumeMountTargetList>()!;
        }
        ...
        [JsiiProperty(name: "smbAccessBasedEnumerationEnabled", typeJson: "{\"fqn\":\"cdktn.IResolvable\"}")]
        public virtual Io.Cdktn.IResolvable SmbAccessBasedEnumerationEnabled
        {
            get => GetInstanceProperty<Io.Cdktn.IResolvable>()!;
        }

        [JsiiProperty(name: "smbNonBrowsableEnabled", typeJson: "{\"fqn\":\"cdktn.IResolvable\"}")]
        public virtual Io.Cdktn.IResolvable SmbNonBrowsableEnabled
        {
            get => GetInstanceProperty<Io.Cdktn.IResolvable>()!;
        }
        ...
        /// <remarks>
        /// <para>Type union: either <see cref="Io.Cdktn.IResolvable" /> or <see cref="azurerm.DataAzurermNetappVolume.IDataAzurermNetappVolumeTimeouts" /></para>
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "timeoutsInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"azurerm.dataAzurermNetappVolume.DataAzurermNetappVolumeTimeouts\"}]}}", isOptional: true)]
