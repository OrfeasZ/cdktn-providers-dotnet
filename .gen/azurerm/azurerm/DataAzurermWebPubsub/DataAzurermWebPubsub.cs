...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.7.0/docs/data-sources/web_pubsub azurerm_web_pubsub}.</summary>
    ...
    public class DataAzurermWebPubsub : Io.Cdktn.TerraformDataSource
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.7.0/docs/data-sources/web_pubsub azurerm_web_pubsub} Data Source.</summary>
        ...
        /// <summary>Generates CDKTN code for importing a DataAzurermWebPubsub resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        ...
        [JsiiMethod(name: "generateConfigForImport", returnsJson: "{\"type\":{\"fqn\":\"cdktn.ImportableResource\"}}", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"summary\":\"The construct id used in the generated config for the DataAzurermWebPubsub to import.\"},\"name\":\"importToId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"remarks\":\"Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.7.0/docs/data-sources/web_pubsub#import import section} in the documentation of this resource for the id to use\",\"summary\":\"The id of the existing DataAzurermWebPubsub that should be imported.\"},\"name\":\"importFromId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"? Optional instance of the provider where the DataAzurermWebPubsub to import is found.\"},\"name\":\"provider\",\"optional\":true,\"type\":{\"fqn\":\"cdktn.TerraformProvider\"}}]")]
        public static Io.Cdktn.ImportableResource GenerateConfigForImport(Constructs.Construct scope, string importToId, string importFromId, Io.Cdktn.TerraformProvider? provider = null)
        {
            return InvokeStaticMethod<Io.Cdktn.ImportableResource>(typeof(azurerm.DataAzurermWebPubsub.DataAzurermWebPubsub), new System.Type[]{typeof(Constructs.Construct), typeof(string), typeof(string), typeof(Io.Cdktn.TerraformProvider)}, new object?[]{scope, importToId, importFromId, provider})!;
        }
        ...
        [JsiiProperty(name: "identity", typeJson: "{\"fqn\":\"azurerm.dataAzurermWebPubsub.DataAzurermWebPubsubIdentityList\"}")]
        public virtual azurerm.DataAzurermWebPubsub.DataAzurermWebPubsubIdentityList Identity
        {
            get => GetInstanceProperty<azurerm.DataAzurermWebPubsub.DataAzurermWebPubsubIdentityList>()!;
        }

        [JsiiProperty(name: "liveTrace", typeJson: "{\"fqn\":\"azurerm.dataAzurermWebPubsub.DataAzurermWebPubsubLiveTraceList\"}")]
        public virtual azurerm.DataAzurermWebPubsub.DataAzurermWebPubsubLiveTraceList LiveTrace
        {
            get => GetInstanceProperty<azurerm.DataAzurermWebPubsub.DataAzurermWebPubsubLiveTraceList>()!;
        }
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "timeoutsInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"azurerm.dataAzurermWebPubsub.DataAzurermWebPubsubTimeouts\"}]}}", isOptional: true)]
