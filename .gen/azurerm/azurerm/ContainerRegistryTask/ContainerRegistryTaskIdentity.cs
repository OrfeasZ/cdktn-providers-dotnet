...
namespace azurerm.ContainerRegistryTask
{
    ...
    public class ContainerRegistryTaskIdentity : azurerm.ContainerRegistryTask.IContainerRegistryTaskIdentity
    {
        ...
        /// <summary>Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.4.0/docs/resources/container_registry_task#identity_ids ContainerRegistryTask#identity_ids}.</summary>
        [JsiiOptional]
