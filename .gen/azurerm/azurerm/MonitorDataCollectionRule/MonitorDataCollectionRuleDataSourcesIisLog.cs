...
namespace azurerm.MonitorDataCollectionRule
{
    ...
    public class MonitorDataCollectionRuleDataSourcesIisLog : azurerm.MonitorDataCollectionRule.IMonitorDataCollectionRuleDataSourcesIisLog
    {
        ...
        /// <summary>Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/monitor_data_collection_rule#log_directories MonitorDataCollectionRule#log_directories}.</summary>
        [JsiiOptional]
