...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.80.0/docs/resources/managed_lustre_file_system azurerm_managed_lustre_file_system}.</summary>
    ...
    public class ManagedLustreFileSystem : Io.Cdktn.TerraformResource
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.80.0/docs/resources/managed_lustre_file_system azurerm_managed_lustre_file_system} Resource.</summary>
        ...
        /// <summary>Generates CDKTN code for importing a ManagedLustreFileSystem resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        ...
        [JsiiMethod(name: "generateConfigForImport", returnsJson: "{\"type\":{\"fqn\":\"cdktn.ImportableResource\"}}", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"summary\":\"The construct id used in the generated config for the ManagedLustreFileSystem to import.\"},\"name\":\"importToId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"remarks\":\"Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.80.0/docs/resources/managed_lustre_file_system#import import section} in the documentation of this resource for the id to use\",\"summary\":\"The id of the existing ManagedLustreFileSystem that should be imported.\"},\"name\":\"importFromId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"? Optional instance of the provider where the ManagedLustreFileSystem to import is found.\"},\"name\":\"provider\",\"optional\":true,\"type\":{\"fqn\":\"cdktn.TerraformProvider\"}}]")]
        public static Io.Cdktn.ImportableResource GenerateConfigForImport(Constructs.Construct scope, string importToId, string importFromId, Io.Cdktn.TerraformProvider? provider = null)
        {
            return InvokeStaticMethod<Io.Cdktn.ImportableResource>(typeof(azurerm.ManagedLustreFileSystem.ManagedLustreFileSystem), new System.Type[]{typeof(Constructs.Construct), typeof(string), typeof(string), typeof(Io.Cdktn.TerraformProvider)}, new object?[]{scope, importToId, importFromId, provider})!;
        }
        ...
        [JsiiMethod(name: "putRootSquash", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"azurerm.managedLustreFileSystem.ManagedLustreFileSystemRootSquash\"}}]")]
        public virtual void PutRootSquash(azurerm.ManagedLustreFileSystem.IManagedLustreFileSystemRootSquash @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(azurerm.ManagedLustreFileSystem.IManagedLustreFileSystemRootSquash)}, new object[]{@value});
        }
        ...
        [JsiiProperty(name: "rootSquash", typeJson: "{\"fqn\":\"azurerm.managedLustreFileSystem.ManagedLustreFileSystemRootSquashOutputReference\"}")]
        public virtual azurerm.ManagedLustreFileSystem.ManagedLustreFileSystemRootSquashOutputReference RootSquash
        {
            get => GetInstanceProperty<azurerm.ManagedLustreFileSystem.ManagedLustreFileSystemRootSquashOutputReference>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "rootSquashInput", typeJson: "{\"fqn\":\"azurerm.managedLustreFileSystem.ManagedLustreFileSystemRootSquash\"}", isOptional: true)]
        public virtual azurerm.ManagedLustreFileSystem.IManagedLustreFileSystemRootSquash? RootSquashInput
        {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "timeoutsInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"azurerm.managedLustreFileSystem.ManagedLustreFileSystemTimeouts\"}]}}", isOptional: true)]
