...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/data-sources/signalr_service azurerm_signalr_service}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/data-sources/signalr_service azurerm_signalr_service} Data Source.</summary>
        ...
        /// <summary>Generates CDKTN code for importing a DataAzurermSignalrService resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        ...
        [JsiiProperty(name: "aadAuthEnabled", typeJson: "{\"fqn\":\"cdktn.IResolvable\"}")]
        public virtual Io.Cdktn.IResolvable AadAuthEnabled
        {
        ...
        [JsiiProperty(name: "tlsClientCertEnabled", typeJson: "{\"fqn\":\"cdktn.IResolvable\"}")]
        ...
        /// <remarks>
        /// <para>Type union: either <see cref="Io.Cdktn.IResolvable" /> or <see cref="azurerm.DataAzurermSignalrService.IDataAzurermSignalrServiceTimeouts" /></para>
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "timeoutsInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"azurerm.dataAzurermSignalrService.DataAzurermSignalrServiceTimeouts\"}]}}", isOptional: true)]
