...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.80.0/docs/data-sources/key_vault azurerm_key_vault}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.80.0/docs/data-sources/key_vault azurerm_key_vault} Data Source.</summary>
        ...
        [JsiiProperty(name: "enableRbacAuthorization", typeJson: "{\"fqn\":\"cdktn.IResolvable\"}")]
        public virtual Io.Cdktn.IResolvable EnableRbacAuthorization
        {
            get => GetInstanceProperty<Io.Cdktn.IResolvable>()!;
        }
