...
{
    [JsiiInterface(nativeType: typeof(IAppServiceSlotSiteConfigIpRestrictionHeaders), fullyQualifiedName: "azurerm.appServiceSlot.AppServiceSlotSiteConfigIpRestrictionHeaders")]
    public interface IAppServiceSlotSiteConfigIpRestrictionHeaders
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IAppServiceSlotSiteConfigIpRestrictionHeaders), fullyQualifiedName: "azurerm.appServiceSlot.AppServiceSlotSiteConfigIpRestrictionHeaders")]
        internal sealed class _Proxy : DeputyBase, azurerm.AppServiceSlot.IAppServiceSlotSiteConfigIpRestrictionHeaders
        {
