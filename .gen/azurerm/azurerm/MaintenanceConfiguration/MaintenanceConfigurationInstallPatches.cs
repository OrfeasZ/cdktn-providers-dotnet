...
namespace azurerm.MaintenanceConfiguration
{
    ...
    public class MaintenanceConfigurationInstallPatches : azurerm.MaintenanceConfiguration.IMaintenanceConfigurationInstallPatches
    {
        ...
        /// <remarks>
        /// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.80.0/docs/resources/maintenance_configuration#linux MaintenanceConfiguration#linux}
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case null:
                            break;
                        default:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(azurerm.MaintenanceConfiguration.IMaintenanceConfigurationInstallPatchesLinux).FullName}[]; received {value.GetType().FullName}", nameof(value));
                    }
                }
                _linux = value;
            }
        ...
        /// <summary>Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.80.0/docs/resources/maintenance_configuration#reboot MaintenanceConfiguration#reboot}.</summary>
        [JsiiOptional]
        ...
        /// <remarks>
        /// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.80.0/docs/resources/maintenance_configuration#windows MaintenanceConfiguration#windows}
