...
{
    [JsiiInterface(nativeType: typeof(IFunctionAppSlotAuthSettingsGoogle), fullyQualifiedName: "azurerm.functionAppSlot.FunctionAppSlotAuthSettingsGoogle")]
    public interface IFunctionAppSlotAuthSettingsGoogle
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IFunctionAppSlotAuthSettingsGoogle), fullyQualifiedName: "azurerm.functionAppSlot.FunctionAppSlotAuthSettingsGoogle")]
        internal sealed class _Proxy : DeputyBase, azurerm.FunctionAppSlot.IFunctionAppSlotAuthSettingsGoogle
        {
