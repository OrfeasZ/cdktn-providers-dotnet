...
namespace azurerm.FunctionAppSlot
{
    ...
    public class FunctionAppSlotAuthSettingsActiveDirectory : azurerm.FunctionAppSlot.IFunctionAppSlotAuthSettingsActiveDirectory
    {
        ...
        /// <summary>Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/function_app_slot#allowed_audiences FunctionAppSlot#allowed_audiences}.</summary>
        [JsiiOptional]
