...
namespace azurerm.DataAzurermVirtualDesktopHostPool
{
    ...
    public class DataAzurermVirtualDesktopHostPoolScheduledAgentUpdatesOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        [JsiiProperty(name: "useSessionHostTimezone", typeJson: "{\"fqn\":\"cdktn.IResolvable\"}")]
        public virtual Io.Cdktn.IResolvable UseSessionHostTimezone
        {
            get => GetInstanceProperty<Io.Cdktn.IResolvable>()!;
        }
