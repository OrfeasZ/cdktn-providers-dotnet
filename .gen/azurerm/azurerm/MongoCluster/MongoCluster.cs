...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.7.0/docs/resources/mongo_cluster azurerm_mongo_cluster}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.7.0/docs/resources/mongo_cluster azurerm_mongo_cluster} Resource.</summary>
        ...
        [JsiiMethod(name: "resetCosmosDbNetworkBypassEnabled")]
        public virtual void ResetCosmosDbNetworkBypassEnabled()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "cosmosDbNetworkBypassEnabledInput", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktn.IResolvable\"}]}}", isOptional: true)]
        public virtual object? CosmosDbNetworkBypassEnabledInput
        {
        ...
        /// <para>Type union: either bool or <see cref="Io.Cdktn.IResolvable" /></para>
        /// </remarks>
        [JsiiProperty(name: "cosmosDbNetworkBypassEnabled", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktn.IResolvable\"}]}}")]
        public virtual object CosmosDbNetworkBypassEnabled
        {
            get => GetInstanceProperty<object>()!;
            set
            {
