...
namespace azurerm.CdnFrontdoorFirewallPolicy
{
    ...
    public class CdnFrontdoorFirewallPolicyCustomRuleMatchConditionOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"azurerm.cdnFrontdoorFirewallPolicy.CdnFrontdoorFirewallPolicyCustomRuleMatchCondition\"}]}}", isOptional: true)]
