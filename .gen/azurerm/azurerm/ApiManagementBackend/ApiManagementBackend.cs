...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.80.0/docs/resources/api_management_backend azurerm_api_management_backend}.</summary>
    ...
    public class ApiManagementBackend : Io.Cdktn.TerraformResource
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.80.0/docs/resources/api_management_backend azurerm_api_management_backend} Resource.</summary>
        ...
        /// <summary>Generates CDKTN code for importing a ApiManagementBackend resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        ...
        [JsiiMethod(name: "generateConfigForImport", returnsJson: "{\"type\":{\"fqn\":\"cdktn.ImportableResource\"}}", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"summary\":\"The construct id used in the generated config for the ApiManagementBackend to import.\"},\"name\":\"importToId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"remarks\":\"Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.80.0/docs/resources/api_management_backend#import import section} in the documentation of this resource for the id to use\",\"summary\":\"The id of the existing ApiManagementBackend that should be imported.\"},\"name\":\"importFromId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"? Optional instance of the provider where the ApiManagementBackend to import is found.\"},\"name\":\"provider\",\"optional\":true,\"type\":{\"fqn\":\"cdktn.TerraformProvider\"}}]")]
        public static Io.Cdktn.ImportableResource GenerateConfigForImport(Constructs.Construct scope, string importToId, string importFromId, Io.Cdktn.TerraformProvider? provider = null)
        {
            return InvokeStaticMethod<Io.Cdktn.ImportableResource>(typeof(azurerm.ApiManagementBackend.ApiManagementBackend), new System.Type[]{typeof(Constructs.Construct), typeof(string), typeof(string), typeof(Io.Cdktn.TerraformProvider)}, new object?[]{scope, importToId, importFromId, provider})!;
        }

        [JsiiMethod(name: "putCircuitBreakerRule", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"azurerm.apiManagementBackend.ApiManagementBackendCircuitBreakerRule\"}}]")]
        public virtual void PutCircuitBreakerRule(azurerm.ApiManagementBackend.IApiManagementBackendCircuitBreakerRule @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(azurerm.ApiManagementBackend.IApiManagementBackendCircuitBreakerRule)}, new object[]{@value});
        }
        ...
        [JsiiMethod(name: "resetCircuitBreakerRule")]
        public virtual void ResetCircuitBreakerRule()
        {
        ...
        [JsiiProperty(name: "circuitBreakerRule", typeJson: "{\"fqn\":\"azurerm.apiManagementBackend.ApiManagementBackendCircuitBreakerRuleOutputReference\"}")]
        public virtual azurerm.ApiManagementBackend.ApiManagementBackendCircuitBreakerRuleOutputReference CircuitBreakerRule
        {
            get => GetInstanceProperty<azurerm.ApiManagementBackend.ApiManagementBackendCircuitBreakerRuleOutputReference>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "circuitBreakerRuleInput", typeJson: "{\"fqn\":\"azurerm.apiManagementBackend.ApiManagementBackendCircuitBreakerRule\"}", isOptional: true)]
        public virtual azurerm.ApiManagementBackend.IApiManagementBackendCircuitBreakerRule? CircuitBreakerRuleInput
        {
        ...
        /// <remarks>
        /// <para>Type union: either <see cref="Io.Cdktn.IResolvable" /> or <see cref="azurerm.ApiManagementBackend.IApiManagementBackendTimeouts" /></para>
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "timeoutsInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"azurerm.apiManagementBackend.ApiManagementBackendTimeouts\"}]}}", isOptional: true)]
