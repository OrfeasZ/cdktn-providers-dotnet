...
namespace azurerm.VirtualMachineScaleSetStandbyPool
{
    ...
    public class VirtualMachineScaleSetStandbyPoolTimeoutsOutputReference : Io.Cdktn.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        public VirtualMachineScaleSetStandbyPoolTimeoutsOutputReference(Io.Cdktn.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
        ...
        protected VirtualMachineScaleSetStandbyPoolTimeoutsOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected VirtualMachineScaleSetStandbyPoolTimeoutsOutputReference(DeputyProps props): base(props)
        {
        }
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"azurerm.virtualMachineScaleSetStandbyPool.VirtualMachineScaleSetStandbyPoolTimeouts\"}]}}", isOptional: true)]
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        case Io.Cdktn.IResolvable cast_cd4240:
                            break;
                        case azurerm.VirtualMachineScaleSetStandbyPool.IVirtualMachineScaleSetStandbyPoolTimeouts cast_cd4240:
                            break;
                        ...
                        case null:
                            break;
                        default:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(azurerm.VirtualMachineScaleSetStandbyPool.IVirtualMachineScaleSetStandbyPoolTimeouts).FullName}; received {value.GetType().FullName}", nameof(value));
                    }
                }
