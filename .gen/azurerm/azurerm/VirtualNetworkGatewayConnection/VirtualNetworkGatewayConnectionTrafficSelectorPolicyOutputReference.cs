...
namespace azurerm.VirtualNetworkGatewayConnection
{
    ...
    public class VirtualNetworkGatewayConnectionTrafficSelectorPolicyOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"azurerm.virtualNetworkGatewayConnection.VirtualNetworkGatewayConnectionTrafficSelectorPolicy\"}]}}", isOptional: true)]
