...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.80.0/docs/data-sources/healthcare_dicom_service azurerm_healthcare_dicom_service}.</summary>
    ...
    public class DataAzurermHealthcareDicomService : Io.Cdktn.TerraformDataSource
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.80.0/docs/data-sources/healthcare_dicom_service azurerm_healthcare_dicom_service} Data Source.</summary>
        ...
        /// <summary>Generates CDKTN code for importing a DataAzurermHealthcareDicomService resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        ...
        [JsiiMethod(name: "generateConfigForImport", returnsJson: "{\"type\":{\"fqn\":\"cdktn.ImportableResource\"}}", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"summary\":\"The construct id used in the generated config for the DataAzurermHealthcareDicomService to import.\"},\"name\":\"importToId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"remarks\":\"Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.80.0/docs/data-sources/healthcare_dicom_service#import import section} in the documentation of this resource for the id to use\",\"summary\":\"The id of the existing DataAzurermHealthcareDicomService that should be imported.\"},\"name\":\"importFromId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"? Optional instance of the provider where the DataAzurermHealthcareDicomService to import is found.\"},\"name\":\"provider\",\"optional\":true,\"type\":{\"fqn\":\"cdktn.TerraformProvider\"}}]")]
        public static Io.Cdktn.ImportableResource GenerateConfigForImport(Constructs.Construct scope, string importToId, string importFromId, Io.Cdktn.TerraformProvider? provider = null)
        {
            return InvokeStaticMethod<Io.Cdktn.ImportableResource>(typeof(azurerm.DataAzurermHealthcareDicomService.DataAzurermHealthcareDicomService), new System.Type[]{typeof(Constructs.Construct), typeof(string), typeof(string), typeof(Io.Cdktn.TerraformProvider)}, new object?[]{scope, importToId, importFromId, provider})!;
        }
        ...
        [JsiiProperty(name: "cors", typeJson: "{\"fqn\":\"azurerm.dataAzurermHealthcareDicomService.DataAzurermHealthcareDicomServiceCorsList\"}")]
        public virtual azurerm.DataAzurermHealthcareDicomService.DataAzurermHealthcareDicomServiceCorsList Cors
        {
            get => GetInstanceProperty<azurerm.DataAzurermHealthcareDicomService.DataAzurermHealthcareDicomServiceCorsList>()!;
        }

        [JsiiProperty(name: "dataPartitionsEnabled", typeJson: "{\"fqn\":\"cdktn.IResolvable\"}")]
        public virtual Io.Cdktn.IResolvable DataPartitionsEnabled
        {
        ...
        [JsiiProperty(name: "storage", typeJson: "{\"fqn\":\"azurerm.dataAzurermHealthcareDicomService.DataAzurermHealthcareDicomServiceStorageList\"}")]
        public virtual azurerm.DataAzurermHealthcareDicomService.DataAzurermHealthcareDicomServiceStorageList Storage
        {
            get => GetInstanceProperty<azurerm.DataAzurermHealthcareDicomService.DataAzurermHealthcareDicomServiceStorageList>()!;
        }
        ...
        /// <remarks>
        /// <para>Type union: either <see cref="Io.Cdktn.IResolvable" /> or <see cref="azurerm.DataAzurermHealthcareDicomService.IDataAzurermHealthcareDicomServiceTimeouts" /></para>
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "timeoutsInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"azurerm.dataAzurermHealthcareDicomService.DataAzurermHealthcareDicomServiceTimeouts\"}]}}", isOptional: true)]
