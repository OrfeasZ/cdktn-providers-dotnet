...
namespace azurerm.VirtualMachineScaleSet
{
    ...
    public class VirtualMachineScaleSetExtensionOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"azurerm.virtualMachineScaleSet.VirtualMachineScaleSetExtension\"}]}}", isOptional: true)]
