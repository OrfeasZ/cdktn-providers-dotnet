...
{
    [JsiiInterface(nativeType: typeof(ISubscriptionAddInvoiceItemsPriceData), fullyQualifiedName: "stripe.subscription.SubscriptionAddInvoiceItemsPriceData")]
    public interface ISubscriptionAddInvoiceItemsPriceData
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ISubscriptionAddInvoiceItemsPriceData), fullyQualifiedName: "stripe.subscription.SubscriptionAddInvoiceItemsPriceData")]
        internal sealed class _Proxy : DeputyBase, stripe.Subscription.ISubscriptionAddInvoiceItemsPriceData
        {
