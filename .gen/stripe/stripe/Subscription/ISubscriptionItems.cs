...
{
    [JsiiInterface(nativeType: typeof(ISubscriptionItems), fullyQualifiedName: "stripe.subscription.SubscriptionItems")]
    public interface ISubscriptionItems
    {
        ...
        stripe.Subscription.ISubscriptionItemsBillingThresholds? BillingThresholds
        {
            get
            {
                return null;
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        stripe.Subscription.ISubscriptionItemsPriceData? PriceData
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(ISubscriptionItems), fullyQualifiedName: "stripe.subscription.SubscriptionItems")]
        internal sealed class _Proxy : DeputyBase, stripe.Subscription.ISubscriptionItems
        {
            ...
            {
                get => GetInstanceProperty<stripe.Subscription.ISubscriptionItemsBillingThresholds?>();
            }
            ...
            {
                get => GetInstanceProperty<stripe.Subscription.ISubscriptionItemsPriceData?>();
            }
