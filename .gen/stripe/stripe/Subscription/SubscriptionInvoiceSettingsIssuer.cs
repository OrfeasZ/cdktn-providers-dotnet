...
namespace stripe.Subscription
{
    ...
    [JsiiByValue(fqn: "stripe.subscription.SubscriptionInvoiceSettingsIssuer")]
    public class SubscriptionInvoiceSettingsIssuer : stripe.Subscription.ISubscriptionInvoiceSettingsIssuer
    {
