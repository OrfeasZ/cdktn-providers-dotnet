...
namespace stripe.Subscription
{
    ...
    [JsiiByValue(fqn: "stripe.subscription.SubscriptionAddInvoiceItemsPeriodStart")]
    public class SubscriptionAddInvoiceItemsPeriodStart : stripe.Subscription.ISubscriptionAddInvoiceItemsPeriodStart
    {
