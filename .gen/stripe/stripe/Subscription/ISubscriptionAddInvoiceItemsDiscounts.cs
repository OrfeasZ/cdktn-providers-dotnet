...
{
    [JsiiInterface(nativeType: typeof(ISubscriptionAddInvoiceItemsDiscounts), fullyQualifiedName: "stripe.subscription.SubscriptionAddInvoiceItemsDiscounts")]
    public interface ISubscriptionAddInvoiceItemsDiscounts
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ISubscriptionAddInvoiceItemsDiscounts), fullyQualifiedName: "stripe.subscription.SubscriptionAddInvoiceItemsDiscounts")]
        internal sealed class _Proxy : DeputyBase, stripe.Subscription.ISubscriptionAddInvoiceItemsDiscounts
        {
