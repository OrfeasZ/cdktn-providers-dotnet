...
{
    [JsiiByValue(fqn: "stripe.subscription.SubscriptionAddInvoiceItemsDiscounts")]
    public class SubscriptionAddInvoiceItemsDiscounts : stripe.Subscription.ISubscriptionAddInvoiceItemsDiscounts
    {
