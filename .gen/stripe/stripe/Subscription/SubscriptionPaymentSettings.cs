...
{
    [JsiiByValue(fqn: "stripe.subscription.SubscriptionPaymentSettings")]
    public class SubscriptionPaymentSettings : stripe.Subscription.ISubscriptionPaymentSettings
    {
