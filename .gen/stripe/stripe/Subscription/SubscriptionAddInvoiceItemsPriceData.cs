...
namespace stripe.Subscription
{
    ...
    [JsiiByValue(fqn: "stripe.subscription.SubscriptionAddInvoiceItemsPriceData")]
    public class SubscriptionAddInvoiceItemsPriceData : stripe.Subscription.ISubscriptionAddInvoiceItemsPriceData
    {
