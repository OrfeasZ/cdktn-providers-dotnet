...
{
    [JsiiByValue(fqn: "stripe.subscription.SubscriptionBillingThresholds")]
    public class SubscriptionBillingThresholds : stripe.Subscription.ISubscriptionBillingThresholds
    {
