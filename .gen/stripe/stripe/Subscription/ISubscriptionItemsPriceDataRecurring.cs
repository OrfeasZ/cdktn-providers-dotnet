...
{
    [JsiiInterface(nativeType: typeof(ISubscriptionItemsPriceDataRecurring), fullyQualifiedName: "stripe.subscription.SubscriptionItemsPriceDataRecurring")]
    public interface ISubscriptionItemsPriceDataRecurring
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ISubscriptionItemsPriceDataRecurring), fullyQualifiedName: "stripe.subscription.SubscriptionItemsPriceDataRecurring")]
        internal sealed class _Proxy : DeputyBase, stripe.Subscription.ISubscriptionItemsPriceDataRecurring
        {
