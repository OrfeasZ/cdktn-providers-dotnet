...
{
    [JsiiByValue(fqn: "stripe.subscription.SubscriptionPaymentSettingsPaymentMethodOptionsUpi")]
    public class SubscriptionPaymentSettingsPaymentMethodOptionsUpi : stripe.Subscription.ISubscriptionPaymentSettingsPaymentMethodOptionsUpi
    {
