...
{
    [JsiiInterface(nativeType: typeof(IPaymentIntentPaymentMethodOptionsPaypal), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsPaypal")]
    public interface IPaymentIntentPaymentMethodOptionsPaypal
    {
        ...
        /// <summary>A reference of the PayPal transaction visible to customer which is mapped to PayPal's invoice ID.</summary>
        /// <remarks>
        ...
        /// <remarks>
        /// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stripe/stripe/0.3.0/docs/resources/payment_intent#risk_correlation_id PaymentIntent#risk_correlation_id}
        /// </remarks>
        [JsiiProperty(name: "riskCorrelationId", typeJson: "{\"primitive\":\"string\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        ...
        [JsiiTypeProxy(nativeType: typeof(IPaymentIntentPaymentMethodOptionsPaypal), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsPaypal")]
        internal sealed class _Proxy : DeputyBase, stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsPaypal
        {
