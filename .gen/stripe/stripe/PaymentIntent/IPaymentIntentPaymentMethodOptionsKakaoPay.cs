...
{
    [JsiiInterface(nativeType: typeof(IPaymentIntentPaymentMethodOptionsKakaoPay), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsKakaoPay")]
    public interface IPaymentIntentPaymentMethodOptionsKakaoPay
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IPaymentIntentPaymentMethodOptionsKakaoPay), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsKakaoPay")]
        internal sealed class _Proxy : DeputyBase, stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsKakaoPay
        {
