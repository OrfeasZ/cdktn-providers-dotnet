...
{
    [JsiiByValue(fqn: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsPaynow")]
    public class PaymentIntentPaymentMethodOptionsPaynow : stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsPaynow
    {
