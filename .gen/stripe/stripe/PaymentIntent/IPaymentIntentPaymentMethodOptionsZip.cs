...
{
    [JsiiInterface(nativeType: typeof(IPaymentIntentPaymentMethodOptionsZip), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsZip")]
    public interface IPaymentIntentPaymentMethodOptionsZip
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IPaymentIntentPaymentMethodOptionsZip), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsZip")]
        internal sealed class _Proxy : DeputyBase, stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsZip
        {
