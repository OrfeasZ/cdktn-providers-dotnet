...
{
    [JsiiByValue(fqn: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsCrypto")]
    public class PaymentIntentPaymentMethodOptionsCrypto : stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsCrypto
    {
