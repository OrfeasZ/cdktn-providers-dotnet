...
{
    [JsiiByValue(fqn: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsCustomerBalance")]
    public class PaymentIntentPaymentMethodOptionsCustomerBalance : stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsCustomerBalance
    {
