...
{
    [JsiiByValue(fqn: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsCard")]
    public class PaymentIntentPaymentMethodOptionsCard : stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsCard
    {
        ...
        private object? _requireCvcRecollection;
