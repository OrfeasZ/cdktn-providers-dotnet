...
{
    [JsiiInterface(nativeType: typeof(IPaymentIntentPaymentMethodOptionsSofort), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsSofort")]
    public interface IPaymentIntentPaymentMethodOptionsSofort
    {
        /// <summary>Preferred language of the SOFORT authorization page that the customer is redirected to.</summary>
        /// <remarks>
        /// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stripe/stripe/0.3.0/docs/resources/payment_intent#preferred_language PaymentIntent#preferred_language}
        /// </remarks>
        ...
        [JsiiTypeProxy(nativeType: typeof(IPaymentIntentPaymentMethodOptionsSofort), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsSofort")]
        internal sealed class _Proxy : DeputyBase, stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsSofort
        {
