...
{
    [JsiiInterface(nativeType: typeof(IPaymentIntentPaymentMethodOptionsOxxo), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsOxxo")]
    public interface IPaymentIntentPaymentMethodOptionsOxxo
    {
        /// <summary>The number of calendar days before an OXXO invoice expires.</summary>
        /// <remarks>
        ...
        [JsiiTypeProxy(nativeType: typeof(IPaymentIntentPaymentMethodOptionsOxxo), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsOxxo")]
        internal sealed class _Proxy : DeputyBase, stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsOxxo
        {
