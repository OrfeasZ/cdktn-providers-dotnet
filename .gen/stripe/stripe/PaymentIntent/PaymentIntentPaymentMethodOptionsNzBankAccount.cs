...
{
    [JsiiByValue(fqn: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsNzBankAccount")]
    public class PaymentIntentPaymentMethodOptionsNzBankAccount : stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsNzBankAccount
    {
