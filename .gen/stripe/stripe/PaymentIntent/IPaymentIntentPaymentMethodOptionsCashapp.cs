...
{
    [JsiiInterface(nativeType: typeof(IPaymentIntentPaymentMethodOptionsCashapp), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsCashapp")]
    public interface IPaymentIntentPaymentMethodOptionsCashapp
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IPaymentIntentPaymentMethodOptionsCashapp), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsCashapp")]
        internal sealed class _Proxy : DeputyBase, stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsCashapp
        {
