...
{
    [JsiiByValue(fqn: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsScalapay")]
    public class PaymentIntentPaymentMethodOptionsScalapay : stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsScalapay
    {
