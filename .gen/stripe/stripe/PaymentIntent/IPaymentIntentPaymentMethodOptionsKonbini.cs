...
{
    [JsiiInterface(nativeType: typeof(IPaymentIntentPaymentMethodOptionsKonbini), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsKonbini")]
    public interface IPaymentIntentPaymentMethodOptionsKonbini
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IPaymentIntentPaymentMethodOptionsKonbini), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsKonbini")]
        internal sealed class _Proxy : DeputyBase, stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsKonbini
        {
