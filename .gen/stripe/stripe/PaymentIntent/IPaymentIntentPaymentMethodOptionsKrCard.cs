...
{
    [JsiiInterface(nativeType: typeof(IPaymentIntentPaymentMethodOptionsKrCard), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsKrCard")]
    public interface IPaymentIntentPaymentMethodOptionsKrCard
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IPaymentIntentPaymentMethodOptionsKrCard), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsKrCard")]
        internal sealed class _Proxy : DeputyBase, stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsKrCard
        {
