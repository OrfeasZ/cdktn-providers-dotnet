...
namespace stripe.PaymentIntent
{
    ...
    [JsiiByValue(fqn: "stripe.paymentIntent.PaymentIntentPaymentMethodDataSofort")]
    public class PaymentIntentPaymentMethodDataSofort : stripe.PaymentIntent.IPaymentIntentPaymentMethodDataSofort
    {
