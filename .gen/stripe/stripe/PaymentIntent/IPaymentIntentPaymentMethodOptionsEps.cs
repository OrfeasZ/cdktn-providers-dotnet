...
{
    [JsiiInterface(nativeType: typeof(IPaymentIntentPaymentMethodOptionsEps), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsEps")]
    public interface IPaymentIntentPaymentMethodOptionsEps
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IPaymentIntentPaymentMethodOptionsEps), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsEps")]
        internal sealed class _Proxy : DeputyBase, stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsEps
        {
