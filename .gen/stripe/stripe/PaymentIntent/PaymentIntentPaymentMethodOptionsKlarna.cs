...
{
    [JsiiByValue(fqn: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsKlarna")]
    public class PaymentIntentPaymentMethodOptionsKlarna : stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsKlarna
    {
