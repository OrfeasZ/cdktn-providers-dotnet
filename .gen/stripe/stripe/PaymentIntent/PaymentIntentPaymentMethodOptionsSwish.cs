...
{
    [JsiiByValue(fqn: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsSwish")]
    public class PaymentIntentPaymentMethodOptionsSwish : stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsSwish
    {
