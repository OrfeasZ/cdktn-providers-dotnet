...
{
    [JsiiInterface(nativeType: typeof(IPaymentIntentPaymentMethodOptionsBlik), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsBlik")]
    public interface IPaymentIntentPaymentMethodOptionsBlik
    {
        /// <summary>The 6-digit BLIK code that a customer has generated using their banking application. Can only be set on confirmation.</summary>
        /// <remarks>
        /// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stripe/stripe/0.3.0/docs/resources/payment_intent#code PaymentIntent#code}
        /// </remarks>
        ...
        [JsiiTypeProxy(nativeType: typeof(IPaymentIntentPaymentMethodOptionsBlik), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsBlik")]
        internal sealed class _Proxy : DeputyBase, stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsBlik
        {
