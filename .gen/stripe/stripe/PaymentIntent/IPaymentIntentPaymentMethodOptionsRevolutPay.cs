...
{
    [JsiiInterface(nativeType: typeof(IPaymentIntentPaymentMethodOptionsRevolutPay), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsRevolutPay")]
    public interface IPaymentIntentPaymentMethodOptionsRevolutPay
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IPaymentIntentPaymentMethodOptionsRevolutPay), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsRevolutPay")]
        internal sealed class _Proxy : DeputyBase, stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsRevolutPay
        {
