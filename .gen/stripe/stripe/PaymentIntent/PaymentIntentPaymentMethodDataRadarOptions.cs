...
{
    [JsiiByValue(fqn: "stripe.paymentIntent.PaymentIntentPaymentMethodDataRadarOptions")]
    public class PaymentIntentPaymentMethodDataRadarOptions : stripe.PaymentIntent.IPaymentIntentPaymentMethodDataRadarOptions
    {
