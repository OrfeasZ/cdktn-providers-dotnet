...
{
    [JsiiInterface(nativeType: typeof(IPaymentIntentPaymentMethodOptionsAcssDebit), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsAcssDebit")]
    public interface IPaymentIntentPaymentMethodOptionsAcssDebit
    {
        ...
        [JsiiProperty(name: "mandateOptions", typeJson: "{\"fqn\":\"stripe.paymentIntent.PaymentIntentPaymentMethodOptionsAcssDebitMandateOptions\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsAcssDebitMandateOptions? MandateOptions
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IPaymentIntentPaymentMethodOptionsAcssDebit), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsAcssDebit")]
        internal sealed class _Proxy : DeputyBase, stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsAcssDebit
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "mandateOptions", typeJson: "{\"fqn\":\"stripe.paymentIntent.PaymentIntentPaymentMethodOptionsAcssDebitMandateOptions\"}", isOptional: true)]
            public stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsAcssDebitMandateOptions? MandateOptions
            {
                get => GetInstanceProperty<stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsAcssDebitMandateOptions?>();
            }
