...
{
    [JsiiByValue(fqn: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsAlipay")]
    public class PaymentIntentPaymentMethodOptionsAlipay : stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsAlipay
    {
