...
{
    [JsiiInterface(nativeType: typeof(IPaymentIntentPaymentMethodOptionsAmazonPay), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsAmazonPay")]
    public interface IPaymentIntentPaymentMethodOptionsAmazonPay
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IPaymentIntentPaymentMethodOptionsAmazonPay), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsAmazonPay")]
        internal sealed class _Proxy : DeputyBase, stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsAmazonPay
        {
