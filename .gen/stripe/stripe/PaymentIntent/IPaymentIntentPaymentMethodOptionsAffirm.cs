...
{
    [JsiiInterface(nativeType: typeof(IPaymentIntentPaymentMethodOptionsAffirm), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsAffirm")]
    public interface IPaymentIntentPaymentMethodOptionsAffirm
    {
        ...
        /// <summary>Preferred language of the Affirm authorization page that the customer is redirected to.</summary>
        /// <remarks>
        ...
        [JsiiTypeProxy(nativeType: typeof(IPaymentIntentPaymentMethodOptionsAffirm), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsAffirm")]
        internal sealed class _Proxy : DeputyBase, stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsAffirm
        {
