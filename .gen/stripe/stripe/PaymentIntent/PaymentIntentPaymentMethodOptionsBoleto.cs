...
{
    [JsiiByValue(fqn: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsBoleto")]
    public class PaymentIntentPaymentMethodOptionsBoleto : stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsBoleto
    {
