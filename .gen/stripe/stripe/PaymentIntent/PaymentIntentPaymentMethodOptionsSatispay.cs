...
{
    [JsiiByValue(fqn: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsSatispay")]
    public class PaymentIntentPaymentMethodOptionsSatispay : stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsSatispay
    {
