...
{
    [JsiiByValue(fqn: "stripe.paymentIntent.PaymentIntentPaymentMethodDataEps")]
    public class PaymentIntentPaymentMethodDataEps : stripe.PaymentIntent.IPaymentIntentPaymentMethodDataEps
    {
