...
{
    [JsiiInterface(nativeType: typeof(IPaymentIntentPaymentMethodOptionsCrypto), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsCrypto")]
    public interface IPaymentIntentPaymentMethodOptionsCrypto
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IPaymentIntentPaymentMethodOptionsCrypto), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsCrypto")]
        internal sealed class _Proxy : DeputyBase, stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsCrypto
        {
