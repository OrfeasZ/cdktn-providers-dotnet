...
{
    [JsiiByValue(fqn: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsBlik")]
    public class PaymentIntentPaymentMethodOptionsBlik : stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsBlik
    {
