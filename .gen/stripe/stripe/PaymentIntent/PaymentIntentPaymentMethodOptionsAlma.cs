...
{
    [JsiiByValue(fqn: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsAlma")]
    public class PaymentIntentPaymentMethodOptionsAlma : stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsAlma
    {
