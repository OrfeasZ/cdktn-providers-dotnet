...
{
    [JsiiByValue(fqn: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsOxxo")]
    public class PaymentIntentPaymentMethodOptionsOxxo : stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsOxxo
    {
