...
{
    [JsiiByValue(fqn: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsCashapp")]
    public class PaymentIntentPaymentMethodOptionsCashapp : stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsCashapp
    {
