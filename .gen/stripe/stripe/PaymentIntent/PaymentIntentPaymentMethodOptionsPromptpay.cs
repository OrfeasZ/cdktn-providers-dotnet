...
{
    [JsiiByValue(fqn: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsPromptpay")]
    public class PaymentIntentPaymentMethodOptionsPromptpay : stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsPromptpay
    {
