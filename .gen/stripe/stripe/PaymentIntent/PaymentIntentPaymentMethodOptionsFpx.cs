...
{
    [JsiiByValue(fqn: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsFpx")]
    public class PaymentIntentPaymentMethodOptionsFpx : stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsFpx
    {
