...
{
    [JsiiByValue(fqn: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsRevolutPay")]
    public class PaymentIntentPaymentMethodOptionsRevolutPay : stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsRevolutPay
    {
