...
{
    [JsiiByValue(fqn: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsAmazonPay")]
    public class PaymentIntentPaymentMethodOptionsAmazonPay : stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsAmazonPay
    {
