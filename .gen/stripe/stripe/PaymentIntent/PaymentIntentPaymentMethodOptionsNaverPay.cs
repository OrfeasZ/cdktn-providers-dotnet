...
{
    [JsiiByValue(fqn: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsNaverPay")]
    public class PaymentIntentPaymentMethodOptionsNaverPay : stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsNaverPay
    {
