...
{
    [JsiiInterface(nativeType: typeof(IPaymentIntentPaymentMethodOptionsSwish), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsSwish")]
    public interface IPaymentIntentPaymentMethodOptionsSwish
    {
        /// <summary>A reference for this payment to be displayed in the Swish app.</summary>
        /// <remarks>
        ...
        [JsiiTypeProxy(nativeType: typeof(IPaymentIntentPaymentMethodOptionsSwish), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsSwish")]
        internal sealed class _Proxy : DeputyBase, stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsSwish
        {
