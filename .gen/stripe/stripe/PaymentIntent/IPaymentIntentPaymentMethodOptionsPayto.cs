...
{
    [JsiiInterface(nativeType: typeof(IPaymentIntentPaymentMethodOptionsPayto), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsPayto")]
    public interface IPaymentIntentPaymentMethodOptionsPayto
    {
        ...
        [JsiiProperty(name: "mandateOptions", typeJson: "{\"fqn\":\"stripe.paymentIntent.PaymentIntentPaymentMethodOptionsPaytoMandateOptions\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsPaytoMandateOptions? MandateOptions
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IPaymentIntentPaymentMethodOptionsPayto), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsPayto")]
        internal sealed class _Proxy : DeputyBase, stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsPayto
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "mandateOptions", typeJson: "{\"fqn\":\"stripe.paymentIntent.PaymentIntentPaymentMethodOptionsPaytoMandateOptions\"}", isOptional: true)]
            public stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsPaytoMandateOptions? MandateOptions
            {
                get => GetInstanceProperty<stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsPaytoMandateOptions?>();
            }
