...
{
    [JsiiClass(nativeType: typeof(stripe.PaymentIntent.PaymentIntentLastPaymentErrorOutputReference), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentLastPaymentErrorOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktn.IInterpolatingParent\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}}]")]
    public class PaymentIntentLastPaymentErrorOutputReference : Io.Cdktn.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        public PaymentIntentLastPaymentErrorOutputReference(Io.Cdktn.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
        ...
        protected PaymentIntentLastPaymentErrorOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected PaymentIntentLastPaymentErrorOutputReference(DeputyProps props): base(props)
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"stripe.paymentIntent.PaymentIntentLastPaymentError\"}", isOptional: true)]
        public virtual stripe.PaymentIntent.IPaymentIntentLastPaymentError? InternalValue
        {
            get => GetInstanceProperty<stripe.PaymentIntent.IPaymentIntentLastPaymentError?>();
