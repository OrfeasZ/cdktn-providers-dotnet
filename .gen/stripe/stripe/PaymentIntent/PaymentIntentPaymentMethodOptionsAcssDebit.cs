...
{
    [JsiiByValue(fqn: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsAcssDebit")]
    public class PaymentIntentPaymentMethodOptionsAcssDebit : stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsAcssDebit
    {
