...
{
    [JsiiByValue(fqn: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsWechatPay")]
    public class PaymentIntentPaymentMethodOptionsWechatPay : stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsWechatPay
    {
