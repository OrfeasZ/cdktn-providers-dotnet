...
{
    [JsiiByValue(fqn: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsEps")]
    public class PaymentIntentPaymentMethodOptionsEps : stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsEps
    {
