...
{
    [JsiiByValue(fqn: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsPayto")]
    public class PaymentIntentPaymentMethodOptionsPayto : stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsPayto
    {
