...
{
    [JsiiInterface(nativeType: typeof(IPaymentIntentPaymentMethodOptionsBancontact), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsBancontact")]
    public interface IPaymentIntentPaymentMethodOptionsBancontact
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IPaymentIntentPaymentMethodOptionsBancontact), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsBancontact")]
        internal sealed class _Proxy : DeputyBase, stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsBancontact
        {
