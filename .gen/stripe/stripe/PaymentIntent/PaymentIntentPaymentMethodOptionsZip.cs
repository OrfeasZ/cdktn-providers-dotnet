...
{
    [JsiiByValue(fqn: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsZip")]
    public class PaymentIntentPaymentMethodOptionsZip : stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsZip
    {
