...
{
    [JsiiInterface(nativeType: typeof(IPaymentIntentPaymentMethodOptionsUsBankAccount), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsUsBankAccount")]
    public interface IPaymentIntentPaymentMethodOptionsUsBankAccount
    {
        ...
        stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsUsBankAccountFinancialConnections? FinancialConnections
        {
            get
            {
                return null;
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsUsBankAccountMandateOptions? MandateOptions
        {
            get
            {
                return null;
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsUsBankAccountNetworks? Networks
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IPaymentIntentPaymentMethodOptionsUsBankAccount), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsUsBankAccount")]
        internal sealed class _Proxy : DeputyBase, stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsUsBankAccount
        {
            ...
            {
                get => GetInstanceProperty<stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsUsBankAccountFinancialConnections?>();
            }
            ...
            {
                get => GetInstanceProperty<stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsUsBankAccountMandateOptions?>();
            }
            ...
            {
                get => GetInstanceProperty<stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsUsBankAccountNetworks?>();
            }
