...
{
    [JsiiByValue(fqn: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsPaypal")]
    public class PaymentIntentPaymentMethodOptionsPaypal : stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsPaypal
    {
