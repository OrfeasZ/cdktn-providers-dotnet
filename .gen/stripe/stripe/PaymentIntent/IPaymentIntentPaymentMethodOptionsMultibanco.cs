...
{
    [JsiiInterface(nativeType: typeof(IPaymentIntentPaymentMethodOptionsMultibanco), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsMultibanco")]
    public interface IPaymentIntentPaymentMethodOptionsMultibanco
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IPaymentIntentPaymentMethodOptionsMultibanco), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsMultibanco")]
        internal sealed class _Proxy : DeputyBase, stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsMultibanco
        {
