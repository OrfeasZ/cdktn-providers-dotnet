...
{
    [JsiiInterface(nativeType: typeof(IPaymentIntentPaymentMethodOptionsPromptpay), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsPromptpay")]
    public interface IPaymentIntentPaymentMethodOptionsPromptpay
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IPaymentIntentPaymentMethodOptionsPromptpay), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsPromptpay")]
        internal sealed class _Proxy : DeputyBase, stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsPromptpay
        {
