...
{
    [JsiiByValue(fqn: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsGiropay")]
    public class PaymentIntentPaymentMethodOptionsGiropay : stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsGiropay
    {
