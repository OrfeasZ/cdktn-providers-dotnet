...
{
    [JsiiInterface(nativeType: typeof(IPaymentIntentPaymentMethodOptionsIdeal), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsIdeal")]
    public interface IPaymentIntentPaymentMethodOptionsIdeal
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IPaymentIntentPaymentMethodOptionsIdeal), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsIdeal")]
        internal sealed class _Proxy : DeputyBase, stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsIdeal
        {
