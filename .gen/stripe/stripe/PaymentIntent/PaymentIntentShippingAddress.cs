...
{
    [JsiiByValue(fqn: "stripe.paymentIntent.PaymentIntentShippingAddress")]
    public class PaymentIntentShippingAddress : stripe.PaymentIntent.IPaymentIntentShippingAddress
    {
