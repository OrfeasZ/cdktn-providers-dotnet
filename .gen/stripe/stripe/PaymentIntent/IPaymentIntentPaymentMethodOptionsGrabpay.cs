...
{
    [JsiiInterface(nativeType: typeof(IPaymentIntentPaymentMethodOptionsGrabpay), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsGrabpay")]
    public interface IPaymentIntentPaymentMethodOptionsGrabpay
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IPaymentIntentPaymentMethodOptionsGrabpay), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsGrabpay")]
        internal sealed class _Proxy : DeputyBase, stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsGrabpay
        {
