...
{
    [JsiiByValue(fqn: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsUpi")]
    public class PaymentIntentPaymentMethodOptionsUpi : stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsUpi
    {
