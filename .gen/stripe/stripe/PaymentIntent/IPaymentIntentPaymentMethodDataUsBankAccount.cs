...
{
    [JsiiInterface(nativeType: typeof(IPaymentIntentPaymentMethodDataUsBankAccount), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodDataUsBankAccount")]
    public interface IPaymentIntentPaymentMethodDataUsBankAccount
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IPaymentIntentPaymentMethodDataUsBankAccount), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodDataUsBankAccount")]
        internal sealed class _Proxy : DeputyBase, stripe.PaymentIntent.IPaymentIntentPaymentMethodDataUsBankAccount
        {
