...
{
    [JsiiInterface(nativeType: typeof(IPaymentIntentPaymentMethodOptionsTwint), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsTwint")]
    public interface IPaymentIntentPaymentMethodOptionsTwint
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IPaymentIntentPaymentMethodOptionsTwint), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsTwint")]
        internal sealed class _Proxy : DeputyBase, stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsTwint
        {
