...
{
    [JsiiInterface(nativeType: typeof(IPaymentIntentPaymentMethodDataUpiMandateOptions), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodDataUpiMandateOptions")]
    public interface IPaymentIntentPaymentMethodDataUpiMandateOptions
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IPaymentIntentPaymentMethodDataUpiMandateOptions), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodDataUpiMandateOptions")]
        internal sealed class _Proxy : DeputyBase, stripe.PaymentIntent.IPaymentIntentPaymentMethodDataUpiMandateOptions
        {
