...
{
    [JsiiByValue(fqn: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsGrabpay")]
    public class PaymentIntentPaymentMethodOptionsGrabpay : stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsGrabpay
    {
