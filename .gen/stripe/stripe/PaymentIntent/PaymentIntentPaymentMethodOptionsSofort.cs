...
{
    [JsiiByValue(fqn: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsSofort")]
    public class PaymentIntentPaymentMethodOptionsSofort : stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsSofort
    {
