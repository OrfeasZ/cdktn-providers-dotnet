...
{
    [JsiiByValue(fqn: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsBillie")]
    public class PaymentIntentPaymentMethodOptionsBillie : stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsBillie
    {
