...
{
    [JsiiInterface(nativeType: typeof(IPaymentIntentPaymentMethodOptionsBacsDebit), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsBacsDebit")]
    public interface IPaymentIntentPaymentMethodOptionsBacsDebit
    {
        ...
        [JsiiProperty(name: "mandateOptions", typeJson: "{\"fqn\":\"stripe.paymentIntent.PaymentIntentPaymentMethodOptionsBacsDebitMandateOptions\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsBacsDebitMandateOptions? MandateOptions
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IPaymentIntentPaymentMethodOptionsBacsDebit), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsBacsDebit")]
        internal sealed class _Proxy : DeputyBase, stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsBacsDebit
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "mandateOptions", typeJson: "{\"fqn\":\"stripe.paymentIntent.PaymentIntentPaymentMethodOptionsBacsDebitMandateOptions\"}", isOptional: true)]
            public stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsBacsDebitMandateOptions? MandateOptions
            {
                get => GetInstanceProperty<stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsBacsDebitMandateOptions?>();
            }
