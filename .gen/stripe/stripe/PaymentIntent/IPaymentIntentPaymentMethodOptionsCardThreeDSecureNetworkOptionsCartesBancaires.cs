...
{
    [JsiiInterface(nativeType: typeof(IPaymentIntentPaymentMethodOptionsCardThreeDSecureNetworkOptionsCartesBancaires), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsCardThreeDSecureNetworkOptionsCartesBancaires")]
    public interface IPaymentIntentPaymentMethodOptionsCardThreeDSecureNetworkOptionsCartesBancaires
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IPaymentIntentPaymentMethodOptionsCardThreeDSecureNetworkOptionsCartesBancaires), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsCardThreeDSecureNetworkOptionsCartesBancaires")]
        internal sealed class _Proxy : DeputyBase, stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsCardThreeDSecureNetworkOptionsCartesBancaires
        {
