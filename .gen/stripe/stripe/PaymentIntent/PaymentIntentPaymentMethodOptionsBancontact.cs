...
{
    [JsiiByValue(fqn: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsBancontact")]
    public class PaymentIntentPaymentMethodOptionsBancontact : stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsBancontact
    {
