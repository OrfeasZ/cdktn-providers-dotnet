...
{
    [JsiiByValue(fqn: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsAuBecsDebit")]
    public class PaymentIntentPaymentMethodOptionsAuBecsDebit : stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsAuBecsDebit
    {
