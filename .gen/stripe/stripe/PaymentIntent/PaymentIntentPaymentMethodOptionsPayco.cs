...
{
    [JsiiByValue(fqn: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsPayco")]
    public class PaymentIntentPaymentMethodOptionsPayco : stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsPayco
    {
