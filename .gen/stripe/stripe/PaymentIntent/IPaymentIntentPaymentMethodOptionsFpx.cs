...
{
    [JsiiInterface(nativeType: typeof(IPaymentIntentPaymentMethodOptionsFpx), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsFpx")]
    public interface IPaymentIntentPaymentMethodOptionsFpx
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IPaymentIntentPaymentMethodOptionsFpx), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsFpx")]
        internal sealed class _Proxy : DeputyBase, stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsFpx
        {
