...
{
    [JsiiByValue(fqn: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsKakaoPay")]
    public class PaymentIntentPaymentMethodOptionsKakaoPay : stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsKakaoPay
    {
