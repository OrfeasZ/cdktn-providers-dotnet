...
{
    [JsiiInterface(nativeType: typeof(IPaymentIntentPaymentMethodOptionsSepaDebit), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsSepaDebit")]
    public interface IPaymentIntentPaymentMethodOptionsSepaDebit
    {
        ...
        stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsSepaDebitMandateOptions? MandateOptions
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IPaymentIntentPaymentMethodOptionsSepaDebit), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsSepaDebit")]
        internal sealed class _Proxy : DeputyBase, stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsSepaDebit
        {
            ...
            {
                get => GetInstanceProperty<stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsSepaDebitMandateOptions?>();
            }
