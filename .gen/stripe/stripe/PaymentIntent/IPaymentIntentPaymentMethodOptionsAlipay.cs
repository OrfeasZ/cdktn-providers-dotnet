...
{
    [JsiiInterface(nativeType: typeof(IPaymentIntentPaymentMethodOptionsAlipay), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsAlipay")]
    public interface IPaymentIntentPaymentMethodOptionsAlipay
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IPaymentIntentPaymentMethodOptionsAlipay), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsAlipay")]
        internal sealed class _Proxy : DeputyBase, stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsAlipay
        {
