...
{
    [JsiiInterface(nativeType: typeof(IPaymentIntentPaymentMethodOptionsNzBankAccount), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsNzBankAccount")]
    public interface IPaymentIntentPaymentMethodOptionsNzBankAccount
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IPaymentIntentPaymentMethodOptionsNzBankAccount), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsNzBankAccount")]
        internal sealed class _Proxy : DeputyBase, stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsNzBankAccount
        {
