...
{
    [JsiiInterface(nativeType: typeof(IPaymentIntentPaymentMethodOptionsGiropay), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsGiropay")]
    public interface IPaymentIntentPaymentMethodOptionsGiropay
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IPaymentIntentPaymentMethodOptionsGiropay), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsGiropay")]
        internal sealed class _Proxy : DeputyBase, stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsGiropay
        {
