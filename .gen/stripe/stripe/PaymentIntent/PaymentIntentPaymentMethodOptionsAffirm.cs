...
{
    [JsiiByValue(fqn: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsAffirm")]
    public class PaymentIntentPaymentMethodOptionsAffirm : stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsAffirm
    {
