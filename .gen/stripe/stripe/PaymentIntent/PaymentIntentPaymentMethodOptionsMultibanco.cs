...
{
    [JsiiByValue(fqn: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsMultibanco")]
    public class PaymentIntentPaymentMethodOptionsMultibanco : stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsMultibanco
    {
