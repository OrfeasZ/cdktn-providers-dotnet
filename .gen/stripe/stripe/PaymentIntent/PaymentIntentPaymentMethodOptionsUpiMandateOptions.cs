...
{
    [JsiiByValue(fqn: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsUpiMandateOptions")]
    public class PaymentIntentPaymentMethodOptionsUpiMandateOptions : stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsUpiMandateOptions
    {
