...
{
    [JsiiInterface(nativeType: typeof(IPaymentIntentPaymentMethodOptionsAuBecsDebit), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsAuBecsDebit")]
    public interface IPaymentIntentPaymentMethodOptionsAuBecsDebit
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IPaymentIntentPaymentMethodOptionsAuBecsDebit), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsAuBecsDebit")]
        internal sealed class _Proxy : DeputyBase, stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsAuBecsDebit
        {
