...
{
    [JsiiByValue(fqn: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsKrCard")]
    public class PaymentIntentPaymentMethodOptionsKrCard : stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsKrCard
    {
