...
{
    [JsiiByValue(fqn: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsBacsDebit")]
    public class PaymentIntentPaymentMethodOptionsBacsDebit : stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsBacsDebit
    {
