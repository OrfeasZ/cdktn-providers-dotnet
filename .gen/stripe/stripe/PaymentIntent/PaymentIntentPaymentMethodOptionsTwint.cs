...
{
    [JsiiByValue(fqn: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsTwint")]
    public class PaymentIntentPaymentMethodOptionsTwint : stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsTwint
    {
