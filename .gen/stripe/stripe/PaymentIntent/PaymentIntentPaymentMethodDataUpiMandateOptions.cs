...
{
    [JsiiByValue(fqn: "stripe.paymentIntent.PaymentIntentPaymentMethodDataUpiMandateOptions")]
    public class PaymentIntentPaymentMethodDataUpiMandateOptions : stripe.PaymentIntent.IPaymentIntentPaymentMethodDataUpiMandateOptions
    {
