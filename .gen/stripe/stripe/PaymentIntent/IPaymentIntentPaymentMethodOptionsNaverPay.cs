...
{
    [JsiiInterface(nativeType: typeof(IPaymentIntentPaymentMethodOptionsNaverPay), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsNaverPay")]
    public interface IPaymentIntentPaymentMethodOptionsNaverPay
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IPaymentIntentPaymentMethodOptionsNaverPay), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsNaverPay")]
        internal sealed class _Proxy : DeputyBase, stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsNaverPay
        {
