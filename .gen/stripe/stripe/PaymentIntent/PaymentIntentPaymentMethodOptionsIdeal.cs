...
{
    [JsiiByValue(fqn: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsIdeal")]
    public class PaymentIntentPaymentMethodOptionsIdeal : stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsIdeal
    {
