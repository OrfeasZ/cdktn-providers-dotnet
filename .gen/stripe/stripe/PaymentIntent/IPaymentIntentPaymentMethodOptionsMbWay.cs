...
{
    [JsiiInterface(nativeType: typeof(IPaymentIntentPaymentMethodOptionsMbWay), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsMbWay")]
    public interface IPaymentIntentPaymentMethodOptionsMbWay
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IPaymentIntentPaymentMethodOptionsMbWay), fullyQualifiedName: "stripe.paymentIntent.PaymentIntentPaymentMethodOptionsMbWay")]
        internal sealed class _Proxy : DeputyBase, stripe.PaymentIntent.IPaymentIntentPaymentMethodOptionsMbWay
        {
