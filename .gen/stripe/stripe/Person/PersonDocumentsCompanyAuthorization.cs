...
{
    [JsiiByValue(fqn: "stripe.person.PersonDocumentsCompanyAuthorization")]
    public class PersonDocumentsCompanyAuthorization : stripe.Person.IPersonDocumentsCompanyAuthorization
    {
