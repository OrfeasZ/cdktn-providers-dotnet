...
{
    [JsiiInterface(nativeType: typeof(IPersonAddress), fullyQualifiedName: "stripe.person.PersonAddress")]
    public interface IPersonAddress
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IPersonAddress), fullyQualifiedName: "stripe.person.PersonAddress")]
        internal sealed class _Proxy : DeputyBase, stripe.Person.IPersonAddress
        {
