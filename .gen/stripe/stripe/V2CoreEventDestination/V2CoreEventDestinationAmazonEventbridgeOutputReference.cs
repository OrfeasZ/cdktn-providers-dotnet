...
namespace stripe.V2CoreEventDestination
{
    ...
    public class V2CoreEventDestinationAmazonEventbridgeOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        public V2CoreEventDestinationAmazonEventbridgeOutputReference(Io.Cdktn.IInterpolatingParent terraformResource, string terraformAttribute, double complexObjectIndex, bool complexObjectIsFromSet): base(_MakeDeputyProps(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet))
        {
        }
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"stripe.v2CoreEventDestination.V2CoreEventDestinationAmazonEventbridge\"}]}}", isOptional: true)]
