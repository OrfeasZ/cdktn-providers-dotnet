...
namespace stripe.SubscriptionItem
{
    ...
    [JsiiByValue(fqn: "stripe.subscriptionItem.SubscriptionItemPriceDataRecurring")]
    public class SubscriptionItemPriceDataRecurring : stripe.SubscriptionItem.ISubscriptionItemPriceDataRecurring
    {
