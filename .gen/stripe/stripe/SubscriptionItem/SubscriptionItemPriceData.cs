...
namespace stripe.SubscriptionItem
{
    ...
    [JsiiByValue(fqn: "stripe.subscriptionItem.SubscriptionItemPriceData")]
    public class SubscriptionItemPriceData : stripe.SubscriptionItem.ISubscriptionItemPriceData
    {
