...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/stripe/stripe/0.3.0/docs/resources/tax_rate stripe_tax_rate}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/stripe/stripe/0.3.0/docs/resources/tax_rate stripe_tax_rate} Resource.</summary>
        ...
        [JsiiProperty(name: "flatAmount", typeJson: "{\"fqn\":\"stripe.taxRate.TaxRateFlatAmountOutputReference\"}")]
        public virtual stripe.TaxRate.TaxRateFlatAmountOutputReference FlatAmount
        {
            get => GetInstanceProperty<stripe.TaxRate.TaxRateFlatAmountOutputReference>()!;
        }
