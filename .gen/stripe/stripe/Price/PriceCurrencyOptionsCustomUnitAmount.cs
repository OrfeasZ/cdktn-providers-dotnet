...
namespace stripe.Price
{
    ...
    [JsiiByValue(fqn: "stripe.price.PriceCurrencyOptionsCustomUnitAmount")]
    public class PriceCurrencyOptionsCustomUnitAmount : stripe.Price.IPriceCurrencyOptionsCustomUnitAmount
    {
