...
namespace stripe.Price
{
    ...
    public interface IPriceTiers
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IPriceTiers), fullyQualifiedName: "stripe.price.PriceTiers")]
        internal sealed class _Proxy : DeputyBase, stripe.Price.IPriceTiers
        {
