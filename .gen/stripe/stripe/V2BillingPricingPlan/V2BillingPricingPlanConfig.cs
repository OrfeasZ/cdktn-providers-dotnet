...
namespace stripe.V2BillingPricingPlan
{
    ...
    [JsiiByValue(fqn: "stripe.v2BillingPricingPlan.V2BillingPricingPlanConfig")]
    public class V2BillingPricingPlanConfig : stripe.V2BillingPricingPlan.IV2BillingPricingPlanConfig
    {
