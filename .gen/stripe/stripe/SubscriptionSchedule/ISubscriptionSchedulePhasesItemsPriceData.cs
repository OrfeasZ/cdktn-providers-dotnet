...
{
    [JsiiInterface(nativeType: typeof(ISubscriptionSchedulePhasesItemsPriceData), fullyQualifiedName: "stripe.subscriptionSchedule.SubscriptionSchedulePhasesItemsPriceData")]
    public interface ISubscriptionSchedulePhasesItemsPriceData
    {
        ...
        stripe.SubscriptionSchedule.ISubscriptionSchedulePhasesItemsPriceDataRecurring Recurring
        {
            get;
        }
        ...
        [JsiiTypeProxy(nativeType: typeof(ISubscriptionSchedulePhasesItemsPriceData), fullyQualifiedName: "stripe.subscriptionSchedule.SubscriptionSchedulePhasesItemsPriceData")]
        internal sealed class _Proxy : DeputyBase, stripe.SubscriptionSchedule.ISubscriptionSchedulePhasesItemsPriceData
        {
