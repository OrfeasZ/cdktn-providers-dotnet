...
namespace stripe.SubscriptionSchedule
{
    ...
    [JsiiByValue(fqn: "stripe.subscriptionSchedule.SubscriptionSchedulePhasesItemsPriceData")]
    public class SubscriptionSchedulePhasesItemsPriceData : stripe.SubscriptionSchedule.ISubscriptionSchedulePhasesItemsPriceData
    {
        ...
        /// <remarks>
        /// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stripe/stripe/0.3.0/docs/resources/subscription_schedule#recurring SubscriptionSchedule#recurring}
        /// </remarks>
        [JsiiProperty(name: "recurring", typeJson: "{\"fqn\":\"stripe.subscriptionSchedule.SubscriptionSchedulePhasesItemsPriceDataRecurring\"}")]
        public stripe.SubscriptionSchedule.ISubscriptionSchedulePhasesItemsPriceDataRecurring Recurring
        {
            get;
            set;
        }
