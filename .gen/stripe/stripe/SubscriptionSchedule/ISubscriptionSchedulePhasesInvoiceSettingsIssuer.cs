...
{
    [JsiiInterface(nativeType: typeof(ISubscriptionSchedulePhasesInvoiceSettingsIssuer), fullyQualifiedName: "stripe.subscriptionSchedule.SubscriptionSchedulePhasesInvoiceSettingsIssuer")]
    public interface ISubscriptionSchedulePhasesInvoiceSettingsIssuer
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ISubscriptionSchedulePhasesInvoiceSettingsIssuer), fullyQualifiedName: "stripe.subscriptionSchedule.SubscriptionSchedulePhasesInvoiceSettingsIssuer")]
        internal sealed class _Proxy : DeputyBase, stripe.SubscriptionSchedule.ISubscriptionSchedulePhasesInvoiceSettingsIssuer
        {
