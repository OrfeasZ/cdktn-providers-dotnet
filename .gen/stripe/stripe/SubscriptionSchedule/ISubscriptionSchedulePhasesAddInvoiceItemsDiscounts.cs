...
{
    [JsiiInterface(nativeType: typeof(ISubscriptionSchedulePhasesAddInvoiceItemsDiscounts), fullyQualifiedName: "stripe.subscriptionSchedule.SubscriptionSchedulePhasesAddInvoiceItemsDiscounts")]
    public interface ISubscriptionSchedulePhasesAddInvoiceItemsDiscounts
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ISubscriptionSchedulePhasesAddInvoiceItemsDiscounts), fullyQualifiedName: "stripe.subscriptionSchedule.SubscriptionSchedulePhasesAddInvoiceItemsDiscounts")]
        internal sealed class _Proxy : DeputyBase, stripe.SubscriptionSchedule.ISubscriptionSchedulePhasesAddInvoiceItemsDiscounts
        {
