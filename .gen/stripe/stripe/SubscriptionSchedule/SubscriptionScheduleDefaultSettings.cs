...
{
    [JsiiByValue(fqn: "stripe.subscriptionSchedule.SubscriptionScheduleDefaultSettings")]
    public class SubscriptionScheduleDefaultSettings : stripe.SubscriptionSchedule.ISubscriptionScheduleDefaultSettings
    {
