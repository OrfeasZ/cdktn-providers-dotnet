...
{
    [JsiiInterface(nativeType: typeof(IQuoteLineItemsPriceData), fullyQualifiedName: "stripe.quote.QuoteLineItemsPriceData")]
    public interface IQuoteLineItemsPriceData
    {
        ...
        stripe.Quote.IQuoteLineItemsPriceDataRecurring? Recurring
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IQuoteLineItemsPriceData), fullyQualifiedName: "stripe.quote.QuoteLineItemsPriceData")]
        internal sealed class _Proxy : DeputyBase, stripe.Quote.IQuoteLineItemsPriceData
        {
            ...
            {
                get => GetInstanceProperty<stripe.Quote.IQuoteLineItemsPriceDataRecurring?>();
            }
