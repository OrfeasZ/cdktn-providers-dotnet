...
{
    [JsiiInterface(nativeType: typeof(IQuoteDiscounts), fullyQualifiedName: "stripe.quote.QuoteDiscounts")]
    public interface IQuoteDiscounts
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IQuoteDiscounts), fullyQualifiedName: "stripe.quote.QuoteDiscounts")]
        internal sealed class _Proxy : DeputyBase, stripe.Quote.IQuoteDiscounts
        {
