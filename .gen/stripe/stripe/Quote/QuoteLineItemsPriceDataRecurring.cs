...
namespace stripe.Quote
{
    ...
    [JsiiByValue(fqn: "stripe.quote.QuoteLineItemsPriceDataRecurring")]
    public class QuoteLineItemsPriceDataRecurring : stripe.Quote.IQuoteLineItemsPriceDataRecurring
    {
