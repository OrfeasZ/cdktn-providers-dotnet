...
{
    [JsiiClass(nativeType: typeof(stripe.Invoice.InvoiceLastFinalizationErrorOutputReference), fullyQualifiedName: "stripe.invoice.InvoiceLastFinalizationErrorOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktn.IInterpolatingParent\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}}]")]
    public class InvoiceLastFinalizationErrorOutputReference : Io.Cdktn.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        public InvoiceLastFinalizationErrorOutputReference(Io.Cdktn.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
        ...
        protected InvoiceLastFinalizationErrorOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected InvoiceLastFinalizationErrorOutputReference(DeputyProps props): base(props)
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"stripe.invoice.InvoiceLastFinalizationError\"}", isOptional: true)]
        public virtual stripe.Invoice.IInvoiceLastFinalizationError? InternalValue
        {
            get => GetInstanceProperty<stripe.Invoice.IInvoiceLastFinalizationError?>();
