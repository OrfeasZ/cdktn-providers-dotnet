...
{
    [JsiiByValue(fqn: "stripe.paymentMethod.PaymentMethodBillingDetailsAddress")]
    public class PaymentMethodBillingDetailsAddress : stripe.PaymentMethod.IPaymentMethodBillingDetailsAddress
    {
