...
namespace stripe.RadarValueListItem
{
    ...
    [JsiiByValue(fqn: "stripe.radarValueListItem.RadarValueListItemConfig")]
    public class RadarValueListItemConfig : stripe.RadarValueListItem.IRadarValueListItemConfig
    {
