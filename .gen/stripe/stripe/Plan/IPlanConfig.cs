...
{
    [JsiiInterface(nativeType: typeof(IPlanConfig), fullyQualifiedName: "stripe.plan.PlanConfig")]
    public interface IPlanConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        stripe.Plan.IPlanTransformUsage? TransformUsage
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IPlanConfig), fullyQualifiedName: "stripe.plan.PlanConfig")]
        internal sealed class _Proxy : DeputyBase, stripe.Plan.IPlanConfig
        {
            ...
            {
                get => GetInstanceProperty<stripe.Plan.IPlanTransformUsage?>();
            }
