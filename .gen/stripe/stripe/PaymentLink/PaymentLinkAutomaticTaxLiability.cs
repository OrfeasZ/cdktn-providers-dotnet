...
namespace stripe.PaymentLink
{
    ...
    [JsiiByValue(fqn: "stripe.paymentLink.PaymentLinkAutomaticTaxLiability")]
    public class PaymentLinkAutomaticTaxLiability : stripe.PaymentLink.IPaymentLinkAutomaticTaxLiability
    {
