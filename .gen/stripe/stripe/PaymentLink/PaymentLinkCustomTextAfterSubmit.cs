...
namespace stripe.PaymentLink
{
    ...
    [JsiiByValue(fqn: "stripe.paymentLink.PaymentLinkCustomTextAfterSubmit")]
    public class PaymentLinkCustomTextAfterSubmit : stripe.PaymentLink.IPaymentLinkCustomTextAfterSubmit
    {
