...
namespace stripe.PaymentLink
{
    ...
    [JsiiByValue(fqn: "stripe.paymentLink.PaymentLinkNameCollectionBusiness")]
    public class PaymentLinkNameCollectionBusiness : stripe.PaymentLink.IPaymentLinkNameCollectionBusiness
    {
