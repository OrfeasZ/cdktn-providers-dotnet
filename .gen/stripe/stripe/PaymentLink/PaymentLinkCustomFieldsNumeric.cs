...
{
    [JsiiByValue(fqn: "stripe.paymentLink.PaymentLinkCustomFieldsNumeric")]
    public class PaymentLinkCustomFieldsNumeric : stripe.PaymentLink.IPaymentLinkCustomFieldsNumeric
    {
