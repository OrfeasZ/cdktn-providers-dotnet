...
namespace stripe.PaymentLink
{
    ...
    [JsiiByValue(fqn: "stripe.paymentLink.PaymentLinkCustomTextShippingAddress")]
    public class PaymentLinkCustomTextShippingAddress : stripe.PaymentLink.IPaymentLinkCustomTextShippingAddress
    {
