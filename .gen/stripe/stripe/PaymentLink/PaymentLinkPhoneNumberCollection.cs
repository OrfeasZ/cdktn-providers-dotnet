...
namespace stripe.PaymentLink
{
    ...
    [JsiiByValue(fqn: "stripe.paymentLink.PaymentLinkPhoneNumberCollection")]
    public class PaymentLinkPhoneNumberCollection : stripe.PaymentLink.IPaymentLinkPhoneNumberCollection
    {
