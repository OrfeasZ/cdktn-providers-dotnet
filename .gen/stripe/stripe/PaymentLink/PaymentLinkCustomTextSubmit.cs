...
namespace stripe.PaymentLink
{
    ...
    [JsiiByValue(fqn: "stripe.paymentLink.PaymentLinkCustomTextSubmit")]
    public class PaymentLinkCustomTextSubmit : stripe.PaymentLink.IPaymentLinkCustomTextSubmit
    {
