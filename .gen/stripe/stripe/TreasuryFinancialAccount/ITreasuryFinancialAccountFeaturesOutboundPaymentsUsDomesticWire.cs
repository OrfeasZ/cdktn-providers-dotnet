...
{
    [JsiiInterface(nativeType: typeof(ITreasuryFinancialAccountFeaturesOutboundPaymentsUsDomesticWire), fullyQualifiedName: "stripe.treasuryFinancialAccount.TreasuryFinancialAccountFeaturesOutboundPaymentsUsDomesticWire")]
    public interface ITreasuryFinancialAccountFeaturesOutboundPaymentsUsDomesticWire
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "statusDetails", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"stripe.treasuryFinancialAccount.TreasuryFinancialAccountFeaturesOutboundPaymentsUsDomesticWireStatusDetails\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        ...
        [JsiiTypeProxy(nativeType: typeof(ITreasuryFinancialAccountFeaturesOutboundPaymentsUsDomesticWire), fullyQualifiedName: "stripe.treasuryFinancialAccount.TreasuryFinancialAccountFeaturesOutboundPaymentsUsDomesticWire")]
        internal sealed class _Proxy : DeputyBase, stripe.TreasuryFinancialAccount.ITreasuryFinancialAccountFeaturesOutboundPaymentsUsDomesticWire
        {
