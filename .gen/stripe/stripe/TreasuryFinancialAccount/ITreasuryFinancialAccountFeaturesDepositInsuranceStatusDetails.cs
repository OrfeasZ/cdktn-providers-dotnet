...
{
    [JsiiInterface(nativeType: typeof(ITreasuryFinancialAccountFeaturesDepositInsuranceStatusDetails), fullyQualifiedName: "stripe.treasuryFinancialAccount.TreasuryFinancialAccountFeaturesDepositInsuranceStatusDetails")]
    public interface ITreasuryFinancialAccountFeaturesDepositInsuranceStatusDetails
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ITreasuryFinancialAccountFeaturesDepositInsuranceStatusDetails), fullyQualifiedName: "stripe.treasuryFinancialAccount.TreasuryFinancialAccountFeaturesDepositInsuranceStatusDetails")]
        internal sealed class _Proxy : DeputyBase, stripe.TreasuryFinancialAccount.ITreasuryFinancialAccountFeaturesDepositInsuranceStatusDetails
        {
