...
{
    [JsiiInterface(nativeType: typeof(ITreasuryFinancialAccountFeaturesOutboundTransfersUsDomesticWireStatusDetails), fullyQualifiedName: "stripe.treasuryFinancialAccount.TreasuryFinancialAccountFeaturesOutboundTransfersUsDomesticWireStatusDetails")]
    public interface ITreasuryFinancialAccountFeaturesOutboundTransfersUsDomesticWireStatusDetails
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ITreasuryFinancialAccountFeaturesOutboundTransfersUsDomesticWireStatusDetails), fullyQualifiedName: "stripe.treasuryFinancialAccount.TreasuryFinancialAccountFeaturesOutboundTransfersUsDomesticWireStatusDetails")]
        internal sealed class _Proxy : DeputyBase, stripe.TreasuryFinancialAccount.ITreasuryFinancialAccountFeaturesOutboundTransfersUsDomesticWireStatusDetails
        {
