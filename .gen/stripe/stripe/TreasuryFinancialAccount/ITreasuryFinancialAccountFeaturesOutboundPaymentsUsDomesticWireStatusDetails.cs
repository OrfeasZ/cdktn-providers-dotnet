...
{
    [JsiiInterface(nativeType: typeof(ITreasuryFinancialAccountFeaturesOutboundPaymentsUsDomesticWireStatusDetails), fullyQualifiedName: "stripe.treasuryFinancialAccount.TreasuryFinancialAccountFeaturesOutboundPaymentsUsDomesticWireStatusDetails")]
    public interface ITreasuryFinancialAccountFeaturesOutboundPaymentsUsDomesticWireStatusDetails
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ITreasuryFinancialAccountFeaturesOutboundPaymentsUsDomesticWireStatusDetails), fullyQualifiedName: "stripe.treasuryFinancialAccount.TreasuryFinancialAccountFeaturesOutboundPaymentsUsDomesticWireStatusDetails")]
        internal sealed class _Proxy : DeputyBase, stripe.TreasuryFinancialAccount.ITreasuryFinancialAccountFeaturesOutboundPaymentsUsDomesticWireStatusDetails
        {
