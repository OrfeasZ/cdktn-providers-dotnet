...
{
    [JsiiInterface(nativeType: typeof(ITreasuryFinancialAccountFeaturesIntraStripeFlowsStatusDetails), fullyQualifiedName: "stripe.treasuryFinancialAccount.TreasuryFinancialAccountFeaturesIntraStripeFlowsStatusDetails")]
    public interface ITreasuryFinancialAccountFeaturesIntraStripeFlowsStatusDetails
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ITreasuryFinancialAccountFeaturesIntraStripeFlowsStatusDetails), fullyQualifiedName: "stripe.treasuryFinancialAccount.TreasuryFinancialAccountFeaturesIntraStripeFlowsStatusDetails")]
        internal sealed class _Proxy : DeputyBase, stripe.TreasuryFinancialAccount.ITreasuryFinancialAccountFeaturesIntraStripeFlowsStatusDetails
        {
