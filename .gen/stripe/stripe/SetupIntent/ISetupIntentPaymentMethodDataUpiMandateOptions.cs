...
{
    [JsiiInterface(nativeType: typeof(ISetupIntentPaymentMethodDataUpiMandateOptions), fullyQualifiedName: "stripe.setupIntent.SetupIntentPaymentMethodDataUpiMandateOptions")]
    public interface ISetupIntentPaymentMethodDataUpiMandateOptions
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ISetupIntentPaymentMethodDataUpiMandateOptions), fullyQualifiedName: "stripe.setupIntent.SetupIntentPaymentMethodDataUpiMandateOptions")]
        internal sealed class _Proxy : DeputyBase, stripe.SetupIntent.ISetupIntentPaymentMethodDataUpiMandateOptions
        {
