...
namespace stripe.SetupIntent
{
    ...
    [JsiiByValue(fqn: "stripe.setupIntent.SetupIntentPaymentMethodDataSofort")]
    public class SetupIntentPaymentMethodDataSofort : stripe.SetupIntent.ISetupIntentPaymentMethodDataSofort
    {
