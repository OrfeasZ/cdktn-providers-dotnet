...
{
    [JsiiByValue(fqn: "stripe.setupIntent.SetupIntentPaymentMethodDataUpiMandateOptions")]
    public class SetupIntentPaymentMethodDataUpiMandateOptions : stripe.SetupIntent.ISetupIntentPaymentMethodDataUpiMandateOptions
    {
