...
{
    [JsiiByValue(fqn: "stripe.setupIntent.SetupIntentPaymentMethodDataEps")]
    public class SetupIntentPaymentMethodDataEps : stripe.SetupIntent.ISetupIntentPaymentMethodDataEps
    {
