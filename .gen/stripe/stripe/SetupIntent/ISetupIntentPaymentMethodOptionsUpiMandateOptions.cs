...
{
    [JsiiInterface(nativeType: typeof(ISetupIntentPaymentMethodOptionsUpiMandateOptions), fullyQualifiedName: "stripe.setupIntent.SetupIntentPaymentMethodOptionsUpiMandateOptions")]
    public interface ISetupIntentPaymentMethodOptionsUpiMandateOptions
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ISetupIntentPaymentMethodOptionsUpiMandateOptions), fullyQualifiedName: "stripe.setupIntent.SetupIntentPaymentMethodOptionsUpiMandateOptions")]
        internal sealed class _Proxy : DeputyBase, stripe.SetupIntent.ISetupIntentPaymentMethodOptionsUpiMandateOptions
        {
