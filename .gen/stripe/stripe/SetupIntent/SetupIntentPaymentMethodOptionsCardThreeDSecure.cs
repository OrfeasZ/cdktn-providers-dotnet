...
{
    [JsiiByValue(fqn: "stripe.setupIntent.SetupIntentPaymentMethodOptionsCardThreeDSecure")]
    public class SetupIntentPaymentMethodOptionsCardThreeDSecure : stripe.SetupIntent.ISetupIntentPaymentMethodOptionsCardThreeDSecure
    {
