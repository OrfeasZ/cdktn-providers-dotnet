...
{
    [JsiiByValue(fqn: "stripe.setupIntent.SetupIntentPaymentMethodOptionsUpiMandateOptions")]
    public class SetupIntentPaymentMethodOptionsUpiMandateOptions : stripe.SetupIntent.ISetupIntentPaymentMethodOptionsUpiMandateOptions
    {
