...
{
    [JsiiByValue(fqn: "stripe.setupIntent.SetupIntentPaymentMethodOptionsBacsDebit")]
    public class SetupIntentPaymentMethodOptionsBacsDebit : stripe.SetupIntent.ISetupIntentPaymentMethodOptionsBacsDebit
    {
