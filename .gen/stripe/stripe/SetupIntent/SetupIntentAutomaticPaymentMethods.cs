...
namespace stripe.SetupIntent
{
    ...
    [JsiiByValue(fqn: "stripe.setupIntent.SetupIntentAutomaticPaymentMethods")]
    public class SetupIntentAutomaticPaymentMethods : stripe.SetupIntent.ISetupIntentAutomaticPaymentMethods
    {
