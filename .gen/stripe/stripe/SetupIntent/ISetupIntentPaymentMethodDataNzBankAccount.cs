...
{
    [JsiiInterface(nativeType: typeof(ISetupIntentPaymentMethodDataNzBankAccount), fullyQualifiedName: "stripe.setupIntent.SetupIntentPaymentMethodDataNzBankAccount")]
    public interface ISetupIntentPaymentMethodDataNzBankAccount
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ISetupIntentPaymentMethodDataNzBankAccount), fullyQualifiedName: "stripe.setupIntent.SetupIntentPaymentMethodDataNzBankAccount")]
        internal sealed class _Proxy : DeputyBase, stripe.SetupIntent.ISetupIntentPaymentMethodDataNzBankAccount
        {
