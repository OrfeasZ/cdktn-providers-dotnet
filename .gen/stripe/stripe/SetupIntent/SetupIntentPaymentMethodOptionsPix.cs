...
{
    [JsiiByValue(fqn: "stripe.setupIntent.SetupIntentPaymentMethodOptionsPix")]
    public class SetupIntentPaymentMethodOptionsPix : stripe.SetupIntent.ISetupIntentPaymentMethodOptionsPix
    {
