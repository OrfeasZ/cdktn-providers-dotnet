...
{
    [JsiiByValue(fqn: "stripe.issuingDispute.IssuingDisputeEvidenceFraudulent")]
    public class IssuingDisputeEvidenceFraudulent : stripe.IssuingDispute.IIssuingDisputeEvidenceFraudulent
    {
