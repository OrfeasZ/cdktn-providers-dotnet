...
{
    [JsiiByValue(fqn: "stripe.issuingDispute.IssuingDisputeEvidenceNotReceived")]
    public class IssuingDisputeEvidenceNotReceived : stripe.IssuingDispute.IIssuingDisputeEvidenceNotReceived
    {
