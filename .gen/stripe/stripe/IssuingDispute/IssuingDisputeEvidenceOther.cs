...
{
    [JsiiByValue(fqn: "stripe.issuingDispute.IssuingDisputeEvidenceOther")]
    public class IssuingDisputeEvidenceOther : stripe.IssuingDispute.IIssuingDisputeEvidenceOther
    {
