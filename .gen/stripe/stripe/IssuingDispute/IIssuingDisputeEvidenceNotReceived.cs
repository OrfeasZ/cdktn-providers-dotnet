...
{
    [JsiiInterface(nativeType: typeof(IIssuingDisputeEvidenceNotReceived), fullyQualifiedName: "stripe.issuingDispute.IssuingDisputeEvidenceNotReceived")]
    public interface IIssuingDisputeEvidenceNotReceived
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IIssuingDisputeEvidenceNotReceived), fullyQualifiedName: "stripe.issuingDispute.IssuingDisputeEvidenceNotReceived")]
        internal sealed class _Proxy : DeputyBase, stripe.IssuingDispute.IIssuingDisputeEvidenceNotReceived
        {
