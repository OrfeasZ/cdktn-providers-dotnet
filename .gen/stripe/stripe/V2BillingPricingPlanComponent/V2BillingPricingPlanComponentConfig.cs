...
namespace stripe.V2BillingPricingPlanComponent
{
    ...
    [JsiiByValue(fqn: "stripe.v2BillingPricingPlanComponent.V2BillingPricingPlanComponentConfig")]
    public class V2BillingPricingPlanComponentConfig : stripe.V2BillingPricingPlanComponent.IV2BillingPricingPlanComponentConfig
    {
