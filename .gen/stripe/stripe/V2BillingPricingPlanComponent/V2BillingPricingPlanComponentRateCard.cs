...
namespace stripe.V2BillingPricingPlanComponent
{
    ...
    [JsiiByValue(fqn: "stripe.v2BillingPricingPlanComponent.V2BillingPricingPlanComponentRateCard")]
    public class V2BillingPricingPlanComponentRateCard : stripe.V2BillingPricingPlanComponent.IV2BillingPricingPlanComponentRateCard
    {
        /// <summary>The ID of the Rate Card.</summary>
        /// <remarks>
        ...
        /// <summary>The version of the RateCard. Defaults to 'latest', if not specified.</summary>
        /// <remarks>
