...
{
    [JsiiByValue(fqn: "stripe.paymentMethodConfiguration.PaymentMethodConfigurationAffirm")]
    public class PaymentMethodConfigurationAffirm : stripe.PaymentMethodConfiguration.IPaymentMethodConfigurationAffirm
    {
