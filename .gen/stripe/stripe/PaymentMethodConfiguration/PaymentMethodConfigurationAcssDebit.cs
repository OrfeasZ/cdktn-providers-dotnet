...
{
    [JsiiByValue(fqn: "stripe.paymentMethodConfiguration.PaymentMethodConfigurationAcssDebit")]
    public class PaymentMethodConfigurationAcssDebit : stripe.PaymentMethodConfiguration.IPaymentMethodConfigurationAcssDebit
    {
