...
{
    [JsiiByValue(fqn: "stripe.paymentMethodConfiguration.PaymentMethodConfigurationFpx")]
    public class PaymentMethodConfigurationFpx : stripe.PaymentMethodConfiguration.IPaymentMethodConfigurationFpx
    {
