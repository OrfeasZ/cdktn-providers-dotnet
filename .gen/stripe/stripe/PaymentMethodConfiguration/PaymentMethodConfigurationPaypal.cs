...
{
    [JsiiByValue(fqn: "stripe.paymentMethodConfiguration.PaymentMethodConfigurationPaypal")]
    public class PaymentMethodConfigurationPaypal : stripe.PaymentMethodConfiguration.IPaymentMethodConfigurationPaypal
    {
