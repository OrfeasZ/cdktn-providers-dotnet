...
{
    [JsiiByValue(fqn: "stripe.paymentMethodConfiguration.PaymentMethodConfigurationApplePay")]
    public class PaymentMethodConfigurationApplePay : stripe.PaymentMethodConfiguration.IPaymentMethodConfigurationApplePay
    {
