...
{
    [JsiiByValue(fqn: "stripe.paymentMethodConfiguration.PaymentMethodConfigurationBancontact")]
    public class PaymentMethodConfigurationBancontact : stripe.PaymentMethodConfiguration.IPaymentMethodConfigurationBancontact
    {
