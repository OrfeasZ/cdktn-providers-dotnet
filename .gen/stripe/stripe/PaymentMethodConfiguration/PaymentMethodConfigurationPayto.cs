...
{
    [JsiiByValue(fqn: "stripe.paymentMethodConfiguration.PaymentMethodConfigurationPayto")]
    public class PaymentMethodConfigurationPayto : stripe.PaymentMethodConfiguration.IPaymentMethodConfigurationPayto
    {
