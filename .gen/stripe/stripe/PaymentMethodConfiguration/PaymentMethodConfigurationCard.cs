...
{
    [JsiiByValue(fqn: "stripe.paymentMethodConfiguration.PaymentMethodConfigurationCard")]
    public class PaymentMethodConfigurationCard : stripe.PaymentMethodConfiguration.IPaymentMethodConfigurationCard
    {
