...
{
    [JsiiByValue(fqn: "stripe.paymentMethodConfiguration.PaymentMethodConfigurationApplePayLater")]
    public class PaymentMethodConfigurationApplePayLater : stripe.PaymentMethodConfiguration.IPaymentMethodConfigurationApplePayLater
    {
