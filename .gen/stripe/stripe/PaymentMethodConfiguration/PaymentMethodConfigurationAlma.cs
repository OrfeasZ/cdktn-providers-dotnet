...
{
    [JsiiByValue(fqn: "stripe.paymentMethodConfiguration.PaymentMethodConfigurationAlma")]
    public class PaymentMethodConfigurationAlma : stripe.PaymentMethodConfiguration.IPaymentMethodConfigurationAlma
    {
