...
{
    [JsiiByValue(fqn: "stripe.paymentMethodConfiguration.PaymentMethodConfigurationPayByBank")]
    public class PaymentMethodConfigurationPayByBank : stripe.PaymentMethodConfiguration.IPaymentMethodConfigurationPayByBank
    {
