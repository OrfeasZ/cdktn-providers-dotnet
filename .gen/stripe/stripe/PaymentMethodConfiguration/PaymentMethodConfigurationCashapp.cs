...
{
    [JsiiByValue(fqn: "stripe.paymentMethodConfiguration.PaymentMethodConfigurationCashapp")]
    public class PaymentMethodConfigurationCashapp : stripe.PaymentMethodConfiguration.IPaymentMethodConfigurationCashapp
    {
