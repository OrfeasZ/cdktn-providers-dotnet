...
{
    [JsiiByValue(fqn: "stripe.paymentMethodConfiguration.PaymentMethodConfigurationTwint")]
    public class PaymentMethodConfigurationTwint : stripe.PaymentMethodConfiguration.IPaymentMethodConfigurationTwint
    {
