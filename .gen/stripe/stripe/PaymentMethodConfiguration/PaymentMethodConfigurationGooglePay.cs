...
{
    [JsiiByValue(fqn: "stripe.paymentMethodConfiguration.PaymentMethodConfigurationGooglePay")]
    public class PaymentMethodConfigurationGooglePay : stripe.PaymentMethodConfiguration.IPaymentMethodConfigurationGooglePay
    {
