...
{
    [JsiiByValue(fqn: "stripe.paymentMethodConfiguration.PaymentMethodConfigurationGrabpay")]
    public class PaymentMethodConfigurationGrabpay : stripe.PaymentMethodConfiguration.IPaymentMethodConfigurationGrabpay
    {
