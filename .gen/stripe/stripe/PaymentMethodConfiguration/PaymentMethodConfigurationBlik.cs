...
{
    [JsiiByValue(fqn: "stripe.paymentMethodConfiguration.PaymentMethodConfigurationBlik")]
    public class PaymentMethodConfigurationBlik : stripe.PaymentMethodConfiguration.IPaymentMethodConfigurationBlik
    {
