...
{
    [JsiiByValue(fqn: "stripe.paymentMethodConfiguration.PaymentMethodConfigurationSofort")]
    public class PaymentMethodConfigurationSofort : stripe.PaymentMethodConfiguration.IPaymentMethodConfigurationSofort
    {
