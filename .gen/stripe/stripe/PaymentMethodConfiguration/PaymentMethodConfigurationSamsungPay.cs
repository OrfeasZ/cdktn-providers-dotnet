...
{
    [JsiiByValue(fqn: "stripe.paymentMethodConfiguration.PaymentMethodConfigurationSamsungPay")]
    public class PaymentMethodConfigurationSamsungPay : stripe.PaymentMethodConfiguration.IPaymentMethodConfigurationSamsungPay
    {
