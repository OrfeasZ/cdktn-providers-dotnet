...
{
    [JsiiByValue(fqn: "stripe.paymentMethodConfiguration.PaymentMethodConfigurationCrypto")]
    public class PaymentMethodConfigurationCrypto : stripe.PaymentMethodConfiguration.IPaymentMethodConfigurationCrypto
    {
