...
{
    [JsiiByValue(fqn: "stripe.paymentMethodConfiguration.PaymentMethodConfigurationKrCard")]
    public class PaymentMethodConfigurationKrCard : stripe.PaymentMethodConfiguration.IPaymentMethodConfigurationKrCard
    {
