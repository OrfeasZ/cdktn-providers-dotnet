...
{
    [JsiiByValue(fqn: "stripe.paymentMethodConfiguration.PaymentMethodConfigurationSepaDebit")]
    public class PaymentMethodConfigurationSepaDebit : stripe.PaymentMethodConfiguration.IPaymentMethodConfigurationSepaDebit
    {
