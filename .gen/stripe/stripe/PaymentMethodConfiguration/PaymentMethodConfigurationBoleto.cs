...
{
    [JsiiByValue(fqn: "stripe.paymentMethodConfiguration.PaymentMethodConfigurationBoleto")]
    public class PaymentMethodConfigurationBoleto : stripe.PaymentMethodConfiguration.IPaymentMethodConfigurationBoleto
    {
