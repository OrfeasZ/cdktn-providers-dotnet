...
{
    [JsiiByValue(fqn: "stripe.paymentMethodConfiguration.PaymentMethodConfigurationUsBankAccount")]
    public class PaymentMethodConfigurationUsBankAccount : stripe.PaymentMethodConfiguration.IPaymentMethodConfigurationUsBankAccount
    {
