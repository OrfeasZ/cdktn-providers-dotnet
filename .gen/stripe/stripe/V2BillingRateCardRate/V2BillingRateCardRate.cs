...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/stripe/stripe/0.2.3/docs/resources/v2_billing_rate_card_rate stripe_v2_billing_rate_card_rate}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/stripe/stripe/0.2.3/docs/resources/v2_billing_rate_card_rate stripe_v2_billing_rate_card_rate} Resource.</summary>
        ...
        /// <param name="value">Type union: either <see cref="Io.Cdktn.IResolvable" /> or (<see cref="stripe.V2BillingRateCardRate.IV2BillingRateCardRateTiers" />)[]</param>
