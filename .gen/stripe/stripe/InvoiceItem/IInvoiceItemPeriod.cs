...
{
    [JsiiInterface(nativeType: typeof(IInvoiceItemPeriod), fullyQualifiedName: "stripe.invoiceItem.InvoiceItemPeriod")]
    public interface IInvoiceItemPeriod
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IInvoiceItemPeriod), fullyQualifiedName: "stripe.invoiceItem.InvoiceItemPeriod")]
        internal sealed class _Proxy : DeputyBase, stripe.InvoiceItem.IInvoiceItemPeriod
        {
