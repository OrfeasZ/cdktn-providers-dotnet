...
{
    [JsiiByValue(fqn: "stripe.terminalConfiguration.TerminalConfigurationTippingNok")]
    public class TerminalConfigurationTippingNok : stripe.TerminalConfiguration.ITerminalConfigurationTippingNok
    {
