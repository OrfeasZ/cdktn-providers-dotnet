...
{
    [JsiiInterface(nativeType: typeof(ITerminalConfigurationTippingHuf), fullyQualifiedName: "stripe.terminalConfiguration.TerminalConfigurationTippingHuf")]
    public interface ITerminalConfigurationTippingHuf
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ITerminalConfigurationTippingHuf), fullyQualifiedName: "stripe.terminalConfiguration.TerminalConfigurationTippingHuf")]
        internal sealed class _Proxy : DeputyBase, stripe.TerminalConfiguration.ITerminalConfigurationTippingHuf
        {
