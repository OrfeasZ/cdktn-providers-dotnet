...
namespace stripe.TerminalConfiguration
{
    ...
    [JsiiByValue(fqn: "stripe.terminalConfiguration.TerminalConfigurationOffline")]
    public class TerminalConfigurationOffline : stripe.TerminalConfiguration.ITerminalConfigurationOffline
    {
