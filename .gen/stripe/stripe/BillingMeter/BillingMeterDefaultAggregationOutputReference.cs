...
namespace stripe.BillingMeter
{
    ...
    public class BillingMeterDefaultAggregationOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        public BillingMeterDefaultAggregationOutputReference(Io.Cdktn.IInterpolatingParent terraformResource, string terraformAttribute, double complexObjectIndex, bool complexObjectIsFromSet): base(_MakeDeputyProps(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet))
        {
        }
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"stripe.billingMeter.BillingMeterDefaultAggregation\"}]}}", isOptional: true)]
