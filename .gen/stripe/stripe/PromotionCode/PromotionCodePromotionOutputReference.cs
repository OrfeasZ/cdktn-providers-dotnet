...
namespace stripe.PromotionCode
{
    ...
    public class PromotionCodePromotionOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        public PromotionCodePromotionOutputReference(Io.Cdktn.IInterpolatingParent terraformResource, string terraformAttribute, double complexObjectIndex, bool complexObjectIsFromSet): base(_MakeDeputyProps(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet))
        {
        }
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"stripe.promotionCode.PromotionCodePromotion\"}]}}", isOptional: true)]
