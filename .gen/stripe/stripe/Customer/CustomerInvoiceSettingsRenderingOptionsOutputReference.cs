...
namespace stripe.Customer
{
    ...
    public class CustomerInvoiceSettingsRenderingOptionsOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        public CustomerInvoiceSettingsRenderingOptionsOutputReference(Io.Cdktn.IInterpolatingParent terraformResource, string terraformAttribute, double complexObjectIndex, bool complexObjectIsFromSet): base(_MakeDeputyProps(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet))
        {
        }
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"stripe.customer.CustomerInvoiceSettingsRenderingOptions\"}]}}", isOptional: true)]
