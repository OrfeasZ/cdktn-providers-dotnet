...
{
    [JsiiClass(nativeType: typeof(stripe.Source.SourceThreeDSecureOutputReference), fullyQualifiedName: "stripe.source.SourceThreeDSecureOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktn.IInterpolatingParent\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}}]")]
    public class SourceThreeDSecureOutputReference : Io.Cdktn.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        public SourceThreeDSecureOutputReference(Io.Cdktn.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
        ...
        protected SourceThreeDSecureOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected SourceThreeDSecureOutputReference(DeputyProps props): base(props)
        {
        }
        ...
        [JsiiProperty(name: "authenticated", typeJson: "{\"fqn\":\"cdktn.IResolvable\"}")]
        public virtual Io.Cdktn.IResolvable Authenticated
        {
        ...
        [JsiiProperty(name: "card", typeJson: "{\"primitive\":\"string\"}")]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"stripe.source.SourceThreeDSecure\"}", isOptional: true)]
        public virtual stripe.Source.ISourceThreeDSecure? InternalValue
        {
            get => GetInstanceProperty<stripe.Source.ISourceThreeDSecure?>();
