...
namespace stripe.ShippingRate
{
    ...
    public class ShippingRateFixedAmountOutputReference : Io.Cdktn.ComplexObject
    {
        ...
        public ShippingRateFixedAmountOutputReference(Io.Cdktn.IInterpolatingParent terraformResource, string terraformAttribute, double complexObjectIndex, bool complexObjectIsFromSet): base(_MakeDeputyProps(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet))
        {
        }
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"stripe.shippingRate.ShippingRateFixedAmount\"}]}}", isOptional: true)]
