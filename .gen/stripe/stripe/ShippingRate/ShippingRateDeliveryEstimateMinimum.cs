...
namespace stripe.ShippingRate
{
    ...
    [JsiiByValue(fqn: "stripe.shippingRate.ShippingRateDeliveryEstimateMinimum")]
    public class ShippingRateDeliveryEstimateMinimum : stripe.ShippingRate.IShippingRateDeliveryEstimateMinimum
    {
