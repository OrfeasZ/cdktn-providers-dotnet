...
namespace stripe.V2BillingServiceAction
{
    ...
    [JsiiByValue(fqn: "stripe.v2BillingServiceAction.V2BillingServiceActionConfig")]
    public class V2BillingServiceActionConfig : stripe.V2BillingServiceAction.IV2BillingServiceActionConfig
    {
