...
{
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsEtStandard")]
    public class TaxRegistrationCountryOptionsEtStandard : stripe.TaxRegistration.ITaxRegistrationCountryOptionsEtStandard
    {
