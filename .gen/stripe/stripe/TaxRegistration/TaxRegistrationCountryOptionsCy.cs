...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsCy")]
    public class TaxRegistrationCountryOptionsCy : stripe.TaxRegistration.ITaxRegistrationCountryOptionsCy
    {
