...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsHr")]
    public class TaxRegistrationCountryOptionsHr : stripe.TaxRegistration.ITaxRegistrationCountryOptionsHr
    {
