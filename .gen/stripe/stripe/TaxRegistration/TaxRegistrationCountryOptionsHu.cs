...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsHu")]
    public class TaxRegistrationCountryOptionsHu : stripe.TaxRegistration.ITaxRegistrationCountryOptionsHu
    {
