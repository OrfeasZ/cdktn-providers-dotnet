...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsNo")]
    public class TaxRegistrationCountryOptionsNo : stripe.TaxRegistration.ITaxRegistrationCountryOptionsNo
    {
