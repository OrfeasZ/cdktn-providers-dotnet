...
{
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsAoStandard")]
    public class TaxRegistrationCountryOptionsAoStandard : stripe.TaxRegistration.ITaxRegistrationCountryOptionsAoStandard
    {
