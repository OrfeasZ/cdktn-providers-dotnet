...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsLv")]
    public class TaxRegistrationCountryOptionsLv : stripe.TaxRegistration.ITaxRegistrationCountryOptionsLv
    {
