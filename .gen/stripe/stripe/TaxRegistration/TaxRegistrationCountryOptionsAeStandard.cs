...
{
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsAeStandard")]
    public class TaxRegistrationCountryOptionsAeStandard : stripe.TaxRegistration.ITaxRegistrationCountryOptionsAeStandard
    {
