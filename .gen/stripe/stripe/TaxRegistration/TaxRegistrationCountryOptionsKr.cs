...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsKr")]
    public class TaxRegistrationCountryOptionsKr : stripe.TaxRegistration.ITaxRegistrationCountryOptionsKr
    {
