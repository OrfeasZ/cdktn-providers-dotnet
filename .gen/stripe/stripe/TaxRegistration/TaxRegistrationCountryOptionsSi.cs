...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsSi")]
    public class TaxRegistrationCountryOptionsSi : stripe.TaxRegistration.ITaxRegistrationCountryOptionsSi
    {
