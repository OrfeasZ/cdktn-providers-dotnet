...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsIt")]
    public class TaxRegistrationCountryOptionsIt : stripe.TaxRegistration.ITaxRegistrationCountryOptionsIt
    {
