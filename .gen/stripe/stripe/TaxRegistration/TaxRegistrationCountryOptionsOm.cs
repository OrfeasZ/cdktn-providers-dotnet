...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsOm")]
    public class TaxRegistrationCountryOptionsOm : stripe.TaxRegistration.ITaxRegistrationCountryOptionsOm
    {
