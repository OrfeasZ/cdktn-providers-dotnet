...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsGr")]
    public class TaxRegistrationCountryOptionsGr : stripe.TaxRegistration.ITaxRegistrationCountryOptionsGr
    {
