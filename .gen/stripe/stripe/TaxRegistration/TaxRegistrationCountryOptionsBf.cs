...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsBf")]
    public class TaxRegistrationCountryOptionsBf : stripe.TaxRegistration.ITaxRegistrationCountryOptionsBf
    {
