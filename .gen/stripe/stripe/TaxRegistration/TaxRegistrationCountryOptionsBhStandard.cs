...
{
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsBhStandard")]
    public class TaxRegistrationCountryOptionsBhStandard : stripe.TaxRegistration.ITaxRegistrationCountryOptionsBhStandard
    {
