...
{
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsIsStandard")]
    public class TaxRegistrationCountryOptionsIsStandard : stripe.TaxRegistration.ITaxRegistrationCountryOptionsIsStandard
    {
