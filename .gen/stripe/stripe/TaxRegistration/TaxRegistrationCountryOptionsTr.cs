...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsTr")]
    public class TaxRegistrationCountryOptionsTr : stripe.TaxRegistration.ITaxRegistrationCountryOptionsTr
    {
