...
{
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsGnStandard")]
    public class TaxRegistrationCountryOptionsGnStandard : stripe.TaxRegistration.ITaxRegistrationCountryOptionsGnStandard
    {
