...
{
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsJpStandard")]
    public class TaxRegistrationCountryOptionsJpStandard : stripe.TaxRegistration.ITaxRegistrationCountryOptionsJpStandard
    {
