...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsAe")]
    public class TaxRegistrationCountryOptionsAe : stripe.TaxRegistration.ITaxRegistrationCountryOptionsAe
    {
