...
{
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsNzStandard")]
    public class TaxRegistrationCountryOptionsNzStandard : stripe.TaxRegistration.ITaxRegistrationCountryOptionsNzStandard
    {
