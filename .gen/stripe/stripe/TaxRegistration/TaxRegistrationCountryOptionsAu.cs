...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsAu")]
    public class TaxRegistrationCountryOptionsAu : stripe.TaxRegistration.ITaxRegistrationCountryOptionsAu
    {
