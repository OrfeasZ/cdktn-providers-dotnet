...
{
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsBaStandard")]
    public class TaxRegistrationCountryOptionsBaStandard : stripe.TaxRegistration.ITaxRegistrationCountryOptionsBaStandard
    {
