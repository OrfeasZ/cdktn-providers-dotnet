...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsRo")]
    public class TaxRegistrationCountryOptionsRo : stripe.TaxRegistration.ITaxRegistrationCountryOptionsRo
    {
