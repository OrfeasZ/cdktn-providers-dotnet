...
{
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsBsStandard")]
    public class TaxRegistrationCountryOptionsBsStandard : stripe.TaxRegistration.ITaxRegistrationCountryOptionsBsStandard
    {
