...
{
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsNoStandard")]
    public class TaxRegistrationCountryOptionsNoStandard : stripe.TaxRegistration.ITaxRegistrationCountryOptionsNoStandard
    {
