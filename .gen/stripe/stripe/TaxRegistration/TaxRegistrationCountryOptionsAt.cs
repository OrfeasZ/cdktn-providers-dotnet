...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsAt")]
    public class TaxRegistrationCountryOptionsAt : stripe.TaxRegistration.ITaxRegistrationCountryOptionsAt
    {
