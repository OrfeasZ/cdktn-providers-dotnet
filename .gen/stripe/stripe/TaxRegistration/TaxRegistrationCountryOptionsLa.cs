...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsLa")]
    public class TaxRegistrationCountryOptionsLa : stripe.TaxRegistration.ITaxRegistrationCountryOptionsLa
    {
