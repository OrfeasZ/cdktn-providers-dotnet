...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsDe")]
    public class TaxRegistrationCountryOptionsDe : stripe.TaxRegistration.ITaxRegistrationCountryOptionsDe
    {
