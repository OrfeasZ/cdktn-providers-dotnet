...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsMa")]
    public class TaxRegistrationCountryOptionsMa : stripe.TaxRegistration.ITaxRegistrationCountryOptionsMa
    {
