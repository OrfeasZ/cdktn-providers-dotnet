...
{
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsUyStandard")]
    public class TaxRegistrationCountryOptionsUyStandard : stripe.TaxRegistration.ITaxRegistrationCountryOptionsUyStandard
    {
