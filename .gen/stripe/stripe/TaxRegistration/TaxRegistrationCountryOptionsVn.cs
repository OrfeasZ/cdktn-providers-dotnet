...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsVn")]
    public class TaxRegistrationCountryOptionsVn : stripe.TaxRegistration.ITaxRegistrationCountryOptionsVn
    {
