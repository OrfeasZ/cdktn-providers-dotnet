...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsCz")]
    public class TaxRegistrationCountryOptionsCz : stripe.TaxRegistration.ITaxRegistrationCountryOptionsCz
    {
