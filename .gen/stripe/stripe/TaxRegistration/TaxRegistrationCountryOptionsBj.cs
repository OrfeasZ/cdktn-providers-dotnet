...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsBj")]
    public class TaxRegistrationCountryOptionsBj : stripe.TaxRegistration.ITaxRegistrationCountryOptionsBj
    {
