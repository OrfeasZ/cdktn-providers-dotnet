...
{
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsMrStandard")]
    public class TaxRegistrationCountryOptionsMrStandard : stripe.TaxRegistration.ITaxRegistrationCountryOptionsMrStandard
    {
