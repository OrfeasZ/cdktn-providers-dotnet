...
{
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsChStandard")]
    public class TaxRegistrationCountryOptionsChStandard : stripe.TaxRegistration.ITaxRegistrationCountryOptionsChStandard
    {
