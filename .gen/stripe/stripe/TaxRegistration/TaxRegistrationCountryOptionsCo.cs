...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsCo")]
    public class TaxRegistrationCountryOptionsCo : stripe.TaxRegistration.ITaxRegistrationCountryOptionsCo
    {
