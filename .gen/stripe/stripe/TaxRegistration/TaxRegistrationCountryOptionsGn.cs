...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsGn")]
    public class TaxRegistrationCountryOptionsGn : stripe.TaxRegistration.ITaxRegistrationCountryOptionsGn
    {
