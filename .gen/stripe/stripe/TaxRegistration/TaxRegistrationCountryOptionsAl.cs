...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsAl")]
    public class TaxRegistrationCountryOptionsAl : stripe.TaxRegistration.ITaxRegistrationCountryOptionsAl
    {
