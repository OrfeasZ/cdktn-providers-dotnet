...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsEc")]
    public class TaxRegistrationCountryOptionsEc : stripe.TaxRegistration.ITaxRegistrationCountryOptionsEc
    {
