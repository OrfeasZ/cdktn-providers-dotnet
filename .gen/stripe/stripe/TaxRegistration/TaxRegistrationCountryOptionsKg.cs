...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsKg")]
    public class TaxRegistrationCountryOptionsKg : stripe.TaxRegistration.ITaxRegistrationCountryOptionsKg
    {
