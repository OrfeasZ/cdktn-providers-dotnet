...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsZm")]
    public class TaxRegistrationCountryOptionsZm : stripe.TaxRegistration.ITaxRegistrationCountryOptionsZm
    {
