...
{
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsBbStandard")]
    public class TaxRegistrationCountryOptionsBbStandard : stripe.TaxRegistration.ITaxRegistrationCountryOptionsBbStandard
    {
