...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsIn")]
    public class TaxRegistrationCountryOptionsIn : stripe.TaxRegistration.ITaxRegistrationCountryOptionsIn
    {
