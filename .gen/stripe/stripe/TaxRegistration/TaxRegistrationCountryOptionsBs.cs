...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsBs")]
    public class TaxRegistrationCountryOptionsBs : stripe.TaxRegistration.ITaxRegistrationCountryOptionsBs
    {
