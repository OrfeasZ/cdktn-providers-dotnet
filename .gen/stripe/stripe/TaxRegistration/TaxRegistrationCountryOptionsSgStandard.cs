...
{
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsSgStandard")]
    public class TaxRegistrationCountryOptionsSgStandard : stripe.TaxRegistration.ITaxRegistrationCountryOptionsSgStandard
    {
