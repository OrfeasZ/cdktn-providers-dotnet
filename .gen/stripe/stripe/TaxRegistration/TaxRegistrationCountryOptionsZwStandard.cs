...
{
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsZwStandard")]
    public class TaxRegistrationCountryOptionsZwStandard : stripe.TaxRegistration.ITaxRegistrationCountryOptionsZwStandard
    {
