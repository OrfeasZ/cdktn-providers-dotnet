...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsBy")]
    public class TaxRegistrationCountryOptionsBy : stripe.TaxRegistration.ITaxRegistrationCountryOptionsBy
    {
