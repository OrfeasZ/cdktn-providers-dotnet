...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsFi")]
    public class TaxRegistrationCountryOptionsFi : stripe.TaxRegistration.ITaxRegistrationCountryOptionsFi
    {
