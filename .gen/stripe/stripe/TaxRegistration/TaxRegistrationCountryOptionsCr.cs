...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsCr")]
    public class TaxRegistrationCountryOptionsCr : stripe.TaxRegistration.ITaxRegistrationCountryOptionsCr
    {
