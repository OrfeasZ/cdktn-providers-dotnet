...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsMd")]
    public class TaxRegistrationCountryOptionsMd : stripe.TaxRegistration.ITaxRegistrationCountryOptionsMd
    {
