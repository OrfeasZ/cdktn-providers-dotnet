...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsUa")]
    public class TaxRegistrationCountryOptionsUa : stripe.TaxRegistration.ITaxRegistrationCountryOptionsUa
    {
