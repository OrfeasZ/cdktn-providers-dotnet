...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsSg")]
    public class TaxRegistrationCountryOptionsSg : stripe.TaxRegistration.ITaxRegistrationCountryOptionsSg
    {
