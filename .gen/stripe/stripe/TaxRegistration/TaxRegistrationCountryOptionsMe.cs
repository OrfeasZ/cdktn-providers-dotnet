...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsMe")]
    public class TaxRegistrationCountryOptionsMe : stripe.TaxRegistration.ITaxRegistrationCountryOptionsMe
    {
