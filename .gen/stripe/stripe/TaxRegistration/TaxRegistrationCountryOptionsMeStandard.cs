...
{
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsMeStandard")]
    public class TaxRegistrationCountryOptionsMeStandard : stripe.TaxRegistration.ITaxRegistrationCountryOptionsMeStandard
    {
