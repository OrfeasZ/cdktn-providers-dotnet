...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsIe")]
    public class TaxRegistrationCountryOptionsIe : stripe.TaxRegistration.ITaxRegistrationCountryOptionsIe
    {
