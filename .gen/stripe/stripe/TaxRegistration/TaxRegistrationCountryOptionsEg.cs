...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsEg")]
    public class TaxRegistrationCountryOptionsEg : stripe.TaxRegistration.ITaxRegistrationCountryOptionsEg
    {
