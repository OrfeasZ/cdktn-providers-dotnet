...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsUy")]
    public class TaxRegistrationCountryOptionsUy : stripe.TaxRegistration.ITaxRegistrationCountryOptionsUy
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "standard", typeJson: "{\"fqn\":\"stripe.taxRegistration.TaxRegistrationCountryOptionsUyStandard\"}", isOptional: true)]
        public stripe.TaxRegistration.ITaxRegistrationCountryOptionsUyStandard? Standard
        {
            get;
            set;
        }
