...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsNp")]
    public class TaxRegistrationCountryOptionsNp : stripe.TaxRegistration.ITaxRegistrationCountryOptionsNp
    {
