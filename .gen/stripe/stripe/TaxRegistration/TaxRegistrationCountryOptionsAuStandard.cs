...
{
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsAuStandard")]
    public class TaxRegistrationCountryOptionsAuStandard : stripe.TaxRegistration.ITaxRegistrationCountryOptionsAuStandard
    {
