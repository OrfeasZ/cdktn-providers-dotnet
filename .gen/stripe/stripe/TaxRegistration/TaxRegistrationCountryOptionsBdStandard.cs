...
{
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsBdStandard")]
    public class TaxRegistrationCountryOptionsBdStandard : stripe.TaxRegistration.ITaxRegistrationCountryOptionsBdStandard
    {
