...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsKe")]
    public class TaxRegistrationCountryOptionsKe : stripe.TaxRegistration.ITaxRegistrationCountryOptionsKe
    {
