...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsBh")]
    public class TaxRegistrationCountryOptionsBh : stripe.TaxRegistration.ITaxRegistrationCountryOptionsBh
    {
