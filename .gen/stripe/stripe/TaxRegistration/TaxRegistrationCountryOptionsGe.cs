...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsGe")]
    public class TaxRegistrationCountryOptionsGe : stripe.TaxRegistration.ITaxRegistrationCountryOptionsGe
    {
