...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsLu")]
    public class TaxRegistrationCountryOptionsLu : stripe.TaxRegistration.ITaxRegistrationCountryOptionsLu
    {
