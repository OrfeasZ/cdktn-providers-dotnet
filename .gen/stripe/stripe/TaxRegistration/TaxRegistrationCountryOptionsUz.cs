...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsUz")]
    public class TaxRegistrationCountryOptionsUz : stripe.TaxRegistration.ITaxRegistrationCountryOptionsUz
    {
