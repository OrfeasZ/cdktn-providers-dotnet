...
{
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsOmStandard")]
    public class TaxRegistrationCountryOptionsOmStandard : stripe.TaxRegistration.ITaxRegistrationCountryOptionsOmStandard
    {
