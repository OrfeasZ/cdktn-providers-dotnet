...
{
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsBfStandard")]
    public class TaxRegistrationCountryOptionsBfStandard : stripe.TaxRegistration.ITaxRegistrationCountryOptionsBfStandard
    {
