...
{
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsAwStandard")]
    public class TaxRegistrationCountryOptionsAwStandard : stripe.TaxRegistration.ITaxRegistrationCountryOptionsAwStandard
    {
