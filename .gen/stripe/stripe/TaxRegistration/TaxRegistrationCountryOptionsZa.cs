...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsZa")]
    public class TaxRegistrationCountryOptionsZa : stripe.TaxRegistration.ITaxRegistrationCountryOptionsZa
    {
