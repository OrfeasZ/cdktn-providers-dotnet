...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsAz")]
    public class TaxRegistrationCountryOptionsAz : stripe.TaxRegistration.ITaxRegistrationCountryOptionsAz
    {
