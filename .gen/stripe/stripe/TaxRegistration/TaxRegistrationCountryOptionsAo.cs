...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsAo")]
    public class TaxRegistrationCountryOptionsAo : stripe.TaxRegistration.ITaxRegistrationCountryOptionsAo
    {
