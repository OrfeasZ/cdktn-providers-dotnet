...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsTw")]
    public class TaxRegistrationCountryOptionsTw : stripe.TaxRegistration.ITaxRegistrationCountryOptionsTw
    {
