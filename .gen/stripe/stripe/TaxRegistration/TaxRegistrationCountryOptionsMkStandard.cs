...
{
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsMkStandard")]
    public class TaxRegistrationCountryOptionsMkStandard : stripe.TaxRegistration.ITaxRegistrationCountryOptionsMkStandard
    {
