...
{
    [JsiiInterface(nativeType: typeof(ITaxRegistrationCountryOptionsBd), fullyQualifiedName: "stripe.taxRegistration.TaxRegistrationCountryOptionsBd")]
    public interface ITaxRegistrationCountryOptionsBd
    {
        ...
        stripe.TaxRegistration.ITaxRegistrationCountryOptionsBdStandard? Standard
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(ITaxRegistrationCountryOptionsBd), fullyQualifiedName: "stripe.taxRegistration.TaxRegistrationCountryOptionsBd")]
        internal sealed class _Proxy : DeputyBase, stripe.TaxRegistration.ITaxRegistrationCountryOptionsBd
        {
            ...
            {
                get => GetInstanceProperty<stripe.TaxRegistration.ITaxRegistrationCountryOptionsBdStandard?>();
            }
        }
    }
}
