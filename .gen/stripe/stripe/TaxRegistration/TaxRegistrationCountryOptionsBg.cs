...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsBg")]
    public class TaxRegistrationCountryOptionsBg : stripe.TaxRegistration.ITaxRegistrationCountryOptionsBg
    {
