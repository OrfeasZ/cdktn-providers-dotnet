...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsCm")]
    public class TaxRegistrationCountryOptionsCm : stripe.TaxRegistration.ITaxRegistrationCountryOptionsCm
    {
