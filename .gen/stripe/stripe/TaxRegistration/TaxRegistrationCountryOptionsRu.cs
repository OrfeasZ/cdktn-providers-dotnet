...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsRu")]
    public class TaxRegistrationCountryOptionsRu : stripe.TaxRegistration.ITaxRegistrationCountryOptionsRu
    {
