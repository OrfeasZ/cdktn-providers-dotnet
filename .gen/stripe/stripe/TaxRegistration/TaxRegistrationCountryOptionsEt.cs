...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsEt")]
    public class TaxRegistrationCountryOptionsEt : stripe.TaxRegistration.ITaxRegistrationCountryOptionsEt
    {
