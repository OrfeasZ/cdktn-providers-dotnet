...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsAw")]
    public class TaxRegistrationCountryOptionsAw : stripe.TaxRegistration.ITaxRegistrationCountryOptionsAw
    {
