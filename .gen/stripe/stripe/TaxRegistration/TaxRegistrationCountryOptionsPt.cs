...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsPt")]
    public class TaxRegistrationCountryOptionsPt : stripe.TaxRegistration.ITaxRegistrationCountryOptionsPt
    {
