...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsPe")]
    public class TaxRegistrationCountryOptionsPe : stripe.TaxRegistration.ITaxRegistrationCountryOptionsPe
    {
