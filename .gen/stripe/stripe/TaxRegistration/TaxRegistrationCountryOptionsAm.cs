...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsAm")]
    public class TaxRegistrationCountryOptionsAm : stripe.TaxRegistration.ITaxRegistrationCountryOptionsAm
    {
