...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsNg")]
    public class TaxRegistrationCountryOptionsNg : stripe.TaxRegistration.ITaxRegistrationCountryOptionsNg
    {
