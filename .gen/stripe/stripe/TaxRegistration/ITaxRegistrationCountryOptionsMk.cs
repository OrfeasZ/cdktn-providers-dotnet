...
{
    [JsiiInterface(nativeType: typeof(ITaxRegistrationCountryOptionsMk), fullyQualifiedName: "stripe.taxRegistration.TaxRegistrationCountryOptionsMk")]
    public interface ITaxRegistrationCountryOptionsMk
    {
        ...
        stripe.TaxRegistration.ITaxRegistrationCountryOptionsMkStandard? Standard
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(ITaxRegistrationCountryOptionsMk), fullyQualifiedName: "stripe.taxRegistration.TaxRegistrationCountryOptionsMk")]
        internal sealed class _Proxy : DeputyBase, stripe.TaxRegistration.ITaxRegistrationCountryOptionsMk
        {
            ...
            {
                get => GetInstanceProperty<stripe.TaxRegistration.ITaxRegistrationCountryOptionsMkStandard?>();
            }
        }
    }
}
