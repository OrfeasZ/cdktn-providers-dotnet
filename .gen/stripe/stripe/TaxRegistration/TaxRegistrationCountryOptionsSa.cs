...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsSa")]
    public class TaxRegistrationCountryOptionsSa : stripe.TaxRegistration.ITaxRegistrationCountryOptionsSa
    {
