...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsMr")]
    public class TaxRegistrationCountryOptionsMr : stripe.TaxRegistration.ITaxRegistrationCountryOptionsMr
    {
