...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsSn")]
    public class TaxRegistrationCountryOptionsSn : stripe.TaxRegistration.ITaxRegistrationCountryOptionsSn
    {
