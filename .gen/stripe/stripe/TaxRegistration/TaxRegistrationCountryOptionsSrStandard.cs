...
{
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsSrStandard")]
    public class TaxRegistrationCountryOptionsSrStandard : stripe.TaxRegistration.ITaxRegistrationCountryOptionsSrStandard
    {
