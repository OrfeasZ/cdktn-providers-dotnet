...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsBb")]
    public class TaxRegistrationCountryOptionsBb : stripe.TaxRegistration.ITaxRegistrationCountryOptionsBb
    {
