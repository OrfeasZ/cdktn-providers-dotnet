...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsTz")]
    public class TaxRegistrationCountryOptionsTz : stripe.TaxRegistration.ITaxRegistrationCountryOptionsTz
    {
