...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsCl")]
    public class TaxRegistrationCountryOptionsCl : stripe.TaxRegistration.ITaxRegistrationCountryOptionsCl
    {
