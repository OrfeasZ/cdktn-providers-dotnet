...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsEe")]
    public class TaxRegistrationCountryOptionsEe : stripe.TaxRegistration.ITaxRegistrationCountryOptionsEe
    {
