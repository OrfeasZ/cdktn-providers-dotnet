...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsSr")]
    public class TaxRegistrationCountryOptionsSr : stripe.TaxRegistration.ITaxRegistrationCountryOptionsSr
    {
