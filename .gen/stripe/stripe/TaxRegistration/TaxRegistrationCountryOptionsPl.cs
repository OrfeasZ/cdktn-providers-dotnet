...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsPl")]
    public class TaxRegistrationCountryOptionsPl : stripe.TaxRegistration.ITaxRegistrationCountryOptionsPl
    {
