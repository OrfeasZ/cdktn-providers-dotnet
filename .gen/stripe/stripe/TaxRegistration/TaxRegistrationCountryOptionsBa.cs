...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsBa")]
    public class TaxRegistrationCountryOptionsBa : stripe.TaxRegistration.ITaxRegistrationCountryOptionsBa
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "standard", typeJson: "{\"fqn\":\"stripe.taxRegistration.TaxRegistrationCountryOptionsBaStandard\"}", isOptional: true)]
        public stripe.TaxRegistration.ITaxRegistrationCountryOptionsBaStandard? Standard
        {
            get;
            set;
        }
