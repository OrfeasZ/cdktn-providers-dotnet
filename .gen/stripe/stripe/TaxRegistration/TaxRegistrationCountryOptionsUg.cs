...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsUg")]
    public class TaxRegistrationCountryOptionsUg : stripe.TaxRegistration.ITaxRegistrationCountryOptionsUg
    {
