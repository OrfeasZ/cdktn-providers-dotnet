...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsNl")]
    public class TaxRegistrationCountryOptionsNl : stripe.TaxRegistration.ITaxRegistrationCountryOptionsNl
    {
