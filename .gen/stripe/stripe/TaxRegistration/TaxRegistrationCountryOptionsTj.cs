...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsTj")]
    public class TaxRegistrationCountryOptionsTj : stripe.TaxRegistration.ITaxRegistrationCountryOptionsTj
    {
