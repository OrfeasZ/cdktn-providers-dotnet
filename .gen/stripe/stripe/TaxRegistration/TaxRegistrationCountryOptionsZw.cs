...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsZw")]
    public class TaxRegistrationCountryOptionsZw : stripe.TaxRegistration.ITaxRegistrationCountryOptionsZw
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "standard", typeJson: "{\"fqn\":\"stripe.taxRegistration.TaxRegistrationCountryOptionsZwStandard\"}", isOptional: true)]
        public stripe.TaxRegistration.ITaxRegistrationCountryOptionsZwStandard? Standard
        {
            get;
            set;
        }
