...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsBe")]
    public class TaxRegistrationCountryOptionsBe : stripe.TaxRegistration.ITaxRegistrationCountryOptionsBe
    {
