...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsRs")]
    public class TaxRegistrationCountryOptionsRs : stripe.TaxRegistration.ITaxRegistrationCountryOptionsRs
    {
