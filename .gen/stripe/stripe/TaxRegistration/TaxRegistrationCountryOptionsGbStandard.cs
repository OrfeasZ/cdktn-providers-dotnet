...
{
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsGbStandard")]
    public class TaxRegistrationCountryOptionsGbStandard : stripe.TaxRegistration.ITaxRegistrationCountryOptionsGbStandard
    {
