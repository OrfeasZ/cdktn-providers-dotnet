...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsCd")]
    public class TaxRegistrationCountryOptionsCd : stripe.TaxRegistration.ITaxRegistrationCountryOptionsCd
    {
