...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsFr")]
    public class TaxRegistrationCountryOptionsFr : stripe.TaxRegistration.ITaxRegistrationCountryOptionsFr
    {
