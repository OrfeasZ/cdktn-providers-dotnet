...
{
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsCdStandard")]
    public class TaxRegistrationCountryOptionsCdStandard : stripe.TaxRegistration.ITaxRegistrationCountryOptionsCdStandard
    {
