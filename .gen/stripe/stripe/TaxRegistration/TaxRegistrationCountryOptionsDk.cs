...
namespace stripe.TaxRegistration
{
    ...
    [JsiiByValue(fqn: "stripe.taxRegistration.TaxRegistrationCountryOptionsDk")]
    public class TaxRegistrationCountryOptionsDk : stripe.TaxRegistration.ITaxRegistrationCountryOptionsDk
    {
