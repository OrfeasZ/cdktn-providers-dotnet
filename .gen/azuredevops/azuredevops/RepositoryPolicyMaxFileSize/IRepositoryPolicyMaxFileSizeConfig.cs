...
{
    [JsiiInterface(nativeType: typeof(IRepositoryPolicyMaxFileSizeConfig), fullyQualifiedName: "azuredevops.repositoryPolicyMaxFileSize.RepositoryPolicyMaxFileSizeConfig")]
    public interface IRepositoryPolicyMaxFileSizeConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        azuredevops.RepositoryPolicyMaxFileSize.IRepositoryPolicyMaxFileSizeTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IRepositoryPolicyMaxFileSizeConfig), fullyQualifiedName: "azuredevops.repositoryPolicyMaxFileSize.RepositoryPolicyMaxFileSizeConfig")]
        internal sealed class _Proxy : DeputyBase, azuredevops.RepositoryPolicyMaxFileSize.IRepositoryPolicyMaxFileSizeConfig
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"azuredevops.repositoryPolicyMaxFileSize.RepositoryPolicyMaxFileSizeTimeouts\"}", isOptional: true)]
            public azuredevops.RepositoryPolicyMaxFileSize.IRepositoryPolicyMaxFileSizeTimeouts? Timeouts
            {
                get => GetInstanceProperty<azuredevops.RepositoryPolicyMaxFileSize.IRepositoryPolicyMaxFileSizeTimeouts?>();
            }
