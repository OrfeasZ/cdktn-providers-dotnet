...
namespace azuredevops.Team
{
    ...
    public class Team : Io.Cdktn.TerraformResource
    {
        ...
        private static DeputyProps _MakeDeputyProps(Constructs.Construct scope, string id, azuredevops.Team.ITeamConfig config)
        {
        ...
        /// <summary>Generates CDKTN code for importing a Team resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        ...
        public virtual void PutTimeouts(azuredevops.Team.ITeamTimeouts @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(azuredevops.Team.ITeamTimeouts)}, new object[]{@value});
        }
        ...
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"azuredevops.team.TeamTimeoutsOutputReference\"}")]
        public virtual azuredevops.Team.TeamTimeoutsOutputReference Timeouts
        {
            get => GetInstanceProperty<azuredevops.Team.TeamTimeoutsOutputReference>()!;
        }
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "timeoutsInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"azuredevops.team.TeamTimeouts\"}]}}", isOptional: true)]
