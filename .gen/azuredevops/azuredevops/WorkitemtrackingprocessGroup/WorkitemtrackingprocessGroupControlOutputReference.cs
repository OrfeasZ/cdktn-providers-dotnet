...
{
    [JsiiClass(nativeType: typeof(azuredevops.WorkitemtrackingprocessGroup.WorkitemtrackingprocessGroupControlOutputReference), fullyQualifiedName: "azuredevops.workitemtrackingprocessGroup.WorkitemtrackingprocessGroupControlOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktn.IInterpolatingParent\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"the index of this item in the list.\"},\"name\":\"complexObjectIndex\",\"type\":{\"primitive\":\"number\"}},{\"docs\":{\"summary\":\"whether the list is wrapping a set (will add tolist() to be able to access an item via an index).\"},\"name\":\"complexObjectIsFromSet\",\"type\":{\"primitive\":\"boolean\"}}]")]
    public class WorkitemtrackingprocessGroupControlOutputReference : Io.Cdktn.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        /// <param name="complexObjectIndex">the index of this item in the list.</param>
        /// <param name="complexObjectIsFromSet">whether the list is wrapping a set (will add tolist() to be able to access an item via an index).</param>
        public WorkitemtrackingprocessGroupControlOutputReference(Io.Cdktn.IInterpolatingParent terraformResource, string terraformAttribute, double complexObjectIndex, bool complexObjectIsFromSet): base(_MakeDeputyProps(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet))
        {
        }
        ...
        protected WorkitemtrackingprocessGroupControlOutputReference(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected WorkitemtrackingprocessGroupControlOutputReference(DeputyProps props): base(props)
        {
        }

        [JsiiMethod(name: "putContribution", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"azuredevops.workitemtrackingprocessGroup.WorkitemtrackingprocessGroupControlContribution\"}}]")]
        public virtual void PutContribution(azuredevops.WorkitemtrackingprocessGroup.IWorkitemtrackingprocessGroupControlContribution @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(azuredevops.WorkitemtrackingprocessGroup.IWorkitemtrackingprocessGroupControlContribution)}, new object[]{@value});
        }
        ...
        [JsiiProperty(name: "contribution", typeJson: "{\"fqn\":\"azuredevops.workitemtrackingprocessGroup.WorkitemtrackingprocessGroupControlContributionOutputReference\"}")]
        public virtual azuredevops.WorkitemtrackingprocessGroup.WorkitemtrackingprocessGroupControlContributionOutputReference Contribution
        {
            get => GetInstanceProperty<azuredevops.WorkitemtrackingprocessGroup.WorkitemtrackingprocessGroupControlContributionOutputReference>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "contributionInput", typeJson: "{\"fqn\":\"azuredevops.workitemtrackingprocessGroup.WorkitemtrackingprocessGroupControlContribution\"}", isOptional: true)]
        public virtual azuredevops.WorkitemtrackingprocessGroup.IWorkitemtrackingprocessGroupControlContribution? ContributionInput
        {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"azuredevops.workitemtrackingprocessGroup.WorkitemtrackingprocessGroupControl\"}]}}", isOptional: true)]
