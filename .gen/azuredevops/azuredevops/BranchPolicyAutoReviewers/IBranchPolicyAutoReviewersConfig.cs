...
{
    [JsiiInterface(nativeType: typeof(IBranchPolicyAutoReviewersConfig), fullyQualifiedName: "azuredevops.branchPolicyAutoReviewers.BranchPolicyAutoReviewersConfig")]
    public interface IBranchPolicyAutoReviewersConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        azuredevops.BranchPolicyAutoReviewers.IBranchPolicyAutoReviewersSettings Settings
        {
            get;
        }
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        azuredevops.BranchPolicyAutoReviewers.IBranchPolicyAutoReviewersTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IBranchPolicyAutoReviewersConfig), fullyQualifiedName: "azuredevops.branchPolicyAutoReviewers.BranchPolicyAutoReviewersConfig")]
        internal sealed class _Proxy : DeputyBase, azuredevops.BranchPolicyAutoReviewers.IBranchPolicyAutoReviewersConfig
        {
            ...
            {
                get => GetInstanceProperty<azuredevops.BranchPolicyAutoReviewers.IBranchPolicyAutoReviewersTimeouts?>();
            }
