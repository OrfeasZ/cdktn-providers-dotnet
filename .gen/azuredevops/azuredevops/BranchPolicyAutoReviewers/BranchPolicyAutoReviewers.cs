...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.16.0/docs/resources/branch_policy_auto_reviewers azuredevops_branch_policy_auto_reviewers}.</summary>
    ...
    public class BranchPolicyAutoReviewers : Io.Cdktn.TerraformResource
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.16.0/docs/resources/branch_policy_auto_reviewers azuredevops_branch_policy_auto_reviewers} Resource.</summary>
        ...
        /// <summary>Generates CDKTN code for importing a BranchPolicyAutoReviewers resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        ...
        [JsiiMethod(name: "generateConfigForImport", returnsJson: "{\"type\":{\"fqn\":\"cdktn.ImportableResource\"}}", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"summary\":\"The construct id used in the generated config for the BranchPolicyAutoReviewers to import.\"},\"name\":\"importToId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"remarks\":\"Refer to the {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.16.0/docs/resources/branch_policy_auto_reviewers#import import section} in the documentation of this resource for the id to use\",\"summary\":\"The id of the existing BranchPolicyAutoReviewers that should be imported.\"},\"name\":\"importFromId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"? Optional instance of the provider where the BranchPolicyAutoReviewers to import is found.\"},\"name\":\"provider\",\"optional\":true,\"type\":{\"fqn\":\"cdktn.TerraformProvider\"}}]")]
        public static Io.Cdktn.ImportableResource GenerateConfigForImport(Constructs.Construct scope, string importToId, string importFromId, Io.Cdktn.TerraformProvider? provider = null)
        {
            return InvokeStaticMethod<Io.Cdktn.ImportableResource>(typeof(azuredevops.BranchPolicyAutoReviewers.BranchPolicyAutoReviewers), new System.Type[]{typeof(Constructs.Construct), typeof(string), typeof(string), typeof(Io.Cdktn.TerraformProvider)}, new object?[]{scope, importToId, importFromId, provider})!;
        }
        ...
        [JsiiMethod(name: "putTimeouts", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"azuredevops.branchPolicyAutoReviewers.BranchPolicyAutoReviewersTimeouts\"}}]")]
        public virtual void PutTimeouts(azuredevops.BranchPolicyAutoReviewers.IBranchPolicyAutoReviewersTimeouts @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(azuredevops.BranchPolicyAutoReviewers.IBranchPolicyAutoReviewersTimeouts)}, new object[]{@value});
        }
        ...
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"azuredevops.branchPolicyAutoReviewers.BranchPolicyAutoReviewersTimeoutsOutputReference\"}")]
        public virtual azuredevops.BranchPolicyAutoReviewers.BranchPolicyAutoReviewersTimeoutsOutputReference Timeouts
        {
            get => GetInstanceProperty<azuredevops.BranchPolicyAutoReviewers.BranchPolicyAutoReviewersTimeoutsOutputReference>()!;
        }
        ...
        /// <remarks>
        /// <para>Type union: either <see cref="Io.Cdktn.IResolvable" /> or <see cref="azuredevops.BranchPolicyAutoReviewers.IBranchPolicyAutoReviewersTimeouts" /></para>
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "timeoutsInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"azuredevops.branchPolicyAutoReviewers.BranchPolicyAutoReviewersTimeouts\"}]}}", isOptional: true)]
