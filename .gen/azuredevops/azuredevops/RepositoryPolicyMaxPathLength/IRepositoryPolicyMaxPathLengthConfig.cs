...
{
    [JsiiInterface(nativeType: typeof(IRepositoryPolicyMaxPathLengthConfig), fullyQualifiedName: "azuredevops.repositoryPolicyMaxPathLength.RepositoryPolicyMaxPathLengthConfig")]
    public interface IRepositoryPolicyMaxPathLengthConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        azuredevops.RepositoryPolicyMaxPathLength.IRepositoryPolicyMaxPathLengthTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IRepositoryPolicyMaxPathLengthConfig), fullyQualifiedName: "azuredevops.repositoryPolicyMaxPathLength.RepositoryPolicyMaxPathLengthConfig")]
        internal sealed class _Proxy : DeputyBase, azuredevops.RepositoryPolicyMaxPathLength.IRepositoryPolicyMaxPathLengthConfig
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"azuredevops.repositoryPolicyMaxPathLength.RepositoryPolicyMaxPathLengthTimeouts\"}", isOptional: true)]
            public azuredevops.RepositoryPolicyMaxPathLength.IRepositoryPolicyMaxPathLengthTimeouts? Timeouts
            {
                get => GetInstanceProperty<azuredevops.RepositoryPolicyMaxPathLength.IRepositoryPolicyMaxPathLengthTimeouts?>();
            }
