...
namespace azuredevops.DataAzuredevopsServicePrincipal
{
    ...
    public interface IDataAzuredevopsServicePrincipalTimeouts
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataAzuredevopsServicePrincipalTimeouts), fullyQualifiedName: "azuredevops.dataAzuredevopsServicePrincipal.DataAzuredevopsServicePrincipalTimeouts")]
        internal sealed class _Proxy : DeputyBase, azuredevops.DataAzuredevopsServicePrincipal.IDataAzuredevopsServicePrincipalTimeouts
        {
