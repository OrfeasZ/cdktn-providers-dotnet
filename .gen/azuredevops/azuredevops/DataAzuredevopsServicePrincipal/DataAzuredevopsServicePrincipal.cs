...
namespace azuredevops.DataAzuredevopsServicePrincipal
{
    ...
    public class DataAzuredevopsServicePrincipal : Io.Cdktn.TerraformDataSource
    {
        ...
        protected DataAzuredevopsServicePrincipal(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected DataAzuredevopsServicePrincipal(DeputyProps props): base(props)
        {
        }

        /// <summary>Generates CDKTN code for importing a DataAzuredevopsServicePrincipal resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        ...
        [JsiiMethod(name: "putTimeouts", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"azuredevops.dataAzuredevopsServicePrincipal.DataAzuredevopsServicePrincipalTimeouts\"}}]")]
        public virtual void PutTimeouts(azuredevops.DataAzuredevopsServicePrincipal.IDataAzuredevopsServicePrincipalTimeouts @value)
        {
        ...
        = GetStaticProperty<string>(typeof(azuredevops.DataAzuredevopsServicePrincipal.DataAzuredevopsServicePrincipal))!;
        ...
        {
            get => GetInstanceProperty<azuredevops.DataAzuredevopsServicePrincipal.DataAzuredevopsServicePrincipalTimeoutsOutputReference>()!;
        }
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "timeoutsInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"azuredevops.dataAzuredevopsServicePrincipal.DataAzuredevopsServicePrincipalTimeouts\"}]}}", isOptional: true)]
