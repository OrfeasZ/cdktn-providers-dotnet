...
namespace azuredevops.RepositoryPolicyCaseEnforcement
{
    ...
    public interface IRepositoryPolicyCaseEnforcementConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        azuredevops.RepositoryPolicyCaseEnforcement.IRepositoryPolicyCaseEnforcementTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IRepositoryPolicyCaseEnforcementConfig), fullyQualifiedName: "azuredevops.repositoryPolicyCaseEnforcement.RepositoryPolicyCaseEnforcementConfig")]
        internal sealed class _Proxy : DeputyBase, azuredevops.RepositoryPolicyCaseEnforcement.IRepositoryPolicyCaseEnforcementConfig
        {
            ...
            /// </remarks>
            [JsiiProperty(name: "enforceConsistentCase", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktn.IResolvable\"}]}}")]
            public object EnforceConsistentCase
            {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"azuredevops.repositoryPolicyCaseEnforcement.RepositoryPolicyCaseEnforcementTimeouts\"}", isOptional: true)]
            public azuredevops.RepositoryPolicyCaseEnforcement.IRepositoryPolicyCaseEnforcementTimeouts? Timeouts
            {
                get => GetInstanceProperty<azuredevops.RepositoryPolicyCaseEnforcement.IRepositoryPolicyCaseEnforcementTimeouts?>();
            }
