...
{
    [JsiiInterface(nativeType: typeof(IBuildDefinitionBuildCompletionTriggerBranchFilter), fullyQualifiedName: "azuredevops.buildDefinition.BuildDefinitionBuildCompletionTriggerBranchFilter")]
    public interface IBuildDefinitionBuildCompletionTriggerBranchFilter
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IBuildDefinitionBuildCompletionTriggerBranchFilter), fullyQualifiedName: "azuredevops.buildDefinition.BuildDefinitionBuildCompletionTriggerBranchFilter")]
        internal sealed class _Proxy : DeputyBase, azuredevops.BuildDefinition.IBuildDefinitionBuildCompletionTriggerBranchFilter
        {
