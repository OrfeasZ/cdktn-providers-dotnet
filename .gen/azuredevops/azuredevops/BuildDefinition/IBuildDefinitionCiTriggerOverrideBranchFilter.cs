...
{
    [JsiiInterface(nativeType: typeof(IBuildDefinitionCiTriggerOverrideBranchFilter), fullyQualifiedName: "azuredevops.buildDefinition.BuildDefinitionCiTriggerOverrideBranchFilter")]
    public interface IBuildDefinitionCiTriggerOverrideBranchFilter
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IBuildDefinitionCiTriggerOverrideBranchFilter), fullyQualifiedName: "azuredevops.buildDefinition.BuildDefinitionCiTriggerOverrideBranchFilter")]
        internal sealed class _Proxy : DeputyBase, azuredevops.BuildDefinition.IBuildDefinitionCiTriggerOverrideBranchFilter
        {
