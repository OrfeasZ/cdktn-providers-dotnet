...
{
    [JsiiInterface(nativeType: typeof(IBuildDefinitionPullRequestTriggerOverrideBranchFilter), fullyQualifiedName: "azuredevops.buildDefinition.BuildDefinitionPullRequestTriggerOverrideBranchFilter")]
    public interface IBuildDefinitionPullRequestTriggerOverrideBranchFilter
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IBuildDefinitionPullRequestTriggerOverrideBranchFilter), fullyQualifiedName: "azuredevops.buildDefinition.BuildDefinitionPullRequestTriggerOverrideBranchFilter")]
        internal sealed class _Proxy : DeputyBase, azuredevops.BuildDefinition.IBuildDefinitionPullRequestTriggerOverrideBranchFilter
        {
