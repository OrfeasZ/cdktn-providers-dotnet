...
{
    [JsiiInterface(nativeType: typeof(IBuildDefinitionSchedulesBranchFilter), fullyQualifiedName: "azuredevops.buildDefinition.BuildDefinitionSchedulesBranchFilter")]
    public interface IBuildDefinitionSchedulesBranchFilter
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IBuildDefinitionSchedulesBranchFilter), fullyQualifiedName: "azuredevops.buildDefinition.BuildDefinitionSchedulesBranchFilter")]
        internal sealed class _Proxy : DeputyBase, azuredevops.BuildDefinition.IBuildDefinitionSchedulesBranchFilter
        {
