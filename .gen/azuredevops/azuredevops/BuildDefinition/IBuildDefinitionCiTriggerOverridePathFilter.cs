...
{
    [JsiiInterface(nativeType: typeof(IBuildDefinitionCiTriggerOverridePathFilter), fullyQualifiedName: "azuredevops.buildDefinition.BuildDefinitionCiTriggerOverridePathFilter")]
    public interface IBuildDefinitionCiTriggerOverridePathFilter
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IBuildDefinitionCiTriggerOverridePathFilter), fullyQualifiedName: "azuredevops.buildDefinition.BuildDefinitionCiTriggerOverridePathFilter")]
        internal sealed class _Proxy : DeputyBase, azuredevops.BuildDefinition.IBuildDefinitionCiTriggerOverridePathFilter
        {
