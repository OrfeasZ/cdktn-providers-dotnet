...
{
    [JsiiInterface(nativeType: typeof(IWorkitemtrackingprocessInheritedPageConfig), fullyQualifiedName: "azuredevops.workitemtrackingprocessInheritedPage.WorkitemtrackingprocessInheritedPageConfig")]
    public interface IWorkitemtrackingprocessInheritedPageConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        azuredevops.WorkitemtrackingprocessInheritedPage.IWorkitemtrackingprocessInheritedPageTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IWorkitemtrackingprocessInheritedPageConfig), fullyQualifiedName: "azuredevops.workitemtrackingprocessInheritedPage.WorkitemtrackingprocessInheritedPageConfig")]
        internal sealed class _Proxy : DeputyBase, azuredevops.WorkitemtrackingprocessInheritedPage.IWorkitemtrackingprocessInheritedPageConfig
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"azuredevops.workitemtrackingprocessInheritedPage.WorkitemtrackingprocessInheritedPageTimeouts\"}", isOptional: true)]
            public azuredevops.WorkitemtrackingprocessInheritedPage.IWorkitemtrackingprocessInheritedPageTimeouts? Timeouts
            {
                get => GetInstanceProperty<azuredevops.WorkitemtrackingprocessInheritedPage.IWorkitemtrackingprocessInheritedPageTimeouts?>();
            }
