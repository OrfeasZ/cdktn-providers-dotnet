...
namespace azuredevops.DataAzuredevopsDescriptor
{
    ...
    public interface IDataAzuredevopsDescriptorConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        azuredevops.DataAzuredevopsDescriptor.IDataAzuredevopsDescriptorTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataAzuredevopsDescriptorConfig), fullyQualifiedName: "azuredevops.dataAzuredevopsDescriptor.DataAzuredevopsDescriptorConfig")]
        internal sealed class _Proxy : DeputyBase, azuredevops.DataAzuredevopsDescriptor.IDataAzuredevopsDescriptorConfig
        {
            ...
            {
                get => GetInstanceProperty<azuredevops.DataAzuredevopsDescriptor.IDataAzuredevopsDescriptorTimeouts?>();
            }
