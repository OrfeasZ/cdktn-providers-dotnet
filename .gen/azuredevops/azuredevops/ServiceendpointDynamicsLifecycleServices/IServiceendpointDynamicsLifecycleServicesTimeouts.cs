...
{
    [JsiiInterface(nativeType: typeof(IServiceendpointDynamicsLifecycleServicesTimeouts), fullyQualifiedName: "azuredevops.serviceendpointDynamicsLifecycleServices.ServiceendpointDynamicsLifecycleServicesTimeouts")]
    public interface IServiceendpointDynamicsLifecycleServicesTimeouts
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IServiceendpointDynamicsLifecycleServicesTimeouts), fullyQualifiedName: "azuredevops.serviceendpointDynamicsLifecycleServices.ServiceendpointDynamicsLifecycleServicesTimeouts")]
        internal sealed class _Proxy : DeputyBase, azuredevops.ServiceendpointDynamicsLifecycleServices.IServiceendpointDynamicsLifecycleServicesTimeouts
        {
