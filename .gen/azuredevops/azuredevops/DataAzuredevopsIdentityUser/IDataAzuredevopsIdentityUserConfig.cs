...
namespace azuredevops.DataAzuredevopsIdentityUser
{
    ...
    public interface IDataAzuredevopsIdentityUserConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        azuredevops.DataAzuredevopsIdentityUser.IDataAzuredevopsIdentityUserTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataAzuredevopsIdentityUserConfig), fullyQualifiedName: "azuredevops.dataAzuredevopsIdentityUser.DataAzuredevopsIdentityUserConfig")]
        internal sealed class _Proxy : DeputyBase, azuredevops.DataAzuredevopsIdentityUser.IDataAzuredevopsIdentityUserConfig
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"azuredevops.dataAzuredevopsIdentityUser.DataAzuredevopsIdentityUserTimeouts\"}", isOptional: true)]
            public azuredevops.DataAzuredevopsIdentityUser.IDataAzuredevopsIdentityUserTimeouts? Timeouts
            {
                get => GetInstanceProperty<azuredevops.DataAzuredevopsIdentityUser.IDataAzuredevopsIdentityUserTimeouts?>();
            }
