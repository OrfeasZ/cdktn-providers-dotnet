...
{
    [JsiiInterface(nativeType: typeof(IServiceendpointCheckmarxScaConfig), fullyQualifiedName: "azuredevops.serviceendpointCheckmarxSca.ServiceendpointCheckmarxScaConfig")]
    public interface IServiceendpointCheckmarxScaConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        azuredevops.ServiceendpointCheckmarxSca.IServiceendpointCheckmarxScaTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IServiceendpointCheckmarxScaConfig), fullyQualifiedName: "azuredevops.serviceendpointCheckmarxSca.ServiceendpointCheckmarxScaConfig")]
        internal sealed class _Proxy : DeputyBase, azuredevops.ServiceendpointCheckmarxSca.IServiceendpointCheckmarxScaConfig
        {
            ...
            {
                get => GetInstanceProperty<azuredevops.ServiceendpointCheckmarxSca.IServiceendpointCheckmarxScaTimeouts?>();
            }
