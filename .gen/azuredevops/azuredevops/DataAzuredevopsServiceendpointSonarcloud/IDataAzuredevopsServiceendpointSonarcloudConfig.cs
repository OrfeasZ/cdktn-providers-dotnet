...
namespace azuredevops.DataAzuredevopsServiceendpointSonarcloud
{
    ...
    public interface IDataAzuredevopsServiceendpointSonarcloudConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        azuredevops.DataAzuredevopsServiceendpointSonarcloud.IDataAzuredevopsServiceendpointSonarcloudTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        internal sealed class _Proxy : DeputyBase, azuredevops.DataAzuredevopsServiceendpointSonarcloud.IDataAzuredevopsServiceendpointSonarcloudConfig
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"azuredevops.dataAzuredevopsServiceendpointSonarcloud.DataAzuredevopsServiceendpointSonarcloudTimeouts\"}", isOptional: true)]
            public azuredevops.DataAzuredevopsServiceendpointSonarcloud.IDataAzuredevopsServiceendpointSonarcloudTimeouts? Timeouts
            {
                get => GetInstanceProperty<azuredevops.DataAzuredevopsServiceendpointSonarcloud.IDataAzuredevopsServiceendpointSonarcloudTimeouts?>();
            }
