...
{
    [JsiiInterface(nativeType: typeof(IDataAzuredevopsWorkitemtrackingprocessWorkitemtypeConfig), fullyQualifiedName: "azuredevops.dataAzuredevopsWorkitemtrackingprocessWorkitemtype.DataAzuredevopsWorkitemtrackingprocessWorkitemtypeConfig")]
    public interface IDataAzuredevopsWorkitemtrackingprocessWorkitemtypeConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        azuredevops.DataAzuredevopsWorkitemtrackingprocessWorkitemtype.IDataAzuredevopsWorkitemtrackingprocessWorkitemtypeTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataAzuredevopsWorkitemtrackingprocessWorkitemtypeConfig), fullyQualifiedName: "azuredevops.dataAzuredevopsWorkitemtrackingprocessWorkitemtype.DataAzuredevopsWorkitemtrackingprocessWorkitemtypeConfig")]
        internal sealed class _Proxy : DeputyBase, azuredevops.DataAzuredevopsWorkitemtrackingprocessWorkitemtype.IDataAzuredevopsWorkitemtrackingprocessWorkitemtypeConfig
        {
            ...
            {
                get => GetInstanceProperty<azuredevops.DataAzuredevopsWorkitemtrackingprocessWorkitemtype.IDataAzuredevopsWorkitemtrackingprocessWorkitemtypeTimeouts?>();
            }
