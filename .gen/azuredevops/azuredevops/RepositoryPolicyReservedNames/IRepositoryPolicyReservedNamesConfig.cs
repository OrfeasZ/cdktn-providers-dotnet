...
{
    [JsiiInterface(nativeType: typeof(IRepositoryPolicyReservedNamesConfig), fullyQualifiedName: "azuredevops.repositoryPolicyReservedNames.RepositoryPolicyReservedNamesConfig")]
    public interface IRepositoryPolicyReservedNamesConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        azuredevops.RepositoryPolicyReservedNames.IRepositoryPolicyReservedNamesTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IRepositoryPolicyReservedNamesConfig), fullyQualifiedName: "azuredevops.repositoryPolicyReservedNames.RepositoryPolicyReservedNamesConfig")]
        internal sealed class _Proxy : DeputyBase, azuredevops.RepositoryPolicyReservedNames.IRepositoryPolicyReservedNamesConfig
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"azuredevops.repositoryPolicyReservedNames.RepositoryPolicyReservedNamesTimeouts\"}", isOptional: true)]
            public azuredevops.RepositoryPolicyReservedNames.IRepositoryPolicyReservedNamesTimeouts? Timeouts
            {
                get => GetInstanceProperty<azuredevops.RepositoryPolicyReservedNames.IRepositoryPolicyReservedNamesTimeouts?>();
            }
