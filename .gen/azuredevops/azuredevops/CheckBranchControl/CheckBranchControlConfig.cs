...
namespace azuredevops.CheckBranchControl
{
    ...
    public class CheckBranchControlConfig : azuredevops.CheckBranchControl.ICheckBranchControlConfig
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "ignoreUnknownProtectionStatus", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktn.IResolvable\"}]}}", isOptional: true)]
        public object? IgnoreUnknownProtectionStatus
        {
            get => _ignoreUnknownProtectionStatus;
            set
            {
                ...
                _ignoreUnknownProtectionStatus = value;
            }
        }
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "verifyBranchProtection", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktn.IResolvable\"}]}}", isOptional: true)]
        public object? VerifyBranchProtection
        {
            get => _verifyBranchProtection;
            set
            {
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
