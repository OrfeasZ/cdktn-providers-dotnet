...
{
    [JsiiInterface(nativeType: typeof(IServicehookPermissionsTimeouts), fullyQualifiedName: "azuredevops.servicehookPermissions.ServicehookPermissionsTimeouts")]
    public interface IServicehookPermissionsTimeouts
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IServicehookPermissionsTimeouts), fullyQualifiedName: "azuredevops.servicehookPermissions.ServicehookPermissionsTimeouts")]
        internal sealed class _Proxy : DeputyBase, azuredevops.ServicehookPermissions.IServicehookPermissionsTimeouts
        {
