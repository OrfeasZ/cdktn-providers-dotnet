...
namespace azuredevops.ServiceendpointBitbucket
{
    ...
    public class ServiceendpointBitbucket : Io.Cdktn.TerraformResource
    {
        ...
        private static DeputyProps _MakeDeputyProps(Constructs.Construct scope, string id, azuredevops.ServiceendpointBitbucket.IServiceendpointBitbucketConfig config)
        {
        ...
        protected ServiceendpointBitbucket(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected ServiceendpointBitbucket(DeputyProps props): base(props)
        {
        }

        /// <summary>Generates CDKTN code for importing a ServiceendpointBitbucket resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        ...
        [JsiiMethod(name: "putTimeouts", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"azuredevops.serviceendpointBitbucket.ServiceendpointBitbucketTimeouts\"}}]")]
        public virtual void PutTimeouts(azuredevops.ServiceendpointBitbucket.IServiceendpointBitbucketTimeouts @value)
        {
        ...
        = GetStaticProperty<string>(typeof(azuredevops.ServiceendpointBitbucket.ServiceendpointBitbucket))!;
        ...
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"azuredevops.serviceendpointBitbucket.ServiceendpointBitbucketTimeoutsOutputReference\"}")]
        public virtual azuredevops.ServiceendpointBitbucket.ServiceendpointBitbucketTimeoutsOutputReference Timeouts
        {
            get => GetInstanceProperty<azuredevops.ServiceendpointBitbucket.ServiceendpointBitbucketTimeoutsOutputReference>()!;
        }
        ...
        /// <remarks>
        /// <para>Type union: either <see cref="Io.Cdktn.IResolvable" /> or <see cref="azuredevops.ServiceendpointBitbucket.IServiceendpointBitbucketTimeouts" /></para>
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "timeoutsInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"azuredevops.serviceendpointBitbucket.ServiceendpointBitbucketTimeouts\"}]}}", isOptional: true)]
