...
{
    [JsiiInterface(nativeType: typeof(IDataAzuredevopsEnvironmentConfig), fullyQualifiedName: "azuredevops.dataAzuredevopsEnvironment.DataAzuredevopsEnvironmentConfig")]
    public interface IDataAzuredevopsEnvironmentConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        azuredevops.DataAzuredevopsEnvironment.IDataAzuredevopsEnvironmentTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataAzuredevopsEnvironmentConfig), fullyQualifiedName: "azuredevops.dataAzuredevopsEnvironment.DataAzuredevopsEnvironmentConfig")]
        internal sealed class _Proxy : DeputyBase, azuredevops.DataAzuredevopsEnvironment.IDataAzuredevopsEnvironmentConfig
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"azuredevops.dataAzuredevopsEnvironment.DataAzuredevopsEnvironmentTimeouts\"}", isOptional: true)]
            public azuredevops.DataAzuredevopsEnvironment.IDataAzuredevopsEnvironmentTimeouts? Timeouts
            {
                get => GetInstanceProperty<azuredevops.DataAzuredevopsEnvironment.IDataAzuredevopsEnvironmentTimeouts?>();
            }
