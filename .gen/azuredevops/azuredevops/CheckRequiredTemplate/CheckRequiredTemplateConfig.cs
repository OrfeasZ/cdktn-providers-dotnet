...
namespace azuredevops.CheckRequiredTemplate
{
    ...
    public class CheckRequiredTemplateConfig : azuredevops.CheckRequiredTemplate.ICheckRequiredTemplateConfig
    {
        ...
        private object _requiredTemplate;
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            ...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(azuredevops.CheckRequiredTemplate.ICheckRequiredTemplateRequiredTemplate).FullName}[]; received null", nameof(value));
                        default:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(azuredevops.CheckRequiredTemplate.ICheckRequiredTemplateRequiredTemplate).FullName}[]; received {value.GetType().FullName}", nameof(value));
                    }
                }
                _requiredTemplate = value;
            }
        }
