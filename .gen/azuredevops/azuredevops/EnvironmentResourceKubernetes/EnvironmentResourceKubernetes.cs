...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.15.1/docs/resources/environment_resource_kubernetes azuredevops_environment_resource_kubernetes}.</summary>
    ...
    public class EnvironmentResourceKubernetes : Io.Cdktn.TerraformResource
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.15.1/docs/resources/environment_resource_kubernetes azuredevops_environment_resource_kubernetes} Resource.</summary>
        ...
        /// <summary>Generates CDKTN code for importing a EnvironmentResourceKubernetes resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        ...
        [JsiiMethod(name: "generateConfigForImport", returnsJson: "{\"type\":{\"fqn\":\"cdktn.ImportableResource\"}}", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"summary\":\"The construct id used in the generated config for the EnvironmentResourceKubernetes to import.\"},\"name\":\"importToId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"remarks\":\"Refer to the {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.15.1/docs/resources/environment_resource_kubernetes#import import section} in the documentation of this resource for the id to use\",\"summary\":\"The id of the existing EnvironmentResourceKubernetes that should be imported.\"},\"name\":\"importFromId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"? Optional instance of the provider where the EnvironmentResourceKubernetes to import is found.\"},\"name\":\"provider\",\"optional\":true,\"type\":{\"fqn\":\"cdktn.TerraformProvider\"}}]")]
        public static Io.Cdktn.ImportableResource GenerateConfigForImport(Constructs.Construct scope, string importToId, string importFromId, Io.Cdktn.TerraformProvider? provider = null)
        {
            return InvokeStaticMethod<Io.Cdktn.ImportableResource>(typeof(azuredevops.EnvironmentResourceKubernetes.EnvironmentResourceKubernetes), new System.Type[]{typeof(Constructs.Construct), typeof(string), typeof(string), typeof(Io.Cdktn.TerraformProvider)}, new object?[]{scope, importToId, importFromId, provider})!;
        }

        [JsiiMethod(name: "putTimeouts", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"azuredevops.environmentResourceKubernetes.EnvironmentResourceKubernetesTimeouts\"}}]")]
        public virtual void PutTimeouts(azuredevops.EnvironmentResourceKubernetes.IEnvironmentResourceKubernetesTimeouts @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(azuredevops.EnvironmentResourceKubernetes.IEnvironmentResourceKubernetesTimeouts)}, new object[]{@value});
        }
        ...
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"azuredevops.environmentResourceKubernetes.EnvironmentResourceKubernetesTimeoutsOutputReference\"}")]
        public virtual azuredevops.EnvironmentResourceKubernetes.EnvironmentResourceKubernetesTimeoutsOutputReference Timeouts
        {
            get => GetInstanceProperty<azuredevops.EnvironmentResourceKubernetes.EnvironmentResourceKubernetesTimeoutsOutputReference>()!;
        }
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "timeoutsInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"azuredevops.environmentResourceKubernetes.EnvironmentResourceKubernetesTimeouts\"}]}}", isOptional: true)]
