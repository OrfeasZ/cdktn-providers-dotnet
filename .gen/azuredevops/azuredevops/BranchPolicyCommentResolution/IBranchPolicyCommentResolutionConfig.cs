...
{
    [JsiiInterface(nativeType: typeof(IBranchPolicyCommentResolutionConfig), fullyQualifiedName: "azuredevops.branchPolicyCommentResolution.BranchPolicyCommentResolutionConfig")]
    public interface IBranchPolicyCommentResolutionConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        azuredevops.BranchPolicyCommentResolution.IBranchPolicyCommentResolutionSettings Settings
        {
            get;
        }
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        azuredevops.BranchPolicyCommentResolution.IBranchPolicyCommentResolutionTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IBranchPolicyCommentResolutionConfig), fullyQualifiedName: "azuredevops.branchPolicyCommentResolution.BranchPolicyCommentResolutionConfig")]
        internal sealed class _Proxy : DeputyBase, azuredevops.BranchPolicyCommentResolution.IBranchPolicyCommentResolutionConfig
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"azuredevops.branchPolicyCommentResolution.BranchPolicyCommentResolutionTimeouts\"}", isOptional: true)]
            public azuredevops.BranchPolicyCommentResolution.IBranchPolicyCommentResolutionTimeouts? Timeouts
            {
                get => GetInstanceProperty<azuredevops.BranchPolicyCommentResolution.IBranchPolicyCommentResolutionTimeouts?>();
            }
