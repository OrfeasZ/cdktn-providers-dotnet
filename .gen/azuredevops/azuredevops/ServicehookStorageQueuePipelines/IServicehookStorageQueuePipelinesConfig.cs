...
namespace azuredevops.ServicehookStorageQueuePipelines
{
    ...
    public interface IServicehookStorageQueuePipelinesConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        azuredevops.ServicehookStorageQueuePipelines.IServicehookStorageQueuePipelinesTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        internal sealed class _Proxy : DeputyBase, azuredevops.ServicehookStorageQueuePipelines.IServicehookStorageQueuePipelinesConfig
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"azuredevops.servicehookStorageQueuePipelines.ServicehookStorageQueuePipelinesTimeouts\"}", isOptional: true)]
            public azuredevops.ServicehookStorageQueuePipelines.IServicehookStorageQueuePipelinesTimeouts? Timeouts
            {
                get => GetInstanceProperty<azuredevops.ServicehookStorageQueuePipelines.IServicehookStorageQueuePipelinesTimeouts?>();
            }
