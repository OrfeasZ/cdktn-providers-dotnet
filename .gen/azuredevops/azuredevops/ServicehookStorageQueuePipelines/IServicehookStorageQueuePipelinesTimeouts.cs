...
{
    [JsiiInterface(nativeType: typeof(IServicehookStorageQueuePipelinesTimeouts), fullyQualifiedName: "azuredevops.servicehookStorageQueuePipelines.ServicehookStorageQueuePipelinesTimeouts")]
    public interface IServicehookStorageQueuePipelinesTimeouts
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IServicehookStorageQueuePipelinesTimeouts), fullyQualifiedName: "azuredevops.servicehookStorageQueuePipelines.ServicehookStorageQueuePipelinesTimeouts")]
        internal sealed class _Proxy : DeputyBase, azuredevops.ServicehookStorageQueuePipelines.IServicehookStorageQueuePipelinesTimeouts
        {
