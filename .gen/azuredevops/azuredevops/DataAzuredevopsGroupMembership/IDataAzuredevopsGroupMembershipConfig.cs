...
namespace azuredevops.DataAzuredevopsGroupMembership
{
    ...
    public interface IDataAzuredevopsGroupMembershipConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        azuredevops.DataAzuredevopsGroupMembership.IDataAzuredevopsGroupMembershipTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataAzuredevopsGroupMembershipConfig), fullyQualifiedName: "azuredevops.dataAzuredevopsGroupMembership.DataAzuredevopsGroupMembershipConfig")]
        internal sealed class _Proxy : DeputyBase, azuredevops.DataAzuredevopsGroupMembership.IDataAzuredevopsGroupMembershipConfig
        {
            ...
            {
                get => GetInstanceProperty<azuredevops.DataAzuredevopsGroupMembership.IDataAzuredevopsGroupMembershipTimeouts?>();
            }
