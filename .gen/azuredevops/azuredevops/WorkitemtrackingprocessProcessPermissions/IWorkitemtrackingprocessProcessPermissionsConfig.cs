...
{
    [JsiiInterface(nativeType: typeof(IWorkitemtrackingprocessProcessPermissionsConfig), fullyQualifiedName: "azuredevops.workitemtrackingprocessProcessPermissions.WorkitemtrackingprocessProcessPermissionsConfig")]
    public interface IWorkitemtrackingprocessProcessPermissionsConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        azuredevops.WorkitemtrackingprocessProcessPermissions.IWorkitemtrackingprocessProcessPermissionsTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IWorkitemtrackingprocessProcessPermissionsConfig), fullyQualifiedName: "azuredevops.workitemtrackingprocessProcessPermissions.WorkitemtrackingprocessProcessPermissionsConfig")]
        internal sealed class _Proxy : DeputyBase, azuredevops.WorkitemtrackingprocessProcessPermissions.IWorkitemtrackingprocessProcessPermissionsConfig
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"azuredevops.workitemtrackingprocessProcessPermissions.WorkitemtrackingprocessProcessPermissionsTimeouts\"}", isOptional: true)]
            public azuredevops.WorkitemtrackingprocessProcessPermissions.IWorkitemtrackingprocessProcessPermissionsTimeouts? Timeouts
            {
                get => GetInstanceProperty<azuredevops.WorkitemtrackingprocessProcessPermissions.IWorkitemtrackingprocessProcessPermissionsTimeouts?>();
            }
