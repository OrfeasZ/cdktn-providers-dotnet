...
{
    [JsiiInterface(nativeType: typeof(IRepositoryPolicyFilePathPatternConfig), fullyQualifiedName: "azuredevops.repositoryPolicyFilePathPattern.RepositoryPolicyFilePathPatternConfig")]
    public interface IRepositoryPolicyFilePathPatternConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        azuredevops.RepositoryPolicyFilePathPattern.IRepositoryPolicyFilePathPatternTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IRepositoryPolicyFilePathPatternConfig), fullyQualifiedName: "azuredevops.repositoryPolicyFilePathPattern.RepositoryPolicyFilePathPatternConfig")]
        internal sealed class _Proxy : DeputyBase, azuredevops.RepositoryPolicyFilePathPattern.IRepositoryPolicyFilePathPatternConfig
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"azuredevops.repositoryPolicyFilePathPattern.RepositoryPolicyFilePathPatternTimeouts\"}", isOptional: true)]
            public azuredevops.RepositoryPolicyFilePathPattern.IRepositoryPolicyFilePathPatternTimeouts? Timeouts
            {
                get => GetInstanceProperty<azuredevops.RepositoryPolicyFilePathPattern.IRepositoryPolicyFilePathPatternTimeouts?>();
            }
