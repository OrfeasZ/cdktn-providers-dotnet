...
{
    [JsiiInterface(nativeType: typeof(IDataAzuredevopsServiceendpointGenericV2Config), fullyQualifiedName: "azuredevops.dataAzuredevopsServiceendpointGenericV2.DataAzuredevopsServiceendpointGenericV2Config")]
    public interface IDataAzuredevopsServiceendpointGenericV2Config : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        azuredevops.DataAzuredevopsServiceendpointGenericV2.IDataAzuredevopsServiceendpointGenericV2Timeouts? Timeouts
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataAzuredevopsServiceendpointGenericV2Config), fullyQualifiedName: "azuredevops.dataAzuredevopsServiceendpointGenericV2.DataAzuredevopsServiceendpointGenericV2Config")]
        internal sealed class _Proxy : DeputyBase, azuredevops.DataAzuredevopsServiceendpointGenericV2.IDataAzuredevopsServiceendpointGenericV2Config
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"azuredevops.dataAzuredevopsServiceendpointGenericV2.DataAzuredevopsServiceendpointGenericV2Timeouts\"}", isOptional: true)]
            public azuredevops.DataAzuredevopsServiceendpointGenericV2.IDataAzuredevopsServiceendpointGenericV2Timeouts? Timeouts
            {
                get => GetInstanceProperty<azuredevops.DataAzuredevopsServiceendpointGenericV2.IDataAzuredevopsServiceendpointGenericV2Timeouts?>();
            }
