...
{
    [JsiiInterface(nativeType: typeof(ICheckExclusiveLockConfig), fullyQualifiedName: "azuredevops.checkExclusiveLock.CheckExclusiveLockConfig")]
    public interface ICheckExclusiveLockConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        azuredevops.CheckExclusiveLock.ICheckExclusiveLockTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(ICheckExclusiveLockConfig), fullyQualifiedName: "azuredevops.checkExclusiveLock.CheckExclusiveLockConfig")]
        internal sealed class _Proxy : DeputyBase, azuredevops.CheckExclusiveLock.ICheckExclusiveLockConfig
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"azuredevops.checkExclusiveLock.CheckExclusiveLockTimeouts\"}", isOptional: true)]
            public azuredevops.CheckExclusiveLock.ICheckExclusiveLockTimeouts? Timeouts
            {
                get => GetInstanceProperty<azuredevops.CheckExclusiveLock.ICheckExclusiveLockTimeouts?>();
            }
