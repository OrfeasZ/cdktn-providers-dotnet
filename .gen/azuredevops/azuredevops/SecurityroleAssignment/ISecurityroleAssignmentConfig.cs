...
{
    [JsiiInterface(nativeType: typeof(ISecurityroleAssignmentConfig), fullyQualifiedName: "azuredevops.securityroleAssignment.SecurityroleAssignmentConfig")]
    public interface ISecurityroleAssignmentConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        azuredevops.SecurityroleAssignment.ISecurityroleAssignmentTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(ISecurityroleAssignmentConfig), fullyQualifiedName: "azuredevops.securityroleAssignment.SecurityroleAssignmentConfig")]
        internal sealed class _Proxy : DeputyBase, azuredevops.SecurityroleAssignment.ISecurityroleAssignmentConfig
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"azuredevops.securityroleAssignment.SecurityroleAssignmentTimeouts\"}", isOptional: true)]
            public azuredevops.SecurityroleAssignment.ISecurityroleAssignmentTimeouts? Timeouts
            {
                get => GetInstanceProperty<azuredevops.SecurityroleAssignment.ISecurityroleAssignmentTimeouts?>();
            }
