...
{
    [JsiiInterface(nativeType: typeof(IExtensionConfig), fullyQualifiedName: "azuredevops.extension.ExtensionConfig")]
    public interface IExtensionConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        azuredevops.Extension.IExtensionTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IExtensionConfig), fullyQualifiedName: "azuredevops.extension.ExtensionConfig")]
        internal sealed class _Proxy : DeputyBase, azuredevops.Extension.IExtensionConfig
        {
            ...
            {
                get => GetInstanceProperty<azuredevops.Extension.IExtensionTimeouts?>();
            }
