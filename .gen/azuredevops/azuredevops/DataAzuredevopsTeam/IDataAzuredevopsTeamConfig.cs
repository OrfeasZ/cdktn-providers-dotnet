...
{
    [JsiiInterface(nativeType: typeof(IDataAzuredevopsTeamConfig), fullyQualifiedName: "azuredevops.dataAzuredevopsTeam.DataAzuredevopsTeamConfig")]
    public interface IDataAzuredevopsTeamConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        azuredevops.DataAzuredevopsTeam.IDataAzuredevopsTeamTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataAzuredevopsTeamConfig), fullyQualifiedName: "azuredevops.dataAzuredevopsTeam.DataAzuredevopsTeamConfig")]
        internal sealed class _Proxy : DeputyBase, azuredevops.DataAzuredevopsTeam.IDataAzuredevopsTeamConfig
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"azuredevops.dataAzuredevopsTeam.DataAzuredevopsTeamTimeouts\"}", isOptional: true)]
            public azuredevops.DataAzuredevopsTeam.IDataAzuredevopsTeamTimeouts? Timeouts
            {
                get => GetInstanceProperty<azuredevops.DataAzuredevopsTeam.IDataAzuredevopsTeamTimeouts?>();
            }
