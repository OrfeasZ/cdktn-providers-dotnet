...
{
    [JsiiInterface(nativeType: typeof(ISecurityPermissionsConfig), fullyQualifiedName: "azuredevops.securityPermissions.SecurityPermissionsConfig")]
    public interface ISecurityPermissionsConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        azuredevops.SecurityPermissions.ISecurityPermissionsTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(ISecurityPermissionsConfig), fullyQualifiedName: "azuredevops.securityPermissions.SecurityPermissionsConfig")]
        internal sealed class _Proxy : DeputyBase, azuredevops.SecurityPermissions.ISecurityPermissionsConfig
        {
            ...
            {
                get => GetInstanceProperty<azuredevops.SecurityPermissions.ISecurityPermissionsTimeouts?>();
            }
