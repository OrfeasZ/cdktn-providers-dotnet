...
namespace azuredevops.ServiceendpointAzurerm
{
    ...
    public class ServiceendpointAzurermCredentialsOutputReference : Io.Cdktn.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        public ServiceendpointAzurermCredentialsOutputReference(Io.Cdktn.IInterpolatingParent terraformResource, string terraformAttribute): base(_MakeDeputyProps(terraformResource, terraformAttribute))
        {
        }
        ...
        [JsiiMethod(name: "resetServiceprincipalcertificate")]
        public virtual void ResetServiceprincipalcertificate()
        {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "serviceprincipalcertificateInput", typeJson: "{\"primitive\":\"string\"}", isOptional: true)]
        public virtual string? ServiceprincipalcertificateInput
        {
        ...
        [JsiiProperty(name: "serviceprincipalcertificate", typeJson: "{\"primitive\":\"string\"}")]
        public virtual string Serviceprincipalcertificate
        {
            get => GetInstanceProperty<string>()!;
