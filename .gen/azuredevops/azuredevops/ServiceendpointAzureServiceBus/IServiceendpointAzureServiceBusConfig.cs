...
{
    [JsiiInterface(nativeType: typeof(IServiceendpointAzureServiceBusConfig), fullyQualifiedName: "azuredevops.serviceendpointAzureServiceBus.ServiceendpointAzureServiceBusConfig")]
    public interface IServiceendpointAzureServiceBusConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        azuredevops.ServiceendpointAzureServiceBus.IServiceendpointAzureServiceBusTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IServiceendpointAzureServiceBusConfig), fullyQualifiedName: "azuredevops.serviceendpointAzureServiceBus.ServiceendpointAzureServiceBusConfig")]
        internal sealed class _Proxy : DeputyBase, azuredevops.ServiceendpointAzureServiceBus.IServiceendpointAzureServiceBusConfig
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"azuredevops.serviceendpointAzureServiceBus.ServiceendpointAzureServiceBusTimeouts\"}", isOptional: true)]
            public azuredevops.ServiceendpointAzureServiceBus.IServiceendpointAzureServiceBusTimeouts? Timeouts
            {
                get => GetInstanceProperty<azuredevops.ServiceendpointAzureServiceBus.IServiceendpointAzureServiceBusTimeouts?>();
            }
