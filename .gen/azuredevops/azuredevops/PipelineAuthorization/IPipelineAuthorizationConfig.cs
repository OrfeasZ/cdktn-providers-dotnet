...
{
    [JsiiInterface(nativeType: typeof(IPipelineAuthorizationConfig), fullyQualifiedName: "azuredevops.pipelineAuthorization.PipelineAuthorizationConfig")]
    public interface IPipelineAuthorizationConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        azuredevops.PipelineAuthorization.IPipelineAuthorizationTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IPipelineAuthorizationConfig), fullyQualifiedName: "azuredevops.pipelineAuthorization.PipelineAuthorizationConfig")]
        internal sealed class _Proxy : DeputyBase, azuredevops.PipelineAuthorization.IPipelineAuthorizationConfig
        {
            ...
            {
                get => GetInstanceProperty<azuredevops.PipelineAuthorization.IPipelineAuthorizationTimeouts?>();
            }
