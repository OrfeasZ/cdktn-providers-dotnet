...
{
    [JsiiByValue(fqn: "azuredevops.groupEntitlement.GroupEntitlementConfig")]
    public class GroupEntitlementConfig : azuredevops.GroupEntitlement.IGroupEntitlementConfig
    {
