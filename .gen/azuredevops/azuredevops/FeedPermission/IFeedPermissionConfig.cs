...
namespace azuredevops.FeedPermission
{
    [JsiiInterface(nativeType: typeof(IFeedPermissionConfig), fullyQualifiedName: "azuredevops.feedPermission.FeedPermissionConfig")]
    public interface IFeedPermissionConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        azuredevops.FeedPermission.IFeedPermissionTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IFeedPermissionConfig), fullyQualifiedName: "azuredevops.feedPermission.FeedPermissionConfig")]
        internal sealed class _Proxy : DeputyBase, azuredevops.FeedPermission.IFeedPermissionConfig
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"azuredevops.feedPermission.FeedPermissionTimeouts\"}", isOptional: true)]
            public azuredevops.FeedPermission.IFeedPermissionTimeouts? Timeouts
            {
                get => GetInstanceProperty<azuredevops.FeedPermission.IFeedPermissionTimeouts?>();
            }
