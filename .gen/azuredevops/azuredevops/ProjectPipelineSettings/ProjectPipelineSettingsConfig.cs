...
namespace azuredevops.ProjectPipelineSettings
{
    ...
    public class ProjectPipelineSettingsConfig : azuredevops.ProjectPipelineSettings.IProjectPipelineSettingsConfig
    {
        ...
        private object? _enforceJobScope;
        ...
        {
            get => _enforceJobScopeForRelease;
            set
            {
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                ...
                _enforceJobScopeForRelease = value;
            }
        }

        private object? _enforceReferencedRepoScopedToken;
        ...
        {
            get => _enforceReferencedRepoScopedToken;
            set
            {
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                ...
                _enforceReferencedRepoScopedToken = value;
            }
        }

        private object? _enforceSettableVar;
        ...
        private object? _publishPipelineMetadata;
        ...
        public object? PublishPipelineMetadata
        {
            ...
            set
            {
                ...
                _publishPipelineMetadata = value;
            }
        }

        private object? _statusBadgesArePrivate;
