...
{
    [JsiiInterface(nativeType: typeof(IWorkitemqueryFolderConfig), fullyQualifiedName: "azuredevops.workitemqueryFolder.WorkitemqueryFolderConfig")]
    public interface IWorkitemqueryFolderConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        azuredevops.WorkitemqueryFolder.IWorkitemqueryFolderTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IWorkitemqueryFolderConfig), fullyQualifiedName: "azuredevops.workitemqueryFolder.WorkitemqueryFolderConfig")]
        internal sealed class _Proxy : DeputyBase, azuredevops.WorkitemqueryFolder.IWorkitemqueryFolderConfig
        {
            ...
            {
                get => GetInstanceProperty<azuredevops.WorkitemqueryFolder.IWorkitemqueryFolderTimeouts?>();
            }
