...
namespace azuredevops.DataAzuredevopsUsers
{
    ...
    public interface IDataAzuredevopsUsersConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        azuredevops.DataAzuredevopsUsers.IDataAzuredevopsUsersTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        internal sealed class _Proxy : DeputyBase, azuredevops.DataAzuredevopsUsers.IDataAzuredevopsUsersConfig
        {
            ...
            {
                get => GetInstanceProperty<azuredevops.DataAzuredevopsUsers.IDataAzuredevopsUsersTimeouts?>();
            }
