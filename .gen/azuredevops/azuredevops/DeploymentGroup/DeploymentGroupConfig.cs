...
namespace azuredevops.DeploymentGroup
{
    ...
    [JsiiByValue(fqn: "azuredevops.deploymentGroup.DeploymentGroupConfig")]
    public class DeploymentGroupConfig : azuredevops.DeploymentGroup.IDeploymentGroupConfig
    {
