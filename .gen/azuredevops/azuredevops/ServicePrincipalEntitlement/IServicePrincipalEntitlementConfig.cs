...
namespace azuredevops.ServicePrincipalEntitlement
{
    ...
    public interface IServicePrincipalEntitlementConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        azuredevops.ServicePrincipalEntitlement.IServicePrincipalEntitlementTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IServicePrincipalEntitlementConfig), fullyQualifiedName: "azuredevops.servicePrincipalEntitlement.ServicePrincipalEntitlementConfig")]
        internal sealed class _Proxy : DeputyBase, azuredevops.ServicePrincipalEntitlement.IServicePrincipalEntitlementConfig
        {
            ...
            {
                get => GetInstanceProperty<azuredevops.ServicePrincipalEntitlement.IServicePrincipalEntitlementTimeouts?>();
            }
