...
{
    [JsiiInterface(nativeType: typeof(IBranchPolicyBuildValidationConfig), fullyQualifiedName: "azuredevops.branchPolicyBuildValidation.BranchPolicyBuildValidationConfig")]
    public interface IBranchPolicyBuildValidationConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        azuredevops.BranchPolicyBuildValidation.IBranchPolicyBuildValidationSettings Settings
        {
            get;
        }
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        azuredevops.BranchPolicyBuildValidation.IBranchPolicyBuildValidationTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IBranchPolicyBuildValidationConfig), fullyQualifiedName: "azuredevops.branchPolicyBuildValidation.BranchPolicyBuildValidationConfig")]
        internal sealed class _Proxy : DeputyBase, azuredevops.BranchPolicyBuildValidation.IBranchPolicyBuildValidationConfig
        {
            ...
            {
                get => GetInstanceProperty<azuredevops.BranchPolicyBuildValidation.IBranchPolicyBuildValidationTimeouts?>();
            }
