...
namespace azuredevops.BranchPolicyBuildValidation
{
    ...
    public class BranchPolicyBuildValidationSettings : azuredevops.BranchPolicyBuildValidation.IBranchPolicyBuildValidationSettings
    {
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        ...
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            ...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(azuredevops.BranchPolicyBuildValidation.IBranchPolicyBuildValidationSettingsScope).FullName}[]; received null", nameof(value));
                        default:
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "manualQueueOnly", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktn.IResolvable\"}]}}", isOptional: true)]
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "queueOnSourceUpdateOnly", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktn.IResolvable\"}]}}", isOptional: true)]
