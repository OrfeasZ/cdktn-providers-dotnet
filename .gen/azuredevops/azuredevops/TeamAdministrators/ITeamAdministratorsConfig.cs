...
{
    [JsiiInterface(nativeType: typeof(ITeamAdministratorsConfig), fullyQualifiedName: "azuredevops.teamAdministrators.TeamAdministratorsConfig")]
    public interface ITeamAdministratorsConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        azuredevops.TeamAdministrators.ITeamAdministratorsTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(ITeamAdministratorsConfig), fullyQualifiedName: "azuredevops.teamAdministrators.TeamAdministratorsConfig")]
        internal sealed class _Proxy : DeputyBase, azuredevops.TeamAdministrators.ITeamAdministratorsConfig
        {
            ...
            {
                get => GetInstanceProperty<azuredevops.TeamAdministrators.ITeamAdministratorsTimeouts?>();
            }
