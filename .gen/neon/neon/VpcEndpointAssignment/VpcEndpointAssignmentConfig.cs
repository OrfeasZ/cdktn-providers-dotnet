...
namespace neon.VpcEndpointAssignment
{
    ...
    [JsiiByValue(fqn: "neon.vpcEndpointAssignment.VpcEndpointAssignmentConfig")]
    public class VpcEndpointAssignmentConfig : neon.VpcEndpointAssignment.IVpcEndpointAssignmentConfig
    {
