...
namespace azuread.SynchronizationJob
{
    ...
    [JsiiByValue(fqn: "azuread.synchronizationJob.SynchronizationJobConfig")]
    public class SynchronizationJobConfig : azuread.SynchronizationJob.ISynchronizationJobConfig
    {
