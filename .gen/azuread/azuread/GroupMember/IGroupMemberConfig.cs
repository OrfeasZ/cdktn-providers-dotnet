...
{
    [JsiiInterface(nativeType: typeof(IGroupMemberConfig), fullyQualifiedName: "azuread.groupMember.GroupMemberConfig")]
    public interface IGroupMemberConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        /// <summary>The object ID of the principal you want to add as a member to the group.</summary>
        /// <remarks>
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        azuread.GroupMember.IGroupMemberTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IGroupMemberConfig), fullyQualifiedName: "azuread.groupMember.GroupMemberConfig")]
        internal sealed class _Proxy : DeputyBase, azuread.GroupMember.IGroupMemberConfig
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"azuread.groupMember.GroupMemberTimeouts\"}", isOptional: true)]
            public azuread.GroupMember.IGroupMemberTimeouts? Timeouts
            {
                get => GetInstanceProperty<azuread.GroupMember.IGroupMemberTimeouts?>();
            }
