...
namespace azuread.ConditionalAccessPolicy
{
    ...
    public interface IConditionalAccessPolicyConditionsApplicationsFilter
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IConditionalAccessPolicyConditionsApplicationsFilter), fullyQualifiedName: "azuread.conditionalAccessPolicy.ConditionalAccessPolicyConditionsApplicationsFilter")]
        internal sealed class _Proxy : DeputyBase, azuread.ConditionalAccessPolicy.IConditionalAccessPolicyConditionsApplicationsFilter
        {
