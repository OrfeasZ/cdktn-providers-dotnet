...
namespace azuread.ConditionalAccessPolicy
{
    ...
    [JsiiByValue(fqn: "azuread.conditionalAccessPolicy.ConditionalAccessPolicyConditionsApplicationsFilter")]
    public class ConditionalAccessPolicyConditionsApplicationsFilter : azuread.ConditionalAccessPolicy.IConditionalAccessPolicyConditionsApplicationsFilter
    {
