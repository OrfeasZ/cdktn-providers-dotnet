...
namespace azuread.ApplicationOwner
{
    ...
    [JsiiByValue(fqn: "azuread.applicationOwner.ApplicationOwnerConfig")]
    public class ApplicationOwnerConfig : azuread.ApplicationOwner.IApplicationOwnerConfig
    {
        ...
        public azuread.ApplicationOwner.IApplicationOwnerTimeouts? Timeouts
        {
            get;
            set;
        }
