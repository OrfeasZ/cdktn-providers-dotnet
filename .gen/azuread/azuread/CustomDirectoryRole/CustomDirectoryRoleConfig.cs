...
namespace azuread.CustomDirectoryRole
{
    ...
    [JsiiByValue(fqn: "azuread.customDirectoryRole.CustomDirectoryRoleConfig")]
    public class CustomDirectoryRoleConfig : azuread.CustomDirectoryRole.ICustomDirectoryRoleConfig
    {
            ...
            set
            {
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        case Io.Cdktn.IResolvable cast_cd4240:
                            break;
                        case azuread.CustomDirectoryRole.ICustomDirectoryRolePermissions[] cast_cd4240:
                            break;
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            // Not enough information to type-check...
                            break;
                        case null:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(azuread.CustomDirectoryRole.ICustomDirectoryRolePermissions).FullName}[]; received null", nameof(value));
                        default:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(azuread.CustomDirectoryRole.ICustomDirectoryRolePermissions).FullName}[]; received {value.GetType().FullName}", nameof(value));
                    }
                }
                _permissions = value;
            }
