...
{
    [JsiiInterface(nativeType: typeof(ICustomDirectoryRoleConfig), fullyQualifiedName: "azuread.customDirectoryRole.CustomDirectoryRoleConfig")]
    public interface ICustomDirectoryRoleConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        azuread.CustomDirectoryRole.ICustomDirectoryRoleTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(ICustomDirectoryRoleConfig), fullyQualifiedName: "azuread.customDirectoryRole.CustomDirectoryRoleConfig")]
        internal sealed class _Proxy : DeputyBase, azuread.CustomDirectoryRole.ICustomDirectoryRoleConfig
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"azuread.customDirectoryRole.CustomDirectoryRoleTimeouts\"}", isOptional: true)]
            public azuread.CustomDirectoryRole.ICustomDirectoryRoleTimeouts? Timeouts
            {
                get => GetInstanceProperty<azuread.CustomDirectoryRole.ICustomDirectoryRoleTimeouts?>();
            }
