...
namespace azuread.Application
{
    ...
    [JsiiByValue(fqn: "azuread.application.ApplicationOptionalClaimsAccessToken")]
    public class ApplicationOptionalClaimsAccessToken : azuread.Application.IApplicationOptionalClaimsAccessToken
    {
