...
{
    [JsiiByValue(fqn: "azuread.application.ApplicationSinglePageApplication")]
    public class ApplicationSinglePageApplication : azuread.Application.IApplicationSinglePageApplication
    {
