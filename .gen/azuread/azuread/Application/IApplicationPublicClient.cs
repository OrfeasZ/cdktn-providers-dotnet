...
{
    [JsiiInterface(nativeType: typeof(IApplicationPublicClient), fullyQualifiedName: "azuread.application.ApplicationPublicClient")]
    public interface IApplicationPublicClient
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IApplicationPublicClient), fullyQualifiedName: "azuread.application.ApplicationPublicClient")]
        internal sealed class _Proxy : DeputyBase, azuread.Application.IApplicationPublicClient
        {
