...
namespace azuread.Application
{
    ...
    [JsiiByValue(fqn: "azuread.application.ApplicationOptionalClaimsIdToken")]
    public class ApplicationOptionalClaimsIdToken : azuread.Application.IApplicationOptionalClaimsIdToken
    {
