...
namespace azuread.AuthenticationStrengthPolicyFido2CombinationConfiguration
{
    ...
    [JsiiByValue(fqn: "azuread.authenticationStrengthPolicyFido2CombinationConfiguration.AuthenticationStrengthPolicyFido2CombinationConfigurationConfig")]
    public class AuthenticationStrengthPolicyFido2CombinationConfigurationConfig : azuread.AuthenticationStrengthPolicyFido2CombinationConfiguration.IAuthenticationStrengthPolicyFido2CombinationConfigurationConfig
    {
        /// <summary>A set of AAGUIDs allowed to be used as part of the `fido2` combination.</summary>
        /// <remarks>
        ...
        /// <summary>Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azuread/3.10.0/docs/resources/authentication_strength_policy_fido2_combination_configuration#id AuthenticationStrengthPolicyFido2CombinationConfiguration#id}.</summary>
        /// <remarks>
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"azuread.authenticationStrengthPolicyFido2CombinationConfiguration.AuthenticationStrengthPolicyFido2CombinationConfigurationTimeouts\"}", isOptional: true)]
        public azuread.AuthenticationStrengthPolicyFido2CombinationConfiguration.IAuthenticationStrengthPolicyFido2CombinationConfigurationTimeouts? Timeouts
        {
            get;
            set;
        }
