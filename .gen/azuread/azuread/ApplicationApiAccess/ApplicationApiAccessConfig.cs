...
namespace azuread.ApplicationApiAccess
{
    ...
    [JsiiByValue(fqn: "azuread.applicationApiAccess.ApplicationApiAccessConfig")]
    public class ApplicationApiAccessConfig : azuread.ApplicationApiAccess.IApplicationApiAccessConfig
    {
