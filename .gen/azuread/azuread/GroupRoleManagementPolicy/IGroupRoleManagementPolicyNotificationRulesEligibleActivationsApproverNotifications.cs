...
{
    [JsiiInterface(nativeType: typeof(IGroupRoleManagementPolicyNotificationRulesEligibleActivationsApproverNotifications), fullyQualifiedName: "azuread.groupRoleManagementPolicy.GroupRoleManagementPolicyNotificationRulesEligibleActivationsApproverNotifications")]
    public interface IGroupRoleManagementPolicyNotificationRulesEligibleActivationsApproverNotifications
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IGroupRoleManagementPolicyNotificationRulesEligibleActivationsApproverNotifications), fullyQualifiedName: "azuread.groupRoleManagementPolicy.GroupRoleManagementPolicyNotificationRulesEligibleActivationsApproverNotifications")]
        internal sealed class _Proxy : DeputyBase, azuread.GroupRoleManagementPolicy.IGroupRoleManagementPolicyNotificationRulesEligibleActivationsApproverNotifications
        {
