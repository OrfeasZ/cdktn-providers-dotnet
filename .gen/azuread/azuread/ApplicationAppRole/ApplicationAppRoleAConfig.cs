...
namespace azuread.ApplicationAppRole
{
    ...
    [JsiiByValue(fqn: "azuread.applicationAppRole.ApplicationAppRoleAConfig")]
    public class ApplicationAppRoleAConfig : azuread.ApplicationAppRole.IApplicationAppRoleAConfig
    {
