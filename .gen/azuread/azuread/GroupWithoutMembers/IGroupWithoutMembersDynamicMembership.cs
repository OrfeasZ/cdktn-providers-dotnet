...
{
    [JsiiInterface(nativeType: typeof(IGroupWithoutMembersDynamicMembership), fullyQualifiedName: "azuread.groupWithoutMembers.GroupWithoutMembersDynamicMembership")]
    public interface IGroupWithoutMembersDynamicMembership
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IGroupWithoutMembersDynamicMembership), fullyQualifiedName: "azuread.groupWithoutMembers.GroupWithoutMembersDynamicMembership")]
        internal sealed class _Proxy : DeputyBase, azuread.GroupWithoutMembers.IGroupWithoutMembersDynamicMembership
        {
