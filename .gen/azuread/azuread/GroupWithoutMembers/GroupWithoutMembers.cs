...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/hashicorp/azuread/3.10.0/docs/resources/group_without_members azuread_group_without_members}.</summary>
    [JsiiClass(nativeType: typeof(azuread.GroupWithoutMembers.GroupWithoutMembers), fullyQualifiedName: "azuread.groupWithoutMembers.GroupWithoutMembers", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"remarks\":\"Must be unique amongst siblings in the same scope\",\"summary\":\"The scoped construct ID.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"azuread.groupWithoutMembers.GroupWithoutMembersConfig\"}}]")]
    public class GroupWithoutMembers : Io.Cdktn.TerraformResource
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/hashicorp/azuread/3.10.0/docs/resources/group_without_members azuread_group_without_members} Resource.</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        /// <param name="id">The scoped construct ID.</param>
        public GroupWithoutMembers(Constructs.Construct scope, string id, azuread.GroupWithoutMembers.IGroupWithoutMembersConfig config): base(_MakeDeputyProps(scope, id, config))
        {
        }

        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static DeputyProps _MakeDeputyProps(Constructs.Construct scope, string id, azuread.GroupWithoutMembers.IGroupWithoutMembersConfig config)
        {
        ...
        protected GroupWithoutMembers(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected GroupWithoutMembers(DeputyProps props): base(props)
        {
        }

        /// <summary>Generates CDKTN code for importing a GroupWithoutMembers resource upon running "cdktn plan &lt;stack-name&gt;".</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        /// <param name="importToId">The construct id used in the generated config for the GroupWithoutMembers to import.</param>
        /// <param name="importFromId">The id of the existing GroupWithoutMembers that should be imported.</param>
        /// <param name="provider">? Optional instance of the provider where the GroupWithoutMembers to import is found.</param>
        [JsiiMethod(name: "generateConfigForImport", returnsJson: "{\"type\":{\"fqn\":\"cdktn.ImportableResource\"}}", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"summary\":\"The construct id used in the generated config for the GroupWithoutMembers to import.\"},\"name\":\"importToId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"remarks\":\"Refer to the {@link https://registry.terraform.io/providers/hashicorp/azuread/3.10.0/docs/resources/group_without_members#import import section} in the documentation of this resource for the id to use\",\"summary\":\"The id of the existing GroupWithoutMembers that should be imported.\"},\"name\":\"importFromId\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"? Optional instance of the provider where the GroupWithoutMembers to import is found.\"},\"name\":\"provider\",\"optional\":true,\"type\":{\"fqn\":\"cdktn.TerraformProvider\"}}]")]
        public static Io.Cdktn.ImportableResource GenerateConfigForImport(Constructs.Construct scope, string importToId, string importFromId, Io.Cdktn.TerraformProvider? provider = null)
        {
            return InvokeStaticMethod<Io.Cdktn.ImportableResource>(typeof(azuread.GroupWithoutMembers.GroupWithoutMembers), new System.Type[]{typeof(Constructs.Construct), typeof(string), typeof(string), typeof(Io.Cdktn.TerraformProvider)}, new object?[]{scope, importToId, importFromId, provider})!;
        }

        [JsiiMethod(name: "putDynamicMembership", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"azuread.groupWithoutMembers.GroupWithoutMembersDynamicMembership\"}}]")]
        public virtual void PutDynamicMembership(azuread.GroupWithoutMembers.IGroupWithoutMembersDynamicMembership @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(azuread.GroupWithoutMembers.IGroupWithoutMembersDynamicMembership)}, new object[]{@value});
        }

        [JsiiMethod(name: "putTimeouts", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"azuread.groupWithoutMembers.GroupWithoutMembersTimeouts\"}}]")]
        public virtual void PutTimeouts(azuread.GroupWithoutMembers.IGroupWithoutMembersTimeouts @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(azuread.GroupWithoutMembers.IGroupWithoutMembersTimeouts)}, new object[]{@value});
        }
        ...
        = GetStaticProperty<string>(typeof(azuread.GroupWithoutMembers.GroupWithoutMembers))!;

        [JsiiProperty(name: "dynamicMembership", typeJson: "{\"fqn\":\"azuread.groupWithoutMembers.GroupWithoutMembersDynamicMembershipOutputReference\"}")]
        public virtual azuread.GroupWithoutMembers.GroupWithoutMembersDynamicMembershipOutputReference DynamicMembership
        {
            get => GetInstanceProperty<azuread.GroupWithoutMembers.GroupWithoutMembersDynamicMembershipOutputReference>()!;
        }
        ...
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"azuread.groupWithoutMembers.GroupWithoutMembersTimeoutsOutputReference\"}")]
        public virtual azuread.GroupWithoutMembers.GroupWithoutMembersTimeoutsOutputReference Timeouts
        {
            get => GetInstanceProperty<azuread.GroupWithoutMembers.GroupWithoutMembersTimeoutsOutputReference>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "dynamicMembershipInput", typeJson: "{\"fqn\":\"azuread.groupWithoutMembers.GroupWithoutMembersDynamicMembership\"}", isOptional: true)]
        public virtual azuread.GroupWithoutMembers.IGroupWithoutMembersDynamicMembership? DynamicMembershipInput
        {
        ...
        /// <remarks>
        /// <para>Type union: either <see cref="Io.Cdktn.IResolvable" /> or <see cref="azuread.GroupWithoutMembers.IGroupWithoutMembersTimeouts" /></para>
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "timeoutsInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"fqn\":\"azuread.groupWithoutMembers.GroupWithoutMembersTimeouts\"}]}}", isOptional: true)]
