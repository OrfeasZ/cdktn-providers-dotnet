...
{
    [JsiiInterface(nativeType: typeof(IApplicationKnownClientsConfig), fullyQualifiedName: "azuread.applicationKnownClients.ApplicationKnownClientsConfig")]
    public interface IApplicationKnownClientsConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        azuread.ApplicationKnownClients.IApplicationKnownClientsTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IApplicationKnownClientsConfig), fullyQualifiedName: "azuread.applicationKnownClients.ApplicationKnownClientsConfig")]
        internal sealed class _Proxy : DeputyBase, azuread.ApplicationKnownClients.IApplicationKnownClientsConfig
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"azuread.applicationKnownClients.ApplicationKnownClientsTimeouts\"}", isOptional: true)]
            public azuread.ApplicationKnownClients.IApplicationKnownClientsTimeouts? Timeouts
            {
                get => GetInstanceProperty<azuread.ApplicationKnownClients.IApplicationKnownClientsTimeouts?>();
            }
