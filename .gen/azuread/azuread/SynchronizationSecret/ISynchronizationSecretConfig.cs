...
{
    [JsiiInterface(nativeType: typeof(ISynchronizationSecretConfig), fullyQualifiedName: "azuread.synchronizationSecret.SynchronizationSecretConfig")]
    public interface ISynchronizationSecretConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        azuread.SynchronizationSecret.ISynchronizationSecretTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(ISynchronizationSecretConfig), fullyQualifiedName: "azuread.synchronizationSecret.SynchronizationSecretConfig")]
        internal sealed class _Proxy : DeputyBase, azuread.SynchronizationSecret.ISynchronizationSecretConfig
        {
            ...
            {
                get => GetInstanceProperty<azuread.SynchronizationSecret.ISynchronizationSecretTimeouts?>();
            }
