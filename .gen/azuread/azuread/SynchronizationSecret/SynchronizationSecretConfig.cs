...
namespace azuread.SynchronizationSecret
{
    ...
    [JsiiByValue(fqn: "azuread.synchronizationSecret.SynchronizationSecretConfig")]
    public class SynchronizationSecretConfig : azuread.SynchronizationSecret.ISynchronizationSecretConfig
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "credential", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktn.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"azuread.synchronizationSecret.SynchronizationSecretCredential\"},\"kind\":\"array\"}}]}}", isOptional: true)]
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        case Io.Cdktn.IResolvable cast_cd4240:
                            break;
                        case azuread.SynchronizationSecret.ISynchronizationSecretCredential[] cast_cd4240:
                            break;
                        ...
                        case null:
                            break;
                        default:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(azuread.SynchronizationSecret.ISynchronizationSecretCredential).FullName}[]; received {value.GetType().FullName}", nameof(value));
                    }
                }
                _credential = value;
            }
        ...
        public azuread.SynchronizationSecret.ISynchronizationSecretTimeouts? Timeouts
        {
            get;
            set;
        }
