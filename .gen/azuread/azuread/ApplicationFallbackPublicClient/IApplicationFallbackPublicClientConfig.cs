...
{
    [JsiiInterface(nativeType: typeof(IApplicationFallbackPublicClientConfig), fullyQualifiedName: "azuread.applicationFallbackPublicClient.ApplicationFallbackPublicClientConfig")]
    public interface IApplicationFallbackPublicClientConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        /// <summary>Specifies explicitly whether the application is a public client.</summary>
        /// <remarks>
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        azuread.ApplicationFallbackPublicClient.IApplicationFallbackPublicClientTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IApplicationFallbackPublicClientConfig), fullyQualifiedName: "azuread.applicationFallbackPublicClient.ApplicationFallbackPublicClientConfig")]
        internal sealed class _Proxy : DeputyBase, azuread.ApplicationFallbackPublicClient.IApplicationFallbackPublicClientConfig
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"azuread.applicationFallbackPublicClient.ApplicationFallbackPublicClientTimeouts\"}", isOptional: true)]
            public azuread.ApplicationFallbackPublicClient.IApplicationFallbackPublicClientTimeouts? Timeouts
            {
                get => GetInstanceProperty<azuread.ApplicationFallbackPublicClient.IApplicationFallbackPublicClientTimeouts?>();
            }
