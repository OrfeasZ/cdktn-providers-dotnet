...
namespace azuread.ApplicationOptionalClaims
{
    ...
    [JsiiByValue(fqn: "azuread.applicationOptionalClaims.ApplicationOptionalClaimsAConfig")]
    public class ApplicationOptionalClaimsAConfig : azuread.ApplicationOptionalClaims.IApplicationOptionalClaimsAConfig
    {
                ...
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        case Io.Cdktn.IResolvable cast_cd4240:
                            break;
                        case azuread.ApplicationOptionalClaims.IApplicationOptionalClaimsAccessTokenA[] cast_cd4240:
                            break;
                        ...
                        case null:
                            break;
                        default:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(azuread.ApplicationOptionalClaims.IApplicationOptionalClaimsAccessTokenA).FullName}[]; received {value.GetType().FullName}", nameof(value));
                    }
                }
                _accessToken = value;
            }
            ...
            set
            {
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        case Io.Cdktn.IResolvable cast_cd4240:
                            break;
                        case azuread.ApplicationOptionalClaims.IApplicationOptionalClaimsIdTokenA[] cast_cd4240:
                            break;
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            // Not enough information to type-check...
                            break;
                        case null:
                            break;
                        default:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(azuread.ApplicationOptionalClaims.IApplicationOptionalClaimsIdTokenA).FullName}[]; received {value.GetType().FullName}", nameof(value));
                    }
                }
                _idToken = value;
            }
            ...
            set
            {
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                    switch (value)
                    {
                        case Io.Cdktn.IResolvable cast_cd4240:
                            break;
                        case azuread.ApplicationOptionalClaims.IApplicationOptionalClaimsSaml2TokenA[] cast_cd4240:
                            break;
                        case Amazon.JSII.Runtime.Deputy.AnonymousObject cast_cd4240:
                            // Not enough information to type-check...
                            break;
                        case null:
                            break;
                        default:
                            throw new System.ArgumentException($"Expected {nameof(value)} to be one of: {typeof(Io.Cdktn.IResolvable).FullName}, {typeof(azuread.ApplicationOptionalClaims.IApplicationOptionalClaimsSaml2TokenA).FullName}[]; received {value.GetType().FullName}", nameof(value));
                    }
                }
                _saml2Token = value;
            }
