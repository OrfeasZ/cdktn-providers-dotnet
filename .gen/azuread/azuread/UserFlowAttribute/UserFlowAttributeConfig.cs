...
namespace azuread.UserFlowAttribute
{
    ...
    [JsiiByValue(fqn: "azuread.userFlowAttribute.UserFlowAttributeConfig")]
    public class UserFlowAttributeConfig : azuread.UserFlowAttribute.IUserFlowAttributeConfig
    {
