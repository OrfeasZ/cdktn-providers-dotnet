...
{
    [JsiiInterface(nativeType: typeof(IDataAzureadAdministrativeUnitConfig), fullyQualifiedName: "azuread.dataAzureadAdministrativeUnit.DataAzureadAdministrativeUnitConfig")]
    public interface IDataAzureadAdministrativeUnitConfig : Io.Cdktn.ITerraformMetaArguments
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        azuread.DataAzureadAdministrativeUnit.IDataAzureadAdministrativeUnitTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataAzureadAdministrativeUnitConfig), fullyQualifiedName: "azuread.dataAzureadAdministrativeUnit.DataAzureadAdministrativeUnitConfig")]
        internal sealed class _Proxy : DeputyBase, azuread.DataAzureadAdministrativeUnit.IDataAzureadAdministrativeUnitConfig
        {
            ...
            {
                get => GetInstanceProperty<azuread.DataAzureadAdministrativeUnit.IDataAzureadAdministrativeUnitTimeouts?>();
            }
