...
namespace azuread.AppRoleAssignment
{
    ...
    [JsiiByValue(fqn: "azuread.appRoleAssignment.AppRoleAssignmentConfig")]
    public class AppRoleAssignmentConfig : azuread.AppRoleAssignment.IAppRoleAssignmentConfig
    {
