...
namespace postgresql.Publication
{
    ...
    [JsiiByValue(fqn: "postgresql.publication.PublicationConfig")]
    public class PublicationConfig : postgresql.Publication.IPublicationConfig
    {
        ...
        private object? _publishViaPartitionRootParam;
        ...
        {
            get => _publishViaPartitionRootParam;
            set
            {
                if (Amazon.JSII.Runtime.Configuration.RuntimeTypeChecking)
                {
                ...
                _publishViaPartitionRootParam = value;
            }
        }
