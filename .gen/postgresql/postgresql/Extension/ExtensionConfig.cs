...
namespace postgresql.Extension
{
    ...
    [JsiiByValue(fqn: "postgresql.extension.ExtensionConfig")]
    public class ExtensionConfig : postgresql.Extension.IExtensionConfig
    {
