...
namespace postgresql.Subscription
{
    ...
    [JsiiByValue(fqn: "postgresql.subscription.SubscriptionConfig")]
    public class SubscriptionConfig : postgresql.Subscription.ISubscriptionConfig
    {
