...
{
    [JsiiInterface(nativeType: typeof(ISecurityLabelConfig), fullyQualifiedName: "postgresql.securityLabel.SecurityLabelConfig")]
    public interface ISecurityLabelConfig : Io.Cdktn.ITerraformMetaArguments
    {
        /// <summary>The label to be applied.</summary>
        /// <remarks>
        ...
        /// <summary>The provider to apply the security label for.</summary>
        /// <remarks>
        ...
        /// <summary>The name of the existing object to apply the security label to.</summary>
        /// <remarks>
        ...
        /// <summary>The type of the existing object to apply the security label to.</summary>
        /// <remarks>
        ...
        /// <summary>Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyrilgdn/postgresql/1.27.0/docs/resources/security_label#id SecurityLabel#id}.</summary>
        /// <remarks>
        ...
        [JsiiTypeProxy(nativeType: typeof(ISecurityLabelConfig), fullyQualifiedName: "postgresql.securityLabel.SecurityLabelConfig")]
        internal sealed class _Proxy : DeputyBase, postgresql.SecurityLabel.ISecurityLabelConfig
        {
