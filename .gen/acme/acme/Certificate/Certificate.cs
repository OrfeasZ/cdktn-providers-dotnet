...
{
    /// <summary>Represents a {@link https://registry.terraform.io/providers/vancluever/acme/3.0.1/docs/resources/certificate acme_certificate}.</summary>
    ...
    {
        /// <summary>Create a new {@link https://registry.terraform.io/providers/vancluever/acme/3.0.1/docs/resources/certificate acme_certificate} Resource.</summary>
        ...
        /// <param name="value">Type union: either <see cref="Io.Cdktn.IResolvable" /> or (<see cref="acme.Certificate.ICertificateDnsChallenge" />)[]</param>
        ...
        [JsiiMethod(name: "resetDisableAuthoritativePropagation")]
        public virtual void ResetDisableAuthoritativePropagation()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "disableAuthoritativePropagationInput", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktn.IResolvable\"}]}}", isOptional: true)]
        public virtual object? DisableAuthoritativePropagationInput
        {
            get => GetInstanceProperty<object?>();
        }
        ...
        /// <para>Type union: either bool or <see cref="Io.Cdktn.IResolvable" /></para>
        /// </remarks>
        [JsiiProperty(name: "disableAuthoritativePropagation", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktn.IResolvable\"}]}}")]
        public virtual object DisableAuthoritativePropagation
        {
            get => GetInstanceProperty<object>()!;
            set
            {
